...
final class l {
    ...
    private static String a(String str, boolean z) {
        ...
        while (i2 < length) {
            ...
            if (codePointAt >= 32 && codePointAt < 127 && f17145l.indexOf(codePointAt) == -1 && (z || (codePointAt != 47 && codePointAt != 37))) {
            ...
            if (!z || (codePointAt != 9 && codePointAt != 10 && codePointAt != 12 && codePointAt != 13)) {
                if (codePointAt >= 32 && codePointAt < 127 && f17145l.indexOf(codePointAt) == -1 && (z || (codePointAt != 47 && codePointAt != 37))) {
                    ...
                    while (!buffer2.exhausted()) {
                        ...
                        buffer.writeByte(37);
                        buffer.writeByte((int) f17144k[(readByte >> 4) & 15]);
                        buffer.writeByte((int) f17144k[readByte & 15]);
                    }
                }
            }
            i2 += Character.charCount(codePointAt);
    ...
    Request a() {
        ...
        if (builder != null) {
            ...
            resolve = this.f17147b.resolve(this.f17148c);
            if (resolve == null) {
                throw new IllegalArgumentException("Malformed URL. Base: " + this.f17147b + ", Relative: " + this.f17148c);
            }
        }
        RequestBody requestBody = this.f17155j;
        if (requestBody == null) {
        ...
        return this.f17150e.url(resolve).method(this.f17146a, requestBody).build();
    }
}
