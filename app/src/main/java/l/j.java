...
abstract class j<T> {
    ...
    static final class d<T> extends j<T> {
        ...
        void a(l.l lVar, @Nullable T t) throws IOException {
            String a2;
            if (t == null || (a2 = this.f17120b.a(t)) == null) {
                return;
            }
            lVar.a(this.f17119a, a2, this.f17121c);
        }
    }
    ...
    static final class k<T> extends j<T> {
        ...
        void a(l.l lVar, @Nullable T t) throws IOException {
            String a2;
            if (t == null || (a2 = this.f17135b.a(t)) == null) {
                return;
            }
            lVar.c(this.f17134a, a2, this.f17136c);
        }
    }
