...
final class C1069f {
    ...
    /* renamed from: b */
    static int m1713b(int i2) throws C1112w {
        if (i2 <= 0) {
        ...
        throw new C1112w("No recommendation possible");
    }

    /* renamed from: a */
    static String m1712a(CharSequence charSequence, int i2) {
        int m1711a = m1711a(i2);
        char[] cArr = new char[m1711a];
        int length = charSequence.length();
        for (int i3 = 0; i3 < length; i3++) {
            int charAt = (charSequence.charAt(i3) + cArr[cArr.length - 1]) % C1045a.f1963a;
            for (int i4 = m1711a - 1; i4 >= 1; i4--) {
                cArr[i4] = (char) ((cArr[i4 - 1] + (929 - ((f2087a[i2][i4] * charAt) % C1045a.f1963a))) % C1045a.f1963a);
            }
            cArr[0] = (char) ((929 - ((charAt * f2087a[i2][0]) % C1045a.f1963a)) % C1045a.f1963a);
        }
        StringBuilder sb = new StringBuilder(m1711a);
        for (int i5 = m1711a - 1; i5 >= 0; i5--) {
            if (cArr[i5] != 0) {
