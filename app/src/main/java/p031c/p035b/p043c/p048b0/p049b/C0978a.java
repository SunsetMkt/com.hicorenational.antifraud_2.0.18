...
final class C0978a {
    ...
    byte[] m1329a() {
        ...
        int m2177d = this.f1735a.m2177d();
        int m2181g = this.f1735a.m2181g();
        for (int i2 = 0; i2 < m2177d; i2++) {
            int[] iArr = f1734b[i2];
            for (int i3 = 0; i3 < m2181g; i3++) {
                int i4 = iArr[i3];
                if (i4 >= 0 && this.f1735a.m2173b(i3, i2)) {
                    int i5 = i4 / 6;
