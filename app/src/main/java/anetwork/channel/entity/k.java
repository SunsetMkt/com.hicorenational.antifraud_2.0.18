...
public class k {
    ...
    public k(ParcelableRequest parcelableRequest, int i2, boolean z) {
        ...
        HttpUrl l2 = l();
        this.f2226f = new RequestStatistic(l2.host(), String.valueOf(parcelableRequest.f2101l));
        this.f2226f.url = l2.simpleUrlString();
        this.f2222b = b(l2);
    }
    ...
    private HttpUrl l() {
        HttpUrl parse = HttpUrl.parse(this.f2221a.f2093d);
        if (parse == null) {
    ...
    private Map<String, String> c(HttpUrl httpUrl) {
        ...
        Map<String, String> map = this.f2221a.f2097h;
        if (map != null) {
            for (Map.Entry<String, String> entry : map.entrySet()) {
                String key = entry.getKey();
                if (!"Host".equalsIgnoreCase(key) && !":host".equalsIgnoreCase(key)) {
                    boolean equalsIgnoreCase = a.a.u.a.f1253j.equalsIgnoreCase(this.f2221a.a(a.a.u.a.f1248e));
