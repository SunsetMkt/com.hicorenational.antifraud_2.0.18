    ...
    public static abstract class a extends Binder implements d {
        ...
        private static class C0020a implements d {
            ...
            public boolean g() throws RemoteException {
                ...
                try {
                    obtain.writeInterfaceToken(a.f2115a);
                    this.f2118a.transact(2, obtain, obtain2, 0);
            ...
            public int read(byte[] bArr) throws RemoteException {
                ...
                try {
                    ...
                    this.f2118a.transact(1, obtain, obtain2, 0);
                    obtain2.readException();
        ...
        public static d a(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(f2115a);
