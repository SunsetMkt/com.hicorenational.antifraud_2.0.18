...
public class f implements Future<a.a.i> {
    ...
    public a.a.i get() throws InterruptedException, ExecutionException {
    ...
    @Override // java.util.concurrent.Future
    public /* synthetic */ a.a.i get(long j2, TimeUnit timeUnit) throws InterruptedException, ExecutionException, TimeoutException {
        return a(j2);
    }
    ...
    public a.a.i a(long j2) throws InterruptedException, ExecutionException, TimeoutException {
        a.a.i iVar = this.f2168b;
        if (iVar != null) {
            return iVar;
        }
