...
public class a extends b {
    ...
    public byte[] a() {
        try {
            String jSONObject = new p.a().a(b.JSON_CMD, this.f8712e).a("appKey", this.f8708a).a("deviceId", this.f8709b).a("alias", this.f8710c).a(JSON_PUSH_USER_TOKEN, this.f8711d).a().toString();
