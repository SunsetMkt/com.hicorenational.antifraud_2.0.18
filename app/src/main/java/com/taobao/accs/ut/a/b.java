...
public class b {
    ...
    private void b(String str) {
        ...
        try {
            hashMap.put("device_id", this.f8575a);
            hashMap.put("bind_date", this.f8576b);
            hashMap.put("ret", this.f8577c ? "y" : "n");
            hashMap.put("fail_reasons", this.f8578d);
            hashMap.put(SocializeConstants.TENCENT_UID, this.f8579e);
            ...
            th = th3;
            ALog.d("accs.BindUserStatistic", UTMini.getCommitInfo(66001, str2, (String) null, str3, hashMap) + c.c.a.b.a.a.f3100g + th.toString(), new Object[0]);
        }
    }
