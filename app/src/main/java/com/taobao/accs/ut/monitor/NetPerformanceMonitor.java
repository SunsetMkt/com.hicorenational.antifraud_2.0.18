...
public class NetPerformanceMonitor extends BaseMonitor {
    ...
    public boolean beforeCommit() {
        if (this.real_to_bz_date == 0) {
            this.real_to_bz_date = this.f5885d;
        }
        this.accs_sdk_version = 221;
        this.total_time = a(this.a, this.real_to_bz_date);
        this.start_to_enter_queue_time = a(this.a, this.f5883b);
        this.in_queue_time = a(this.f5883b, this.take_date);
        this.talk_to_send_time = a(this.take_date, this.to_tnet_date);
        this.send_to_receive_time = a(this.to_tnet_date, this.f5884c);
        this.receive_to_distribute_time = a(this.f5884c, this.f5885d);
        this.distribute_to_service_time = a(this.f5885d, this.start_service);
        ...
        this.receive_accs_to_call_time = a(this.f5886e, this.f5887f);
        this.receive_agoo_to_call_time = a(this.f5886e, this.f5888g);
