...
public class TrafficsMonitor {
    ...
    private void b() {
        ...
        synchronized (this.f8621a) {
            ...
            if (TextUtils.isEmpty(this.f8625e) || this.f8625e.equals(a2)) {
                str = a2;
                z = false;
            } else {
                str = this.f8625e;
            ...
            if (z) {
                ...
                ALog.d("TrafficsMonitor", "no need commit lastsaveDay:" + this.f8625e + " currday:" + a2, new Object[0]);
            }
            this.f8625e = a2;
            this.f8623c = 0;
        }
    ...
    private void c() {
        List<a> a2 = com.taobao.accs.b.a.a(this.f8624d).a(false);
        if (a2 == null) {
            return;
        }
        try {
    ...
    public void a(a aVar) {
        ...
        synchronized (this.f8621a) {
            ...
            List<a> list = this.f8621a.get(str);
            if (list != null) {
    ...
    public void a() {
        try {
            ...
            List<a> a2 = com.taobao.accs.b.a.a(this.f8624d).a(true);
            if (a2 == null) {
                return;
            }
