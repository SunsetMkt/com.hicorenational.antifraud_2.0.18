...
public class AccsConfig {
    ...
    public static void setAccsCenterHosts(String str, String str2, String str3) {
        ...
        ALog.i(TAG, "setAccsCenterHost", at.a, Integer.valueOf(ACCSManager.mEnv), "releaseHost", str, "prepareHost", str2, "dailyHost", str3);
    ...
    public static void setChannelHosts(String str, String str2, String str3) {
        ALog.i(TAG, at.a, Integer.valueOf(ACCSManager.mEnv), "setChannelHosts", "releaseHost", str, "prepareHost", str2, "dailyHost", str3);
        int i2 = ACCSManager.mEnv;
        if (i2 == 1) {
