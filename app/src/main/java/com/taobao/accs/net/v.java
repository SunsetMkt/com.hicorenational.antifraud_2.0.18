...
public class v extends com.taobao.accs.net.a implements SessionCb, Spdycb {
    ...
    private class a extends Thread {
        ...
        public void run() {
            Message message;
            boolean z;
            ALog.i(this.f8562d, "NetworkThread run", new Object[0]);
            this.f8559a = 0;
            Message message2 = null;
            while (v.this.w) {
                ALog.d(this.f8562d, "ready to get message", new Object[0]);
                synchronized (v.this.u) {
                    if (v.this.u.size() == 0) {
                        try {
                            ALog.d(this.f8562d, "no message, wait", new Object[0]);
                            v.this.u.wait();
                        } catch (InterruptedException e2) {
                            e2.printStackTrace();
                        }
                    }
                    ALog.d(this.f8562d, "try get message", new Object[0]);
                    if (v.this.u.size() != 0) {
                ...
                if (message != null) {
                    ALog.d(this.f8562d, "sendMessage not null", new Object[0]);
                    try {
                        int type = message.getType();
                        ALog.i(this.f8562d, "sendMessage", "type", Message.MsgType.name(type), NotificationCompat.CATEGORY_STATUS, Integer.valueOf(v.this.t));
                        if (type != 2) {
                            if (type == 1) {
                                a(true);
                                if (v.this.t == 1 && v.this.A != null) {
                                    byte[] build = message.build(v.this.f8503d, v.this.f8502c);
                                    ...
                                    if (build.length <= 49152 || message.command.intValue() == 102) {
                                        ...
                                        objArr[4] = "utdid";
                                        objArr[5] = v.this.f8509j;
                                        ALog.e(str, "send data", objArr);
                                        v.this.f8504e.a(message);
                                        if (message.isAck) {
                                            ALog.e(this.f8562d, "sendCFrame end ack", Constants.KEY_DATA_ID, Integer.valueOf(id));
                                            v.this.f8511l.put(Integer.valueOf(id), message);
                                        }
                                        if (message.getNetPermanceMonitor() != null) {
                                            message.getNetPermanceMonitor().onSendData();
                                        }
                                        v.this.a(message.getDataId(), v.this.f8508i.isQuickReconnect(), message.timeout);
                                        v.this.f8504e.a(new TrafficsMonitor.a(message.serviceId, GlobalAppRuntimeInfo.isAppBackground(), v.this.p(), build.length));
                                    } else {
                                        v.this.f8504e.a(message, -4);
                                    }
                                }
                                z = false;
                            } else {
                                a(false);
                                ALog.e(this.f8562d, "skip msg", "type", Integer.valueOf(type));
                            }
                            z = true;
                        } else if (v.this.f8502c == 1) {
                            ALog.d(this.f8562d, "sendMessage INAPP ping, skip", new Object[0]);
                            try {
                                ALog.d(this.f8562d, "send succ, remove it", new Object[0]);
                                synchronized (v.this.u) {
                                    v.this.u.remove(message);
                                }
                            } catch (Throwable th) {
                                ALog.e(this.f8562d, " run finally error", th, new Object[0]);
                            }
                        } else {
                            if (System.currentTimeMillis() - v.this.C < (g.a(v.this.f8503d).b() - 1) * 1000 && !message.force) {
                                a(false);
                                z = true;
                            }
                            ALog.d(this.f8562d, "sendMessage", "force", Boolean.valueOf(message.force), "last ping", Long.valueOf(System.currentTimeMillis() - v.this.C));
                            a(true);
                            if (v.this.A != null && v.this.t == 1) {
                                if (System.currentTimeMillis() - v.this.C >= (g.a(v.this.f8503d).b() - 1) * 1000) {
                                    ALog.i(this.f8562d, "sendMessage onSendPing", new Object[0]);
                                    v.this.f8504e.a();
                                    v.this.A.submitPing();
                                    v.this.I.onSendPing();
                    ...
                    try {
                                ...
                                synchronized (v.this.u) {
                                    for (int size = v.this.u.size() - 1; size >= 0; size--) {
                                        ...
                                        if (message3 != null && message3.command != null && (message3.command.intValue() == 100 || message3.command.intValue() == 201)) {
                                            v.this.f8504e.a(message3, -1);
                                            v.this.u.remove(size);
                                        }
                                    }
                                    ALog.e(this.f8562d, "network disconnected, wait", new Object[0]);
                                    v.this.u.wait();
                                }
                            } catch (Throwable th3) {
                                ALog.e(this.f8562d, " run finally error", th3, new Object[0]);
                            }
                        }
                        ALog.e(this.f8562d, " run finally error", th3, new Object[0]);
                    } catch (Throwable th4) {
                        th = th4;
                        try {
                            com.taobao.accs.utl.k.a("accs", BaseMonitor.ALARM_POINT_REQ_ERROR, message.serviceId, "1", v.this.f8502c + th.toString());
                            th.printStackTrace();
                            ALog.e(this.f8562d, "service connection run", th, new Object[0]);
                            if (z) {
                                ALog.d(this.f8562d, "send succ, remove it", new Object[0]);
                                synchronized (v.this.u) {
                                    v.this.u.remove(message);
                                ...
                                try {
                                    ...
                                    ALog.e(this.f8562d, " run finally error", th5, new Object[0]);
                                }
                                message2 = message;
                            }
                            ALog.e(this.f8562d, " run finally error", th5, new Object[0]);
                            ...
                            try {
                                ...
                                ALog.e(this.f8562d, " run finally error", th7, new Object[0]);
                                throw th6;
                            }
                            ALog.e(this.f8562d, " run finally error", th7, new Object[0]);
                            throw th6;
    ...
    private void s() {
        ...
        try {
            String encode = URLEncoder.encode(UtilityImpl.j(this.f8503d));
            String a2 = UtilityImpl.a(i(), this.f8508i.getAppSecret(), UtilityImpl.j(this.f8503d));
            String c2 = c(this.x);
            ...
            if (!a(encode, i(), a2)) {
                ...
                SpdyRequest spdyRequest = new SpdyRequest(new URL(c2), "GET", RequestPriority.DEFAULT_PRIORITY, 80000, com.taobao.accs.net.a.ACCS_RECEIVE_TIMEOUT);
    ...
    public void spdyCustomControlFrameRecvCallback(SpdySession spdySession, Object obj, int i2, int i3, int i4, int i5, byte[] bArr) {
        ...
        if (i3 == 200) {
            try {
                ...
                this.f8504e.a(bArr);
                com.taobao.accs.ut.a.d g2 = this.f8504e.g();
                if (g2 != null) {
                    g2.f8595c = String.valueOf(currentTimeMillis2);
                    g2.f8599g = this.f8502c == 0 ? "service" : "inapp";
                    g2.a();
                }
            } catch (Throwable th) {
            ...
            try {
                if (ThreadPoolExecutorFactory.getScheduledExecutor().getQueue().size() <= 1000) {
                    ...
                    if (message.getType() == 1 && message.cunstomDataId != null) {
                        ...
                        this.f8504e.f8450a.put(message.cunstomDataId, schedule);
                    }
                    if (message.getNetPermanceMonitor() != null) {
