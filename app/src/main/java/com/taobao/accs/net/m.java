...
class m implements ISessionListener {
    ...
    public void onConnectionChanged(Intent intent) {
        if (intent != null) {
            ...
            ALog.e(this.a.d(), "onConnectionChanged", "currentHost", DefaultWebClient.HTTPS_SCHEME + this.a.f5806i.getInappHost(), "changeHost", stringExtra, "state", Boolean.valueOf(booleanExtra));
            if ((DefaultWebClient.HTTPS_SCHEME + this.a.f5806i.getInappHost()).equals(stringExtra)) {
                ...
                while (it.hasNext()) {
                    this.a.r.post(new n(this, connectInfo, it.next()));
                }
            }
        }
    }
