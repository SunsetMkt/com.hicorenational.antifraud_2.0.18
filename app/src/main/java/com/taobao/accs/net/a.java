...
public abstract class a {
    ...
    public void b(Message message, boolean z) {
        ...
        long a2 = message.getType() != 2 ? this.f8504e.f8453d.a(message.serviceId, message.bizId) : 0L;
        if (a2 == -1) {
    ...
    protected String c(String str) {
        String str2;
        String j2 = UtilityImpl.j(this.f8503d);
        try {
            str2 = URLEncoder.encode(j2);
        } catch (Throwable th) {
            ALog.e(d(), "buildAuthUrl", th, new Object[0]);
            str2 = j2;
        }
        String a2 = UtilityImpl.a(i(), this.f8508i.getAppSecret(), j2);
