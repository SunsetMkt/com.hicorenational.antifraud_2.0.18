...
public class k extends com.taobao.accs.net.a implements DataFrameCb {
    ...
    public static class a implements IAuth {
        ...
        private com.taobao.accs.net.a f5826d;

        public a(com.taobao.accs.net.a aVar, String str) {
            this.f5825c = aVar.d();
            this.a = aVar.c(DefaultWebClient.HTTPS_SCHEME + str + "/accs/");
            this.f5824b = aVar.f5800c;
            this.f5826d = aVar;
        }

        @Override // anet.channel.IAuth
        public void auth(Session session, IAuth.AuthCallback authCallback) {
            ALog.e(this.f5825c, "auth", "URL", this.a);
    ...
    public k(Context context, int i2, String str) {
        ...
        this.o = true;
        this.p = com.heytap.mcssdk.constant.a.f3869e;
    ...
    public void o() {
        if (this.f5806i.isAccsHeartbeatEnable()) {
    ...
    public boolean m() {
        ...
        try {
            Session session = SessionCenter.getInstance(this.f5806i.getAppKey()).get(b((String) null), ConnType.TypeLevel.SPDY, 0L);
                ...
                if (ThreadPoolExecutorFactory.getSendScheduledExecutor().getQueue().size() <= 1000) {
                    ...
                    if (message.getType() == 1 && message.cunstomDataId != null) {
                        if (message.isControlFrame() && a(message.cunstomDataId)) {
                            this.f5802e.b(message);
                        }
                        this.f5802e.a.put(message.cunstomDataId, scheduledFutureSchedule);
                    }
                    NetPerformanceMonitor netPermanceMonitor = message.getNetPermanceMonitor();
                    if (netPermanceMonitor != null) {
                        netPermanceMonitor.setDeviceId(UtilityImpl.j(this.f5801d));
                        netPermanceMonitor.setConnType(this.f5800c);
    ...
    public void a(String str, boolean z, String str2) {
        Session session;
        try {
            Message messageB = this.f5802e.b(str);
            if (messageB != null && messageB.host != null && (session = SessionCenter.getInstance(this.f5806i.getAppKey()).get(messageB.host.toString(), 0L)) != null) {
                if (z) {
    ...
    public boolean a(String str) {
        ...
        ScheduledFuture<?> scheduledFuture = this.f5802e.a.get(str);
    ...
    public void a(JSONObject jSONObject) {
        ...
        try {
            ...
            if (this.p != j2) {
                if (i2 == 0) {
                    j2 = com.heytap.mcssdk.constant.a.f3869e;
                }
                this.p = j2;
                if (this.q != null) {
                    this.q.cancel(true);
    ...
    protected void a(Context context) {
        ...
        try {
            ...
            if (com.taobao.accs.utl.t.c()) {
                SessionCenter.getInstance(this.f5806i.getAppKey()).registerAccsSessionListener(this.t);
            }
            String inappHost = this.f5806i.getInappHost();
            if (h() && this.f5806i.isKeepalive()) {
                z = true;
            } else {
                ALog.d(d(), "initAwcn close keepalive", new Object[0]);
                z = false;
            }
            a(SessionCenter.getInstance(this.f5806i.getAppKey()), inappHost, z);
            this.f5804g = true;
    ...
    public void a(SessionCenter sessionCenter, String str, boolean z) {
        ...
        sessionCenter.registerPublicKey(str, this.f5806i.getInappPubKey());
        this.v.add(str);
    ...
    public void a(AccsClientConfig accsClientConfig) {
        ...
        if (accsClientConfig.equals(this.f5806i)) {
            ALog.w(d(), "updateConfig not any changed", new Object[0]);
            return;
        }
        if (!this.f5804g) {
            if (UtilityImpl.isMainProcess(this.f5801d)) {
                this.f5806i = accsClientConfig;
                a(this.f5801d);
                return;
            }
            return;
        ...
        try {
            boolean z = true;
            ALog.w(d(), "updateConfig", "old", this.f5806i, "new", accsClientConfig);
            String inappHost = this.f5806i.getInappHost();
            String inappHost2 = accsClientConfig.getInappHost();
            SessionCenter sessionCenter = SessionCenter.getInstance(this.f5806i.getAppKey());
            ...
            this.f5810m = this.f5806i.getTag();
            String str = ConnType.PK_ACS;
            if (this.f5806i.getInappPubKey() == 10 || this.f5806i.getInappPubKey() == 11) {
                str = ConnType.PK_OPEN;
            }
            ALog.i(d(), "update config register new conn protocol host:", this.f5806i.getInappHost());
