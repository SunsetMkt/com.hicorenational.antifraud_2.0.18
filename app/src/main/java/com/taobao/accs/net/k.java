...
public class k extends com.taobao.accs.net.a implements DataFrameCb {
    ...
    */
    public boolean m() {
        /*
            r7 = this;
            boolean r0 = r7.f8506g
            r1 = 0
            if (r0 == 0) goto L48
            r0 = 1
            com.taobao.accs.AccsClientConfig r2 = r7.f8508i     // Catch: java.lang.Exception -> L47
            ...
            r3 = 0
            java.lang.String r3 = r7.b(r3)     // Catch: java.lang.Exception -> L47
        ...
        L34:
            ...
            com.taobao.accs.utl.ALog.e(r3, r4, r5)     // Catch: java.lang.Exception -> L47
            if (r2 == 0) goto L46
    ...
    public void a(String str, boolean z, String str2) {
        Session session;
        try {
            Message b2 = this.f8504e.b(str);
            if (b2 != null && b2.host != null && (session = SessionCenter.getInstance(this.f8508i.getAppKey()).get(b2.host.toString(), 0L)) != null) {
                if (z) {
