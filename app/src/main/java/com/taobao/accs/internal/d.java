...
public abstract class d implements IBaseService {
    ...
    protected static com.taobao.accs.net.a a(Context context, String str, boolean z) {
        ...
        int b2 = v.b(context);
        String str2 = str + HiAnalyticsConstant.REPORT_VAL_SEPARATOR + b2;
        synchronized (d.class) {
            try {
                com.taobao.accs.net.a aVar2 = f8495a.get(str2);
                if (aVar2 == null) {
                    try {
                        AccsClientConfig.mEnv = b2;
                        aVar = new com.taobao.accs.net.v(context, 0, str);
                        f8495a.put(str2, aVar);
                    } catch (Throwable th2) {
                        th = th2;
                        throw th;
                    }
    ...
    private void b(Intent intent) {
        try {
            ...
            if (!TextUtils.isEmpty(stringExtra) && !TextUtils.isEmpty(stringExtra2) && stringExtra.equals(this.f8496b.getPackageName())) {
                ...
                com.taobao.accs.net.a a2 = a(this.f8496b, stringExtra5, false);
                if (a2 != null) {
                    a2.f8500a = stringExtra3;
                } else {
