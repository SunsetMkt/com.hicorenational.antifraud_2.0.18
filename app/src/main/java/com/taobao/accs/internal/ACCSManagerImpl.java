...
public class ACCSManagerImpl implements com.taobao.accs.b {
    ...
    public void c(Context context, String str) {
        ...
        if (UtilityImpl.isMainProcess(context)) {
            a(context, Message.buildUnbindService(this.f8483d.b((String) null), this.f8482b, b2), 6, false);
        }
    }
    ...
    public void b(Context context, String str) {
        ...
        b2.putExtra(Constants.KEY_SERVICE_ID, str);
        if (UtilityImpl.isMainProcess(context)) {
            Message buildBindService = Message.buildBindService(this.f8483d.b((String) null), this.f8482b, b2);
    ...
    */
    ...
    public Map<String, Boolean> b() throws Exception {
        String b2 = this.f8483d.b((String) null);
        HashMap hashMap = new HashMap();
        hashMap.put(b2, false);
        if (SessionCenter.getInstance(this.f8483d.c()).getThrowsException(b2, com.heytap.mcssdk.constant.a.f5800d) != null) {
            hashMap.put(b2, true);
        }
        ALog.d(f8480c, "getChannelState " + hashMap.toString(), new Object[0]);
        return hashMap;
    }
    ...
    public void a(Context context, String str, boolean z) {
        try {
            ...
            if (UtilityImpl.isMainProcess(context)) {
                Message buildBindUser = Message.buildBindUser(this.f8483d.b((String) null), this.f8482b, b2);
    ...
    public void a(Context context) {
        ...
        b2.putExtra("appKey", c2);
        if (UtilityImpl.isMainProcess(context)) {
            a(context, Message.buildUnbindUser(this.f8483d.b((String) null), this.f8482b, b2), 4, false);
        }
    }
    ...
    */
    ...
    public String a(Context context, ACCSManager.AccsRequest accsRequest, String str, boolean z) {
        ...
        this.f8483d.a();
        Message buildRequest = Message.buildRequest(context, this.f8483d.b((String) null), this.f8482b, "", str == null ? context.getPackageName() : str, Constants.TARGET_SERVICE_PRE, accsRequest, z);
        if (buildRequest != null && buildRequest.getNetPermanceMonitor() != null) {
            buildRequest.getNetPermanceMonitor().onSend();
        }
        this.f8483d.a(buildRequest, true);
