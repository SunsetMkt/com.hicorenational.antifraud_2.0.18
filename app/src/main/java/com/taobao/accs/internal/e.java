...
class e implements Runnable {
    ...
    public void run() {
        ...
        Context context5;
        try {
            context = ServiceImpl.this.f8487c;
            if (context != null) {
                context2 = ServiceImpl.this.f8487c;
                if (UtilityImpl.e(context2)) {
                    Intent intent = new Intent();
                    intent.setAction("org.agoo.android.intent.action.PING_V4");
                    context3 = ServiceImpl.this.f8487c;
                    intent.setClassName(context3.getPackageName(), j.channelService);
                    context4 = ServiceImpl.this.f8487c;
                    context4.startService(intent);
                    UTMini uTMini = UTMini.getInstance();
                    context5 = ServiceImpl.this.f8487c;
