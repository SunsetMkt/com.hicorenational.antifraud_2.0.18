...
public class v {
    ...
    private static final byte[] f5946b = new byte[0];

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static int f5947c = -1;
    ...
    public static boolean a(Context context) {
        ...
        if (f5947c == -1) {
            f5947c = context.getApplicationInfo().targetSdkVersion;
        }
        return f5947c >= 26 && Build.VERSION.SDK_INT >= 26;
    }
    ...
    public static java.lang.String a(android.content.Context r4, java.lang.String r5, java.lang.String r6) {
        /*
            r0 = 0
            r1 = 0
            byte[] r2 = com.taobao.accs.utl.v.f5946b     // Catch: java.lang.Throwable -> L3a
