...
public class a extends SQLiteOpenHelper {
    ...
    private static volatile a f8384c;

    /* renamed from: e, reason: collision with root package name */
    private static final Lock f8385e = new ReentrantLock();

    /* renamed from: a, reason: collision with root package name */
    public int f8386a;

    /* renamed from: b, reason: collision with root package name */
    LinkedList<C0122a> f8387b;

    /* renamed from: d, reason: collision with root package name */
    private Context f8388d;
    ...
    private class C0122a {
        ...
        private C0122a(String str, Object[] objArr) {
            this.f8389a = str;
            this.f8390b = objArr;
        }
    }
    ...
    public static a a(Context context) {
        if (f8384c == null) {
            synchronized (a.class) {
                if (f8384c == null) {
                    f8384c = new a(context, Constants.DB_NAME, null, 3);
                }
            }
        }
        return f8384c;
    ...
    public List<TrafficsMonitor.a> a(boolean z) {
        ...
        synchronized (this) {
            ...
            try {
                ...
                if (z) {
                    query = writableDatabase.query(d.F, new String[]{bl.f10170d, "date", Constants.KEY_HOST, "serviceid", "bid", "isbackground", "size"}, "date=?", new String[]{UtilityImpl.a(System.currentTimeMillis())}, null, null, null, String.valueOf(100));
                } else {
                    query = writableDatabase.query(d.F, new String[]{bl.f10170d, "date", Constants.KEY_HOST, "serviceid", "bid", "isbackground", "size"}, null, null, null, null, null, String.valueOf(100));
                }
                if (query == null) {
                    if (query != null) {
                        query.close();
                    ...
                    if (query.moveToFirst()) {
                        do {
                            ...
                            if (string4 != null && j2 > 0) {
                                arrayList.add(new TrafficsMonitor.a(string, string4, string3, booleanValue, string2, j2));
                            }
    ...
    */
    private synchronized void a(java.lang.String r5, java.lang.Object[] r6, boolean r7) {
        /*
            ...
            monitor-enter(r4)
            r0 = 0
            java.util.LinkedList<com.taobao.accs.b.a$a> r1 = r4.f8387b     // Catch: java.lang.Throwable -> L6e java.lang.Exception -> L70
            ...
            java.util.LinkedList<com.taobao.accs.b.a$a> r5 = r4.f8387b     // Catch: java.lang.Throwable -> L6e java.lang.Exception -> L70
        ...
        L18:
            ...
            return
        L20:
            java.util.LinkedList<com.taobao.accs.b.a$a> r6 = r4.f8387b     // Catch: java.lang.Throwable -> L69
            int r6 = r6.size()     // Catch: java.lang.Throwable -> L69
            if (r6 <= 0) goto L65
            java.util.LinkedList<com.taobao.accs.b.a$a> r6 = r4.f8387b     // Catch: java.lang.Throwable -> L69
            java.lang.Object r6 = r6.removeFirst()     // Catch: java.lang.Throwable -> L69
            com.taobao.accs.b.a$a r6 = (com.taobao.accs.b.a.C0122a) r6     // Catch: java.lang.Throwable -> L69
            java.lang.Object[] r7 = r6.f8390b     // Catch: java.lang.Throwable -> L69
            if (r7 == 0) goto L3c
            java.lang.String r7 = r6.f8389a     // Catch: java.lang.Throwable -> L69
            java.lang.Object[] r1 = r6.f8390b     // Catch: java.lang.Throwable -> L69
        ...
        L41:
            java.lang.String r6 = r6.f8389a     // Catch: java.lang.Throwable -> L69
            java.lang.String r7 = "INSERT"
            boolean r6 = r6.contains(r7)     // Catch: java.lang.Throwable -> L69
            if (r6 == 0) goto L20
            int r6 = r4.f8386a     // Catch: java.lang.Throwable -> L69
            r7 = 1
            int r6 = r6 + r7
            r4.f8386a = r6     // Catch: java.lang.Throwable -> L69
            int r6 = r4.f8386a     // Catch: java.lang.Throwable -> L69
            ...
            r4.f8386a = r0     // Catch: java.lang.Throwable -> L69
        L65:
