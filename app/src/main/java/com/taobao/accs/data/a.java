            ...
            synchronized (this) {
                if (this.f8445f != 0) {
                    ...
                    if (this.f8447h.size() == this.f8442c) {
                        ...
                        if (bArr2 != null) {
                            j3 = bArr2.length;
                            j2 = System.currentTimeMillis() - this.f8444e;
                            this.f8445f = 2;
                            ALog.i("AssembleMessage", "putBurst completed", Constants.KEY_DATA_ID, this.f8441b, "length", Long.valueOf(j3), "cost", Long.valueOf(j2));
                        } else {
                            j2 = 0;
                        }
