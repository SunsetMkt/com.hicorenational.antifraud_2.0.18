...
public class PhotoItemSelectedDialog extends DialogFragment implements View.OnClickListener {
    ...
    private void initDialogStyle() {
        ...
        window.setWindowAnimations(C2639R.style.PictureThemeDialogFragmentAnim);
    }
    ...
    public void onClick(View view) {
        ...
        if (onItemClickListener != null) {
            if (id == C2639R.id.picture_tv_photo) {
                onItemClickListener.onItemClick(view, 0);
            }
            if (id == C2639R.id.picture_tv_video) {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        return layoutInflater.inflate(C2639R.layout.picture_dialog_camera_selected, viewGroup);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle bundle) {
        ...
        this.tvPicturePhoto = (TextView) view.findViewById(C2639R.id.picture_tv_photo);
        this.tvPictureVideo = (TextView) view.findViewById(C2639R.id.picture_tv_video);
        this.tvPictureCancel = (TextView) view.findViewById(C2639R.id.picture_tv_cancel);
