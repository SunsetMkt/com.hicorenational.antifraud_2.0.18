...
public abstract class PictureBaseActivity extends AppCompatActivity {
    ...
    /* JADX INFO: renamed from: com.luck.picture.lib.PictureBaseActivity$1 */
    class AnonymousClass1 extends PictureThreadUtils.SimpleTask<List<LocalMedia>> {
    ...
    /* JADX INFO: renamed from: com.luck.picture.lib.PictureBaseActivity$2 */
    class AnonymousClass2 extends PictureThreadUtils.SimpleTask<List<File>> {
        final /* synthetic */ List val$result;
        ...
        public void onSuccess(List<File> list) {
            PictureThreadUtils.cancel(PictureThreadUtils.getCachedPool());
            if (list == null || list.size() <= 0 || list.size() != list.size()) {
    ...
    /* JADX INFO: renamed from: com.luck.picture.lib.PictureBaseActivity$3 */
    ...
    /* JADX INFO: renamed from: com.luck.picture.lib.PictureBaseActivity$4 */
    class AnonymousClass4 extends PictureThreadUtils.SimpleTask<String> {
        final /* synthetic */ String val$mimeType;
        final /* synthetic */ UCrop.Options val$options;
        final /* synthetic */ String val$originalPath;

        AnonymousClass4(String str, String str2, UCrop.Options options) {
            str = str;
            str = str2;
            options = options;
        }
        ...
        public void onSuccess(String str) {
            PictureThreadUtils.cancel(PictureThreadUtils.getCachedPool());
            PictureBaseActivity.this.startSingleCropActivity(str, str, str, options);
        }
    }

    /* JADX INFO: renamed from: com.luck.picture.lib.PictureBaseActivity$5 */
    class AnonymousClass5 extends PictureThreadUtils.SimpleTask<List<CutInfo>> {
        final /* synthetic */ ArrayList val$list;
        final /* synthetic */ UCrop.Options val$options;
        final /* synthetic */ int val$size;

        AnonymousClass5(int i2, ArrayList arrayList, UCrop.Options options) {
            i = i2;
            arrayList = arrayList;
            options = options;
        }
        ...
        public List<CutInfo> doInBackground() {
            for (int i2 = 0; i2 < i; i2++) {
                CutInfo cutInfo = (CutInfo) arrayList.get(i2);
                String strOnCachePath = PictureSelectionConfig.cacheResourcesEngine.onCachePath(PictureBaseActivity.this.getContext(), cutInfo.getPath());
                if (!TextUtils.isEmpty(strOnCachePath)) {
                    cutInfo.setAndroidQToPath(strOnCachePath);
                }
            }
            return arrayList;
        }
        ...
        public void onSuccess(List<CutInfo> list) {
            PictureThreadUtils.cancel(PictureThreadUtils.getCachedPool());
            if (PictureBaseActivity.this.index < i) {
                PictureBaseActivity pictureBaseActivity = PictureBaseActivity.this;
                pictureBaseActivity.startMultipleCropActivity(list.get(pictureBaseActivity.index), options);
            }
        }
    }

    /* JADX INFO: renamed from: com.luck.picture.lib.PictureBaseActivity$6 */
    class AnonymousClass6 extends PictureThreadUtils.SimpleTask<List<LocalMedia>> {
    ...
    @Override // androidx.appcompat.app.AppCompatActivity, androidx.fragment.app.FragmentActivity, androidx.activity.ComponentActivity, androidx.core.app.ComponentActivity, android.app.Activity
    protected void onSaveInstanceState(@j.c.a.d Bundle bundle) {
    ...
    protected void startCrop(String str, String str2) {
        ...
        UCrop.Options optionsBasicOptions = basicOptions();
        if (PictureSelectionConfig.cacheResourcesEngine != null) {
            PictureThreadUtils.executeByCached(new PictureThreadUtils.SimpleTask<String>() { // from class: com.luck.picture.lib.PictureBaseActivity.4
                ...
                AnonymousClass4(String str3, String str22, UCrop.Options optionsBasicOptions2) {
                    str = str3;
                    str = str22;
                    options = optionsBasicOptions2;
                }
                ...
                public void onSuccess(String str3) {
                    PictureThreadUtils.cancel(PictureThreadUtils.getCachedPool());
                    PictureBaseActivity.this.startSingleCropActivity(str, str3, str, options);
                }
            });
        } else {
            startSingleCropActivity(str3, null, str22, optionsBasicOptions2);
        }
    }
    ...
    public void startOpenCameraAudio() {
        if (!PermissionChecker.checkSelfPermission(this, util.permissionutil.a.f15032i)) {
            PermissionChecker.requestPermissions(this, new String[]{util.permissionutil.a.f15032i}, 3);
            return;
        }
        Intent intent = new Intent("android.provider.MediaStore.RECORD_SOUND");
        if (intent.resolveActivity(getPackageManager()) != null) {
    ...
    protected void startCrop(ArrayList<CutInfo> arrayList) {
        if (arrayList != null && arrayList.size() != 0) {
            UCrop.Options optionsBasicOptions = basicOptions(arrayList);
            ...
            if (PictureSelectionConfig.cacheResourcesEngine != null) {
                PictureThreadUtils.executeByCached(new PictureThreadUtils.SimpleTask<List<CutInfo>>() { // from class: com.luck.picture.lib.PictureBaseActivity.5
                    ...
                    AnonymousClass5(int size2, ArrayList arrayList2, UCrop.Options optionsBasicOptions2) {
                        i = size2;
                    ...
                    public List<CutInfo> doInBackground() {
                        for (int i22 = 0; i22 < i; i22++) {
                            CutInfo cutInfo2 = (CutInfo) arrayList.get(i22);
            ...
            int i3 = this.index;
            if (i3 < size2) {
                startMultipleCropActivity(arrayList2.get(i3), optionsBasicOptions2);
                return;
            }
            return;
        }
