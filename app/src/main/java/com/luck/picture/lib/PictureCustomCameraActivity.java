...
public class PictureCustomCameraActivity extends PictureSelectorCameraEmptyActivity {
    ...
    /* JADX INFO: renamed from: com.luck.picture.lib.PictureCustomCameraActivity$1 */
    class AnonymousClass1 implements CameraListener {
        AnonymousClass1() {
        }
    ...
    protected void initView() {
        ...
        this.mCameraView.setCameraListener(new CameraListener() { // from class: com.luck.picture.lib.PictureCustomCameraActivity.1
            ...
            @Override // com.luck.picture.lib.camera.listener.CameraListener
            public void onError(int i22, @NonNull String str, @Nullable Throwable th) {
                ToastUtils.s(PictureCustomCameraActivity.this.getContext(), str);
                PictureCustomCameraActivity.this.a();
            }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        getWindow().setFlags(d.c.a.b.a.a.B1, d.c.a.b.a.a.B1);
        getWindow().setFlags(d.c.a.b.a.a.C1, d.c.a.b.a.a.C1);
        ...
        } else if (PermissionChecker.checkSelfPermission(this, util.permissionutil.a.f15032i)) {
            createCameraView();
        } else {
    ...
    protected void onResume() {
        ...
        if (this.isEnterSetting) {
            ...
            } else if (!PermissionChecker.checkSelfPermission(this, util.permissionutil.a.f15026c)) {
