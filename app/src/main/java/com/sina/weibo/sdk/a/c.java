...
public abstract class c<Params, Progress, Result> {
    ...
    final FutureTask<Result> N = new c<Params, Progress, Result>.AbstractC0108c(this.M) { // from class: com.sina.weibo.sdk.a.c.3
    ...
    abstract class AbstractC0108c extends FutureTask<Result> implements Comparable<Object> {
        int priority;

        public AbstractC0108c(d dVar) {
            super(dVar);
