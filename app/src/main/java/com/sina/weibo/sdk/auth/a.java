    ...
    public final void a(Activity activity) {
        ...
        try {
            ...
            if (c0109aE == null) {
                ...
                intent.setClassName(c0109aE.packageName, c0109aE.ag);
            }
            ...
            if (activity == null) {
                this.f5687d.onError(new UiError(-1, "activity is null", ""));
            } else if (!com.sina.weibo.sdk.b.a.a(activity, intent)) {
                this.f5687d.onError(new UiError(-2, "your app is illegal", ""));
            } else {
            ...
            this.f5687d.onError(new UiError(-3, "occur exception", e2.getMessage()));
        }
    }
