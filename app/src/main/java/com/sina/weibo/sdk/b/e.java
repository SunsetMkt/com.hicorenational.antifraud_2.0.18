...
public final class e {
    ...
    public static String o() {
        return Build.MANUFACTURER + Constants.ACCEPT_TIME_SEPARATOR_SERVER + Build.MODEL + d.c.a.b.a.a.s1 + Build.VERSION.RELEASE + d.c.a.b.a.a.s1 + "weibosdk" + d.c.a.b.a.a.s1 + "0041005000_android";
    }
    ...
    public static byte[] b(byte[] bArr) {
        ...
        while (i2 < bArr.length) {
            int i4 = (bArr[i2] & f1.f12066c) << 8;
            int i5 = i2 + 1;
            boolean z2 = true;
            if (i5 < bArr.length) {
                i4 |= bArr[i5] & f1.f12066c;
                z = true;
            } else {
                z = false;
            }
