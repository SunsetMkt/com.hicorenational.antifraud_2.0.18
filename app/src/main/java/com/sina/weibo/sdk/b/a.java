...
public final class a {
    ...
    public static boolean d(Context context) {
        C0109a c0109aE = e(context);
        return c0109aE != null && c0109aE.ah >= 10791;
    }
            ...
            if (context != null && (listQueryIntentServices = context.getPackageManager().queryIntentServices(intent, 0)) != null && !listQueryIntentServices.isEmpty()) {
                for (ResolveInfo resolveInfo : listQueryIntentServices) {
                    ...
                    if (serviceInfo != null && serviceInfo.applicationInfo != null && !TextUtils.isEmpty(resolveInfo.serviceInfo.packageName)) {
                        ...
                        if (TextUtils.equals(str, str2) && (c0109aA = a(context, str2)) != null) {
                            return c0109aA;
                        }
                    }
                }
    ...
    private static C0109a a(Context context, String str) {
        ...
        try {
            ...
            while (true) {
                ...
                if (i2 != -1) {
                    ...
                    c0109a.ah = jSONObject.optInt("support_api", -1);
                    c0109a.ag = jSONObject.optString("authActivityName", null);
                    c0109a.packageName = str;
                    return c0109a;
                }
            }
        } catch (PackageManager.NameNotFoundException e2) {
