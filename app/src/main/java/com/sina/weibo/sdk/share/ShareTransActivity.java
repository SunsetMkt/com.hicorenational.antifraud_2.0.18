...
public class ShareTransActivity extends BaseActivity {
    ...
    /* JADX INFO: renamed from: com.sina.weibo.sdk.share.ShareTransActivity$1 */
    ...
    /* JADX INFO: renamed from: com.sina.weibo.sdk.share.ShareTransActivity$2 */
    ...
    protected void onActivityResult(int i2, int i3, Intent intent) {
        ...
        if (handler != null) {
            ...
            this.x.sendMessageDelayed(messageObtain, 100L);
        }
    }
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.u.addView(viewInflate, layoutParams);
    ...
    public void a(WeiboMultiMessage weiboMultiMessage) {
        ...
        try {
            ...
            a.C0109a c0109aC = com.sina.weibo.sdk.b.a.c(this);
            if (c0109aC != null) {
                intent.setPackage(c0109aC.packageName);
            }
