...
public final class a implements IWBAPI {
    ...
    public final void authorizeCallback(Activity activity, int i2, int i3, Intent intent) {
        ...
        WbAuthListener wbAuthListener = aVar.f5687d;
        if (wbAuthListener != null) {
            if (32973 != i2) {
            ...
            if (intent != null) {
                ...
                if (!TextUtils.isEmpty(stringExtra) || !TextUtils.isEmpty(stringExtra2) || !TextUtils.isEmpty(stringExtra3)) {
                    if ("access_denied".equals(stringExtra) || "OAuthAccessDeniedException".equals(stringExtra)) {
                        aVar.f5687d.onCancel();
                        return;
                    } else {
                        aVar.f5687d.onError(new UiError(-5, stringExtra2, stringExtra3));
                        return;
                    }
                }
                Oauth2AccessToken accessToken = Oauth2AccessToken.parseAccessToken(intent.getExtras());
                if (accessToken == null) {
                    aVar.f5687d.onError(new UiError(-4, "oauth2AccessToken is null", "oauth2AccessToken is null"));
                } else {
                    AccessTokenHelper.writeAccessToken(activity, accessToken);
                    aVar.f5687d.onComplete(accessToken);
                }
            }
        }
    }
        ...
        if (activity != null) {
            if (com.sina.weibo.sdk.a.a(activity) || !z) {
                ...
                if (jCurrentTimeMillis - eVar.D >= com.heytap.mcssdk.constant.a.r) {
                    ...
                    a.C0109a c0109aE = com.sina.weibo.sdk.b.a.e(activity);
                    if (com.sina.weibo.sdk.a.a(activity) && c0109aE != null) {
                        a.C0109a c0109aE2 = com.sina.weibo.sdk.b.a.e(activity);
                        boolean z2 = false;
                        if (c0109aE2 != null && c0109aE2.ah > 10000) {
                            z2 = true;
                        }
                        if (z2) {
                            e.a(activity, weiboMultiMessage);
