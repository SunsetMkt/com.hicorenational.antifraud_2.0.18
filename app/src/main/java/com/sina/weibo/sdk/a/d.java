...
public final class d extends c<Void, Void, String> {
    ...
    public String l() {
        try {
            ...
            return new com.sina.weibo.sdk.net.b().a(aVar.a("oauth_timestamp", valueOf).a("oauth_sign", d(valueOf)).b("appKey", this.ad).b("oauth_timestamp", valueOf).b("oauth_sign", d(valueOf)).b(SocialConstants.PARAM_IMG_URL, this.ac).e()).f();
        } catch (Throwable th) {
            th.printStackTrace();
            this.ab = th;
            return null;
