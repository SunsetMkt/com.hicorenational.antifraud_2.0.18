...
public class SignInAccountInfo extends AbstractSignInAccountInfo {
    ...
    public void c(JSONObject jSONObject) throws JSONException {
        super.c(jSONObject);
        this.f4017k = jSONObject.optInt("accountFlag", 0);
    }
    ...
    public Account p() {
        if (TextUtils.isEmpty(this.f4062f)) {
            return null;
        }
        return new Account(this.f4062f, "com.hihonor");
    }
    ...
    public String toString() {
        return "{photoUriString: " + this.f4058b + ",accountFlag" + this.f4017k + '}';
    }
