...
public class b {
    public static String a(byte[] bArr) {
        ...
        for (byte b2 : bArr) {
            String hexString = Integer.toHexString(b2 & i.f1.f12066c);
    ...
    public static <TResult> a1<TResult> a(Callable<TResult> callable) {
        ExecutorService executorService = o0.f4270c.f4271b;
        n0 n0Var = new n0();
        try {
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:70:0x0050 -> B:71:0x0051). Please report as a decompilation issue!!! */
    /*
    ...
    */
    public static String a(Context context, String str) {
        ...
        String str2 = "getCertFingerprint pkgName=" + str + "isOnlyOne=true";
        ArrayList arrayList = new ArrayList();
        PackageManager packageManager = context.getPackageManager();
        if (Build.VERSION.SDK_INT >= 30) {
            PackageInfo packageInfo = packageManager.getPackageInfo(str, d.c.a.b.a.a.C1);
        ...
        if (signingCertificateHistory != null && signingCertificateHistory.length > 0) {
            ...
            while (true) {
                ...
                try {
                    byte[] bArrDigest = MessageDigest.getInstance("SHA256").digest(signingCertificateHistory[i2].toByteArray());
                    StringBuilder sb = new StringBuilder();
                    for (byte b2 : bArrDigest) {
                        String upperCase = Integer.toHexString(b2 & i.f1.f12066c).toUpperCase(Locale.ENGLISH);
