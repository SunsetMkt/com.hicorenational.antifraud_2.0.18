...
public class C0331r implements k0<List<HonorPushDataMsg>> {
    ...
    public C0331r(s sVar, HonorPushCallback honorPushCallback) {
        this.f6320b = sVar;
    ...
    public void a(a1<List<HonorPushDataMsg>> a1Var) {
        ...
        List<HonorPushDataMsg> c2 = a1Var.c();
        sVar.getClass();
        b1.a(new t(sVar, honorPushCallback, c2));
    }
}
