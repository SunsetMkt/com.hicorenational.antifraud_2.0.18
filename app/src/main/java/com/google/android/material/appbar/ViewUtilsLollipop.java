...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(@NonNull View view, float f2) {
    ...
    static void setStateListAnimatorFromAttrs(@NonNull View view, AttributeSet attributeSet, int i2, int i3) {
