...
class UtcDates {
    ...
    private static String removeYearFromDateFormatPattern(@NonNull String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, str2, -1, iFindCharactersInDateFormatPattern) + 1, iFindCharactersInDateFormatPattern2), a.f10074g).trim();
    }
