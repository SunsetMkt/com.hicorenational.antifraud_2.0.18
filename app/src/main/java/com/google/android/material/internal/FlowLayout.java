    ...
    protected void onMeasure(int i2, int i3) {
        ...
        for (int i11 = 0; i11 < getChildCount(); i11++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                int measuredWidth2 = i12 + i4 + i5 + childAt.getMeasuredWidth() + this.itemSpacing;
        ...
        setMeasuredDimension(getMeasuredDimension(size, mode, i10 + getPaddingRight()), getMeasuredDimension(size2, mode2, i8 + getPaddingBottom()));
    }
