...
public final class TabLayoutMediator {
    ...
    @Nullable
    private RecyclerView.Adapter<?> f3635adapter;
    ...
    public void attach() {
        ...
        this.f3635adapter = this.viewPager.getAdapter();
        if (this.f3635adapter == null) {
        ...
        if (this.autoRefresh) {
            ...
            this.f3635adapter.registerAdapterDataObserver(this.pagerAdapterObserver);
        }
    ...
    public void detach() {
        ...
        if (this.autoRefresh && (adapter2 = this.f3635adapter) != null) {
    ...
    void populateTabsFromPagerAdapter() {
        ...
        RecyclerView.Adapter<?> adapter2 = this.f3635adapter;
        if (adapter2 != null) {
