...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(@NonNull MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(SocializeProtocolConstants.WIDTH)) {
            arrayList.add(motionSpec.getAnimator(SocializeProtocolConstants.WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec.hasPropertyValues(SocializeProtocolConstants.HEIGHT)) {
            arrayList.add(motionSpec.getAnimator(SocializeProtocolConstants.HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
