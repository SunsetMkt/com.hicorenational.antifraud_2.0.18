...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    static class AnonymousClass3 extends Property<DrawableWithAnimatedVisibilityChange, Float> {
        AnonymousClass3(Class cls, String str) {
            super(cls, str);
        }
    ...
    void setGrowFraction(@FloatRange(from = 0.0d, to = 1.0d) float f2) {
    ...
    @VisibleForTesting
    void setMockHideAnimationRunning(boolean z, @FloatRange(from = 0.0d, to = 1.0d) float f2) {
        this.mockHideAnimationRunning = z;
        this.mockGrowFraction = f2;
    }

    @VisibleForTesting
    void setMockShowAnimationRunning(boolean z, @FloatRange(from = 0.0d, to = 1.0d) float f2) {
