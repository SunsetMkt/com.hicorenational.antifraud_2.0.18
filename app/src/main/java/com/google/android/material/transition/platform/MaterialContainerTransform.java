...
public final class MaterialContainerTransform extends Transition {
    ...
    private static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f2) {
            ...
            float f9 = fitModeResult.currentStartWidth;
            rectF.set(f8 - (f9 / 2.0f), f7, (f9 / 2.0f) + f8, fitModeResult.currentStartHeight + f7);
            RectF rectF2 = this.currentEndBounds;
            FitModeResult fitModeResult2 = this.fitModeResult;
            float f10 = fitModeResult2.currentEndWidth;
            rectF2.set(f8 - (f10 / 2.0f), f7, f8 + (f10 / 2.0f), fitModeResult2.currentEndHeight + f7);
            ...
            this.currentElevationDy = (int) (fCalculateElevationDyMultiplier * f11);
            this.shadowPaint.setShadowLayer(f11, (int) (fCalculateElevationDxMultiplier * f11), this.currentElevationDy, SHADOW_COLOR);
