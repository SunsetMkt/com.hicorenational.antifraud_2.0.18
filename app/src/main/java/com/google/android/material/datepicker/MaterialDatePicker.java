...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    class AnonymousClass3 extends OnSelectionChangedListener<S> {
        AnonymousClass3() {
        }
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.headerSelectionText = (TextView) viewInflate.findViewById(com.google.android.material.R.id.mtrl_picker_header_selection_text);
        ...
        TextView textView = (TextView) viewInflate.findViewById(com.google.android.material.R.id.mtrl_picker_title_text);
    ...
    public static final class Builder<S> {
        ...
        private Month createDefaultOpenAt() {
            long j2 = this.calendarConstraints.getStart().timeInMillis;
            long j3 = this.calendarConstraints.getEnd().timeInMillis;
            if (!this.dateSelector.getSelectedDays().isEmpty()) {
                long jLongValue = this.dateSelector.getSelectedDays().iterator().next().longValue();
                if (jLongValue >= j2 && jLongValue <= j3) {
                    return Month.create(jLongValue);
                }
            }
            long jThisMonthInUtcMilliseconds = MaterialDatePicker.thisMonthInUtcMilliseconds();
            if (j2 <= jThisMonthInUtcMilliseconds && jThisMonthInUtcMilliseconds <= j3) {
                j2 = jThisMonthInUtcMilliseconds;
            }
