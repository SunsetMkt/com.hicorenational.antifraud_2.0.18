...
abstract class DateFormatTextWatcher extends TextWatcherAdapter {
    ...
    private Runnable createRangeErrorCallback(final long j2) {
        return new Runnable() { // from class: com.google.android.material.datepicker.DateFormatTextWatcher.2
            @Override // java.lang.Runnable
            public void run() {
                DateFormatTextWatcher.this.textInputLayout.setError(String.format(DateFormatTextWatcher.this.outOfRange, DateStrings.getDateString(j2)));
                DateFormatTextWatcher.this.onInvalidDate();
            }
        };
    }
    ...
    abstract void onValidDate(@Nullable Long l2);
