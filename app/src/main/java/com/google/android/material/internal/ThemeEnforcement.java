...
public final class ThemeEnforcement {
    ...
    private static void checkTextAppearance(@NonNull Context context, AttributeSet attributeSet, @NonNull @StyleableRes int[] iArr, @AttrRes int i2, @StyleRes int i3, @Nullable @StyleableRes int... iArr2) {
        ...
        boolean zIsCustomTextAppearanceValid = (iArr2 == null || iArr2.length == 0) ? typedArrayObtainStyledAttributes.getResourceId(R.styleable.ThemeEnforcement_android_textAppearance, -1) != -1 : isCustomTextAppearanceValid(context, attributeSet, iArr, i2, i3, iArr2);
        typedArrayObtainStyledAttributes.recycle();
