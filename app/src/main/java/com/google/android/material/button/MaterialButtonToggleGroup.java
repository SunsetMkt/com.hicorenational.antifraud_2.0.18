...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    private class CheckedStateTracker implements MaterialButton.OnCheckedChangeListener {
        ...
        /* synthetic */ CheckedStateTracker(MaterialButtonToggleGroup materialButtonToggleGroup, AnonymousClass1 anonymousClass1) {
            this();
        }
    }
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.skipCheckedStateTracker = false;
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MaterialButtonToggleGroup, i2, DEF_STYLE_RES, new int[0]);
