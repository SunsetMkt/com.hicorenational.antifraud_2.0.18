...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    void setAncestorContentPadding(int i2, int i3, int i4, int i5) {
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, com.google.android.material.R.styleable.MaterialCardView, i2, DEF_STYLE_RES, new int[0]);
        this.cardViewHelper = new MaterialCardViewHelper(this, attributeSet, i2, DEF_STYLE_RES);
