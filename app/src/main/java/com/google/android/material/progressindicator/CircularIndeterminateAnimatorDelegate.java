...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate$1 */
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate$2 */
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate$3 */
    static class AnonymousClass3 extends Property<CircularIndeterminateAnimatorDelegate, Float> {
        AnonymousClass3(Class cls, String str) {
            super(cls, str);
        }
    ...
    /* JADX INFO: renamed from: com.google.android.material.progressindicator.CircularIndeterminateAnimatorDelegate$4 */
    static class AnonymousClass4 extends Property<CircularIndeterminateAnimatorDelegate, Float> {
        AnonymousClass4(Class cls, String str) {
            super(cls, str);
        }
    ...
    void setAnimationFraction(float f2) {
        ...
        int i2 = (int) (this.animationFraction * 5400.0f);
