...
public abstract class w implements x {
    ...
    public static final w LONG_OR_DOUBLE = new w("LONG_OR_DOUBLE", 2) { // from class: com.google.gson.w.c
        ...
        @Override // com.google.gson.x
        public Number readNumber(com.google.gson.e0.a aVar) throws IOException, n {
            String s = aVar.s();
            try {
                try {
                    ...
                    throw new com.google.gson.e0.e("JSON forbids NaN and infinities: " + valueOf + "; at path " + aVar.i());
                }
            } catch (NumberFormatException e2) {
                throw new n("Cannot parse " + s + "; at path " + aVar.i(), e2);
            }
        }
    };
