...
public abstract class w implements x {
    ...
    public static final w LONG_OR_DOUBLE = new w("LONG_OR_DOUBLE", 2) { // from class: com.google.gson.w.c
        ...
        @Override // com.google.gson.x
        public Number readNumber(com.google.gson.e0.a aVar) throws n, IOException {
            String strS = aVar.s();
            try {
                try {
    ...
    private static final /* synthetic */ w[] a = {DOUBLE, LAZILY_PARSED_NUMBER, LONG_OR_DOUBLE, BIG_DECIMAL};
