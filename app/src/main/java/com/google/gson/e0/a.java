...
public class a implements Closeable {
    ...
    */
    ...
    public double n() throws IOException {
        ...
        this.f5708h = 11;
        double parseDouble = Double.parseDouble(this.f5711k);
        if (!this.f5702b && (Double.isNaN(parseDouble) || Double.isInfinite(parseDouble))) {
            throw new e("JSON forbids NaN and infinities: " + parseDouble + l());
        }
        this.f5711k = null;
        this.f5708h = 0;
        int[] iArr2 = this.o;
    ...
    public int o() throws IOException {
        ...
        if (i2 == 16) {
            ...
            try {
                int parseInt = Integer.parseInt(this.f5711k);
                this.f5708h = 0;
                int[] iArr2 = this.o;
    ...
    public long p() throws IOException {
        ...
        if (i2 == 16) {
            ...
            try {
                long parseLong = Long.parseLong(this.f5711k);
                this.f5708h = 0;
                int[] iArr2 = this.o;
                int i4 = this.f5713m - 1;
                iArr2[i4] = iArr2[i4] + 1;
