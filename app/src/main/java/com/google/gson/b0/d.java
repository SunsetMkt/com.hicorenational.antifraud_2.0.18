...
public final class d implements z, Cloneable {
    ...
    class a<T> extends y<T> {
        ...
        private y<T> a() {
            ...
            y<T> a2 = this.f5515d.a(d.this, this.f5516e);
            this.f5512a = a2;
            return a2;
        }
    ...
    public d a(int... iArr) {
        ...
        m38clone.f5507b = 0;
        for (int i2 : iArr) {
            m38clone.f5507b = i2 | m38clone.f5507b;
        }
        return m38clone;
    }
    ...
    public d a(com.google.gson.a aVar, boolean z, boolean z2) {
        d m38clone = m38clone();
        if (z) {
            m38clone.f5510e = new ArrayList(this.f5510e);
            m38clone.f5510e.add(aVar);
        }
        if (z2) {
            m38clone.f5511f = new ArrayList(this.f5511f);
            m38clone.f5511f.add(aVar);
        }
        return m38clone;
    }
