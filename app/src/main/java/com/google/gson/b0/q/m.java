...
public final class m<T> extends l<T> {
    ...
    private y<T> b() {
        ...
        y<T> a2 = this.f5609c.a(this.f5611e, this.f5610d);
        this.f5614h = a2;
        return a2;
    }
    ...
    public T read2(com.google.gson.e0.a aVar) throws IOException {
        ...
        com.google.gson.k a2 = com.google.gson.b0.o.a(aVar);
        if (this.f5613g && a2.isJsonNull()) {
            return null;
        }
        return this.f5608b.a(a2, this.f5610d.getType(), this.f5612f);
    }
