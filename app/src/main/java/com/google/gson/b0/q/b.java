...
public final class b implements z {
    ...
    private static final class a<E> extends y<Collection<E>> {
        ...
        public Collection<E> read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            Collection<E> a2 = this.f5557b.a();
            aVar.c();
            while (aVar.j()) {
                a2.add(this.f5556a.read2(aVar));
            }
            aVar.f();
            return a2;
        }
    ...
    public <T> y<T> create(com.google.gson.e eVar, com.google.gson.d0.a<T> aVar) {
        ...
        Type a2 = com.google.gson.b0.b.a(type, (Class<?>) rawType);
        return new a(eVar, a2, eVar.a((com.google.gson.d0.a) com.google.gson.d0.a.get(a2)), this.f5555a.a(aVar));
    }
}
