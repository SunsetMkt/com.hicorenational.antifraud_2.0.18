...
public final class i<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    e<K, V> find(K k2, boolean z) {
        ...
        if (eVar2 != null) {
            ...
            while (true) {
                i2 = comparable != null ? comparable.compareTo(eVar2.f5535f) : comparator.compare(k2, eVar2.f5535f);
                if (i2 == 0) {
                    return eVar2;
                }
                e<K, V> eVar3 = i2 < 0 ? eVar2.f5531b : eVar2.f5532c;
                if (eVar3 == null) {
                    break;
                }
                eVar2 = eVar3;
    ...
    e<K, V> findByEntry(Map.Entry<?, ?> entry) {
        ...
        if (findByObject != null && a(findByObject.f5537h, entry.getValue())) {
            return findByObject;
        }
        return null;
    }
    ...
    public V remove(Object obj) {
        ...
        if (removeInternalByKey != null) {
            return removeInternalByKey.f5537h;
        }
        return null;
    }
    ...
    void removeInternal(e<K, V> eVar, boolean z) {
        ...
        e<K, V> b2 = eVar3.f5538i > eVar4.f5538i ? eVar3.b() : eVar4.a();
