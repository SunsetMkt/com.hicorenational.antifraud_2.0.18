...
public final class g extends com.google.gson.e0.d {
    ...
    private final List<com.google.gson.k> f3687m;
    ...
    public g() {
        super(p);
        this.f3687m = new ArrayList();
        this.o = com.google.gson.m.a;
    }

    private void a(com.google.gson.k kVar) {
        if (this.f3688n != null) {
            if (!kVar.isJsonNull() || g()) {
                ((JsonObject) peek()).add(this.f3688n, kVar);
            }
            this.f3688n = null;
            return;
        }
    ...
    public com.google.gson.k k() {
        ...
        throw new IllegalStateException("Expected one JSON element but was " + this.f3687m);
    }
