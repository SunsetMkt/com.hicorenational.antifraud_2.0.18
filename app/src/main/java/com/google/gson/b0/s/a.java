...
public class a {
    ...
    private static class d extends b {
        ...
        private final Method f3761b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final Method f3762c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        private final Method f3763d;

        @Override // com.google.gson.b0.s.a.b
        public <T> Constructor<T> a(Class<T> cls) {
            try {
                Object[] objArr = (Object[]) this.f3761b.invoke(cls, new Object[0]);
                Class<?>[] clsArr = new Class[objArr.length];
                for (int i2 = 0; i2 < objArr.length; i2++) {
                    clsArr[i2] = (Class) this.f3763d.invoke(objArr[i2], new Object[0]);
                }
        ...
        String[] b(Class<?> cls) {
            try {
                ...
                for (int i2 = 0; i2 < objArr.length; i2++) {
                    strArr[i2] = (String) this.f3762c.invoke(objArr[i2], new Object[0]);
                }
                return strArr;
            } catch (ReflectiveOperationException e2) {
                throw a.b(e2);
        ...
        private d() throws NoSuchMethodException {
            ...
            this.f3761b = Class.class.getMethod("getRecordComponents", new Class[0]);
            Class<?> componentType = this.f3761b.getReturnType().getComponentType();
            this.f3762c = componentType.getMethod("getName", new Class[0]);
            this.f3763d = componentType.getMethod("getType", new Class[0]);
        }
    ...
    public static void a(AccessibleObject accessibleObject) throws l {
        try {
