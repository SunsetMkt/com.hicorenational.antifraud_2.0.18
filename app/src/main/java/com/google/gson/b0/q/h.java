...
public final class h implements z {
    ...
    private final class a<K, V> extends y<Map<K, V>> {
        ...
        /* JADX INFO: renamed from: b */
        private final y<V> f3690b;

        /* JADX INFO: renamed from: c */
        private final com.google.gson.b0.k<? extends Map<K, V>> f3691c;
        ...
        public a(com.google.gson.e eVar, Type type, y<K> yVar, Type type2, y<V> yVar2, com.google.gson.b0.k<? extends Map<K, V>> kVar) {
            ...
            this.f3690b = new n(eVar, yVar2, type2);
            this.f3691c = kVar;
        }
        ...
        public void write(com.google.gson.e0.d dVar, Map<K, V> map) throws IOException {
            ...
            if (!h.this.f3689b) {
                ...
                for (Map.Entry<K, V> entry : map.entrySet()) {
                    ...
                    this.f3690b.write(dVar, entry.getValue());
                }
                dVar.f();
                return;
            }
            ...
            if (!z) {
                ...
                while (i2 < size) {
                    ...
                    this.f3690b.write(dVar, (V) arrayList2.get(i2));
                    i2++;
                }
                dVar.f();
                return;
        ...
        @Override // com.google.gson.y
        public Map<K, V> read(com.google.gson.e0.a aVar) throws IOException {
            com.google.gson.e0.c cVarPeek = aVar.peek();
            if (cVarPeek == com.google.gson.e0.c.NULL) {
                aVar.r();
                return null;
            }
            Map<K, V> mapA = this.f3691c.a();
            if (cVarPeek == com.google.gson.e0.c.BEGIN_ARRAY) {
                aVar.c();
                while (aVar.j()) {
                    aVar.c();
                    K k2 = this.a.read(aVar);
                    if (mapA.put(k2, this.f3690b.read(aVar)) != null) {
                ...
                aVar.d();
                while (aVar.j()) {
                    com.google.gson.b0.g.a.a(aVar);
                    K k3 = this.a.read(aVar);
                    if (mapA.put(k3, this.f3690b.read(aVar)) != null) {
    ...
    private y<?> a(com.google.gson.e eVar, Type type) {
        return (type == Boolean.TYPE || type == Boolean.class) ? o.f3735f : eVar.a((com.google.gson.d0.a) com.google.gson.d0.a.get(type));
    }
    ...
    public <T> y<T> create(com.google.gson.e eVar, com.google.gson.d0.a<T> aVar) {
        ...
        return new a(eVar, typeArrB[0], a(eVar, typeArrB[0]), typeArrB[1], eVar.a((com.google.gson.d0.a) com.google.gson.d0.a.get(typeArrB[1])), this.a.a(aVar));
    }
}
