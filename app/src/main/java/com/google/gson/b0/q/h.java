...
public final class h implements z {
    ...
    private final class a<K, V> extends y<Map<K, V>> {
        ...
        public Map<K, V> read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            Map<K, V> a2 = this.f5572c.a();
            if (peek == com.google.gson.e0.c.BEGIN_ARRAY) {
                aVar.c();
                while (aVar.j()) {
                    aVar.c();
                    K read2 = this.f5570a.read2(aVar);
                    if (a2.put(read2, this.f5571b.read2(aVar)) != null) {
                ...
                while (aVar.j()) {
                    ...
                    K read22 = this.f5570a.read2(aVar);
                    if (a2.put(read22, this.f5571b.read2(aVar)) != null) {
    ...
    public <T> y<T> create(com.google.gson.e eVar, com.google.gson.d0.a<T> aVar) {
        ...
        Type[] b2 = com.google.gson.b0.b.b(type, rawType);
        return new a(eVar, b2[0], a(eVar, b2[0]), b2[1], eVar.a((com.google.gson.d0.a) com.google.gson.d0.a.get(b2[1])), this.f5568a.a(aVar));
    }
}
