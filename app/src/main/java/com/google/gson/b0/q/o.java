...
public final class o {
    ...
    class c0 extends com.google.gson.y<Boolean> {
        ...
        public Boolean read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            if (peek != com.google.gson.e0.c.NULL) {
                return peek == com.google.gson.e0.c.STRING ? Boolean.valueOf(Boolean.parseBoolean(aVar.s())) : Boolean.valueOf(aVar.m());
            }
            aVar.r();
            return null;
        }
    ...
    class e extends com.google.gson.y<Character> {
        ...
        public Character read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            throw new com.google.gson.t("Expecting character, got: " + s + "; at " + aVar.i());
        }
    }
    ...
    class e0 extends com.google.gson.y<Number> {
        ...
        public Number read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            try {
                ...
                throw new com.google.gson.t("Lossy conversion from " + o + " to byte; at path " + aVar.i());
            } catch (NumberFormatException e2) {
                throw new com.google.gson.t(e2);
            }
        }
    ...
    class f extends com.google.gson.y<String> {
        ...
        public String read2(com.google.gson.e0.a aVar) throws IOException {
            com.google.gson.e0.c peek = aVar.peek();
            if (peek != com.google.gson.e0.c.NULL) {
                return peek == com.google.gson.e0.c.BOOLEAN ? Boolean.toString(aVar.m()) : aVar.s();
            }
            aVar.r();
            return null;
        }
    ...
    class f0 extends com.google.gson.y<Number> {
        ...
        public Number read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            try {
                ...
                throw new com.google.gson.t("Lossy conversion from " + o + " to short; at path " + aVar.i());
            } catch (NumberFormatException e2) {
                throw new com.google.gson.t(e2);
            }
        }
    ...
    class g extends com.google.gson.y<BigDecimal> {
        ...
        public BigDecimal read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            try {
                ...
                throw new com.google.gson.t("Failed parsing '" + s + "' as BigDecimal; at path " + aVar.i(), e2);
            }
        }
    }
    ...
    class h extends com.google.gson.y<BigInteger> {
        ...
        public BigInteger read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            try {
                ...
                throw new com.google.gson.t("Failed parsing '" + s + "' as BigInteger; at path " + aVar.i(), e2);
            }
        }
    }
    ...
    private static final class j0<T extends Enum<T>> extends com.google.gson.y<T> {
                ...
                for (Field field : (Field[]) AccessController.doPrivileged(new a(cls))) {
                    ...
                    if (cVar != null) {
                        ...
                        for (String str2 : cVar.alternate()) {
                            this.f5642a.put(str2, r4);
                        }
                    }
                    this.f5642a.put(name, r4);
                    this.f5643b.put(str, r4);
                    this.f5644c.put(r4, name);
                }
        ...
        public T read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            String s = aVar.s();
            T t = this.f5642a.get(s);
            return t == null ? this.f5643b.get(s) : t;
        }
    }
    ...
    class m extends com.google.gson.y<URL> {
        ...
        public URL read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            String s = aVar.s();
            if (c.c.a.b.a.a.f3101h.equals(s)) {
                return null;
            }
            return new URL(s);
        }
    ...
    class p extends com.google.gson.y<UUID> {
        ...
        public UUID read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            try {
                ...
                throw new com.google.gson.t("Failed parsing '" + s + "' as UUID; at path " + aVar.i(), e2);
            }
        }
    }
    ...
    class q extends com.google.gson.y<Currency> {
        ...
        public Currency read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            try {
                ...
                throw new com.google.gson.t("Failed parsing '" + s + "' as Currency; at path " + aVar.i(), e2);
            }
        }
    }
    ...
    class r extends com.google.gson.y<Calendar> {
        ...
        @Override // com.google.gson.y
        /* renamed from: read, reason: avoid collision after fix types in other method */
        public Calendar read2(com.google.gson.e0.a aVar) throws IOException {
            if (aVar.peek() == com.google.gson.e0.c.NULL) {
                aVar.r();
                return null;
            }
            ...
            while (aVar.peek() != com.google.gson.e0.c.END_OBJECT) {
                ...
                if (f5647a.equals(q)) {
                    i2 = o;
                } else if (f5648b.equals(q)) {
                    i3 = o;
                } else if (f5649c.equals(q)) {
                    i4 = o;
                } else if (f5650d.equals(q)) {
                    i5 = o;
                } else if (f5651e.equals(q)) {
                    i6 = o;
                } else if (f5652f.equals(q)) {
                    i7 = o;
                }
            }
            aVar.g();
    ...
    class t extends com.google.gson.y<com.google.gson.k> {
        ...
        public com.google.gson.k read2(com.google.gson.e0.a aVar) throws IOException {
            ...
            com.google.gson.e0.c peek = aVar.peek();
            com.google.gson.k b2 = b(aVar, peek);
            if (b2 == null) {
                return a(aVar, peek);
            }
            ...
            while (true) {
                if (aVar.j()) {
                    String q = b2 instanceof JsonObject ? aVar.q() : null;
                    com.google.gson.e0.c peek2 = aVar.peek();
                    com.google.gson.k b3 = b(aVar, peek2);
                    boolean z = b3 != null;
                    if (b3 == null) {
                        b3 = a(aVar, peek2);
                    }
                    if (b2 instanceof com.google.gson.h) {
                        ((com.google.gson.h) b2).a(b3);
                    } else {
                        ((JsonObject) b2).add(q, b3);
                    }
                    if (z) {
                    ...
                    b2 = (com.google.gson.k) arrayDeque.removeLast();
                }
            }
        }
    ...
    class v extends com.google.gson.y<BitSet> {
        ...
        @Override // com.google.gson.y
        /* renamed from: read, reason: avoid collision after fix types in other method */
        public BitSet read2(com.google.gson.e0.a aVar) throws IOException {
            boolean z;
            BitSet bitSet = new BitSet();
            aVar.c();
            com.google.gson.e0.c peek = aVar.peek();
            int i2 = 0;
            while (peek != com.google.gson.e0.c.END_ARRAY) {
                int i3 = b0.f5641a[peek.ordinal()];
                if (i3 == 1 || i3 == 2) {
                    int o = aVar.o();
                    if (o == 0) {
                        z = false;
                        ...
                        if (o != 1) {
                            throw new com.google.gson.t("Invalid bitset value " + o + ", expected 0 or 1; at path " + aVar.i());
                        }
                        z = true;
                    }
                } else {
                    if (i3 != 3) {
                        throw new com.google.gson.t("Invalid bitset value type: " + peek + "; at path " + aVar.h());
                    }
                    z = aVar.m();
                }
                if (z) {
