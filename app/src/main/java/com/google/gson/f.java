...
public final class f {
    ...
    private void a(String str, int i2, int i3, List<z> list) {
        ...
        if (str != null && !str.trim().isEmpty()) {
            z a4 = d.b.f5563b.a(str);
            if (z) {
                zVar = com.google.gson.b0.t.d.f5678c.a(str);
                a3 = com.google.gson.b0.t.d.f5677b.a(str);
                a2 = a4;
            } else {
                a2 = a4;
                a3 = null;
            ...
            a2 = d.b.f5563b.a(i2, i3);
            if (z) {
                zVar = com.google.gson.b0.t.d.f5678c.a(i2, i3);
                a3 = com.google.gson.b0.t.d.f5677b.a(i2, i3);
            }
            a3 = null;
        }
        list.add(a2);
