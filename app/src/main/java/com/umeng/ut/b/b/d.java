...
public class d {
    ...
    private long f8436d = -1;

    /* JADX INFO: renamed from: b */
    private static Pattern f8434b = Pattern.compile("[^0-9a-zA-Z=/+]+");
    ...
    private boolean b(String str) {
        ...
        if (24 == str.length()) {
            return !f8434b.matcher(str).find();
        }
        return false;
    }
    ...
    private synchronized String j() {
        boolean z = m45c() || !com.umeng.ut.a.c.a.a(this.f65a);
        if (z) {
            this.f8435c = l();
            if (!com.umeng.ut.b.a.a.d.isEmpty(this.f8435c) && b(this.f8435c)) {
                return this.f8435c;
            }
            this.f8435c = k();
            if (!com.umeng.ut.b.a.a.d.isEmpty(this.f8435c) && b(this.f8435c)) {
        ...
        try {
            byte[] bArrA = a();
            if (bArrA != null) {
                this.f8435c = com.umeng.ut.b.a.a.a.a(bArrA, 2);
                a(this.f8435c, true);
                if (!z) {
                    e();
                }
    ...
    public boolean b() {
        try {
            ...
            if (this.f8436d == -1) {
                this.f8436d = sharedPreferencesA.getLong("v_ts", 0L);
            }
            long jCurrentTimeMillis = System.currentTimeMillis();
            if (Math.abs(jCurrentTimeMillis - this.f8436d) >= c()) {
                this.f8436d = jCurrentTimeMillis;
                sharedPreferencesA.edit().putLong("v_ts", jCurrentTimeMillis).commit();
                com.umeng.ut.a.c.e.m42a("UTUtdid", "req valid");
                return true;
            }
        } catch (Throwable unused) {
        }
    ...
    private byte[] a() throws Exception {
        String strF;
        com.umeng.ut.a.c.e.m42a("UTUtdid", "generate UTDid");
