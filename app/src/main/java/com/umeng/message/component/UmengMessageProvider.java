...
public class UmengMessageProvider extends ContentProvider {
    ...
    private volatile a f7886b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private volatile b f7887c;
        ...
        try {
            ...
            if (iMatch != 2) {
                ...
                if (strArr != null && strArr.length != 0) {
                    SharedPreferences.Editor editorEdit = apVarA.a.edit();
                    int i2 = 0;
                    for (String str2 : strArr) {
                        if (apVarA.a.contains(str2)) {
    ...
    public boolean onCreate() {
        try {
            ...
            this.a.addURI(uriA.getAuthority(), uriA.getPath(), 3);
            Uri uriB = h.b(context);
            this.a.addURI(uriB.getAuthority(), uriB.getPath(), 4);
            Uri uriD = h.d(context);
            this.a.addURI(uriD.getAuthority(), uriD.getPath(), 5);
            Uri uriE = h.e(context);
            this.a.addURI(uriE.getAuthority(), uriE.getPath(), 10);
            Uri uriC = h.c(context);
            this.a.addURI(uriC.getAuthority(), uriC.getPath(), 2);
            return true;
        } catch (Throwable th) {
            UPLog.e("MessageProvider", th);
            return true;
