...
public class UmengMessageProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        ...
        try {
            int match = this.f11143a.match(uri);
            if (match != 2) {
                if (match == 3) {
                ...
                if (strArr != null && strArr.length != 0) {
                    SharedPreferences.Editor edit = a2.f11297a.edit();
                    int i2 = 0;
                    for (String str2 : strArr) {
                        if (a2.f11297a.contains(str2)) {
                            edit.remove(str2);
                            i2++;
                        }
                    }
    ...
    public boolean onCreate() {
        try {
            ...
            x.a(context);
            Uri a2 = h.a(context);
            this.f11143a.addURI(a2.getAuthority(), a2.getPath(), 3);
            Uri b2 = h.b(context);
            this.f11143a.addURI(b2.getAuthority(), b2.getPath(), 4);
            Uri d2 = h.d(context);
            this.f11143a.addURI(d2.getAuthority(), d2.getPath(), 5);
            Uri e2 = h.e(context);
            this.f11143a.addURI(e2.getAuthority(), e2.getPath(), 10);
            Uri c2 = h.c(context);
            this.f11143a.addURI(c2.getAuthority(), c2.getPath(), 2);
            return true;
        } catch (Throwable th) {
            UPLog.e("MessageProvider", th);
            return true;
