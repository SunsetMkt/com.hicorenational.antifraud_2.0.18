...
public class UInAppMessage {
    ...
    public UInAppMessage(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject2.has("image")) {
            ...
            this.width = jSONObject4.getInt(SocializeProtocolConstants.WIDTH);
            this.height = jSONObject4.getInt(SocializeProtocolConstants.HEIGHT);
        ...
        if (jSONObject2.has("bottom_image")) {
            ...
            this.bottom_width = jSONObject5.getInt(SocializeProtocolConstants.WIDTH);
            this.bottom_height = jSONObject5.getInt(SocializeProtocolConstants.HEIGHT);
