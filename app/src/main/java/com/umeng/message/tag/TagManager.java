            ...
            public final void run() {
                ...
                try {
                    if (strArr != null && strArr.length != 0) {
                        ...
                        Set<String> b2 = MessageSharedPrefs.getInstance(a2).f11128b.b(SocializeProtocolConstants.TAGS, new HashSet());
                        ...
                        if (arrayList.size() > MessageSharedPrefs.getInstance(a2).d()) {
                        ...
                        try {
                            JSONObject d2 = TagManager.d();
                            d2.put(SocializeProtocolConstants.TAGS, av.a(arrayList));
                            result = TagManager.this.f11487a.addTags(d2, strArr);
                            z = true;
                        } catch (Exception e2) {
                            UPLog.e("TagManager", e2);
                        }
            ...
            public final void run() {
                ...
                try {
                    ...
                    try {
                        ...
                        d2.put(SocializeProtocolConstants.TAGS, strArr3 == null ? "" : av.a(Arrays.asList(strArr3)));
                        result = TagManager.this.f11487a.deleteTags(d2, strArr);
                        z = true;
                    } catch (Exception e2) {
                        UPLog.e("TagManager", e2);
                    }
