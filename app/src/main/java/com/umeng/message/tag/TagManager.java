...
public class TagManager {
    ...
    private static volatile TagManager f8128b;
    private final ITagManager a = new ar();
    ...
    static /* synthetic */ boolean b() {
        boolean z = MessageSharedPrefs.getInstance(x.a()).f7878b.b("tag_send_policy", -1) == 1;
        if (z) {
            ...
            public final void run() {
                ...
                try {
                    if (strArr != null && strArr.length != 0) {
                        ...
                        Set<String> setB = MessageSharedPrefs.getInstance(applicationA).f7878b.b(SocializeProtocolConstants.TAGS, new HashSet());
                        ...
                        try {
                            ...
                            result = TagManager.this.a.addTags(jSONObjectD, strArr);
                            z = true;
                        } catch (Exception e2) {
                            UPLog.e("TagManager", e2);
                        }
            ...
            public final void run() {
                ...
                try {
                    ...
                    try {
                        ...
                        result = TagManager.this.a.deleteTags(jSONObjectD, strArr);
                        z = true;
                    } catch (Exception e2) {
                        UPLog.e("TagManager", e2);
                    }
        ...
        b.b(new Runnable() { // from class: com.umeng.message.tag.TagManager.3
            ...
            public final void run() {
                ...
                try {
                    ...
                    try {
                        List<String> tags = TagManager.this.a.getTags(TagManager.d());
