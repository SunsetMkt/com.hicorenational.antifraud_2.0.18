...
public final class UmengCardMessage extends DialogFragment {
    ...
    private static final String f7909b = UmengCardMessage.class.getName();
    ...
    private UInAppMessage f7911d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private String f7912e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private Bitmap f7913f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private ViewGroup f7914g;
    ...
    private UInAppHandler f7919l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private boolean f7920m = false;
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.f7914g != null) {
            ...
            this.f7914g.setLayoutParams(layoutParams);
        }
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            this.f7910c = getActivity();
            Bundle arguments = getArguments();
            this.f7911d = new UInAppMessage(new JSONObject(arguments.getString("msg")));
            this.f7912e = arguments.getString("label");
            byte[] byteArray = arguments.getByteArray("bitmapByte");
            if (byteArray != null) {
                this.f7913f = BitmapFactory.decodeByteArray(byteArray, 0, byteArray.length);
            }
            this.f7919l = InAppMessageManager.getInstance(this.f7910c).getInAppHandler();
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        int i2 = this.f7911d.msg_type;
        if (i2 == 5 || i2 == 6) {
            String strA = InAppMessageManager.getInstance(this.f7910c).a("KEY_PLAIN_TEXT_SIZE", "");
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (window != null) {
            ...
            this.f7916i = rect.height() - bb.a(65.0f);
            this.f7915h = (int) (((double) this.f7916i) * 1.2d);
            this.f7917j = rect.width() - bb.a(70.0f);
            this.f7918k = (this.f7917j / 2) * 3;
        } else {
            rect = null;
        }
        int i2 = this.f7911d.msg_type;
        if (i2 == 2 || i2 == 3) {
            RelativeLayout relativeLayout = new RelativeLayout(this.f7910c);
            relativeLayout.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
            relativeLayout.setBackgroundColor(Color.parseColor("#33000000"));
            RelativeLayout.LayoutParams layoutParams = getResources().getConfiguration().orientation == 1 ? new RelativeLayout.LayoutParams(-1, -2) : this.f7911d.msg_type == 2 ? new RelativeLayout.LayoutParams(this.f7915h, this.f7916i) : new RelativeLayout.LayoutParams(-2, -1);
            int iA = bb.a(30.0f);
            int iA2 = bb.a(15.0f);
            layoutParams.setMargins(iA, iA2, iA, iA2);
            layoutParams.addRule(13);
            this.f7914g = new FrameLayout(this.f7910c);
            this.f7914g.setLayoutParams(layoutParams);
            FrameLayout.LayoutParams layoutParams2 = new FrameLayout.LayoutParams(-1, -1);
            int iA3 = bb.a(12.0f);
            layoutParams2.setMargins(iA3, iA3, iA3, iA3);
            ImageView imageView = new ImageView(this.f7910c);
            imageView.setLayoutParams(layoutParams2);
            imageView.setAdjustViewBounds(true);
            imageView.setId(f.a());
            imageView.setImageBitmap(this.f7913f);
            this.f7914g.addView(imageView);
            int iA4 = bb.a(24.0f);
            FrameLayout.LayoutParams layoutParams3 = new FrameLayout.LayoutParams(iA4, iA4, 5);
            bd bdVar = new bd(this.f7910c);
            bdVar.setLayoutParams(layoutParams3);
            this.f7914g.addView(bdVar);
            relativeLayout.addView(this.f7914g);
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.umeng.message.inapp.UmengCardMessage.1
                ...
                public final void onClick(View view) {
                    ...
                    if (TextUtils.equals("none", UmengCardMessage.this.f7911d.action_type)) {
                        return;
                    }
                    UmengCardMessage.this.f7919l.handleInAppMessage(UmengCardMessage.this.f7910c, UmengCardMessage.this.f7911d, 16);
        ...
        if (i2 == 4) {
            View viewInflate = layoutInflater.inflate(a.a(a.a().a, "umeng_custom_card_message"), viewGroup, false);
            ...
            imageView2.setImageBitmap(this.f7913f);
            ...
            button.setOnClickListener(new View.OnClickListener() { // from class: com.umeng.message.inapp.UmengCardMessage.5
                ...
                public final void onClick(View view) {
                    ...
                    UmengCardMessage.this.f7919l.handleInAppMessage(UmengCardMessage.this.f7910c, UmengCardMessage.this.f7911d, 19);
                    UmengCardMessage.this.dismiss();
                }
            });
        ...
        RelativeLayout relativeLayout2 = new RelativeLayout(this.f7910c);
        relativeLayout2.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        relativeLayout2.setBackgroundColor(Color.parseColor("#33000000"));
        if (getResources().getConfiguration().orientation == 1) {
            this.f7917j = rect.width() - bb.a(70.0f);
            if (this.f7911d.msg_type == 5) {
                this.f7918k = (this.f7917j / 6) * 5;
            } else {
                this.f7918k = (this.f7917j / 2) * 3;
            }
        } else {
            this.f7918k = rect.height() - bb.a(65.0f);
            this.f7917j = (this.f7918k / 5) * 6;
        }
        RelativeLayout.LayoutParams layoutParams4 = new RelativeLayout.LayoutParams(this.f7917j, this.f7918k);
        layoutParams4.addRule(13);
        LinearLayout linearLayout = new LinearLayout(this.f7910c);
        ...
        TextView textView = new TextView(this.f7910c);
        textView.setLayoutParams(layoutParams5);
        textView.setGravity(17);
        textView.setText(this.f7911d.title);
        ...
        ScrollView scrollView = new ScrollView(this.f7910c);
        scrollView.setLayoutParams(layoutParams6);
        scrollView.setScrollBarStyle(16777216);
        scrollView.setVerticalScrollBarEnabled(false);
        TextView textView2 = new TextView(this.f7910c);
        textView2.setLayoutParams(new LinearLayout.LayoutParams(-1, -2));
        textView2.setText(this.f7911d.content);
        ...
        TextView textView3 = new TextView(this.f7910c);
        textView3.setLayoutParams(layoutParams7);
        textView3.setGravity(17);
        textView3.setBackgroundColor(Color.parseColor("#FFFFFF"));
        textView3.setText(this.f7911d.button_text);
        ...
        textView3.setOnClickListener(new View.OnClickListener() { // from class: com.umeng.message.inapp.UmengCardMessage.3
            ...
            public final void onClick(View view) {
                UmengCardMessage.a(UmengCardMessage.this);
                UmengCardMessage.this.f7919l.handleInAppMessage(UmengCardMessage.this.f7910c, UmengCardMessage.this.f7911d, 18);
                UmengCardMessage.this.dismiss();
            }
        });
    ...
    public final void onDestroy() {
        super.onDestroy();
        ai aiVarA = ai.a(this.f7910c);
        UInAppMessage uInAppMessage = this.f7911d;
        aiVarA.a(uInAppMessage.msg_id, uInAppMessage.msg_type, 0, this.f7921n ? 1 : 0, 0, 0, this.p ? 1 : 0, 0, this.o ? 1 : 0);
        this.p = false;
        this.f7921n = false;
        this.o = false;
        this.f7920m = false;
