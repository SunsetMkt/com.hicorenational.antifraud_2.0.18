...
public final class UmengCardMessage extends DialogFragment {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (i2 == 5 || i2 == 6) {
            String a2 = InAppMessageManager.getInstance(this.f11174c).a("KEY_PLAIN_TEXT_SIZE", "");
            String[] split = !TextUtils.isEmpty(a2) ? a2.split(com.xiaomi.mipush.sdk.Constants.ACCEPT_TIME_SEPARATOR_SP) : null;
            if (split != null) {
                this.q = split;
            }
        }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (i2 == 4) {
            View inflate = layoutInflater.inflate(a.a(a.a().f11216a, "umeng_custom_card_message"), viewGroup, false);
            ImageView imageView2 = (ImageView) inflate.findViewById(a.a("umeng_card_message_image"));
            Button button = (Button) inflate.findViewById(a.a("umeng_card_message_ok"));
            Button button2 = (Button) inflate.findViewById(a.a("umeng_card_message_close"));
        ...
        layoutParams7.setMargins(a6, bb.a(30.0f), a6, a6);
    ...
    public final void onDestroy() {
        super.onDestroy();
        ai a2 = ai.a(this.f11174c);
        UInAppMessage uInAppMessage = this.f11175d;
        a2.a(uInAppMessage.msg_id, uInAppMessage.msg_type, 0, this.n ? 1 : 0, 0, 0, this.p ? 1 : 0, 0, this.o ? 1 : 0);
        this.p = false;
        this.n = false;
        this.o = false;
        this.f11184m = false;
    ...
    public final void onStart() {
        ...
        if (!this.f11184m) {
            ai a2 = ai.a(this.f11174c);
            UInAppMessage uInAppMessage = this.f11175d;
            a2.a(uInAppMessage.msg_id, uInAppMessage.msg_type, 1, 0, 0, 0, 0, 0, 0);
        }
        this.f11184m = true;
    }
}
