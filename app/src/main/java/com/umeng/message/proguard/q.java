...
public abstract class q extends Service {
    ...
    static class a implements Runnable {
        ...
        public final void run() {
            while (true) {
                try {
                    e dequeueWork = this.f11405a.dequeueWork();
                    if (dequeueWork != null) {
                        this.f11405a.onHandleWork(dequeueWork.a());
                        dequeueWork.b();
                    }
                } catch (Throwable th) {
                    UPLog.e(q.TAG, th);
    ...
    static final class f extends JobServiceEngine implements b {
        ...
        public final e b() {
            try {
                synchronized (this.f11415b) {
                    ...
                    JobWorkItem dequeueWork = this.f11416c.dequeueWork();
                    if (dequeueWork == null) {
                        return null;
                    }
                    dequeueWork.getIntent().setExtrasClassLoader(this.f11414a.getClassLoader());
        ...
        public final boolean onStopJob(JobParameters jobParameters) {
            boolean doStopCurrentWork = this.f11414a.doStopCurrentWork();
            synchronized (this.f11415b) {
                this.f11416c = null;
            }
