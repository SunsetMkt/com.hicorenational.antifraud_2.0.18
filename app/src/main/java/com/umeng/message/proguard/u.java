...
public final class u implements UPushApi {
    ...
    public final String getMessageChannel() {
        ...
        String b2 = MessageSharedPrefs.getInstance(a2).f11128b.b("channel", "");
    ...
    public final String getMessageSecret() {
        Application a2 = x.a();
        String b2 = MessageSharedPrefs.getInstance(a2).f11128b.b("message_secret", "");
    ...
    public final String getNotificationChannelName() {
        String b2 = MessageSharedPrefs.getInstance(x.a()).f11128b.b("notification_channel_default", "");
    ...
    public final String getNotificationSilenceChannelName() {
        String b2 = MessageSharedPrefs.getInstance(x.a()).f11128b.b("notification_channel_silence", "");
        ...
        try {
            ...
            if (!TextUtils.isEmpty(messageAppkey) && !TextUtils.isEmpty(messageSecret)) {
                ...
                b.c(new Runnable() { // from class: com.umeng.message.proguard.u.3
                    ...
                    public final void run() {
                        try {
                            TaobaoRegister.register(a2, AccsClientConfig.DEFAULT_CONFIGTAG, "umeng:" + messageAppkey, messageSecret, "android@umeng", new IRegister() { // from class: com.umeng.message.proguard.u.3.1
                                ...
                                public final void onFailure(String str, String str2) {
                                    ...
                                    intent.putExtra("code", str);
                                    intent.putExtra(SocialConstants.PARAM_APP_DESC, str2);
                                    q.enqueueWork(a4, UmengMessageHandlerService.class, intent);
    ...
    public final void setMuteDurationSeconds(int i2) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("mute_duration", i2);
        }
    }
    ...
    public final void setNotificationChannelName(String str) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("notification_channel_default", str);
        }
    }
    ...
    public final void setNotificationOnForeground(boolean z) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("notification_foreground_show", z);
        }
    }
    ...
    public final void setNotificationPlayLights(int i2) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("notification_light", i2);
        }
    }
    ...
    public final void setNotificationPlaySound(int i2) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("notification_sound", i2);
        }
    }
    ...
    public final void setNotificationPlayVibrate(int i2) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("notification_vibrate", i2);
        }
    }
    ...
    public final void setNotificationSilenceChannelName(String str) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("notification_channel_silence", str);
        }
    }
    ...
    public final void setResourcePackageName(String str) {
        Application a2 = x.a();
        if (f.b(a2)) {
            MessageSharedPrefs.getInstance(a2).f11128b.a("res_pkg", str);
        }
    }
