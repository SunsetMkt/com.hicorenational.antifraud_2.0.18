...
public final class o implements ALog.ILog, ALog.ILog {
    ...
    public final void e(String str, String str2, Throwable th) {
        if (th instanceof SocketTimeoutException) {
            UPLog.i(str, str2 + d.c.a.b.a.a.f10074g + th.getMessage());
            return;
        }
        UPLog.d(str, str2, UPLog.getStackTrace(th));
        UPLog.e(str, str2 + d.c.a.b.a.a.f10074g + th.getMessage());
    }

    @Override // anet.channel.util.ALog.ILog
    public final void w(String str, String str2, Throwable th) {
        UPLog.d(str, str2, UPLog.getStackTrace(th));
        UPLog.w(str, str2 + d.c.a.b.a.a.f10074g + th.getMessage());
    }
}
