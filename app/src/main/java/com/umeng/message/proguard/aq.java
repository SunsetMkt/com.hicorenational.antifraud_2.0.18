...
public final class aq {
    ...
    /* JADX WARN: Removed duplicated region for block: B:75:0x0046 A[EXC_TOP_SPLITTER, PHI: r0 r10
  0x0046: PHI (r0v1 android.database.Cursor) = (r0v0 android.database.Cursor), (r0v2 android.database.Cursor) binds: [B:63:0x0052, B:56:0x0044] A[DONT_GENERATE, DONT_INLINE]
  0x0046: PHI (r10v1 java.lang.String) = (r10v0 java.lang.String), (r10v3 java.lang.String) binds: [B:63:0x0052, B:56:0x0044] A[DONT_GENERATE, DONT_INLINE], SYNTHETIC] */
    /*
    ...
    */
    private static String c(String str, String str2) {
        ...
        try {
            ...
            if (f.b(applicationA)) {
                return ap.a().a.getString(str, str2);
            }
    ...
    public final boolean b(String str, boolean z) {
        String strC = c(b(str), String.valueOf(z));
        if (!TextUtils.isEmpty(strC)) {
            try {
