...
public final class d {
    ...
    public static String c(Context context) {
        ...
        try {
            ...
            try {
                ...
                return (messageAppkey == null || messageAppkey.length() < 16) ? str : ax.a(str, messageAppkey.substring(0, 16), as.a("bm1ldWcuZjkvT20rTDgyMw=="));
            } catch (Exception e2) {
                e = e2;
    ...
    public static boolean h() {
        ...
        if (k2.startsWith("OriginOS") || k2.startsWith("Funtouch")) {
            f11345f = Boolean.TRUE;
            return true;
        }
        f11345f = Boolean.FALSE;
