...
public final class i {
    ...
    private static volatile boolean f8041b = true;
    ...
    static class a extends BroadcastReceiver {
        ...
        public final void onReceive(final Context context, final Intent intent) {
            if (!i.f8041b || intent == null || intent.getData() == null) {
                return;
            }
    ...
    static class b extends BroadcastReceiver {
        private final BroadcastReceiver a = new EventReceiver();
        ...
        public final void onReceive(final Context context, final Intent intent) {
            ...
            com.umeng.message.proguard.b.c(new Runnable() { // from class: com.umeng.message.proguard.i.b.1
                ...
                public final void run() {
                    try {
                        b.this.a.onReceive(context, intent);
                    } catch (Throwable th) {
                        UPLog.e("RH", th);
                    }
                }
