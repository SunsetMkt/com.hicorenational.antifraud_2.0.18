...
public final class aw {
    ...
    private static int f8013b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Handler f8014c = new Handler(Looper.getMainLooper()) { // from class: com.umeng.message.proguard.aw.4
            ...
            if (2 == i2) {
                ...
                b.c(new Runnable() { // from class: com.umeng.message.proguard.aw.4.1
                    ...
                    public final void run() {
                        String type;
                        if (aw.a == null || aw.a.booleanValue()) {
                            try {
                                ComponentName componentNameA = aw.a(context);
                                if (componentNameA == null) {
                                    Boolean unused = aw.a = Boolean.FALSE;
                                    return;
                                }
                                ...
                                if (type == null) {
                                    Boolean unused3 = aw.a = Boolean.FALSE;
                                    return;
                                }
                                ...
                                Boolean unused4 = aw.a = Boolean.TRUE;
                            } catch (Throwable unused5) {
                                Boolean unused6 = aw.a = Boolean.FALSE;
                            }
                        }
                    }
                });
    ...
    public static void b(Context context, int i2) {
        ...
        if (bool == null || bool.booleanValue()) {
            ...
            if ("huawei".equalsIgnoreCase(str) || "honor".equalsIgnoreCase(str)) {
                Message messageObtainMessage = f8014c.obtainMessage(1);
                messageObtainMessage.arg1 = i2;
                messageObtainMessage.obj = context;
                f8014c.sendMessage(messageObtainMessage);
            }
        }
    }
                    ...
                    public final void run() {
                        if (aw.a == null || aw.a.booleanValue()) {
                            try {
                                ...
                                Boolean unused = aw.a = Boolean.TRUE;
                            } catch (Throwable unused2) {
                                Boolean unused3 = aw.a = Boolean.FALSE;
                            }
                        }
                    ...
                    public final void run() {
                        if (aw.a == null || aw.a.booleanValue()) {
                            try {
                                ...
                                intent.putExtra(Constants.KEY_PACKAGE_NAME, componentNameA.getPackageName());
                                ...
                                Boolean unused2 = aw.a = Boolean.TRUE;
                            } catch (Throwable unused3) {
                                Boolean unused4 = aw.a = Boolean.FALSE;
                            }
                        }
                    }
                });
                    ...
                    public final void run() {
                        ...
                        if (aw.a == null || aw.a.booleanValue()) {
                            try {
                                ...
                                if (type == null) {
                                    Boolean unused2 = aw.a = Boolean.FALSE;
                                    return;
                                }
                                ComponentName componentNameA = aw.a(context);
                                if (componentNameA == null) {
