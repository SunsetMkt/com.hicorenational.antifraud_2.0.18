        ...
        try {
            synchronized (f11288b) {
                ...
                if (notification != null) {
                    ...
                    messageSharedPrefs.f11128b.a("re_pop_times", String.format(Locale.getDefault(), "%d.%d.%d", Integer.valueOf(calendar.get(1)), Integer.valueOf(calendar.get(6)), Integer.valueOf(o + 1)));
