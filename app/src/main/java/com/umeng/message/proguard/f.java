...
public final class f {
    ...
    public static void c() {
        try {
            Method a2 = ba.a(UMConfigure.class.getName(), "registerActionInfo", (Class<?>[]) new Class[]{Class.forName("com.umeng.ccg.ActionInfo")});
            if (a2 != null) {
                ba.a(a2, (Object) null, new Object[]{ba.a(r.class.getName(), (Class<?>[]) null, (Object[]) null)});
            }
        } catch (Throwable unused) {
        }
    }
