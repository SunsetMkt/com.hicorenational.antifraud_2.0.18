        ...
        b.c(new Runnable() { // from class: com.umeng.message.proguard.ai.4
            ...
            public final void run() {
                try {
                    ...
                    while (it.hasNext()) {
                        ae next = it.next();
                        JSONObject b2 = ai.b(next.f11227b, next.f11228c, next.f11229d, next.f11230e, next.f11231f, next.f11232g, next.f11233h, next.f11234i, next.f11235j);
        ...
        if (f.b()) {
            ...
            b.c(new Runnable() { // from class: com.umeng.message.proguard.ai.1
                ...
                public final void run() {
                    ...
                    try {
                        JSONObject a2 = g.a(ai.a(), "https://msg.umengcloud.com/admsg/v3/launch", UMUtils.getAppkey(x.a()), true);
                        if (TextUtils.equals(a2.getString("success"), ITagManager.SUCCESS)) {
                            UMLog.mutlInfo("UmengInAppMessageTracker", 2, "get splash message success".concat(String.valueOf(a2)));
                        ...
                        String a3 = InAppMessageManager.getInstance(ai.this.f11255a).a();
            ...
            b.c(new Runnable() { // from class: com.umeng.message.proguard.ai.2
                ...
                public final void run() {
                    ...
                    try {
                        JSONObject a2 = ai.a();
                        a2.put("label", str);
                        JSONObject a3 = g.a(a2, "https://msg.umengcloud.com/admsg/v3/getmsg", UMUtils.getAppkey(x.a()), true);
                        if (TextUtils.equals(a3.getString("success"), ITagManager.SUCCESS)) {
                            UMLog.mutlInfo("UmengInAppMessageTracker", 2, "get card message success".concat(String.valueOf(a3)));
                            JSONObject jSONObject = a3.getJSONObject("data");
                            InAppMessageManager.f11150d = jSONObject.getInt("pduration") * 1000;
                            InAppMessageManager.f11151e = jSONObject.getInt("sduration") * 1000;
                            adVar.b(new UInAppMessage(jSONObject.getJSONObject("card")));
                            InAppMessageManager inAppMessageManager = InAppMessageManager.getInstance(ai.this.f11255a);
                            String concat = "KEY_CARD_TS_".concat(String.valueOf(a2.optString("label", "")));
                            StringBuilder sb = new StringBuilder();
                            sb.append(System.currentTimeMillis());
                        ...
                        String a4 = InAppMessageManager.getInstance(ai.this.f11255a).a(str);
            ...
            public final void run() {
                try {
                    ...
                    b.c(new Runnable() { // from class: com.umeng.message.inapp.InAppMessageManager.1
                        ...
                        public final void run() {
                            try {
                                ae a2 = InAppMessageManager.a(InAppMessageManager.this, r2);
                                if (a2 != null) {
                                    InAppMessageManager.this.f11153b.getContentResolver().update(h.e(InAppMessageManager.this.f11153b), new ae(r2, r3, a2.f11229d + r4, a2.f11230e + r5, a2.f11231f + r6, a2.f11232g + r7, a2.f11233h + r8, a2.f11234i + r9, a2.f11235j).a(), "MsgId=?", new String[]{r2});
                                } else {
                                    InAppMessageManager.this.f11153b.getContentResolver().insert(h.e(InAppMessageManager.this.f11153b), new ae(r2, r3, r4, r5, r6, r7, r8, r9, r10).a());
                                }
