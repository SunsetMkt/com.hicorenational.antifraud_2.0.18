...
final class m implements Runnable {
    ...
    public final void run() {
        if (f.a) {
            ...
            if (messageSharedPrefs.f7879c == null) {
                try {
                    if (f.b(messageSharedPrefs.a)) {
                        messageSharedPrefs.f7878b.a(com.umeng.socialize.a.a.f8166d, messageSharedPrefs.m() + 1);
                    }
                } finally {
                    messageSharedPrefs.f7879c = Boolean.TRUE;
                }
            }
            if (messageSharedPrefs.m() >= messageSharedPrefs.f7878b.b(com.umeng.socialize.a.a.f8168f, 0) && messageSharedPrefs.a(com.umeng.socialize.a.a.f8167e)) {
                try {
                    ...
                    long jB = messageSharedPrefs.f7878b.b("smart_ts", 0L);
                    if (jB > 0) {
                    ...
                    if (jSONObjectA == null) {
                        messageSharedPrefs.a(com.umeng.socialize.a.a.f8167e, 7200L);
                        return;
                    }
                    ...
                    messageSharedPrefs.f7878b.a(com.umeng.socialize.a.a.f8168f, iOptInt);
                    if (messageSharedPrefs.m() < iOptInt) {
                        return;
                    }
                    messageSharedPrefs.a(com.umeng.socialize.a.a.f8167e, jSONObjectOptJSONObject.optLong(RemoteMessageConst.TTL, 86400L));
                                ...
                                try {
                                    ...
                                    while (it3.hasNext()) {
                                        ...
                                        if (objA6 != null) {
                                            ...
                                            jSONObject3.put(bh.ay, lVar.f8050b);
                                            jSONObject3.put(bh.aA, lVar.a);
                                            jSONObject3.put("v", lVar.f8051c);
                                            jSONObject3.put("t", lVar.f8054f);
                                            jSONObject3.put(bh.aF, lVar.f8052d);
                                            jSONObject3.put(bh.aK, lVar.f8053e);
                                    ...
                                    for (JSONArray jSONArray2 : arrayList) {
                                        ...
                                        try {
                                            g.b(jSONObject4, com.umeng.socialize.a.a.f8164b, appkey);
                                        } catch (Exception e2) {
                                            throw e2;
                                        }
                                    }
