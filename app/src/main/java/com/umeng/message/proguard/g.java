...
public final class g {
    ...
    /* JADX INFO: renamed from: com.umeng.message.proguard.g$1 */
            ...
            try {
                ...
                if (httpURLConnection instanceof HttpsURLConnection) {
                    ((HttpsURLConnection) httpURLConnection).setHostnameVerifier(new HostnameVerifier() { // from class: com.umeng.message.proguard.g.1
                        ...
                        AnonymousClass1(HttpURLConnection httpURLConnection2) {
                            httpURLConnection = httpURLConnection2;
                        }
                ...
                JSONObject jSONObject2 = new JSONObject(a(string, httpURLConnection2, str2));
                if (UPLog.isEnable()) {
                    UPLog.d("Net", "req:", url, "\n", jSONObject, "\nresp:\n", jSONObject2, "\nconsume:", Long.valueOf(SystemClock.elapsedRealtime() - jElapsedRealtime));
                }
                return jSONObject2;
    ...
    /* JADX WARN: Removed duplicated region for block: B:120:0x01b3 A[EXC_TOP_SPLITTER, SYNTHETIC] */
    /*
    ...
    public static JSONObject a(JSONObject jSONObject, String str, String str2, File file) throws Exception {
        ...
        try {
            ...
            try {
                ...
                outputStream.write("Content-Disposition: form-data; name=\"msg\"".getBytes());
                outputStream.write(bytes3);
                outputStream.write(bytes3);
                outputStream.write(as.b(bArrA));
                outputStream.write(bytes3);
                outputStream.write(bytes2);
                outputStream.write("----WebKitFormBoundary7MA4YWxkTrZu0gW".getBytes());
                outputStream.write(bytes3);
                outputStream.write(("Content-Disposition: form-data; name=\"file\"; filename=\"" + file.getName() + "\"").getBytes());
                outputStream.write(bytes3);
