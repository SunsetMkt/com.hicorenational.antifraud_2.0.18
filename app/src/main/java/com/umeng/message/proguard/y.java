...
public final class y extends UTrack {
    ...
    public static volatile boolean f11461a;

    /* renamed from: d, reason: collision with root package name */
    private final aa f11464d = new z();

    /* renamed from: e, reason: collision with root package name */
    private long f11465e;

    /* renamed from: c, reason: collision with root package name */
    private static final y f11463c = new y();
    ...
    public static boolean c() {
        ...
        Application a2 = x.a();
        if (TextUtils.isEmpty(MessageSharedPrefs.getInstance(a2).k())) {
            return true;
        }
    ...
    static /* synthetic */ JSONObject d() throws JSONException {
        String k2 = MessageSharedPrefs.getInstance(x.a()).k();
        String o = d.o(x.a());
        JSONObject jSONObject = new JSONObject();
        jSONObject.put("header", e.a());
        jSONObject.put("utdid", o);
        jSONObject.put(RemoteMessageConst.DEVICE_TOKEN, k2);
        return jSONObject;
    }
            ...
            public final void run() {
                ...
                try {
                    ...
                    if (z) {
                        d2.put("alias", str);
                        d2.put("type", str2);
                        d2.put("last_alias", messageSharedPrefs.a(0, str2));
                    ...
                    y.this.f11464d.a(str, str2, d2, uPushAliasCallback);
                } catch (Throwable th) {
                    UPLog.e("Track", th);
        ...
        b.b(new Runnable() { // from class: com.umeng.message.proguard.y.6
            ...
            public final void run() {
                ...
                try {
                    ...
                    y.this.f11464d.c(str, str2, d2, uPushAliasCallback);
                } catch (Throwable th2) {
                    UPLog.e("Track", th2);
            ...
            public final void run() {
                ...
                try {
                    ...
                    if (z) {
                        d2.put("alias", str);
                        d2.put("type", str2);
                        d2.put("last_alias", messageSharedPrefs.a(1, str2));
                        d2.put("ts", System.currentTimeMillis());
                    } else if (z2) {
                        d2.put("success", str4);
                    } else {
                    ...
                    y.this.f11464d.b(str, str2, d2, uPushAliasCallback);
                } catch (Throwable th2) {
                    UPLog.e("Track", th2);
                    if (th2.getMessage() == null) {
    ...
    public final void trackMsgRepost(UMessage uMessage, Notification notification) {
        ...
        try {
            ...
            this.f11464d.a(uMessage.getMsgId(), str, i2);
        } catch (Throwable th) {
            UPLog.e("Track", th);
        }
    }
    ...
    public final void trackMsgShow(UMessage uMessage, Notification notification) {
        ...
        try {
            ...
            this.f11464d.a(uMessage.getMsgId(), i2, str);
        } catch (Throwable th) {
    ...
    final synchronized void b() {
        ...
        try {
            ...
            if (Math.abs(currentTimeMillis - this.f11465e) >= 30000) {
                this.f11465e = currentTimeMillis;
                if (f.b(a2)) {
                    ao a3 = ao.a(a2);
                    Cursor query = a3.f11292a.getContentResolver().query(h.d(a3.f11292a), null, null, null, "Time Asc ");
                    if (query == null) {
                        arrayList = null;
                    } else {
                        ArrayList arrayList2 = new ArrayList();
                        for (boolean moveToFirst = query.moveToFirst(); moveToFirst; moveToFirst = query.moveToNext()) {
                            arrayList2.add(new ao.a(query));
                        }
                        query.close();
                    ...
                    if (arrayList != null && !arrayList.isEmpty()) {
                        ...
                        for (int i2 = 0; i2 < arrayList.size(); i2++) {
                            ...
                            JSONObject jSONObject = new JSONObject();
                            jSONObject.put("ts", aVar.f11294b);
                            jSONObject.put("pa", "");
                            jSONObject.put(RemoteMessageConst.DEVICE_TOKEN, MessageSharedPrefs.getInstance(a2).k());
                            jSONObject.put("msg_id", aVar.f11293a);
                            jSONObject.put("action_type", aVar.f11295c);
        ...
        b.a(new Runnable() { // from class: com.umeng.message.proguard.y.2
            ...
            public final void run() {
                try {
                    MessageSharedPrefs messageSharedPrefs = MessageSharedPrefs.getInstance(x.a());
                    if (messageSharedPrefs.f11128b.b("launch_send_policy", -1) == 1) {
