...
public final class y extends UTrack {
    ...
    private final aa f8112d = new z();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private long f8113e;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final y f8111c = new y();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static boolean f8110b = false;
        ...
        b.b(new Runnable() { // from class: com.umeng.message.proguard.y.4
            ...
            public final void run() {
                ...
                try {
                    ...
                    y.this.f8112d.a(str, str2, jSONObjectD, uPushAliasCallback);
                } catch (Throwable th) {
                    UPLog.e("Track", th);
        ...
        b.b(new Runnable() { // from class: com.umeng.message.proguard.y.6
            ...
            public final void run() {
                ...
                try {
                    ...
                    y.this.f8112d.c(str, str2, jSONObjectD, uPushAliasCallback);
                } catch (Throwable th2) {
                    UPLog.e("Track", th2);
        ...
        b.b(new Runnable() { // from class: com.umeng.message.proguard.y.5
            ...
            public final void run() {
                ...
                try {
                    ...
                    y.this.f8112d.b(str, str2, jSONObjectD, uPushAliasCallback);
                } catch (Throwable th2) {
                    UPLog.e("Track", th2);
                    if (th2.getMessage() == null) {
    ...
    public final void trackMsgRepost(UMessage uMessage, Notification notification) {
        ...
        int i2 = acVarA.f7946d;
        String channelId = null;
        try {
            if (Build.VERSION.SDK_INT >= 26 && notification != null) {
                channelId = notification.getChannelId();
            }
            this.f8112d.a(uMessage.getMsgId(), channelId, i2);
        } catch (Throwable th) {
            UPLog.e("Track", th);
        }
    }
    ...
    public final void trackMsgShow(UMessage uMessage, Notification notification) {
        ...
        try {
            ...
            this.f8112d.a(uMessage.getMsgId(), i2, channelId);
        } catch (Throwable th) {
    ...
    final synchronized void b() {
        ...
        try {
            ...
            if (Math.abs(jCurrentTimeMillis - this.f8113e) >= 30000) {
                this.f8113e = jCurrentTimeMillis;
                if (f.b(applicationA)) {
                    ao aoVarA = ao.a(applicationA);
                    Cursor cursorQuery = aoVarA.a.getContentResolver().query(h.d(aoVarA.a), null, null, null, "Time Asc ");
                    if (cursorQuery == null) {
                        arrayList = null;
                    } else {
        ...
        b.a(new Runnable() { // from class: com.umeng.message.proguard.y.2
            ...
            public final void run() {
                try {
                    MessageSharedPrefs messageSharedPrefs = MessageSharedPrefs.getInstance(x.a());
                    if (messageSharedPrefs.f7878b.b("launch_send_policy", -1) == 1) {
