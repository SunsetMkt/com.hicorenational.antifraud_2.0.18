...
public final class v implements UMLogDataProtocol {
    private static final UMLogDataProtocol a = new v();
            ...
            switch (i2) {
                case 16385:
                    ...
                    if (jSONObjectOptJSONObject == null || (jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray("push")) == null || jSONArrayOptJSONArray.length() <= 0) {
                        ...
                        iOptInt = jSONObject3.optInt("action_type");
                    ...
                    if (jSONObjectOptJSONObject2 != null && jSONObjectOptJSONObject != null && (jSONObjectBuildEnvelopeWithExtHeader = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA, jSONObjectOptJSONObject2, jSONObjectOptJSONObject, "umpx_push_logs", bh.aA, MsgConstant.SDK_VERSION)) != null && !jSONObjectBuildEnvelopeWithExtHeader.has("exception") && iOptInt != 70 && iOptInt != 71) {
                        try {
                ...
                case InputDeviceCompat.SOURCE_STYLUS /* 16386 */:
                    ...
                    if (jSONObjectOptJSONObject3 != null && jSONObjectOptJSONObject4 != null && (jSONObjectBuildEnvelopeWithExtHeader2 = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA2, jSONObjectOptJSONObject3, jSONObjectOptJSONObject4, "umpx_push_launch", bh.aA, MsgConstant.SDK_VERSION)) != null && !jSONObjectBuildEnvelopeWithExtHeader2.has("exception")) {
                        MessageSharedPrefs messageSharedPrefs = MessageSharedPrefs.getInstance(applicationA2);
                        messageSharedPrefs.f7878b.a(com.umeng.analytics.pro.d.p, System.currentTimeMillis());
                        try {
                            int i3 = Integer.parseInt(UMEnvelopeBuild.imprintProperty(applicationA2, "launch_policy", "-1"));
                            UPLog.i("LogDataProtocol", "launch policy:", Integer.valueOf(i3));
                            if (i3 > 0) {
                                messageSharedPrefs.f7878b.a("launch_send_policy", i3);
                            }
                            break;
                        } catch (Throwable unused) {
                        }
                        try {
                            int i4 = Integer.parseInt(UMEnvelopeBuild.imprintProperty(applicationA2, "tag_policy", "-1"));
                            UPLog.i("LogDataProtocol", "tag policy:", Integer.valueOf(i4));
                            if (i4 > 0) {
                                messageSharedPrefs.f7878b.a("tag_send_policy", i4);
                            }
                            break;
                ...
                case 16388:
                    ...
                    if (jSONObjectOptJSONObject7 != null && jSONObjectOptJSONObject8 != null) {
                        jSONObjectOptJSONObject7.put(bh.aO, MsgConstant.SDK_VERSION);
                        ...
                        if (jSONArrayOptJSONArray2 != null && jSONArrayOptJSONArray2.length() > 0 && (iOptInt2 = (jSONObject = (JSONObject) jSONArrayOptJSONArray2.get(0)).optInt("action_type")) == 0) {
                            ((aj) PushAgent.getInstance(applicationA4).getMessageNotifyApi()).a(jSONObject);
                        }
                        JSONObject jSONObjectBuildEnvelopeWithExtHeader6 = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA4, jSONObjectOptJSONObject7, jSONObjectOptJSONObject8, strOptString, bh.aA, MsgConstant.SDK_VERSION);
                        if (jSONObjectBuildEnvelopeWithExtHeader6 != null && !jSONObjectBuildEnvelopeWithExtHeader6.has("exception") && iOptInt2 != 6 && iOptInt2 != 7) {
                ...
                case 16389:
                    ...
                    if (jSONObjectOptJSONObject9 != null && jSONObjectOptJSONObject10 != null && (jSONObjectBuildEnvelopeWithExtHeader4 = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA5, jSONObjectOptJSONObject9, jSONObjectOptJSONObject10, "umpx_push_logs", bh.aA, MsgConstant.SDK_VERSION)) != null && !jSONObjectBuildEnvelopeWithExtHeader4.has("exception")) {
                        y.a();
                ...
                case 16390:
                    ...
                    JSONObject jSONObjectBuildEnvelopeWithExtHeader7 = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA6, jSONObject9, jSONObject10, "umpx_push_logs", bh.aA, MsgConstant.SDK_VERSION);
                ...
                case 16392:
                    ...
                    if (jSONObjectOptJSONObject12 != null && jSONObjectOptJSONObject11 != null && (jSONObjectBuildEnvelopeWithExtHeader5 = UMEnvelopeBuild.buildEnvelopeWithExtHeader(applicationA7, jSONObjectOptJSONObject12, jSONObjectOptJSONObject11, "umpx_push_logs", bh.aA, MsgConstant.SDK_VERSION)) != null) {
