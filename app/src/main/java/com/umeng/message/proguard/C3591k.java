...
public final class C3591k {
    /* renamed from: a */
    private static void m12419a(final Context context, final String str) {
        new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: com.umeng.message.proguard.k.1
            @Override // java.lang.Runnable
            public final void run() {
                UPLog.m12144e("SelfCheck", str);
    ...
    /* renamed from: a */
    public static boolean m12420a(Context context) {
        Class<?> cls;
        boolean z;
        boolean z2;
        boolean z3;
        ...
        if (cls == null) {
            UPLog.m12144e("SelfCheck", "--->>> common sdk版本不匹配，请确认！<<<--- ");
        } else {
            try {
        ...
        if (TextUtils.isEmpty(PushAgent.getInstance(context).getMessageAppkey())) {
            m12419a(context, "please set umeng appkey!");
            return false;
        }
        if (TextUtils.isEmpty(PushAgent.getInstance(context).getMessageSecret())) {
            m12419a(context, "please set umeng message secret!");
            return false;
        }
        ...
        while (true) {
            ...
            if (it.next().serviceInfo.name.equals(C3042j.channelService)) {
                z = true;
                break;
            }
        }
        if (!z) {
            m12419a(context, "please check ChannelService in AndroidManifest!");
            return false;
        }
        ...
        while (true) {
            ...
            if (it2.next().serviceInfo.name.equals(C3042j.channelService)) {
                z2 = true;
                break;
            }
        }
        ...
        while (true) {
            ...
            if (it3.next().serviceInfo.name.equals(C3042j.msgService)) {
                z3 = true;
                break;
            }
        }
        if (!z3) {
            m12419a(context, "please check MsgDistributeService in AndroidManifest!");
            return false;
        }
        ...
        if (!z4) {
            m12419a(context, "Please check AgooService in AndroidManifest!");
            return false;
        }
        ...
        if (!z5) {
            m12419a(context, "Please check UmengIntentService in AndroidManifest!");
            return false;
        }
        ...
        if (!z6) {
            m12419a(context, "please check UmengNotificationReceiver in AndroidManifest!");
            return false;
        }
        ...
        if (!z7) {
            m12419a(context, "please check UmengMessageHandlerService in AndroidManifest!");
            return false;
        }
        ...
        if (!z8) {
            m12419a(context, "please check UmengMessageReceiverService in AndroidManifest!");
            return false;
        }
        ...
        if (!(z10 && z11 && z9)) {
            m12419a(context, "please add required permission in AndroidManifest!");
            return false;
        }
        return true;
    }
