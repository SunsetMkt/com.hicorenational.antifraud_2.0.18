...
public class af extends AsyncTask<String, Void, Bitmap[]> {
                ...
                if (new File(this.f11238c, sb.toString()).exists()) {
                    ...
                    if (bitmapArr[i2] == null) {
                        ...
                        if (this.f11239d == null) {
                            ...
                            decodeStream = BitmapFactory.decodeStream(inputStream, null, this.f11239d);
                        }
                        inputStream.close();
                        ...
                        if (bitmap != null) {
                            try {
                                ...
                                try {
                                    ...
                                    e.printStackTrace();
                                    z2 = z;
                                    UMLog.mutlInfo(f11236b, 2, "store bitmap".concat(String.valueOf(z2)));
                                }
                            } catch (Exception e3) {
                                e = e3;
                                z = false;
    ...
    private Bitmap a(String str) {
        ...
        try {
            StringBuilder sb = new StringBuilder();
            sb.append(str.hashCode());
            bitmap = BitmapFactory.decodeFile(this.f11238c + sb.toString());
