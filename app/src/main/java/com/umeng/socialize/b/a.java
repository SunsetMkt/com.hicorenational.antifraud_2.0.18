...
public final class a {
    ...
    private static final String f8191b = "umeng_share_platform";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f8192c = "share_action";
    private SHARE_MEDIA a;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final Map<SHARE_MEDIA, UMSSOHandler> f8193d = new HashMap();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final List<Pair<SHARE_MEDIA, String>> f8194e = new ArrayList();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private final C0144a f8195f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private Context f8196g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private final SparseArray<UMAuthListener> f8197h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private final SparseArray<UMShareListener> f8198i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private final SparseArray<UMAuthListener> f8199j;

    public a(Context context) {
        List<Pair<SHARE_MEDIA, String>> list = this.f8194e;
        ...
        this.f8195f = new C0144a(this.f8193d);
        this.f8197h = new SparseArray<>();
        this.f8198i = new SparseArray<>();
        this.f8199j = new SparseArray<>();
        this.f8196g = context;
        b();
    }
    ...
    public synchronized UMShareListener e(int i2) {
        ...
        uMShareListener = this.f8198i.get(i2, null);
        if (uMShareListener != null) {
            this.f8198i.remove(i2);
        }
        return uMShareListener;
    }

    public boolean d(Activity activity, SHARE_MEDIA share_media) {
        if (!this.f8195f.a(activity, share_media)) {
            return false;
        }
        this.f8193d.get(share_media).onCreate(activity, PlatformConfig.getPlatform(share_media));
        return this.f8193d.get(share_media).isAuthorize();
    }
    ...
    public String c(Activity activity, SHARE_MEDIA share_media) {
        ...
        this.f8193d.get(share_media).onCreate(activity, PlatformConfig.getPlatform(share_media));
        return this.f8193d.get(share_media).getSDKVersion();
    }
    ...
    public synchronized UMAuthListener d(int i2) {
        ...
        uMAuthListener = this.f8199j.get(i2, null);
        if (uMAuthListener != null) {
            this.f8199j.remove(i2);
        }
        return uMAuthListener;
    }

    public UMSSOHandler a(SHARE_MEDIA share_media) {
        UMSSOHandler uMSSOHandler = this.f8193d.get(share_media);
        if (uMSSOHandler != null) {
            uMSSOHandler.onCreate(this.f8196g, PlatformConfig.getPlatform(share_media));
        }
        return uMSSOHandler;
    }
    ...
    private static class C0144a {
        ...
        public C0144a(Map<SHARE_MEDIA, UMSSOHandler> map) {
            this.a = map;
        }
    ...
    private UMSSOHandler a(int i2) {
        ...
        for (UMSSOHandler uMSSOHandler : this.f8193d.values()) {
    ...
    public void a(Activity activity, SHARE_MEDIA share_media, UMAuthListener uMAuthListener) {
        if (this.f8195f.a(activity, share_media)) {
            ...
            this.f8193d.get(share_media).onCreate(activity, PlatformConfig.getPlatform(share_media));
            this.f8193d.get(share_media).deleteAuth(uMAuthListener);
        }
    }
    ...
    public synchronized UMAuthListener c(int i2) {
        UMAuthListener uMAuthListener;
        this.a = null;
        uMAuthListener = this.f8197h.get(i2, null);
        if (uMAuthListener != null) {
            this.f8197h.remove(i2);
        }
        return uMAuthListener;
    }
    ...
    public boolean a(Activity activity, SHARE_MEDIA share_media) {
        this.f8193d.get(share_media).onCreate(activity, PlatformConfig.getPlatform(share_media));
        return this.f8193d.get(share_media).isInstall();
    }
                    ...
                    public void run() {
                        try {
                            ...
                            if (th != null) {
                                ...
                                SLog.E(d.c.a.b.a.a.f10075h);
                                SLog.runtimePrint(d.c.a.b.a.a.f10075h);
                            }
    ...
    private synchronized void a(int i2, UMAuthListener uMAuthListener) {
        this.f8197h.put(i2, uMAuthListener);
    }

    private synchronized void a(int i2, UMShareListener uMShareListener) {
        this.f8198i.put(i2, uMShareListener);
    }
    ...
    public void a() {
        ...
        UMSSOHandler uMSSOHandler = this.f8193d.get(SHARE_MEDIA.SINA);
        if (uMSSOHandler != null) {
            uMSSOHandler.release();
        }
        UMSSOHandler uMSSOHandler2 = this.f8193d.get(SHARE_MEDIA.MORE);
        if (uMSSOHandler2 != null) {
            uMSSOHandler2.release();
        }
        UMSSOHandler uMSSOHandler3 = this.f8193d.get(SHARE_MEDIA.DINGTALK);
        if (uMSSOHandler3 != null) {
            uMSSOHandler3.release();
        }
        UMSSOHandler uMSSOHandler4 = this.f8193d.get(SHARE_MEDIA.WEIXIN);
        if (uMSSOHandler4 != null) {
            uMSSOHandler4.release();
        }
        UMSSOHandler uMSSOHandler5 = this.f8193d.get(SHARE_MEDIA.QQ);
    ...
    public void a(Bundle bundle) {
        ...
        bundle.putString(f8191b, string);
        bundle.putInt(f8192c, i2);
        this.a = null;
    }
    ...
    public void a(Activity activity, Bundle bundle, UMAuthListener uMAuthListener) {
        ...
        String string = bundle.getString(f8191b, null);
        if (bundle.getInt(f8192c, -1) != 0 || TextUtils.isEmpty(string) || (share_mediaConvertToEmun = SHARE_MEDIA.convertToEmun(string)) == null) {
            return;
        }
        if (share_mediaConvertToEmun == SHARE_MEDIA.QQ) {
            uMSSOHandlerA = this.f8193d.get(share_mediaConvertToEmun);
    ...
    public void a(UMShareConfig uMShareConfig) {
        ...
        Iterator<Map.Entry<SHARE_MEDIA, UMSSOHandler>> it = this.f8193d.entrySet().iterator();
        while (it.hasNext()) {
