...
class a extends UMShareAPI {
    private final com.umeng.socialize.b.a a;

    /* JADX INFO: renamed from: com.umeng.socialize.a$a, reason: collision with other inner class name */
    /* JADX INFO: compiled from: UMShareImpl.java */
    private static class C0142a extends QueuedWork.UMAsyncTask<Void> {
        ...
        private final boolean f8163c = SocializeUtils.isHasDplusCache();

        public C0142a(Context context) {
            this.a = context;
            this.f8162b = SocializeUtils.isToday(SocializeSpUtils.getTime(context));
        }
        ...
        private void c() {
            SharedPreferences.Editor editorEdit = this.a.getSharedPreferences(SocializeConstants.SOCIAL_PREFERENCE_NAME, 0).edit();
        ...
        public Void doInBackground() {
            ...
            SocialAnalytics.verifyStats(this.a);
            if (!zB) {
                c();
                return null;
            }
    ...
    protected a(Context context) {
        ...
        this.a = new com.umeng.socialize.b.a(context.getApplicationContext());
        String currentProcessName = UMFrUtils.getCurrentProcessName(context);
        if (TextUtils.isEmpty(currentProcessName) || !currentProcessName.equals(ContextUtil.getPackageName())) {
            return;
        }
        new C0142a(context.getApplicationContext()).execute();
    }
        ...
        if (activity != null) {
            new QueuedWork.DialogThread<Void>(activity) { // from class: com.umeng.socialize.a.2
                ...
                protected Object doInBackground() {
                    a.this.a.a(activity, share_media, uMAuthListener);
                    return null;
                }
            }.execute();
        } else {
        ...
        if (!SLog.isDebug() || a(activity, share_media)) {
            if (activity != null) {
                new QueuedWork.DialogThread<Void>(activity) { // from class: com.umeng.socialize.a.1
                    ...
                    /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
                    public Void doInBackground() {
                        a.this.a.c(activity, share_media, uMAuthListener);
                        return null;
                    }
                }.execute();
            } else {
    ...
    public void doShare(Activity activity, final ShareAction shareAction, final UMShareListener uMShareListener) {
        ...
        if (weakReference.get() == null || ((Activity) weakReference.get()).isFinishing()) {
            ...
            new QueuedWork.DialogThread<Void>((Context) weakReference.get()) { // from class: com.umeng.socialize.a.4
                ...
                public Void doInBackground() {
                    if (weakReference.get() != null && !((Activity) weakReference.get()).isFinishing()) {
                        a.this.a.a((Activity) weakReference.get(), shareAction, uMShareListener);
    ...
    public void fetchAuthResultWithBundle(Activity activity, Bundle bundle, UMAuthListener uMAuthListener) {
        this.a.a(activity, bundle, uMAuthListener);
    }
    ...
    public void getPlatformInfo(final Activity activity, final SHARE_MEDIA share_media, final UMAuthListener uMAuthListener) {
        ...
        new QueuedWork.DialogThread<Void>(activity) { // from class: com.umeng.socialize.a.3
            @Override // com.umeng.socialize.common.QueuedWork.UMAsyncTask
            protected Object doInBackground() {
                a.this.a.b(activity, share_media, uMAuthListener);
                Context context = ContextUtil.getContext();
                if (context == null) {
                    return null;
                }
