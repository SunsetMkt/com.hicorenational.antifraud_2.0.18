...
public class SinaSsoHandler extends UMSSOHandler {
    ...
    public void userinfo(final UMAuthListener uMAuthListener) {
        ...
        map.put(CommonNetImpl.NAME, map.get("screen_name"));
        map.put(UserInfo.GENDER, getGender(map.get(UserInfo.GENDER)));
    ...
    public boolean getActivity() {
        WeakReference<Activity> weakReference = this.mActivityStack;
    ...
    public void onCreate(Context context, PlatformConfig.Platform platform) {
        ...
        if (context instanceof Activity) {
            ...
            this.mWBAPI.registerApp(context, this.mAuthInfo, new SdkListener() { // from class: com.umeng.socialize.handler.SinaSsoHandler.1
