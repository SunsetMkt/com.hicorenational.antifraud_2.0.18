...
public class e {
    ...
    private boolean a(String str) {
        long b2 = this.f11553d.b(str + bh.aX, 0L);
        if (b2 <= 0) {
            return true;
        }
        long abs = Math.abs(System.currentTimeMillis() - this.f11553d.b(str + "ts", 0L)) / 1000;
        boolean z = abs >= b2;
        if (!z && com.umeng.socialize.a.a.f11537c) {
            m.a(f11550a, "interval deny ", str, " config:", Long.valueOf(b2), " current:", Long.valueOf(abs));
        }
        return z;
    }
}
