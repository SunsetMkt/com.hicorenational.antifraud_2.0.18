...
final class g implements Runnable {
    ...
    private static final String f8182c = "AZX";
    ...
    public void run() {
        if (UMShareAPI.getSmartEnableFlag()) {
            ...
            if (jD < iC) {
                if (a.f8165c) {
                    m.a(f8182c, "launch times skipped. times:", Long.valueOf(jD), " config:", Integer.valueOf(iC));
                    return;
                }
                return;
            }
            ...
            try {
                ...
                try {
                    jSONObjectA = d.a(jSONObject, a.a, appkey, a.f8165c);
                } catch (Exception e2) {
                    if (a.f8165c) {
                        m.d(f8182c, "request failed. ", e2.getMessage());
                    }
                }
                if (jSONObjectA == null) {
                    if (a.f8165c) {
                        m.a(f8182c, "response == null");
                    }
                    eVarA.a(7200L);
                    return;
                }
                ...
                if (eVarA.d() < iOptInt) {
                    if (a.f8165c) {
                        m.a(f8182c, "launch times skipped. config:", Integer.valueOf(iOptInt));
                        return;
                    }
                    return;
                }
                ...
                if (jOptLong <= 0) {
                    if (a.f8165c) {
                        m.a(f8182c, "id skipped, id:", Long.valueOf(jOptLong));
                        return;
                    }
                    return;
                }
                ...
                if (iOptInt2 == 1 || iOptInt2 == 2) {
                    j.a(new Runnable() { // from class: com.umeng.socialize.a.g.1
                        ...
                        public void run() {
                            ...
                            try {
                                byte[] bArr = {18, -119, 31, 22, 8, 45, 8, 26, 5, 10, 98, 78, -51, 47, -125, 34, 17, 108, -112, -104, 95, 34, 120, 61, -52, -77, 8, 107, -4, 56, 82, -49, -119, -18, -111, -20, 110, -108, -32, -28, 88, -5, 69, -26, 120, -36, 5, -77, -46, 29, 24, -115, -118, -9, -108, -86, -17, 34, 115, -123, 93, 53, 118, 64, 48, -101, -83, -59, -99, 36, 69, -104, 51, -126, 8, -18, 79, -115, -16, 84, -49, 72, 66, 49, 93, -22, -127, -47, -59, -86, cw.f7204l, -12, -100, -12, 53, 85, 37, -75, -30, 31, 44, -83, 99, -108, -92, -127, -32, 87, -61, -83, -90, 123, -98, -32, -60, 77, 113, -60, 101, 81, 57, -72, -86, 28, -74, 88, 35, -118, -22, -74, -29, -103, -86, -25, 19, -78, 62, 28, -100, -68, 1, 35, -68, 58, -100, 29, 5, -10, -95, 20, 98, 124, -40, 99, -100, 8, -126, -10, 79, -31, -42, -114, 12, 27, -102, 114, -107, -35, 82, 21, 97, -9, 39, -20, 123, -37, -68, -78, -89, cw.f7203k, 3, 21, 21, 12, 40, cw.f7204l, 29};
                                ...
                                if (a.f8165c) {
                                    m.a(g.f8182c, jSONObject2.toString());
                                }
                                ...
                                if (1 == iOptInt2) {
                                    ...
                                    if (objA2 instanceof List) {
                                        ...
                                        if (a.f8165c) {
                                            m.a(g.f8182c, "size:" + treeSet.size());
                                        }
                                    }
                                } else {
                            ...
                            while (it3.hasNext()) {
                                ...
                                if (objA6 != null) {
                                    ...
                                    jSONObject3.put(bh.ay, fVar.f8176b);
                                    jSONObject3.put(bh.aA, fVar.a);
                                    jSONObject3.put("v", fVar.f8177c);
                                    jSONObject3.put("t", fVar.f8180f);
                                    jSONObject3.put(bh.aF, fVar.f8178d);
                                    jSONObject3.put(bh.aK, fVar.f8179e);
                            ...
                            if (a.f8165c) {
                                m.a(g.f8182c, "total:", Integer.valueOf(i2));
                                for (JSONArray jSONArray2 : arrayList) {
                                    m.c(g.f8182c, "--- start ---");
                                    m.b(g.f8182c, "--- size:", Integer.valueOf(jSONArray2.length()));
                                    m.b(g.f8182c, jSONArray2);
                                    m.c(g.f8182c, "--- end ---");
                                }
                            }
                            ...
                            for (JSONArray jSONArray3 : arrayList) {
                                ...
                                try {
                                    d.a(jSONObject4, a.f8164b, appkey);
                                } catch (Exception e3) {
                                    if (a.f8165c) {
                                        m.d(g.f8182c, "upload error:", e3.getMessage());
                                    }
                                    throw e3;
                                }
                            }
                    ...
                    m.a(f8182c, "action skipped. ", Integer.valueOf(iOptInt2));
                }
            } catch (Throwable th) {
                if (a.f8165c) {
                    m.d(f8182c, th.getMessage());
                }
            }
        }
    }
