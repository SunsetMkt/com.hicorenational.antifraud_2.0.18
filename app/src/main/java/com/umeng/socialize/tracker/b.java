...
class b {
    ...
    public static String e(String str) {
        ...
        try {
            JSONObject jSONObject = new JSONObject(str);
            if (jSONObject.has("data") && (optJSONObject = jSONObject.optJSONObject("data")) != null && optJSONObject.has(com.umeng.socialize.tracker.a.f11822l)) {
                return optJSONObject.optString(com.umeng.socialize.tracker.a.f11822l);
            }
            return null;
        } catch (Throwable unused) {
            return null;
        ...
        try {
            ...
            c.a(new Runnable() { // from class: com.umeng.socialize.tracker.b.1
                ...
                public void run() {
                    ...
                    com.umeng.socialize.tracker.utils.b bVar = new com.umeng.socialize.tracker.utils.b(com.umeng.socialize.tracker.a.f11811a, b.a.POST, hashMap2, new HttpRequestListener() { // from class: com.umeng.socialize.tracker.b.1.1
