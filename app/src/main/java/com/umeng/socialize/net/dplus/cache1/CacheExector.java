...
public class CacheExector {
    ...
    private final int f8339b = 32;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final int f8340c = 5120;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final int f8341d = 8;
    ...
    private File a() {
        ...
        File file = new File(this.f8342e);
        if (file.exists() || file.mkdirs()) {
            return file;
        }
        String str = "Couldn't create directory" + this.f8342e;
        return null;
    }
