...
public class d {
    public static void a(Context context) {
        try {
            ...
            JSONObject buildEnvelopeWithExtHeader = UMEnvelopeBuild.buildEnvelopeWithExtHeader(context, jSONObject, d(context), UMServerURL.PATH_ANALYTICS, bh.aF, a.f10759e);
    ...
    private static JSONObject b() {
        try {
            ...
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("pro", a2.f10806a);
                jSONObject.put("pla", a2.f10807b);
                jSONObject.put("cpus", a2.f10808c);
                jSONObject.put("fea", a2.f10809d);
                jSONObject.put(at.f10069c, a2.f10810e);
                jSONObject.put("arc", a2.f10811f);
                jSONObject.put("var", a2.f10812g);
                jSONObject.put("par", a2.f10813h);
                jSONObject.put("rev", a2.f10814i);
                jSONObject.put("har", a2.f10815j);
                jSONObject.put("rev", a2.f10816k);
                jSONObject.put("ser", a2.f10817l);
