...
public class j {
    private static final String a = at.b().b(at.r);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final String f7629b = "um_common_strength";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f7630c = "um_common_battery";
    ...
    public static String a(Context context) {
        ...
        return sharedPreferences.getString(f7630c, null);
    }
    ...
    public static void a(Context context, String str) {
        ...
        sharedPreferences.edit().putString(f7630c, str).commit();
    }
}
