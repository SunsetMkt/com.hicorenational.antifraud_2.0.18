...
public class b {
    ...
    public JSONObject a(Context context, JSONObject jSONObject, JSONObject jSONObject2, String str, String str2, String str3) {
        ...
        if (context != null && jSONObject2 != null) {
            try {
                    ...
                    try {
                        ...
                        if (a3 != null) {
                            ...
                            if (!TextUtils.isEmpty(encodeToString)) {
                                ...
                                jSONObject5.put(a(bh.Y), encodeToString);
                ...
                if (!str6.startsWith(bh.aG) && !str6.startsWith(bh.aF) && !str6.startsWith("t") && !str6.startsWith("a") && !com.umeng.commonsdk.stateless.b.a()) {
    ...
    private int a(Context context, Envelope envelope, String str, String str2, String str3) {
        ...
        if (!str.startsWith(bh.aG) && !str.startsWith(bh.aF) && !str.startsWith("a") && !str.startsWith("t")) {
