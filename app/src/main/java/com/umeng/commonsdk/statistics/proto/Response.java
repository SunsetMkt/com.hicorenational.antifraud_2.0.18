...
public class Response implements bq<Response, e>, Serializable, Cloneable {
    ...
    private static final Map<Class<? extends cx>, cy> schemes = new HashMap();
    ...
    static {
        schemes.put(cz.class, new b());
        schemes.put(da.class, new d());
        EnumMap enumMap = new EnumMap(e.class);
        enumMap.put(e.RESP_CODE, new cc("resp_code", (byte) 1, new cd((byte) 8)));
        enumMap.put(e.MSG, new cc("msg", (byte) 2, new cd((byte) 11)));
        enumMap.put(e.IMPRINT, new cc(bh.X, (byte) 2, new ch((byte) 12, com.umeng.commonsdk.statistics.proto.d.class)));
        metaDataMap = Collections.unmodifiableMap(enumMap);
        cc.a(Response.class, metaDataMap);
    }
    ...
    public enum e implements bx {
        ...
        private static final Map<String, e> f7739d = new HashMap();

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        private final short f7741e;
