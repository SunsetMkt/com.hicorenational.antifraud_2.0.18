...
public class ImLatent implements d {
    ...
    private final long _ONE_HOURS_IN_MS = a.f3869e;
    private final long _360HOURS_IN_MS = d.c.a.b.a.a.a;
    private final long _36HOURS_IN_MS = 129600000;
    private final int LATENT_MAX = 1800000;
    private final int LATENT_WINDOW = 10;
    private long latentHour = d.c.a.b.a.a.a;
    ...
    public void onImprintChanged(ImprintHandler.a aVar) {
        ...
        this.latentHour = ((long) (iIntValue > 36 ? iIntValue : 360)) * a.f3869e;
        int iIntValue2 = Integer.valueOf(aVar.a(bh.aV, "0")).intValue();
        ...
        int i2 = com.umeng.commonsdk.statistics.a.f7662c;
        if (i2 <= 0 || i2 > 1800000) {
