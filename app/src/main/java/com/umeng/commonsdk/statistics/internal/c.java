...
public class c {
    ...
    private void b() {
        String imprintProperty = UMEnvelopeBuild.imprintProperty(this.f10964c, "domain_p", "");
        String imprintProperty2 = UMEnvelopeBuild.imprintProperty(this.f10964c, "domain_s", "");
        ...
        String imprintProperty3 = UMEnvelopeBuild.imprintProperty(this.f10964c, "oversea_domain_p", "");
        String imprintProperty4 = UMEnvelopeBuild.imprintProperty(this.f10964c, "oversea_domain_s", "");
