    ...
    private Handler.Callback f11081h = new Handler.Callback() { // from class: com.umeng.commonsdk.utils.a.1
        ...
        public boolean handleMessage(Message message) {
            synchronized (a.this) {
                ...
                long elapsedRealtime = a.this.f11077c - SystemClock.elapsedRealtime();
                if (elapsedRealtime <= 0) {
                    a.this.c();
                    if (a.this.f11079f != null) {
                        a.this.f11079f.quit();
                    }
                } else if (elapsedRealtime < a.this.f11076b) {
                    a.this.f11080g.sendMessageDelayed(a.this.f11080g.obtainMessage(1), elapsedRealtime);
                } else {
                    long elapsedRealtime2 = SystemClock.elapsedRealtime();
                    a.this.a(elapsedRealtime);
                    long elapsedRealtime3 = (elapsedRealtime2 + a.this.f11076b) - SystemClock.elapsedRealtime();
                    while (elapsedRealtime3 < 0) {
                        elapsedRealtime3 += a.this.f11076b;
                    }
                    a.this.f11080g.sendMessageDelayed(a.this.f11080g.obtainMessage(1), elapsedRealtime3);
                }
                return false;
            }
        }
