...
public class c {
    ...
    static {
        ...
        if (appContext != null) {
            String imprintProperty = UMEnvelopeBuild.imprintProperty(appContext, f11091f, "");
            ...
            String imprintProperty2 = UMEnvelopeBuild.imprintProperty(appContext, f11092g, "");
            if (TextUtils.isEmpty(imprintProperty)) {
                f11095j = 48;
                return;
            }
            try {
                f11095j = a(Integer.parseInt(imprintProperty2));
