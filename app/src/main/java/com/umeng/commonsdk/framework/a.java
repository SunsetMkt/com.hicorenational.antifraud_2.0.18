...
public class a implements UMImprintChangeCallback {
    ...
    public static void c(int i2) {
        ...
        f10741b.sendMessage(obtainMessage);
    }
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            if (DeviceConfig.checkPermission(context, "android.permission.ACCESS_NETWORK_STATE")) {
                ...
                if (f10749j != null) {
                    ...
                    f10749j.registerNetworkCallback(build, new ConnectivityManager.NetworkCallback() { // from class: com.umeng.commonsdk.framework.a.1
    ...
    private static void b(int i2) {
        ...
        Message obtainMessage = f10741b.obtainMessage();
        obtainMessage.what = i2;
        f10741b.sendMessage(obtainMessage);
    }
    ...
    private static void a(int i2, long j2) {
        ...
        f10741b.sendMessageDelayed(obtainMessage, j2);
    }
    ...
    private static void a(int i2, int i3) {
        ...
        Message obtainMessage = f10741b.obtainMessage();
        obtainMessage.what = i2;
        f10741b.sendMessageDelayed(obtainMessage, i3);
    }
}
