...
public class bj extends SQLiteOpenHelper {
    ...
    private static bj f10156c = null;

    /* renamed from: d, reason: collision with root package name */
    private static final String f10157d = "CREATE TABLE IF NOT EXISTS stf(_id INTEGER PRIMARY KEY AUTOINCREMENT, _tp TEXT, _hd TEXT, _bd TEXT, _ts TEXT, _uuid TEXT, _re1 TEXT, _re2 TEXT)";

    /* renamed from: e, reason: collision with root package name */
    private static final String f10158e = "DROP TABLE IF EXISTS stf";

    /* renamed from: f, reason: collision with root package name */
    private static final String f10159f = "DELETE FROM stf WHERE _id IN( SELECT _id FROM stf ORDER BY _id LIMIT 1)";
    ...
    public static bj a(Context context) {
        ...
        synchronized (f10155b) {
            if (f10156c == null) {
                f10156c = new bj(context, bl.f10168b, null, 1);
            }
            bjVar = f10156c;
        }
        return bjVar;
    ...
    private void b(SQLiteDatabase sQLiteDatabase) {
        try {
            sQLiteDatabase.execSQL(f10157d);
    ...
    private void d() {
        try {
            ...
            try {
                writableDatabase.execSQL(f10159f);
    ...
    private void a(SQLiteDatabase sQLiteDatabase) {
        try {
            sQLiteDatabase.execSQL(f10158e);
            sQLiteDatabase.execSQL(f10157d);
    ...
    */
    public com.umeng.analytics.pro.bk a(java.lang.String r11) {
        /*
            ...
            r2.f10161a = r0     // Catch: java.lang.Throwable -> L6b
            r0 = 1
            java.lang.String r0 = r1.getString(r0)     // Catch: java.lang.Throwable -> L6b
            r2.f10162b = r0     // Catch: java.lang.Throwable -> L6b
            r0 = 2
            java.lang.String r0 = r1.getString(r0)     // Catch: java.lang.Throwable -> L6b
            r3 = 3
            java.lang.String r3 = r1.getString(r3)     // Catch: java.lang.Throwable -> L6b
            android.content.Context r4 = r10.f10160a     // Catch: java.lang.Throwable -> L6b
            ...
            r2.f10163c = r0     // Catch: java.lang.Throwable -> L6b
            android.content.Context r0 = r10.f10160a     // Catch: java.lang.Throwable -> L6b
            ...
            r2.f10164d = r0     // Catch: java.lang.Throwable -> L6b
            r0 = 4
            java.lang.String r0 = r1.getString(r0)     // Catch: java.lang.Throwable -> L6b
            r2.f10165e = r0     // Catch: java.lang.Throwable -> L6b
            r0 = 5
            java.lang.String r0 = r1.getString(r0)     // Catch: java.lang.Throwable -> L6b
            r2.f10166f = r0     // Catch: java.lang.Throwable -> L6b
            r0 = r2
            goto L6d
        L6b:
            r0 = r2
