...
public class y {
    ...
    private String f(Context context) {
        try {
            ...
            edit.putString(u.f10517d, d(context));
            edit.commit();
        ...
        long a2 = u.a(context);
        long j2 = a2 * com.heytap.mcssdk.constant.a.r;
    ...
    private boolean j(Context context) {
        ...
        try {
            ...
            if (FieldManager.allow(com.umeng.commonsdk.utils.d.E) && j2 > 0 && j3 == 0) {
                ...
                if (a2 > 0) {
                    long j4 = a2 * com.heytap.mcssdk.constant.a.r;
    ...
    public String a(Context context) {
        ...
        try {
            synchronized (y.class) {
                str = PreferenceWrapper.getDefault(appContext).getString(u.f10517d, "");
            }
        } catch (Exception unused) {
        }
        return str;
