...
public class r {
    ...
    private static final int f7371b = 1;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final int f7372c = 2;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int f7373d = 3;
    ...
    public void b(JSONObject jSONObject, Context context) {
        ...
        if (iA == 1) {
            ...
            if (jSONObject.has(d.f7219n)) {
                try {
                    JSONArray jSONArray = jSONObject.getJSONArray(d.f7219n);
        ...
        if (iA == 2) {
            ...
            if (jSONObject.has(d.f7219n)) {
                jSONObject.remove(d.f7219n);
            }
            try {
                jSONObject.put(d.f7219n, c());
    ...
    private r() {
        this.f7374e = com.heytap.mcssdk.constant.a.f3868d;
    }
    ...
    private JSONArray b() {
        ...
        try {
            ...
            jSONObject.put(d.p, jCurrentTimeMillis);
            jSONObject.put(d.q, jCurrentTimeMillis + com.heytap.mcssdk.constant.a.f3868d);
            jSONObject.put("duration", com.heytap.mcssdk.constant.a.f3868d);
            jSONArray.put(jSONObject);
        } catch (JSONException unused) {
        }
        return jSONArray;
