...
public class s {
    ...
    private static final String f10505a = "fs_lc_tl_uapp";

    /* renamed from: f, reason: collision with root package name */
    private static final String f10506f = "-1";

    /* renamed from: g, reason: collision with root package name */
    private static Context f10507g;
    ...
    private JSONObject f10512h;

    /* compiled from: EventTracker.java */
    private static class a {

        /* renamed from: a, reason: collision with root package name */
        private static final s f10513a = new s();
    ...
    private void b(Context context) {
        try {
            String string = PreferenceWrapper.getDefault(context).getString(f10505a, null);
            if (!TextUtils.isEmpty(string)) {
                this.f10512h = new JSONObject(string);
            }
            a();
    ...
    private void c(Context context) {
        try {
            if (this.f10512h != null) {
                PreferenceWrapper.getDefault(f10507g).edit().putString(f10505a, this.f10512h.toString()).commit();
            }
    ...
    public void a(String str, String str2, long j2, int i2, String str3) {
        ...
        try {
            if (a(str) && b(str2)) {
                ...
                jSONObject.put("__t", i.f10404a);
                if (!TextUtils.isEmpty(str2)) {
                    jSONObject.put(str, str2);
                }
                if (UMUtils.isMainProgress(f10507g)) {
                    a2 = y.a().d(UMGlobalContext.getAppContext(f10507g));
                } else {
                    a2 = y.a().a(UMGlobalContext.getAppContext(f10507g), currentTimeMillis);
                }
                ...
                jSONObject.put("ds", 0);
                jSONObject.put("pn", UMGlobalContext.getInstance(f10507g).getProcessName(f10507g));
                a();
                if (this.f10512h != null && this.f10512h.has(str) && !((Boolean) this.f10512h.get(str)).booleanValue()) {
                    jSONObject.put(d.Y, 1);
                    this.f10512h.put(str, true);
                    c(f10507g);
                }
                UMWorkDispatch.sendEvent(f10507g, 4097, CoreProtocol.getInstance(f10507g), jSONObject);
                return;
            }
            UMLog.aq(j.f10435l, 0, "\\|");
            ...
            try {
                if (!map.isEmpty()) {
                    for (Map.Entry<String, Object> entry : map.entrySet()) {
                        if (!a(entry.getKey())) {
                            UMLog.aq(j.f10431h, 0, "\\|");
                            return false;
                        }
                        if (entry.getValue() == null) {
                            UMLog.aq(j.f10432i, 0, "\\|");
                            return false;
                        }
        ...
        try {
            ...
            if (b(map)) {
                ...
                if (UMUtils.isMainProgress(f10507g)) {
                    ...
                    a2 = y.a().a(UMGlobalContext.getAppContext(f10507g), jSONObject.getLong("ts"));
                }
                if (TextUtils.isEmpty(a2)) {
                    a2 = f10506f;
                }
                ...
                if (!z) {
                    ...
                    UMWorkDispatch.sendEvent(f10507g, o.a.n, CoreProtocol.getInstance(f10507g), jSONObject);
                }
            }
        } catch (Throwable unused2) {
        }
    ...
    public void a(String str, Map<String, Object> map, String str2) {
        try {
            if (a(str)) {
                ...
                String d2 = y.a().d(UMGlobalContext.getAppContext(f10507g));
                ...
                UMWorkDispatch.sendEvent(f10507g, 4098, CoreProtocol.getInstance(f10507g), jSONObject);
            }
        } catch (Throwable unused2) {
        }
    }
    ...
    private void a() {
        try {
            String imprintProperty = UMEnvelopeBuild.imprintProperty(f10507g, "track_list", "");
            ...
            if (this.f10512h != null) {
                for (String str : split) {
                    ...
                    if (this.f10512h.has(subStr)) {
                        jSONObject.put(subStr, this.f10512h.get(subStr));
                    }
                }
            }
            this.f10512h = new JSONObject();
            if (split.length >= 10) {
                while (i2 < 10) {
    ...
    private void a(String str, boolean z) {
        try {
            if (d.Y.equals(str) || d.W.equals(str) || "id".equals(str) || "ts".equals(str) || this.f10512h.has(str)) {
                return;
            }
            this.f10512h.put(str, z);
        } catch (Exception unused) {
        }
    }
