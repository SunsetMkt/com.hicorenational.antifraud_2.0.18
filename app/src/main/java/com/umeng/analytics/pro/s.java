...
public class s {
    ...
    private static final String f7375f = "-1";

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static Context f7376g;
    ...
    public static s a(Context context) {
        if (f7376g == null && context != null) {
            f7376g = context.getApplicationContext();
        }
        return a.a;
    }
    ...
    private void b(Context context) {
        try {
            ...
            if (!TextUtils.isEmpty(string)) {
                this.f7381h = new JSONObject(string);
            }
            a();
    ...
    private void c(Context context) {
        try {
            if (this.f7381h != null) {
                PreferenceWrapper.getDefault(f7376g).edit().putString(a, this.f7381h.toString()).commit();
            }
    ...
    public void a(String str, String str2, long j2, int i2, String str3) {
        ...
        try {
            if (a(str) && b(str2)) {
                ...
                if (UMUtils.isMainProgress(f7376g)) {
                    strA = y.a().d(UMGlobalContext.getAppContext(f7376g));
                } else {
                    strA = y.a().a(UMGlobalContext.getAppContext(f7376g), jCurrentTimeMillis);
                }
                ...
                jSONObject.put("ds", 0);
                jSONObject.put("pn", UMGlobalContext.getInstance(f7376g).getProcessName(f7376g));
                a();
                if (this.f7381h != null && this.f7381h.has(str) && !((Boolean) this.f7381h.get(str)).booleanValue()) {
                    jSONObject.put(d.Y, 1);
                    this.f7381h.put(str, true);
                    c(f7376g);
                }
                UMWorkDispatch.sendEvent(f7376g, 4097, CoreProtocol.getInstance(f7376g), jSONObject);
                return;
            }
            UMLog.aq(j.f7314l, 0, "\\|");
        ...
        try {
            ...
            if (b(map)) {
                ...
                if (UMUtils.isMainProgress(f7376g)) {
                    ...
                    strA = y.a().a(UMGlobalContext.getAppContext(f7376g), jSONObject.getLong("ts"));
                }
                if (TextUtils.isEmpty(strA)) {
                    strA = f7375f;
                }
                ...
                if (!z) {
                    ...
                    UMWorkDispatch.sendEvent(f7376g, o.a.f7361n, CoreProtocol.getInstance(f7376g), jSONObject);
                }
            }
        } catch (Throwable unused2) {
        }
    ...
    public void a(String str, Map<String, Object> map, String str2) {
        try {
            if (a(str)) {
                ...
                String strD = y.a().d(UMGlobalContext.getAppContext(f7376g));
                ...
                UMWorkDispatch.sendEvent(f7376g, 4098, CoreProtocol.getInstance(f7376g), jSONObject);
            }
        } catch (Throwable unused2) {
        }
    }
    ...
    private void a() {
        try {
            String strImprintProperty = UMEnvelopeBuild.imprintProperty(f7376g, "track_list", "");
            ...
            if (this.f7381h != null) {
                for (String str : strArrSplit) {
                    ...
                    if (this.f7381h.has(strSubStr)) {
                        jSONObject.put(strSubStr, this.f7381h.get(strSubStr));
                    }
                }
            }
            this.f7381h = new JSONObject();
    ...
    private void a(String str, boolean z) {
        try {
            if (d.Y.equals(str) || d.W.equals(str) || "id".equals(str) || "ts".equals(str) || this.f7381h.has(str)) {
                return;
            }
            this.f7381h.put(str, z);
        } catch (Exception unused) {
        }
    }
