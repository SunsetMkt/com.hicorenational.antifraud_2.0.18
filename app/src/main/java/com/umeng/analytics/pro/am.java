...
public class am {
    ...
    public static byte[] a(String str, byte[] bArr) {
        ...
        byte[] bArr2 = null;
        try {
            HttpsURLConnection a2 = a(str, SocializeProtocolConstants.PROTOCOL_KEY_AK, as.a(bArr, UMConfigure.sAppkey.getBytes()));
            if (a2 != null && a2.getResponseCode() == 200) {
                ...
                try {
                    String headerField = a2.getHeaderField(SocializeProtocolConstants.PROTOCOL_KEY_AK);
