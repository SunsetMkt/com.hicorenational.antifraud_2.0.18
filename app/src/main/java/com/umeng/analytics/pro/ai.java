...
public class ai {
    ...
    private void a() {
        try {
            ...
            String[] split = this.f10028a.split(Constants.ACCEPT_TIME_SEPARATOR_SERVER);
            if (split.length == 2) {
                this.f10029b = Integer.valueOf(split[0]).intValue();
                this.f10030c = Integer.valueOf(split[1]).intValue();
                if (this.f10029b < 1) {
                    this.f10029b = 1;
                }
                if (this.f10030c > 24) {
