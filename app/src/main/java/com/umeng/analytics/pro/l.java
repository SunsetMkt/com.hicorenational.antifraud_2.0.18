                ...
                if (activity != null) {
                    if (l.this.f10449m <= 0) {
                        ...
                        if (l.f10439e == 0 && UMUtils.isMainProgress(activity)) {
                            ...
                            hashMap2.put("pairUUID", l.f10438d);
                ...
                if (activity != null) {
                    ...
                    if (l.this.f10449m <= 0) {
                        ...
                        if ((i2 == 1 || (i2 == 0 && !UMUtils.isMainProgress(activity))) && activity != null) {
                            HashMap hashMap = new HashMap();
                            hashMap.put("pairUUID", l.f10438d);
        ...
        if (context != null) {
            try {
                ...
                synchronized (f10441j) {
                    jSONArray = f10440i.toString();
                    f10440i = new JSONArray();
                }
                if (jSONArray.length() > 0) {
                    jSONObject.put(e.d.a.f10374c, new JSONArray(jSONArray));
        ...
        try {
            synchronized (this.f10447h) {
                ...
                if (TextUtils.isEmpty(f10437a) || !this.f10447h.containsKey(f10437a)) {
                    ...
                    long longValue = this.f10447h.get(f10437a).longValue();
