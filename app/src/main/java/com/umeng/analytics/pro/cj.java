...
public class cj extends cp {
    ...
    private int E() throws bw {
        int i2 = 0;
        if (this.f10278g.h() >= 5) {
            byte[] f2 = this.f10278g.f();
            int g2 = this.f10278g.g();
            int i3 = 0;
            int i4 = 0;
            while (true) {
                byte b2 = f2[g2 + i2];
    ...
    private long F() throws bw {
        ...
        if (this.f10278g.h() >= 10) {
            ...
            while (true) {
                ...
                if ((f2[g2 + i2] & h.q2.t.n.f16413a) != 128) {
                    break;
                }
                i3 += 7;
                i2++;
    ...
    public cm n() throws bw {
        int E = E();
        byte u = E == 0 ? (byte) 0 : u();
        return new cm(d((byte) (u >> 4)), d((byte) (u & cw.f10303m)), E);
    }
    ...
    public String z() throws bw {
        ...
        try {
            ...
            String str = new String(this.f10278g.f(), this.f10278g.g(), E, "UTF-8");
            this.f10278g.a(E);
            return str;
