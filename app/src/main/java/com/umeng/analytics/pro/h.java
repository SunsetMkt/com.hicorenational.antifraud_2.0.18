...
public class h {
    ...
    public static String b(Context context) {
        return context.getDatabasePath(e.f7229b).getParent() + File.separator;
    }
    ...
    public static void a(Context context) {
        ...
        try {
            File databasePath = context.getDatabasePath(e.f7229b);
    ...
    public static void a(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3) {
        sQLiteDatabase.execSQL("alter table " + str + " add " + str2 + d.c.a.b.a.a.f10074g + str3);
    }
}
