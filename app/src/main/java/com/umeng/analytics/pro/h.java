...
public class h {
    ...
    */
    ...
    public static String b(Context context) {
        return context.getDatabasePath(e.f10330b).getParent() + File.separator;
    }

    public static String c(Context context) {
        return b(context) + e.f10329a;
    }
    ...
    public static void a(Context context) {
        ...
        try {
            File databasePath = context.getDatabasePath(e.f10330b);
    ...
    */
    ...
    public static void a(SQLiteDatabase sQLiteDatabase, String str, String str2, String str3) {
        sQLiteDatabase.execSQL("alter table " + str + " add " + str2 + c.c.a.b.a.a.f3100g + str3);
    }
}
