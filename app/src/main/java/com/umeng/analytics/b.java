...
public class b implements n, t {
    ...
    private static final String f6955h = "sp_uapp";

    /* JADX INFO: renamed from: i */
    private static final String f6956i = "prepp_uapp";
    ...
    private volatile JSONObject f6964k;

    /* JADX INFO: renamed from: l */
    private volatile JSONObject f6965l;

    /* JADX INFO: renamed from: m */
    private volatile JSONObject f6966m;
    ...
    private void i(Context context) {
        try {
            ...
            if (this.f6964k == null) {
                this.f6964k = new JSONObject();
            }
            if (this.f6965l == null) {
                this.f6965l = new JSONObject();
            }
            String string = sharedPreferences.getString(f6956i, null);
            if (!TextUtils.isEmpty(string)) {
                try {
                    this.f6966m = new JSONObject(string);
                } catch (JSONException unused) {
                }
            }
            if (this.f6966m == null) {
                this.f6966m = new JSONObject();
            }
        ...
        try {
            if (a != null) {
                if (!UMUtils.isMainProgress(a)) {
                    ...
                    UMWorkDispatch.sendEvent(a, o.a.f7358k, CoreProtocol.getInstance(a), Long.valueOf(jCurrentTimeMillis));
                    UMWorkDispatch.sendEvent(a, 4103, CoreProtocol.getInstance(a), Long.valueOf(jCurrentTimeMillis));
                }
            }
            if (this.f6957b != null) {
                this.f6957b.onAppResume();
            }
    ...
    void j() {
        try {
            ...
            UMWorkDispatch.sendEvent(a, o.a.o, CoreProtocol.getInstance(a), jSONObject);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
    ...
    public synchronized void k() {
        ...
        if (this.f6964k != null) {
            ...
            editorEdit.putString(f6955h, this.f6964k.toString());
            editorEdit.commit();
        } else {
            this.f6964k = new JSONObject();
        }
    ...
    void d(Context context) {
        ...
        try {
            ...
            if (a != null) {
                if (this.f6961f != null) {
                    this.f6961f.c(a, Long.valueOf(System.currentTimeMillis()));
                }
                o.a(a).d();
                v.a(a);
                if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION == MobclickAgent.PageMode.AUTO) {
    ...
    public synchronized Object e(Context context, String str) {
        ...
        if (this.f6964k == null) {
            this.f6964k = new JSONObject();
        } else if (this.f6964k.has(str)) {
            return this.f6964k.opt(str);
        }
        return null;
    }
    ...
    public synchronized void f(Context context) {
        ...
        this.f6964k = new JSONObject();
        UMWorkDispatch.sendEvent(a, o.a.t, CoreProtocol.getInstance(a), null);
    }
    ...
    public synchronized void g(Context context) {
        ...
        if (this.f6966m.length() > 0) {
            UMWorkDispatch.sendEvent(a, o.a.x, CoreProtocol.getInstance(a), null);
        }
        this.f6966m = new JSONObject();
    }
    ...
    void b(Context context) {
        ...
        try {
            ...
            if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION != MobclickAgent.PageMode.LEGACY_MANUAL) {
                this.f6960e.a(context.getClass().getName());
            }
            h();
            if (UMConfigure.isDebugLog() && (context instanceof Activity)) {
    ...
    public synchronized JSONObject h(Context context) {
        ...
        if (this.f6966m.length() > 0) {
            try {
                jSONObject = new JSONObject(this.f6966m.toString());
            } catch (JSONException unused) {
            }
        }
        return jSONObject;
    ...
    public void i() {
        try {
            if (a != null) {
                ...
                UMWorkDispatch.sendEvent(a, o.a.f7355h, CoreProtocol.getInstance(a), Long.valueOf(System.currentTimeMillis()));
        ...
        ISysListener iSysListener = this.f6957b;
    ...
    public synchronized void f(Context context, String str) {
        ...
        if (str != null && str.length() > 0) {
            if (this.f6966m.has(str)) {
                this.f6966m.remove(str);
                UMWorkDispatch.sendEvent(a, 8200, CoreProtocol.getInstance(a), this.f6966m.toString());
    ...
    public synchronized void d(Context context, String str) {
        ...
        if (this.f6964k.has(str)) {
            this.f6964k.remove(str);
            UMWorkDispatch.sendEvent(a, o.a.u, CoreProtocol.getInstance(a), str);
        }
    }
    ...
    public void b(Context context, String str) {
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                map.put(d.aE, str);
                a(a, d.aD, (Map<String, Object>) map, -1L, false);
                return;
            }
            UMLog.aq(j.O, 0, "\\|");
        } catch (Throwable th) {
    ...
    public synchronized void b(Object obj) {
        ...
        if (obj != null) {
            ...
            if (editorEdit != null && !TextUtils.isEmpty(str)) {
                editorEdit.putString(f6956i, str).commit();
            }
        } else if (editorEdit != null) {
            editorEdit.remove(f6956i).commit();
        }
    }
    ...
    void a(Context context, String str) {
        ...
        try {
            ...
            jSONObject.put("__ii", this.f6961f.c());
        ...
        try {
            ...
            if (AnalyticsConfig.enable) {
                ...
                if (th != null) {
                    ...
                    i.a(a).a(this.f6961f.c(), jSONObject.toString(), 1);
                }
                o.a(a).d();
                v.a(a);
                if (UMConfigure.AUTO_ACTIVITY_PAGE_COLLECTION == MobclickAgent.PageMode.AUTO) {
            ...
            try {
                ...
                if (obj.getClass().isArray()) {
                    if (obj instanceof String[]) {
                        ...
                        this.f6964k.put(str, jSONArray2);
                        ...
                        this.f6964k.put(str, jSONArray3);
                        ...
                        this.f6964k.put(str, jSONArray4);
                        ...
                        this.f6964k.put(str, jSONArray5);
                        ...
                        this.f6964k.put(str, jSONArray6);
                    } else {
                    ...
                    this.f6964k.put(str, obj);
                }
            } catch (Throwable unused) {
            }
            UMWorkDispatch.sendEvent(a, o.a.s, CoreProtocol.getInstance(a), this.f6964k.toString());
            return;
        }
        UMLog.aq(j.ag, 0, "\\|");
    }
    ...
    private void a(String str, Object obj) {
        try {
            ...
            if (obj instanceof List) {
                ...
                this.f6964k.put(str, jSONArray7);
                return;
            }
            if ((obj instanceof String) || (obj instanceof Long) || (obj instanceof Integer) || (obj instanceof Float) || (obj instanceof Double) || (obj instanceof Short)) {
                this.f6964k.put(str, obj);
    ...
    public synchronized void a(Object obj) {
        ...
        if (obj != null) {
            ...
            SharedPreferences.Editor editorEdit = PreferenceWrapper.getDefault(a).edit();
            if (editorEdit != null && !TextUtils.isEmpty(str)) {
                editorEdit.putString(f6955h, this.f6964k.toString()).commit();
            }
        }
    }
    ...
    public synchronized void a(Context context, JSONObject jSONObject) {
        ...
        if (jSONObject != null && jSONObject.length() > 0) {
            ...
            try {
                jSONObject2 = new JSONObject(this.f6966m.toString());
            ...
            this.f6966m = jSONObject2;
            if (this.f6966m.length() > 0) {
                UMWorkDispatch.sendEvent(a, o.a.v, CoreProtocol.getInstance(a), this.f6966m.toString());
            }
            return;
        }
        UMLog.aq(j.am, 0, "\\|");
