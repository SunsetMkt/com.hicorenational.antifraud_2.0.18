...
public class b implements n, t {
        ...
        try {
            if (f9985a != null) {
                if (!UMUtils.isMainProgress(f9985a)) {
                    ...
                    UMWorkDispatch.sendEvent(f9985a, o.a.f10483k, CoreProtocol.getInstance(f9985a), Long.valueOf(currentTimeMillis));
                    UMWorkDispatch.sendEvent(f9985a, 4103, CoreProtocol.getInstance(f9985a), Long.valueOf(currentTimeMillis));
                }
            }
            if (this.f9988b != null) {
    ...
    public synchronized void k() {
        ...
        if (this.f9995k != null) {
            SharedPreferences.Editor edit = PreferenceWrapper.getDefault(f9985a).edit();
            edit.putString(f9986h, this.f9995k.toString());
            edit.commit();
        } else {
            this.f9995k = new JSONObject();
        }
    ...
    public void b(Context context, String str) {
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                a(f9985a, d.aD, (Map<String, Object>) hashMap, -1L, false);
                return;
            }
            UMLog.aq(j.O, 0, "\\|");
        } catch (Throwable th) {
    ...
    public synchronized void b(Object obj) {
        ...
        if (obj != null) {
            ...
            if (edit != null && !TextUtils.isEmpty(str)) {
                edit.putString(f9987i, str).commit();
            }
        } else if (edit != null) {
            edit.remove(f9987i).commit();
        }
    }
    ...
    public void a(Context context, String str, HashMap<String, Object> hashMap) {
        ...
        try {
            ...
            if (this.f9995k == null) {
                ...
                str2 = this.f9995k.toString();
            }
            s.a(f9985a).a(str, hashMap, str2);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    public void a(Context context, String str, String str2, long j2, int i2) {
        ...
        try {
            ...
            if (this.f9995k == null) {
                ...
                str3 = this.f9995k.toString();
            }
            s.a(f9985a).a(str, str2, j2, i2, str3);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    private void a(Context context, String str, Map<String, Object> map, long j2, boolean z2) {
        try {
            ...
            s.a(f9985a).a(str, map, j2, str2, z2);
        } catch (Throwable th) {
            if (MLog.DEBUG) {
                MLog.e(th);
            }
    ...
    public synchronized void a(Object obj) {
        ...
        if (obj != null) {
            ...
            SharedPreferences.Editor edit = PreferenceWrapper.getDefault(f9985a).edit();
            if (edit != null && !TextUtils.isEmpty(str)) {
                edit.putString(f9986h, this.f9995k.toString()).commit();
            }
        }
    }
