...
public final class i<TResult> extends Task<TResult> {
    ...
    private volatile boolean f4379c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private TResult f4380d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private Exception f4381e;
    private final Object a = new Object();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private List<ExecuteResult<TResult>> f4382f = new ArrayList();
    ...
    private void b() {
        synchronized (this.a) {
            Iterator<ExecuteResult<TResult>> it = this.f4382f.iterator();
            while (it.hasNext()) {
                try {
    ...
    public final TResult getResult() {
        ...
        synchronized (this.a) {
            if (this.f4381e != null) {
                throw new RuntimeException(this.f4381e);
            }
            tresult = this.f4380d;
        }
        return tresult;
    ...
    public final <E extends Throwable> TResult getResultThrowException(Class<E> cls) throws Throwable {
        ...
        synchronized (this.a) {
            if (cls != null) {
                if (cls.isInstance(this.f4381e)) {
                    throw cls.cast(this.f4381e);
                }
            }
            if (this.f4381e != null) {
                throw new RuntimeException(this.f4381e);
    ...
    public final boolean isSuccessful() {
        boolean z;
        synchronized (this.a) {
            z = this.f4378b && !isCanceled() && this.f4381e == null;
        }
        return z;
    }
