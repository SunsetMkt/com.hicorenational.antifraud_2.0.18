...
public final class i<TResult> extends Task<TResult> {
    ...
    private TResult f6481d;

    /* renamed from: e, reason: collision with root package name */
    private Exception f6482e;

    /* renamed from: a, reason: collision with root package name */
    private final Object f6478a = new Object();

    /* renamed from: f, reason: collision with root package name */
    private List<ExecuteResult<TResult>> f6483f = new ArrayList();
    ...
    private void b() {
        synchronized (this.f6478a) {
            Iterator<ExecuteResult<TResult>> it = this.f6483f.iterator();
            while (it.hasNext()) {
                try {
    ...
    public final TResult getResult() {
        ...
        synchronized (this.f6478a) {
            if (this.f6482e != null) {
                throw new RuntimeException(this.f6482e);
            }
            tresult = this.f6481d;
        }
        return tresult;
    ...
    public final <E extends Throwable> TResult getResultThrowException(Class<E> cls) throws Throwable {
        ...
        synchronized (this.f6478a) {
            if (cls != null) {
                if (cls.isInstance(this.f6482e)) {
                    throw cls.cast(this.f6482e);
                }
            }
            if (this.f6482e != null) {
                throw new RuntimeException(this.f6482e);
    ...
    public final boolean isSuccessful() {
        boolean z;
        synchronized (this.f6478a) {
            z = this.f6479b && !isCanceled() && this.f6482e == null;
        }
        return z;
    }
