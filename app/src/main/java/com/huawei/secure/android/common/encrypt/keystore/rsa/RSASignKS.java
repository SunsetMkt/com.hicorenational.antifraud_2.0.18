...
public abstract class RSASignKS {
    ...
    private static final String f5091b = "AndroidKeyStore";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f5092c = "SHA256withRSA/PSS";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f5093d = "";

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final int f5094e = 2048;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final int f5095f = 3072;
    ...
    private static byte[] a(String str, byte[] bArr, boolean z) {
        ...
        try {
            Signature signature = Signature.getInstance(f5092c);
    ...
    private static KeyStore.Entry b(String str, boolean z) {
        ...
        try {
            KeyStore keyStore = KeyStore.getInstance(f5091b);
            keyStore.load(null);
    ...
    private static synchronized KeyPair a(String str, boolean z) {
        ...
        try {
            try {
                KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance("RSA", f5091b);
                if (!z) {
                    ...
                    keyPairGenerator.initialize(new KeyGenParameterSpec.Builder(str, 12).setDigests("SHA-256", "SHA-512").setSignaturePaddings("PSS").setKeySize(f5095f).build());
                }
