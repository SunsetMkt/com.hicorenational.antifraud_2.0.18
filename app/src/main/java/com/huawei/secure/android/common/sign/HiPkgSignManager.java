...
public class HiPkgSignManager {
    ...
    private static String b(byte[] bArr) {
        try {
            ...
            LogsUtil.e(a, "NoSuchAlgorithmException" + e2.getMessage());
            return "";
        }
    }
    ...
    public static byte[] getInstalledAPPSignature(Context context, String str) {
        ...
        try {
            ...
            LogsUtil.e(a, "PackageManager.NameNotFoundException : " + e2.getMessage(), true);
        } catch (Exception e3) {
            LogsUtil.e(a, "Exception : " + e3.getMessage(), true);
        }
        return new byte[0];
    }
