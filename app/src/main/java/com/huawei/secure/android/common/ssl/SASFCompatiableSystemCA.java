...
public class SASFCompatiableSystemCA extends SSLSocketFactory {
    ...
    static void a(X509TrustManager x509TrustManager) {
        ...
        e.a(f7537i, "sasf system ca update: cost : " + (System.currentTimeMillis() - currentTimeMillis) + " ms");
    }
    ...
    public Socket createSocket(Socket socket, String str, int i2, boolean z) throws IOException {
        ...
        Socket createSocket = this.f7539a.getSocketFactory().createSocket(socket, str, i2, z);
        if (createSocket instanceof SSLSocket) {
            a(createSocket);
            this.f7540b = (SSLSocket) createSocket;
    ...
    public Socket createSocket() throws IOException {
        ...
        Socket createSocket = this.f7539a.getSocketFactory().createSocket();
        if (createSocket instanceof SSLSocket) {
            a(createSocket);
            this.f7540b = (SSLSocket) createSocket;
            this.f7542d = (String[]) this.f7540b.getEnabledCipherSuites().clone();
