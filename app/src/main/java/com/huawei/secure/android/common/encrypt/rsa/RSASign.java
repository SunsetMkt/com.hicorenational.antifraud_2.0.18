...
public abstract class RSASign {
    ...
    private static final String f5101b = "SHA256WithRSA/PSS";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f5102c = "RSASign";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f5103d = "UTF-8";

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final String f5104e = "";

    private static String a(String str, String str2, boolean z) {
        if (TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            b.b(f5102c, "sign content or key is null");
            return "";
        }
    ...
    public static String newSign(String str, String str2) {
        ...
        b.b(f5102c, "sdk version is too low");
        return "";
    }
    ...
    public static byte[] sign(byte[] bArr, PrivateKey privateKey, boolean z) {
        ...
        if (bArr != null && privateKey != null && RSAEncrypt.isPrivateKeyLengthRight((RSAPrivateKey) privateKey)) {
            try {
                if (z) {
                    signature = Signature.getInstance(f5101b);
                ...
                b.b(f5102c, "sign InvalidAlgorithmParameterException: " + e2.getMessage());
                return bArr2;
            } catch (InvalidKeyException e3) {
                b.b(f5102c, "sign InvalidKeyException: " + e3.getMessage());
                return bArr2;
            } catch (NoSuchAlgorithmException e4) {
                b.b(f5102c, "sign NoSuchAlgorithmException: " + e4.getMessage());
                return bArr2;
            } catch (SignatureException e5) {
                b.b(f5102c, "sign SignatureException: " + e5.getMessage());
                return bArr2;
            } catch (Exception e6) {
                b.b(f5102c, "sign Exception: " + e6.getMessage());
                return bArr2;
            }
        }
        b.b(f5102c, "content or privateKey is null , or length is too short");
        return bArr2;
    }
    ...
    public static boolean verifySign(byte[] bArr, byte[] bArr2, PublicKey publicKey, boolean z) {
        ...
        if (bArr != null && publicKey != null && bArr2 != null && RSAEncrypt.isPublicKeyLengthRight((RSAPublicKey) publicKey)) {
            try {
                ...
                b.b(f5102c, "check sign exception: " + e2.getMessage());
                return false;
            } catch (Exception e3) {
                b.b(f5102c, "exception : " + e3.getMessage());
                return false;
            }
        }
        b.b(f5102c, "content or publicKey is null , or length is too short");
        return false;
    }
    ...
    private static String a(String str, PrivateKey privateKey, boolean z) {
        try {
            ...
            b.b(f5102c, "sign UnsupportedEncodingException: " + e2.getMessage());
            return "";
        }
    }
    ...
    private static boolean a(String str, String str2, String str3, boolean z) {
        ...
        b.b(f5102c, "content or public key or sign value is null");
        return false;
    }
    ...
    private static boolean a(String str, String str2, PublicKey publicKey, boolean z) {
        try {
            ...
            b.b(f5102c, "verifySign UnsupportedEncodingException: " + e2.getMessage());
            return false;
        } catch (Exception e3) {
            b.b(f5102c, "base64 decode Exception : " + e3.getMessage());
            return false;
        }
    }
    ...
    public static byte[] sign(ByteBuffer byteBuffer, PrivateKey privateKey, boolean z) {
        ...
        if (byteBuffer != null && privateKey != null && RSAEncrypt.isPrivateKeyLengthRight((RSAPrivateKey) privateKey)) {
            try {
                ...
                b.c(f5102c, "result is : " + Arrays.toString(bArrSign));
                return bArrSign;
            } catch (InvalidAlgorithmParameterException e2) {
                b.b(f5102c, "sign InvalidAlgorithmParameterException: " + e2.getMessage());
                return bArrSign;
