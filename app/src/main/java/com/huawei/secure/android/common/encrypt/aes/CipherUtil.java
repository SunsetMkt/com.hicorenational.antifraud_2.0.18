...
public class CipherUtil {
    ...
    private static final String f5049b = "AES/GCM/NoPadding";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f5050c = "AES/CBC/PKCS5Padding";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String f5051d = "AES";

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final String f5052e = "";

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final int f5053f = 16;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final int f5054g = 12;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private static final int f5055h = 16;

    private static Cipher a(byte[] bArr, byte[] bArr2, int i2) {
        return a(bArr, bArr2, i2, f5050c);
    }

    private static Cipher b(byte[] bArr, byte[] bArr2, int i2) {
        return a(bArr, bArr2, i2, f5049b);
    }
    ...
    private static Cipher a(byte[] bArr, byte[] bArr2, int i2, String str) {
        ...
        try {
            SecretKeySpec secretKeySpec = new SecretKeySpec(bArr, f5051d);
            Cipher cipher = Cipher.getInstance(str);
            cipher.init(i2, secretKeySpec, f5049b.equals(str) ? AesGcm.getGcmAlgorithmParams(bArr2) : new IvParameterSpec(bArr2));
            return cipher;
