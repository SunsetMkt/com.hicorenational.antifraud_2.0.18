...
public class a {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:24:0x00a7, code lost:
        ...
        return new java.lang.String(r1, r2, r8.f7637f - r2);
     */
    /*
    ...
    private String d() {
        ...
        while (true) {
            ...
            if (cArr[i3] == ' ') {
                ...
                while (true) {
                    int i4 = this.f7634c;
                    if (i4 >= this.f7633b || this.f7638g[i4] != ' ') {
                        break;
                    }
                    this.f7634c = i4 + 1;
                }
        ...
        return new String(this.f7638g, this.f7635d, i7);
    }
