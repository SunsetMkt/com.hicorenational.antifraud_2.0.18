...
public class b {
    ...
    private static final String f7656a = "b";

    /* renamed from: b, reason: collision with root package name */
    private static final int f7657b = 5;
    ...
    public static X509Certificate a(String str) {
        try {
            ...
            e.b(f7656a, "generateX509FromStr: CertificateException" + e2.getMessage());
            return null;
        }
    }
    ...
    public static boolean b(X509Certificate[] x509CertificateArr) {
        ...
        for (X509Certificate x509Certificate : x509CertificateArr) {
            try {
                ...
                e = e2;
                e.b(f7656a, "verifyCertificateDate: exception : " + e.getMessage());
                return false;
                ...
                e.b(f7656a, "verifyCertificateDate : exception : " + e4.getMessage());
                return false;
            }
        }
        return true;
        ...
        try {
            ...
            while (it.hasNext()) {
                if (arrayList.contains(it.next().getSerialNumber())) {
                    e.b(f7656a, "verify: certificate revoked");
                    return false;
                }
            }
            return true;
        } catch (Exception e2) {
            e.b(f7656a, "verify: revoked verify exception : " + e2.getMessage());
            return false;
        }
    }
    ...
    public static boolean a(X509Certificate x509Certificate, String str) {
        ...
        e.b(f7656a, "verify: subject name is error");
        return false;
    }
    ...
    public static boolean a(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        try {
            ...
            e.b(f7656a, "verify: date not right");
            return false;
        } catch (InvalidKeyException e2) {
            e.b(f7656a, "verify: publickey InvalidKeyException " + e2.getMessage());
            return false;
        } catch (NoSuchAlgorithmException e3) {
            e.b(f7656a, "verify: publickey NoSuchAlgorithmException " + e3.getMessage());
            return false;
        } catch (NoSuchProviderException e4) {
            e.b(f7656a, "verify: publickey NoSuchProviderException " + e4.getMessage());
            return false;
        } catch (SignatureException e5) {
            e.b(f7656a, "verify: publickey SignatureException " + e5.getMessage());
            return false;
        } catch (CertificateException e6) {
            e.b(f7656a, "verify: publickey CertificateException " + e6.getMessage());
            return false;
        } catch (Exception e7) {
            e.b(f7656a, "verify: Exception " + e7.getMessage());
            return false;
        }
    }
        ...
        while (i2 < x509CertificateArr.length) {
            ...
            if (principal != null) {
                if (issuerDN.equals(principal)) {
                    ...
                    e.b(f7656a, "verify: principalIssuer not match");
                    return false;
                }
            }
            i2++;
