...
public class b {
    ...
    public static X509Certificate a(String str) {
        try {
            ...
            e.b(a, "generateX509FromStr: CertificateException" + e2.getMessage());
            return null;
        }
    }
    ...
    public static boolean b(X509Certificate[] x509CertificateArr) {
        ...
        for (X509Certificate x509Certificate : x509CertificateArr) {
            try {
                ...
                e.b(a, "verifyCertificateDate : exception : " + e4.getMessage());
                return false;
            }
        }
        return true;
    ...
    public static boolean a(X509Certificate[] x509CertificateArr, X509CRL x509crl) {
        ...
        try {
            ...
            e.b(a, "verify: revoked verify exception : " + e2.getMessage());
            return false;
        }
    }
    ...
    public static boolean a(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        try {
            ...
            e.b(a, "verify: publickey InvalidKeyException " + e2.getMessage());
            return false;
        } catch (NoSuchAlgorithmException e3) {
            e.b(a, "verify: publickey NoSuchAlgorithmException " + e3.getMessage());
            return false;
        } catch (NoSuchProviderException e4) {
            e.b(a, "verify: publickey NoSuchProviderException " + e4.getMessage());
            return false;
        } catch (SignatureException e5) {
            e.b(a, "verify: publickey SignatureException " + e5.getMessage());
            return false;
        } catch (CertificateException e6) {
            e.b(a, "verify: publickey CertificateException " + e6.getMessage());
            return false;
        } catch (Exception e7) {
            e.b(a, "verify: Exception " + e7.getMessage());
            return false;
        }
    }
