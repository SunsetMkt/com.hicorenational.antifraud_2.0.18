...
public abstract class PBKDF2 {
    ...
    private static final String f7468a = "PBKDF2";

    /* renamed from: b, reason: collision with root package name */
    private static final String f7469b = "PBKDF2WithHmacSHA1";

    /* renamed from: c, reason: collision with root package name */
    private static final String f7470c = "PBKDF2WithHmacSHA256";

    /* renamed from: d, reason: collision with root package name */
    private static final String f7471d = "";

    /* renamed from: e, reason: collision with root package name */
    private static final int f7472e = 8;

    /* renamed from: f, reason: collision with root package name */
    private static final int f7473f = 16;

    /* renamed from: g, reason: collision with root package name */
    private static final int f7474g = 32;

    /* renamed from: h, reason: collision with root package name */
    private static final int f7475h = 10000;

    /* renamed from: i, reason: collision with root package name */
    private static final int f7476i = 1000;

    private static byte[] a(char[] cArr, byte[] bArr, int i2, int i3, boolean z) {
        try {
            return (z ? SecretKeyFactory.getInstance(f7470c) : SecretKeyFactory.getInstance(f7469b)).generateSecret(new PBEKeySpec(cArr, bArr, i2, i3)).getEncoded();
        } catch (NoSuchAlgorithmException | InvalidKeySpecException e2) {
            b.b(f7468a, "pbkdf exception : " + e2.getMessage());
            return new byte[0];
        }
    }
    ...
    public static byte[] pbkdf2SHA256(char[] cArr, byte[] bArr, int i2, int i3) {
        ...
        b.b(f7468a, "system version not high than 26");
        return bArr2;
    }
    ...
    public static String pbkdf2Encrypt(String str, byte[] bArr, int i2, int i3) {
        if (TextUtils.isEmpty(str)) {
            b.b(f7468a, "pwd is null.");
            return "";
        }
        if (i2 < 1000) {
            b.b(f7468a, "iterations times is not enough.");
            return "";
        }
        if (bArr == null || bArr.length < 8) {
            b.b(f7468a, "salt parameter is null or length is not enough");
            return "";
        }
        if (i3 < 32) {
            b.b(f7468a, "cipherLen length is not enough");
            return "";
        }
