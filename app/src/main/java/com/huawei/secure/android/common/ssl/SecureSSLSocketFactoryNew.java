...
public class SecureSSLSocketFactoryNew extends SSLSocketFactory {
    ...
    public static SecureSSLSocketFactoryNew getInstance(Context context) throws IOException, NoSuchAlgorithmException, CertificateException, KeyStoreException, IllegalAccessException, KeyManagementException, IllegalArgumentException {
        ...
        e.a(f7587i, "getInstance: cost : " + (System.currentTimeMillis() - currentTimeMillis) + " ms");
        return f7588j;
    }
    ...
    public Socket createSocket(String str, int i2) throws IOException {
        ...
        Socket createSocket = this.f7589a.getSocketFactory().createSocket(str, i2);
        if (createSocket instanceof SSLSocket) {
            a(createSocket);
            this.f7590b = (SSLSocket) createSocket;
    ...
    public Socket createSocket(Socket socket, String str, int i2, boolean z) throws IOException {
        ...
        Socket createSocket = this.f7589a.getSocketFactory().createSocket(socket, str, i2, z);
        if (createSocket instanceof SSLSocket) {
            a(createSocket);
            this.f7590b = (SSLSocket) createSocket;
            this.f7592d = (String[]) this.f7590b.getEnabledCipherSuites().clone();
