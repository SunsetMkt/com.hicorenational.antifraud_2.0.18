...
public class b {
    ...
    private static final String[] f5202b = {"ac", "co", "com", "ed", "edu", "go", "gouv", "gov", "info", "lg", "ne", "net", "or", "org"};
    ...
    public static final void a(String str, String[] strArr, String[] strArr2, boolean z) throws SSLException {
        ...
        if (!linkedList.isEmpty()) {
            ...
            while (it.hasNext()) {
                ...
                stringBuffer.append(h0.f12425e);
                if (it.hasNext()) {
    ...
    public static boolean a(String str) {
        ...
        int i2 = length - 3;
        if (str.charAt(i2) == '.') {
            return Arrays.binarySearch(f5202b, str.substring(2, i2)) < 0;
        }
        return true;
    }

    public static String[] a(X509Certificate x509Certificate) {
        List<String> listB = new a(x509Certificate.getSubjectX500Principal()).b(d.c.a.b.a.a.J);
        if (listB.isEmpty()) {
            return null;
        }
