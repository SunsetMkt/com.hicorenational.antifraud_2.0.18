...
public class SendUpStreamTask extends TaskApiCall<PushClient, BaseVoidTask> {
    ...
    private void a(PushClient pushClient, ResponseErrorCode responseErrorCode) {
        HMSLog.i("SendUpStreamTask", "receive upstream, msgId :" + this.f7236b + " , packageName = " + this.f7235a + " , errorCode = " + responseErrorCode.getErrorCode());
        Intent intent = new Intent("com.huawei.push.action.MESSAGING_EVENT");
        intent.setPackage(this.f7235a);
        Bundle bundle = new Bundle();
        bundle.putString("message_id", this.f7236b);
