...
public class AttributionReporter {
    ...
    private Task<Void> a(AttributionEvent attributionEvent, Bundle bundle) {
        ...
        int externalCode;
        String reportEntry = PushBiUtil.reportEntry(this.f7149b, PushNaming.PUSH_ANALYSIS_REPORT);
        if (bundle == null || attributionEvent == null) {
            PushBiUtil.reportExit(this.f7149b, PushNaming.PUSH_ANALYSIS_REPORT, reportEntry, ErrorEnum.ERROR_ARGUMENTS_INVALID);
        ...
        try {
            ...
            return this.f7148a.doWrite(new AttributionReportTask(PushNaming.PUSH_ANALYSIS_REPORT, JsonUtil.createJsonString(a(attributionEvent, new SafeBundle(bundle))), reportEntry));
        } catch (ApiException e2) {
            TaskCompletionSource taskCompletionSource2 = new TaskCompletionSource();
            taskCompletionSource2.setException(e2);
            externalCode = e2.getStatusCode();
            taskCompletionSource = taskCompletionSource2;
            PushBiUtil.reportExit(this.f7149b, PushNaming.PUSH_ANALYSIS_REPORT, reportEntry, externalCode);
