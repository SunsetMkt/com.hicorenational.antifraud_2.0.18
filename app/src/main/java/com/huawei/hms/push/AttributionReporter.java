...
public class AttributionReporter {
    ...
    private AttributionReporter(Context context) {
        ...
        this.a.setKitSdkVersion(61200300);
    }

    private Task<Void> a(AttributionEvent attributionEvent, Bundle bundle) {
        TaskCompletionSource taskCompletionSource;
        int externalCode;
        String strReportEntry = PushBiUtil.reportEntry(this.f4844b, PushNaming.PUSH_ANALYSIS_REPORT);
        if (bundle == null || attributionEvent == null) {
            PushBiUtil.reportExit(this.f4844b, PushNaming.PUSH_ANALYSIS_REPORT, strReportEntry, ErrorEnum.ERROR_ARGUMENTS_INVALID);
        ...
        try {
            ...
            long j2 = new PushPreferences(this.f4844b, "hwpush_local_config").getLong("analysis_last_failed_time");
            ...
            PushBiUtil.reportExit(this.f4844b, PushNaming.PUSH_ANALYSIS_REPORT, strReportEntry, externalCode);
        ...
        if (bundle != null && !bundle.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(string)) {
                ...
                if (!TextUtils.isEmpty(string2)) {
                    ...
                    attributionReportReq.setPkgName(this.f4844b.getPackageName());
