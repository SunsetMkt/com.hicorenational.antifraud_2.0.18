...
import com.huawei.hms.p182ui.SafeBundle;
...
public class AttributionReporter {
    ...
    /* renamed from: a */
    private HuaweiApi<Api.ApiOptions.NoOptions> f7678a;
    ...
    private AttributionReporter(Context context) {
        ...
        if (context instanceof Activity) {
            this.f7678a = new HuaweiApi<>((Activity) context, (Api<Api.ApiOptions>) api, (Api.ApiOptions) null, (AbstractClientBuilder) new PushClientBuilder());
        } else {
            this.f7678a = new HuaweiApi<>(context, (Api<Api.ApiOptions>) api, (Api.ApiOptions) null, new PushClientBuilder());
        }
        this.f7678a.setKitSdkVersion(61200300);
    }

    /* renamed from: a */
    private Task<Void> m7505a(AttributionEvent attributionEvent, Bundle bundle) {
        TaskCompletionSource taskCompletionSource;
        int externalCode;
        String reportEntry = PushBiUtil.reportEntry(this.f7679b, PushNaming.PUSH_ANALYSIS_REPORT);
        if (bundle == null || attributionEvent == null) {
            PushBiUtil.reportExit(this.f7679b, PushNaming.PUSH_ANALYSIS_REPORT, reportEntry, ErrorEnum.ERROR_ARGUMENTS_INVALID);
            HMSLog.m7715e("AttributionReporter", "Invalid argument: argument should not be null");
            throw new IllegalArgumentException("Invalid argument: argument should not be null");
        }
        try {
            if (!AbstractC2484d.m7550d(this.f7679b)) {
                throw ErrorEnum.ERROR_OPERATION_NOT_SUPPORTED.toApiException();
            }
            long j2 = new PushPreferences(this.f7679b, "hwpush_local_config").getLong("analysis_last_failed_time");
            if (j2 > 0 && System.currentTimeMillis() - j2 < 86400000) {
                throw ErrorEnum.ERROR_NOT_IN_SERVICE.toApiException();
            }
            return this.f7678a.doWrite(new AttributionReportTask(PushNaming.PUSH_ANALYSIS_REPORT, JsonUtil.createJsonString(m7506a(attributionEvent, new SafeBundle(bundle))), reportEntry));
        } catch (ApiException e2) {
            TaskCompletionSource taskCompletionSource2 = new TaskCompletionSource();
            taskCompletionSource2.setException(e2);
            externalCode = e2.getStatusCode();
            taskCompletionSource = taskCompletionSource2;
            PushBiUtil.reportExit(this.f7679b, PushNaming.PUSH_ANALYSIS_REPORT, reportEntry, externalCode);
    ...
    public Task<Void> report(AttributionEvent attributionEvent, Bundle bundle) {
        return m7505a(attributionEvent, bundle);
    }

    /* renamed from: a */
    private AttributionReportReq m7506a(AttributionEvent attributionEvent, SafeBundle safeBundle) throws ApiException {
        ...
        if (bundle != null && !bundle.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(string)) {
                ...
                if (!TextUtils.isEmpty(string2)) {
                    ...
                    attributionReportReq.setPkgName(this.f7679b.getPackageName());
