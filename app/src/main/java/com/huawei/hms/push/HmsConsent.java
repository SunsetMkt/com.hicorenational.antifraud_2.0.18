...
public class HmsConsent {
    ...
    private Task<Void> a(boolean z) {
        ...
        int externalCode;
        String reportEntry = PushBiUtil.reportEntry(this.f7153b, PushNaming.PUSH_CONSENT);
        try {
            if (!d.d(this.f7153b)) {
            ...
            return this.f7152a.doWrite(new ConsentTask(PushNaming.PUSH_CONSENT, JsonUtil.createJsonString(enableConsentReq), reportEntry));
        } catch (ApiException e2) {
            TaskCompletionSource taskCompletionSource2 = new TaskCompletionSource();
            taskCompletionSource2.setException(e2);
            externalCode = e2.getStatusCode();
            taskCompletionSource = taskCompletionSource2;
            PushBiUtil.reportExit(this.f7153b, PushNaming.PUSH_CONSENT, reportEntry, externalCode);
