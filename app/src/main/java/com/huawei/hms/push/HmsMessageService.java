...
public class HmsMessageService extends Service {
    ...
    private final Messenger f7154a = new Messenger(new f(new b(this, null)));
    ...
    class a implements Runnable {
        ...
        public void run() {
            ...
            if (this.f7156b.equals(BaseUtils.getLocalToken(applicationContext, this.f7155a))) {
                return;
            }
            HMSLog.i("HmsMessageService", "receive a new token, refresh the local token");
            BaseUtils.saveToken(applicationContext, this.f7155a, this.f7156b);
        }
    }
