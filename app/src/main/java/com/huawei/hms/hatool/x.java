...
public class x {
    ...
    private String f7113a = q0.i().getFilesDir().getPath();

    x() {
    }

    private String a(String str) {
        return this.f7113a + "/hms/component/".replace("component", str);
    }
    ...
    public String a() {
        ...
        if (b()) {
            ...
            a("marfil", b4);
            b5 = EncryptUtil.generateSecureRandomStr(128);
            a("maywnj", b5);
        ...
        return HexUtil.byteArray2HexStr(PBKDF2.pbkdf2(a(b2, b3, b4, d2), HexUtil.hexStr2ByteArray(b5), 10000, 16));
    }
}
