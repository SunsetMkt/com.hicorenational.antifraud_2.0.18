...
public class n {
    ...
    public static final Charset f7059a = Charset.forName("UTF-8");
    ...
    public static String a(String str, String str2) {
        ...
        return new String(AesCbc.decrypt(HexUtil.hexStr2ByteArray((String) a2.second), HexUtil.hexStr2ByteArray(str2), (byte[]) a2.first), f7059a);
    }
    ...
    public static String b(String str, String str2) {
        return HexUtil.byteArray2HexStr(AesCbc.encrypt(str.getBytes(f7059a), HexUtil.hexStr2ByteArray(str2)));
    }
}
