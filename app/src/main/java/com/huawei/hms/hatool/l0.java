...
public class l0 {
    ...
    private void b() {
        ...
        JSONArray c2 = c();
        String a2 = n1.a(this.f7039a, this.f7040b, this.f7043e);
    ...
    public void a() {
        ...
        b0 c2;
        String str;
        String a2 = a(this.f7039a, this.f7040b);
        if (!TextUtils.isEmpty(a2) || "preins".equals(this.f7040b)) {
            ...
            if (d2 != null) {
                ...
                if (a3.length == 0) {
                    ...
                    d1Var = new f(a3, a2, this.f7039a, this.f7040b, this.f7043e, this.f7042d);
                    c2 = b0.b();
                }
            } else {
