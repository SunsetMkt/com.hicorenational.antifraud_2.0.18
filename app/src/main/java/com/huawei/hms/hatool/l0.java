...
public class l0 {
    ...
    private void b() {
        ...
        String strA = n1.a(this.a, this.f4772b, this.f4775e);
    ...
    private JSONArray c() {
        ...
        Iterator<b1> it = this.f4774d.iterator();
        while (it.hasNext()) {
            try {
    ...
    private h1 d() {
        return k.a(this.f4774d, this.a, this.f4772b, this.f4775e, this.f4773c);
    }
    ...
    public void a() {
        ...
        b0 b0VarC;
        String str;
        String strA = a(this.a, this.f4772b);
        if (!TextUtils.isEmpty(strA) || "preins".equals(this.f4772b)) {
            ...
            if (h1VarD != null) {
                ...
                if (bArrA.length == 0) {
                    ...
                    d1Var = new f(bArrA, strA, this.a, this.f4772b, this.f4775e, this.f4774d);
                    b0VarC = b0.b();
                }
            } else {
                d1Var = new d1(this.f4774d, this.a, this.f4775e, this.f4772b);
                b0VarC = b0.c();
            }
            b0VarC.a(d1Var);
            return;
