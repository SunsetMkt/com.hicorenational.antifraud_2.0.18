...
public class h1 implements o1 {
    ...
    public JSONObject a() {
        ...
        if (list == null || list.size() == 0) {
            ...
            JSONObject a2 = this.f7002d.a();
            a2.put("properties", this.f7001c.a());
            try {
                a2.put("events_global_properties", new JSONObject(this.f7003e));
            } catch (JSONException unused) {
                a2.put("events_global_properties", this.f7003e);
            }
            ...
            try {
                String a4 = n.a(k1.a(jSONObject2.toString().getBytes("UTF-8")), this.f7004f);
