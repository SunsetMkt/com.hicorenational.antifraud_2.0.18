...
public class x0 extends o {
    ...
    public static Pair<String, String> e(Context context) {
        if (c0.a(context, util.permissionutil.a.f15033j)) {
        ...
        if (telephonyManager != null && telephonyManager.getSimState() == 5) {
            ...
            return (TextUtils.isEmpty(networkOperator) || TextUtils.equals(networkOperator, d.c.a.b.a.a.f10075h)) ? new Pair<>("", "") : networkOperator.length() > 3 ? new Pair<>(networkOperator.substring(0, 3), networkOperator.substring(3)) : new Pair<>("", "");
        }
        return new Pair<>("", "");
    }
}
