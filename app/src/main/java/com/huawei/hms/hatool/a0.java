...
public class a0 implements g {
    ...
    public a0(String str, JSONObject jSONObject, String str2, String str3, long j2) {
        ...
        if (z.i(str2, "oper")) {
            p0 a2 = y.a().a(str2, j2);
            this.f6941g = a2.a();
            this.f6942h = Boolean.valueOf(a2.b());
        }
    }
    ...
    public void run() {
        ...
        int h2 = q0.h();
        int k2 = a1.k(this.f6938d, this.f6939e);
        if (c0.a(this.f6935a, "stat_v2_1", h2 * 1048576)) {
        ...
        try {
            ...
            String a2 = n1.a(this.f6938d, this.f6939e);
            String a3 = d.a(this.f6935a, "stat_v2_1", a2, "");
            try {
            ...
            jSONArray.put(d2);
            d.b(this.f6935a, "stat_v2_1", a2, jSONArray.toString());
