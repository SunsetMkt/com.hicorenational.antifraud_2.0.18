...
public class v0 implements g {
    ...
    private void a(String str, List<b1> list) {
        ...
        new u(list, (String) pairA.first, (String) pairA.second, this.f4823d).a();
    }
        ...
        try {
            try {
                ...
                if ("alltype".equals(this.f4822c)) {
                    ...
                    String strA2 = n1.a(this.f4821b, this.f4822c);
                    d.a(this.a, "stat_v2_1", strA2);
                    d.a(this.a, "cached_v2_1", strA2);
                }
            }
            if (mapA.size() == 0) {
                v.b("hmsSdk", "no have events to report: tag:%s : type:%s", this.f4821b, this.f4822c);
                if ("alltype".equals(this.f4822c)) {
                    d.a(this.a, "stat_v2_1", new String[0]);
                    d.a(this.a, "cached_v2_1", new String[0]);
                    return;
                } else {
                    String strA3 = n1.a(this.f4821b, this.f4822c);
            ...
            if ("alltype".equals(this.f4822c)) {
                ...
                String strA4 = n1.a(this.f4821b, this.f4822c);
            ...
            if ("alltype".equals(this.f4822c)) {
                ...
                String strA5 = n1.a(this.f4821b, this.f4822c);
