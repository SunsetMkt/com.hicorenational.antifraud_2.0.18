...
public class v0 implements g {
    ...
    private void a(String str, List<b1> list) {
        ...
        new u(list, (String) a2.first, (String) a2.second, this.f7112d).a();
    }
    ...
    public void run() {
        ...
        try {
            try {
                a2 = c1.a(this.f7109a, this.f7110b, this.f7111c);
                ...
                if ("alltype".equals(this.f7111c)) {
                    ...
                    String a4 = n1.a(this.f7110b, this.f7111c);
                    d.a(this.f7109a, "stat_v2_1", a4);
                    d.a(this.f7109a, "cached_v2_1", a4);
                }
            } catch (Exception e3) {
                ...
                if ("alltype".equals(this.f7111c)) {
                    ...
                    String a5 = n1.a(this.f7110b, this.f7111c);
                    d.a(this.f7109a, "stat_v2_1", a5);
                    d.a(this.f7109a, "cached_v2_1", a5);
                }
            }
            if (a2.size() == 0) {
                ...
                if ("alltype".equals(this.f7111c)) {
                    ...
                    String a6 = n1.a(this.f7110b, this.f7111c);
                    d.a(this.f7109a, "stat_v2_1", a6);
                    d.a(this.f7109a, "cached_v2_1", a6);
                    return;
                }
            }
            ...
            if ("alltype".equals(this.f7111c)) {
                ...
                String a7 = n1.a(this.f7110b, this.f7111c);
                d.a(this.f7109a, "stat_v2_1", a7);
                d.a(this.f7109a, "cached_v2_1", a7);
            }
            if (a3) {
            ...
            if ("alltype".equals(this.f7111c)) {
                ...
                String a8 = n1.a(this.f7110b, this.f7111c);
                d.a(this.f7109a, "stat_v2_1", a8);
                d.a(this.f7109a, "cached_v2_1", a8);
            }
            throw th;
        }
    }
