...
public class c0 {
    public static boolean a(Context context) {
        return System.currentTimeMillis() - d.a(context, "Privacy_MY", "flashKeyTime", -1L) > com.heytap.mcssdk.constant.a.f3871g;
    }
    ...
    public static boolean a(Context context, String str, int i2) {
        ...
        if (!file.exists()) {
            String str3 = context.getPackageName() + d.c.a.b.a.a.s1 + str2;
