...
public class UpdateAdapter implements IBridgeActivityDelegate {
    ...
    public boolean onBridgeActivityResult(int i2, int i3, Intent intent) {
        ...
        if (AvailableUtil.isInstallerLibExist(this.f6601b) && i3 == 1214) {
            ...
            invokeMethod("com.huawei.hms.update.manager.UpdateManager", "startUpdate", new Object[]{b2, 1001, this.f6603d});
            this.f6603d = null;
        }
        if (i3 == -1) {
            if (intent != null) {
            ...
            String hMSPackageName = HMSPackageManager.getInstance(b3.getApplicationContext()).getHMSPackageName();
            if (TextUtils.isEmpty(hMSPackageName)) {
                hMSPackageName = "com.huawei.hwid";
            }
            if (this.f6604e || a(b3, hMSPackageName, this.f6602c)) {
