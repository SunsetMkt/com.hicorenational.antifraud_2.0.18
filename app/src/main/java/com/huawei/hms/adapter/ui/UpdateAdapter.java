...
public class UpdateAdapter implements IBridgeActivityDelegate {
    ...
    public void onBridgeActivityCreate(Activity activity) {
        ...
        this.f4455b = activity.getApplicationContext();
        ...
        if (c.f4490b.a(b())) {
            ...
            try {
                this.f4456c = intent.getIntExtra(CommonCode.MapKey.UPDATE_VERSION, 0);
            } catch (Throwable th) {
            ...
            try {
                if (AvailableUtil.isInstallerLibExist(this.f4455b)) {
                    UpdateBean updateBean = (UpdateBean) a("com.huawei.hms.adapter.ui.InstallerAdapter", "setUpdateBean", new Object[]{activity, Integer.valueOf(this.f4456c), Boolean.valueOf(this.f4458e)});
                    this.f4457d = updateBean;
    ...
    public boolean onBridgeActivityResult(int i2, int i3, Intent intent) {
        ...
        if (AvailableUtil.isInstallerLibExist(this.f4455b) && i3 == 1214) {
            ...
            invokeMethod("com.huawei.hms.update.manager.UpdateManager", "startUpdate", new Object[]{activityB, 1001, this.f4457d});
            this.f4457d = null;
        }
        if (i3 == -1) {
            if (intent != null) {
            ...
            if (this.f4458e || a(activityB2, hMSPackageName, this.f4456c)) {
