...
public class AvailableAdapter {
    ...
    private AvailableCallBack f4413b;

    /* JADX INFO: renamed from: d */
    private SystemObserver f4415d = new a();
    ...
    public void startNotice(Activity activity, AvailableCallBack availableCallBack) {
        ...
        if (UIUtil.isBackground(activity)) {
            ...
            this.f4413b = availableCallBack;
            SystemManager.getSystemNotifier().registerObserver(this.f4415d);
