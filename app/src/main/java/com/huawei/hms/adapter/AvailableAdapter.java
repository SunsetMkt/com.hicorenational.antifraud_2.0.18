...
public class AvailableAdapter {
    ...
    private AvailableCallBack f6540b;

    /* renamed from: d, reason: collision with root package name */
    private SystemObserver f6542d = new a();
    ...
    public int checkHuaweiMobileServicesForUpdate(Context context) {
        ...
        int a2 = a(context);
        if (a2 != 0 || !HMSPackageManager.getInstance(context).isApkNeedUpdate(this.f6539a)) {
            return a2;
        }
    ...
    public int isHuaweiMobileServicesAvailable(Context context) {
        Checker.checkNonNull(context, "context must not be null.");
        int a2 = a(context);
        if (a2 != 0 || !HMSPackageManager.getInstance(context).isApkUpdateNecessary(this.f6539a)) {
            return a2;
        }
    ...
    public void startNotice(Activity activity, AvailableCallBack availableCallBack) {
        ...
        if (UIUtil.isBackground(activity)) {
            ...
            this.f6540b = availableCallBack;
            SystemManager.getSystemNotifier().registerObserver(this.f6542d);
    ...
    public void startResolution(Activity activity, AvailableCallBack availableCallBack) {
        ...
        intentStartBridgeActivity.putExtra(CommonCode.MapKey.UPDATE_VERSION, this.f6539a);
        if (this.f6541c) {
