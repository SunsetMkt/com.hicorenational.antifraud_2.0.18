...
public class d {
    ...
    public static c a(GrsBaseInfo grsBaseInfo, Context context) {
        synchronized (f6831b) {
            ...
            c cVar = f6830a.get(context.getPackageName() + uniqueCode);
            if (cVar == null) {
                Logger.i("GrsClientManager", "grsClientImpl == null, and new GrsClientImpl");
                c cVar2 = new c(context, grsBaseInfo);
                f6830a.put(context.getPackageName() + uniqueCode, cVar2);
                return cVar2;
            }
            ...
            f6830a.put(context.getPackageName() + uniqueCode, cVar3);
            return cVar3;
        }
    }
}
