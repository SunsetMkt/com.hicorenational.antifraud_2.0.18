...
public class b {
    ...
    private final GrsBaseInfo f4635b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final com.huawei.hms.framework.network.grs.e.a f4636c;

    public b(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo) {
        this.a = context;
        this.f4635b = grsBaseInfo;
        this.f4636c = aVar;
    }

    public String a(boolean z) {
        String str = com.huawei.hms.framework.network.grs.a.a(this.f4636c.a().a("geoipCountryCode", ""), "geoip.countrycode").get("ROOT");
        Logger.i("GeoipCountry", "geoIpCountry is: " + str);
        String strA = this.f4636c.a().a("geoipCountryCodetime", "0");
        long j2 = 0;
        ...
        if (TextUtils.isEmpty(str) || com.huawei.hms.framework.network.grs.h.e.a(Long.valueOf(j2))) {
            com.huawei.hms.framework.network.grs.g.j.c cVar = new com.huawei.hms.framework.network.grs.g.j.c(this.f4635b, this.a);
            cVar.a("geoip.countrycode");
            com.huawei.hms.framework.network.grs.e.c cVarC = this.f4636c.c();
            if (cVarC != null) {
                String strA2 = null;
                try {
            ...
            if (z) {
                d dVarA = this.f4636c.b().a(cVar, "geoip.countrycode", cVarC, -1);
                if (dVarA != null) {
                ...
                this.f4636c.b().a(cVar, null, "geoip.countrycode", cVarC, -1);
            }
        }
        return str;
    }
