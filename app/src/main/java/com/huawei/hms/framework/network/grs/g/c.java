...
public class c {
    ...
    */
    ...
    private void b() {
        com.huawei.hms.framework.network.grs.g.j.d a2 = com.huawei.hms.framework.network.grs.g.i.a.a(this.f6865b);
        if (a2 == null) {
    ...
    private String d() {
        com.huawei.hms.framework.network.grs.f.b a2 = com.huawei.hms.framework.network.grs.f.b.a(this.f6865b.getPackageName());
        com.huawei.hms.framework.network.grs.local.model.a a3 = a2 != null ? a2.a() : null;
        if (a3 == null) {
            return "";
        }
        String a4 = a3.a();
        Logger.v(f6863l, "get appName from local assets is{%s}", a4);
        return a4;
    }
    ...
    public d a(ExecutorService executorService, String str, com.huawei.hms.framework.network.grs.e.c cVar) {
        ...
        d a2 = a(executorService, this.f6871h, str, cVar);
        Logger.i(f6863l, "use 2.0 interface return http's code is：{%d}", Integer.valueOf(a2 == null ? 0 : a2.b()));
        e.a(new ArrayList(this.f6869f), SystemClock.elapsedRealtime() - elapsedRealtime, this.f6870g, this.f6865b);
        this.f6869f.clear();
        return a2;
    }
