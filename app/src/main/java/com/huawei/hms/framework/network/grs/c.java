...
public class c {
    ...
    class a implements Callable<Boolean> {
        ...
        public Boolean call() {
            ...
            String c2 = new com.huawei.hms.framework.network.grs.g.j.c(this.f6828b, this.f6827a).c();
            Logger.v(c.f6816i, "scan serviceSet is: " + c2);
            String a2 = c.this.f6824f.a("services", "");
            String a3 = h.a(a2, c2);
            if (!TextUtils.isEmpty(a3)) {
                c.this.f6824f.b("services", a3);
                Logger.i(c.f6816i, "postList is:" + StringUtils.anonymizeMessage(a3));
                Logger.i(c.f6816i, "currentServices:" + StringUtils.anonymizeMessage(a2));
                if (!a3.equals(a2)) {
            ...
            long elapsedRealtime = SystemClock.elapsedRealtime() - c.f6818k;
            if (c.f6818k == 0 || TimeUnit.MILLISECONDS.toHours(elapsedRealtime) > 24) {
