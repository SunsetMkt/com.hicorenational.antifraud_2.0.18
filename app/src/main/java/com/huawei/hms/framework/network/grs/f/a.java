...
public abstract class a {
    ...
    protected com.huawei.hms.framework.network.grs.local.model.a f6842a;

    /* renamed from: b, reason: collision with root package name */
    protected List<com.huawei.hms.framework.network.grs.local.model.b> f6843b;

    /* renamed from: c, reason: collision with root package name */
    protected boolean f6844c = false;

    /* renamed from: d, reason: collision with root package name */
    protected boolean f6845d = false;

    /* renamed from: e, reason: collision with root package name */
    protected Set<String> f6846e = new HashSet(16);
    ...
    private int g(String str) {
        ...
        if (this.f6845d && (c2 = c(str)) != 0) {
            return c2;
        }
        int b2 = b(str);
        return b2 != 0 ? b2 : f(str);
    }
    ...
    private int h(String str) {
        ...
        return (!this.f6845d || !((list = this.f6843b) == null || list.isEmpty()) || (d2 = d(str)) == 0) ? e(str) : d2;
    }
    ...
    public String a(String str) {
        ...
        List<com.huawei.hms.framework.network.grs.local.model.b> list = this.f6843b;
        if (list != null && !list.isEmpty()) {
            for (com.huawei.hms.framework.network.grs.local.model.b bVar : this.f6843b) {
                if (bVar.a().contains(str)) {
                    return bVar.b();
                }
            }
    ...
    */
    ...
    public Map<String, String> a(Context context, com.huawei.hms.framework.network.grs.e.a aVar, GrsBaseInfo grsBaseInfo, String str, boolean z) {
        com.huawei.hms.framework.network.grs.local.model.a aVar2 = this.f6842a;
        if (aVar2 == null) {
        ...
        com.huawei.hms.framework.network.grs.local.model.d a4 = a2.a((a3 == null || a3.size() == 0) ? a(b2) : a(a3, grsBaseInfo, b2).get(b2));
        if (a4 == null) {
            return null;
        }
        return a4.a();
    ...
    */
    protected void b(org.json.JSONArray r15) {
        ...
        Lc:
            ...
            r3.b(r4)
            java.util.Set<java.lang.String> r5 = r14.f6846e
            boolean r5 = r5.contains(r4)
            if (r5 != 0) goto Lf2
            java.util.Set<java.lang.String> r5 = r14.f6846e
            r5.add(r4)
            boolean r5 = r14.f6845d
            if (r5 == 0) goto Lf2
        ...
        Ldf:
            r3.a(r5)
            com.huawei.hms.framework.network.grs.local.model.a r2 = r14.f6842a
            if (r2 != 0) goto Led
    ...
    public int d(String str) {
        ...
        try {
            ...
            this.f6843b.addAll(a(jSONArray));
            return 0;
