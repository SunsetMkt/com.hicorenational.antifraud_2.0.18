...
public class PowerUtils {
    ...
    public static boolean isAppIdleMode(Context context) {
        if (context == null) {
            Logger.m6799i(TAG, "isAppIdleMode Context is null!");
            return false;
        }
        ...
        if (i2 < 21) {
            Logger.m6799i(TAG, "isAppIdleMode statsManager is null!");
        } else if (i2 >= 22) {
    ...
    public static boolean isDozeIdleMode(Context context) {
        if (context == null) {
            Logger.m6799i(TAG, "isDozeIdleMode Context is null!");
            return false;
        }
        Object systemService = ContextCompat.getSystemService(context, "power");
        PowerManager powerManager = systemService instanceof PowerManager ? (PowerManager) systemService : null;
        if (powerManager == null) {
            Logger.m6799i(TAG, "isDozeIdleMode powerManager is null!");
            return false;
        }
        if (Build.VERSION.SDK_INT < 23) {
            Logger.m6799i(TAG, "isDozeIdleMode is version control state!");
            return false;
        }
        try {
    ...
    public static int readDataSaverMode(Context context) {
        if (context == null) {
            Logger.m6799i(TAG, "readDataSaverMode manager is null!");
            return 0;
        }
        Object systemService = context.getSystemService("connectivity");
        ConnectivityManager connectivityManager = systemService instanceof ConnectivityManager ? (ConnectivityManager) systemService : null;
        if (connectivityManager == null) {
            Logger.m6799i(TAG, "readDataSaverMode Context is null!");
            return 0;
        }
    ...
    public static int readPowerSaverMode(Context context) {
        if (context == null) {
            Logger.m6799i(TAG, "readPowerSaverMode Context is null!");
            return 0;
        }
        ...
        if (systemInt == 0) {
            ...
            if (powerManager != null) {
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    Logger.m6799i(TAG, "readPowerSaverMode is control by version!");
                }
            }
        }
        return systemInt;
