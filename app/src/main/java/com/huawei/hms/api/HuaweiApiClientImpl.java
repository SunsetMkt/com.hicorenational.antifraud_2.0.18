...
public class HuaweiApiClientImpl extends HuaweiApiClient implements InnerApiClient, ServiceConnection {
    ...
    private volatile IAIDLInvoke f4473f;

    /* JADX INFO: renamed from: g */
    private String f4474g;

    /* JADX INFO: renamed from: h */
    private WeakReference<Activity> f4475h;

    /* JADX INFO: renamed from: i */
    private WeakReference<Activity> f4476i;

    /* JADX INFO: renamed from: l */
    private List<Scope> f4479l;

    /* JADX INFO: renamed from: m */
    private List<PermissionInfo> f4480m;

    /* JADX INFO: renamed from: n */
    private Map<Api<?>, Api.ApiOptions> f4481n;
    ...
    private AtomicInteger f4478k = new AtomicInteger(1);
    private long p = 0;
    private int q = 0;
    ...
    class a implements Handler.Callback {
        ...
        public boolean handleMessage(Message message) {
            ...
            if (HuaweiApiClientImpl.this.f4478k.get() == 5) {
    ...
    class b implements Handler.Callback {
        ...
        public boolean handleMessage(Message message) {
            ...
            if (HuaweiApiClientImpl.this.f4478k.get() == 2) {
                HuaweiApiClientImpl.this.c(1);
                HuaweiApiClientImpl.this.b();
            }
            return true;
    ...
    private class g implements ResultCallback<ResolveResult<JosGetNoticeResp>> {
        ...
        public void onResult(ResolveResult<JosGetNoticeResp> resolveResult) {
            ...
            Activity validActivity = Util.getValidActivity((Activity) HuaweiApiClientImpl.this.f4475h.get(), HuaweiApiClientImpl.this.getTopActivity());
            if (validActivity == null) {
                HMSLog.e("HuaweiApiClientImpl", "showNotice no valid activity!");
            } else {
                HuaweiApiClientImpl.this.f4477j = true;
    ...
    public HuaweiApiClientImpl(Context context) {
        ...
        this.f4470c = appId;
        this.f4471d = appId;
        this.f4472e = Util.getCpId(context);
    }

    private DisconnectInfo d() {
        ArrayList arrayList = new ArrayList();
        Map<Api<?>, Api.ApiOptions> map = this.f4481n;
        if (map != null) {
        ...
        return new DisconnectInfo(this.f4479l, arrayList);
    }

    private int e() {
        int hmsVersion = Util.getHmsVersion(this.f4469b);
    ...
    private void m() {
        ...
        } else if (HuaweiApiAvailability.getInstance().isHuaweiMobileNoticeAvailable(this.f4469b) == 0) {
            ConnectService.getNotice(this, 0, "6.11.0.302").setResultCallback(new g(this, null));
        }
    }

    private void n() {
        Util.unBindServiceCatchException(this.f4469b, this);
        this.f4473f = null;
    }
    ...
    public void connect(Activity activity) {
        ...
        int i2 = this.f4478k.get();
        HMSLog.i("HuaweiApiClientImpl", "Enter connect, Connection Status: " + i2);
        if (i2 == 3 || i2 == 5 || i2 == 2 || i2 == 4) {
            return;
        }
        if (activity != null) {
            this.f4475h = new WeakReference<>(activity);
            this.f4476i = new WeakReference<>(activity);
        }
        this.f4471d = TextUtils.isEmpty(this.f4470c) ? Util.getAppId(this.f4469b) : this.f4470c;
        int iE = e();
        HMSLog.i("HuaweiApiClientImpl", "connect minVersion:" + iE);
        HuaweiApiAvailability.setServicesVersionCode(iE);
        int iIsHuaweiMobileServicesAvailable = HuaweiMobileServicesUtil.isHuaweiMobileServicesAvailable(this.f4469b, iE);
        HMSLog.i("HuaweiApiClientImpl", "In connect, isHuaweiMobileServicesAvailable result: " + iIsHuaweiMobileServicesAvailable);
        this.q = HMSPackageManager.getInstance(this.f4469b).getHmsMultiServiceVersion();
    ...
    public String getPackageName() {
        return this.f4469b.getPackageName();
    }
    ...
    public boolean innerIsConnected() {
        return this.f4478k.get() == 3 || this.f4478k.get() == 4;
    }
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        a(2);
        this.f4473f = IAIDLInvoke.Stub.asInterface(iBinder);
        if (this.f4473f != null) {
            if (this.f4478k.get() == 5) {
                c(2);
                j();
                i();
                return;
            } else {
                if (this.f4478k.get() != 3) {
                    n();
                    return;
                }
                return;
        ...
        if (this.w != null) {
            ...
            WeakReference<Activity> weakReference = this.f4475h;
            if (weakReference != null && weakReference.get() != null) {
                resolveErrorPendingIntent = HuaweiApiAvailability.getInstance().getResolveErrorPendingIntent(this.f4475h.get(), 10);
            }
    ...
    public boolean setSubAppInfo(SubAppInfo subAppInfo) {
        ...
        if (subAppID.equals(TextUtils.isEmpty(this.f4470c) ? Util.getAppId(this.f4469b) : this.f4470c)) {
    ...
    private void b(int i2) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            resolveErrorPendingIntent = HuaweiApiAvailability.getInstance().getResolveErrorPendingIntent(this.f4475h.get(), i2);
    ...
    private void a() {
        Intent intent = new Intent(HMSPackageManager.getInstance(this.f4469b).getServiceAction());
        HMSPackageManager.getInstance(this.f4469b).refreshForMultiService();
        try {
            String hMSPackageNameForMultiService = HMSPackageManager.getInstance(this.f4469b).getHMSPackageNameForMultiService();
            ...
            synchronized (A) {
                if (this.f4469b.bindService(intent, this, 1)) {
                    h();
                    return;
                }
                c(1);
    ...
    private ConnectInfo c() {
        String packageSignature = new PackageManagerHelper(this.f4469b).getPackageSignature(this.f4469b.getPackageName());
        if (packageSignature == null) {
            packageSignature = "";
        }
        SubAppInfo subAppInfo = this.o;
        return new ConnectInfo(getApiNameList(), this.f4479l, packageSignature, subAppInfo == null ? null : subAppInfo.getSubAppID());
    }

    public void b() {
        n();
        if (this.w != null) {
            int i2 = UIUtil.isBackground(this.f4469b) ? 7 : 6;
            PendingIntent resolveErrorPendingIntent = null;
            WeakReference<Activity> weakReference = this.f4475h;
            if (weakReference != null && weakReference.get() != null) {
                resolveErrorPendingIntent = HuaweiApiAvailability.getInstance().getResolveErrorPendingIntent(this.f4475h.get(), i2);
        ...
        for (Map.Entry<Api<?>, Api.ApiOptions> entry : getApiMap().entrySet()) {
            if (entry.getKey().getmConnetctPostList() != null && !entry.getKey().getmConnetctPostList().isEmpty()) {
                ...
                for (ConnectionPostProcessor connectionPostProcessor : entry.getKey().getmConnetctPostList()) {
                    ...
                    connectionPostProcessor.run(this, this.f4475h);
                }
            }
        }
    }
    ...
    public void a(ResolveResult<ConnectResp> resolveResult) {
        ...
        if (this.f4473f != null && this.f4478k.get() == 2) {
            a(3);
            ConnectResp value = resolveResult.getValue();
            if (value != null) {
                this.f4474g = value.sessionId;
            }
            SubAppInfo subAppInfo = this.o;
            PendingIntent resolveErrorPendingIntent = null;
            String subAppID = subAppInfo == null ? null : subAppInfo.getSubAppID();
            if (!TextUtils.isEmpty(subAppID)) {
                this.f4471d = subAppID;
            }
            ...
            if (this.w != null) {
                WeakReference<Activity> weakReference = this.f4475h;
                if (weakReference != null && weakReference.get() != null) {
                    resolveErrorPendingIntent = HuaweiApiAvailability.getInstance().getResolveErrorPendingIntent(this.f4475h.get(), statusCode);
                }
