...
public abstract class HuaweiApiAvailability {
    ...
    public static void setServicesVersionCode(int i2) {
        servicesVersionCode = i2;
    }
    ...
    public abstract PendingIntent getErrPendingIntent(Context context, int i2, int i3);

    public abstract PendingIntent getErrPendingIntent(Context context, ConnectionResult connectionResult);

    public abstract Dialog getErrorDialog(Activity activity, int i2, int i3);

    public abstract Dialog getErrorDialog(Activity activity, int i2, int i3, DialogInterface.OnCancelListener onCancelListener);

    public abstract String getErrorString(int i2);

    public abstract Task<Void> getHuaweiServicesReady(Activity activity);

    public abstract Intent getResolveErrorIntent(Activity activity, int i2);

    public abstract PendingIntent getResolveErrorPendingIntent(Activity activity, int i2);
    ...
    public abstract int isHuaweiMobileServicesAvailable(Context context, int i2);

    public abstract boolean isUserResolvableError(int i2);

    public abstract boolean isUserResolvableError(int i2, PendingIntent pendingIntent);
    ...
    public abstract void resolveError(Activity activity, int i2, int i3, PendingIntent pendingIntent);

    public abstract boolean showErrorDialogFragment(Activity activity, int i2, int i3);

    public abstract boolean showErrorDialogFragment(Activity activity, int i2, int i3, DialogInterface.OnCancelListener onCancelListener);

    public abstract boolean showErrorDialogFragment(Activity activity, int i2, Fragment fragment, int i3, DialogInterface.OnCancelListener onCancelListener);

    public abstract void showErrorNotification(Context context, int i2);
}
