...
public final class PushReceiver extends BroadcastReceiver {
    ...
    private static class b implements Runnable {
        ...
        public void run() {
            ...
            intent.setPackage(this.f7283b.getPackage());
            try {
                JSONObject b2 = PushReceiver.b(this.f7283b);
                String string = JsonUtil.getString(b2, "moduleName", "");
                int i2 = JsonUtil.getInt(b2, "msgType", 0);
                int i3 = JsonUtil.getInt(b2, NotificationCompat.CATEGORY_STATUS, 0);
                ...
                if ("Push".equals(string) && i2 == 1) {
                    ...
                    if (this.f7283b.getExtras() != null) {
                        bundle.putAll(this.f7283b.getExtras());
                    }
                    bundle.putString("message_type", "received_message");
                    bundle.putString("message_id", this.f7283b.getStringExtra("msgIdStr"));
                    bundle.putByteArray(RemoteMessageConst.MSGBODY, this.f7283b.getByteArrayExtra("msg_data"));
                    bundle.putString(RemoteMessageConst.DEVICE_TOKEN, com.huawei.hms.push.a.a(this.f7283b.getByteArrayExtra(RemoteMessageConst.DEVICE_TOKEN)));
                    bundle.putInt(RemoteMessageConst.INPUT_TYPE, 1);
                    bundle.putString("message_proxy_type", this.f7283b.getStringExtra("message_proxy_type"));
                }
                if (new r().a(this.f7282a, bundle, intent)) {
                    HMSLog.i("PushReceiver", "receive " + this.f7283b.getAction() + " and start service success");
                    return;
                }
                HMSLog.e("PushReceiver", "receive " + this.f7283b.getAction() + " and start service failed");
    ...
    private static class c implements Runnable {
        ...
        /* renamed from: b, reason: collision with root package name */
        private Intent f7285b;

        @Override // java.lang.Runnable
        public void run() {
            try {
                byte[] byteArrayExtra = this.f7285b.getByteArrayExtra(RemoteMessageConst.DEVICE_TOKEN);
                if (byteArrayExtra != null && byteArrayExtra.length != 0) {
                    HMSLog.i("PushReceiver", "receive a push token: " + this.f7284a.getPackageName());
                    Intent intent = new Intent("com.huawei.push.action.MESSAGING_EVENT");
                    intent.setPackage(this.f7285b.getPackage());
                    Bundle bundle = new Bundle();
                    bundle.putString("message_type", "new_token");
                    bundle.putString(RemoteMessageConst.DEVICE_TOKEN, com.huawei.hms.push.a.a(byteArrayExtra));
                    bundle.putString(CommonCode.MapKey.TRANSACTION_ID, this.f7285b.getStringExtra(CommonCode.MapKey.TRANSACTION_ID));
                    bundle.putString("subjectId", this.f7285b.getStringExtra("subjectId"));
                    bundle.putInt("error", this.f7285b.getIntExtra("error", ErrorEnum.SUCCESS.getInternalCode()));
                    bundle.putString("belongId", this.f7285b.getStringExtra("belongId"));
                    if (new r().a(this.f7284a, bundle, intent)) {
                        return;
                    }
                    HMSLog.e("PushReceiver", "receive " + this.f7285b.getAction() + " and start service failed");
                    return;
                }
