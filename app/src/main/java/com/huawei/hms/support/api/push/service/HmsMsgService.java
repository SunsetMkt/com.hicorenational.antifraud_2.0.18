...
public class HmsMsgService extends Service {
    ...
    private static class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (Objects.equals(this.a.getApplicationContext().getPackageManager().getNameForUid(message.sendingUid), HMSPackageManager.getInstance(this.a).getHMSPackageName()) && data != null && HMSPackageManager.getInstance(this.a).getHMSPackageStates() == PackageManagerHelper.PackageStates.ENABLED) {
