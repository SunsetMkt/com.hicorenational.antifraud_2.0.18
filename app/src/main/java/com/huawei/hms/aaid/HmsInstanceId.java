...
public class HmsInstanceId {
        ...
        try {
            if (this.f6506b.containsKey("aaid")) {
                ...
                if (b.d(this.f6505a)) {
                    ...
                    DeleteTokenReq a2 = b.a(this.f6505a);
                    a2.setDeleteType(1);
    ...
    public void deleteToken(String str, String str2) throws ApiException {
        b();
        a();
        DeleteTokenReq a2 = b.a(this.f6505a, str, str2);
        a2.setMultiSender(false);
        a(a2, 1);
    }
    ...
    public String getToken(String str, String str2) throws ApiException {
        b();
        a();
        TokenReq b2 = b.b(this.f6505a, null, str2);
        b2.setAaid(getId());
    ...
    public void deleteToken(String str) throws ApiException {
        ...
        a();
        if (!TextUtils.isEmpty(str)) {
            String c2 = b.c(this.f6505a);
            if (!TextUtils.isEmpty(c2)) {
                if (str.equals(c2)) {
                    deleteToken(null, null);
                    return;
                }
                DeleteTokenReq a2 = b.a(this.f6505a, str);
    ...
    public String getToken(String str) throws ApiException {
        ...
        if (!TextUtils.isEmpty(str)) {
            ...
            if (!TextUtils.isEmpty(c2)) {
                ...
                TokenReq b2 = b.b(this.f6505a, str);
                b2.setAaid(getId());
    ...
    private String a(TokenReq tokenReq, int i2) throws ApiException {
        ...
        String a2 = h.a(this.f6505a, "push.gettoken");
        try {
            HMSLog.d(TAG, "getToken req :" + tokenReq.toString());
            g gVar = new g("push.gettoken", tokenReq, this.f6505a, a2);
            gVar.setApiLevel(i2);
            return ((TokenResult) Tasks.await(this.f6507c.doWrite(gVar))).getToken();
        } catch (Exception e2) {
            if (e2.getCause() instanceof ApiException) {
                ApiException apiException = (ApiException) e2.getCause();
                h.a(this.f6505a, "push.gettoken", a2, apiException.getStatusCode());
                throw apiException;
            }
    ...
    private void a(DeleteTokenReq deleteTokenReq, int i2) throws ApiException {
        ...
        String a2 = h.a(this.f6505a, "push.deletetoken");
        try {
            String b2 = i.a(this.f6505a).b(subjectId);
            if (deleteTokenReq.isMultiSender() && (TextUtils.isEmpty(b2) || b2.equals(i.a(this.f6505a).b(null)))) {
                i.a(this.f6505a).removeKey(subjectId);
            ...
            if (e2.getCause() instanceof ApiException) {
                ApiException apiException = (ApiException) e2.getCause();
                h.a(this.f6505a, "push.deletetoken", a2, apiException.getStatusCode());
                throw apiException;
            }
            Context context = this.f6505a;
            ErrorEnum errorEnum = ErrorEnum.ERROR_INTERNAL_ERROR;
