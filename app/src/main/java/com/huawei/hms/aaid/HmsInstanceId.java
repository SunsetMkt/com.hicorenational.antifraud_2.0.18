...
public class HmsInstanceId {
    ...
    private PushPreferences f4393b;

    /* JADX INFO: renamed from: c */
    private HuaweiApi<Api.ApiOptions.NoOptions> f4394c;

    private HmsInstanceId(Context context) {
        this.a = context.getApplicationContext();
        this.f4393b = new PushPreferences(context, "aaid");
        Api api = new Api(HuaweiApiAvailability.HMS_API_NAME_PUSH);
        if (context instanceof Activity) {
            this.f4394c = new HuaweiApi<>((Activity) context, (Api<Api.ApiOptions>) api, (Api.ApiOptions) null, (AbstractClientBuilder) new PushClientBuilder());
        } else {
            this.f4394c = new HuaweiApi<>(context, (Api<Api.ApiOptions>) api, (Api.ApiOptions) null, new PushClientBuilder());
        }
        this.f4394c.setKitSdkVersion(61200300);
    }
    ...
    public void deleteAAID() throws ApiException {
        b();
        try {
            if (this.f4393b.containsKey("aaid")) {
                this.f4393b.removeKey("aaid");
                this.f4393b.removeKey("creationTime");
                if (b.d(this.a)) {
    ...
    public long getCreationTime() {
        try {
            if (!this.f4393b.containsKey("creationTime")) {
                getAAID();
            }
            return this.f4393b.getLong("creationTime");
        } catch (Exception unused) {
            return 0L;
        }
    }
    ...
    private String a(TokenReq tokenReq, int i2) throws ApiException {
        ...
        try {
            ...
            gVar.setApiLevel(i2);
            return ((TokenResult) Tasks.await(this.f4394c.doWrite(gVar))).getToken();
        } catch (Exception e2) {
    ...
    private void a(DeleteTokenReq deleteTokenReq, int i2) throws ApiException {
        ...
        try {
            ...
            fVar.setApiLevel(i2);
            Tasks.await(this.f4394c.doWrite(fVar));
