...
public abstract class AbstractDialog {
    ...
    private AlertDialog f4962b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private Callback f4963c;
    ...
    public void cancel() {
        AlertDialog alertDialog = this.f4962b;
        if (alertDialog != null) {
            alertDialog.cancel();
        }
    }
    ...
    public void show(Activity activity, Callback callback) {
        ...
        this.f4962b = alertDialogOnCreateDialog;
        alertDialogOnCreateDialog.setCanceledOnTouchOutside(false);
        this.f4962b.setOnCancelListener(new c());
        this.f4962b.setOnKeyListener(new d());
        this.f4962b.show();
    }
}
