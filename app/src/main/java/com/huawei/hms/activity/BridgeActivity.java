...
public class BridgeActivity extends Activity {
    ...
    private static final int f4397b = a("ro.build.hw_emui_api_level", 0);
    ...
    protected void onActivityResult(int i2, int i3, Intent intent) {
        ...
        if (iBridgeActivityDelegate != null) {
            boolean zOnBridgeActivityResult = false;
            try {
                zOnBridgeActivityResult = iBridgeActivityDelegate.onBridgeActivityResult(i2, i3, safeIntent);
            } catch (Throwable unused) {
