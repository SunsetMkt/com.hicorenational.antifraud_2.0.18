...
public class HMSBIInitializer {
    ...
    public void a(String str) {
        ...
        HiAnalyticsInstance create = new HiAnalyticsInstance.Builder(this.f7368a).setOperConf(build).setMaintConf(new HiAnalyticsConfig.Builder().setEnableImei(false).setEnableUDID(false).setEnableSN(false).setCollectURL(str).build()).create(HiAnalyticsConstant.HA_SERVICE_TAG);
        f7367f = create;
        if (create != null) {
