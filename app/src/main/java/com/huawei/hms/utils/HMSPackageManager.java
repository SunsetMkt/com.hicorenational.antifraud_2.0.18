...
public class HMSPackageManager {
    ...
    private final PackageManagerHelper f4989b;
    ...
    public static class PackagePriorityInfo implements Comparable<PackagePriorityInfo> {
        ...
        public PackagePriorityInfo(String str, String str2, String str3, String str4, String str5, long j2) {
            ...
            this.f5004d = str4;
            this.f5005e = str5;
            this.f5006f = Long.valueOf(j2);
        }

        @Override // java.lang.Comparable
        public int compareTo(PackagePriorityInfo packagePriorityInfo) {
            return TextUtils.equals(this.f5005e, packagePriorityInfo.f5005e) ? this.f5006f.compareTo(packagePriorityInfo.f5006f) : this.f5005e.compareTo(packagePriorityInfo.f5005e);
        }
    }
    ...
    private HMSPackageManager(Context context) {
        this.a = context;
        this.f4989b = new PackageManagerHelper(context);
    }

    private boolean c(String str, String str2) {
        return Objects.equals(str2, this.f4989b.getPackageSigningCertificate(str)) || Objects.equals(str2, this.f4989b.getPackageSignature(str));
    }
    ...
    private Pair<String, String> g() {
        try {
            ...
            for (ResolveInfo resolveInfo : listQueryIntentServices) {
                String str = resolveInfo.serviceInfo.applicationInfo.packageName;
                String packageSigningCertificate = this.f4989b.getPackageSigningCertificate(str);
                String packageSignature = this.f4989b.getPackageSignature(str);
    ...
    private Pair<String, String> h() {
        ...
        if (pairG != null) {
            ...
            this.f4995h = "com.huawei.hms.core.aidlservice";
            this.f4996i = null;
            return pairG;
        }
        ...
        for (PackagePriorityInfo packagePriorityInfo : arrayListI) {
            String str = packagePriorityInfo.a;
            String str2 = packagePriorityInfo.f5002b;
            String str3 = packagePriorityInfo.f5003c;
            String str4 = packagePriorityInfo.f5004d;
            String packageSignature = this.f4989b.getPackageSignature(str);
            if (a(str + "&" + packageSignature + "&" + str2, str3, str4)) {
                HMSLog.i("HMSPackageManager", "result: " + str + ", " + str2 + ", " + packagePriorityInfo.f5006f);
                this.f4995h = PackageConstants.GENERAL_SERVICES_ACTION;
                d(str2);
    ...
    private ArrayList<PackagePriorityInfo> i() {
        try {
            ...
            for (ResolveInfo resolveInfo : listQueryIntentServices) {
                String str = resolveInfo.serviceInfo.applicationInfo.packageName;
                long packageFirstInstallTime = this.f4989b.getPackageFirstInstallTime(str);
    ...
    private void j() {
        synchronized (q) {
            ...
            this.f4990c = str;
            this.f4991d = (String) pairG.second;
            this.f4992e = this.f4989b.getPackageVersionCode(str);
            HMSLog.i("HMSPackageManager", "<initHmsPackageInfo> Succeed to find HMS apk: " + this.f4990c + " version: " + this.f4992e);
        }
    }
    ...
    private void k() {
        synchronized (q) {
            ...
            this.f4993f = (String) pairH.first;
            this.f4994g = (String) pairH.second;
            this.f4997j = this.f4989b.getPackageVersionCode(getHMSPackageNameForMultiService());
            e(this.f4993f);
            HMSLog.i("HMSPackageManager", "<initHmsPackageInfoForMultiService> Succeed to find HMS apk: " + this.f4993f + " version: " + this.f4997j);
        }
    }
    ...
    private boolean l() {
        ...
        if (!TextUtils.isEmpty(this.f4995h) && (this.f4995h.equals(PackageConstants.GENERAL_SERVICES_ACTION) || this.f4995h.equals(PackageConstants.INTERNAL_SERVICES_ACTION))) {
            HMSLog.i("HMSPackageManager", "action = " + this.f4995h + " exist");
            return false;
        }
    ...
    public String getHMSPackageName() {
        ...
        if (str != null) {
            if (PackageManagerHelper.PackageStates.NOT_INSTALLED.equals(this.f4989b.getPackageStates(str))) {
    ...
    public PackageManagerHelper.PackageStates getHMSPackageStates() {
        synchronized (p) {
            refresh();
            PackageManagerHelper.PackageStates packageStates = this.f4989b.getPackageStates(this.f4990c);
            ...
            boolean z = false;
            if ("com.huawei.hwid".equals(this.f4990c) && d() == 1) {
                return PackageManagerHelper.PackageStates.SPOOF;
            }
            if (packageStates == PackageManagerHelper.PackageStates.ENABLED && !c(this.f4990c, this.f4991d)) {
                z = true;
            }
    ...
    public PackageManagerHelper.PackageStates getHMSPackageStatesForMultiService() {
        synchronized (p) {
            refreshForMultiService();
            PackageManagerHelper.PackageStates packageStates = this.f4989b.getPackageStates(this.f4993f);
            PackageManagerHelper.PackageStates packageStates2 = PackageManagerHelper.PackageStates.NOT_INSTALLED;
            if (packageStates == packageStates2) {
                e();
                return packageStates2;
            ...
            boolean z = false;
            if ("com.huawei.hwid".equals(this.f4993f) && d() == 1) {
                return PackageManagerHelper.PackageStates.SPOOF;
            }
            if (packageStates == PackageManagerHelper.PackageStates.ENABLED && !c(this.f4993f, this.f4994g)) {
                z = true;
            }
            return z ? packageStates2 : packageStates;
        }
    ...
    public int getHmsMultiServiceVersion() {
        return this.f4989b.getPackageVersionCode(getHMSPackageNameForMultiService());
    }

    public int getHmsVersionCode() {
        return this.f4989b.getPackageVersionCode(getHMSPackageName());
    }
    ...
    public String getServiceAction() {
        return !TextUtils.isEmpty(this.f4995h) ? this.f4995h : "com.huawei.hms.core.aidlservice";
    }
    ...
    public boolean hmsVerHigherThan(int i2) {
        ...
        int packageVersionCode = this.f4989b.getPackageVersionCode(getHMSPackageName());
        this.f4992e = packageVersionCode;
    ...
    public boolean isUpdateHmsForThirdPartyDevice() {
        return "com.huawei.hwid".equals(this.f4993f) && AgHmsUpdateState.getInstance().isUpdateHms();
    }
    ...
    public void refreshForMultiService() {
        if (TextUtils.isEmpty(this.f4993f) || TextUtils.isEmpty(this.f4994g)) {
            k();
        }
        c(this.f4993f);
    }
    ...
    private boolean b(String str) {
        return !"com.huawei.hwid".equals(str) || this.f5001n == 3;
    }
    ...
    private void c(String str) {
        if ("com.huawei.hwid".equals(str) && AgHmsUpdateState.getInstance().isUpdateHms() && this.f4989b.getPackageVersionCode(str) >= AgHmsUpdateState.getInstance().getTargetVersionCode()) {
    ...
    public int d() {
        synchronized (r) {
            ...
            if (!(this.f4998k == 3 || this.f4999l != this.f4989b.getPackageFirstInstallTime("com.huawei.hwid"))) {
                HMSLog.i("HMSPackageManager", "quit checkHmsIsSpoof cached state: " + a(this.f4998k));
                return this.f4998k;
            }
            this.f4998k = c() ? 2 : 1;
            this.f4999l = this.f4989b.getPackageFirstInstallTime("com.huawei.hwid");
            HMSLog.i("HMSPackageManager", "quit checkHmsIsSpoof state: " + a(this.f4998k));
            return this.f4998k;
        }
    }
    ...
    private Pair<String, String> a(String str, String str2) {
        ...
        HMSLog.w("HMSPackageManager", "check sign fail: " + str + d.c.a.b.a.a.s1 + str2);
        return null;
    }
