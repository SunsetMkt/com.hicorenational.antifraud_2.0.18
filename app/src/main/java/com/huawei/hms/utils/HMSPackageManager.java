...
public class HMSPackageManager {
    ...
    class b implements Runnable {
        ...
        public void run() {
            ...
            try {
                List<ResolveInfo> queryIntentServices = HMSPackageManager.this.f7373a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
    ...
    private Pair<String, String> g() {
        try {
            List<ResolveInfo> queryIntentServices = this.f7373a.getPackageManager().queryIntentServices(new Intent("com.huawei.hms.core.aidlservice"), 128);
            if (queryIntentServices == null || queryIntentServices.size() == 0) {
    ...
    private Pair<String, String> h() {
        ...
        if (g2 != null) {
            HMSLog.i("HMSPackageManager", "aidlService pkgName: " + ((String) g2.first));
            this.f7380h = "com.huawei.hms.core.aidlservice";
            this.f7381i = null;
            return g2;
        }
        ArrayList<PackagePriorityInfo> i2 = i();
        if (i2 == null) {
            HMSLog.e("HMSPackageManager", "PackagePriorityInfo list is null");
            return null;
        }
        Iterator<PackagePriorityInfo> it = i2.iterator();
        while (it.hasNext()) {
    ...
    private ArrayList<PackagePriorityInfo> i() {
        try {
            List<ResolveInfo> queryIntentServices = this.f7373a.getPackageManager().queryIntentServices(new Intent(PackageConstants.GENERAL_SERVICES_ACTION), 128);
    ...
    private void k() {
        synchronized (q) {
            ...
            this.f7378f = (String) h2.first;
            this.f7379g = (String) h2.second;
    ...
    */
    public int d() {
        /*
            ...
            com.huawei.hms.utils.PackageManagerHelper r1 = r7.f7374b     // Catch: java.lang.Throwable -> L77
            java.lang.String r2 = "com.huawei.hwid"
            long r1 = r1.getPackageFirstInstallTime(r2)     // Catch: java.lang.Throwable -> L77
            int r3 = r7.f7383k     // Catch: java.lang.Throwable -> L77
            r4 = 3
            r5 = 1
            if (r3 == r4) goto L21
            long r3 = r7.f7384l     // Catch: java.lang.Throwable -> L77
        ...
        L22:
            ...
            com.huawei.hms.support.log.HMSLog.i(r1, r2)     // Catch: java.lang.Throwable -> L77
            int r1 = r7.f7383k     // Catch: java.lang.Throwable -> L77
        ...
        L44:
            ...
            r5 = 2
        L4b:
            r7.f7383k = r5     // Catch: java.lang.Throwable -> L77
            com.huawei.hms.utils.PackageManagerHelper r1 = r7.f7374b     // Catch: java.lang.Throwable -> L77
            java.lang.String r2 = "com.huawei.hwid"
            long r1 = r1.getPackageFirstInstallTime(r2)     // Catch: java.lang.Throwable -> L77
            r7.f7384l = r1     // Catch: java.lang.Throwable -> L77
            java.lang.String r1 = "HMSPackageManager"
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch: java.lang.Throwable -> L77
            r2.<init>()     // Catch: java.lang.Throwable -> L77
    ...
    private boolean a(String str, String str2, String str3) {
        if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3)) {
            ...
            if (!com.huawei.hms.device.a.a(com.huawei.hms.device.a.a(this.f7373a), b2)) {
