...
public class j<TranscodeType> extends com.bumptech.glide.r.a<j<TranscodeType>> implements Cloneable, g<j<TranscodeType>> {
    ...
    public j<TranscodeType> mo36clone() {
        ...
        jVar.m0 = (l<?, ? super TranscodeType>) jVar.m0.m37clone();
        return jVar;
    }
    ...
    private <Y extends p<TranscodeType>> Y b(@NonNull Y y, @Nullable com.bumptech.glide.r.g<TranscodeType> gVar, com.bumptech.glide.r.a<?> aVar, Executor executor) {
        ...
        if (this.t0) {
            ...
            if (a2.a(a3) && !a(aVar, a3)) {
                if (!((com.bumptech.glide.r.d) com.bumptech.glide.util.j.a(a3)).isRunning()) {
                    a3.c();
                }
                return y;
            }
    ...
    private com.bumptech.glide.r.d b(Object obj, p<TranscodeType> pVar, com.bumptech.glide.r.g<TranscodeType> gVar, @Nullable com.bumptech.glide.r.e eVar, l<?, ? super TranscodeType> lVar, h hVar, int i2, int i3, com.bumptech.glide.r.a<?> aVar, Executor executor) {
        ...
        if (jVar != null) {
            if (!this.u0) {
                ...
                com.bumptech.glide.r.d a2 = a(obj, pVar, gVar, aVar, kVar, lVar, hVar, i2, i3, executor);
                this.u0 = true;
                j<TranscodeType> jVar2 = this.p0;
                com.bumptech.glide.r.d a3 = jVar2.a(obj, pVar, gVar, kVar, lVar2, hVar2, q, p, jVar2, executor);
                this.u0 = false;
                kVar.a(a2, a3);
                return kVar;
            }
    ...
    public j<TranscodeType> a(@Nullable byte[] bArr) {
        ...
        if (!b2.C()) {
            b2 = b2.a((com.bumptech.glide.r.a<?>) com.bumptech.glide.r.h.b(com.bumptech.glide.load.p.j.f4571b));
        }
    ...
    public r<ImageView, TranscodeType> a(@NonNull ImageView imageView) {
        ...
        if (!K() && I() && imageView.getScaleType() != null) {
            switch (a.f4216a[imageView.getScaleType().ordinal()]) {
                case 1:
                    aVar = mo36clone().N();
                    break;
                case 2:
            ...
            return (r) b(this.l0.a(imageView, this.j0), null, aVar, com.bumptech.glide.util.d.b());
        }
        aVar = this;
        return (r) b(this.l0.a(imageView, this.j0), null, aVar, com.bumptech.glide.util.d.b());
    }
    ...
    private com.bumptech.glide.r.d a(Object obj, p<TranscodeType> pVar, @Nullable com.bumptech.glide.r.g<TranscodeType> gVar, @Nullable com.bumptech.glide.r.e eVar, l<?, ? super TranscodeType> lVar, h hVar, int i2, int i3, com.bumptech.glide.r.a<?> aVar, Executor executor) {
        ...
        com.bumptech.glide.r.d b2 = b(obj, pVar, gVar, eVar3, lVar, hVar, i2, i3, aVar, executor);
        if (eVar2 == null) {
            return b2;
        }
        int q = this.q0.q();
        ...
        bVar.a(b2, jVar.a(obj, pVar, gVar, bVar, jVar.m0, jVar.t(), q, p, this.q0, executor));
        return bVar;
    }
