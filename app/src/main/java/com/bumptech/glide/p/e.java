...
public final class e {
    ...
    private static final String f3429b = "ManifestParser";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f3430c = "GlideModule";
    ...
    public List<c> a() {
        ...
        try {
            ...
            if (Log.isLoggable(f3429b, 2)) {
                String str = "Got app info metadata: " + applicationInfo.metaData;
            }
            for (String str2 : applicationInfo.metaData.keySet()) {
                if (f3430c.equals(applicationInfo.metaData.get(str2))) {
                    arrayList.add(a(str2));
                    if (Log.isLoggable(f3429b, 3)) {
