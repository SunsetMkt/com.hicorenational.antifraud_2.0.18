...
public class d {
    ...
    private void f() {
        ...
        this.f5182c.f5161d.f5151e = (e2 & 64) != 0;
        if (z) {
            this.f5182c.f5161d.f5157k = a(pow);
        } else {
    ...
    private void i() {
        ...
        this.f5182c.f5161d.f5152f = (e2 & 1) != 0;
        int m2 = m();
        if (m2 < 2) {
            m2 = 10;
        }
    ...
    private void o() {
        ...
        do {
            e2 = e();
            this.f5181b.position(Math.min(this.f5181b.position() + e2, this.f5181b.limit()));
        } while (e2 > 0);
    }
