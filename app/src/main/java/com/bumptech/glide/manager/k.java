...
public class k implements Handler.Callback {
    ...
    public boolean handleMessage(Message message) {
        ...
        if (z && remove == null && Log.isLoggable(f5082j, 5)) {
    ...
    private Fragment a(@NonNull View view, @NonNull FragmentActivity fragmentActivity) {
        ...
        while (!view.equals(findViewById) && (fragment = this.f5091f.get(view)) == null && (view.getParent() instanceof View)) {
    ...
    private android.app.Fragment a(@NonNull View view, @NonNull Activity activity) {
        ...
        android.app.Fragment fragment = null;
        while (!view.equals(findViewById) && (fragment = this.f5092g.get(view)) == null && (view.getParent() instanceof View)) {
            view = (View) view.getParent();
        }
        this.f5092g.clear();
        return fragment;
    ...
    private com.bumptech.glide.k a(@NonNull Context context, @NonNull FragmentManager fragmentManager, @Nullable android.app.Fragment fragment, boolean z) {
        ...
        com.bumptech.glide.k a3 = this.f5090e.a(com.bumptech.glide.b.a(context), a2.b(), a2.d(), context);
        a2.a(a3);
        return a3;
    }
    ...
    private com.bumptech.glide.k a(@NonNull Context context, @NonNull androidx.fragment.app.FragmentManager fragmentManager, @Nullable Fragment fragment, boolean z) {
        ...
        com.bumptech.glide.k f2 = a2.f();
        if (f2 != null) {
            return f2;
        }
        com.bumptech.glide.k a3 = this.f5090e.a(com.bumptech.glide.b.a(context), a2.e(), a2.g(), context);
        a2.a(a3);
        return a3;
    }
}
