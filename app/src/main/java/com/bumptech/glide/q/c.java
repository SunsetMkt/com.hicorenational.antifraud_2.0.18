...
public class c {
    ...
    private static final t<?, ?, ?> f3432c = new t<>(Object.class, Object.class, Object.class, Collections.singletonList(new i(Object.class, Object.class, Object.class, Collections.emptyList(), new g(), null)), null);
    private final ArrayMap<com.bumptech.glide.util.i, t<?, ?, ?>> a = new ArrayMap<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final AtomicReference<com.bumptech.glide.util.i> f3433b = new AtomicReference<>();

    private com.bumptech.glide.util.i b(Class<?> cls, Class<?> cls2, Class<?> cls3) {
        com.bumptech.glide.util.i andSet = this.f3433b.getAndSet(null);
        if (andSet == null) {
    ...
    public <Data, TResource, Transcode> t<Data, TResource, Transcode> a(Class<Data> cls, Class<TResource> cls2, Class<Transcode> cls3) {
        ...
        synchronized (this.a) {
            tVar = (t) this.a.get(iVarB);
        }
        this.f3433b.set(iVarB);
        return tVar;
    }
