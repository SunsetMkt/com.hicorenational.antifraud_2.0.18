...
public class a implements l<ByteBuffer, GifDrawable> {
    ...
    public d a(@NonNull ByteBuffer byteBuffer, int i2, int i3, @NonNull j jVar) {
        com.bumptech.glide.o.d a2 = this.f5015c.a(byteBuffer);
        try {
    ...
    private d a(ByteBuffer byteBuffer, int i2, int i3, com.bumptech.glide.o.d dVar, j jVar) {
        ...
        try {
            ...
            if (c2.b() > 0 && c2.c() == 0) {
                ...
                com.bumptech.glide.o.a a3 = this.f5016d.a(this.f5017e, c2, byteBuffer, a(c2, i2, i3));
                a3.a(config);
                a3.b();
                Bitmap a4 = a3.a();
                if (a4 == null) {
                ...
                d dVar2 = new d(new GifDrawable(this.f5013a, a3, com.bumptech.glide.load.r.c.a(), i2, i3, a4));
                if (Log.isLoggable(f5010f, 2)) {
                    String str = "Decoded GIF from stream in " + com.bumptech.glide.util.f.a(a2);
                }
                return dVar2;
            }
            if (Log.isLoggable(f5010f, 2)) {
                String str2 = "Decoded GIF from stream in " + com.bumptech.glide.util.f.a(a2);
            }
            return null;
        } finally {
            if (Log.isLoggable(f5010f, 2)) {
                String str3 = "Decoded GIF from stream in " + com.bumptech.glide.util.f.a(a2);
            }
        }
    }
    ...
    private static int a(com.bumptech.glide.o.c cVar, int i2, int i3) {
        ...
        if (Log.isLoggable(f5010f, 2) && max > 1) {
