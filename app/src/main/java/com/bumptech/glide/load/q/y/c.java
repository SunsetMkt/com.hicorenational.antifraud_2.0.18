...
public class c implements n<Uri, InputStream> {
    ...
    private static final Set<String> f3114b = Collections.unmodifiableSet(new HashSet(Arrays.asList(HttpConstant.HTTP, HttpConstant.HTTPS)));
    ...
    public n.a<InputStream> a(@NonNull Uri uri, int i2, int i3, @NonNull j jVar) {
        return this.a.a(new com.bumptech.glide.load.q.g(uri.toString()), i2, i3, jVar);
    }

    @Override // com.bumptech.glide.load.q.n
    public boolean a(@NonNull Uri uri) {
        return f3114b.contains(uri.getScheme());
    }
}
