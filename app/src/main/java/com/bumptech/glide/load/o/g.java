...
public final class g extends FilterInputStream {
    ...
    public int read() throws IOException {
        int i2;
        int i3 = this.f4274b;
        int read = (i3 < 2 || i3 > (i2 = f4272f)) ? super.read() : i3 == i2 ? this.f4273a : f4270d[i3 - 2] & f1.f16099c;
        if (read != -1) {
            this.f4274b++;
        }
        return read;
    ...
    public long skip(long j2) throws IOException {
        ...
        if (skip > 0) {
            this.f4274b = (int) (this.f4274b + skip);
        }
        return skip;
    }
    ...
    public int read(@NonNull byte[] bArr, int i2, int i3) throws IOException {
        ...
        if (i5 > i6) {
            ...
            System.arraycopy(f4270d, this.f4274b - 2, bArr, i2, min);
            i4 = min;
        }
        if (i4 > 0) {
            this.f4274b += i4;
