...
class e {
    ...
    */
    private java.lang.String c(@androidx.annotation.NonNull android.net.Uri r5) {
        /*
            r4 = this;
            r0 = 0
    ...
    int a(Uri uri) {
        ...
        try {
            try {
                inputStream = this.f4317d.openInputStream(uri);
                int a2 = f.a(this.f4318e, inputStream, this.f4316c);
                if (inputStream != null) {
                    try {
                        inputStream.close();
    ...
    public InputStream b(Uri uri) throws FileNotFoundException {
        ...
        File a2 = this.f4314a.a(c2);
        if (!a(a2)) {
            return null;
        }
        Uri fromFile = Uri.fromFile(a2);
        try {
            return this.f4317d.openInputStream(fromFile);
