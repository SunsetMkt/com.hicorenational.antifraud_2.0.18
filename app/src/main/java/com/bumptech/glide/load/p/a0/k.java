...
public class k implements e {
    ...
    private synchronized Bitmap d(int i2, int i3, @Nullable Bitmap.Config config) {
        Bitmap a2;
        a(config);
        a2 = this.f4363a.a(i2, i3, config != null ? config : f4362l);
        if (a2 == null) {
    ...
    private synchronized void a(long j2) {
        while (this.f4368f > j2) {
            Bitmap removeLast = this.f4363a.removeLast();
            if (removeLast == null) {
            ...
            this.f4366d.a(removeLast);
            this.f4368f -= this.f4363a.b(removeLast);
            this.f4372j++;
            if (Log.isLoggable(f4361k, 3)) {
                String str = "Evicting bitmap=" + this.f4363a.c(removeLast);
            }
            g();
            removeLast.recycle();
        }
