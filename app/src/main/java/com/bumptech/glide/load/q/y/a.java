...
public abstract class a<Model> implements n<Model, InputStream> {
    ...
    public n.a<InputStream> a(@NonNull Model model, int i2, int i3, @NonNull j jVar) {
        ...
        com.bumptech.glide.load.q.g a2 = mVar != null ? mVar.a(model, i2, i3) : null;
        if (a2 == null) {
            String d2 = d(model, i2, i3, jVar);
            if (TextUtils.isEmpty(d2)) {
                return null;
            }
            com.bumptech.glide.load.q.g gVar = new com.bumptech.glide.load.q.g(d2, c(model, i2, i3, jVar));
        ...
        n.a<InputStream> a3 = this.f4792a.a(a2, i2, i3, jVar);
        return (a3 == null || b2.isEmpty()) ? a3 : new n.a<>(a3.f4747a, a((Collection<String>) b2), a3.f4749c);
    }
