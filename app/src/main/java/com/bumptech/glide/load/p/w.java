...
class w implements f, d.a<Object> {
    ...
    public boolean a() {
        List<com.bumptech.glide.load.g> c2 = this.f4656b.c();
        boolean z = false;
        if (c2.isEmpty()) {
            return false;
        }
        List<Class<?>> k2 = this.f4656b.k();
        if (k2.isEmpty()) {
        ...
        while (true) {
            ...
            this.f4658d++;
            if (this.f4658d >= k2.size()) {
                this.f4657c++;
                if (this.f4657c >= c2.size()) {
                    return false;
                }
                this.f4658d = 0;
            }
            com.bumptech.glide.load.g gVar = c2.get(this.f4657c);
            Class<?> cls = k2.get(this.f4658d);
