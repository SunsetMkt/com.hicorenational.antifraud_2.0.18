...
public final class o implements ImageHeaderParser {
    ...
    private static final class a implements c {
        ...
        public int read(byte[] bArr, int i2) {
            int min = Math.min(i2, this.f4914a.remaining());
            if (min == 0) {
                return -1;
            }
            this.f4914a.get(bArr, 0, min);
            return min;
        }

        @Override // com.bumptech.glide.load.r.d.o.c
        public long skip(long j2) {
            int min = (int) Math.min(this.f4914a.remaining(), j2);
            ...
            if (a5 == n) {
                ...
                if (a6 >= 1 && a6 <= 12) {
                    ...
                    if (b3 < 0) {
                        ...
                        if (i3 > 4) {
                            if (Log.isLoggable(f4902b, 3)) {
                                String str3 = "Got byte count > 4, not orientation, continuing, formatCode=" + ((int) a6);
                            }
                        } else {
                            int i4 = a4 + 8;
                            if (i4 >= 0 && i4 <= bVar.a()) {
                                ...
                                String str5 = "Illegal tagValueOffset=" + i4 + " tagType=" + ((int) a5);
                            }
                        }
                    }
                } else if (Log.isLoggable(f4902b, 3)) {
