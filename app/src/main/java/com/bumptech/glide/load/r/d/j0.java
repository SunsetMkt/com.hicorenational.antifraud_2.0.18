...
public class j0<T> implements com.bumptech.glide.load.l<T, Bitmap> {
    ...
    static final class d implements f<ByteBuffer> {
        ...
        class a extends MediaDataSource {
            ...
            public int readAt(long j2, byte[] bArr, int i2, int i3) {
                ...
                int min = Math.min(i3, this.f4892a.remaining());
                this.f4892a.get(bArr, i2, min);
                return min;
            }
        }
    ...
    public com.bumptech.glide.load.p.v<Bitmap> a(@NonNull T t, int i2, int i3, @NonNull com.bumptech.glide.load.j jVar) throws IOException {
        long longValue = ((Long) jVar.a(f4884g)).longValue();
        ...
        p pVar2 = pVar;
        MediaMetadataRetriever a2 = this.f4889c.a();
        try {
            try {
                this.f4887a.a(a2, t);
                Bitmap a3 = a(a2, longValue, num.intValue(), i2, i3, pVar2);
                a2.release();
                return com.bumptech.glide.load.r.d.g.a(a3, this.f4888b);
    ...
    private static Bitmap a(MediaMetadataRetriever mediaMetadataRetriever, long j2, int i2, int i3, int i4, p pVar) {
        Bitmap b2 = (Build.VERSION.SDK_INT < 27 || i3 == Integer.MIN_VALUE || i4 == Integer.MIN_VALUE || pVar == p.f4922f) ? null : b(mediaMetadataRetriever, j2, i2, i3, i4, pVar);
