...
final class x implements com.bumptech.glide.load.g {
    ...
    @Override // com.bumptech.glide.load.g
    public int hashCode() {
        int hashCode = (((((this.f4667d.hashCode() * 31) + this.f4668e.hashCode()) * 31) + this.f4669f) * 31) + this.f4670g;
        com.bumptech.glide.load.n<?> nVar = this.f4673j;
        if (nVar != null) {
            hashCode = (hashCode * 31) + nVar.hashCode();
        }
        return (((hashCode * 31) + this.f4671h.hashCode()) * 31) + this.f4672i.hashCode();
    }
