...
public final class l {
    ...
    l(a aVar) {
        ...
        int a2 = a(aVar.f4436b, aVar.f4440f, aVar.f4441g);
        float b2 = aVar.f4437c.b() * aVar.f4437c.a() * 4;
        int round = Math.round(aVar.f4439e * b2);
        int round2 = Math.round(b2 * aVar.f4438d);
        int i2 = a2 - this.f4429d;
        int i3 = round2 + round;
        if (i3 <= i2) {
            this.f4427b = round2;
            this.f4426a = round;
