...
public final class q {
    ...
    private com.bumptech.glide.load.p.v<Bitmap> a(x xVar, int i2, int i3, com.bumptech.glide.load.j jVar, b bVar) throws IOException {
        ...
        try {
            return g.a(a(xVar, a2, (p) jVar.a(p.f4924h), bVar2, kVar, jVar.a(f4932k) != null && ((Boolean) jVar.a(f4932k)).booleanValue(), i2, i3, ((Boolean) jVar.a(f4931j)).booleanValue(), bVar), this.f4935a);
        } finally {
            c(a2);
    ...
    private Bitmap a(x xVar, BitmapFactory.Options options, p pVar, com.bumptech.glide.load.b bVar, com.bumptech.glide.load.k kVar, boolean z, int i2, int i3, boolean z2, b bVar2) throws IOException {
        ...
        int[] b2 = b(xVar, options, bVar2, this.f4935a);
        boolean z3 = false;
        int i8 = b2[0];
        int i9 = b2[1];
        ...
        ImageHeaderParser.ImageType c2 = xVar.c();
        a(c2, xVar, bVar2, this.f4935a, pVar, a4, i8, i9, i5, i6, options);
        a(xVar, bVar, z4, b3, options, i5, i6);
        ...
        if (options.inSampleSize == 1 || z5) {
            ...
            if (qVar.a(c2)) {
                ...
                if (round > 0 && round2 > 0) {
                    a(options, qVar.f4935a, round, round2);
                }
            }
        } else {
            qVar = this;
        ...
        Bitmap a5 = a(xVar, options, bVar2, qVar.f4935a);
        bVar2.a(qVar.f4935a, a5);
        if (Log.isLoggable(f4927f, 2)) {
            i7 = a3;
            a(i8, i9, str, options, a5, i2, i3, a2);
        } else {
            i7 = a3;
        }
        Bitmap bitmap = null;
        if (a5 != null) {
            a5.setDensity(qVar.f4936b.densityDpi);
            bitmap = g0.a(qVar.f4935a, a5, i7);
            if (!a5.equals(bitmap)) {
                qVar.f4935a.a(a5);
            }
        }
    ...
    private static void a(ImageHeaderParser.ImageType imageType, x xVar, b bVar, com.bumptech.glide.load.p.a0.e eVar, p pVar, int i2, int i3, int i4, int i5, int i6, BitmapFactory.Options options) throws IOException {
        ...
        if (i3 > 0 && i4 > 0) {
            ...
            float b2 = pVar.b(i7, i8, i5, i6);
            if (b2 > 0.0f) {
                p.g a2 = pVar.a(i7, i8, i5, i6);
                if (a2 != null) {
                    float f2 = i7;
                    float f3 = i8;
                    int c2 = i7 / c(b2 * f2);
                        ...
                        if (imageType != ImageHeaderParser.ImageType.PNG && imageType != ImageHeaderParser.ImageType.PNG_A) {
                            if (imageType != ImageHeaderParser.ImageType.WEBP && imageType != ImageHeaderParser.ImageType.WEBP_A) {
                                if (i7 % max == 0 && i8 % max == 0) {
                                    ...
                                    int[] b3 = b(xVar, options, bVar, eVar);
                                    floor = b3[0];
                                    i9 = b3[1];
                                }
                    ...
                    double b4 = pVar.b(floor, i9, i5, i6);
                    ...
                    if (Log.isLoggable(f4927f, 2)) {
                        String str = "Calculate scaling, source: [" + i3 + "x" + i4 + "], degreesToRotate: " + i2 + ", target: [" + i5 + "x" + i6 + "], power of two scaled: [" + floor + "x" + i9 + "], exact scale factor: " + b2 + ", power of 2 sample size: " + max + ", adjusted scale factor: " + b4 + ", target density: " + options.inTargetDensity + ", density: " + options.inDensity;
                        return;
                    }
                    return;
                }
            ...
            throw new IllegalArgumentException("Cannot scale with factor: " + b2 + " from: " + pVar + ", source: [" + i3 + "x" + i4 + "], target: [" + i5 + "x" + i6 + "]");
        }
