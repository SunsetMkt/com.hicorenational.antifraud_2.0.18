...
class h<R> implements f.a, Runnable, Comparable<h<?>>, a.f {
    ...
    private void e() {
        ...
        v<R> vVar = null;
        try {
            vVar = a(this.B, (com.bumptech.glide.load.o.d<?>) this.z, this.A);
        } catch (q e2) {
    ...
    private void l() {
        ...
        if ((this.r == EnumC0065h.FINISHED || this.E) && !z) {
            h();
        }
    }
    ...
    boolean d() {
        EnumC0065h a2 = a(EnumC0065h.INITIALIZE);
        return a2 == EnumC0065h.RESOURCE_CACHE || a2 == EnumC0065h.DATA_CACHE;
    }
    ...
    private <Data, ResourceType> v<R> a(Data data, com.bumptech.glide.load.a aVar, t<Data, ResourceType, R> tVar) throws q {
        ...
        com.bumptech.glide.load.o.e<Data> b2 = this.f4545h.f().b((com.bumptech.glide.i) data);
        try {
            return tVar.a(b2, a2, this.f4549l, this.f4550m, new c(aVar));
        } finally {
            b2.b();
        }
    }
    ...
    <Z> v<Z> a(com.bumptech.glide.load.a aVar, @NonNull v<Z> vVar) {
        ...
        if (aVar != com.bumptech.glide.load.a.RESOURCE_DISK_CACHE) {
            com.bumptech.glide.load.n<Z> b2 = this.f4538a.b(cls);
            nVar = b2;
            vVar2 = b2.a(this.f4545h, vVar, this.f4549l, this.f4550m);
        } else {
            vVar2 = vVar;
            nVar = null;
        }
        ...
        if (this.f4538a.b((v<?>) vVar2)) {
            mVar = this.f4538a.a((v) vVar2);
            cVar = mVar.a(this.o);
        } else {
            cVar = com.bumptech.glide.load.c.NONE;
        }
        com.bumptech.glide.load.m mVar2 = mVar;
        if (!this.n.a(!this.f4538a.a(this.x), aVar, cVar)) {
            return vVar2;
        }
        if (mVar2 != null) {
            int i2 = a.f4553c[cVar.ordinal()];
            if (i2 == 1) {
