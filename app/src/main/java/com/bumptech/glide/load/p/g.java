...
final class g<Transcode> {
    ...
    List<n.a<?>> g() {
        if (!this.f4536l) {
            this.f4536l = true;
            this.f4525a.clear();
            List a2 = this.f4527c.f().a((com.bumptech.glide.i) this.f4528d);
            int size = a2.size();
            for (int i2 = 0; i2 < size; i2++) {
                n.a<?> a3 = ((com.bumptech.glide.load.q.n) a2.get(i2)).a(this.f4528d, this.f4529e, this.f4530f, this.f4533i);
                if (a3 != null) {
                    this.f4525a.add(a3);
                }
            }
    ...
    boolean a(com.bumptech.glide.load.g gVar) {
        ...
        int size = g2.size();
        for (int i2 = 0; i2 < size; i2++) {
            if (g2.get(i2).f4747a.equals(gVar)) {
                return true;
            }
        }
        return false;
