...
final class a implements Runnable {
    ...
    boolean a() {
        Bitmap createBitmap;
        long a2 = this.f4499d.a();
        while (!this.f4498c.b() && !a(a2)) {
            d c2 = this.f4498c.c();
            if (this.f4500e.contains(c2)) {
                createBitmap = Bitmap.createBitmap(c2.d(), c2.b(), c2.a());
            } else {
                this.f4500e.add(c2);
                createBitmap = this.f4496a.b(c2.d(), c2.b(), c2.a());
            }
            int a3 = l.a(createBitmap);
            if (c() >= a3) {
                this.f4497b.a(new b(), com.bumptech.glide.load.r.d.g.a(createBitmap, this.f4496a));
            } else {
                this.f4496a.a(createBitmap);
            }
