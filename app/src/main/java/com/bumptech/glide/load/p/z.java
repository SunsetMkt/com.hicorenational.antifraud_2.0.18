...
class z implements f, f.a {
    ...
    public boolean a() {
        ...
        boolean z = false;
        while (!z && c()) {
            List<n.a<?>> g2 = this.f4678a.g();
            int i2 = this.f4680c;
            this.f4680c = i2 + 1;
            this.f4683f = g2.get(i2);
    ...
    private void a(Object obj) {
        ...
        try {
            com.bumptech.glide.load.d<X> a3 = this.f4678a.a((g<?>) obj);
            e eVar = new e(a3, obj, this.f4678a.i());
            this.f4684g = new d(this.f4683f.f4747a, this.f4678a.l());
            this.f4678a.d().a(this.f4684g, eVar);
            if (Log.isLoggable(f4677h, 2)) {
                String str = "Finished encoding source to cache, key: " + this.f4684g + ", data: " + obj + ", encoder: " + a3 + ", duration: " + com.bumptech.glide.util.f.a(a2);
            }
    ...
    void a(n.a<?> aVar, Object obj) {
        j e2 = this.f4678a.e();
        if (obj != null && e2.a(aVar.f4749c.c())) {
            this.f4682e = obj;
            this.f4679b.b();
        } else {
