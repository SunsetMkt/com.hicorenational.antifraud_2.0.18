...
public class o implements l {
    ...
    public void a(Bitmap bitmap) {
        b a2 = this.f4380a.a(com.bumptech.glide.util.l.a(bitmap), bitmap.getConfig());
        this.f4381b.a(a2, bitmap);
        NavigableMap<Integer, Integer> b2 = b(bitmap.getConfig());
        Integer num = (Integer) b2.get(Integer.valueOf(a2.f4385b));
        b2.put(Integer.valueOf(a2.f4385b), Integer.valueOf(num != null ? 1 + num.intValue() : 1));
    }
    ...
    public Bitmap removeLast() {
        Bitmap a2 = this.f4381b.a();
        if (a2 != null) {
            a(Integer.valueOf(com.bumptech.glide.util.l.a(a2)), a2);
        }
        return a2;
    }
    ...
    public Bitmap a(int i2, int i3, Bitmap.Config config) {
        b a2 = a(com.bumptech.glide.util.l.a(i2, i3, config), config);
        Bitmap a3 = this.f4381b.a((h<b, Bitmap>) a2);
        if (a3 != null) {
            a(Integer.valueOf(a2.f4385b), a3);
    ...
    private b a(int i2, Bitmap.Config config) {
        ...
        for (Bitmap.Config config2 : a(config)) {
            ...
            if (ceilingKey != null && ceilingKey.intValue() <= i2 * 8) {
                ...
                this.f4380a.a(a2);
                return this.f4380a.a(ceilingKey.intValue(), config2);
            }
        }
        return a2;
    }
