...
public final class j<R> implements d, o, i {
    ...
    private void q() {
        if (h()) {
            Drawable l2 = this.f5250h == null ? l() : null;
            if (l2 == null) {
                l2 = k();
            }
            if (l2 == null) {
    ...
    */
    public void a(com.bumptech.glide.load.p.v<?> r6, com.bumptech.glide.load.a r7) {
        /*
            r5 = this;
    ...
    private void a(v<R> vVar, R r, com.bumptech.glide.load.a aVar) {
        ...
        try {
            if (this.o != null) {
                ...
                z = false;
                while (it.hasNext()) {
                    z |= it.next().a(r, this.f5250h, this.n, aVar, n);
                }
            } else {
                z = false;
            }
            if (this.f5246d == null || !this.f5246d.a(r, this.f5250h, this.n, aVar, n)) {
                z2 = false;
            }
            if (!(z2 | z)) {
        ...
        synchronized (this.f5245c) {
            ...
            try {
                if (this.o != null) {
                    ...
                    z = false;
                    while (it.hasNext()) {
                        z |= it.next().a(qVar, this.f5250h, this.n, n());
                    }
                } else {
                    z = false;
                }
