...
public final class m<Z> extends e<Z> {
    ...
    private static final int f3518e = 1;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Handler f3519f = new Handler(Looper.getMainLooper(), new a());

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final com.bumptech.glide.k f3520d;
    ...
    public void a(@NonNull Z z, @Nullable com.bumptech.glide.r.m.f<? super Z> fVar) {
        f3519f.obtainMessage(1, this).sendToTarget();
    }
}
