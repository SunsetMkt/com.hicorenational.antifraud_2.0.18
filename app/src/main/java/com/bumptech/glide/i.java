...
public class i {
    ...
    public <Model, TResource, Transcode> List<Class<?>> b(@NonNull Class<Model> cls, @NonNull Class<TResource> cls2, @NonNull Class<Transcode> cls3) {
        List<Class<?>> a2 = this.f4213h.a(cls, cls2, cls3);
        if (a2 == null) {
            a2 = new ArrayList<>();
            Iterator<Class<?>> it = this.f4206a.a((Class<?>) cls).iterator();
            while (it.hasNext()) {
                for (Class<?> cls4 : this.f4208c.b(it.next(), cls2)) {
                    if (!this.f4211f.b(cls4, cls3).isEmpty() && !a2.contains(cls4)) {
                        a2.add(cls4);
                    }
                }
            }
            this.f4213h.a(cls, cls2, cls3, Collections.unmodifiableList(a2));
        }
        return a2;
    }
    ...
    public <Data, TResource, Transcode> t<Data, TResource, Transcode> a(@NonNull Class<Data> cls, @NonNull Class<TResource> cls2, @NonNull Class<Transcode> cls3) {
        t<Data, TResource, Transcode> a2 = this.f4214i.a(cls, cls2, cls3);
        if (this.f4214i.a(a2)) {
            return null;
        }
        if (a2 == null) {
            List<com.bumptech.glide.load.p.i<Data, TResource, Transcode>> c2 = c(cls, cls2, cls3);
            a2 = c2.isEmpty() ? null : new t<>(cls, cls2, cls3, c2, this.f4215j);
            this.f4214i.a(cls, cls2, cls3, a2);
        }
        return a2;
    }
    ...
    public <X> com.bumptech.glide.load.d<X> c(@NonNull X x) throws e {
        com.bumptech.glide.load.d<X> a2 = this.f4207b.a(x.getClass());
        if (a2 != null) {
            return a2;
        }
    ...
    public List<ImageHeaderParser> a() {
        List<ImageHeaderParser> a2 = this.f4212g.a();
        if (a2.isEmpty()) {
            throw new b();
        }
        return a2;
