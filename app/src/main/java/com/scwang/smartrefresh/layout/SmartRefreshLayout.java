...
public class SmartRefreshLayout extends ViewGroup implements com.scwang.smartrefresh.layout.b.j, NestedScrollingParent {
    ...
    class g implements Runnable {
        ...
        public void run() {
            ...
            SmartRefreshLayout smartRefreshLayout2 = SmartRefreshLayout.this;
            int a2 = smartRefreshLayout2.A0.a(smartRefreshLayout2, this.f8224a);
            SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
            com.scwang.smartrefresh.layout.d.c cVar = smartRefreshLayout3.j0;
            if (cVar != null) {
            ...
            if (a2 < Integer.MAX_VALUE) {
                ...
                if (smartRefreshLayout4.n || smartRefreshLayout4.m0) {
                    ...
                    SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 0, smartRefreshLayout6.f8214j, (smartRefreshLayout6.f8215k + smartRefreshLayout6.f8206b) - (smartRefreshLayout6.f8205a * 2), 0));
                    SmartRefreshLayout smartRefreshLayout7 = SmartRefreshLayout.this;
                    SmartRefreshLayout.super.dispatchTouchEvent(MotionEvent.obtain(currentTimeMillis, currentTimeMillis, 2, smartRefreshLayout7.f8214j, smartRefreshLayout7.f8215k + smartRefreshLayout7.f8206b, 0));
                ...
                if (i2 <= 0) {
                    if (i2 < 0) {
                        smartRefreshLayout9.a(0, a2, smartRefreshLayout9.y, smartRefreshLayout9.f8210f);
                        return;
                    } else {
                ...
                ValueAnimator a3 = smartRefreshLayout9.a(0, a2, smartRefreshLayout9.y, smartRefreshLayout9.f8210f);
                SmartRefreshLayout smartRefreshLayout10 = SmartRefreshLayout.this;
                ValueAnimator.AnimatorUpdateListener a4 = smartRefreshLayout10.N ? smartRefreshLayout10.C0.a(smartRefreshLayout10.f8206b) : null;
                if (a3 == null || a4 == null) {
                    return;
                }
    ...
    class h implements Runnable {
        ...
        class a implements Runnable {
            ...
            public void run() {
                ...
                SmartRefreshLayout smartRefreshLayout = SmartRefreshLayout.this;
                ValueAnimator.AnimatorUpdateListener a2 = (!smartRefreshLayout.M || this.f8229a >= 0) ? null : smartRefreshLayout.C0.a(smartRefreshLayout.f8206b);
                if (a2 != null) {
                ...
                if (i2 > 0) {
                    ...
                    if (a2 != null || i2 == 0) {
                        ...
                        if (i2 >= (-i3)) {
                            ...
                            valueAnimator = smartRefreshLayout2.F0.a(-i3);
                        }
                    } else {
                        valueAnimator = SmartRefreshLayout.this.F0.a(0);
                    }
                    valueAnimator = null;
                }
                if (valueAnimator != null) {
                    valueAnimator.addListener(c0119a);
                } else {
    ...
    protected class k implements Runnable {
        ...
        public void run() {
            ...
            float f2 = this.f8249f * (((currentAnimationTimeMillis - this.f8247d) * 1.0f) / 1000.0f);
            if (Math.abs(f2) >= 1.0f) {
                this.f8247d = currentAnimationTimeMillis;
                this.f8248e += f2;
            ...
            if (Math.abs(smartRefreshLayout2.f8206b) >= Math.abs(this.f8246c)) {
                int min = Math.min(Math.max((int) com.scwang.smartrefresh.layout.e.b.b(Math.abs(SmartRefreshLayout.this.f8206b - this.f8246c)), 30), 100) * 10;
                SmartRefreshLayout smartRefreshLayout3 = SmartRefreshLayout.this;
                smartRefreshLayout3.a(this.f8246c, 0, smartRefreshLayout3.y, min);
            }
        }
    }
    ...
    protected class l implements Runnable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:45:0x004f, code lost:
            ...
            if (r0.f8206b > r0.q0) goto L29;
         */
        /* JADX WARN: Code restructure failed: missing block: B:47:0x0041, code lost:
        
            if (r0.f8206b >= (-r0.s0)) goto L25;
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        ...
        public void run() {
            ...
            long currentAnimationTimeMillis = AnimationUtils.currentAnimationTimeMillis();
            long j2 = currentAnimationTimeMillis - this.f8257g;
            this.f8254d = (float) (this.f8254d * Math.pow(this.f8255e, (currentAnimationTimeMillis - this.f8256f) / (1000 / this.f8253c)));
            float f2 = this.f8254d * ((j2 * 1.0f) / 1000.0f);
            if (Math.abs(f2) <= 1.0f) {
                SmartRefreshLayout.this.R0 = null;
                return;
            }
            this.f8257g = currentAnimationTimeMillis;
    ...
    public class n implements com.scwang.smartrefresh.layout.b.i {
        ...
        public com.scwang.smartrefresh.layout.b.i a(boolean z) {
            if (z) {
                ...
                if (a2 != null) {
                    if (a2 == SmartRefreshLayout.this.S0) {
                        a2.setDuration(r1.f8209e);
                        a2.addListener(aVar);
                    }
                }
        ...
        public com.scwang.smartrefresh.layout.b.i a(int i2, boolean z) {
            ...
            if (smartRefreshLayout6.C0 != null) {
                ...
                if (num != null) {
                    ...
                    SmartRefreshLayout smartRefreshLayout7 = SmartRefreshLayout.this;
                    eVar.a(intValue, smartRefreshLayout7.r, smartRefreshLayout7.s);
                    SmartRefreshLayout smartRefreshLayout8 = SmartRefreshLayout.this;
            ...
            if ((i2 >= 0 || i3 > 0) && SmartRefreshLayout.this.A0 != null) {
                ...
                if (smartRefreshLayout11.v(smartRefreshLayout11.A) || (SmartRefreshLayout.this.H0 == com.scwang.smartrefresh.layout.c.b.RefreshFinish && !z)) {
                    ...
                    if (i3 != smartRefreshLayout12.f8206b) {
                        ...
                        SmartRefreshLayout.this.A0.a(z, f2, max, i4, i5);
                    }
                ...
                if (i3 != smartRefreshLayout14.f8206b && (cVar = smartRefreshLayout14.j0) != null) {
                    ...
                    if (hVar7 instanceof com.scwang.smartrefresh.layout.b.g) {
                        cVar.a((com.scwang.smartrefresh.layout.b.g) hVar7, z, f2, max, i4, i5);
                    }
                }
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:63:0x00d4, code lost:
        ...
        if (r22.H0.isHeader == false) goto L68;
     */
    ...
    */
    ...
    protected boolean drawChild(Canvas canvas, View view, long j2) {
        ...
        if (hVar != null && hVar.getView() == view) {
            ...
            if (view2 != null) {
                int max = Math.max(view2.getTop() + view2.getPaddingTop() + this.f8206b, view.getTop());
                int i2 = this.K0;
                if (i2 != 0 && (paint2 = this.D0) != null) {
                    ...
                    if (this.A0.getSpinnerStyle() == com.scwang.smartrefresh.layout.c.c.Scale) {
                        ...
                        max = view.getBottom() + this.f8206b;
                    }
        ...
        if (hVar2 != null && hVar2.getView() == view) {
            ...
            if (view2 != null) {
                int min = Math.min((view2.getBottom() - view2.getPaddingBottom()) + this.f8206b, view.getBottom());
                int i3 = this.L0;
    ...
    protected void onAttachedToWindow() {
        ...
        if (!isInEditMode()) {
            ...
            if (this.C0 == null) {
                ...
                this.C0.getView().setPadding(b2, b2, b2, b2);
            }
            int i3 = this.p;
            ...
            this.C0.a(this.k0);
            this.C0.b(this.O);
            this.C0.a(this.F0, findViewById, findViewById2);
            if (this.f8206b != 0) {
    ...
    */
    protected void onFinishInflate() {
        ...
        Lf:
            ...
            boolean r10 = com.scwang.smartrefresh.layout.e.e.a(r9)
            if (r10 == 0) goto L24
            if (r6 < r7) goto L21
            if (r4 != r8) goto L24
        L21:
        ...
        L50:
            ...
            if (r4 == r7) goto L65
            if (r1 != r2) goto L65
            com.scwang.smartrefresh.layout.b.h r6 = r11.A0
            if (r6 != 0) goto L65
    ...
    protected void onLayout(boolean z, int i2, int i3, int i4, int i5) {
        ...
        for (int i7 = 0; i7 < childCount; i7++) {
            ...
            if (hVar != null && hVar.getView() == childAt) {
                ...
                int i12 = ((ViewGroup.MarginLayoutParams) mVar2).topMargin + this.u0;
            ...
            if (hVar2 != null && hVar2.getView() == childAt) {
                ...
                if (spinnerStyle == com.scwang.smartrefresh.layout.c.c.MatchLayout) {
                    ...
                    if (z4 || spinnerStyle == com.scwang.smartrefresh.layout.c.c.FixedFront || spinnerStyle == com.scwang.smartrefresh.layout.c.c.FixedBehind) {
                        ...
                        i6 = Math.max(v(this.B) ? -this.f8206b : 0, 0);
                    }
                    i16 -= i6;
                }
    ...
    */
    ...
    protected void l() {
        ...
        ValueAnimator a2 = this.F0.a(-this.s0);
        if (a2 != null) {
            a2.addListener(bVar);
        }
        com.scwang.smartrefresh.layout.b.h hVar = this.B0;
    ...
    protected void m() {
        ...
        ValueAnimator a2 = this.F0.a(this.q0);
        if (a2 != null) {
            a2.addListener(cVar);
        }
        com.scwang.smartrefresh.layout.b.h hVar = this.A0;
    ...
    public SmartRefreshLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f8216l = obtainStyledAttributes.getFloat(R.styleable.SmartRefreshLayout_srlDragRate, this.f8216l);
        ...
        this.f8210f = obtainStyledAttributes.getInt(R.styleable.SmartRefreshLayout_srlReboundDuration, this.f8210f);
        ...
        this.e0 = this.e0 || obtainStyledAttributes.hasValue(R.styleable.SmartRefreshLayout_srlEnableLoadMore);
        this.f0 = this.f0 || obtainStyledAttributes.hasValue(R.styleable.SmartRefreshLayout_srlEnableHeaderTranslationContent);
        this.g0 = this.g0 || obtainStyledAttributes.hasValue(R.styleable.SmartRefreshLayout_srlEnableFooterTranslationContent);
        this.r0 = obtainStyledAttributes.hasValue(R.styleable.SmartRefreshLayout_srlHeaderHeight) ? com.scwang.smartrefresh.layout.c.a.XmlLayoutUnNotify : this.r0;
        this.t0 = obtainStyledAttributes.hasValue(R.styleable.SmartRefreshLayout_srlFooterHeight) ? com.scwang.smartrefresh.layout.c.a.XmlLayoutUnNotify : this.t0;
    ...
    protected void k(float f2) {
        ...
        if (this.H0 == com.scwang.smartrefresh.layout.c.b.TwoLevel && f2 > 0.0f) {
            ...
            if (f2 < i2) {
                ...
                int max = Math.max((this.f8211g * 4) / 3, getHeight());
                int i3 = this.q0;
                double d3 = max - i3;
                double max2 = Math.max(0.0f, (f2 - i3) * this.f8216l);
                double d4 = -max2;
                if (d3 == 0.0d) {
                    d3 = 1.0d;
                }
                this.F0.a(((int) Math.min(d2 * (1.0d - Math.pow(100.0d, d4 / d3)), max2)) + this.q0, true);
            }
            ...
            if (f2 > (-i4)) {
                ...
                int max3 = Math.max((this.f8211g * 4) / 3, getHeight());
                int i5 = this.s0;
                double d6 = max3 - i5;
            ...
            double max4 = Math.max(this.f8211g / 2, getHeight());
            double max5 = Math.max(0.0f, this.f8216l * f2);
            double d10 = -max5;
            if (max4 == 0.0d) {
                max4 = 1.0d;
            }
            this.F0.a((int) Math.min(d9 * (1.0d - Math.pow(100.0d, d10 / max4)), max5), true);
        } else {
            double d11 = this.x0 * this.s0;
            double max6 = Math.max(this.f8211g / 2, getHeight());
            double d12 = -Math.min(0.0f, this.f8216l * f2);
            double d13 = -d12;
            if (max6 == 0.0d) {
                max6 = 1.0d;
            }
            this.F0.a((int) (-Math.min(d11 * (1.0d - Math.pow(100.0d, d13 / max6)), d12)), true);
        }
    ...
    public static class m extends ViewGroup.MarginLayoutParams {
        ...
        public m(Context context, AttributeSet attributeSet) {
            ...
            this.f8259a = obtainStyledAttributes.getColor(R.styleable.SmartRefreshLayout_Layout_layout_srlBackgroundColor, this.f8259a);
            if (obtainStyledAttributes.hasValue(R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                this.f8260b = com.scwang.smartrefresh.layout.c.c.values()[obtainStyledAttributes.getInt(R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle, com.scwang.smartrefresh.layout.c.c.Translate.ordinal())];
            }
            obtainStyledAttributes.recycle();
        }
    ...
    protected void j() {
        ...
        if (bVar == com.scwang.smartrefresh.layout.c.b.TwoLevel) {
            if (this.v > -1000 && this.f8206b > getMeasuredHeight() / 2) {
                ValueAnimator a2 = this.F0.a(getMeasuredHeight());
                if (a2 != null) {
                    a2.setDuration(this.f8209e);
                    return;
                }
                return;
            }
    ...
    protected boolean a(Float f2) {
        ...
        if (Math.abs(floatValue) > this.t) {
            ...
            if ((floatValue < 0.0f && ((this.I && (this.J || v(this.B))) || ((this.H0 == com.scwang.smartrefresh.layout.c.b.Loading && this.f8206b >= 0) || (this.K && v(this.B))))) || (floatValue > 0.0f && ((this.I && (this.J || v(this.A))) || (this.H0 == com.scwang.smartrefresh.layout.c.b.Refreshing && this.f8206b <= 0)))) {
                this.P0 = false;
