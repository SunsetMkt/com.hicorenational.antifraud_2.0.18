...
public class BallPulseFooter extends InternalAbstract implements f {
    ...
    public BallPulseFooter(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i2) {
        ...
        this.f8334b = c.values()[obtainStyledAttributes.getInt(R.styleable.BallPulseFooter_srlClassicsSpinnerStyle, this.f8334b.ordinal())];
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            ...
            this.f8288m.put(ofFloat, new a(i3, this));
            this.f8287l.add(ofFloat);
        }
    }
