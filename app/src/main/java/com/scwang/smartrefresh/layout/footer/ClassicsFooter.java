...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements f {
    ...
    public ClassicsFooter(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f5666d.setText(isInEditMode() ? D : B);
        ...
        this.f5676n = typedArrayObtainStyledAttributes.getInt(R.styleable.ClassicsFooter_srlFinishDuration, this.f5676n);
        this.f5664b = c.values()[typedArrayObtainStyledAttributes.getInt(R.styleable.ClassicsFooter_srlClassicsSpinnerStyle, this.f5664b.ordinal())];
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.ClassicsFooter_srlDrawableArrow)) {
            this.f5667e.setImageDrawable(typedArrayObtainStyledAttributes.getDrawable(R.styleable.ClassicsFooter_srlDrawableArrow));
        } else {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.ClassicsFooter_srlDrawableProgress)) {
            this.f5668f.setImageDrawable(typedArrayObtainStyledAttributes.getDrawable(R.styleable.ClassicsFooter_srlDrawableProgress));
        } else {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.ClassicsFooter_srlTextSizeTitle)) {
            this.f5666d.setTextSize(0, typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.ClassicsFooter_srlTextSizeTitle, com.scwang.smartrefresh.layout.e.b.b(16.0f)));
        } else {
    ...
    public int a(@NonNull j jVar, boolean z) {
        ...
        this.f5666d.setText(z ? this.x : this.y);
    ...
    public void a(@NonNull j jVar, @NonNull b bVar, @NonNull b bVar2) {
        ...
        switch (a.a[bVar2.ordinal()]) {
            ...
            case 4:
                imageView.setVisibility(8);
                this.f5666d.setText(this.v);
                return;
            case 5:
                this.f5666d.setText(this.u);
                imageView.animate().rotation(0.0f);
                return;
            case 6:
                this.f5666d.setText(this.w);
                imageView.setVisibility(8);
                return;
            default:
                return;
