...
public class BezierRadarHeader extends InternalAbstract implements g {
    ...
    public BezierRadarHeader(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f8299i = obtainStyledAttributes.getBoolean(R.styleable.BezierRadarHeader_srlEnableHorizontalDrag, this.f8299i);
        ...
        this.f8297g = obtainStyledAttributes.hasValue(R.styleable.BezierRadarHeader_srlAccentColor);
        this.f8296f = obtainStyledAttributes.hasValue(R.styleable.BezierRadarHeader_srlPrimaryColor);
    ...
    protected void a(Canvas canvas, int i2, int i3) {
        if (this.o > 0.0f) {
            this.f8301k.setColor(this.f8294d);
            float b2 = com.scwang.smartrefresh.layout.e.b.b(i3);
            float f2 = i2 / 7;
            float f3 = this.p;
            float f4 = 1.0f;
            ...
            while (i4 < 7) {
                ...
                this.f8301k.setAlpha((int) (this.o * (f4 - ((Math.abs(f10) / 7.0f) * f8)) * 255.0f * (1.0d - (1.0d / Math.pow((b2 / 800.0d) + 1.0d, 15.0d)))));
                float f11 = this.q * (1.0f - (1.0f / ((b2 / 10.0f) + 1.0f)));
