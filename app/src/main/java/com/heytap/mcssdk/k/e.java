...
public class e {
    ...
    public static String b(String str) {
        ...
        try {
            str2 = f.a(str, a());
            g.b("sdkDecrypt desDecrypt des data " + str2);
            z = true;
        } catch (Exception e2) {
        ...
        try {
            ...
            f5896a = "AES";
            h.c().a(f5896a);
            g.b("sdkDecrypt desDecrypt aes data " + str2);
            return str2;
        } catch (Exception e3) {
    ...
    public static String c(String str) {
        ...
        try {
            str2 = AESEncrypt.decrypt(AESEncrypt.SDK_APP_SECRET, str);
            g.b("sdkDecrypt aesDecrypt aes data " + str2);
            z = true;
        } catch (Exception e2) {
        ...
        try {
            ...
            f5896a = "DES";
            h.c().a(f5896a);
            g.b("sdkDecrypt aesDecrypt des data " + str2);
            return str2;
        } catch (Exception e3) {
