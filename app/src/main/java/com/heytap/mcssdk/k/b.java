...
public class b {
    ...
    private static final String f3944b = "count";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final String f3945c = "list";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int f3946d = 1017;
    ...
    private static boolean b(Context context, List<MessageStat> list) {
        try {
            ...
            intent.putExtra(f3944b, list.size());
            ArrayList<String> arrayList = new ArrayList<>();
            Iterator<MessageStat> it = list.iterator();
            while (it.hasNext()) {
                arrayList.add(it.next().toJsonObject());
            }
            intent.putStringArrayListExtra(f3945c, arrayList);
