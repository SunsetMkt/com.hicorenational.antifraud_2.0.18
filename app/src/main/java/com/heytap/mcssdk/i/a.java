...
public class a implements c {
    ...
    /* JADX INFO: renamed from: com.heytap.mcssdk.i.a$a, reason: collision with other inner class name */
    class RunnableC0084a implements Runnable {
        final /* synthetic */ f.c a;

        RunnableC0084a(f.c cVar) {
            this.a = cVar;
        }

        @Override // java.lang.Runnable
        public void run() {
            a.this.a(this.a, com.heytap.mcssdk.a.w());
        }
    }
