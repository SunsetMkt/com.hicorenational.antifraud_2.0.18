...
public class a implements c {
    ...
    public void a(f.c cVar, com.heytap.mcssdk.a aVar) {
        String str;
        if (cVar == null) {
            ...
            if (aVar.n() != null) {
                int e2 = cVar.e();
                if (e2 == 12287) {
                    ICallBackResultService n = aVar.n();
                    if (n != null) {
                        n.onError(cVar.g(), cVar.f(), cVar.i(), cVar.h());
                        return;
                    }
                    return;
                }
                ...
                switch (e2) {
                    ...
                    case MessageConstant.CommandId.COMMAND_APP_NOTIFICATION_CLOSE /* 12317 */:
                        ISetAppNotificationCallBackService p = aVar.p();
                        if (p != null) {
                            p.onSetAppNotificationSwitch(cVar.g());
                            break;
                        }
                        break;
                    case MessageConstant.CommandId.COMMAND_APP_NOTIFICATION_GET /* 12318 */:
                        ...
                        IGetAppNotificationCallBackService o = aVar.o();
                        if (o != null) {
                            o.onGetAppNotificationSwitch(cVar.g(), i2);
                            break;
                        }
                        break;
                }
