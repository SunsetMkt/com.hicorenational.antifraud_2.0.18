...
public class b implements c {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ IDataMessageCallBackService f3942c;

        a(DataMessage dataMessage, Context context, IDataMessageCallBackService iDataMessageCallBackService) {
            this.a = dataMessage;
            this.f3941b = context;
            this.f3942c = iDataMessageCallBackService;
        }

        @Override // java.lang.Runnable
        public void run() {
            if (this.a.getMsgCommand() == 1) {
                b.this.a(this.f3941b, this.a);
            } else {
                this.f3942c.processMessage(this.f3941b, this.a);
            }
        }
    }
