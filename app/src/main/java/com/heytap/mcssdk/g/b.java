...
public class b {
    ...
    private void a(Context context, NotificationManager notificationManager, List<NotificationSortMessage> list) {
        ...
        if (arrayList.size() != 0) {
            ...
            hashMap.put(c.a.f5839g, arrayList);
    ...
    private boolean a(NotificationManager notificationManager, Context context, PushNotification.Builder builder, NotificationSortMessage notificationSortMessage) {
        ...
        if (this.f5877f + this.f5878g < this.f5872a) {
            ...
            if (i2 > 0) {
                ...
                Notification a2 = com.heytap.mcssdk.g.a.a(context, notificationSortMessage.getGroup(), builder);
                if (a2 != null) {
        ...
        if (g.g()) {
            g.b("dealCurrentMessage : needPost :" + z);
        }
        if (z) {
    ...
    private boolean a(PushNotification.Builder builder, int i2, int i3, String str, String str2) {
        ...
        if (builder == null || k2 == null) {
            return false;
        }
        NotificationManager a2 = com.heytap.mcssdk.g.a.a(k2);
        ...
        if (!a(k2, a2, notificationSortMessage, builder)) {
            return true;
        }
        a(a2, k2, builder.getVerifyNotifyId());
        if (a(k2, builder, notificationSortMessage)) {
            return true;
        }
        return a(a2, k2, builder, notificationSortMessage);
    }
