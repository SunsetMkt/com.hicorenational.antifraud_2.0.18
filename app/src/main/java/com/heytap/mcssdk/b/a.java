...
public class a extends b {
    ...
    */
    ...
    void a(byte[] bArr, int i2, int i3) {
        ...
        if (i3 >= 0) {
            ...
            while (i5 < i3) {
                ...
                if (this.f3859k == 0) {
                    ...
                    this.f3858j += 4;
                    int i13 = this.f3852d;
                    if (i13 > 0 && i13 <= this.f3858j) {
                        byte[] bArr4 = this.t;
                        System.arraycopy(bArr4, 0, bArr2, this.f3855g, bArr4.length);
                        this.f3855g += this.t.length;
                        this.f3858j = 0;
                    }
                }
                i5++;
        ...
        this.f3857i = true;
        if (this.f3859k == 0 && this.f3852d == 0) {
            return;
        }
        a(this.v);
        int i14 = this.f3855g;
        ...
        int i24 = this.f3858j;
        int i25 = this.f3855g;
        this.f3858j = i24 + (i25 - i14);
        if (this.f3852d <= 0 || this.f3858j <= 0) {
            return;
        }
        byte[] bArr9 = this.t;
        System.arraycopy(bArr9, 0, this.f3854f, i25, bArr9.length);
        this.f3855g += this.t.length;
    }
        ...
        while (true) {
            ...
            if (b3 >= 0) {
                ...
                if (b3 < bArr2.length && (b2 = bArr2[b3]) >= 0) {
                    this.f3859k = (this.f3859k + 1) % 4;
                    this.w = (this.w << 6) + b2;
                    if (this.f3859k == 0) {
                        byte[] bArr3 = this.f3854f;
                        int i6 = this.f3855g;
                        this.f3855g = i6 + 1;
                        int i7 = this.w;
