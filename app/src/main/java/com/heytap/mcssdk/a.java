...
public class a implements e {
    ...
    private boolean a(f.b bVar) {
        ...
        g.b("checkTimeNeedUpdate : lastedTime " + a2 + " currentTime:" + currentTimeMillis);
    ...
    private String e(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            try {
                try {
                    String a2 = com.heytap.mcssdk.k.c.a(p);
                    ApplicationInfo applicationInfo = packageManager.getApplicationInfo(a2, 0);
                    if (applicationInfo != null) {
                        boolean z2 = (applicationInfo.flags & 1) == 1;
                        boolean z3 = packageManager.getPackageUid(a2, 0) == packageManager.getPackageUid(DispatchConstants.ANDROID, 0);
                        if (z2 || z3) {
                            return a2;
                        }
                    }
    ...
    private boolean f(Context context) {
        ...
        String a2 = a(this.f5763a);
        boolean z2 = com.heytap.mcssdk.k.c.c(this.f5763a, a2) && com.heytap.mcssdk.k.c.a(this.f5763a, a2) >= 1019 && com.heytap.mcssdk.k.c.a(this.f5763a, a2, B);
    ...
    public void b(int i2) {
        if (!c(i2)) {
            Intent a2 = a(i2, "", null);
            this.f5763a.bindService(a2, new ServiceConnectionC0093a(a2), 1);
        } else {
