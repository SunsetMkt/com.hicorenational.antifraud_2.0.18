...
public class b extends c {
    ...
    public BaseMode a(Context context, int i2, Intent intent) {
        ...
        com.heytap.mcssdk.j.a.a(context, c.a.f5837e, (DataMessage) a2);
        return a2;
    }
    ...
    public BaseMode a(Intent intent, int i2) {
        try {
            ...
            String d2 = e.d(intent.getStringExtra(com.heytap.mcssdk.constant.b.f5832j));
            int i3 = 0;
            ...
            String d3 = e.d(intent.getStringExtra(com.heytap.mcssdk.constant.b.f5835m));
