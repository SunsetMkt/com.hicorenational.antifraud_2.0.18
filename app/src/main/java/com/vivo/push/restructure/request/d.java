...
public final class d {
    ...
    private synchronized Integer b() {
        ...
        if (this.f8625b.intValue() < 0 || this.f8625b.intValue() >= Integer.MAX_VALUE) {
            this.f8625b = 0;
        }
        numValueOf = Integer.valueOf(this.f8625b.intValue() + 1);
        this.f8625b = numValueOf;
    ...
    private d() {
        ...
        this.f8625b = null;
        this.f8626c = new HandlerThread("request_timer_task\u2014\u2014thread");
        this.f8626c.start();
        this.f8627d = new e(this, this.f8626c.getLooper());
    }
    ...
    public final void a(b bVar) {
        ...
        if (iA != 0) {
            ...
            this.a.put(numB, bVar);
            this.f8627d.sendEmptyMessageDelayed(numB.intValue(), bVar.c());
        }
    }
    ...
    public final void a(com.vivo.push.restructure.a.a aVar) {
        ...
        this.f8627d.removeMessages(iB);
        b bVarRemove = this.a.remove(Integer.valueOf(iB));
