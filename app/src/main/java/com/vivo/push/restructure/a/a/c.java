...
/* JADX INFO: compiled from: CheckNode.java */
/* JADX INFO: loaded from: classes2.dex */
final class c extends a<com.vivo.push.restructure.a.a> {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final List<Integer> f8590b = Arrays.asList(3);
    ...
    private static int a2(com.vivo.push.restructure.a.a aVar) {
        ...
        if (!TextUtils.isEmpty(stringExtra) && stringExtra.equals("reflect_receiver")) {
            ...
            if (f8590b.contains(Integer.valueOf(intExtra)) && aa.c(contextB, packageName) && !aa.b(contextB)) {
