...
/* renamed from: com.vivo.push.f.l */
/* loaded from: classes2.dex */
final class C3902l extends AbstractC3882aa {
    C3902l(AbstractC4016v abstractC4016v) {
    ...
    protected final void mo12952a(AbstractC4016v abstractC4016v) {
        ...
        C4010u.m13306c("OnDelTagsTask", "doTask,删除成功的标签 = " + m12878d + " 删除失败的= " + m12879e + " 错误码= " + m12877i);
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            C4010u.m13306c("OnDelTagsTask", "doTask1,删除成功的别名 = " + arrayList + " 删除失败的别名= " + arrayList3 + " 错误码= " + m12877i);
            if (arrayList.size() > 0) {
                C3924m.m13016a();
                C3924m.m13025b(arrayList);
            }
            C3924m.m13016a().m13034a(c3848t.m12876h(), m12877i);
            C3975t.m13170b(new RunnableC3903m(this, m12877i, arrayList, arrayList3, m12876h));
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            C4010u.m13306c("OnDelTagsTask", "doTask1,删除成功的标签 = " + arrayList + " 删除失败的标签= " + arrayList3 + " 错误码= " + m12877i);
            if (arrayList2.size() > 0) {
                C3924m.m13016a().m13044c(arrayList2);
            }
            C3924m.m13016a().m13034a(c3848t.m12876h(), m12877i);
            C3975t.m13170b(new RunnableC3904n(this, m12877i, arrayList2, arrayList4, m12876h));
        }
    }
}
