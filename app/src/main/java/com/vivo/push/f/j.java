...
final class j extends com.vivo.push.s {
    ...
    protected final void a(com.vivo.push.v vVar) {
        if (this.f12207a.getPackageName().equals(com.vivo.push.util.aa.a(this.f12207a))) {
            return;
        }
        com.vivo.push.b.j jVar = (com.vivo.push.b.j) vVar;
        int d2 = jVar.d();
        int e2 = jVar.e();
        com.vivo.push.util.u.d("OnChangePushStatusTask", "OnChangePushStatusTask serviceStatus is " + d2 + " ; receiverStatus is " + e2);
        if (d2 == 2) {
            b(this.f12207a);
        } else if (d2 == 1) {
            a(this.f12207a);
