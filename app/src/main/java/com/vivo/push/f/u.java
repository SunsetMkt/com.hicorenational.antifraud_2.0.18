...
public final class u extends aa {
    ...
    protected final void a(com.vivo.push.v vVar) {
        ...
        if (!com.vivo.push.util.aa.d(context, context.getPackageName())) {
            ...
            map.put(com.heytap.mcssdk.constant.b.f3893c, String.valueOf(qVar.f()));
        ...
        com.vivo.push.util.u.d("OnNotificationArrivedTask", "PushMessageReceiver " + this.a.getPackageName() + " isEnablePush :" + zIsEnablePush);
        if (!zIsEnablePush) {
            com.vivo.push.b.x xVar2 = new com.vivo.push.b.x(1020L);
            HashMap<String, String> map2 = new HashMap<>();
            map2.put(com.heytap.mcssdk.constant.b.f3893c, String.valueOf(qVar.f()));
        ...
        if (com.vivo.push.m.a().g() && !a(com.vivo.push.util.ag.c(this.a), qVar.e(), qVar.g())) {
            com.vivo.push.b.x xVar3 = new com.vivo.push.b.x(1021L);
            HashMap<String, String> map3 = new HashMap<>();
            map3.put(com.heytap.mcssdk.constant.b.f3893c, String.valueOf(qVar.f()));
