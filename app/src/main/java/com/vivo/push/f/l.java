...
final class l extends aa {
    ...
    protected final void a(com.vivo.push.v vVar) {
        ...
        int i2 = tVar.i();
        com.vivo.push.util.u.c("OnDelTagsTask", "doTask,删除成功的标签 = " + d2 + " 删除失败的= " + e2 + " 错误码= " + i2);
        String h2 = tVar.h();
        if (d2 != null) {
            for (String str : d2) {
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            ...
            com.vivo.push.t.b(new m(this, i2, arrayList, arrayList3, h2));
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            ...
            com.vivo.push.m.a().a(tVar.h(), i2);
            com.vivo.push.t.b(new n(this, i2, arrayList2, arrayList4, h2));
        }
    }
}
