...
final class n implements Runnable {
    ...
    public final void run() {
        Context context;
        l lVar = this.f12065e;
        PushMessageCallback pushMessageCallback = ((aa) lVar).f12034b;
        context = ((com.vivo.push.s) lVar).f12207a;
        pushMessageCallback.onDelAlias(context, this.f12061a, this.f12062b, this.f12063c, this.f12064d);
    }
}
