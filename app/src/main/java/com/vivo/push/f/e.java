...
public final class e extends aa {
    ...
    protected final void a(com.vivo.push.v vVar) {
        ...
        if (zEquals) {
            ...
            boolean z = true;
            if (skipType == 1) {
                new Thread(new f(this, this.a, uPSNotificationMessageA.getParams())).start();
            ...
            if (!TextUtils.isEmpty(str) && !this.a.getPackageName().equals(str)) {
                com.vivo.push.util.u.a("NotifyOpenClientTask", "open activity error : local pkgName is " + this.a.getPackageName() + "; but remote pkgName is " + uri.getPackage());
                return;
            }
            ...
            if (!TextUtils.isEmpty(packageName) && !this.a.getPackageName().equals(packageName)) {
                com.vivo.push.util.u.a("NotifyOpenClientTask", "open activity component error : local pkgName is " + this.a.getPackageName() + "; but remote pkgName is " + uri.getPackage());
                return;
            }
