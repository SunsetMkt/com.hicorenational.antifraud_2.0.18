...
public final class l implements BaseNotifyDataAdapter {
    ...
    public final int getDefaultNotifyIcon() {
        ...
        for (String str2 = this.f12277c; !TextUtils.isEmpty(str2); str2 = str2.substring(0, str2.length() - 1)) {
            int identifier = this.f12275a.getIdentifier("vivo_push_rom" + str2 + "_notifyicon", "drawable", this.f12276b);
            if (identifier > 0) {
                return identifier;
            }
        }
    ...
    public final int getDefaultSmallIconId() {
        ...
        for (String str2 = this.f12277c; !TextUtils.isEmpty(str2); str2 = str2.substring(0, str2.length() - 1)) {
            int identifier = this.f12275a.getIdentifier("vivo_push_rom" + str2 + "_icon", "drawable", this.f12276b);
            if (identifier > 0) {
                return identifier;
            }
        }
