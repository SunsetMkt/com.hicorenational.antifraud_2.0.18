...
public final class C4011v {
    /* renamed from: a */
    public static UPSNotificationMessage m13312a(InsideNotificationItem insideNotificationItem) {
    ...
    /* renamed from: b */
    public static String m13313b(InsideNotificationItem insideNotificationItem) {
    ...
    /* renamed from: a */
    public static InsideNotificationItem m13311a(String str) {
        InsideNotificationItem insideNotificationItem = new InsideNotificationItem();
        try {
        } catch (JSONException e2) {
            C4010u.m13293a("MessageConvertUtil", "notify msg pack to obj error", e2);
        }
        if (TextUtils.isEmpty(str)) {
            C4010u.m13292a("MessageConvertUtil", "notify msg pack to obj is null");
            return null;
        }
        ...
        if (jSONArray.length() > 11) {
            insideNotificationItem.setParams(C4007r.m13277a(new JSONObject(jSONArray.getString(11))));
        }
