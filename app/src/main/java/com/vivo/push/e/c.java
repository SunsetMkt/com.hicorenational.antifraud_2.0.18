...
public final class c implements a {
    ...
    private void b(Context context) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= 18) {
                KeyPairGeneratorSpec build = new KeyPairGeneratorSpec.Builder(context.getApplicationContext()).setAlias("PushRsaKeyAlias").setSubject(this.f12032d).setSerialNumber(BigInteger.valueOf(1337L)).setStartDate(calendar.getTime()).setEndDate(calendar2.getTime()).build();
    ...
    private PrivateKey c(Context context) {
        ...
        if (d2 instanceof KeyStore.PrivateKeyEntry) {
            this.f12029a = ((KeyStore.PrivateKeyEntry) d2).getPrivateKey();
            return this.f12029a;
        }
        return null;
    }
    ...
    public final PublicKey a() {
        try {
            ...
            KeyStore.Entry d2 = d(this.f12033e);
            if (!(d2 instanceof KeyStore.PrivateKeyEntry)) {
                return null;
            }
            this.f12030b = ((KeyStore.PrivateKeyEntry) d2).getCertificate().getPublicKey();
            return this.f12030b;
        } catch (Exception e2) {
            e2.printStackTrace();
