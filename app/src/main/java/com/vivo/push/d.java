    ...
    */
    ...
    public final void a(String str, int i2) {
        if (this.f11997a == null) {
            this.f11997a = new Bundle();
        }
        this.f11997a.putInt(str, i2);
    }
    ...
    public final void a(String str, String str2) {
        ...
        this.f11997a.putString(str, str2);
    }
    ...
    public final void a(String str, byte[] bArr) {
        ...
        this.f11997a.putByteArray(str, bArr);
    }
    ...
    public final void a(String str, Serializable serializable) {
        ...
        this.f11997a.putSerializable(str, serializable);
    }
    ...
    public final void a(String str, ArrayList<String> arrayList) {
        ...
        this.f11997a.putStringArrayList(str, arrayList);
    }
