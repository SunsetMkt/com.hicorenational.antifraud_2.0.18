...
public class a {
    ...
    public void c(Context context, String str) {
        ...
        if (this.mContext != null) {
            ...
            this.f2a = new Beacon.Builder().appKey("24657847").appSecret("f30fc0937f2b1e9e50a1b7134f1ddb10").loopInterval(com.heytap.mcssdk.constant.a.n).extras(hashMap).build();
