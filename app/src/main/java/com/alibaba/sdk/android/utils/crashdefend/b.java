...
public class b {
    ...
    public boolean m33a(c cVar, SDKMessageCallback sDKMessageCallback) {
        ...
        if (cVar != null && sDKMessageCallback != null) {
            try {
                if (TextUtils.isEmpty(cVar.f54b) || TextUtils.isEmpty(cVar.f52a) || (a2 = a(cVar, sDKMessageCallback)) == null) {
                    return false;
                }
                boolean m32a = m32a(a2);
                if (a2.crashCount == a2.f4139a) {
                    a(a2.f52a, a2.f54b, a2.crashCount, a2.f4139a);
                }
                a2.crashCount++;
                e.a(this.context, this.f45a, this.f47a);
                if (m32a) {
                    a(a2);
                    String str = "START:" + a2.f52a + " --- limit:" + a2.f4139a + "  count:" + (a2.crashCount - 1) + "  restore:" + a2.f4141c + "  startSerialNumber:" + a2.f50a + "  registerSerialNumber:" + a2.f53b;
                } else {
                    sDKMessageCallback.crashDefendMessage(a2.f4139a, a2.crashCount - 1);
                    String str2 = "STOP:" + a2.f52a + " --- limit:" + a2.f4139a + "  count:" + (a2.crashCount - 1) + "  restore:" + a2.f4141c + "  startSerialNumber:" + a2.f50a + "  registerSerialNumber:" + a2.f53b;
                }
                return true;
            } catch (Exception e2) {
                e2.getMessage();
    ...
    private void a(String str, String str2, int i2, int i3) {
        ...
        this.f4135a.sendCustomHit("utils_biz_crash", 0L, hashMap);
    }
}
