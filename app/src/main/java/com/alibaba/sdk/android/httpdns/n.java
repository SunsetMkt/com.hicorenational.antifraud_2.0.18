...
public class n {
    ...
    private void a(String str, long j2) {
        try {
            ...
            if (a2 != null) {
                a2.a(str, j2, com.alibaba.sdk.android.httpdns.d.c.a());
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    ...
    private void d(Throwable th) {
        try {
            ...
            if (a2 != null) {
                ...
                a2.a(m27d(), String.valueOf(a3), th.getMessage(), com.alibaba.sdk.android.httpdns.d.c.a());
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        ...
        try {
            if (str.equals(this.f4074i)) {
                ...
                if (System.currentTimeMillis() - this.f31g >= 300000) {
                    ...
                    i.e("The call time should be greater than 5 minutes. SDK will initiate an update request after " + (currentTimeMillis / com.heytap.mcssdk.constant.a.f5800d) + " minutes.");
                    if (this.f26a == null) {
                ...
                SharedPreferences.Editor edit = this.f25a.edit();
                edit.putString("httpdns_region", this.f4074i);
