...
public class e implements IPProbeService {
    ...
    private ConcurrentHashMap<String, Long> f2600c = new ConcurrentHashMap<>();
    private b a = null;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private f f2599b = new f() { // from class: com.alibaba.sdk.android.httpdns.probe.e.1
        @Override // com.alibaba.sdk.android.httpdns.probe.f
        public void a(long j2, c cVar) {
            if (cVar != null) {
                try {
                    if (!e.this.f2600c.containsKey(cVar.getHostName()) || ((Long) e.this.f2600c.get(cVar.getHostName())).longValue() != j2) {
                        ...
                        e.this.f2600c.remove(cVar.getHostName());
                    }
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
    ...
    public IPProbeService.a getProbeStatus(String str) {
        return this.f2600c.containsKey(str) ? IPProbeService.a.PROBING : IPProbeService.a.NO_PROBING;
    }
    ...
    public void launchIPProbeTask(String str, int i2, String[] strArr) {
        if (!com.alibaba.sdk.android.httpdns.a.a.a().f()) {
            ...
            this.f2600c.put(str, Long.valueOf(jAddAndGet));
            com.alibaba.sdk.android.httpdns.c.a().execute(new a(jAddAndGet, str, strArr, i2, this.f2599b));
        }
    }
    ...
    public boolean stopIPProbeTask(String str) {
        if (!this.f2600c.containsKey(str)) {
            return false;
        }
        i.d("stop ip probe task for host:" + str);
        this.f2600c.remove(str);
        return true;
    }
}
