...
public class e implements IPProbeService {
    ...
    private ConcurrentHashMap<String, Long> f4092c = new ConcurrentHashMap<>();

    /* renamed from: a, reason: collision with root package name */
    private b f4090a = null;

    /* renamed from: b, reason: collision with root package name */
    private f f4091b = new f() { // from class: com.alibaba.sdk.android.httpdns.probe.e.1
        @Override // com.alibaba.sdk.android.httpdns.probe.f
        public void a(long j2, c cVar) {
            if (cVar != null) {
                try {
                    if (e.this.f4092c.containsKey(cVar.getHostName()) && ((Long) e.this.f4092c.get(cVar.getHostName())).longValue() == j2) {
                        if (cVar != null && cVar.getIps() != null && cVar.j() != null && cVar.k() != null && cVar.getHostName() != null) {
                            ...
                            e.this.f4090a.a(cVar.getHostName(), cVar.getIps());
                            e.this.f4092c.remove(cVar.getHostName());
                        }
                    }
    ...
    public IPProbeService.a getProbeStatus(String str) {
        return this.f4092c.containsKey(str) ? IPProbeService.a.PROBING : IPProbeService.a.NO_PROBING;
    }
    ...
    public void launchIPProbeTask(String str, int i2, String[] strArr) {
        if (!com.alibaba.sdk.android.httpdns.a.a.a().f()) {
            ...
            this.f4092c.put(str, Long.valueOf(addAndGet));
            com.alibaba.sdk.android.httpdns.c.a().execute(new a(addAndGet, str, strArr, i2, this.f4091b));
        }
    }
    ...
    public boolean stopIPProbeTask(String str) {
        if (!this.f4092c.containsKey(str)) {
            return false;
        }
