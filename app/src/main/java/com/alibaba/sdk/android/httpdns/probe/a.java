...
class a implements Runnable {
    ...
    private ConcurrentHashMap<String, Long> f2595b = new ConcurrentHashMap<>();
    private String host;
    private String[] ips;
    ...
    private c a(String[] strArr) {
        ...
        return new c(this.host, strArr, str, str2, this.f2595b.containsKey(str) ? this.f2595b.get(str).longValue() : 2147483647L, this.f2595b.containsKey(str2) ? this.f2595b.get(str2).longValue() : 2147483647L);
    }
    ...
    public void run() {
        ...
        for (int i2 = 0; i2 < this.ips.length; i2++) {
            com.alibaba.sdk.android.httpdns.c.a().execute(new g(this.ips[i2], this.port, countDownLatch, this.f2595b));
        }
        try {
            countDownLatch.await(com.heytap.mcssdk.constant.a.q, TimeUnit.MILLISECONDS);
            if (this.a == null || (strArrA = a(this.f2595b)) == null || strArrA.length == 0) {
                return;
            }
            this.a.a(this.f2596j, a(strArrA));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
