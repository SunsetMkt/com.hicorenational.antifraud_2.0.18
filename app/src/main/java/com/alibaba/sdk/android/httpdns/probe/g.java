...
class g implements Runnable {
    ...
    private CountDownLatch f4094a;

    /* renamed from: b, reason: collision with root package name */
    private ConcurrentHashMap<String, Long> f4095b;
    private String o;
    private int port;
    ...
    public g(String str, int i2, CountDownLatch countDownLatch, ConcurrentHashMap<String, Long> concurrentHashMap) {
        ...
        this.o = str;
        this.port = i2;
        this.f4094a = countDownLatch;
        this.f4095b = concurrentHashMap;
    }
    ...
    */
    public void run() {
        /*
            r4 = this;
            java.lang.String r0 = r4.o     // Catch: java.lang.Exception -> L52
            if (r0 == 0) goto L43
            int r0 = r4.port     // Catch: java.lang.Exception -> L52
            boolean r0 = r4.a(r0)     // Catch: java.lang.Exception -> L52
            if (r0 != 0) goto Ld
            goto L43
        Ld:
            java.lang.String r0 = r4.o     // Catch: java.lang.Exception -> L52
            int r1 = r4.port     // Catch: java.lang.Exception -> L52
            long r0 = r4.a(r0, r1)     // Catch: java.lang.Exception -> L52
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch: java.lang.Exception -> L52
            r2.<init>()     // Catch: java.lang.Exception -> L52
            java.lang.String r3 = "connect cost for ip:"
            r2.append(r3)     // Catch: java.lang.Exception -> L52
            java.lang.String r3 = r4.o     // Catch: java.lang.Exception -> L52
            r2.append(r3)     // Catch: java.lang.Exception -> L52
            java.lang.String r3 = " is "
            r2.append(r3)     // Catch: java.lang.Exception -> L52
            r2.append(r0)     // Catch: java.lang.Exception -> L52
            java.lang.String r2 = r2.toString()     // Catch: java.lang.Exception -> L52
            com.alibaba.sdk.android.httpdns.i.d(r2)     // Catch: java.lang.Exception -> L52
            java.util.concurrent.ConcurrentHashMap<java.lang.String, java.lang.Long> r2 = r4.f4095b     // Catch: java.lang.Exception -> L52
            if (r2 == 0) goto L48
            java.util.concurrent.ConcurrentHashMap<java.lang.String, java.lang.Long> r2 = r4.f4095b     // Catch: java.lang.Exception -> L52
            java.lang.String r3 = r4.o     // Catch: java.lang.Exception -> L52
        ...
        L43:
            ...
            com.alibaba.sdk.android.httpdns.i.f(r0)     // Catch: java.lang.Exception -> L52
        L48:
            java.util.concurrent.CountDownLatch r0 = r4.f4094a     // Catch: java.lang.Exception -> L52
            if (r0 == 0) goto L56
            java.util.concurrent.CountDownLatch r0 = r4.f4094a     // Catch: java.lang.Exception -> L52
