...
public class HttpDns implements HttpDnsService {
    ...
    private String[] getIpsByHost(String str) {
        if (!b.a()) {
            ...
            e m14a = hostManager.m14a(str);
            if (m14a != null && m14a.m24b() && this.isExpiredIPEnabled) {
    ...
    private static void reportUserGetIP(String str, int i2) {
        com.alibaba.sdk.android.httpdns.d.b a2 = com.alibaba.sdk.android.httpdns.d.b.a();
        if (a2 != null) {
            a2.b(str, i2, com.alibaba.sdk.android.httpdns.d.c.a(), com.alibaba.sdk.android.httpdns.b.b.m9a() ? 1 : 0);
        }
    }
