...
class d {
    ...
    private boolean a(String str, e eVar) {
        IPProbeItem a2;
        if (eVar == null || eVar.getIps() == null || eVar.getIps().length <= 1 || f11a == null || (a2 = a(str)) == null) {
            return false;
        }
        ...
        i.f("START PROBE");
        f11a.launchIPProbeTask(str, a2.getPort(), eVar.getIps());
        return true;
    }
    ...
    void m18a(String str, e eVar) {
        ...
        f12a.put(str, eVar);
        if (com.alibaba.sdk.android.httpdns.b.b.m9a()) {
            com.alibaba.sdk.android.httpdns.b.e m21a = eVar.m21a();
            ArrayList<com.alibaba.sdk.android.httpdns.b.g> arrayList2 = m21a.f7a;
            if ((arrayList2 == null || arrayList2.size() <= 0) && ((arrayList = m21a.f8b) == null || arrayList.size() <= 0)) {
                com.alibaba.sdk.android.httpdns.b.b.b(m21a);
            } else {
                com.alibaba.sdk.android.httpdns.b.b.a(m21a);
            }
        }
        a(str, eVar);
    }
