...
public class j extends Drawable implements Drawable.Callback, Animatable {
    ...
    public void d(String str) {
        ...
        if (b2 != null) {
            int i2 = (int) b2.f3834b;
            a(i2, ((int) b2.f3835c) + i2);
        } else {
    ...
    private void c(Canvas canvas) {
        ...
        if (f2 > 1.0f) {
            i2 = canvas.save();
            float width = this.f3543b.a().width() / 2.0f;
            float height = this.f3543b.a().height() / 2.0f;
            float f4 = width * d2;
            float f5 = height * d2;
    ...
    private void b(Canvas canvas) {
        ...
        float width = bounds.width() / this.f3543b.a().width();
        float height = bounds.height() / this.f3543b.a().height();
        if (this.v) {
        ...
        this.f3542a.reset();
        this.f3542a.preScale(width, height);
        this.q.a(canvas, this.f3542a, this.r);
        if (i2 > 0) {
            canvas.restoreToCount(i2);
        }
    ...
    public void a(String str, String str2, boolean z2) {
        ...
        if (b2 != null) {
            int i2 = (int) b2.f3834b;
            com.airbnb.lottie.y.h b3 = this.f3543b.b(str2);
            if (b3 != null) {
                a(i2, (int) (b3.f3834b + (z2 ? 1.0f : 0.0f)));
                return;
            }
