...
public class b extends com.airbnb.lottie.y.l.a {
    ...
    void b(Canvas canvas, Matrix matrix, int i2) {
        ...
        boolean z = this.f2526n.u() && this.E.size() > 1 && i2 != 255;
        if (z) {
            this.H.setAlpha(i2);
    ...
    public void a(RectF rectF, Matrix matrix, boolean z) {
        ...
        for (int size = this.E.size() - 1; size >= 0; size--) {
            ...
            this.E.get(size).a(this.F, this.f2525m, true);
            rectF.union(this.F);
        }
    }
    ...
    public void a(@FloatRange(from = 0.0d, to = 1.0d) float f2) {
        super.a(f2);
        if (this.D != null) {
            f2 = ((this.D.f().floatValue() * this.o.a().g()) - this.o.a().m()) / (this.f2526n.f().d() + 0.01f);
        }
        if (this.D == null) {
            f2 -= this.o.p();
        }
