...
public class h extends com.airbnb.lottie.y.l.a {
    ...
    h(j jVar, d dVar) {
        ...
        a(this.K);
        k r = dVar.r();
        if (r != null && (aVar2 = r.f3841a) != null) {
            this.N = aVar2.a();
            this.N.a(this);
            a(this.N);
        }
        if (r != null && (aVar = r.f3842b) != null) {
            this.P = aVar.a();
            this.P.a(this);
            a(this.P);
        }
        if (r != null && (bVar2 = r.f3843c) != null) {
            this.R = bVar2.a();
            this.R.a(this);
            a(this.R);
        }
        if (r == null || (bVar = r.f3844d) == null) {
            return;
        }
        this.T = bVar.a();
        this.T.a(this);
    ...
    void b(Canvas canvas, Matrix matrix, int i2) {
        ...
        com.airbnb.lottie.y.b f2 = this.K.f();
        com.airbnb.lottie.y.c cVar = this.M.f().get(f2.f3805b);
        if (cVar == null) {
            canvas.restore();
            return;
        }
        ...
        if (aVar5 != null) {
            ...
            if (aVar6 != null) {
                ...
                this.H.setStrokeWidth(f2.f3813j * com.airbnb.lottie.b0.h.a() * com.airbnb.lottie.b0.h.a(matrix));
            }
        }
        if (this.L.D()) {
    ...
    private void a(com.airbnb.lottie.y.b bVar, Matrix matrix, com.airbnb.lottie.y.c cVar, Canvas canvas) {
        ...
        float a3 = bVar.f3809f * com.airbnb.lottie.b0.h.a();
    ...
    private void a(String str, com.airbnb.lottie.y.b bVar, Matrix matrix, com.airbnb.lottie.y.c cVar, Canvas canvas, float f2, float f3) {
        ...
        for (int i2 = 0; i2 < str.length(); i2++) {
            ...
            if (dVar != null) {
                ...
                float d2 = ((float) dVar.d()) * f3 * com.airbnb.lottie.b0.h.a() * f2;
    ...
    */
    ...
    private Typeface a(com.airbnb.lottie.y.c cVar) {
        ...
        Typeface a2 = this.L.a(cVar.b(), cVar.d());
    ...
    private float a(String str, com.airbnb.lottie.y.c cVar, float f2, float f3) {
        ...
        for (int i2 = 0; i2 < str.length(); i2++) {
            com.airbnb.lottie.y.d dVar = this.M.b().get(com.airbnb.lottie.y.d.a(str.charAt(i2), cVar.b(), cVar.d()));
            if (dVar != null) {
                f4 = (float) (f4 + (dVar.d() * f2 * com.airbnb.lottie.b0.h.a() * f3));
            }
        }
        return f4;
    }
    ...
    private void a(com.airbnb.lottie.y.d dVar, Matrix matrix, float f2, com.airbnb.lottie.y.b bVar, Canvas canvas) {
        List<com.airbnb.lottie.w.b.d> a2 = a(dVar);
    ...
    private List<com.airbnb.lottie.w.b.d> a(com.airbnb.lottie.y.d dVar) {
        ...
        List<com.airbnb.lottie.y.k.n> a2 = dVar.a();
        int size = a2.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i2 = 0; i2 < size; i2++) {
            arrayList.add(new com.airbnb.lottie.w.b.d(this.L, this, a2.get(i2)));
        }
