...
public class b {
    ...
    public int hashCode() {
        int hashCode = (((((int) ((((this.f3804a.hashCode() * 31) + this.f3805b.hashCode()) * 31) + this.f3806c)) * 31) + this.f3807d.ordinal()) * 31) + this.f3808e;
        long floatToRawIntBits = Float.floatToRawIntBits(this.f3809f);
        return (((hashCode * 31) + ((int) (floatToRawIntBits ^ (floatToRawIntBits >>> 32)))) * 31) + this.f3811h;
    }
}
