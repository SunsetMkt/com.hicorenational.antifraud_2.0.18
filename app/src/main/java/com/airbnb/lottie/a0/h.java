...
public class h implements k0<com.airbnb.lottie.y.b> {
    ...
    private static final c.a f2042b = c.a.a("t", "f", bh.aE, "j", "tr", "lh", "ls", "fc", "sc", "sw", "of");
    ...
    public com.airbnb.lottie.y.b a(com.airbnb.lottie.a0.l0.c cVar, float f2) throws IOException {
        ...
        while (cVar.h()) {
            switch (cVar.a(f2042b)) {
                ...
                case 3:
                    int iK2 = cVar.k();
                    aVar2 = (iK2 <= b.a.CENTER.ordinal() && iK2 >= 0) ? b.a.values()[iK2] : b.a.CENTER;
                    break;
                case 4:
                    iK = cVar.k();
                    break;
