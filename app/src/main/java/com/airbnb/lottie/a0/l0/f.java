...
final class f<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    g<K, V> find(K k2, boolean z) {
        ...
        if (gVar3 != null) {
            ...
            while (true) {
                int compareTo = comparable != null ? comparable.compareTo(gVar3.f3396f) : comparator.compare(k2, gVar3.f3396f);
                if (compareTo == 0) {
                    return gVar3;
                }
                g<K, V> gVar4 = compareTo < 0 ? gVar3.f3392b : gVar3.f3393c;
                if (gVar4 == null) {
                    gVar = gVar3;
                    i2 = compareTo;
                    break;
        ...
        if (gVar != null) {
            gVar2 = new g<>(gVar, k2, a2, gVar5, gVar5.f3395e);
            if (i2 < 0) {
                gVar.f3392b = gVar2;
            } else {
                gVar.f3393c = gVar2;
    ...
    g<K, V> findByEntry(Map.Entry<?, ?> entry) {
        ...
        if (findByObject != null && a(findByObject.f3398h, entry.getValue())) {
            return findByObject;
        }
        return null;
    }
    ...
    public V remove(Object obj) {
        ...
        if (removeInternalByKey != null) {
            return removeInternalByKey.f3398h;
        }
        return null;
    }
    ...
    void removeInternal(g<K, V> gVar, boolean z) {
        ...
        g<K, V> b2 = gVar3.f3399i > gVar4.f3399i ? gVar3.b() : gVar4.a();
