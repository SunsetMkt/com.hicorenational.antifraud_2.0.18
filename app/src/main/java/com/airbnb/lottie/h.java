...
public class h {
    ...
    class c implements Callable<p<com.airbnb.lottie.g>> {
        ...
        public p<com.airbnb.lottie.g> call() {
            p<com.airbnb.lottie.g> a2 = com.airbnb.lottie.e.b(this.f3511a).a(this.f3512b, this.f3513c);
            if (this.f3513c != null && a2.b() != null) {
                com.airbnb.lottie.y.g.b().a(this.f3513c, a2.b());
            }
            return a2;
        }
    }
        ...
        try {
            ...
            while (nextEntry != null) {
                ...
                if (name.contains("__MACOSX")) {
                    ...
                    gVar = a(com.airbnb.lottie.a0.l0.c.a(Okio.buffer(Okio.source(zipInputStream))), (String) null, false).b();
                } else {
    ...
    public static p<com.airbnb.lottie.g> b(Context context, @RawRes int i2, @Nullable String str) {
        try {
            ...
            if (a(buffer).booleanValue()) {
                return b(new ZipInputStream(buffer.inputStream()), str);
            }
