...
public class b extends f<Integer> {
    ...
    public int b(com.airbnb.lottie.c0.a<Integer> aVar, float f2) {
        ...
        int intValue2 = aVar.f3451c.intValue();
        com.airbnb.lottie.c0.j<A> jVar = this.f3748e;
        return (jVar == 0 || (num = (Integer) jVar.a(aVar.f3455g, aVar.f3456h.floatValue(), Integer.valueOf(intValue), Integer.valueOf(intValue2), f2, d(), e())) == null) ? com.airbnb.lottie.b0.b.a(com.airbnb.lottie.b0.g.a(f2, 0.0f, 1.0f), intValue, intValue2) : num.intValue();
    }
