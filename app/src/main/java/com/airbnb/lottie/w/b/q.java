...
public class q implements e, n, j, a.b, k {
    ...
    public Path getPath() {
        ...
        this.f3721b.reset();
        float floatValue = this.f3726g.f().floatValue();
        float floatValue2 = this.f3727h.f().floatValue();
        for (int i2 = ((int) floatValue) - 1; i2 >= 0; i2--) {
            this.f3720a.set(this.f3728i.a(i2 + floatValue2));
    ...
    public void a(Canvas canvas, Matrix matrix, int i2) {
        float floatValue = this.f3726g.f().floatValue();
        float floatValue2 = this.f3727h.f().floatValue();
        float floatValue3 = this.f3728i.d().f().floatValue() / 100.0f;
        float floatValue4 = this.f3728i.a().f().floatValue() / 100.0f;
        for (int i3 = ((int) floatValue) - 1; i3 >= 0; i3--) {
            this.f3720a.set(matrix);
            float f2 = i3;
            this.f3720a.preConcat(this.f3728i.a(f2 + floatValue2));
            this.f3729j.a(canvas, this.f3720a, (int) (i2 * com.airbnb.lottie.b0.g.c(floatValue3, floatValue4, f2 / floatValue)));
        }
    }
