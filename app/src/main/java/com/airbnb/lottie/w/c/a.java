...
public abstract class a<K, A> {
    ...
    protected float c() {
        com.airbnb.lottie.c0.a<K> a2 = a();
        if (a2.g()) {
            return 0.0f;
        }
        return a2.f3452d.getInterpolation(d());
    }
    ...
    float d() {
        ...
        return (this.f3747d - a2.d()) / (a2.a() - a2.d());
    }
    ...
    public A f() {
        float d2 = d();
        if (this.f3748e == null && this.f3746c.a(d2)) {
            return this.f3749f;
        }
        com.airbnb.lottie.c0.a<K> a2 = a();
        Interpolator interpolator = a2.f3453e;
        A a3 = (interpolator == null || a2.f3454f == null) ? a(a2, c()) : a(a2, d2, interpolator.getInterpolation(d2), a2.f3454f.getInterpolation(d2));
        this.f3749f = a3;
        return a3;
    }
    ...
    protected com.airbnb.lottie.c0.a<K> a() {
        ...
        com.airbnb.lottie.c0.a<K> a2 = this.f3746c.a();
