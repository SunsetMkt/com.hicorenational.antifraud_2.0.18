...
public class o {
    ...
    public Matrix b() {
        ...
        if (aVar != null) {
            ...
            if (f2.x != 0.0f || f2.y != 0.0f) {
                this.f3775a.preTranslate(f2.x, f2.y);
            }
        }
        a<Float, Float> aVar2 = this.f3783i;
        if (aVar2 != null) {
            if (aVar2 instanceof p) {
                i2 = aVar2.f().floatValue();
            } else {
                i2 = ((c) aVar2).i();
            }
            if (i2 != 0.0f) {
                this.f3775a.preRotate(i2);
            }
        }
        if (this.f3785k != null) {
            float cos = this.f3786l == null ? 0.0f : (float) Math.cos(Math.toRadians((-r0.i()) + 90.0f));
            float sin = this.f3786l == null ? 1.0f : (float) Math.sin(Math.toRadians((-r4.i()) + 90.0f));
            float tan = (float) Math.tan(Math.toRadians(this.f3785k.i()));
            e();
        ...
        if (aVar3 != null) {
            com.airbnb.lottie.c0.k f4 = aVar3.f();
            if (f4.a() != 1.0f || f4.b() != 1.0f) {
                this.f3775a.preScale(f4.a(), f4.b());
            }
        }
        a<PointF, PointF> aVar4 = this.f3780f;
        if (aVar4 != null) {
            ...
            if (f5.x != 0.0f || f5.y != 0.0f) {
                this.f3775a.preTranslate(-f5.x, -f5.y);
            }
        }
        return this.f3775a;
    }
    ...
    public Matrix a(float f2) {
        ...
        com.airbnb.lottie.c0.k f4 = aVar2 == null ? null : aVar2.f();
        this.f3775a.reset();
        if (f3 != null) {
            this.f3775a.preTranslate(f3.x * f2, f3.y * f2);
        }
        if (f4 != null) {
            double d2 = f2;
            this.f3775a.preScale((float) Math.pow(f4.a(), d2), (float) Math.pow(f4.b(), d2));
        }
        ...
        if (aVar3 != null) {
            ...
            this.f3775a.preRotate(floatValue * f2, f5 == null ? 0.0f : f5.x, f5 != null ? f5.y : 0.0f);
        }
        return this.f3775a;
    }
