...
public class h implements e, a.b, k {
    ...
    private int b() {
        int round = Math.round(this.f3688m.e() * this.r);
        int round2 = Math.round(this.n.e() * this.r);
        int round3 = Math.round(this.f3686k.e() * this.r);
    ...
    private LinearGradient c() {
        long b2 = b();
        LinearGradient linearGradient = this.f3679d.get(b2);
        if (linearGradient != null) {
            return linearGradient;
        }
        PointF f2 = this.f3688m.f();
        PointF f3 = this.n.f();
        com.airbnb.lottie.y.k.c f4 = this.f3686k.f();
        LinearGradient linearGradient2 = new LinearGradient(f2.x, f2.y, f3.x, f3.y, a(f4.a()), f4.b(), Shader.TileMode.CLAMP);
        this.f3679d.put(b2, linearGradient2);
        return linearGradient2;
    }

    private RadialGradient d() {
        long b2 = b();
        RadialGradient radialGradient = this.f3680e.get(b2);
        ...
        this.f3680e.put(b2, radialGradient2);
