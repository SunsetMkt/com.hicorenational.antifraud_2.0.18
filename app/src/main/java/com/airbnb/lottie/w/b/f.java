...
public class f implements n, a.b, k {
    ...
    public Path getPath() {
        ...
        if (this.f3663f.e()) {
            float f7 = -f4;
            this.f3658a.moveTo(0.0f, f7);
            float f8 = 0.0f - f5;
            float f9 = -f3;
            float f10 = 0.0f - f6;
            this.f3658a.cubicTo(f8, f7, f9, f10, f9, 0.0f);
            float f11 = f6 + 0.0f;
            this.f3658a.cubicTo(f9, f11, f8, f4, 0.0f, f4);
            float f12 = f5 + 0.0f;
            this.f3658a.cubicTo(f12, f4, f3, f11, f3, 0.0f);
            this.f3658a.cubicTo(f3, f10, f12, f7, 0.0f, f7);
        } else {
            float f13 = -f4;
            this.f3658a.moveTo(0.0f, f13);
            float f14 = f5 + 0.0f;
            float f15 = 0.0f - f6;
            this.f3658a.cubicTo(f14, f13, f3, f15, f3, 0.0f);
            float f16 = f6 + 0.0f;
            this.f3658a.cubicTo(f3, f16, f14, f4, 0.0f, f4);
            float f17 = 0.0f - f5;
            float f18 = -f3;
            this.f3658a.cubicTo(f17, f4, f18, f16, f18, 0.0f);
            this.f3658a.cubicTo(f18, f15, f17, f13, 0.0f, f13);
        }
        PointF f19 = this.f3662e.f();
        this.f3658a.offset(f19.x, f19.y);
        this.f3658a.close();
