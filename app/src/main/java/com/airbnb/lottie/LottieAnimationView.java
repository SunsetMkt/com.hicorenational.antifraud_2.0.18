...
public class LottieAnimationView extends AppCompatImageView {
    ...
    */
    ...
    public void setComposition(@NonNull com.airbnb.lottie.g gVar) {
        ...
        this.s = gVar;
        this.f3305l = true;
        boolean a2 = this.f3298e.a(gVar);
        this.f3305l = false;
        q();
        if (getDrawable() != this.f3298e || a2) {
            if (!a2) {
                r();
            }
            onVisibilityChanged(this, getVisibility());
    ...
    private void a(@Nullable AttributeSet attributeSet, @AttrRes int i2) {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.LottieAnimationView_lottie_colorFilter)) {
            a(new com.airbnb.lottie.y.e("**"), (com.airbnb.lottie.y.e) o.E, (com.airbnb.lottie.c0.j<com.airbnb.lottie.y.e>) new com.airbnb.lottie.c0.j(new u(AppCompatResources.getColorStateList(getContext(), obtainStyledAttributes.getResourceId(R.styleable.LottieAnimationView_lottie_colorFilter, -1)).getDefaultColor())));
        }
        if (obtainStyledAttributes.hasValue(R.styleable.LottieAnimationView_lottie_scale)) {
            this.f3298e.d(obtainStyledAttributes.getFloat(R.styleable.LottieAnimationView_lottie_scale, 1.0f));
        }
        if (obtainStyledAttributes.hasValue(R.styleable.LottieAnimationView_lottie_renderMode)) {
            int i3 = obtainStyledAttributes.getInt(R.styleable.LottieAnimationView_lottie_renderMode, t.AUTOMATIC.ordinal());
