...
public class a {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int b() {
        HashMap<String, HashMap<String, com.xiaomi.clientreport.data.a>> hashMap = this.f80a;
        int i2 = 0;
        if (hashMap != null) {
            Iterator<String> it = hashMap.keySet().iterator();
            while (it.hasNext()) {
                HashMap<String, com.xiaomi.clientreport.data.a> hashMap2 = this.f80a.get(it.next());
                if (hashMap2 != null) {
    ...
    public void a(boolean z, boolean z2, long j2, long j3) {
        ...
        if (config != null) {
            ...
            Config build = Config.getBuilder().setAESKey(bl.a(this.f75a)).setEventEncrypted(this.f76a.isEventEncrypted()).setEventUploadSwitchOpen(z).setEventUploadFrequency(j2).setPerfUploadSwitchOpen(z2).setPerfUploadFrequency(j3).build(this.f75a);
            this.f76a = build;
            if (!this.f76a.isEventUploadSwitchOpen()) {
                ae.a(this.f75a).m131a("100886");
            } else if (eventUploadFrequency != build.getEventUploadFrequency()) {
                b.c(this.f75a.getPackageName() + "reset event job " + build.getEventUploadFrequency());
                f();
            }
            ...
            if (perfUploadFrequency != build.getPerfUploadFrequency()) {
                b.c(this.f75a.getPackageName() + " reset perf job " + build.getPerfUploadFrequency());
                g();
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int a() {
        HashMap<String, ArrayList<com.xiaomi.clientreport.data.a>> hashMap = this.f12324b;
        if (hashMap == null) {
            return 0;
        }
        Iterator<String> it = hashMap.keySet().iterator();
