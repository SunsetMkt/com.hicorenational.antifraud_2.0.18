...
public class a {
    ...
    private HashMap<String, ArrayList<com.xiaomi.clientreport.data.a>> f8708b = new HashMap<>();
    ...
    private void f() {
        if (a(this.f75a).m57a().isEventUploadSwitchOpen()) {
            final bi biVar = new bi(this.f75a);
            int eventUploadFrequency = (int) a(this.f75a).m57a().getEventUploadFrequency();
    ...
    private void g() {
        if (a(this.f75a).m57a().isPerfUploadSwitchOpen()) {
            final bj bjVar = new bj(this.f75a);
            int perfUploadFrequency = (int) a(this.f75a).m57a().getPerfUploadFrequency();
    ...
    public void c() {
        if (m57a().isPerfUploadSwitchOpen()) {
            bk bkVar = new bk();
            bkVar.a(this.f78a);
            bkVar.a(this.f75a);
    ...
    public void b(EventClientReport eventClientReport) {
        ...
        if (iEventProcessor != null) {
            iEventProcessor.mo60a(eventClientReport);
            if (a() >= 10) {
                d();
                ae.a(this.f75a).m129a("100888");
            } else {
    ...
    public void b(PerfClientReport perfClientReport) {
        ...
        if (iPerfProcessor != null) {
            iPerfProcessor.mo60a(perfClientReport);
            if (b() >= 10) {
                e();
                ae.a(this.f75a).m129a("100889");
            } else {
    ...
    public synchronized Config m57a() {
        if (this.f76a == null) {
                ...
                if (map2 != null) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (aVar instanceof PerfClientReport) {
                            i2 = (int) (((long) i2) + ((PerfClientReport) aVar).perfCounts);
                        }
                    }
                }
            }
    ...
    public void a(Config config, IEventProcessor iEventProcessor, IPerfProcessor iPerfProcessor) {
        ...
        this.f77a.setEventMap(this.f8708b);
    ...
    public void m59b() {
        if (m57a().isEventUploadSwitchOpen()) {
            bk bkVar = new bk();
            bkVar.a(this.f75a);
            bkVar.a(this.f77a);
            this.f81a.execute(bkVar);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int a() {
        HashMap<String, ArrayList<com.xiaomi.clientreport.data.a>> map = this.f8708b;
        if (map == null) {
            return 0;
        }
        Iterator<String> it = map.keySet().iterator();
        int size = 0;
        while (it.hasNext()) {
            ArrayList<com.xiaomi.clientreport.data.a> arrayList = this.f8708b.get(it.next());
