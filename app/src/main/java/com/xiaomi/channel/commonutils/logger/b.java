...
public abstract class b {
    ...
    public static Integer a(String str) {
        if (f12320a <= 1) {
            Integer valueOf = Integer.valueOf(f71a.incrementAndGet());
            f70a.put(valueOf, Long.valueOf(System.currentTimeMillis()));
            f12321b.put(valueOf, str);
            f67a.log(str + " starts");
            return valueOf;
        }
        return f68a;
    ...
    public static void a(Integer num) {
        ...
        long longValue = f70a.remove(num).longValue();
        String remove = f12321b.remove(num);
        long currentTimeMillis = System.currentTimeMillis() - longValue;
        f67a.log(remove + " ends in " + currentTimeMillis + " ms");
    }
