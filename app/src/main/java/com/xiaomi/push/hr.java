...
public final class hr {
    ...
    public static int a(List list, List list2) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            int compare = f13211a.compare(list.get(i2), list2.get(i2));
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int compare = f13211a.compare(it.next(), it2.next());
            if (compare != 0) {
                return compare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            int compare = f13211a.compare(entry.getKey(), entry2.getKey());
            if (compare != 0) {
                return compare;
            }
            int compare2 = f13211a.compare(entry.getValue(), entry2.getValue());
            if (compare2 != 0) {
                return compare2;
            }
        }
