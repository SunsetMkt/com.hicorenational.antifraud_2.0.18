...
public final class hr {
    ...
    public static byte[] m596a(ByteBuffer byteBuffer) {
        if (m595a(byteBuffer)) {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static boolean m595a(ByteBuffer byteBuffer) {
    ...
    public static ByteBuffer a(ByteBuffer byteBuffer) {
        return m595a(byteBuffer) ? byteBuffer : ByteBuffer.wrap(m596a(byteBuffer));
    }
}
