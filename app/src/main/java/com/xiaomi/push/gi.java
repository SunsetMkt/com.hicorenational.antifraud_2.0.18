...
public class gi implements hq<gi, Object>, Serializable, Cloneable {
    ...
    public boolean m462a(gi giVar) {
        ...
        boolean m461a = m461a();
        boolean m461a2 = giVar.m461a();
        if (m461a || m461a2) {
            return m461a && m461a2 && this.f566a.equals(giVar.f566a);
        }
        return true;
    }
    ...
    public int compareTo(gi giVar) {
        ...
        int compareTo = Boolean.valueOf(m461a()).compareTo(Boolean.valueOf(giVar.m461a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (!m461a() || (a2 = hr.a(this.f566a, giVar.f566a)) == 0) {
            return 0;
        }
        return a2;
    }
    ...
    public void a(ia iaVar) {
        ...
        while (true) {
            ...
            if (mo603a.f898a != 1) {
                ...
                this.f566a = new ArrayList(mo604a.f899a);
