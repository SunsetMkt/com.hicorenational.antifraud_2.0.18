...
public class hp {
    ...
    public static short a(Context context, hb hbVar) {
        ...
        return m596a(context, hbVar.f724b, (m529a == null || m529a.m496a() == null) ? null : m529a.m496a().get("channel_id"));
    }
    ...
    private static int a(Context context, String str, String str2) {
        com.xiaomi.push.service.af a2;
        NotificationChannel m681a;
        if (Build.VERSION.SDK_INT < 26 || context == null || TextUtils.isEmpty(str) || (a2 = com.xiaomi.push.service.af.a(context, str)) == null || (m681a = a2.m681a(a2.m684a(str2))) == null) {
            return 0;
        }
        return m681a.getImportance() != 0 ? 32 : 64;
    }
}
