...
public class cw {
    ...
    public static synchronized void i(Context context, long j2, boolean z) {
        ...
        synchronized (cw.class) {
            ...
            int a2 = a(z);
            SharedPreferences m258a = m258a(context);
            long j3 = m258a.getLong(com.umeng.analytics.pro.d.p, 0L);
            if (j3 <= 0) {
                a(context, m258a, j2, a2);
            }
            if (a2 == 1) {
                i2 = m258a.getInt("on_up_count", 0) + 1;
                m258a.edit().putInt("on_up_count", i2).apply();
            } else {
                i2 = m258a.getInt("off_up_count", 0) + 1;
                m258a.edit().putInt("off_up_count", i2).apply();
            }
            a(context, j3, j2, i2, a2);
    ...
    public static synchronized void j(Context context, long j2, boolean z) {
        ...
        synchronized (cw.class) {
            ...
            if (a2 == 1) {
                i2 = m258a.getInt("on_down_count", 0) + 1;
                m258a.edit().putInt("on_down_count", i2).apply();
            } else {
                i2 = m258a.getInt("off_down_count", 0) + 1;
                m258a.edit().putInt("off_down_count", i2).apply();
            }
            a(context, j3, j2, i2, a2);
    ...
    public static synchronized void k(Context context, long j2, boolean z) {
        ...
        synchronized (cw.class) {
            ...
            if (a2 == 1) {
                i2 = m258a.getInt("on_ping_count", 0) + 1;
                m258a.edit().putInt("on_ping_count", i2).apply();
            } else {
                i2 = m258a.getInt("off_ping_count", 0) + 1;
                m258a.edit().putInt("off_ping_count", i2).apply();
            }
            a(context, j3, j2, i2, a2);
    ...
    public static synchronized void l(Context context, long j2, boolean z) {
        ...
        synchronized (cw.class) {
            ...
            if (a2 == 1) {
                i2 = m258a.getInt("on_pong_count", 0) + 1;
                m258a.edit().putInt("on_pong_count", i2).apply();
            } else {
                i2 = m258a.getInt("off_pong_count", 0) + 1;
                m258a.edit().putInt("off_pong_count", i2).apply();
            }
            a(context, j3, j2, i2, a2);
    ...
    private static cu m259a(Context context) {
        SharedPreferences m258a = m258a(context);
        cu cuVar = new cu();
        cuVar.a(m258a.getInt("off_up_count", 0));
        cuVar.b(m258a.getInt("off_down_count", 0));
        cuVar.c(m258a.getInt("off_ping_count", 0));
        cuVar.d(m258a.getInt("off_pong_count", 0));
        cuVar.a(m258a.getLong("off_duration", 0L));
        cuVar.e(m258a.getInt("on_up_count", 0));
        cuVar.f(m258a.getInt("on_down_count", 0));
        cuVar.g(m258a.getInt("on_ping_count", 0));
        cuVar.h(m258a.getInt("on_pong_count", 0));
        cuVar.b(m258a.getLong("on_duration", 0L));
        cuVar.c(m258a.getLong(com.umeng.analytics.pro.d.p, 0L));
        cuVar.d(m258a.getLong(com.umeng.analytics.pro.d.q, 0L));
        cuVar.i(m258a.getInt("xmsf_vc", 0));
        cuVar.j(m258a.getInt("android_vc", 0));
        return cuVar;
    }
    ...
    private static boolean m260a(Context context) {
        ...
        if (f290a) {
            f290a = false;
            SharedPreferences m258a = m258a(context);
            int i2 = m258a.getInt("xmsf_vc", 0);
            int i3 = m258a.getInt("android_vc", 0);
