...
public class db {
    ...
    private void c() {
        while (!this.f305a.isEmpty()) {
            ...
            if (bVarPeek != null) {
                if (!bVarPeek.m262b() && this.f305a.size() <= 6) {
                    return;
                }
    ...
    class c extends b {
        ...
        public boolean a() {
            return au.d(db.this.f304a) || (this.f317b && au.m149a(db.this.f304a));
        }
        ...
        public void b() {
            try {
                if (c()) {
                    ...
                    map.put("uid", com.xiaomi.push.service.ax.m703a());
                    map.put("token", this.f8853b);
                    map.put("net", au.m145a(db.this.f304a));
