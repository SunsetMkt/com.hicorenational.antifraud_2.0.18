...
public class db {
    ...
    private void c() {
        while (!this.f305a.isEmpty()) {
            b peek = this.f305a.peek();
            if (peek != null) {
                if (!peek.m264b() && this.f305a.size() <= 6) {
                    return;
                }
                com.xiaomi.channel.commonutils.logger.b.c("remove Expired task");
                this.f305a.remove(peek);
            }
        }
    }
        ...
        public void b() {
            try {
                if (c()) {
                    ...
                    hashMap.put("uid", com.xiaomi.push.service.ax.m705a());
                    hashMap.put("token", this.f12633b);
                    hashMap.put("net", au.m147a(db.this.f304a));
                    au.a(this.f315a, hashMap, this.f314a, "file");
                }
                this.f316a = true;
