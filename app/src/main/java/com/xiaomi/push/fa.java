...
public abstract class fa {
    ...
    private int f8964c = 2;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    protected final int f8963b = a.getAndIncrement();

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private long f8966e = 0;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    protected long f8965d = 0;
    ...
    protected fa(XMPushService xMPushService, fb fbVar) {
        this.f497a = fbVar;
    ...
    public static class a {
        ...
        public void a(fo foVar) {
            fk fkVar = this.f508a;
            if (fkVar == null || fkVar.mo238a(foVar)) {
                this.a.a(foVar);
            }
        }
    ...
    /* JADX INFO: renamed from: b, reason: collision with other method in class */
    protected void m415b() {
        String property;
        if (this.f497a.m419a() && this.f498a == null) {
            Class<?> cls = null;
            try {
    ...
    public void a(int i2, int i3, Exception exc) {
        int i4 = this.f8964c;
        if (i2 != i4) {
            com.xiaomi.channel.commonutils.logger.b.m48a(String.format("update the connection status. %1$s -> %2$s : %3$s ", a(i4), a(i2), com.xiaomi.push.service.an.a(i3)));
        }
        if (au.m149a((Context) this.f499a)) {
            m409a(i2);
        }
        if (i2 == 1) {
            this.f499a.a(10);
    ...
    public synchronized void a(String str) {
        if (this.f8964c == 0) {
            com.xiaomi.channel.commonutils.logger.b.m48a("setChallenge hash = " + ba.a(str).substring(0, 8));
            this.f500a = str;
            a(1, 0, null);
        } else {
    ...
    public synchronized boolean a(long j2) {
        return this.f8966e >= j2;
    }

    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    private void m409a(int i2) {
        synchronized (this.f502a) {
            if (i2 == 1) {
                this.f502a.clear();
            } else {
