...
class aj implements ai, InvocationHandler {
    ...
    private void a(Context context) {
        ...
        this.f173a = a2;
        this.f175a = a(a2, "InitSdk", (Class<?>[]) new Class[]{Context.class, cls});
        this.f12428b = cls;
    ...
    private void a(String str) {
        ...
        if (this.f172a != null || j2 < 0 || elapsedRealtime > 3000 || Looper.myLooper() == Looper.getMainLooper()) {
            return;
        }
        synchronized (this.f174a) {
            if (this.f172a == null) {
