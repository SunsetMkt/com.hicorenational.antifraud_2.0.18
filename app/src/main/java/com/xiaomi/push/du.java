...
public class du extends dx {
    ...
    public void mo360a() {
        if (m370b() && this.f12717b != null) {
            ...
            if (j.a(a()) >= 10) {
                m366a().setImageViewBitmap(a2, a(this.f12717b, 30.0f));
            } else {
                m366a().setImageViewBitmap(a2, this.f12717b);
            }
            int a3 = a(resources, RemoteMessageConst.Notification.ICON, "id", packageName);
            if (this.f12718c != null) {
                m366a().setImageViewBitmap(a3, this.f12718c);
            } else {
                a(a3);
            }
            int a4 = a(resources, "title", "id", packageName);
            m366a().setTextViewText(a4, ((dx) this).f409a);
            Map<String, String> map = ((dx) this).f412a;
            if (map != null && this.f12716a == 16777216) {
                mo362a(map.get("notification_image_text_color"));
            }
            RemoteViews m366a = m366a();
            int i2 = this.f12716a;
            m366a.setTextColor(a4, (i2 == 16777216 || !m368a(i2)) ? -1 : ViewCompat.MEASURED_STATE_MASK);
