...
public class ej implements hq<ej, Object>, Serializable, Cloneable {
    ...
    public boolean m376a(ej ejVar) {
        ...
        boolean d2 = d();
        boolean d3 = ejVar.d();
        if ((d2 || d3) && !(d2 && d3 && this.f431a.equals(ejVar.f431a))) {
            return false;
        }
        boolean e2 = e();
        boolean e3 = ejVar.e();
        if ((e2 || e3) && !(e2 && e3 && this.f434b.equals(ejVar.f434b))) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = ejVar.f();
        if ((f2 || f3) && !(f2 && f3 && this.f435c == ejVar.f435c)) {
            return false;
        }
        boolean g2 = g();
        boolean g3 = ejVar.g();
        if ((g2 || g3) && !(g2 && g3 && this.f436c.equals(ejVar.f436c))) {
            return false;
        }
        boolean h2 = h();
        boolean h3 = ejVar.h();
        if ((h2 || h3) && !(h2 && h3 && this.f438d.equals(ejVar.f438d))) {
            return false;
        }
        boolean i2 = i();
        boolean i3 = ejVar.i();
        if ((i2 || i3) && !(i2 && i3 && this.f437d == ejVar.f437d)) {
            return false;
        }
        boolean j2 = j();
        boolean j3 = ejVar.j();
        if (j2 || j3) {
            return j2 && j3 && this.f439e == ejVar.f439e;
        }
        return true;
    }
    ...
    public int compareTo(ej ejVar) {
        ...
        int compareTo = Boolean.valueOf(m375a()).compareTo(Boolean.valueOf(ejVar.m375a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m375a() && (a11 = hr.a(this.f429a, ejVar.f429a)) != 0) {
            return a11;
        }
        ...
        if (b() && (a10 = hr.a(this.f430a, ejVar.f430a)) != 0) {
            return a10;
        }
        ...
        if (c() && (a9 = hr.a(this.f433b, ejVar.f433b)) != 0) {
            return a9;
        }
        ...
        if (d() && (a8 = hr.a(this.f431a, ejVar.f431a)) != 0) {
            return a8;
        }
        ...
        if (e() && (a7 = hr.a(this.f434b, ejVar.f434b)) != 0) {
            return a7;
        }
        ...
        if (f() && (a6 = hr.a(this.f435c, ejVar.f435c)) != 0) {
            return a6;
        }
        ...
        if (g() && (a5 = hr.a(this.f436c, ejVar.f436c)) != 0) {
            return a5;
        }
        ...
        if (h() && (a4 = hr.a(this.f438d, ejVar.f438d)) != 0) {
            return a4;
        }
        ...
        if (i() && (a3 = hr.a(this.f437d, ejVar.f437d)) != 0) {
            return a3;
        }
        ...
        if (!j() || (a2 = hr.a(this.f439e, ejVar.f439e)) == 0) {
            return 0;
        }
        return a2;
    }
