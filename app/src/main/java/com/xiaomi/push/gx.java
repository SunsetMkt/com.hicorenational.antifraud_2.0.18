...
public class gx implements hq<gx, Object>, Serializable, Cloneable {
    ...
    public int compareTo(gx gxVar) {
        ...
        int compareTo = Boolean.valueOf(m515a()).compareTo(Boolean.valueOf(gxVar.m515a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (m515a() && (a3 = hr.a(this.f687a, gxVar.f687a)) != 0) {
            return a3;
        }
        ...
        if (!b() || (a2 = hr.a(this.f689b, gxVar.f689b)) == 0) {
            return 0;
        }
        return a2;
    }
