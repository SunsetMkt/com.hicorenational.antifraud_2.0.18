...
public enum EnumC4188ei {
    ...
    CONN_BOSH_ERR(20499),
    BIND_SUCCESS(BuglyStrategy.C3070a.MAX_USERDATA_VALUE_LENGTH),
    ...
    CHANNEL_TIMER_DELAYED(UpdateManager.REQUESTCODE_INSTALL_PERMISS_CODE);
    ...
    /* renamed from: a */
    public static EnumC4188ei m14599a(int i2) {
        if (i2 == 30501) {
            return BIND_TIMEOUT;
        }
        if (i2 == 30502) {
        ...
        switch (i2) {
            ...
            default:
                switch (i2) {
                    ...
                    case BuglyStrategy.C3070a.MAX_USERDATA_VALUE_LENGTH /* 30000 */:
                        return BIND_SUCCESS;
                    case 30199:
                        return BIND_TCP_ERR;
                    case 30399:
                    ...
                    case UpdateManager.REQUESTCODE_INSTALL_PERMISS_CODE /* 50001 */:
