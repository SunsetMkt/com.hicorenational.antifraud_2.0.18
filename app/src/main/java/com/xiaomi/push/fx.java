...
public class fx {
    ...
    private static final char[] f12901b = "&apos;".toCharArray();

    /* renamed from: c, reason: collision with root package name */
    private static final char[] f12902c = "&amp;".toCharArray();

    /* renamed from: d, reason: collision with root package name */
    private static final char[] f12903d = "&lt;".toCharArray();

    /* renamed from: e, reason: collision with root package name */
    private static final char[] f12904e = "&gt;".toCharArray();

    /* renamed from: a, reason: collision with root package name */
    private static Random f12900a = new Random();

    /* renamed from: f, reason: collision with root package name */
    private static char[] f12905f = "0123456789abcdefghijklmnopqrstuvwxyz0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ".toCharArray();
    ...
    public static String a(int i2) {
        ...
        for (int i3 = 0; i3 < cArr.length; i3++) {
            cArr[i3] = f12905f[f12900a.nextInt(71)];
        }
