...
public class hf implements hq<hf, Object>, Serializable, Cloneable {
    ...
    private static final hx f9216b = new hx("", (byte) 12, 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final hx f9217c = new hx("", (byte) 11, 3);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final hx f9218d = new hx("", (byte) 11, 4);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final hx f9219e = new hx("", (byte) 11, 5);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final hx f9220f = new hx("", (byte) 11, 6);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final hx f9221g = new hx("", (byte) 11, 7);

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private static final hx f9222h = new hx("", (byte) 11, 8);

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private static final hx f9223i = new hx("", (byte) 11, 9);

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private static final hx f9224j = new hx("", (byte) 11, 10);

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private static final hx f9225k = new hx("", (byte) 11, 11);

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    private static final hx f9226l = new hx("", (byte) 11, 12);

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private static final hx f9227m = new hx("", (byte) 8, 13);

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private static final hx f9228n = new hx("", (byte) 8, 14);
    ...
    private static final hx A = new hx("", com.umeng.analytics.pro.cw.f7203k, 100);
    ...
    public void b(ia iaVar) throws ib {
        m552a();
        iaVar.a(f747a);
        if (this.f752a != null && m553a()) {
            iaVar.a(a);
            iaVar.a(this.f752a);
            iaVar.b();
        }
        if (this.f751a != null && m555b()) {
            iaVar.a(f9216b);
            this.f751a.b(iaVar);
            iaVar.b();
        }
        ...
        if (m()) {
            iaVar.a(f9227m);
            iaVar.mo610a(this.f748a);
            iaVar.b();
        }
        if (n()) {
            iaVar.a(f9228n);
            iaVar.mo610a(this.f756b);
            iaVar.b();
        }
        ...
        if (s()) {
            iaVar.a(s);
            iaVar.mo610a(this.f760c);
            iaVar.b();
        }
        if (this.f750a != null && t()) {
            iaVar.a(t);
            iaVar.mo610a(this.f750a.a());
            iaVar.b();
        }
        if (u()) {
            iaVar.a(u);
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public boolean m554a(hf hfVar) {
        if (hfVar == null) {
            return false;
        }
        boolean zM553a = m553a();
        boolean zM553a2 = hfVar.m553a();
        if ((zM553a || zM553a2) && !(zM553a && zM553a2 && this.f752a.equals(hfVar.f752a))) {
            return false;
        }
        boolean zM555b = m555b();
        boolean zM555b2 = hfVar.m555b();
        if ((zM555b || zM555b2) && !(zM555b && zM555b2 && this.f751a.m505a(hfVar.f751a))) {
            return false;
        }
        boolean zM556c = m556c();
        boolean zM556c2 = hfVar.m556c();
        if ((zM556c || zM556c2) && !(zM556c && zM556c2 && this.f758b.equals(hfVar.f758b))) {
            return false;
        }
        boolean zD = d();
        boolean zD2 = hfVar.d();
    ...
    public int compareTo(hf hfVar) {
        ...
        int iCompareTo = Boolean.valueOf(m553a()).compareTo(Boolean.valueOf(hfVar.m553a()));
        if (iCompareTo != 0) {
            return iCompareTo;
        }
        if (m553a() && (iA29 = hr.a(this.f752a, hfVar.f752a)) != 0) {
            return iA29;
        }
        int iCompareTo2 = Boolean.valueOf(m555b()).compareTo(Boolean.valueOf(hfVar.m555b()));
        if (iCompareTo2 != 0) {
            return iCompareTo2;
        }
        if (m555b() && (iA28 = hr.a(this.f751a, hfVar.f751a)) != 0) {
            return iA28;
        }
        int iCompareTo3 = Boolean.valueOf(m556c()).compareTo(Boolean.valueOf(hfVar.m556c()));
        if (iCompareTo3 != 0) {
            return iCompareTo3;
        }
        if (m556c() && (iA27 = hr.a(this.f758b, hfVar.f758b)) != 0) {
            return iA27;
        }
    ...
    public void a(ia iaVar) throws ib {
        ...
        while (true) {
            ...
            short s2 = hxVarMo601a.f898a;
            switch (s2) {
                case 1:
                    if (b2 == 11) {
                        this.f752a = iaVar.mo606a();
                    } else {
                        id.a(iaVar, b2);
                    }
                    break;
                    ...
                    switch (s2) {
                        case 100:
                            if (b2 == 13) {
                                ...
                                this.f754a = new HashMap(hzVarMo603a.f900a * 2);
                                for (int i2 = 0; i2 < hzVarMo603a.f900a; i2++) {
                                    this.f754a.put(iaVar.mo606a(), iaVar.mo606a());
                                }
                                iaVar.h();
                            } else {
                                id.a(iaVar, b2);
