...
public class gb {
    ...
    */
    public static void c(android.content.Context r11, com.xiaomi.push.ge r12) {
        /*
            java.lang.String r0 = "/"
            java.lang.String r1 = "/tdReadTemp"
            boolean r2 = com.xiaomi.push.gb.f12918a
            if (r2 != 0) goto Ldd
            r2 = 1
            com.xiaomi.push.gb.f12918a = r2
        ...
        L22:
            ...
            com.xiaomi.push.w.m765a(r7)     // Catch: java.lang.Throwable -> L78 java.lang.Exception -> L7b
        ...
        Lbb:
            a(r11, r12, r2, r3)
            r12 = 0
            com.xiaomi.push.ga.a(r12)
            b(r11)
            com.xiaomi.push.gb.f12918a = r12
            return
        Lc8:
            r11 = move-exception
        Lc9:
        ...
        Ldd:
            ...
            com.xiaomi.channel.commonutils.logger.b.m50a(r11)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xiaomi.push.gb.c(android.content.Context, com.xiaomi.push.ge):void");
    }

    private static void a(Context context, ge geVar, File file, byte[] bArr) {
        ...
        try {
            try {
                ...
                com.xiaomi.channel.commonutils.logger.b.d("TinyData read from cache file failed cause lengthBuffer < 1 || too big. length:" + a2);
                gc.a(context, geVar, arrayList);
