...
public class ds {
    ...
    public static Config a(Context context) {
        boolean a2 = com.xiaomi.push.service.ah.a(context).a(gk.PerfUploadSwitch.a(), false);
        boolean a3 = com.xiaomi.push.service.ah.a(context).a(gk.EventUploadNewSwitch.a(), false);
        return Config.getBuilder().setEventUploadSwitchOpen(a3).setEventUploadFrequency(com.xiaomi.push.service.ah.a(context).a(gk.EventUploadFrequency.a(), RemoteMessageConst.DEFAULT_TTL)).setPerfUploadSwitchOpen(a2).setPerfUploadFrequency(com.xiaomi.push.service.ah.a(context).a(gk.PerfUploadFrequency.a(), RemoteMessageConst.DEFAULT_TTL)).build(context);
    }
