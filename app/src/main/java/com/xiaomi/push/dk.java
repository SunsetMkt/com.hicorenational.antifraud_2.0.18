...
public class dk {
    ...
    public void b() {
        a aVar;
        ae a2 = ae.a(this.f328a);
        com.xiaomi.push.service.ah a3 = com.xiaomi.push.service.ah.a(this.f328a);
        ...
        a(a3, a2, false);
        if (a3.a(gk.StorageCollectionSwitch.a(), true)) {
            int a4 = a(a3.a(gk.StorageCollectionFrequency.a(), RemoteMessageConst.DEFAULT_TTL));
            a2.a(new dm(this.f328a, a4), a4, 0);
        }
        if (j.m627a(this.f328a) && (aVar = this.f329a) != null) {
            aVar.a();
        }
        if (a3.a(gk.ActivityTSSwitch.a(), false)) {
            a();
        }
        a(a3, a2, true);
    }
