...
public class u {
    private static void b(Context context, hb hbVar, byte[] bArr) {
        ...
        dt.a(context).b(a2, x.b(hbVar), hbVar.m529a().m495a(), "1");
    }
    ...
    private static void d(final XMPushService xMPushService, final hb hbVar) {
        xMPushService.a(new XMPushService.j(4) { // from class: com.xiaomi.push.service.u.4
            ...
            public void mo379a() {
                try {
                    hb a2 = u.a((Context) xMPushService, hbVar);
                    a2.m529a().a("miui_message_unrecognized", "1");
                    w.a(xMPushService, a2);
                } catch (fi e2) {
    ...
    public void a(Context context, am.b bVar, boolean z, int i2, String str) {
        p m741a;
        if (z || (m741a = q.m741a(context)) == null || !"token-expired".equals(str)) {
            return;
        }
        q.a(context, m741a.f13450f, m741a.f13448d, m741a.f13449e);
    }
    ...
    public void a(XMPushService xMPushService, fo foVar, am.b bVar) {
        if (foVar instanceof fn) {
            ...
            if (a2 != null) {
                try {
                    a(xMPushService, ar.a(ar.a(bVar.f13351h, fnVar.j()), a2.c()), fz.a(foVar.mo431a()));
                    return;
    ...
    private static boolean b(hb hbVar) {
        ...
        return m496a != null && m496a.containsKey("notify_effect");
    }
    ...
    public void a(XMPushService xMPushService, er erVar, am.b bVar) {
        try {
            byte[] m395a = erVar.m395a(bVar.f13351h);
            HashMap hashMap = null;
            if (e.b(erVar)) {
                hashMap = new HashMap();
                hashMap.put("t_im", String.valueOf(erVar.m396b()));
                hashMap.put("t_rt", String.valueOf(erVar.m389a()));
            }
            a(xMPushService, m395a, erVar.c(), hashMap);
        } catch (IllegalArgumentException e2) {
            com.xiaomi.channel.commonutils.logger.b.a(e2);
        }
    }
    ...
    */
    ...
    public static void a(Context context, hb hbVar, byte[] bArr) {
        try {
            x.c m753a = x.m753a(context, hbVar, bArr);
            if (m753a.f13477a > 0 && !TextUtils.isEmpty(m753a.f1095a)) {
                fz.a(context, m753a.f1095a, m753a.f13477a, true, false, System.currentTimeMillis());
            }
            if (com.xiaomi.push.j.m627a(context) && v.a(context, hbVar, m753a.f1096a)) {
    ...
    private static boolean a(XMPushService xMPushService, String str, hb hbVar, gs gsVar) {
        ...
        if (gsVar != null && gsVar.m496a() != null && gsVar.m496a().containsKey("__check_alive") && gsVar.m496a().containsKey("__awake")) {
            ...
            boolean m454a = com.xiaomi.push.g.m454a(xMPushService.getApplicationContext(), str);
            heVar.f736a.put("app_running", Boolean.toString(m454a));
            if (!m454a) {
                boolean parseBoolean = Boolean.parseBoolean(gsVar.m496a().get("__awake"));
                heVar.f736a.put("awaked", Boolean.toString(parseBoolean));
                if (!parseBoolean) {
                    z = false;
                }
            }
    ...
    private static void a(final XMPushService xMPushService, final hb hbVar, final String str) {
        xMPushService.a(new XMPushService.j(4) { // from class: com.xiaomi.push.service.u.5
            ...
            public void mo379a() {
                try {
                    hb a2 = u.a((Context) xMPushService, hbVar);
                    a2.m529a().a("absent_target_package", str);
                    w.a(xMPushService, a2);
                } catch (fi e2) {
                    com.xiaomi.channel.commonutils.logger.b.a(e2);
                    xMPushService.a(10, e2);
    ...
    private static void a(final XMPushService xMPushService, final hb hbVar, final String str, final String str2) {
        xMPushService.a(new XMPushService.j(4) { // from class: com.xiaomi.push.service.u.6
            ...
            public void mo379a() {
                try {
                    hb a2 = u.a((Context) xMPushService, hbVar);
                    a2.f718a.a("error", str);
                    a2.f718a.a("reason", str2);
                    w.a(xMPushService, a2);
                } catch (fi e2) {
                    com.xiaomi.channel.commonutils.logger.b.a(e2);
                    xMPushService.a(10, e2);
    ...
    public static hb a(Context context, hb hbVar, Map<String, String> map) {
        ...
        hb a2 = w.a(hbVar.b(), hbVar.m530a(), gvVar, gf.AckMessage);
        gs m529a2 = hbVar.m529a();
        if (m529a2 != null) {
            m529a2 = au.a(m529a2.m494a());
            Map<String, String> m496a = m529a2.m496a();
            String str = m496a != null ? m496a.get("channel_id") : null;
            m529a2.a("mat", Long.toString(System.currentTimeMillis()));
            m529a2.a("cs", String.valueOf(f.a(context, hbVar.f724b, str)));
        }
        if (map != null) {
            try {
                if (map.size() > 0) {
                    for (String str2 : map.keySet()) {
                        m529a2.a(str2, map.get(str2));
                    }
                }
            } catch (Throwable th) {
