...
public class ax {
    ...
    private void c() {
        ...
        this.f1016a = new af.b() { // from class: com.xiaomi.push.service.ax.1
            ...
            public void b() {
                try {
                    Cdo.a a2 = Cdo.a.a(Base64.decode(ci.a(C0334r.m636a(), "https://resolver.msg.xiaomi.net/psc/?t=a", (List<com.xiaomi.push.at>) null), 10));
                    if (a2 != null) {
                        ax.this.f1017a = a2;
                        this.f1019a = true;
                        ax.this.e();
    ...
    */
    private void d() {
        /*
            r4 = this;
            r0 = 0
            android.content.Context r1 = com.xiaomi.push.C0334r.m636a()     // Catch: java.lang.Throwable -> L29 java.lang.Exception -> L2b
    ...
    public void e() {
        try {
            if (this.f1017a != null) {
                BufferedOutputStream bufferedOutputStream = new BufferedOutputStream(C0334r.m636a().openFileOutput("XMCloudCfg", 0));
    ...
    public static synchronized String m705a() {
        ...
        synchronized (ax.class) {
            if (f1015a == null) {
                SharedPreferences sharedPreferences = C0334r.m636a().getSharedPreferences("XMPushServiceConfig", 0);
                f1015a = sharedPreferences.getString("DeviceUUID", null);
                if (f1015a == null) {
                    f1015a = com.xiaomi.push.i.a(C0334r.m636a(), false);
                    if (f1015a != null) {
