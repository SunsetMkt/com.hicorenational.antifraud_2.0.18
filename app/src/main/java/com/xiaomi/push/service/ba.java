...
public class ba {
    ...
    /* JADX INFO: renamed from: com.xiaomi.push.service.ba$1 */
    static class AnonymousClass1 implements Runnable {
        final /* synthetic */ Context a;

        /* JADX INFO: renamed from: a */
        final /* synthetic */ gj f1032a;

        AnonymousClass1(Context context, gj gjVar) {
            context = context;
            gjVar = gjVar;
        }
    ...
    public static void a(Context context, gj gjVar) {
        if (az.a(gjVar.e())) {
            com.xiaomi.push.ae.a(context).a(new Runnable() { // from class: com.xiaomi.push.service.ba.1
                ...
                AnonymousClass1(Context context2, gj gjVar2) {
                    context = context2;
                    gjVar = gjVar2;
                }
        ...
        try {
            try {
                ...
                if (bArrB == null || bArrB.length < 1) {
                    com.xiaomi.channel.commonutils.logger.b.m48a("TinyData write to cache file failed case encryption fail item:" + gjVar.d() + "  ts:" + System.currentTimeMillis());
                } else {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m48a("TinyData write to cache file failed case too much data content item:" + gjVar.d() + "  ts:" + System.currentTimeMillis());
                }
                com.xiaomi.push.w.a((Closeable) null);
                com.xiaomi.push.w.a((Closeable) null);
            } catch (IOException e4) {
    ...
    public static byte[] a(Context context) {
        ...
        if (TextUtils.isEmpty(strA)) {
            ...
            com.xiaomi.push.o.a(context).m633a("mipush", "td_key", strA);
        }
        return a(strA);
    }

    private static byte[] a(String str) {
        byte[] bArrCopyOf = Arrays.copyOf(com.xiaomi.push.ay.m159a(str), 16);
        bArrCopyOf[0] = 68;
        bArrCopyOf[15] = 84;
        return bArrCopyOf;
    }
