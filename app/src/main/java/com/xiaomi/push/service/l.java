...
public class l {
    static void a(Context context, Intent intent) {
        ...
        try {
            ...
            if (bArrB != null) {
                x.m751a(context, u.a(bArrB), bArrB);
            } else {
                com.xiaomi.channel.commonutils.logger.b.m48a("notify fcm notification error \uff1adencrypt failed");
            }
        } catch (Throwable th) {
    ...
    public static byte[] b(byte[] bArr, String str) {
        if (TextUtils.isEmpty(str)) {
            com.xiaomi.channel.commonutils.logger.b.m48a("secret is empty, return null");
            return null;
        }
        try {
            return com.xiaomi.push.h.a(com.xiaomi.push.ay.m159a(str), bArr);
        } catch (Exception e2) {
    ...
    public static byte[] a(byte[] bArr, String str) {
        ...
        try {
            return com.xiaomi.push.h.b(com.xiaomi.push.ay.m159a(str), bArr);
        } catch (Exception e2) {
