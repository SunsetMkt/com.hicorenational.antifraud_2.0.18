...
public class bb {
    ...
    public static void c(Context context, String str, int i2, String str2, Notification notification) {
        ...
        if (!z) {
            if (iMin > 0) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a("update top notification: " + str2);
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a("update top notification to common: " + str2);
                afVarA.a(i2, builderRecoverBuilder.build());
            }
        }
        if (iMin > 0) {
            com.xiaomi.channel.commonutils.logger.b.m48a("schedule top notification next update delay: " + iMin);
            com.xiaomi.push.ae.a(context).m129a(b(i2, str2));
    ...
    static void a(Context context, Map<String, String> map, dv dvVar, long j2) {
        if (map == null || dvVar == null || !com.xiaomi.push.j.m625a(context) || !m712a(map)) {
            return;
        }
        int iA = a(map);
        int iB = b(map);
    ...
    public static String b(int i2, String str) {
        return "n_top_update_" + i2 + d.c.a.b.a.a.s1 + str;
    }

    @TargetApi(19)
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    static void m711a(Context context, String str, int i2, String str2, Notification notification) {
        if (com.xiaomi.push.j.m625a(context) && notification != null && notification.extras.getBoolean("mipush_n_top_flag", false)) {
            c(context, str, i2, str2, notification);
        }
    }

    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    private static boolean m712a(Map<String, String> map) {
    ...
    private static Notification a(Notification notification, int i2, String str, af afVar) {
        ...
        List<StatusBarNotification> listM685b = afVar.m685b();
        if (listM685b == null) {
            return null;
        }
