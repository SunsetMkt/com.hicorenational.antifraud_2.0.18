...
public class m {
    ...
    /* JADX INFO: renamed from: c */
    private final AtomicInteger f9401c = new AtomicInteger(0);

    /* JADX INFO: renamed from: a */
    private int f1044a = -1;

    /* JADX INFO: renamed from: b */
    private long f9400b = -1;

    /* JADX INFO: renamed from: d */
    private final boolean f9402d = m720g();
    ...
    private m(Context context) {
        this.f1046a = context;
        this.f1054c = com.xiaomi.push.j.m625a(context);
    ...
    private void b(String str) {
        ...
        com.xiaomi.channel.commonutils.logger.b.m48a(String.format("[HB] network changed, netid:%s, %s", this.f1048a, Boolean.valueOf(this.f1050a)));
    }
    ...
    private void g() {
        ...
        if (m716c()) {
            ...
            if (!TextUtils.isEmpty(string) && (strArrSplit = string.split("###")) != null) {
                ...
                while (i3 < strArrSplit.length) {
                    if (!TextUtils.isEmpty(strArrSplit[i3]) && (strArrSplit2 = strArrSplit[i3].split(":::")) != null && strArrSplit2.length >= 4) {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m48a("[HB] report hb changed events.");
                    }
                    i3++;
                    c2 = 1;
                    c3 = 0;
            ...
            if (this.f1047a.getBoolean(a.a(), false)) {
                ...
                long jCurrentTimeMillis = System.currentTimeMillis();
                if (jCurrentTimeMillis - j2 > d.c.a.b.a.a.a) {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m48a("[HB] report support wifi digest events.");
            ...
            if (m718e()) {
                ...
                if (i4 > 0 || i5 > 0) {
                    ...
                    try {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m48a("[HB] report short/long hb count events.");
            ...
            if (m719f()) {
                ...
                if (i6 > 0) {
                    try {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m48a("[HB] report ping timeout count events of mobile network.");
                ...
                if (i7 > 0) {
                    try {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m48a("[HB] report ping timeout count events of wifi network.");
    ...
    private void d(String str) {
        String str2;
        String string;
        if (m716c() && !TextUtils.isEmpty(str)) {
            if (str.startsWith("W-")) {
    ...
    /* JADX INFO: renamed from: c */
    private boolean m716c() {
        return m717d() && ah.a(this.f1046a).a(gk.IntelligentHeartbeatDataCollectSwitchBoolean.a(), true) && com.xiaomi.push.n.China.name().equals(b.a(this.f1046a).a());
    }

    /* JADX INFO: renamed from: f */
    private boolean m719f() {
        if (this.f1045a == -1) {
            return false;
        }
        long jCurrentTimeMillis = System.currentTimeMillis();
    ...
    public void m725b() {
        if (m717d()) {
            ...
            if (this.f1050a && !TextUtils.isEmpty(this.f1048a) && this.f1048a.equals(this.f1051b)) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a("[HB] ping timeout count:" + this.f1049a);
                if (m715a()) {
                    com.xiaomi.channel.commonutils.logger.b.m48a("[HB] change hb interval for net:" + this.f1048a);
                    c(this.f1048a);
                    this.f1050a = false;
                    this.f1049a.getAndSet(0);
                    d(this.f1048a);
    ...
    public synchronized void m723a(String str) {
        ...
        if (m717d() && !TextUtils.isEmpty(str)) {
            b("W-" + str);
        }
    }

    /* JADX INFO: renamed from: d */
    private boolean m717d() {
        return this.f1054c && (this.f1053b || this.f9402d || ((c() > System.currentTimeMillis() ? 1 : (c() == System.currentTimeMillis() ? 0 : -1)) >= 0));
    }

    public void a(int i2) {
        this.f1047a.edit().putLong(a.j(), System.currentTimeMillis() + ((long) (i2 * 1000))).apply();
    }
    ...
    private boolean b() {
        if (!TextUtils.isEmpty(this.f1048a)) {
            ...
            } else if (this.f1048a.equals("W-NETWORK_ID_WIFI_DEFAULT") && !m720g()) {
                return true;
            }
        }
        return false;
    ...
    public long m721a() {
        ...
        this.f9400b = jB;
        com.xiaomi.channel.commonutils.logger.b.m48a("[HB] ping interval:" + jB);
        return jB;
    }
    ...
    private void a(boolean z) {
        String strE;
        if (m716c()) {
            int iIncrementAndGet = (z ? this.f1052b : this.f9401c).incrementAndGet();
            ...
            if (iIncrementAndGet >= 5) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a(String.format("[HB] accumulate %s hb count(%s) and write to file. ", objArr2));
                if (z) {
                    this.f1052b.set(0);
                } else {
                    this.f9401c.set(0);
    ...
    private void a(String str, String str2, Map<String, String> map) {
        ...
        String str3 = null;
        p pVarM739a = q.m739a(this.f1046a);
