...
public class az {
    ...
    public static synchronized String a() {
        ...
        synchronized (az.class) {
            String format = f1026a.format(Long.valueOf(System.currentTimeMillis()));
            if (!TextUtils.equals(f13402a, format)) {
                f1027a.set(0L);
                f13402a = format;
            }
            str = format + Constants.ACCEPT_TIME_SEPARATOR_SERVER + f1027a.incrementAndGet();
        }
        return str;
    }
    ...
    */
    ...
    public static boolean a(String str) {
        return !C0334r.m640b() || Constants.HYBRID_PACKAGE_NAME.equals(str);
    }
}
