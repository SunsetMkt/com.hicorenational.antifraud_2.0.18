...
public class z {
    ...
    public static boolean b(String str) {
        ...
        try {
            ...
            socket.connect(ce.m223a(str, 5222), 5000);
            socket.setTcpNoDelay(true);
            com.xiaomi.channel.commonutils.logger.b.m48a("ConnectivityTest: connect to " + str + " in " + (System.currentTimeMillis() - jCurrentTimeMillis));
            socket.close();
            return true;
        } catch (Throwable th) {
    ...
    public static void a() {
        Cdo.a aVarM707a;
        long jCurrentTimeMillis = System.currentTimeMillis();
        if ((f1098a.getActiveCount() <= 0 || jCurrentTimeMillis - a >= 1800000) && eo.m380a().m385a() && (aVarM707a = ax.a().m707a()) != null && aVarM707a.e() > 0) {
            a = jCurrentTimeMillis;
            a(aVarM707a.m273a(), true);
        }
    }
    ...
    public static void b() throws Throwable {
        ...
        if (!TextUtils.isEmpty(strA)) {
            ...
            com.xiaomi.channel.commonutils.logger.b.m48a(strA);
        }
        ...
        com.xiaomi.channel.commonutils.logger.b.m48a(strA2);
    }
}
