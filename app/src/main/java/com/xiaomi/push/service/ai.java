...
public class ai {
    ...
    public static void a(ah ahVar, hd hdVar) {
        ...
        for (go goVar : hdVar.a()) {
            ...
            List<Pair<Integer, Object>> a2 = a(goVar.f595a, false);
            if (!com.xiaomi.push.z.a(a2)) {
        ...
        for (gq gqVar : list) {
            ...
            if (a3 != null) {
                if (z && gqVar.f603a) {
                    ...
                    int i2 = AnonymousClass1.f13339b[a3.ordinal()];
                    if (i2 == 1) {
                        pair = new Pair(Integer.valueOf(a2), Integer.valueOf(gqVar.c()));
                    } else if (i2 == 2) {
                        pair = new Pair(Integer.valueOf(a2), Long.valueOf(gqVar.m480a()));
                    } else if (i2 != 3) {
                        pair = i2 != 4 ? null : new Pair(Integer.valueOf(a2), Boolean.valueOf(gqVar.g()));
                    } else {
                        pair = new Pair(Integer.valueOf(a2), gqVar.m481a());
                    }
                    arrayList.add(pair);
                }
            }
