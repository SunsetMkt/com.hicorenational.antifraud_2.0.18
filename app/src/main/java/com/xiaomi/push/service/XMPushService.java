...
public class XMPushService extends Service implements fd {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (TextUtils.equals(context.getPackageName(), intent.getPackage())) {
                ...
                try {
                    ...
                    a(3000L);
                    com.xiaomi.channel.commonutils.logger.b.m50a("[Alarm] heartbeat alarm finish in " + (System.currentTimeMillis() - currentTimeMillis));
    ...
    private void d() {
        com.xiaomi.push.av m144a = com.xiaomi.push.au.m144a();
        com.xiaomi.push.service.m.a(getApplicationContext()).a(m144a);
        if (m144a != null) {
            StringBuilder sb = new StringBuilder();
            sb.append("network changed,");
            sb.append("[type: " + m144a.m154a() + "[" + m144a.m156b() + "], state: " + m144a.m153a() + "/" + m144a.m152a());
            com.xiaomi.channel.commonutils.logger.b.m51a("XMPushService", sb.toString());
            NetworkInfo.State m153a = m144a.m153a();
            if (m153a == NetworkInfo.State.SUSPENDED || m153a == NetworkInfo.State.UNKNOWN) {
                return;
            }
        } else {
    ...
    private boolean m657h() {
        ...
        if ("com.xiaomi.xmsf".equals(packageName)) {
            ...
            z = com.xiaomi.push.n.China.name().equals(com.xiaomi.push.service.b.a(getApplicationContext()).a());
        } else {
            z = !com.xiaomi.push.service.r.a(this).m746b(packageName);
        }
        if (!z) {
            com.xiaomi.channel.commonutils.logger.b.m52a("XMPushService", "-->isPushEnabled(): isEnabled=", Boolean.valueOf(z), ", package=", packageName, ", region=", com.xiaomi.push.service.b.a(getApplicationContext()).a());
        }
        return z;
    }
    ...
    public void onCreate() {
        ...
        C0334r.a((Context) this);
        com.xiaomi.push.service.p m741a = com.xiaomi.push.service.q.m741a((Context) this);
        if (m741a != null) {
            com.xiaomi.push.x.a(m741a.f13445a);
        }
            ...
            if (uriFor != null) {
                this.f934a = new ContentObserver(new Handler(Looper.getMainLooper())) { // from class: com.xiaomi.push.service.XMPushService.12
                    ...
                    public void onChange(boolean z) {
                        super.onChange(z);
                        boolean m656g = XMPushService.this.m656g();
                        com.xiaomi.channel.commonutils.logger.b.m50a("SuperPowerMode:" + m656g);
                        XMPushService.this.e();
                        if (!m656g) {
        ...
        if (m741a != null) {
            try {
                if (!TextUtils.isEmpty(m741a.f1067a) && (split = m741a.f1067a.split("@")) != null && split.length > 0) {
                    str = split[0];
                }
    ...
    public void c() {
        ...
        String a3 = a2.a();
        com.xiaomi.channel.commonutils.logger.b.m51a("XMPushService", "region of cache is " + a3);
        ...
        com.xiaomi.channel.commonutils.logger.b.m52a("XMPushService", "after check, appRegion is ", a3, ", countryCode=", str);
    ...
    private String b() {
        ...
        com.xiaomi.channel.commonutils.logger.b.m50a("wait coutrycode :" + str + " cost = " + (SystemClock.elapsedRealtime() - elapsedRealtime) + " , count = " + i2);
        return str;
    }
    ...
    class b extends j {
        ...
        public void mo379a() {
            try {
                if (XMPushService.this.m668c()) {
                    am.b a2 = am.a().a(this.f961a.f13350g, this.f961a.f1001b);
                    if (a2 == null) {
                        com.xiaomi.channel.commonutils.logger.b.m50a("ignore bind because the channel " + this.f961a.f13350g + " is removed ");
                    } else if (a2.f996a == am.c.unbind) {
                        a2.a(am.c.binding, 0, 0, (String) null, (String) null);
                        XMPushService.this.f937a.a(a2);
                        ep.a(XMPushService.this, a2);
                    } else {
                        com.xiaomi.channel.commonutils.logger.b.m50a("trying duplicate bind, ingore! " + a2.f996a);
                    }
                } else {
    ...
    private int[] m652a() {
        String[] split;
        String a2 = ah.a(getApplicationContext()).a(gk.FallDownTimeRange.a(), "");
    ...
    private String a() {
        String m624a = com.xiaomi.push.j.m624a("ro.miui.region");
        return TextUtils.isEmpty(m624a) ? com.xiaomi.push.j.m624a("ro.product.locale.region") : m624a;
    }
    ...
    private void b(Intent intent) {
        ...
        if (bundleExtra != null) {
            ...
            if (fnVar == null) {
                ...
                erVar = er.a(fnVar, a2.a(fnVar.k(), fnVar.m()).f13351h);
            }
        } else {
            ...
            if (byteArrayExtra != null) {
                ...
                if (a3 != null) {
                    er erVar2 = new er();
                    try {
                        erVar2.a(Integer.parseInt(stringExtra5));
                    ...
                    erVar2.a(j2, stringExtra3, stringExtra4);
                    erVar2.a(intent.getStringExtra("ext_pkt_id"));
                    erVar2.a(byteArrayExtra, a3.f13351h);
    ...
    */
    ...
    private void c(Intent intent) {
        ...
        for (int i3 = 0; i3 < fnVarArr.length; i3++) {
            ...
            erVarArr[i3] = er.a(fnVar, a2.a(fnVar.k(), fnVar.m()).f13351h);
        }
    ...
    void a(final String str, final byte[] bArr, boolean z) {
        Collection<am.b> m693a = am.a().m693a("5");
        if (m693a.isEmpty()) {
            if (z) {
                com.xiaomi.push.service.t.b(str, bArr);
            }
        } else if (m693a.iterator().next().f996a == am.c.binded) {
    ...
    public boolean m667b() {
        try {
            Class<?> a2 = C0334r.a(this, "miui.os.Build");
    ...
    private fo a(fo foVar, String str, String str2) {
        am a2 = am.a();
        List<String> m694a = a2.m694a(str);
        if (m694a.isEmpty()) {
    ...
    private boolean m651a(String str, Intent intent) {
        ...
        if (!TextUtils.isEmpty(a2.f13352i) && !TextUtils.equals(stringExtra, a2.f13352i)) {
            com.xiaomi.channel.commonutils.logger.b.m50a("session changed. old session=" + a2.f13352i + ", new session=" + stringExtra + " chid = " + str);
            z = true;
        }
        if (stringExtra2.equals(a2.f13351h)) {
            return z;
        }
    ...
    private am.b a(String str, Intent intent) {
        ...
        a2.f13350g = intent.getStringExtra(an.v);
        a2.f1001b = intent.getStringExtra(an.s);
        a2.f13346c = intent.getStringExtra(an.z);
        a2.f998a = intent.getStringExtra(an.F);
        a2.f13348e = intent.getStringExtra(an.D);
        a2.f13349f = intent.getStringExtra(an.E);
        a2.f1000a = intent.getBooleanExtra(an.C, false);
        a2.f13351h = intent.getStringExtra(an.B);
        a2.f13352i = intent.getStringExtra(an.J);
        a2.f13347d = intent.getStringExtra(an.A);
        a2.f997a = this.f947a;
        a2.a((Messenger) intent.getParcelableExtra(an.N));
        a2.f990a = getApplicationContext();
        am.a().a(a2);
        return a2;
    }
    ...
    private void a(String str, int i2) {
        Collection<am.b> m693a = am.a().m693a(str);
        if (m693a != null) {
            for (am.b bVar : m693a) {
                if (bVar != null) {
    ...
    public boolean m663a() {
        boolean m151a = com.xiaomi.push.au.m151a((Context) this);
        boolean z = am.a().m691a() > 0;
        boolean z2 = !m667b();
        boolean m657h = m657h();
        boolean z3 = !m656g();
        boolean z4 = m151a && z && z2 && m657h && z3;
        if (!z4) {
            com.xiaomi.channel.commonutils.logger.b.e(String.format("not conn, net=%s;cnt=%s;!dis=%s;enb=%s;!spm=%s;", Boolean.valueOf(m151a), Boolean.valueOf(z), Boolean.valueOf(z2), Boolean.valueOf(m657h), Boolean.valueOf(z3)));
        }
        return z4;
    }
