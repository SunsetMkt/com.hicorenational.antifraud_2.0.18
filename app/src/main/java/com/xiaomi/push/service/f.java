...
public class f {
    ...
    static void a(Context context, String str) {
        List<NotificationChannel> m685a;
        if (!com.xiaomi.push.j.m627a(context) || TextUtils.isEmpty(str) || (m685a = af.a(context, str).m685a()) == null) {
            return;
        }
        synchronized (f.class) {
            SharedPreferences a2 = a(context);
            ArrayList arrayList = new ArrayList();
            Iterator<NotificationChannel> it = m685a.iterator();
            while (it.hasNext()) {
    ...
    private static void a(String str, String str2, int i2, boolean z) {
        com.xiaomi.channel.commonutils.logger.b.m50a("ChannelPermissions.grantPermission:" + str + Constants.COLON_SEPARATOR + str2 + ": <" + i2 + ContainerUtils.KEY_VALUE_DELIMITER + z + "> :" + ag.a(C0334r.m636a(), str, str2, f13419a.get(i2), z));
    }

    public static int a(String str, String str2, int i2) {
        return ag.a(C0334r.m636a(), str, str2, f13419a.get(i2));
    }

    /* renamed from: a, reason: collision with other method in class */
    public static Bundle m715a(String str, String str2) {
        return ag.a(C0334r.m636a(), str, str2);
    }

    /* renamed from: a, reason: collision with other method in class */
    private static boolean m716a(String str, String str2, int i2) {
        boolean z = ag.a(C0334r.m636a(), str, str2, f13419a.get(i2)) == 1;
