...
public class ag {
    ...
    public static boolean a() {
        if (f982a == null) {
            if (Build.VERSION.SDK_INT >= 30) {
                Bundle m715a = f.m715a("com.xiaomi.xmsf", (String) null);
                if (m715a == null || m715a.isEmpty()) {
                    f982a = false;
                } else {
                    f982a = true;
                }
    ...
    public static String c(Notification notification) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(r0) && (a2 = com.xiaomi.push.aw.a(notification, "extraNotification")) != null) {
                return (String) com.xiaomi.push.aw.a(a2, "getTargetPkg", new Object[0]);
            }
    ...
    public static void b(Notification notification, boolean z) {
        try {
            ...
            if (a2 != null) {
                com.xiaomi.push.aw.a(a2, "setEnableKeyguard", Boolean.valueOf(z));
            }
        } catch (Exception unused) {
        }
    }
    ...
    static void m688a(Notification notification, String str) {
        try {
            ...
            Object a2 = com.xiaomi.push.aw.a(notification, "extraNotification");
            if (a2 != null) {
                com.xiaomi.push.aw.a(a2, "setTargetPkg", str);
            }
        } catch (Exception unused) {
        }
    }
    ...
    static void a(Notification notification, boolean z) {
        try {
            ...
            Object a2 = com.xiaomi.push.aw.a(notification, "extraNotification");
            if (a2 != null) {
                com.xiaomi.push.aw.a(a2, "setEnableFloat", Boolean.valueOf(z));
            }
        } catch (Exception unused) {
        }
    }
    ...
    static void a(Notification notification, int i2) {
        try {
            ...
            Object a2 = com.xiaomi.push.aw.a(notification, "extraNotification");
            if (a2 != null) {
                com.xiaomi.push.aw.a(a2, "setMessageCount", Integer.valueOf(i2));
            }
        } catch (Exception unused) {
        }
    }
    ...
    public static int a(Context context, String str, String str2, a<String, String, String> aVar) {
        ...
        try {
            Bundle a2 = a(context, aVar.f13334b, str, str2, (Bundle) null);
            if (a2 == null || !a2.containsKey(aVar.f13335c)) {
                return -1;
            }
            return a2.getBoolean(aVar.f13335c) ? 1 : 0;
        } catch (Exception unused) {
            return -1;
        }
    }
