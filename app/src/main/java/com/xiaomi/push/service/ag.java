...
public class ag {
    ...
    public static final a<String, String, String> f9346b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final a<String, String, String> f9347c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final a<String, String, String> f9348d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final a<String, String, String> f9349e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public static final a<String, String, String> f9350f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public static final a<String, String, String> f9351g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public static final a<String, String, String> f9352h;
    ...
    static {
        ...
        f9346b = new a<>("setSound", str2, str2);
        String str3 = "canVibrate";
        f9347c = new a<>("setVibrate", str3, str3);
        String str4 = "canLights";
        f9348d = new a<>("setLights", str4, str4);
        String str5 = "canShowOnKeyguard";
        f9349e = new a<>("setShowOnKeyguard", str5, str5);
        f9350f = new a<>("setFloat", "canFloat", "canShowFloat");
        String str6 = "canShowBadge";
        f9351g = new a<>("setShowBadge", str6, str6);
        String str7 = "canShowOngoing";
        f9352h = new a<>("setShowOngoing", str7, str7);
    }

    public static boolean a() {
        Bundle bundleM713a;
        if (f982a == null) {
            if (Build.VERSION.SDK_INT < 30 || (bundleM713a = f.m713a("com.xiaomi.xmsf", (String) null)) == null || bundleM713a.isEmpty()) {
                f982a = false;
            } else {
                f982a = true;
            }
    ...
    public static Notification.Action[] m688a(Notification notification) {
    ...
    public static void a(Map<String, String> map, Bundle bundle, String str) {
        ...
        com.xiaomi.channel.commonutils.logger.b.m48a("cp map to b fail:" + str);
    }

    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    static void m686a(Notification notification, String str) {
        try {
            if (notification.extras != null) {
    ...
    public static <T> T a(Object obj, String str, T t) {
        ...
        try {
            if (obj instanceof Notification) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a("not support get value from classType:" + obj);
            }
        } catch (Exception e2) {
            com.xiaomi.channel.commonutils.logger.b.m48a("get value error " + e2);
        }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (!TextUtils.isEmpty(str2)) {
                ...
                try {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m48a("can't match url intent. " + e2);
                }
            }
        }
    ...
    public static int a(ContentResolver contentResolver) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m48a("get user aggregate failed, " + e2);
            return 0;
        }
    }

    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static boolean m687a(ContentResolver contentResolver) {
        int iA = a(contentResolver);
        return iA == 1 || iA == 2;
    }

    public static boolean a(Map<String, String> map) {
        return Boolean.parseBoolean((String) a(map, "not_suppress", b.a.u.a.f1908j));
    }
    ...
    public static int a(Context context, String str, String str2, a<String, String, String> aVar) {
        ...
        try {
            Bundle bundleA = a(context, aVar.f9353b, str, str2, (Bundle) null);
            if (bundleA == null || !bundleA.containsKey(aVar.f9354c)) {
                return -1;
            }
            return bundleA.getBoolean(aVar.f9354c) ? 1 : 0;
        } catch (Exception unused) {
            return -1;
        }
    }
    ...
    public static Bundle a(Context context, String str, String str2) {
        try {
            return a(context, a.f9353b, str, str2, (Bundle) null);
        } catch (Exception unused) {
            return null;
        }
    }
    ...
    public static boolean a(Context context, String str, String str2, a<String, String, String> aVar, boolean z) {
        if (aVar != null) {
            try {
                ...
                bundle.putBoolean(aVar.f9354c, z);
