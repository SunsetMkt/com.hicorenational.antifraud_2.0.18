...
public class ah {
    ...
    protected SharedPreferences f9355b;
    ...
    private ah(Context context) {
        ...
        this.f9355b = context.getSharedPreferences("mipush_oc_custom", 0);
    }
    ...
    public void a(List<Pair<gl, Integer>> list, List<Pair<Integer, Object>> list2) {
        ...
        com.xiaomi.channel.commonutils.logger.b.m48a("not update oc, because versions or configs are empty");
    }
    ...
    public void a(List<Pair<Integer, Object>> list) {
        ...
        SharedPreferences.Editor editorEdit = this.f9355b.edit();
    ...
    public int a(int i2, int i3) {
        try {
            String strA = a(i2);
            if (this.f9355b.contains(strA)) {
                return this.f9355b.getInt(strA, 0);
            }
            return this.f985a.contains(strA) ? this.f985a.getInt(strA, 0) : i3;
        } catch (Exception e2) {
            com.xiaomi.channel.commonutils.logger.b.m48a(i2 + " oc int error " + e2);
            return i3;
        }
    }
    ...
    public long a(int i2, long j2) {
        try {
            String strA = a(i2);
            if (this.f9355b.contains(strA)) {
                return this.f9355b.getLong(strA, 0L);
            }
            return this.f985a.contains(strA) ? this.f985a.getLong(strA, 0L) : j2;
        } catch (Exception e2) {
            com.xiaomi.channel.commonutils.logger.b.m48a(i2 + " oc long error " + e2);
            return j2;
        }
    }
    ...
    public String a(int i2, String str) {
        try {
            String strA = a(i2);
            if (this.f9355b.contains(strA)) {
                return this.f9355b.getString(strA, null);
            }
            return this.f985a.contains(strA) ? this.f985a.getString(strA, null) : str;
        } catch (Exception e2) {
            com.xiaomi.channel.commonutils.logger.b.m48a(i2 + " oc string error " + e2);
            return str;
        }
    }
    ...
    public boolean a(int i2, boolean z) {
        try {
            String strA = a(i2);
            if (this.f9355b.contains(strA)) {
                return this.f9355b.getBoolean(strA, false);
            }
            return this.f985a.contains(strA) ? this.f985a.getBoolean(strA, false) : z;
        } catch (Exception e2) {
            com.xiaomi.channel.commonutils.logger.b.m48a(i2 + " oc boolean error " + e2);
            return z;
        }
    }
    ...
    public int a(gl glVar, int i2) {
        try {
            ...
            com.xiaomi.channel.commonutils.logger.b.m48a(glVar + " version error " + e2);
            return i2;
        }
    }
