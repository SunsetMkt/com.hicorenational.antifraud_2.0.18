...
public class ah {
    ...
    public void a(List<Pair<gl, Integer>> list, List<Pair<Integer, Object>> list2) {
        if (!com.xiaomi.push.z.a(list) && !com.xiaomi.push.z.a(list2)) {
            SharedPreferences.Editor edit = this.f985a.edit();
            edit.clear();
            for (Pair<gl, Integer> pair : list) {
                Object obj = pair.first;
                if (obj != null && pair.second != null) {
                    edit.putInt(a((gl) obj), ((Integer) pair.second).intValue());
                }
            }
    ...
    public void a(List<Pair<Integer, Object>> list) {
        ...
        SharedPreferences.Editor edit = this.f13337b.edit();
    ...
    public int a(int i2, int i3) {
        try {
            String a2 = a(i2);
            if (this.f13337b.contains(a2)) {
                return this.f13337b.getInt(a2, 0);
            }
            return this.f985a.contains(a2) ? this.f985a.getInt(a2, 0) : i3;
        } catch (Exception e2) {
    ...
    public long a(int i2, long j2) {
        try {
            String a2 = a(i2);
            if (this.f13337b.contains(a2)) {
                return this.f13337b.getLong(a2, 0L);
            }
            return this.f985a.contains(a2) ? this.f985a.getLong(a2, 0L) : j2;
        } catch (Exception e2) {
    ...
    public String a(int i2, String str) {
        try {
            String a2 = a(i2);
            if (this.f13337b.contains(a2)) {
                return this.f13337b.getString(a2, null);
            }
            return this.f985a.contains(a2) ? this.f985a.getString(a2, null) : str;
        } catch (Exception e2) {
    ...
    public boolean a(int i2, boolean z) {
        try {
            String a2 = a(i2);
            if (this.f13337b.contains(a2)) {
                return this.f13337b.getBoolean(a2, false);
            }
            return this.f985a.contains(a2) ? this.f985a.getBoolean(a2, false) : z;
        } catch (Exception e2) {
