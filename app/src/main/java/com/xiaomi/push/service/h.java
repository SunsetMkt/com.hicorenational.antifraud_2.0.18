...
public class h {
    ...
    public void a(XMPushService xMPushService, String str, fo foVar) {
        ...
        if ("5".equalsIgnoreCase(str)) {
            this.f13423a.a(xMPushService, foVar, a2);
            return;
        }
        String str3 = a2.f998a;
        ...
        intent.putExtra(an.J, a2.f13352i);
        intent.putExtra(an.B, a2.f13351h);
        com.xiaomi.channel.commonutils.logger.b.m50a(String.format("[Bcst] notify packet arrival. %s,%s,%s", a2.f13350g, a2.f998a, foVar.j()));
    ...
    public void a(XMPushService xMPushService, String str, er erVar) {
        ...
        if ("5".equalsIgnoreCase(str)) {
            this.f13423a.a(xMPushService, erVar, a2);
            return;
        }
        String str2 = a2.f998a;
        Intent intent = new Intent();
        intent.setAction("com.xiaomi.push.new_msg");
        intent.setPackage(str2);
        intent.putExtra("ext_rcv_timestamp", SystemClock.elapsedRealtime());
        intent.putExtra("ext_chid", str);
        intent.putExtra("ext_raw_packet", erVar.m395a(a2.f13351h));
        intent.putExtra(an.J, a2.f13352i);
        intent.putExtra(an.B, a2.f13351h);
        if (e.a(erVar)) {
        ...
        if (a2.f992a != null) {
            try {
                a2.f992a.send(Message.obtain(null, 17, intent));
        ...
        com.xiaomi.channel.commonutils.logger.b.m50a(String.format("[Bcst] notify packet(blob) arrival. %s,%s,%s", a2.f13350g, a2.f998a, erVar.e()));
        if (e.a(erVar)) {
    ...
    am.b a(fo foVar) {
        Collection<am.b> m693a = am.a().m693a(foVar.k());
        if (m693a.isEmpty()) {
            return null;
        }
        Iterator<am.b> it = m693a.iterator();
        if (m693a.size() == 1) {
            return it.next();
        }
        String m2 = foVar.m();
        ...
        while (it.hasNext()) {
            am.b next = it.next();
            if (TextUtils.equals(m2, next.f1001b) || TextUtils.equals(l2, next.f1001b)) {
                return next;
            }
        }
        return null;
    ...
    am.b a(er erVar) {
        Collection<am.b> m693a = am.a().m693a(Integer.toString(erVar.a()));
        if (m693a.isEmpty()) {
            return null;
        }
        Iterator<am.b> it = m693a.iterator();
        ...
        while (it.hasNext()) {
            am.b next = it.next();
            if (TextUtils.equals(g2, next.f1001b)) {
                return next;
            }
        }
        return null;
