...
public class am {
                ...
                if ("9".equals(this.f1005a.f13350g) && "com.xiaomi.xmsf".equals(b.this.f994a.getPackageName())) {
                    b.this.f994a.a(new XMPushService.j(i2) { // from class: com.xiaomi.push.service.am.b.c.2
                        ...
                        public void mo379a() {
                            ...
                            if (a2.a(bVar.f13350g, bVar.f1001b).f992a == null) {
    ...
    public synchronized void a(b bVar) {
        HashMap<String, b> hashMap = this.f989a.get(bVar.f13350g);
        if (hashMap == null) {
            hashMap = new HashMap<>();
            this.f989a.put(bVar.f13350g, hashMap);
        }
        hashMap.put(a(bVar.f1001b), bVar);
    ...
    public synchronized void m697a(String str, String str2) {
        HashMap<String, b> hashMap = this.f989a.get(str);
        if (hashMap != null) {
