    ...
    public boolean a(a aVar, int i2, int i3, final boolean z) {
        ...
        b bVar = new b(aVar) { // from class: com.xiaomi.push.ae.1
            ...
            void b() {
                ...
                ae.this.f150a.edit().putLong(a2, System.currentTimeMillis()).commit();
            }
        };
        if (!z) {
            long abs = Math.abs(System.currentTimeMillis() - this.f150a.getLong(a2, 0L)) / 1000;
            if (abs < i2 - i3) {
                i3 = (int) (i2 - abs);
            }
        }
        try {
            ScheduledFuture<?> scheduleAtFixedRate = this.f153a.scheduleAtFixedRate(bVar, i3, i2, TimeUnit.SECONDS);
            synchronized (this.f151a) {
