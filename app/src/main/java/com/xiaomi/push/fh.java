...
public abstract class fh extends fa {
    ...
    public void b(boolean z) {
        ...
        this.f12821b.a(new XMPushService.j(13) { // from class: com.xiaomi.push.fh.1
            ...
            public void mo379a() {
                Thread.yield();
                if (!fh.this.m419c() || fh.this.a(elapsedRealtime)) {
                    return;
                }
    ...
    protected void a(Exception exc) {
        if (SystemClock.elapsedRealtime() - this.f12826g < 300000) {
            if (au.m151a((Context) this.f12821b)) {
                this.f12822c++;
                if (this.f12822c >= 2) {
                    String mo414a = mo414a();
                    com.xiaomi.channel.commonutils.logger.b.m50a("max short conn time reached, sink down current host:" + mo414a);
                    a(mo414a, 0L, exc);
                    this.f12822c = 0;
                    return;
                }
