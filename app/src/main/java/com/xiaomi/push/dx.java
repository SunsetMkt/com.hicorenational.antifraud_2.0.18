...
public abstract class dx extends dv {
    ...
    private boolean f() {
        List<StatusBarNotification> m687b;
        if (Build.VERSION.SDK_INT >= 20 && (m687b = com.xiaomi.push.service.af.a(a(), this.f410a).m687b()) != null && !m687b.isEmpty()) {
    ...
    private void m363c() {
        ...
        if (a2 != 0) {
            this.f408a = new RemoteViews(a().getPackageName(), a2);
            this.f413a = mo361a();
        } else {
    ...
    protected void a(int i2) {
        Bitmap a2 = a();
        if (a2 != null) {
            m366a().setImageViewBitmap(i2, a2);
            return;
        }
        int b2 = g.b(a(), this.f410a);
        if (b2 != 0) {
            m366a().setImageViewResource(i2, b2);
        }
    }
