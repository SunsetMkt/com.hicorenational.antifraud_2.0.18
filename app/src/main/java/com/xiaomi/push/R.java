...
public class r {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static synchronized String m635a() {
        String strB;
        if (f920a != null) {
            return f920a;
        }
        ...
        if (a() <= 0) {
            ...
            if (TextUtils.isEmpty(strB)) {
                ...
                if (TextUtils.isEmpty(strB)) {
                    strB = d();
                    if (TextUtils.isEmpty(strB)) {
                        strValueOf = String.valueOf(q.a(SystemUtils.PRODUCT_BRAND, "Android") + d.c.a.b.a.a.s1 + strValueOf);
                        strB = strValueOf;
                    }
                }
            }
    ...
    public static Class<?> a(Context context, String str) throws ClassNotFoundException {
        if (str != null && str.trim().length() != 0) {
            ...
            try {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a(String.format("loadClass fail hasContext= %s, errMsg = %s", Boolean.valueOf(z), th.getLocalizedMessage()));
