...
public class fz {
    ...
    static class a {
        ...
        public boolean a(a aVar) {
            return TextUtils.equals(aVar.f549a, this.f549a) && TextUtils.equals(aVar.f551b, this.f551b) && aVar.a == this.a && aVar.f9042b == this.f9042b && Math.abs(aVar.f548a - this.f548a) <= com.heytap.mcssdk.constant.a.r;
        }
    }
    ...
    public static void b(Context context, List<a> list) {
        try {
            synchronized (com.xiaomi.push.providers.a.f918a) {
                SQLiteDatabase writableDatabase = m442a(context).getWritableDatabase();
                ...
                try {
                    for (a aVar : list) {
                        ...
                        contentValues.put(com.umeng.analytics.pro.bh.T, Integer.valueOf(aVar.a));
                        contentValues.put("bytes", Long.valueOf(aVar.f550b));
                        contentValues.put("rcv", Integer.valueOf(aVar.f9042b));
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    private static synchronized String m443a(Context context) {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static synchronized void m446a(String str) {
        if (!j.m630d() && !TextUtils.isEmpty(str)) {
            f546a = str;
        }
    }
    ...
    private static void a(final Context context, String str, long j2, boolean z, long j3) {
        ...
        synchronized (f545a) {
            ...
            a(new a(str, j3, iA, z ? 1 : 0, iA == 0 ? m443a(context) : "", j2));
        }
        if (zIsEmpty) {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    private static com.xiaomi.push.providers.a m442a(Context context) {
