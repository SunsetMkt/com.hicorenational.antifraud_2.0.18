...
public class bw {
    ...
    public void b(a aVar) {
        ...
        synchronized (this.f231a) {
            buVar = this.f231a.get(m194a);
            if (buVar == null) {
                buVar = this.f229a.a(this.f228a, m194a);
                this.f231a.put(m194a, buVar);
            }
        }
        if (this.f232a.isShutdown()) {
            return;
        }
        aVar.a(buVar, this.f228a);
        a((Runnable) aVar);
    }
    ...
    public static abstract class b<T> extends a {
        ...
        public void a(Context context, SQLiteDatabase sQLiteDatabase) {
            ...
            int i2 = this.f12525a;
            Cursor query = sQLiteDatabase.query(super.f12523b, strArr, this.f239a, this.f241a, this.f12527c, this.f12528d, this.f12529e, i2 > 0 ? String.valueOf(i2) : null);
    ...
    private bu a(String str) {
        bu buVar = this.f231a.get(str);
        if (buVar == null) {
            synchronized (this.f231a) {
                if (buVar == null) {
                    buVar = this.f229a.a(this.f228a, str);
                    this.f231a.put(str, buVar);
                }
            }
        }
        return buVar;
