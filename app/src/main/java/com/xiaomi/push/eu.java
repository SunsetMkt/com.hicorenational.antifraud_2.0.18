...
public class eu {
    ...
    public int a(er erVar) {
        int c2 = erVar.c();
        if (c2 > 32768) {
            com.xiaomi.channel.commonutils.logger.b.m50a("Blob size=" + c2 + " should be less than 32768 Drop blob chid=" + erVar.a() + " id=" + erVar.e());
            return 0;
        }
        this.f476a.clear();
        int i2 = c2 + 8 + 4;
        ...
        this.f476a.putInt(c2);
        int position = this.f476a.position();
        this.f476a = erVar.mo391a(this.f476a);
        if (!"CONN".equals(erVar.m390a())) {
            if (this.f478a == null) {
                this.f478a = this.f474a.m408a();
            }
            com.xiaomi.push.service.ar.a(this.f478a, this.f476a.array(), true, position, c2);
        }
        this.f477a.reset();
        ...
        this.f475a.flush();
        int position2 = this.f476a.position() + 4;
        com.xiaomi.channel.commonutils.logger.b.c("[Slim] Wrote {cmd=" + erVar.m390a() + ";chid=" + erVar.a() + ";len=" + position2 + "}");
        return position2;
    }
    ...
    public void a() {
        ...
        byte[] mo422a = this.f474a.m413a().mo422a();
        if (mo422a != null) {
            eVar.a(dp.b.a(mo422a));
        }
        er erVar = new er();
        erVar.a(0);
