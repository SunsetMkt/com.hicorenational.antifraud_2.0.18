...
public class hd implements hq<hd, Object>, Serializable, Cloneable {
    ...
    public boolean m543a(hd hdVar) {
        ...
        boolean m542a = m542a();
        boolean m542a2 = hdVar.m542a();
        if (m542a || m542a2) {
            return m542a && m542a2 && this.f729a.equals(hdVar.f729a);
        }
        return true;
    }
    ...
    public int compareTo(hd hdVar) {
        ...
        int compareTo = Boolean.valueOf(m542a()).compareTo(Boolean.valueOf(hdVar.m542a()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (!m542a() || (a2 = hr.a(this.f729a, hdVar.f729a)) == 0) {
            return 0;
        }
        return a2;
    }
    ...
    public void a(ia iaVar) {
        ...
        while (true) {
            ...
            if (mo603a.f898a != 1) {
                ...
                this.f729a = new ArrayList(mo604a.f899a);
