...
public abstract class dl extends ae.a {
    ...
    public void run() {
        ...
        if (!TextUtils.isEmpty(a2) && m272b()) {
            if (m273c()) {
                SharedPreferences sharedPreferences = this.f330a.getSharedPreferences("mipush_extra", 0);
                if (bb.a(b2).equals(sharedPreferences.getString(d(), null))) {
                    long j2 = sharedPreferences.getLong(c(), 0L);
                    int a3 = com.xiaomi.push.service.ah.a(this.f330a).a(gk.DCJobUploadRepeatedInterval.a(), 604800);
