...
public class dd implements LoggerInterface {
    ...
    private dd(Context context) {
        ...
        this.f8855b = this.f321a.getPackageName() + Constants.ACCEPT_TIME_SEPARATOR_SERVER + Process.myPid();
    ...
    public final void log(final String str, final Throwable th) {
        this.f322a.post(new Runnable() { // from class: com.xiaomi.push.dd.1
            ...
            public void run() throws Throwable {
                dd.f320a.add(new Pair(String.format("%1$s %2$s %3$s ", dd.f319a.format(new Date()), dd.this.f8855b, str), th));
                if (dd.f320a.size() > 20000) {
                    ...
                    dd.f320a.add(new Pair(String.format("%1$s %2$s %3$s ", dd.f319a.format(new Date()), dd.this.f8855b, "flush " + size + " lines logs."), null));
                }
                try {
                    dd.this.m265a();
                } catch (Exception unused2) {
                    String unused3 = dd.this.f8855b;
                }
            }
        });
    }
    ...
    public void m265a() throws Throwable {
