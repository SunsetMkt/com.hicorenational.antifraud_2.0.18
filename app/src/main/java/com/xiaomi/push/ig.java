...
public class ig extends hw {
    ...
    public hz mo605a() {
        ...
        int mo601a = mo601a();
        if (mo601a <= f13239b) {
            return new hz(a2, a3, mo601a);
        }
        throw new ib(3, "Thrift map size " + mo601a + " out of range!");
    }
    ...
    public hy mo604a() {
        ...
        int mo601a = mo601a();
        if (mo601a <= f13240c) {
            return new hy(a2, mo601a);
        }
        throw new ib(3, "Thrift list size " + mo601a + " out of range!");
    }
    ...
    public ie mo606a() {
        ...
        int mo601a = mo601a();
        if (mo601a <= f13241d) {
            return new ie(a2, mo601a);
        }
        throw new ib(3, "Thrift set size " + mo601a + " out of range!");
    }
    ...
    public String mo608a() {
        ...
        throw new ib(3, "Thrift string size " + mo601a + " out of range!");
    }
    ...
    public ByteBuffer mo609a() {
        ...
        throw new ib(3, "Thrift binary size " + mo601a + " out of range!");
    }
}
