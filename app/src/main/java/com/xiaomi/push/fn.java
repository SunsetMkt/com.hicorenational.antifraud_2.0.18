...
public class fn extends fo {
    ...
    public Bundle a() {
        ...
        if (!TextUtils.isEmpty(this.f12844b)) {
            a2.putString("ext_msg_type", this.f12844b);
        }
        ...
        if (!TextUtils.isEmpty(this.f12849g)) {
            a2.putString("ext_body_encode", this.f12849g);
        }
        String str4 = this.f12845c;
        if (str4 != null) {
        ...
        if (!TextUtils.isEmpty(this.f12851i)) {
            a2.putString("ext_msg_seq", this.f12851i);
        }
        if (!TextUtils.isEmpty(this.f12852j)) {
            a2.putString("ext_msg_mseq", this.f12852j);
        }
        if (!TextUtils.isEmpty(this.f12853k)) {
            a2.putString("ext_msg_fseq", this.f12853k);
        }
        if (this.f526b) {
            a2.putBoolean("ext_msg_encrypt", true);
        }
        if (!TextUtils.isEmpty(this.f12854l)) {
            a2.putString("ext_msg_status", this.f12854l);
        }
        return a2;
    }
    ...
    public String mo431a() {
        ...
        if ("error".equalsIgnoreCase(this.f12844b) && (m432a = m432a()) != null) {
            sb.append(m432a.m435a());
        }
        sb.append(o());
        sb.append("</message>");
        return sb.toString();
