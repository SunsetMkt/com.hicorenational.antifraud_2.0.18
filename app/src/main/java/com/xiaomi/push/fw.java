...
public class fw {
    ...
    public static fo a(XmlPullParser xmlPullParser) throws XmlPullParserException, fi, IOException {
        ...
        if ("1".equals(xmlPullParser.getAttributeValue("", com.umeng.analytics.pro.bh.aE))) {
            ...
            while (!z) {
                ...
                if (next == 2) {
                    ...
                    a(com.xiaomi.push.service.ar.a(com.xiaomi.push.service.ar.a(bVarA.f9363h, attributeValue3), text));
                    a.next();
                    foVarA = a(a);
        ...
        fnVar2.a(!TextUtils.isEmpty(attributeValue) && attributeValue.equalsIgnoreCase(b.a.u.a.f1908j));
    ...
    private static String m441a(XmlPullParser xmlPullParser) {
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static fq m438a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
    ...
    public static fm a(XmlPullParser xmlPullParser, fa faVar) throws XmlPullParserException, IOException {
        ...
        while (!z) {
            ...
            if (next == 2) {
                ...
                if (name.equals("error")) {
                    fsVarM440a = m440a(xmlPullParser);
                } else {
                    fmVar = new fm();
        ...
        if (fmVar == null) {
            if (fm.a.a != aVarA && fm.a.f8985b != aVarA) {
                ...
                fmVar2.a(fm.a.f8987d);
                fmVar2.l(attributeValue4);
                fmVar2.a(new fs(fs.a.f9026e));
                faVar.a(fmVar2);
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static fr m439a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        fr frVar = null;
        boolean z = false;
        while (!z) {
            int next = xmlPullParser.next();
    ...
    /* JADX INFO: renamed from: a, reason: collision with other method in class */
    public static fs m440a(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
    ...
    public static fl a(String str, String str2, XmlPullParser xmlPullParser) {
        Object objM436a = fv.a().m436a("all", "xm:chat");
        if (objM436a == null || !(objM436a instanceof com.xiaomi.push.service.i)) {
            return null;
        }
        return ((com.xiaomi.push.service.i) objM436a).b(xmlPullParser);
    }
}
