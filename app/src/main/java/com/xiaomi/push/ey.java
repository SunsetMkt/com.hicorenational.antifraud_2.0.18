...
public class ey extends fh {
    ...
    synchronized byte[] m408a() {
        if (this.f486a == null && !TextUtils.isEmpty(((fa) this).f500a)) {
            String m705a = com.xiaomi.push.service.ax.m705a();
            this.f486a = com.xiaomi.push.service.ar.a(((fa) this).f500a.getBytes(), (((fa) this).f500a.substring(((fa) this).f500a.length() / 2) + m705a.substring(m705a.length() / 2)).getBytes());
        }
        return this.f486a;
    }
    ...
    public void b(er erVar) {
        ...
        if (euVar != null) {
            try {
                int a2 = euVar.a(erVar);
                ((fa) this).f12808d = SystemClock.elapsedRealtime();
                String f2 = erVar.f();
                if (!TextUtils.isEmpty(f2)) {
                    fz.a(((fa) this).f499a, f2, a2, false, true, System.currentTimeMillis());
                }
    ...
    /* renamed from: a, reason: collision with other method in class */
    protected void mo406a(boolean z) {
        if (this.f484a != null) {
            er a2 = a(z);
            com.xiaomi.channel.commonutils.logger.b.m50a("[Slim] SND ping id=" + a2.e());
            b(a2);
            f();
            return;
        }
