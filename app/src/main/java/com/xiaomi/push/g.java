...
public class g {
    ...
    public interface a {
        ...
        boolean m455a(Context context, String str);
    ...
    /* JADX INFO: renamed from: a */
    public static String m449a(Context context, String str) {
    ...
    public static boolean m454b(Context context, String str) {
        a aVar = a;
    ...
    /* JADX INFO: renamed from: b */
    public static String m453b(Context context, String str) {
    ...
    public static int b(Context context, String str) {
        ApplicationInfo applicationInfoM447a = m447a(context, str);
        if (applicationInfoM447a == null) {
            return 0;
        }
        int i2 = applicationInfoM447a.icon;
        return i2 == 0 ? applicationInfoM447a.logo : i2;
    }
    ...
    public static b a(Context context, String str, boolean z) {
        ...
        if (context != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a("get app op error " + th);
            }
            if (bVarA != b.UNKNOWN) {
                return bVarA;
            }
    ...
    private static b a(Context context, ApplicationInfo applicationInfo) {
        ...
        if (applicationInfo != null && i2 >= 24) {
            ...
            try {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a("are notifications enabled error " + e2);
            }
            return b.UNKNOWN;
        }
        return b.UNKNOWN;
    ...
    public static void a(Context context, ApplicationInfo applicationInfo, boolean z) {
        ...
        if (b.ALLOWED != a(context, applicationInfo)) {
            try {
                ...
                com.xiaomi.channel.commonutils.logger.b.m48a("set notifications enabled error " + e2);
            }
        }
    }

    /* JADX INFO: renamed from: a */
    public static boolean m452a(Context context, String str) {
        if (context == null || TextUtils.isEmpty(str)) {
            return false;
        }
        if (!j.m624a()) {
        ...
        a aVar = a;
        return aVar != null && aVar.m455a(context, str);
    }
    ...
    /* JADX INFO: renamed from: a */
    private static ApplicationInfo m447a(Context context, String str) {
        if (str.equals(context.getPackageName())) {
    ...
    /* JADX INFO: renamed from: a */
    public static Drawable m448a(Context context, String str) {
        ApplicationInfo applicationInfoM447a = m447a(context, str);
        Drawable drawableLoadIcon = null;
        if (applicationInfoM447a != null) {
            try {
                drawableLoadIcon = applicationInfoM447a.loadIcon(context.getPackageManager());
                if (drawableLoadIcon == null) {
                    drawableLoadIcon = applicationInfoM447a.loadLogo(context.getPackageManager());
                }
            } catch (Exception e2) {
                com.xiaomi.channel.commonutils.logger.b.m48a("get app icon drawable failed, " + e2);
            }
        }
    ...
    /* JADX INFO: renamed from: a */
    public static Map<String, String> m450a(Context context, String str) {
        a aVar = a;
        if (aVar == null) {
            return null;
        }
