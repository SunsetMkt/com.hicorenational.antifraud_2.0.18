...
public abstract class MiPushClient {
    ...
    private static void initEventPerfLogic(final Context context) {
        ...
        Config a2 = ds.a(context);
        com.xiaomi.clientreport.manager.a.a(context).a(BuildConfig.VERSION_NAME);
        ClientReportClient.init(context, a2, new dq(context), new dr(context));
        a.a(context);
        k.a(context, a2);
    ...
    static void reInitialize(Context context, gt gtVar) {
        ...
        String a2 = bb.a(6);
        String m76a = b.m75a(context).m76a();
        String b2 = b.m75a(context).b();
        b.m75a(context).m77a();
        clearExtrasForInitialize(context);
        clearNotification(context);
        b.m75a(context).a(Constants.a());
        b.m75a(context).a(m76a, b2, a2);
        hf hfVar = new hf();
        hfVar.a(aj.b());
        hfVar.b(m76a);
        hfVar.e(b2);
        ...
        new Thread(new Runnable() { // from class: com.xiaomi.mipush.sdk.MiPushClient.3
            ...
            public void run() {
                ...
                if (com.xiaomi.push.i.c(MiPushClient.sContext) != null || an.a(MiPushClient.sContext).mo137a()) {
                    ...
                    String e2 = com.xiaomi.push.i.e(MiPushClient.sContext);
                    if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(e2)) {
                        str = str + Constants.ACCEPT_TIME_SEPARATOR_SP + e2;
                    }
                    if (!TextUtils.isEmpty(str)) {
                    ...
                    if (a2 >= 0) {
                        heVar.m545a().put("space_id", Integer.toString(a2));
                    }
            ...
            if (z || !b.m75a(sContext).a(str, str2) || b.m75a(sContext).m87f()) {
                ...
                if (!com.xiaomi.push.j.m632d()) {
                    ...
                    if (!TextUtils.isEmpty(d2)) {
                        hfVar.i(bb.a(d2) + Constants.ACCEPT_TIME_SEPARATOR_SP + com.xiaomi.push.i.f(sContext));
                    }
                }
                int a3 = com.xiaomi.push.i.a();
                if (a3 >= 0) {
                ...
                if (b.m75a(sContext).m79a()) {
                    ...
                    String e2 = b.m75a(sContext).e();
                    if (!TextUtils.isEmpty(e2)) {
                        heVar.f736a.put("deviceid", e2);
                    }
