...
public final class NotificationClickedActivity extends Activity {
        ...
        try {
            if (intent != null) {
                ...
                if (intent2 != null) {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m49a("PushClickedActivity", "clicked activity start service.");
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.a = new BroadcastReceiver() { // from class: com.xiaomi.mipush.sdk.NotificationClickedActivity.2
        ...
        try {
            com.xiaomi.push.m.a(this, this.a, intentFilter, c.a(this), null, 4);
