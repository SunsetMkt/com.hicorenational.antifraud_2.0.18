...
public class r {
    ...
    /* JADX INFO: renamed from: com.xiaomi.mipush.sdk.r$1 */
    ...
    protected static <T extends hq<T, ?>> hb a(Context context, T t, gf gfVar) {
        return a(context, t, gfVar, !gfVar.equals(gf.Registration), context.getPackageName(), b.m73a(context).m74a());
    }
    ...
    public static hq a(Context context, hb hbVar) {
        ...
        if (hbVar.m535b()) {
            ...
            if (bArrA == null) {
                bArrA = ay.m159a(b.m73a(context).d());
            }
            try {
                bArrM533a = com.xiaomi.push.h.a(bArrA, hbVar.m533a());
            } catch (Exception e2) {
                throw new l("the aes decrypt failed.", e2);
            }
        } else {
            bArrM533a = hbVar.m533a();
        }
