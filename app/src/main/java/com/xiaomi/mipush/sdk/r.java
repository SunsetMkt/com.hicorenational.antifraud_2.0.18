...
public class r {
    ...
    public static hq a(Context context, hb hbVar) {
        byte[] m535a;
        if (hbVar.m537b()) {
            byte[] a2 = f.a(context, hbVar, d.ASSEMBLE_PUSH_FCM);
            if (a2 == null) {
                a2 = ay.m161a(b.m75a(context).d());
            }
            try {
                m535a = com.xiaomi.push.h.a(a2, hbVar.m535a());
            } catch (Exception e2) {
