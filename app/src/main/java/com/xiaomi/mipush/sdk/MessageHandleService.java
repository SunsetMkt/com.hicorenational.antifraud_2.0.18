...
public class MessageHandleService extends BaseService {
        ...
        ae.a(context).a(new Runnable() { // from class: com.xiaomi.mipush.sdk.MessageHandleService.1
            ...
            public void run() {
                try {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m48a(e2.getMessage());
                }
            }
        });
    }
    ...
    static void a(Context context, a aVar) {
        ...
        try {
            PushMessageReceiver pushMessageReceiverM66a = aVar.m66a();
            ...
            if (intExtra != 1) {
                if (intExtra != 3) {
                    ...
                    pushMessageReceiverM66a.onRequirePermissions(context, stringArrayExtra);
                    return;
                }
                ...
                pushMessageReceiverM66a.onCommandResult(context, miPushCommandMessage);
                if (TextUtils.equals(miPushCommandMessage.getCommand(), ed.COMMAND_REGISTER.f424a)) {
                    pushMessageReceiverM66a.onReceiveRegisterResult(context, miPushCommandMessage);
            ...
            if (aVarA != null) {
                if (aVarA instanceof MiPushMessage) {
                    ...
                    if (!miPushMessage.isArrivedMessage()) {
                        pushMessageReceiverM66a.onReceiveMessage(context, miPushMessage);
                    }
                    if (miPushMessage.getPassThrough() == 1) {
                        ...
                        pushMessageReceiverM66a.onReceivePassThroughMessage(context, miPushMessage);
                        return;
                    }
                    if (miPushMessage.isNotified()) {
                        ...
                        pushMessageReceiverM66a.onNotificationMessageClicked(context, miPushMessage);
                        return;
                    }
                    ...
                    pushMessageReceiverM66a.onNotificationMessageArrived(context, miPushMessage);
                    return;
                }
                if (aVarA instanceof MiPushCommandMessage) {
                    ...
                    pushMessageReceiverM66a.onCommandResult(context, miPushCommandMessage2);
                    if (TextUtils.equals(miPushCommandMessage2.getCommand(), ed.COMMAND_REGISTER.f424a)) {
                        pushMessageReceiverM66a.onReceiveRegisterResult(context, miPushCommandMessage2);
