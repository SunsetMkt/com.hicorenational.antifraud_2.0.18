...
public class b {
    ...
    private void c() {
        ...
        SharedPreferences a2 = a(this.f106a);
        this.f107a.f111a = a2.getString("appId", null);
        this.f107a.f12357b = a2.getString("appToken", null);
        this.f107a.f12358c = a2.getString("regId", null);
        this.f107a.f12359d = a2.getString("regSec", null);
        this.f107a.f12361f = a2.getString("devId", null);
        if (!TextUtils.isEmpty(this.f107a.f12361f) && com.xiaomi.push.i.a(this.f107a.f12361f)) {
            ...
            a2.edit().putString("devId", this.f107a.f12361f).commit();
        }
        this.f107a.f12360e = a2.getString("vName", null);
        this.f107a.f112a = a2.getBoolean("valid", true);
        this.f107a.f113b = a2.getBoolean("paused", false);
        this.f107a.f12356a = a2.getInt("envType", 1);
        this.f107a.f12362g = a2.getString("regResource", null);
        this.f107a.f12363h = a2.getString("appRegion", null);
    }
    ...
    public static class a {
        ...
        public void b(String str, String str2, String str3) {
            ...
            edit.putString("devId", this.f12361f);
        ...
        public boolean m90a(String str, String str2) {
            ...
            boolean equals2 = TextUtils.equals(this.f12357b, str2);
    ...
    public a a(String str) {
        ...
        a a3 = a.a(this.f106a, a2.getString(str2, ""));
        this.f109a.put(str2, a3);
        return a3;
    }
    ...
    public boolean m80a(String str, String str2, String str3) {
        a a2 = a(str3);
        return a2 != null && TextUtils.equals(str, a2.f111a) && TextUtils.equals(str2, a2.f12357b);
    }
