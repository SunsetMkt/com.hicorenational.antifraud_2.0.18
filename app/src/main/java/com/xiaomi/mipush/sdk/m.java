...
public class m {
    ...
    /* JADX INFO: renamed from: com.xiaomi.mipush.sdk.m$1 */
        ...
        if (serviceInfoArr != null) {
            for (ServiceInfo serviceInfo : serviceInfoArr) {
                if (!TextUtils.isEmpty(serviceInfo.name) && map2.containsKey(serviceInfo.name)) {
                    ...
                    boolean z = bVar.f123a;
                    boolean z2 = bVar.f124b;
    ...
    /* JADX WARN: Removed duplicated region for block: B:95:0x00aa A[EDGE_INSN: B:95:0x00aa->B:81:0x00aa BREAK  A[LOOP:0: B:66:0x0076->B:98:0x0076], SYNTHETIC] */
    ...
    */
    public static void c(Context context) {
        ...
        try {
            ActivityInfo activityInfoA = a(packageManager, intent, com.xiaomi.push.r.a(context, "com.xiaomi.push.service.receivers.PingReceiver"));
        ...
        while (it.hasNext()) {
            ...
            if (activityInfo != null) {
                try {
                    if (!TextUtils.isEmpty(activityInfo.name) && PushMessageReceiver.class.isAssignableFrom(com.xiaomi.push.r.a(context, activityInfo.name)) && activityInfo.enabled) {
                        z = true;
                    }
