...
public class MiPushClient4Hybrid {
    ...
    public static void onReceiveRegisterResult(Context context, hg hgVar) {
        b.a aVar;
        String c2 = hgVar.c();
        if (hgVar.a() == 0 && (aVar = dataMap.get(c2)) != null) {
            aVar.a(hgVar.f792e, hgVar.f793f);
            b.m75a(context).a(c2, aVar);
        }
        ...
        MiPushCommandMessage generateCommandMessage = PushMessageHelper.generateCommandMessage(ed.COMMAND_REGISTER.f424a, arrayList, hgVar.f780a, hgVar.f791d, null, null);
    ...
    public static void onReceiveUnregisterResult(Context context, hm hmVar) {
        MiPushCommandMessage generateCommandMessage = PushMessageHelper.generateCommandMessage(ed.COMMAND_UNREGISTER.f424a, null, hmVar.f858a, hmVar.f866d, null, null);
        String a2 = hmVar.a();
        MiPushCallback miPushCallback = sCallback;
        if (miPushCallback != null) {
    ...
    public static void registerPush(Context context, String str, String str2, String str3) {
        if (b.m75a(context).m80a(str2, str3, str)) {
            ...
            b.a a2 = b.m75a(context).a(str);
            if (a2 != null) {
                arrayList.add(a2.f12358c);
                MiPushCommandMessage generateCommandMessage = PushMessageHelper.generateCommandMessage(ed.COMMAND_REGISTER.f424a, arrayList, 0L, null, null, null);
                MiPushCallback miPushCallback = sCallback;
                if (miPushCallback != null) {
