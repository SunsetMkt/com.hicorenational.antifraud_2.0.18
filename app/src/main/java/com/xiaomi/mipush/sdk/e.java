...
public class e implements AbstractPushManager {
        ...
        if (this.f117a.getOpenHmsPush() || this.f117a.getOpenFCMPush() || this.f117a.getOpenCOSPush() || this.f117a.getOpenFTOSPush()) {
            ah.a(this.f116a).a(new ah.a(101, "assemblePush") { // from class: com.xiaomi.mipush.sdk.e.1
                ...
                protected void onCallback() {
                    boolean a2 = ah.a(e.this.f116a).a(gk.AggregatePushSwitch.a(), true);
                    if (e.this.f119a != a2) {
                        e.this.f119a = a2;
                        f.b(e.this.f116a);
                    }
    ...
    private void a() {
        ...
        if (pushConfiguration != null) {
            ...
            } else if (m93a(d.ASSEMBLE_PUSH_HUAWEI) && (a2 = a(d.ASSEMBLE_PUSH_HUAWEI)) != null) {
            ...
            } else if (m93a(d.ASSEMBLE_PUSH_FCM) && (a3 = a(d.ASSEMBLE_PUSH_FCM)) != null) {
            ...
            } else if (m93a(d.ASSEMBLE_PUSH_COS) && (a4 = a(d.ASSEMBLE_PUSH_COS)) != null) {
            ...
            if (this.f117a.getOpenFTOSPush() && f.m99a(this.f116a, d.ASSEMBLE_PUSH_FTOS) && h.d(this.f116a)) {
                ...
                if (!m93a(d.ASSEMBLE_PUSH_FTOS) || (a5 = a(d.ASSEMBLE_PUSH_FTOS)) == null) {
                    return;
                }
