...
public class w {
    ...
    /* JADX INFO: renamed from: com.xiaomi.mipush.sdk.w$1 */
    static class AnonymousClass1 implements Runnable {
        ...
        public void run() {
            ...
            heVar.b(bVarM73a.m74a());
            heVar.d(context.getPackageName());
            heVar.f736a = new HashMap();
            Map<String, String> map = heVar.f736a;
            Context context = context;
            com.xiaomi.push.l.a(map, "app_version", com.xiaomi.push.g.m449a(context, context.getPackageName()));
            Map<String, String> map2 = heVar.f736a;
            Context context2 = context;
            com.xiaomi.push.l.a(map2, Constants.EXTRA_KEY_APP_VERSION_CODE, Integer.toString(com.xiaomi.push.g.a(context2, context2.getPackageName())));
            ...
            com.xiaomi.push.l.a(heVar.f736a, "token", bVarM73a.b());
            ...
            com.xiaomi.push.l.a(heVar.f736a, Constants.EXTRA_KEY_REG_ID, bVarM73a.m81c());
            com.xiaomi.push.l.a(heVar.f736a, Constants.EXTRA_KEY_REG_SECRET, bVarM73a.d());
            ...
            u.a(context).a(heVar, gf.Notification, false, (gs) null);
        }
    }
    ...
    public static void a(Context context, boolean z) {
        ae.a(context).a(new Runnable() { // from class: com.xiaomi.mipush.sdk.w.1
            ...
            public void run() {
                ...
                Map<String, String> map = heVar.f736a;
                Context context2 = context;
                com.xiaomi.push.l.a(map, "app_version", com.xiaomi.push.g.m449a(context2, context2.getPackageName()));
                Map<String, String> map2 = heVar.f736a;
                Context context22 = context;
                com.xiaomi.push.l.a(map2, Constants.EXTRA_KEY_APP_VERSION_CODE, Integer.toString(com.xiaomi.push.g.a(context22, context22.getPackageName())));
                com.xiaomi.push.l.a(heVar.f736a, "push_sdk_vn", BuildConfig.VERSION_NAME);
                com.xiaomi.push.l.a(heVar.f736a, "push_sdk_vc", Integer.toString(BuildConfig.VERSION_CODE));
                com.xiaomi.push.l.a(heVar.f736a, "token", bVarM73a.b());
                if (!com.xiaomi.push.j.m630d()) {
    ...
    public static void a(Context context, he heVar) {
        com.xiaomi.channel.commonutils.logger.b.m48a("need to update local info with: " + heVar.m543a());
        String str = heVar.m543a().get(Constants.EXTRA_KEY_ACCEPT_TIME);
        if (str != null) {
            ...
            if (strArrSplit.length == 2) {
                ...
                if ("00:00".equals(strArrSplit[0]) && "00:00".equals(strArrSplit[1])) {
                    b.m73a(context).a(true);
                } else {
                    b.m73a(context).a(false);
                }
            }
        }
        String str2 = heVar.m543a().get(Constants.EXTRA_KEY_ALIASES);
        if (str2 != null) {
        ...
        String str4 = heVar.m543a().get(Constants.EXTRA_KEY_TOPICS);
        if (str4 != null) {
        ...
        String str6 = heVar.m543a().get(Constants.EXTRA_KEY_ACCOUNTS);
        if (str6 != null) {
