    ...
    public static void a(final Context context, final boolean z) {
        ae.a(context).a(new Runnable() { // from class: com.xiaomi.mipush.sdk.w.1
            ...
            public void run() {
                ...
                com.xiaomi.push.l.a(heVar.f736a, "token", m75a.b());
                if (!com.xiaomi.push.j.m632d()) {
                    String a2 = bb.a(com.xiaomi.push.i.c(context));
                    String e2 = com.xiaomi.push.i.e(context);
                    if (!TextUtils.isEmpty(e2)) {
                        a2 = a2 + Constants.ACCEPT_TIME_SEPARATOR_SP + e2;
                    }
                    if (!TextUtils.isEmpty(a2)) {
                        com.xiaomi.push.l.a(heVar.f736a, Constants.EXTRA_KEY_IMEI_MD5, a2);
                    }
                }
                an.a(context).a(heVar.f736a);
                com.xiaomi.push.l.a(heVar.f736a, Constants.EXTRA_KEY_REG_ID, m75a.m83c());
                com.xiaomi.push.l.a(heVar.f736a, Constants.EXTRA_KEY_REG_SECRET, m75a.d());
