...
public final class SendAuth {
    ...
    public static class Options {
        ...
        public void fromBundle(Bundle bundle) {
            this.callbackClassName = C3232a.m10348a(bundle, "_wxapi_sendauth_options_callback_classname");
            this.callbackFlags = C3232a.m10346a(bundle, "_wxapi_sendauth_options_callback_flags", -1);
        }
    ...
    public static class Resp extends BaseResp {
        ...
        public boolean checkArgs() {
            ...
            Log.m10364e(TAG, "checkArgs fail, state is invalid");
            return false;
        }
