...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (pathOldToNew != null && pathOldToNew.length() > 0) {
                try {
                    ...
                    Log.m10364e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e2.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            Log.m10364e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        private static String pathOldToNew(String str) {
            Log.m10365i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m10364e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            ...
            Log.m10364e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = " + str);
            return str;
        }
    ...
    boolean checkArgs() {
        ...
        } else if (getType() == 76 && C3240b.m10372b(this.title)) {
            str = "checkArgs fail, Type = Music Video, but title == null";
        } else if (C3240b.m10371a(getType()) && ((bArr2 = this.thumbData) == null || bArr2.length > 131072)) {
            str = "checkArgs fail, thumbData should not be null or exceed 128kb";
        } else if (C3240b.m10371a(getType()) || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m10364e(TAG, "setThumbImage exception:" + e2.getMessage());
        }
    }
}
