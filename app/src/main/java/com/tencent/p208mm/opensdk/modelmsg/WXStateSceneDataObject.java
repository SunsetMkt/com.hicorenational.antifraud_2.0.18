...
public class WXStateSceneDataObject implements SendMessageToWX.IWXSceneDataObject {
    ...
    public boolean checkArgs() {
        ...
        if (str != null && str.length() > LENGTH_LIMIT) {
            Log.m10364e(TAG, "checkArgs fail, stateId is invalid");
            return false;
        }
        ...
        Log.m10364e(TAG, "checkArgs fail, statsJumpInfo is null");
        return false;
    }
    ...
    public void unserialize(Bundle bundle) {
        ...
        if (string != null) {
            try {
                ...
                Log.m10364e(TAG, "get WXSceneDataObject from bundle failed: unknown ident " + string + ", ex = " + e2.getMessage());
            }
        }
    }
}
