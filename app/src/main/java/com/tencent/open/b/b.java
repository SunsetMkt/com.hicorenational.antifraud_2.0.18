...
public class b {
    ...
    public void d() {
        ...
        if (!this.f9794l) {
            ...
            this.f9794l = b2.isEmpty();
            this.f9791i.addAll(b2);
    ...
    private c b(String str, String str2, Object obj, Map<String, Object> map) {
        ...
        hashMap.put("time_appid_openid", currentTimeMillis + c.c.a.b.a.a.s1 + this.f9784b + c.c.a.b.a.a.s1 + this.f9786d);
        hashMap.put("time", String.valueOf(currentTimeMillis));
        hashMap.put("openid", this.f9786d);
        hashMap.put("appid", this.f9784b);
        hashMap.put("app_name", this.f9785c);
        hashMap.put(Constants.PARAM_APP_VER, this.f9787e);
        hashMap.put(Constants.PARAM_PKG_NAME, this.f9788f);
        hashMap.put("os", "AND");
        ...
        hashMap.put("qq_install", this.f9789g);
        hashMap.put(Constants.PARAM_QQ_VER, this.f9790h);
    ...
    public void a(String str, String str2, Object obj, Map<String, Object> map) {
        ...
        SLog.i("AttaReporter", "attaReport cancel appid=" + this.f9784b + ", mAppName=" + this.f9785c + ", context=" + com.tencent.open.utils.g.a() + ", " + b2);
        this.f9792j.add(b2);
    }
