...
public class h {
        ...
        if (m.b(com.tencent.open.utils.g.a())) {
            this.f9807g.execute(new Runnable() { // from class: com.tencent.open.b.h.3
                ...
                public void run() {
                    ...
                    long j6;
                    boolean z;
                    com.tencent.open.a.g b2;
                    JSONObject d2;
                    int i3;
                    try {
                        Map<String, String> c2 = h.this.c();
                        if (c2 == null) {
                            return;
                        }
                        SLog.d("openSDK_LOG.ReportManager", "-->doReportVia, params: " + c2.toString());
                        int a2 = f.a();
                        ...
                        do {
                            ...
                            try {
                                try {
                                    b2 = com.tencent.open.a.f.a().b("https://appsupport.qq.com/cgi-bin/appstage/mstats_batch_report", c2);
                        ...
                        j5 = j3;
                        z = false;
                        h.this.a("mapp_apptrace_sdk", j6, j5, j4, i5, null, false);
                        if (z) {
                            g.a("report_via");
                        } else {
                ...
                public void run() {
                    try {
                        ...
                        if (!h.this.a("report_via", size) && !z) {
                            ...
                            obtain.what = 1001;
                            h.this.f9806f.sendMessageDelayed(obtain, a2);
                            return;
                        }
                        h.this.d();
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0055, code lost:
        ...
        if (r5.f9802b.nextInt(100) < r6) goto L16;
     */
