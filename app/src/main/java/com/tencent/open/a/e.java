...
class e implements com.tencent.open.a.a {
    ...
    private static class a implements Interceptor {
        ...
        public Response intercept(Interceptor.Chain chain) throws IOException {
            return chain.proceed(chain.request().newBuilder().header(HttpHeaders.USER_AGENT, this.a).build());
        }
    }
    ...
    public void a(long j2, long j3) {
        ...
        this.a = this.a.newBuilder().connectTimeout(j2, TimeUnit.MILLISECONDS).readTimeout(j3, TimeUnit.MILLISECONDS).writeTimeout(j3, TimeUnit.MILLISECONDS).build();
    }
