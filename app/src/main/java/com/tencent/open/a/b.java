...
class b implements a {
    ...
    private g a(String str, int i2, String str2) throws IOException {
        HttpURLConnection httpURLConnection;
        InputStream inputStream;
        ByteArrayOutputStream byteArrayOutputStream;
        ByteArrayOutputStream byteArrayOutputStream2 = null;
    ...
    public g a(String str, Map<String, String> map, String str2, byte[] bArr) throws IOException {
        ...
        try {
            ...
            try {
                ...
                try {
                    try {
                        c cVar = new c(httpURLConnection, str3, httpURLConnection.getContentLength(), i2, httpURLConnection.getResponseCode(), "");
                        a(dataOutputStream);
                        a(inputStream2);
                        a(byteArrayOutputStream2);
                        b(httpURLConnection);
