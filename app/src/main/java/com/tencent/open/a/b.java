...
class b implements a {
    ...
    private int f6798b = BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH;
    ...
    private void a(HttpURLConnection httpURLConnection) {
        ...
        httpURLConnection.setRequestProperty(HttpHeaders.USER_AGENT, this.f6799c);
        httpURLConnection.setConnectTimeout(this.a);
        httpURLConnection.setReadTimeout(this.f6798b);
        ...
        try {
            ...
            try {
                ...
                if (bArr == null || bArr.length <= 0) {
                    ...
                    byte[] bytes = (e.d.F + string2 + e.d.F + "\r\n").getBytes();
