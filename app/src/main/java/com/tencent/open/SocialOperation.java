...
public class SocialOperation extends BaseApi {
    ...
    public void bindQQGroup(final Activity activity, String str, String str2, final IUiListener iUiListener) {
            ...
            public void onComplete(Object obj) {
                ...
                if (((JSONObject) obj).optInt(BaseMonitor.ALARM_POINT_BIND) == 1) {
                    ...
                    if (iUiListener3 != null) {
                        iUiListener3.onError(new UiError(ErrorStatus.r0, "该群已绑定！", "绑定过的群不能再次绑定。"));
                    }
        ...
        HttpUtils.requestAsync(this.f9634c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", a3, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void joinGroup(final Activity activity, String str, final IUiListener iUiListener) {
        ...
        DefaultUiListener defaultUiListener = new DefaultUiListener() { // from class: com.tencent.open.SocialOperation.2
            ...
            public void onComplete(Object obj) {
                ...
                if (((JSONObject) obj).optInt(BaseMonitor.ALARM_POINT_BIND) != 1) {
                    IUiListener iUiListener3 = iUiListener;
                    if (iUiListener3 != null) {
                        iUiListener3.onError(new UiError(ErrorStatus.q0, "该组织未绑群，无法加入", "该组织未绑群，无法加入。"));
                        return;
                    }
                    return;
                }
        ...
        HttpUtils.requestAsync(this.f9634c, activity, "https://openmobile.qq.com/cgi-bin/qunopensdk/check_group", a2, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    public void makeFriend(Activity activity, Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            e.a().a(this.f9634c.getOpenId(), this.f9634c.getAppId(), Constants.VIA_MAKE_FRIEND, "14", "18", "1");
            return;
        }
        ...
        if (m.f(activity, "5.1.0")) {
            ...
            try {
                ...
                e.a().a(this.f9634c.getOpenId(), this.f9634c.getAppId(), Constants.VIA_MAKE_FRIEND, "14", "18", "0");
            } catch (Exception e2) {
    ...
    public void unBindGroup(Context context, String str, final IUiListener iUiListener) {
        ...
        a2.putString("appid", appId);
        a2.putString("orgid", str);
        HttpUtils.requestAsync(this.f9634c, context, "https://openmobile.qq.com/cgi-bin/qunopensdk/unbind", a2, "GET", new BaseApi.TempRequestListener(defaultUiListener));
    ...
    private void a(Activity activity, String str) {
        new TDialog(activity, "", a(str), null, this.f9634c).show();
    }
}
