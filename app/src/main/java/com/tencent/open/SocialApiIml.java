...
public class SocialApiIml extends BaseApi {
    ...
    private class a extends DefaultUiListener {
        ...
        public void onComplete(Object obj) {
            ...
            this.f9721e.putString("encrytoken", str);
    ...
    public void writeEncryToken(Context context) {
        ...
        String str2 = "<!DOCTYPE HTML><html lang=\"en-US\"><head><meta charset=\"UTF-8\"><title>localStorage Test</title><script type=\"text/javascript\">document.domain = 'qq.com';localStorage[\"" + this.f9634c.getOpenId() + c.c.a.b.a.a.s1 + this.f9634c.getAppId() + "\"]=\"" + str + "\";</script></head><body></body></html>";
    ...
    private void a(Activity activity, Intent intent, String str, Bundle bundle, String str2, IUiListener iUiListener, boolean z) {
        ...
        i a2 = i.a(g.a(), this.f9634c.getAppId());
        if (!z && !a2.b("C_LoginH5")) {
            z2 = false;
        }
        if (z2) {
    ...
    private void a(Activity activity, String str, Bundle bundle, String str2, IUiListener iUiListener) {
        ...
        if (b2 != null && c2 != null && c2.getComponent() != null && b2.getComponent() != null && c2.getComponent().getPackageName().equals(b2.getComponent().getPackageName())) {
            b2.putExtra("oauth_consumer_key", this.f9634c.getAppId());
            b2.putExtra("openid", this.f9634c.getOpenId());
            b2.putExtra("access_token", this.f9634c.getAccessToken());
        ...
        String g2 = m.g("tencent&sdk&qazxc***14969%%" + this.f9634c.getAccessToken() + this.f9634c.getAppId() + this.f9634c.getOpenId() + "qzone3.4");
