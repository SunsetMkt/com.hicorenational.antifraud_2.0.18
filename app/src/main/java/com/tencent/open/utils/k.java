...
public class k {
    ...
    public static String b(Context context, String str) {
        ...
        try {
            ...
            messageDigest.update(m.j(packageName + c.c.a.b.a.a.s1 + a2 + c.c.a.b.a.a.s1 + str + ""));
    ...
    private static PackageInfo e(Context context, String str) {
        ...
        synchronized (k.class) {
            if (!f9933a.containsKey(str)) {
                ...
                f9933a.put(str, new com.tencent.a.a.a(str, f2));
                return f2;
            }
    ...
    private static String c() {
        String b2 = com.tencent.open.b.b.b();
        if (b2 == null || b2.isEmpty()) {
            SLog.e("openSDK_LOG.SystemUtils", "getAppId error: " + b2);
        }
        return b2;
    }
    ...
    public static boolean a(Context context, Intent intent) {
        if (context != null && intent != null) {
            ...
            if (!z) {
                ...
                sb.append(queryIntentActivities == null ? c.c.a.b.a.a.f3101h : Integer.valueOf(queryIntentActivities.size()));
                sb.append(" Intent= ");
                sb.append(intent);
