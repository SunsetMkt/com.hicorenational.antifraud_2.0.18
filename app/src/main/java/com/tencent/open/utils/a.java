...
public class a {
    ...
    private SharedPreferences f6904b;

    public a(Context context) {
        try {
            this.f6904b = context.getSharedPreferences("KEYSTORE_SETTING", 0);
    ...
    private void c(String str) {
        this.f6904b.edit().putString("PREF_KEY_IV", str).apply();
    }

    private void d(String str) {
        this.f6904b.edit().putString("PREF_KEY_AES", str).apply();
    }
    ...
    private SecretKeySpec c() throws Exception {
        String string = this.f6904b.getString("PREF_KEY_AES", "");
    ...
    private byte[] b() {
        return Base64.decode(this.f6904b.getString("PREF_KEY_IV", ""), 0);
    }
