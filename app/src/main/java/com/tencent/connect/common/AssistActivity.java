...
public class AssistActivity extends Activity {
    ...
    protected Handler f6705b = new Handler() { // from class: com.tencent.connect.common.AssistActivity.1
        AnonymousClass1() {
        }
    ...
    /* JADX INFO: renamed from: com.tencent.connect.common.AssistActivity$1 */
    /* JADX INFO: compiled from: ProGuard */
    ...
    /* JADX INFO: renamed from: com.tencent.connect.common.AssistActivity$2 */
    /* JADX INFO: compiled from: ProGuard */
    ...
    private void a(Intent intent, boolean z) {
        ...
        if (bundleExtra != null) {
            ...
            h.a().a(bundleExtra, this.f6707d, intent.getBooleanExtra(Constants.KEY_PASS_REPORT_VIA_TIMELY, false));
        }
    }
    ...
    */
    protected void onCreate(Bundle bundle) throws Throwable {
        ...
        boolean z = false;
        this.f6709f = getIntent().getBooleanExtra(Constants.KEY_RESTORE_LANDSCAPE, false);
        SLog.i("openSDK_LOG.AssistActivity", "--onCreate-- mRestoreLandscape=" + this.f6709f);
        if (getIntent() == null) {
        ...
        this.f6707d = intent == null ? "" : intent.getStringExtra("appid");
        Bundle bundleExtra = getIntent().getBundleExtra("h5_share_data");
        if (bundle != null) {
            this.f6706c = bundle.getBoolean("RESTART_FLAG");
        ...
        try {
            ...
            if (this.f6708e == null) {
                this.f6708e = new QQStayReceiver();
            }
            registerReceiver(this.f6708e, intentFilter);
        } catch (Exception e2) {
    ...
    protected void onDestroy() {
        ...
        super.onDestroy();
        QQStayReceiver qQStayReceiver = this.f6708e;
    ...
    protected void onResume() {
        ...
        if (!intent.getBooleanExtra("is_qq_mobile_share", false) && this.f6706c && !isFinishing()) {
            finish();
        }
        if (!this.a) {
            this.a = true;
        } else {
            this.f6705b.sendMessage(this.f6705b.obtainMessage(0));
        }
    }
        ...
        try {
            ...
            if (TextUtils.isEmpty(stringExtra)) {
                ...
                if (!TextUtils.isEmpty(strOptString) && !TextUtils.isEmpty(strOptString2)) {
                    ...
                    setResult(-1, intent);
                    e.a().a(strOptString, this.f6707d, "2", "1", "7", "0");
