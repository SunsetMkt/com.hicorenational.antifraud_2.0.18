...
public abstract class BaseApi {
    ...
    protected QQToken f6711c;

    /* JADX INFO: compiled from: ProGuard */
    public class TempRequestListener implements IRequestListener {

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final IUiListener f6712b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final Handler f6713c;

        public TempRequestListener(IUiListener iUiListener) {
            this.f6712b = iUiListener;
            this.f6713c = new Handler(g.a().getMainLooper()) { // from class: com.tencent.connect.common.BaseApi.TempRequestListener.1
                @Override // android.os.Handler
                public void handleMessage(Message message) {
                    if (message.what == 0) {
                        TempRequestListener.this.f6712b.onComplete(message.obj);
                    } else {
                        TempRequestListener.this.f6712b.onError(new UiError(message.what, (String) message.obj, null));
                    }
                }
            };
        }
        ...
        public void onComplete(JSONObject jSONObject) {
            Message messageObtainMessage = this.f6713c.obtainMessage();
            messageObtainMessage.obj = jSONObject;
            messageObtainMessage.what = 0;
            this.f6713c.sendMessage(messageObtainMessage);
        }
    ...
    protected void a(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        new TDialog(activity, "", "https://imgcache.qq.com/ptlogin/static/qzsjump.html?" + HttpUtils.encodeUrl(bundle), null, this.f6711c).show();
    }
}
