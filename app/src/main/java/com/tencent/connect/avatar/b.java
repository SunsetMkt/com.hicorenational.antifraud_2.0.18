...
public class b extends View {
    ...
    public Rect a() {
        if (this.f9607a == null) {
            ...
            this.f9607a.set(i2, i3, i2 + min, min + i3);
        }
        return this.f9607a;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0.0f, 0.0f, f2, a2.top, this.f9608b);
        canvas.drawRect(0.0f, a2.bottom, f2, measuredHeight, this.f9608b);
        canvas.drawRect(0.0f, a2.top, a2.left, a2.bottom, this.f9608b);
        canvas.drawRect(a2.right, a2.top, f2, a2.bottom, this.f9608b);
        canvas.drawColor(Color.argb(100, 0, 0, 0));
        this.f9608b.setStyle(Paint.Style.STROKE);
        this.f9608b.setColor(-1);
        canvas.drawRect(a2.left, a2.top, a2.right - 1, a2.bottom, this.f9608b);
    }
}
