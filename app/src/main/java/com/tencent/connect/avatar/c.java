...
public class c extends ImageView {
    ...
    public void b() {
        ...
        if (f4 > f5) {
            ...
            if (f4 < f10) {
                ...
                float width2 = this.f9616h.getWidth() * f4;
                float height2 = this.f9616h.getHeight() * f4;
                int i2 = this.p.left;
                float f13 = i2 - f2;
                float f14 = r9.top - f3;
                if (f13 < 0.0f) {
    ...
    private void c() {
        ...
        float[] fArr = {r1, 0.0f, this.f9618j, 0.0f, r1, this.f9619k, 0.0f, 0.0f, 0.0f};
        this.f9611c.getValues(fArr);
        float max = Math.max(this.p.width() / this.f9616h.getWidth(), this.p.height() / this.f9616h.getHeight());
        this.f9618j = this.p.left - (((this.f9616h.getWidth() * max) - this.p.width()) / 2.0f);
        this.f9619k = this.p.top - (((this.f9616h.getHeight() * max) - this.p.height()) / 2.0f);
        this.f9611c.setValues(fArr);
    ...
    */
    ...
    private void a(PointF pointF) {
        ...
        float width2 = (this.p.width() * f5) / (f6 + f5);
        Rect rect = this.p;
