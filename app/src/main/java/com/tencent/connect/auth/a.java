...
public class a extends Dialog {
            ...
            if (str.startsWith("auth://browser")) {
                ...
                if (!a.this.f9554m) {
                    if (c2.optString("fail_cb", null) != null) {
                        ...
                        if (optString != null) {
                            a.this.f9551j.loadUrl(optString);
                        }
                    }
                }
                return true;
    ...
    public boolean e() {
        ...
        Bundle b2 = m.b(this.f9542a);
        b2.putString("token_key", c2);
        b2.putString("serial", a3);
        b2.putString("browser", "1");
        this.f9542a = substring + "?" + HttpUtils.encodeUrl(b2);
    ...
    private void a(ViewGroup viewGroup) {
        ...
        int a2 = com.tencent.connect.avatar.a.a(this.f9552k, 15.6f);
        int a3 = com.tencent.connect.avatar.a.a(this.f9552k, 25.2f);
        int a4 = com.tencent.connect.avatar.a.a(this.f9552k, 10.0f);
        int i2 = a4 * 2;
