...
public class c {
    ...
    private QQToken f6674b;

    private c(String str, Context context) {
        SLog.i("openSDK_LOG.QQAuth", "new QQAuth() --start");
        this.f6674b = new QQToken(str);
        this.a = new AuthAgent(this.f6674b);
        com.tencent.connect.a.a.c(context, this.f6674b);
    ...
    public boolean c() {
        ...
        sb.append(this.f6674b.isSessionValid() ? b.a.u.a.f1908j : b.a.u.a.f1909k);
        SLog.i("openSDK_LOG.QQAuth", sb.toString());
        return this.f6674b.isSessionValid();
    }
    ...
    public void b(Context context, String str) {
        ...
        this.f6674b.setOpenId(str);
        com.tencent.connect.a.a.d(context, this.f6674b);
    ...
    public int a(Activity activity, String str, IUiListener iUiListener, boolean z, String str2, String str3, String str4) {
        ...
        if (str3.equals("")) {
            str3 = d.c.a.b.a.a.f10075h;
        }
        if (str4.equals("")) {
            str4 = d.c.a.b.a.a.f10075h;
        }
    ...
    public void a(String str, String str2) {
        ...
        this.f6674b.setAccessToken(str, str2);
    }
}
