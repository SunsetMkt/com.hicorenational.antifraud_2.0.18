...
public class b {
    ...
    private boolean f(CrashDetailBean crashDetailBean) {
        try {
            ...
            String format = String.format(Locale.US, "#--------\npackage:%s\nversion:%s\nsdk:%s\nprocess:%s\ndate:%s\ntype:%s\nmessage:%s\nstack:\n%s\neupID:%s\n", b2.f(), b2.p, b2.f8983j, crashDetailBean.A, aq.a(new Date(crashDetailBean.r)), crashDetailBean.n, crashDetailBean.o, crashDetailBean.q, crashDetailBean.f9024c);
            String str = null;
            if (c.f9089j != null) {
                ...
                str = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Tencent/" + this.f9072b.getPackageName();
            }
            aq.a(this.f9072b, str + "/euplog.txt", format, c.f9090k);
            return true;
        } catch (Throwable th) {
    ...
    protected List<a> a(List<a> list) {
        ...
        for (a aVar : list) {
            if (aVar.f9038d && aVar.f9036b <= currentTimeMillis - 86400000) {
                arrayList.add(aVar);
            }
        }
        return arrayList;
    ...
    public void c(CrashDetailBean crashDetailBean) {
        ...
        try {
            ...
            if (this.f9076f != null) {
                ...
                str = str5;
                str2 = str6;
                String b2 = this.f9076f.b(z, str4, str5, str6, -1234567890, j2);
                if (b2 != null) {
                    hashMap = new HashMap(1);
                    hashMap.put(com.umeng.socialize.tracker.a.f11818h, b2);
                } else {
                    hashMap = null;
                }
                map = hashMap;
                ...
                if (this.f9077g != null) {
                    ...
                    map = this.f9077g.onCrashHandleStart(i2, crashDetailBean.n, crashDetailBean.o, crashDetailBean.q);
                } else {
                    map = null;
                }
            }
            ...
            if (this.f9076f != null) {
                ...
                bArr = this.f9076f.a(z, str4, str, str2, -1234567890, j2);
                ...
                if (this.f9077g != null) {
                    ...
                    bArr2 = this.f9077g.onCrashHandleStart2GetExtraDatas(i2, crashDetailBean.n, crashDetailBean.o, crashDetailBean.q);
                }
                bArr = bArr2;
            }
            ...
            if (bArr != null) {
                if (bArr.length > i3) {
                    an.d("extra bytes size %d is over limit %d will drop over part", Integer.valueOf(bArr.length), Integer.valueOf(i3));
                    crashDetailBean.U = Arrays.copyOf(bArr, i3);
                }
                an.a("add extra bytes %d ", Integer.valueOf(bArr.length));
            }
            if (this.f9076f != null) {
                an.c("Calling 'onCrashSaving' of RQD crash listener.", new Object[0]);
                if (this.f9076f.a(z, str4, crashDetailBean.o, str, str2, -1234567890, j2, crashDetailBean.f9034m, crashDetailBean.f9026e, crashDetailBean.f9024c, crashDetailBean.A, crashDetailBean.B)) {
                    return;
                }
                ...
                while (cursor.moveToNext()) {
                    try {
                        ...
                        if (a2 != null) {
                            ...
                            try {
                                sb.append(cursor.getLong(cursor.getColumnIndex(bl.f10170d)));
                                sb.append(Constants.ACCEPT_TIME_SEPARATOR_SP);
                                i2++;
    ...
    public List<a> b() {
        ...
        ArrayList arrayList = new ArrayList();
        try {
            cursor = ae.a().a("t_cr", new String[]{bl.f10170d, "_tm", "_s1", "_up", "_me", "_uc"}, null, null, null, true);
            if (cursor == null) {
                return null;
            }
            try {
    ...
    public List<CrashDetailBean> a() {
        ...
        long b2 = aq.b();
        List<a> b3 = b();
        an.c("Size of crash list loaded from DB: %s", Integer.valueOf(b3.size()));
        ...
        while (it.hasNext()) {
            ...
            } else if (next.f9040f >= 3 && j2 < currentTimeMillis - 86400000) {
                it.remove();
                arrayList.add(next);
            }
        }
    ...
    public void a(final List<CrashDetailBean> list, long j2, boolean z, boolean z2, boolean z3) {
        ...
        if (com.tencent.bugly.crashreport.common.info.a.a(this.f9072b).f8981h && (akVar = this.f9073c) != null) {
            if (z3 || akVar.b(c.f9080a)) {
                ...
                try {
                    String str = this.f9073c.f9215b ? c2.s : c2.t;
                    String str2 = this.f9073c.f9215b ? StrategyBean.f8994c : StrategyBean.f8992a;
                    int i2 = this.f9073c.f9215b ? 830 : 630;
                    bg a2 = a(this.f9072b, list, com.tencent.bugly.crashreport.common.info.a.b());
                    if (a2 == null) {
                    ...
                    if (z) {
                        this.f9073c.a(f9071a, a4, str, str2, ajVar, j2, z2);
                    } else {
                        this.f9073c.a(f9071a, a4, str, str2, ajVar, false);
                    }
                } catch (Throwable th) {
    ...
    public void a(int i2) {
        ...
        sb.setLength(0);
        try {
            an.c("deleted first record %s data %d", "t_cr", Integer.valueOf(ae.a().a("t_cr", sb2, (String[]) null, (ad) null, true)));
        } catch (Throwable th) {
            if (an.a(th)) {
                return;
            }
    ...
    public static void a(String str, String str2, String str3, String str4, String str5, CrashDetailBean crashDetailBean) {
        ...
        an.e("# PKG NAME: %s", b2.f8977d);
        an.e("# APP VER: %s", b2.p);
        an.e("# SDK VER: %s", b2.f8983j);
