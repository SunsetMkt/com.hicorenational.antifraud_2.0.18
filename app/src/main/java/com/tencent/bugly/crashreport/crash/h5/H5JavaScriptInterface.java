...
public class H5JavaScriptInterface {
    ...
    public void reportJSException(String str) {
        ...
        a(a2, this.f9125c, linkedHashMap);
    }
    ...
    private a a(String str) {
        ...
        if (str != null && str.length() > 0) {
            try {
                ...
                aVar.f9135h = string.substring(indexOf + 1);
                aVar.f9134g = string.substring(0, indexOf);
                int indexOf2 = aVar.f9134g.indexOf(Constants.COLON_SEPARATOR);
                if (indexOf2 > 0) {
                    aVar.f9134g = aVar.f9134g.substring(indexOf2 + 1);
                }
