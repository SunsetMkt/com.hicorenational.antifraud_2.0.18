    ...
    */
    private static java.lang.String c(java.lang.String r3, java.lang.String r4) {
        /*
            ...
            java.io.BufferedReader r3 = com.tencent.bugly.proguard.aq.a(r3, r0)
            r0 = 0
            if (r3 != 0) goto La
            return r0
        La:
        ...
        L4a:
            r4 = move-exception
            com.tencent.bugly.proguard.an.a(r4)     // Catch: java.lang.Throwable -> L59
            if (r3 == 0) goto L58
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x0072, code lost:
        ...
        com.tencent.bugly.proguard.an.a(r9);
     */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private static java.lang.String b(java.lang.String r9, java.lang.String r10) {
        /*
            ...
            java.io.BufferedReader r9 = com.tencent.bugly.proguard.aq.a(r9, r0)
            r0 = 0
            if (r9 != 0) goto La
            return r0
        La:
        ...
        L76:
            r10 = move-exception
            com.tencent.bugly.proguard.an.a(r10)     // Catch: java.lang.Throwable -> L85
            if (r9 == 0) goto L84
    ...
    protected static CrashDetailBean a(Context context, Map<String, String> map, NativeExceptionHandler nativeExceptionHandler) {
        ...
        if (str3 != null && str3.trim().length() > 0) {
            ...
            try {
                ...
                byte[] a3 = (str14 == null || str14.isEmpty()) ? null : aq.a((File) null, str14, "BuglyNativeLog.txt");
                ...
                CrashDetailBean packageCrashDatas = nativeExceptionHandler.packageCrashDatas(str20, str18, (a2.get("etms").intValue() / 1000) + (a2.get("ets").intValue() * 1000), str2, str7, b(str12), str, str16, str10, map.get("sysLogPath"), map.get("jniLogPath"), str4, a3, hashMap, false, false);
                if (packageCrashDatas != null) {
                    String str22 = map.get("userId");
                    if (str22 != null) {
                        an.c("[Native record info] userId: %s", str22);
                        packageCrashDatas.f9034m = str22;
                    }
                    ...
                    if (str24 != null) {
                        ...
                        packageCrashDatas.f9027f = str24;
                    }
                    String str25 = map.get("isAppForeground");
                    if (str25 != null) {
                        an.c("[Native record info] isAppForeground: %s", str25);
                        packageCrashDatas.O = str25.equalsIgnoreCase(a.a.u.a.f1253j);
                    }
    ...
    */
    protected static java.lang.String a(java.io.BufferedInputStream r4) throws java.io.IOException {
        ...
        L29:
            ...
            r1 = r0
        L2b:
            com.tencent.bugly.proguard.an.a(r4)     // Catch: java.lang.Throwable -> L34
            if (r1 == 0) goto L33
        L30:
            r1.close()
        L33:
