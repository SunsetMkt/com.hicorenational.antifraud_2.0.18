    ...
    protected static CrashDetailBean a(Context context, Map<String, String> map, NativeExceptionHandler nativeExceptionHandler) {
        ...
        if (str3 != null && str3.trim().length() > 0) {
            ...
            try {
                ...
                CrashDetailBean crashDetailBeanPackageCrashDatas = nativeExceptionHandler.packageCrashDatas(str20, str18, (((long) mapA.get("etms").intValue()) / 1000) + (((long) mapA.get("ets").intValue()) * 1000), str2, str7, b(str12), str, str16, str10, map.get("sysLogPath"), map.get("jniLogPath"), str4, bArrA, map2, false, false);
                if (crashDetailBeanPackageCrashDatas != null) {
                    String str22 = map.get("userId");
                    if (str22 != null) {
                        an.c("[Native record info] userId: %s", str22);
                        crashDetailBeanPackageCrashDatas.f6227m = str22;
                    }
                    ...
                    if (str24 != null) {
                        ...
                        crashDetailBeanPackageCrashDatas.f6220f = str24;
                    }
                    String str25 = map.get("isAppForeground");
                    if (str25 != null) {
                        an.c("[Native record info] isAppForeground: %s", str25);
                        crashDetailBeanPackageCrashDatas.O = str25.equalsIgnoreCase(b.a.u.a.f1908j);
                    }
                    ...
                    crashDetailBeanPackageCrashDatas.f6225k = true;
                }
