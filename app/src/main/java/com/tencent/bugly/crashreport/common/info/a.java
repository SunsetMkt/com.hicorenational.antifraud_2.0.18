...
public class a {
    ...
    public final String f6180i = "com.tencent.bugly";

    /* JADX INFO: renamed from: j */
    public String f6181j = "3.1.7(1.4.5)";
    ...
    private a(Context context) {
        ...
        this.Q = aq.a(context);
        b(context);
        this.f6175d = AppInfo.a(context);
        this.f6176e = AppInfo.a(context, Process.myPid());
        this.f6183l = b.m();
        this.f6184m = b.a();
        this.r = AppInfo.c(context);
        this.f6185n = "Android " + b.b() + ",level " + b.c();
        StringBuilder sb = new StringBuilder();
        sb.append(this.f6184m);
        sb.append(";");
        sb.append(this.f6185n);
        this.f6173b = sb.toString();
        c(context);
        try {
    ...
    private void c(Context context) {
        ...
        try {
            ...
            if (str4 != null) {
                this.B = str4.equalsIgnoreCase(b.a.u.a.f1908j);
            }
    ...
    public String T() {
        if (this.f6178g == null) {
            this.f6178g = AppInfo.g(this.Q);
            an.a("Beacon channel " + this.f6178g, new Object[0]);
        }
        return this.f6178g;
    }
    ...
    public String f() {
        return !aq.a(this.f6177f) ? this.f6177f : this.ai;
    }
