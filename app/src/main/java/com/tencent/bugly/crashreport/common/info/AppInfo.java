...
public class AppInfo {
    ...
    public static final String[] f6169b = "@buglyAllChannelPriority@".split(Constants.ACCEPT_TIME_SEPARATOR_SP);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static ActivityManager f6170c;
    ...
    public static boolean f(Context context) {
        ...
        if (f6170c == null) {
            f6170c = (ActivityManager) context.getSystemService("activity");
        }
        try {
            ActivityManager.MemoryInfo memoryInfo = new ActivityManager.MemoryInfo();
            f6170c.getMemoryInfo(memoryInfo);
