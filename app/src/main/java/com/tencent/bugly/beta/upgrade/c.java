...
public class c {
    ...
    private DownloadTask b() {
        ...
        if (this.f8862c == null) {
            e eVar = e.G;
            this.f8862c = eVar.r.a(a2.f9480f.f9445b, eVar.v.getAbsolutePath(), null, this.f8861b.f8848a.f9480f.f9444a);
    ...
    private void c() {
        ...
        } else if (this.f8866g && com.tencent.bugly.beta.global.a.a(e.G.u, this.f8862c.getSaveFile(), a2.f9480f.f9444a)) {
            p.f9423a.a(new w("install", System.currentTimeMillis(), (byte) 0, 0L, a2.f9479e, a2.f9487m, a2.p, null));
        } else {
            a(this.f8866g);
        }
    }
    ...
    private void a(boolean z) {
        ...
        if (!z && downloadTask.getStatus() == 2) {
            an.a("Task is downloading %s %s", a2.f9487m, this.f8862c.getDownloadUrl());
            return;
        }
        this.f8862c.addListener(this.n);
        ...
        objArr[0] = hVar;
        objArr[1] = Boolean.valueOf(z || a2.f9481g == 2);
