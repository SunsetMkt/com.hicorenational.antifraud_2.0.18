    ...
    public boolean onPreDraw() {
        ...
        try {
            ...
            if (i4 == 1) {
                ...
                int intValue = ((Integer) this.f8841b[3]).intValue();
                ...
                if (currentTimeMillis - this.f8842c <= 300) {
                    return true;
                }
                this.f8842c = currentTimeMillis;
            ...
            int intValue2 = ((Integer) this.f8841b[0]).intValue();
