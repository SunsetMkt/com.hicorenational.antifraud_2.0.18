...
public class c {
    ...
    public synchronized void a(y yVar, b bVar) {
        ...
        this.f8839k.setTicker(com.tencent.bugly.beta.global.e.G.A + Beta.strNotificationHaveNewVersion).setContentTitle(String.format("%s %s", com.tencent.bugly.beta.global.e.G.A, Beta.strNotificationHaveNewVersion)).setContentIntent(PendingIntent.getBroadcast(this.f8836h, 2, intent, CommonNetImpl.FLAG_AUTH)).setAutoCancel(true).setContentText(String.format("%s.%s", yVar.f9479e.f9453d, Integer.valueOf(yVar.f9479e.f9452c)));
        if (com.tencent.bugly.beta.global.e.G.f8798h > 0) {
            this.f8839k.setSmallIcon(com.tencent.bugly.beta.global.e.G.f8798h);
        } else if (com.tencent.bugly.beta.global.e.G.B != null && com.tencent.bugly.beta.global.e.G.B.applicationInfo != null) {
            this.f8839k.setSmallIcon(com.tencent.bugly.beta.global.e.G.B.applicationInfo.icon);
        }
        if (com.tencent.bugly.beta.global.e.G.f8799i > 0 && this.f8836h.getResources().getDrawable(com.tencent.bugly.beta.global.e.G.f8799i) != null) {
            this.f8839k.setLargeIcon(com.tencent.bugly.beta.global.a.a(this.f8836h.getResources().getDrawable(com.tencent.bugly.beta.global.e.G.f8799i)));
        }
        this.f8835g = this.f8839k.build();
        this.f8834f.notify(1001, this.f8835g);
    }
}
