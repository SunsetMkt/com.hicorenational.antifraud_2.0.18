    ...
    public synchronized void a(int i2, bi biVar, long j2, long j3, boolean z, String str) {
        ...
        try {
            if (!this.f8858d && i2 == this.f8856b) {
                ...
                int i3 = this.f8855a;
                if (i3 == 1) {
                    boolean booleanValue = ((Boolean) this.f8857c[0]).booleanValue();
                    boolean booleanValue2 = ((Boolean) this.f8857c[1]).booleanValue();
                    if (this.f8856b != 804) {
                        return;
                    }
                    y yVar2 = null;
                    ...
                    if (yVar2 != null) {
                        int i4 = yVar2.p;
                        if (i4 == 1) {
                            c.f8860a.a(booleanValue, booleanValue2, z ? 0 : -1, yVar, str);
                        } else if (i4 != 2) {
                            if (i4 != 3) {
                                ...
                                if (c.f8860a.f8865f != null) {
                                    e.a(new d(18, c.f8860a.f8865f, 1, Boolean.valueOf(booleanValue)));
