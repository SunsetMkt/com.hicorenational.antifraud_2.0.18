    ...
    public synchronized void c() {
        ...
        if (this.f8809b != null && this.p != null && this.q != null) {
            ...
            if (this.f8819l != 0) {
                ...
                if (this.f8812e != null) {
                    ...
                    if (this.f8818k != 0) {
                        ...
                        if (this.t != null) {
                            ...
                            bitmap = com.tencent.bugly.beta.global.a.a(this.f8808a, 1, Integer.valueOf(com.tencent.bugly.beta.global.e.G.f8800j));
                        }
                        this.f8812e.setImageBitmap(bitmap);
                    }
                }
                ...
                this.C = new d(1, this, this.f8813f, bitmap, Integer.valueOf(this.f8818k));
