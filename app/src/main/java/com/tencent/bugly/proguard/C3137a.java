...
public class C3137a {
    /* renamed from: a */
    public static String m9792a(ArrayList<String> arrayList) {
        StringBuffer stringBuffer = new StringBuffer();
        for (int i2 = 0; i2 < arrayList.size(); i2++) {
            arrayList.set(i2, m9791a(arrayList.get(i2)));
        }
        ...
        for (int i3 = 0; i3 < arrayList.size(); i3++) {
            ...
            if (str.equals("list")) {
                ...
                int i5 = i3 - 1;
                arrayList.set(i5, "<" + arrayList.get(i5) + Constants.ACCEPT_TIME_SEPARATOR_SP);
    ...
    /* renamed from: a */
    public static String m9791a(String str) {
