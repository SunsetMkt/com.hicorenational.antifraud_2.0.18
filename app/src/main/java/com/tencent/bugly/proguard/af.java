...
public class af extends SQLiteOpenHelper {
    ...
    public static int f6365b = 15;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    protected Context f6366c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private List<com.tencent.bugly.a> f6367d;
    ...
    public af(Context context, List<com.tencent.bugly.a> list) {
        ...
        sb.append("");
        super(context, sb.toString(), (SQLiteDatabase.CursorFactory) null, f6365b);
        this.f6366c = context;
        this.f6367d = list;
    }
    ...
    public synchronized void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        Iterator<com.tencent.bugly.a> it = this.f6367d.iterator();
        while (it.hasNext()) {
            try {
    ...
    public synchronized void onDowngrade(SQLiteDatabase sQLiteDatabase, int i2, int i3) {
        if (com.tencent.bugly.crashreport.common.info.b.c() >= 11) {
            ...
            if (a(sQLiteDatabase)) {
                ...
                File databasePath = this.f6366c.getDatabasePath(a);
