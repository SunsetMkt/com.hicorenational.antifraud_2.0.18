...
public class r {
    public static synchronized void a(Context context) {
        ...
        synchronized (r.class) {
            ...
            if (file2 != null && file2.exists() && (a2 = aq.a(file2, "SHA")) != null) {
                com.tencent.bugly.beta.global.e.G.N = a2;
            }
            if (TinkerManager.isTinkerManagerInstalled()) {
                ...
                TinkerManager.getInstance().setTinkerListener(new TinkerManager.TinkerListener() { // from class: com.tencent.bugly.proguard.r.1
                    ...
                    public void onApplyFailure(String str2) {
                        com.tencent.bugly.beta.global.e.this.P = false;
                        ...
                        BetaPatchListener betaPatchListener = com.tencent.bugly.beta.global.e.this.Y;
                    ...
                    public void onApplySuccess(String str2) {
                        com.tencent.bugly.beta.global.e eVar2 = com.tencent.bugly.beta.global.e.this;
                        eVar2.ae = false;
                        eVar2.P = true;
                        com.tencent.bugly.beta.global.a.a("IS_PATCHING", false);
                        com.tencent.bugly.beta.global.a.a("PatchResult", true);
                        an.a("Tinker patch success, result: " + str2, new Object[0]);
                        if (com.tencent.bugly.beta.global.e.this.Z) {
                    ...
                    public void onPatchRollback() {
                        ...
                        if (TinkerManager.getInstance().getPatchDirectory(com.tencent.bugly.beta.global.e.this.u) == null || TinkerManager.getInstance().getPatchDirectory(com.tencent.bugly.beta.global.e.this.u).exists()) {
                            return;
                        }
                        com.tencent.bugly.beta.global.a.a("IS_PATCH_ROLL_BACK", false);
                    }
                    ...
                    public void onPatchStart() {
                        com.tencent.bugly.beta.global.e.this.ae = true;
                        com.tencent.bugly.beta.global.a.a("IS_PATCHING", true);
                    }
                });
            }
            if (TextUtils.isEmpty(com.tencent.bugly.beta.global.a.b("BaseArchName", "")) && (str = eVar.u.getApplicationInfo().nativeLibraryDir) != null && (listFiles = new File(str).listFiles()) != null && listFiles.length > 0) {
                boolean z = false;
                for (File file3 : listFiles) {
                    if (file3.getName().endsWith(".so")) {
                        ...
                        an.a("libName:" + replace, new Object[0]);
                        ...
                        if (!z) {
                            String b2 = com.tencent.bugly.beta.global.a.b(absolutePath3);
                            an.a("archName:" + b2, new Object[0]);
                            if (b2 != null && b2.equals("armeabi-v5te")) {
                                b2 = "armeabi";
                            }
                            com.tencent.bugly.beta.global.a.a(replace, b2);
                            if (TextUtils.isEmpty(com.tencent.bugly.beta.global.a.b("BaseArchName", ""))) {
                                com.tencent.bugly.beta.global.a.a("BaseArchName", b2);
                            }
                            z = false;
                        }
                    }
