        ...
        try {
            ...
            if (bArr != null && bArr.length != 0) {
                ...
                if (this.f9241g != null && this.f9244j != null && this.f9245k != null && this.f9246l != null) {
                    StrategyBean c2 = this.f9245k.c();
                    if (c2 == null) {
                        a(null, false, 0, "illegal local strategy", 0);
                        return;
                    }
                    HashMap hashMap = new HashMap();
                    hashMap.put("prodId", this.f9244j.f());
                    hashMap.put("bundleId", this.f9244j.f8977d);
                    hashMap.put("appVer", this.f9244j.p);
                    if (this.s != null) {
                        hashMap.putAll(this.s);
                    }
                    if (this.f9240f) {
                        hashMap.put(com.taobao.agoo.a.a.b.JSON_CMD, Integer.toString(this.f9242h));
                        hashMap.put(ConstantsAPI.Token.WX_TOKEN_PLATFORMID_KEY, Byte.toString((byte) 1));
                        hashMap.put("sdkVer", this.f9244j.f8983j);
                        hashMap.put("strategylastUpdateTime", Long.toString(c2.p));
                        if (!this.f9247m.a(hashMap)) {
                    ...
                    while (true) {
                        ...
                        if (i7 > 1) {
                            an.d("[Upload] Failed to upload last time, wait and try(%d) again.", Integer.valueOf(i7));
                            aq.b(this.f9236b);
                            if (i7 == this.f9235a) {
                        ...
                        an.c("[Upload] Send %d bytes", Integer.valueOf(bArr.length));
                        if (this.f9240f) {
                            str = a(str);
                        }
                        an.c("[Upload] Upload to %s with cmd %d (pid=%d | tid=%d).", str, Integer.valueOf(this.f9242h), Integer.valueOf(Process.myPid()), Integer.valueOf(Process.myTid()));
                        a2 = this.f9246l.a(str, bArr, this, hashMap);
                        if (a2 != null) {
                            ...
                            if (a(map)) {
                                ...
                                try {
                                    ...
                                    j2 = 0;
                                    i6 = i2;
                                    a(1, "[Upload] Failed to upload for format of status header is invalid: " + Integer.toString(i6));
                                    i4 = i7;
                                    i5 = 1;
                                }
                            } else {
                    ...
                    an.c("[Upload] Received %d bytes", Integer.valueOf(a2.length));
                    if (this.f9240f) {
                        if (a2.length == 0) {
                    ...
                    objArr[0] = Integer.valueOf(a4.f9338b);
                    if (a4.f9339c != null) {
                        i3 = a4.f9339c.length;
                    }
                    objArr[1] = Integer.valueOf(i3);
                    an.c("[Upload] Response cmd is: %d, length of sBuffer is: %d", objArr);
                    if (a(a4, this.f9244j, this.f9245k)) {
