    ...
    public synchronized boolean b(int i2) {
        try {
            ...
            for (ab abVar : c2) {
                ...
                if (abVar.f9167c + 86400000 < currentTimeMillis) {
                    arrayList2.add(abVar);
                }
            }
            Collections.sort(arrayList);
            if (arrayList.size() >= 2) {
                if (arrayList.size() <= 0 || ((ab) arrayList.get(arrayList.size() - 1)).f9167c + 86400000 >= currentTimeMillis) {
                    return true;
                }
                c2.clear();
                a(i2, (int) c2);
    ...
    public synchronized boolean a(final int i2) {
        ...
        try {
            ...
            am.a().a(new Runnable() { // from class: com.tencent.bugly.proguard.ac.2
                @Override // java.lang.Runnable
                public void run() {
                    boolean b2 = ac.this.b(i2);
                    ac.this.f9177f.edit().putBoolean(i2 + c.c.a.b.a.a.s1 + ac.this.f9175d, !b2).commit();
                }
            });
        } catch (Exception unused) {
