...
public class p {
        ...
        try {
            ...
            try {
                ...
                while (cursorA.moveToNext()) {
                    map.put(cursorA.getString(cursorA.getColumnIndex(com.umeng.analytics.pro.bl.f7102e)), cursorA.getBlob(cursorA.getColumnIndex("_dt")));
                }
                if (cursorA != null) {
                    cursorA.close();
                }
    ...
    public synchronized boolean a(w wVar) {
        ...
        if (bArrA != null && bArrA.length > 0) {
            ...
            contentValues.put("_time", Long.valueOf(wVar.f6586b));
    ...
    public synchronized boolean a(int i2, String str, byte[] bArr) {
        ContentValues contentValues;
        contentValues = new ContentValues();
        contentValues.put(com.umeng.analytics.pro.bl.f7101d, Integer.valueOf(i2));
        contentValues.put("_tm", Long.valueOf(System.currentTimeMillis()));
        contentValues.put(com.umeng.analytics.pro.bl.f7102e, str);
