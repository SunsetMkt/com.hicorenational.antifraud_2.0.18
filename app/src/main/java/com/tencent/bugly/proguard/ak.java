...
public class ak {
    ...
    */
    ...
    protected boolean b() {
        ...
        an.c("[UploadManager] Session ID expired time from server is: %d(%s), but now is: %d(%s)", Long.valueOf(j2), new Date(this.r).toString(), Long.valueOf(currentTimeMillis), new Date(currentTimeMillis).toString());
        return false;
    }
    ...
    public long a(boolean z) {
        ...
        long b2 = aq.b();
        int i2 = z ? 5 : 3;
        List<ag> a2 = this.f9216d.a(i2);
        if (a2 != null && a2.size() > 0) {
            j2 = 0;
            try {
                ag agVar = a2.get(0);
                if (agVar.f9207e >= b2) {
                    j2 = aq.c(agVar.f9209g);
                    if (i2 == 3) {
                        this.f9219g = j2;
                    } else {
                        this.f9220h = j2;
    ...
    public boolean a(Map<String, String> map) {
        ...
        if (bArr != null && bArr.length * 8 == 128) {
            ...
            byte[] b2 = aq.b(1, this.o, this.f9225m);
            if (b2 == null) {
