...
public class b extends AsyncTask<Void, Void, a> {
    ...
    protected a doInBackground(Void[] voidArr) {
        ...
        String format = String.format("https://open.weixin.qq.com/connect/sdk/qrconnect?appid=%s&noncestr=%s&timestamp=%s&scope=%s&signature=%s", this.f9682a, this.f9684c, this.f9685d, this.f9683b, this.f9686e);
