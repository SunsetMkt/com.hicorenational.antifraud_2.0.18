...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    BaseWXApiImplV10(Context context, String str, boolean z, int i2) {
        ...
        this.launchMode = i2;
        b.f9710a = context.getApplicationContext();
    }
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), a.C1).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
    ...
    public int getWXAppSupportAPI() {
        ...
        b.f9714e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
    ...
    public boolean registerApp(String str, long j2) {
        ...
        c0127a.f9671a = "com.tencent.mm";
        c0127a.f9672b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c0127a.f9673c = "weixin://registerapp?appid=" + this.appId;
        c0127a.f9674d = j2;
        return com.tencent.mm.opensdk.channel.a.a.a(this.context, c0127a);
    }
    ...
    public void unregisterApp() {
        ...
        a.C0127a c0127a = new a.C0127a();
        c0127a.f9671a = "com.tencent.mm";
        c0127a.f9672b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c0127a.f9673c = "weixin://unregisterapp?appid=" + this.appId;
        com.tencent.mm.opensdk.channel.a.a.a(this.context, c0127a);
    }
}
