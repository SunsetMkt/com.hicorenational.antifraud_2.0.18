...
public class PhotoViewContainer extends FrameLayout {
    ...
    class a extends ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(@NonNull View view, int i2, int i3, int i4, int i5) {
            ...
            float abs = (Math.abs(i3) * 1.0f) / PhotoViewContainer.this.f8164d;
            ...
            if (PhotoViewContainer.this.f8165e != null) {
                PhotoViewContainer.this.f8165e.a(i5, f2, abs);
            }
        }
    ...
    */
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean shouldInterceptTouchEvent = this.f8161a.shouldInterceptTouchEvent(motionEvent);
        ...
        return shouldInterceptTouchEvent && this.f8167g;
    }
