...
public class d extends com.lxj.xpopup.c.b {
    ...
    class b implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            Float valueOf = Float.valueOf(d.this.f7958g);
            ...
            float floatValue = d.this.f7954c.evaluate(animatedFraction, (Number) Float.valueOf(d.this.f7959h), (Number) valueOf2).floatValue();
            d.this.f7950a.setScaleX(floatValue);
            d dVar3 = d.this;
            if (!dVar3.f7960i) {
                dVar3.f7950a.setScaleY(floatValue);
            }
    ...
    class c implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            view.setAlpha(floatEvaluator.evaluate(animatedFraction, (Number) valueOf, (Number) Float.valueOf(d.this.f7958g)).floatValue());
            d dVar2 = d.this;
            ...
            float floatValue = d.this.f7954c.evaluate(animatedFraction, (Number) valueOf, (Number) Float.valueOf(d.this.f7959h)).floatValue();
            d.this.f7950a.setScaleX(floatValue);
            d dVar3 = d.this;
            if (!dVar3.f7960i) {
                dVar3.f7950a.setScaleY(floatValue);
