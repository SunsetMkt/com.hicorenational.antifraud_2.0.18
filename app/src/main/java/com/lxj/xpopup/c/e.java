...
public class e extends com.lxj.xpopup.c.b {
    ...
    public void a() {
        ValueAnimator ofObject = ValueAnimator.ofObject(this.f7965c, Integer.valueOf(com.lxj.xpopup.b.c()), Integer.valueOf(this.f7966d));
        ofObject.addUpdateListener(new b());
        ofObject.setInterpolator(new FastOutSlowInInterpolator());
        ofObject.setDuration(this.f7967e ? 0L : com.lxj.xpopup.b.a()).start();
    }

    @Override // com.lxj.xpopup.c.b
    public void b() {
        ValueAnimator ofObject = ValueAnimator.ofObject(this.f7965c, Integer.valueOf(this.f7966d), Integer.valueOf(com.lxj.xpopup.b.c()));
