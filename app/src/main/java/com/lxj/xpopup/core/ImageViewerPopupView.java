...
public class ImageViewerPopupView extends BasePopupView implements com.lxj.xpopup.e.d, View.OnClickListener {
    ...
    class b implements Runnable {
        ...
        class a extends TransitionListenerAdapter {
            ...
            public void onTransitionEnd(@NonNull Transition transition) {
                ...
                ImageViewerPopupView imageViewerPopupView = ImageViewerPopupView.this;
                imageViewerPopupView.q.f5538f = false;
    ...
    class c implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ImageViewerPopupView imageViewerPopupView = ImageViewerPopupView.this;
            imageViewerPopupView.q.setBackgroundColor(((Integer) imageViewerPopupView.v.evaluate(valueAnimator.getAnimatedFraction(), Integer.valueOf(this.a), Integer.valueOf(this.f5439b))).intValue());
        }
    }
    ...
    protected void u() {
        XPermission.a(getContext(), com.lxj.xpermission.b.f5386i).a(new f()).e();
    }

    @Override // com.lxj.xpopup.core.BasePopupView
    public void b() {
        if (this.f5427e != com.lxj.xpopup.d.e.Show) {
            return;
        }
        this.f5427e = com.lxj.xpopup.d.e.Dismissing;
        if (this.B != null) {
