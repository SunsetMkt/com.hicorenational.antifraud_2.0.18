...
public class HorizontalAttachPopupView extends AttachPopupView {
    ...
    protected void k() {
        super.k();
        int i2 = this.f7987a.t;
        if (i2 == 0) {
            i2 = com.lxj.xpopup.f.c.a(getContext(), 0.0f);
        }
        this.p = i2;
        int i3 = this.f7987a.s;
        if (i3 == 0) {
            i3 = com.lxj.xpopup.f.c.a(getContext(), 4.0f);
        }
        this.q = i3;
    ...
    protected void u() {
        ...
        if (pointF != null) {
            ...
            height = (this.f7987a.f8036j.y - (measuredHeight * 0.5f)) + this.p;
            f2 = f3;
        } else {
            int[] iArr = new int[2];
