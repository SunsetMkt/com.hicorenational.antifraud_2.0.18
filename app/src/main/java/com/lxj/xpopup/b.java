...
public class b {
    ...
    public static class a {
        ...
        public CenterListPopupView b(String str, String[] strArr, int[] iArr, int i2, com.lxj.xpopup.e.f fVar) {
            a(f.Center);
            CenterListPopupView a2 = new CenterListPopupView(this.f7948b).a(str, strArr, iArr).c(i2).a(fVar);
            a2.f7987a = this.f7947a;
            return a2;
        }
        ...
        public LoadingPopupView a(String str) {
            a(f.Center);
            LoadingPopupView a2 = new LoadingPopupView(this.f7948b).a(str);
            a2.f7987a = this.f7947a;
            return a2;
        }
        ...
        public BottomListPopupView a(String str, String[] strArr, int[] iArr, int i2, boolean z, com.lxj.xpopup.e.f fVar) {
            a(f.Bottom);
            BottomListPopupView a2 = new BottomListPopupView(this.f7948b).a(str, strArr, iArr).c(i2).a(fVar);
            a2.f7987a = this.f7947a;
            return a2;
        }
        ...
        public AttachListPopupView a(String[] strArr, int[] iArr, int i2, int i3, com.lxj.xpopup.e.f fVar) {
            a(f.AttachView);
            AttachListPopupView a2 = new AttachListPopupView(this.f7948b).a(strArr, iArr).a(i2, i3).a(fVar);
            a2.f7987a = this.f7947a;
            return a2;
        }
        ...
        public ImageViewerPopupView a(ImageView imageView, Object obj, j jVar) {
            a(f.ImageViewer);
            ImageViewerPopupView a2 = new ImageViewerPopupView(this.f7948b).a(imageView, obj).a(jVar);
            a2.f7987a = this.f7947a;
            return a2;
        }
        ...
        public ImageViewerPopupView a(ImageView imageView, Object obj, boolean z, int i2, int i3, int i4, boolean z2, j jVar) {
            a(f.ImageViewer);
            ImageViewerPopupView a2 = new ImageViewerPopupView(this.f7948b).a(imageView, obj).a(z).a(i2).c(i3).b(i4).d(z2).a(jVar);
            a2.f7987a = this.f7947a;
            return a2;
        }
        ...
        public ImageViewerPopupView a(ImageView imageView, int i2, List<Object> list, boolean z, int i3, int i4, int i5, boolean z2, g gVar, j jVar) {
            a(f.ImageViewer);
            ImageViewerPopupView a2 = new ImageViewerPopupView(this.f7948b).a(imageView, i2).a(list).a(z).a(i3).c(i4).b(i5).d(z2).a(gVar).a(jVar);
            a2.f7987a = this.f7947a;
            return a2;
        }
