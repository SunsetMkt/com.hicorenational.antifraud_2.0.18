...
public final class c<T> {
    ...
    public final c<T> c(@d b<T> bVar) {
        i0.f(bVar, "delegate");
        int indexOfValue = this.f7899a.indexOfValue(bVar);
        if (indexOfValue >= 0) {
            this.f7899a.removeAt(indexOfValue);
        }
        return this;
    }
    ...
    public final c<T> c(int i2) {
        int indexOfKey = this.f7899a.indexOfKey(i2);
        if (indexOfKey >= 0) {
            this.f7899a.removeAt(indexOfKey);
        }
        return this;
    }
    ...
    public final void a(@d ViewHolder viewHolder, T t, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            b<T> valueAt = this.f7899a.valueAt(i3);
            if (valueAt.a(t, i2)) {
