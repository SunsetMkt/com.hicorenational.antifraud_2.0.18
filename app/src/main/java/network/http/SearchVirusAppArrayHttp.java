...
/* JADX INFO: compiled from: SearchVirusAppArrayHttp.kt */
...
public final class SearchVirusAppArrayHttp {
    ...
    private final void searchAppHttp(final List<? extends AppInfoBean> list, List<SearchVirusAppBean> list2, final Callback callback) {
        ModelPresent.searchVirusApp(e.a.b(ModuelConfig.MODEL_WARN, 6, b.i0), list2, new MiddleSubscriber<APIresult<List<? extends SearchVirusAppResultBean>>>() { // from class: network.http.SearchVirusAppArrayHttp.searchAppHttp.1
    ...
    public /* synthetic */ SearchVirusAppArrayHttp(i.q2.t.v vVar) {
        this();
    }
}
