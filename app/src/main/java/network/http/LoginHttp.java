...
public class LoginHttp extends ModelPresent {
    ...
    /* JADX INFO: renamed from: network.http.LoginHttp$1 */
    class AnonymousClass1 extends MiddleSubscriber<APIresult<AccountInfo>> {
        final /* synthetic */ RegisterBody val$body;

        AnonymousClass1(RegisterBody registerBody) {
        ...
        protected void onCompleteMiddle() {
            s1.a(LoginHttp.TAG, "-->onComplete");
            f1.a();
        }

        @Override // network.MiddleSubscriber
        protected void onErrorMiddle(APIException aPIException) {
            s1.a(LoginHttp.TAG, "-->onError");
            f1.a();
        ...
        protected void onStartMiddle(h.a.u0.c cVar) {
            s1.a(LoginHttp.TAG, "-->onSubscribe");
            f1.a("\u8bf7\u7a0d\u540e...", false, LoginHttp.this.mContext);
        }
    }
    ...
    private void loginHttp(RegisterBody registerBody) {
        loginHttp(a.f10139c + b.f10195n, registerBody, new MiddleSubscriber<APIresult<AccountInfo>>() { // from class: network.http.LoginHttp.1
            final /* synthetic */ RegisterBody val$body;

            AnonymousClass1(RegisterBody registerBody2) {
    ...
    public void loginSubmit(Activity activity, String str, String str2, String str3, int i2, IOneClickListener iOneClickListener) {
        ...
        if (i2 != 0) {
            ...
            if (TextUtils.isEmpty(str2) || str2.length() < 6 || str2.length() > 16 || h1.a(str2)) {
                intentLogin();
                return;
            }
            registerBody.setPassword(str2);
        }
        s1.b("RegisterBody-->", registerBody.toString());
