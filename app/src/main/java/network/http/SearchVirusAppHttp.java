...
public final class SearchVirusAppHttp {
    ...
    static {
        s a2;
        a2 = h.v.a(x.SYNCHRONIZED, (a) SearchVirusAppHttp$Companion$instance$2.INSTANCE);
    ...
    private final String getMd5(String str, String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            String a2 = o1.a(new File(str2));
            i0.a((Object) a2, "MD5Utils.getFileMD5(File(filePath))");
            return a2;
        }
        if (str != null) {
            return str;
    ...
    private final void installSearchAppHttp(final AppInfoBean appInfoBean, List<SearchVirusAppBean> list, final Callback callback) {
        ...
        String str = b.h0;
        if (j2 != null && TextUtils.equals(d.a.b(ModuelConfig.MODEL_WARN), "1")) {
            str = b.i0;
        }
        ModelPresent.searchVirusApp(d.a.a(ModuelConfig.MODEL_WARN, 6, str), list, new MiddleSubscriber<APIresult<List<? extends SearchVirusAppResultBean>>>() { // from class: network.http.SearchVirusAppHttp$installSearchAppHttp$1
            ...
            @Override // network.MiddleSubscriber
            protected void onNextMiddle(@e APIresult<List<? extends SearchVirusAppResultBean>> aPIresult) {
                if (aPIresult == null) {
    ...
    public /* synthetic */ SearchVirusAppHttp(v vVar) {
        this();
    }
}
