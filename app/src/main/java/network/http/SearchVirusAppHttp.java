...
/* JADX INFO: compiled from: SearchVirusAppHttp.kt */
...
public final class SearchVirusAppHttp {
    ...
    public static final class Companion {
        ...
        public /* synthetic */ Companion(i.q2.t.v vVar) {
            this();
        }
    }
    ...
    private final String getMd5(String str, String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            String strA = t1.a(new File(str2));
    ...
    private final void getSignVirus(SearchVirusAppBean searchVirusAppBean) {
        ...
        if (searchVirusAppBean == null || (appSignBeanD = x1.d(searchVirusAppBean.getPkgName(), searchVirusAppBean.getFilePath())) == null) {
            return;
        }
    ...
    private final void installSearchAppHttp(final AppInfoBean appInfoBean, List<SearchVirusAppBean> list, final Callback callback) {
        ...
        String str = b.i0;
        if (regionMudelBeanJ != null && TextUtils.equals(e.a.b(ModuelConfig.MODEL_WARN), "1")) {
            str = b.j0;
        }
        ModelPresent.searchVirusApp(e.a.b(ModuelConfig.MODEL_WARN, 6, str), list, new MiddleSubscriber<APIresult<List<? extends SearchVirusAppResultBean>>>() { // from class: network.http.SearchVirusAppHttp.installSearchAppHttp.1
    ...
    public /* synthetic */ SearchVirusAppHttp(i.q2.t.v vVar) {
        this();
    }
}
