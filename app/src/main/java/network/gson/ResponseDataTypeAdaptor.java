...
public class ResponseDataTypeAdaptor extends y<ResponseData> {
    ...
    private Object readInternal(com.google.gson.e0.a aVar) throws IOException {
        switch (AnonymousClass2.$SwitchMap$com$google$gson$stream$JsonToken[aVar.peek().ordinal()]) {
            ...
            case 4:
                String s = aVar.s();
                return (s.contains(".") || s.contains("e") || s.contains(ExifInterface.LONGITUDE_EAST)) ? Double.valueOf(Double.parseDouble(s)) : Long.parseLong(s) <= 2147483647L ? Integer.valueOf(Integer.parseInt(s)) : Long.valueOf(Long.parseLong(s));
            case 5:
