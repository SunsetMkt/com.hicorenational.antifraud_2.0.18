...
public final class c {
    ...
    public static void a(Camera.Parameters parameters, boolean z, boolean z2, boolean z3) {
        ...
        String a2 = z ? (z3 || z2) ? a("focus mode", supportedFocusModes, ConnType.PK_AUTO) : a("focus mode", supportedFocusModes, "continuous-video", ConnType.PK_AUTO) : null;
        if (!z3 && a2 == null) {
    ...
    public static void a(Camera.Parameters parameters, boolean z) {
        ...
        if (exposureCompensationStep > 0.0f) {
            int round = Math.round((z ? 0.0f : f17260d) / exposureCompensationStep);
    ...
    public static String a(CharSequence charSequence) {
        ...
        if (charSequence != null) {
            String[] split = f17258b.split(charSequence);
            Arrays.sort(split);
