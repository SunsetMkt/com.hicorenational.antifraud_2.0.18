...
final class p {
    ...
    private static final class b implements ParameterizedType {
        ...
        private final Type f12788b;

        /* JADX INFO: renamed from: c */
        private final Type[] f12789c;
        ...
        b(@Nullable Type type, Type type2, Type... typeArr) {
            ...
            this.a = type;
            this.f12788b = type2;
            this.f12789c = (Type[]) typeArr.clone();
        }
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f12789c.clone();
        }
        ...
        public int hashCode() {
            int iHashCode = Arrays.hashCode(this.f12789c) ^ this.f12788b.hashCode();
            Type type = this.a;
            return iHashCode ^ (type != null ? type.hashCode() : 0);
        }

        public String toString() {
            Type[] typeArr = this.f12789c;
            if (typeArr.length == 0) {
                return p.e(this.f12788b);
            }
            StringBuilder sb = new StringBuilder((typeArr.length + 1) * 30);
            sb.append(p.e(this.f12788b));
            sb.append("<");
            sb.append(p.e(this.f12789c[0]));
            for (int i2 = 1; i2 < this.f12789c.length; i2++) {
                sb.append(", ");
                sb.append(p.e(this.f12789c[i2]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    private static final class c implements WildcardType {
        ...
        public String toString() {
            if (this.f12790b != null) {
                return "? super " + p.e(this.f12790b);
            }
            if (this.a == Object.class) {
                return "?";
            }
            return "? extends " + p.e(this.a);
        }
    }
            ...
            if (lowerBounds.length == 1) {
                ...
                if (upperBounds.length == 1) {
                    ...
                    if (typeA7 != upperBounds[0]) {
                        return new c(new Type[]{typeA7}, a);
                    }
                }
            }
        }
