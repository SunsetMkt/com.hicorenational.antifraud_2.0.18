...
public class d {
    ...
    public static void a(File file, String str) throws Exception {
        ...
        if (a(file)) {
            try {
                ...
                if (d2 != null) {
                    file.delete();
                    throw new a("file : " + file.getAbsolutePath() + " has a channel : " + d2 + ", only ignore");
                }
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        }
        int a2 = c.d.a.a.f.b.a(c2.a(), 20);
        int length = bytes.length + a2 + 2 + b.f3151d.length;
        try {
        ...
        try {
            ...
            randomAccessFile.seek(c2.b().longValue() + 22 + a2);
    ...
    */
    ...
    public static c<ByteBuffer, Long> c(File file) throws IOException, a.c {
        RandomAccessFile randomAccessFile;
        ...
        try {
            ...
            if (c.d.a.a.f.b.a(randomAccessFile, b2.b().longValue())) {
