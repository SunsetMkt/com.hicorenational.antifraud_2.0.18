...
public class a {
    ...
    public static c.d.a.a.c<ByteBuffer, Long> b(RandomAccessFile randomAccessFile) throws IOException, c {
        c.d.a.a.c<ByteBuffer, Long> a2 = c.d.a.a.f.b.a(randomAccessFile);
        if (a2 != null) {
            return a2;
        }
    ...
    private static b a(RandomAccessFile randomAccessFile) throws IOException, c {
        c.d.a.a.c<ByteBuffer, Long> b2 = b(randomAccessFile);
        ByteBuffer a2 = b2.a();
        long longValue = b2.b().longValue();
        if (!c.d.a.a.f.b.a(randomAccessFile, longValue)) {
            long a3 = a(a2, longValue);
            c.d.a.a.c<ByteBuffer, Long> a4 = a(randomAccessFile, a3);
            ByteBuffer a5 = a4.a();
            return new b(b(a5), a4.b().longValue(), a3, longValue, a2);
        }
            ...
            if (a2.remaining() >= 8) {
                ...
                if (j2 >= 4 && j2 <= 2147483647L) {
                    ...
                    if (i3 <= a2.remaining()) {
                        ...
                        throw new c("APK Signing Block entry #" + i2 + " size out of range: " + i3 + ", available: " + a2.remaining());
                    }
                } else {
    ...
    public static long a(ByteBuffer byteBuffer, long j2) throws c {
        long c2 = c.d.a.a.f.b.c(byteBuffer);
        if (c2 < j2) {
            if (c.d.a.a.f.b.d(byteBuffer) + c2 == j2) {
                return c2;
            }
            throw new c("ZIP Central Directory is not immediately followed by End of Central Directory");
        }
        throw new c("ZIP Central Directory offset out of range: " + c2 + ". ZIP End of Central Directory offset: " + j2);
    }
    ...
    public static c.d.a.a.c<ByteBuffer, Long> a(RandomAccessFile randomAccessFile, long j2) throws IOException, c {
        if (j2 >= 32) {
            ...
            if (allocate.getLong(8) == n && allocate.getLong(16) == f3166m) {
                ...
                if (j4 >= 0) {
                    ...
                    if (j5 == j3) {
                        return c.d.a.a.c.a(allocate2, Long.valueOf(j4));
                    }
