    ...
    public static abstract class b extends Binder implements a {
        ...
        private static class C0043a implements a {
            ...
            public void a(Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(b.f3180a);
                    if (bundle != null) {
                        obtain.writeInt(1);
                    ...
                    if (this.f3183a.transact(1, obtain, obtain2, 0) || b.a() == null) {
        ...
        public static a a(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(f3180a);
