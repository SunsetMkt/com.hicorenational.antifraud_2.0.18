...
public class b extends k.a.a.c.a.b {
    ...
    class a extends a.AbstractBinderC0098a {
        ...
        public void a(DataBuffer dataBuffer) {
            ...
            if (i2 == 0) {
                ...
                b.this.a(a2);
                com.hihonor.honorid.h.a.a(b.this.f3092g).a(a2);
                HonorAccount a3 = com.hihonor.honorid.h.a.a(b.this.f3092g).a();
                if (b.this.f3091f != null) {
                    b.this.f3091f.a(a3);
                }
                com.hihonor.honorid.g.a.a(b.this.f3092g).a(b.this.f3092g, a2);
                return;
            }
            if (i2 == 2002) {
            ...
            e.a("LoginTask", "loginResult : errCode = " + i3 + " errMsg = " + str, true);
            if (1101 == i3) {
                b.this.f3091f.a(new ErrorStatus(67, str));
            } else if (1202 == i3) {
                b.this.f3091f.a(new ErrorStatus(68, str));
            } else {
                b.this.f3091f.a(new ErrorStatus(i3, str));
            }
        }
    }
    ...
    protected void a() {
        ...
        com.hihonor.cloudservice.framework.aidl.b a2 = k.a.a.c.a.a.a(this.f3092g).a();
        try {
    ...
    public void a(HonorAccount honorAccount) {
        ...
        if (TextUtils.isEmpty(u) || c.c.a.b.a.a.f3101h.equalsIgnoreCase(u)) {
            String a2 = h.a(this.f3092g, 0);
            if (a2 == null) {
                a2 = "";
            }
            honorAccount.v(a2);
