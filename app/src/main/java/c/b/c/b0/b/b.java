...
final class b {
    ...
    static e a(byte[] bArr, int i2) {
        ...
        if (i2 == 2 || i2 == 3) {
            if (i2 == 2) {
                d2 = new DecimalFormat("0000000000".substring(0, c(bArr))).format(b(bArr));
            } else {
                d2 = d(bArr);
            }
            String format = r.format(a(bArr));
            String format2 = r.format(e(bArr));
            sb.append(a(bArr, 10, 84));
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, d2 + o + format + o + format2 + o);
            } else {
                sb.insert(0, d2 + o + format + o + format2 + o);
            }
        } else if (i2 == 4) {
    ...
    private static int a(byte[] bArr, byte[] bArr2) {
        if (bArr2.length != 0) {
            ...
            for (int i3 = 0; i3 < bArr2.length; i3++) {
                i2 += a(bArr2[i3], bArr) << ((bArr2.length - i3) - 1);
            }
            return i2;
        }
    ...
    private static String a(byte[] bArr, int i2, int i3) {
        ...
        int i7 = 0;
        while (i4 < i2 + i3) {
            char charAt = s[i5].charAt(bArr[i4]);
            switch (charAt) {
                case 65520:
                case 65521:
                case 65522:
