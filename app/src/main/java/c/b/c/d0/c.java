...
public final class c extends q {
            ...
            if (aVar.b(c3) ^ z) {
                ...
                if (i3 == i4) {
                    ...
                    for (int i6 = 103; i6 <= 105; i6++) {
                        float a2 = q.a(iArr, f2530a[i6], f2532c);
                        if (a2 < f2) {
                            i5 = i6;
                            f2 = a2;
                        }
                    }
                    if (i5 >= 0 && aVar.a(Math.max(0, i2 - ((c3 - i2) / 2)), i2, false)) {
                        return new int[]{i2, c3, i5};
                    }
                    i2 += iArr[0] + iArr[1];
                    int i7 = length - 2;
    ...
    private static int a(c.b.c.z.a aVar, int[] iArr, int i2) throws c.b.c.m {
        ...
        while (true) {
            ...
            float a2 = q.a(iArr, iArr2[i4], f2532c);
            if (a2 < f2) {
                i3 = i4;
                f2 = a2;
            }
  ...
  0x0149: PHI (r19v7 boolean) = (r19v5 boolean), (r19v12 boolean) binds: [B:82:0x011b, B:52:0x00c3] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public c.b.c.r a(int r25, c.b.c.z.a r26, java.util.Map<c.b.c.e, ?> r27) throws c.b.c.m, c.b.c.h, c.b.c.d {
        /*
