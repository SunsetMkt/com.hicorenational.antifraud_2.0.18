            ...
            if (a3 == '*') {
                ...
                if (this.f2560a) {
                    ...
                    for (int i9 = 0; i9 < length; i9++) {
                        i8 += f2556e.indexOf(this.f2562c.charAt(i9));
                    }
                    if (sb.charAt(length) != f2557f[i8 % 43]) {
                ...
                float f2 = i2;
                return new c.b.c.r(this.f2561b ? a(sb) : sb.toString(), null, new c.b.c.t[]{new c.b.c.t((r2[1] + r2[0]) / 2.0f, f2), new c.b.c.t(c2 + (i5 / 2.0f), f2)}, c.b.c.a.CODE_39);
            }
            c2 = c4;
        }
    }
        ...
        while (c3 < c2) {
            if (aVar.b(c3) ^ z) {
                ...
                if (i3 != i4) {
                    ...
                    if (a(iArr) == f2559h && aVar.a(Math.max(0, i2 - ((c3 - i2) / 2)), i2, false)) {
