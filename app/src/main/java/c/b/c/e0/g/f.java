...
final class f {
    ...
    static String a(CharSequence charSequence, int i2) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            int charAt = (charSequence.charAt(i3) + cArr[cArr.length - 1]) % c.b.c.e0.a.f2613a;
            for (int i4 = a2 - 1; i4 >= 1; i4--) {
                cArr[i4] = (char) ((cArr[i4 - 1] + (929 - ((f2725a[i2][i4] * charAt) % c.b.c.e0.a.f2613a))) % c.b.c.e0.a.f2613a);
            }
            cArr[0] = (char) ((929 - ((charAt * f2725a[i2][0]) % c.b.c.e0.a.f2613a)) % c.b.c.e0.a.f2613a);
        }
