...
public final class a {
    ...
    */
    ...
    private static t[] a(c.b.c.z.b bVar, int i2, int i3) {
        ...
        int g2 = bVar.g();
        t[] tVarArr = new t[8];
        a(tVarArr, a(bVar, d2, g2, i2, i3, f2692e), f2688a);
        if (tVarArr[4] != null) {
            i3 = (int) tVarArr[4].a();
            i2 = (int) tVarArr[4].b();
        }
        a(tVarArr, a(bVar, d2, g2, i2, i3, f2693f), f2689b);
        return tVarArr;
    }
    ...
    private static t[] a(c.b.c.z.b bVar, int i2, int i3, int i4, int i5, int[] iArr) {
        ...
        while (true) {
            ...
            int[] a2 = a(bVar, i5, i8, i3, false, iArr, iArr3);
            if (a2 != null) {
                while (true) {
                    iArr2 = a2;
                    if (i8 <= 0) {
                    ...
                    i8--;
                    a2 = a(bVar, i5, i8, i3, false, iArr, iArr3);
                    if (a2 == null) {
                        i8++;
                        break;
                    }
        ...
        if (z) {
            ...
            while (true) {
                ...
                i7 = i11;
                int[] a3 = a(bVar, iArr4[0], i10, i3, false, iArr, iArr3);
