...
public final class d implements v {
    ...
    public c.b.c.z.b a(String str, c.b.c.a aVar, int i2, int i3, Map<g, ?> map) throws w {
        ...
        if (map != null) {
            ...
            int intValue = map.containsKey(g.MARGIN) ? ((Number) map.get(g.MARGIN)).intValue() : 30;
            int intValue2 = map.containsKey(g.ERROR_CORRECTION) ? ((Number) map.get(g.ERROR_CORRECTION)).intValue() : 2;
    ...
    private static c.b.c.z.b a(e eVar, String str, int i2, int i3, int i4, int i5) throws w {
        ...
        if (length > 1) {
            byte[][] a3 = eVar.a().a(length, length * 4);
            if (z) {
                a3 = a(a3);
            }
            return a(a3, i5);
