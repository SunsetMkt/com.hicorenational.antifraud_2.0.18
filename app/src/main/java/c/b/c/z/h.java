...
public class h extends c.b.c.b {
    ...
    public a a(int i2, a aVar) throws m {
        ...
        a(c3);
        byte[] a2 = c2.a(i2, this.f3027b);
        int[] iArr = this.f3028c;
        for (int i3 = 0; i3 < c3; i3++) {
            int i4 = (a2[i3] & f1.f16099c) >> 3;
            iArr[i4] = iArr[i4] + 1;
        }
        int a3 = a(iArr);
        int i5 = a2[0] & f1.f16099c;
        int i6 = a2[1] & f1.f16099c;
        int i7 = i5;
        int i8 = 1;
        while (i8 < c3 - 1) {
            int i9 = i8 + 1;
            int i10 = a2[i9] & f1.f16099c;
            if ((((i6 * 4) - i7) - i10) / 2 < a3) {
                aVar.e(i8);
            }
            i7 = i6;
    ...
    public b a() throws m {
        ...
        for (int i2 = 1; i2 < 5; i2++) {
            byte[] a3 = c2.a((a2 * i2) / 5, this.f3027b);
            int i3 = (c3 * 4) / 5;
            for (int i4 = c3 / 5; i4 < i3; i4++) {
                int i5 = (a3[i4] & f1.f16099c) >> 3;
                iArr[i5] = iArr[i5] + 1;
            }
        }
        int a4 = a(iArr);
