...
public final class c {
    ...
    private t[] a(t tVar, t tVar2, t tVar3, t tVar4) {
        ...
        float a5 = tVar4.a();
        float b5 = tVar4.b();
        return a2 < ((float) this.f3058c) / 2.0f ? new t[]{new t(a5 - 1.0f, b5 + 1.0f), new t(a3 + 1.0f, b3 + 1.0f), new t(a4 - 1.0f, b4 - 1.0f), new t(a2 + 1.0f, b2 - 1.0f)} : new t[]{new t(a5 + 1.0f, b5 + 1.0f), new t(a3 + 1.0f, b3 - 1.0f), new t(a4 - 1.0f, b4 + 1.0f), new t(a2 - 1.0f, b2 - 1.0f)};
    }
