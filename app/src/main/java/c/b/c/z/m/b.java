...
public final class b {
    ...
    public t[] a() throws m {
        int d2 = this.f3053a.d();
        int g2 = this.f3053a.g();
        int i2 = d2 / 2;
        int i3 = g2 / 2;
        int max = Math.max(1, d2 / 256);
        int max2 = Math.max(1, g2 / 256);
        int i4 = -max;
        int i5 = i3 / 2;
        int b2 = ((int) a(i3, 0, 0, g2, i2, i4, 0, d2, i5).b()) - 1;
        int i6 = i2 / 2;
        t a2 = a(i3, -max2, 0, g2, i2, 0, b2, d2, i6);
        int a3 = ((int) a2.a()) - 1;
        t a4 = a(i3, max2, a3, g2, i2, 0, b2, d2, i6);
        int a5 = ((int) a4.a()) + 1;
        t a6 = a(i3, 0, a3, a5, i2, max, b2, d2, i5);
        return new t[]{a(i3, 0, a3, a5, i2, i4, b2, ((int) a6.b()) + 1, i3 / 4), a2, a4, a6};
    }
    ...
    private t a(int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10) throws m {
        ...
        while (i12 < i9 && i12 >= i8 && i11 < i5 && i11 >= i4) {
            if (i3 == 0) {
                a2 = a(i12, i10, i4, i5, true);
            } else {
                a2 = a(i11, i10, i8, i9, false);
            }
            if (a2 == null) {
                if (iArr == null) {
