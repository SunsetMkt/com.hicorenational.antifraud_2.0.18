...
final class d {
    ...
    static int c(b bVar) {
        ...
        while (i2 < b2) {
            ...
            for (int i5 = 0; i5 < c2; i5++) {
                byte[] bArr = a2[i2];
                int i6 = i5 + 6;
                if (i6 < c2 && bArr[i5] == 1 && bArr[i5 + 1] == 0 && bArr[i5 + 2] == 1 && bArr[i5 + 3] == 1 && bArr[i5 + 4] == 1 && bArr[i5 + 5] == 0 && bArr[i6] == 1 && (a(bArr, i5 - 4, i5) || a(bArr, i5 + 7, i5 + 11))) {
                    i4++;
                }
                int i7 = i2 + 6;
                if (i7 < b2 && a2[i2][i5] == 1 && a2[i2 + 1][i5] == 0 && a2[i2 + 2][i5] == 1 && a2[i2 + 3][i5] == 1 && a2[i2 + 4][i5] == 1 && a2[i2 + 5][i5] == 0 && a2[i7][i5] == 1 && (a(a2, i5, i2 - 4, i2) || a(a2, i5, i2 + 7, i2 + 11))) {
                    i4++;
                }
            }
            i2++;
    ...
    static int d(b bVar) {
        ...
        return ((Math.abs((i3 * 2) - b3) * 10) / b3) * 10;
    }
