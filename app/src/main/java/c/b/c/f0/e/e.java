...
final class e {
    ...
    static void c(j jVar, b bVar) throws w {
        ...
        while (i2 < 6) {
            ...
            for (int i5 = 0; i5 < 3; i5++) {
                boolean b2 = aVar.b(i4);
                i4--;
                bVar.a(i2, (bVar.b() - 11) + i5, b2);
                bVar.a((bVar.b() - 11) + i5, i2, b2);
            }
            i2++;
            i3 = i4;
        }
    ...
    static void a(c.b.c.f0.c.f fVar, int i2, b bVar) throws w {
        ...
        for (int i3 = 0; i3 < aVar.c(); i3++) {
            boolean b2 = aVar.b((aVar.c() - 1) - i3);
            int[][] iArr = f2813d;
            bVar.a(iArr[i3][0], iArr[i3][1], b2);
            if (i3 < 8) {
                bVar.a((bVar.c() - i3) - 1, 8, b2);
            } else {
                bVar.a(8, (bVar.b() - 7) + (i3 - 8), b2);
            }
        }
    }
