...
/* JADX INFO: compiled from: SinglePicker.java */
...
public class i<T> extends k {
    ...
    public void D(int i2) {
        ...
        layoutParams.width = c.a.a.g.b.b(this.a, i2);
    ...
    protected View r() {
        ...
        if (TextUtils.isEmpty(this.m0)) {
            this.i0.setLayoutParams(new LinearLayout.LayoutParams(this.f1943b, -2));
        } else {
        ...
        if (this.n0 != o0) {
            ...
            layoutParams.width = c.a.a.g.b.b(this.a, this.n0);
            this.i0.setLayoutParams(layoutParams);
        }
        return linearLayout;
    }
