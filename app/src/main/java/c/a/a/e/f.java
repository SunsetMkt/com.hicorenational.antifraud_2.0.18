...
/* JADX INFO: compiled from: LinkagePicker.java */
...
public class f<Fst extends c.a.a.d.g<Snd>, Snd extends c.a.a.d.i<Trd>, Trd> extends c.a.a.e.k {
    ...
    class a implements WheelView.g {
        ...
        final /* synthetic */ WheelView f1932b;

        a(WheelView wheelView, WheelView wheelView2) {
            this.a = wheelView;
            this.f1932b = wheelView2;
        }
        ...
        public void a(int i2) {
            ...
            f.this.m0 = i2;
            c.a.a.g.d.c(this, "change second data after first wheeled");
            f fVar2 = f.this;
            fVar2.n0 = 0;
            fVar2.o0 = 0;
    ...
    class b implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            fVar2.n0 = i2;
            if (!fVar2.p0.b()) {
                c.a.a.g.d.c(this, "change third data after second wheeled");
                f fVar3 = f.this;
                fVar3.o0 = 0;
                List<Trd> listA = fVar3.p0.a(fVar3.m0, fVar3.n0);
                f fVar4 = f.this;
                fVar4.i0 = listA.get(fVar4.o0);
                this.a.a((List<?>) listA, f.this.o0);
            }
            if (f.this.w0 != null) {
                i iVar = f.this.w0;
                f fVar5 = f.this;
    ...
    class c implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            if (f.this.v0 != null) {
                Trd trd = f.this.i0;
                f.this.v0.c(f.this.o0, trd instanceof c.a.a.d.j ? ((c.a.a.d.j) trd).getName() : trd.toString());
            }
        }
    }
    ...
    private static class e<Fst extends c.a.a.d.g<Snd>, Snd extends c.a.a.d.i<Trd>, Trd> implements k<Fst, Snd, Trd> {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private List<List<Snd>> f1935b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private List<List<List<Trd>>> f1936c;
        ...
        public List<Trd> a(int i2, int i3) {
            ...
            return this.f1936c.get(i2).get(i3);
        }
    }

    /* JADX INFO: renamed from: c.a.a.e.f$f, reason: collision with other inner class name */
    /* JADX INFO: compiled from: LinkagePicker.java */
    @Deprecated
    ...
    /* JADX INFO: compiled from: LinkagePicker.java */
    private static class l implements c.a.a.d.g<m> {
        private String name;
    ...
    /* JADX INFO: compiled from: LinkagePicker.java */
    private static class m implements c.a.a.d.i<String> {
        private String name;
    ...
    public void v() {
        ...
        if (!this.p0.b()) {
            ...
            if (this.u0 != null) {
                this.u0.a(gVarZ.getName(), iVarB.getName(), trdD instanceof c.a.a.d.j ? ((c.a.a.d.j) trdD).getName() : trdD.toString());
                return;
            }
            return;
        }
    ...
    public void a(Fst fst, Snd snd, Trd trd) {
        ...
        if (kVar != null) {
            ...
            this.m0 = i3;
            c.a.a.g.d.e("init select first: " + fst.getName() + ", index:" + this.m0);
            ...
            this.n0 = i4;
            c.a.a.g.d.e("init select second: " + snd.getName() + ", index:" + this.n0);
            if (this.p0.b()) {
                return;
            }
            ...
            while (true) {
                ...
                if (next3 instanceof c.a.a.d.j) {
                    c.a.a.d.j jVar = (c.a.a.d.j) trd;
                    c.a.a.d.j jVar2 = (c.a.a.d.j) next3;
            ...
            this.o0 = i2;
            c.a.a.g.d.e("init select third: " + trd + ", index:" + this.o0);
            return;
        }
