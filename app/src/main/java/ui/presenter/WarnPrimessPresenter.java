...
public class WarnPrimessPresenter extends ModelPresent<WarnPrimessCallView> {
    ...
    class a extends MiddleSubscriber<APIresult<List<GuideBean>>> {
        ...
        /* JADX INFO: renamed from: ui.presenter.WarnPrimessPresenter$a$a */
        class C0321a extends com.google.gson.d0.a<List<GuideBean>> {
            C0321a() {
            }
        }
    ...
    public void requestGuideConfig(HashMap<String, String> map) {
        requestGuideConfig(e.a.b(ModuelConfig.MODEL_WARN, 8, f.b.h0), map, new a());
    }
}
