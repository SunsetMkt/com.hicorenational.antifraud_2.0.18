...
public class AIVerifyVideoPresenter extends ModelPresent<AIVerifyVideoCallView> {
    ...
    class a implements PermissionsListener {
        ...
        public void onDenied(List<String> list, boolean z) {
            util.permissionutil.c.a(AIVerifyVideoPresenter.this.mActivity, list, z, true, this);
        }

        @Override // interfaces.PermissionsListener
        public void onGranted() {
            k.e.a(this.a, 100L, PictureMimeType.ofVideo(), 1).forResult(PictureConfig.AI_REQUEST_VIDEO);
        }
    }
    ...
    class b extends MiddleSubscriber<APIresult<OssTokenBean>> {
        ...
        class a implements IRCallback {
            ...
            public void onFail(String str) {
                ((AIVerifyVideoCallView) AIVerifyVideoPresenter.this.mvpView).onError(str);
            }

            @Override // interfaces.IRCallback
            public void onSuccess() {
                String str = this.a.getPath() + "/" + b.this.f14266b + "." + j1.d(this.f14268b.getName());
                b bVar = b.this;
                AIVerifyVideoPresenter.this.startInformationVerify(this.f14268b, bVar.f14266b, str);
            }
        }
        ...
        protected void onErrorMiddle(APIException aPIException) {
            ...
            ((AIVerifyVideoCallView) AIVerifyVideoPresenter.this.mvpView).onError(aPIException.getMessage());
        }

        @Override // network.MiddleSubscriber
        protected void onNextMiddle(APIresult<OssTokenBean> aPIresult) {
            if (aPIresult.getCode() != 0) {
                ((AIVerifyVideoCallView) AIVerifyVideoPresenter.this.mvpView).onError("\u7cfb\u7edf\u51fa\u5c0f\u5dee,\u8bf7\u7a0d\u540e\u518d\u8bd5");
                return;
            }
            ...
            if (this.a == null) {
                ((AIVerifyVideoCallView) AIVerifyVideoPresenter.this.mvpView).onError("\u6587\u4ef6\u4e3a\u7a7a,\u8bf7\u91cd\u65b0\u9009\u62e9");
                return;
            }
            ...
            AIVerifyVideoPresenter.this.conUpLoadFile(bucketName, str, callBack, this.a.getFilePath(), new a(data, file));
        }
    }
    ...
    class d extends MiddleSubscriber<APIresult<Object>> {
        ...
        protected void onNextMiddle(APIresult<Object> aPIresult) {
            ...
            if (aPIresult.getCode() == 0) {
                ((AIVerifyVideoCallView) AIVerifyVideoPresenter.this.mvpView).onSuccess(aPIresult.getEncodeStr());
            } else {
                ((AIVerifyVideoCallView) AIVerifyVideoPresenter.this.mvpView).onError(aPIresult.getMsg());
            }
        }
    }

    public AIVerifyVideoPresenter(Activity activity, AIVerifyVideoCallView aIVerifyVideoCallView) {
        super(activity, aIVerifyVideoCallView);
    ...
    public void startInformationVerify(File file, String str, String str2) {
        String str3 = e.a.f10139c + f.b.k2;
        ...
        map.put("duration", v1.e(file.getPath()));
        checkVideoInformationVerify(str3, map, new d());
    }
    ...
    public void upAiVideoFileToOss(OssFileRequest ossFileRequest) {
