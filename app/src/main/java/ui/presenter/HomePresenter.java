...
public class HomePresenter extends ModelPresent<HomeCallView> {
    ...
    public void getNewCaseApi(int i2, int i3, boolean z) {
        String a2 = d.a.a(ModuelConfig.MODEL_LOCALNEWS, 8, e.b.B);
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("Page", i2 + "");
        hashMap.put("Rows", i3 + "");
        hashMap.put("Sort", "releasetime");
        hashMap.put("Order", SocialConstants.PARAM_APP_DESC);
        getNewCaseList(a2, hashMap, new c(z));
    }

    private String getOssPath() {
        RegionMudelBean j2 = d.a.j();
        return (j2 == null || !TextUtils.equals(d.a.b(ModuelConfig.MODEL_LOCALNEWS), "1")) ? d.a.f13515a : j2.getOssPath();
    }
    ...
    public void showIDVerifyDlg() {
        ...
        if ((dialog == null || !dialog.isShowing()) && HomeFragment.mIsVisibleToUser) {
            String a2 = p1.a("update_home");
            String d2 = y1.d("yyyy-MM-dd");
            if (TextUtils.equals(a2, d2)) {
                return;
            }
            this.verifyDlg = b1.a(this.mActivity, new g(d2));
        }
    }
