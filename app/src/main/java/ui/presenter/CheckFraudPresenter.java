...
public class CheckFraudPresenter extends ModelPresent<CheckFraudCallView> {
    ...
    private void checkFraudIpUrlHttp(HashMap<String, String> map) {
        checkFraudIpUrl(map, e.a.b(ModuelConfig.MODEL_FRAUDCHECK, 7, f.b.A0), new c());
    }

    public void checkFraud(String str) {
        String strB = e.a.b(ModuelConfig.MODEL_FRAUDCHECK, 7, f.b.x0);
        HashMap<String, String> map = new HashMap<>();
        map.put("CardNumber", str);
        requestCheckFraud(strB, map, new b());
    }

    public void checkFraudChat(String str) {
        String strB = e.a.b(ModuelConfig.MODEL_FRAUDCHECK, 7, f.b.z0);
        HashMap<String, String> map = new HashMap<>();
        map.put("accountNumber", str);
        requestCheckFraud(strB, map, new d());
    }

    public void checkFraudCount(int i2) {
        requestCheckFraudCount(i2 == 1 ? e.a.b(ModuelConfig.MODEL_FRAUDCHECK, 7, f.b.B0) : i2 == 2 ? e.a.b(ModuelConfig.MODEL_FRAUDCHECK, 7, f.b.C0) : e.a.b(ModuelConfig.MODEL_FRAUDCHECK, 7, f.b.y0), new e());
    }
