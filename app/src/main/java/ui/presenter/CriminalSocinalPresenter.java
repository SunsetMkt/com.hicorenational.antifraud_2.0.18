...
public class CriminalSocinalPresenter extends ModelPresent<CriminalSocialCallView> {
    ...
    class a extends MiddleSubscriber<APIresult<List<CriminalSocialBean>>> {
        ...
        /* JADX INFO: renamed from: ui.presenter.CriminalSocinalPresenter$a$a, reason: collision with other inner class name */
        class C0300a extends com.google.gson.d0.a<List<CriminalSocialBean>> {
            C0300a() {
            }
        }
    ...
    class b extends MiddleSubscriber<APIresult> {
        ...
        protected void onNextMiddle(APIresult aPIresult) {
            if (aPIresult == null || aPIresult.getCode() != 0) {
                ...
                ((CriminalSocialCallView) CriminalSocinalPresenter.this.mvpView).onSuccessDelete(this.a);
            }
        }
    }
    ...
    public void socialDeleteHttp(String str, String str2, int i2) {
        ...
        String strB = e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.W1);
        HashMap<String, String> map = new HashMap<>();
        map.put("caseInfoID", str);
        map.put("netAccountInfoID", str2);
        postOperation(strB, map, new b(i2));
    }
    ...
    public void socialHttp(String str) {
        ...
        String strB = e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.V1);
        HashMap<String, String> map = new HashMap<>();
        map.put("caseInfoID", str);
        socialList(strB, map, new a());
    }
}
