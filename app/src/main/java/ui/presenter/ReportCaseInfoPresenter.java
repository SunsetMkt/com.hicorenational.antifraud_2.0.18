...
public class ReportCaseInfoPresenter extends ModelPresent<VictimPeopleView> {
        ...
        public void onBindViewHolder(a aVar, final int i2) {
            ...
            aVar.f20060a.setOnClickListener(new View.OnClickListener() { // from class: ui.presenter.r
                ...
                public final void onClick(View view) {
                    ReportCaseInfoPresenter.HolderAdapte.this.a(i2, view);
                }
            });
            aVar.f20066g.setOnClickListener(new View.OnClickListener() { // from class: ui.presenter.s
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    ReportCaseInfoPresenter.HolderAdapte.this.b(i2, view);
                }
            });
        }
    ...
    public void deletePeople(String str) {
        String a2 = d.a.a(ModuelConfig.MODEL_CASEXC, 4, e.b.e1);
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("victimInfoID", str);
        deletePeople(a2, hashMap, new c());
    }

    public void getSubmitCaseInfo(String str) {
        String a2 = d.a.a(ModuelConfig.MODEL_CASEXC, 4, e.b.b2);
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("caseInfoID", str);
        getComitReportNum(a2, hashMap, new b());
    }

    public void getVictimList(String str) {
        b1.a("请稍后...", true, this.mActivity);
        String a2 = d.a.a(ModuelConfig.MODEL_CASEXC, 4, e.b.d1);
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("caseInfoID", str);
        getVictimList(a2, hashMap, new a());
    }
