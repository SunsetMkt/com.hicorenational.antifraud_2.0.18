...
/* JADX INFO: compiled from: CriminalPhonePresenter.kt */
...
public final class CriminalPhonePresenter extends ModelPresent<CriminalPhoneView> {
    ...
    public static final class a extends MiddleSubscriber<APIresult<CallBean>> {
        ...
        @Override // network.MiddleSubscriber
        protected void onNextMiddle(@j.c.a.d APIresult<CallBean> aPIresult) {
            i.q2.t.i0.f(aPIresult, "result");
    ...
    public static final class b extends MiddleSubscriber<APIresult<List<? extends String>>> {
        ...
        protected Type getType() {
            ...
            i.q2.t.i0.a((Object) type, "object : TypeToken<List<String>>() {}.type");
            return type;
        }
        ...
        @Override // network.MiddleSubscriber
        protected void onNextMiddle(@j.c.a.d APIresult<List<String>> aPIresult) {
    ...
    public static final class c extends MiddleSubscriber<APIresult<List<? extends CallBean>>> {
        ...
        protected Type getType() {
            Type type = new a().getType();
            i.q2.t.i0.a((Object) type, "object : TypeToken<List<CallBean>>() {}.type");
            return type;
        }
        ...
        @Override // network.MiddleSubscriber
        protected void onNextMiddle(@j.c.a.e APIresult<List<CallBean>> aPIresult) {
    ...
    public static final class d extends MiddleSubscriber<APIresult<CriminalPhoneNumBean>> {
        ...
        protected Type getType() {
            Type type = new a().getType();
            i.q2.t.i0.a((Object) type, "object : TypeToken<CriminalPhoneNumBean>() {}.type");
            return type;
        }
        ...
        @Override // network.MiddleSubscriber
        protected void onNextMiddle(@j.c.a.e APIresult<CriminalPhoneNumBean> aPIresult) {
            if (aPIresult == null || aPIresult.getCode() != 0 || aPIresult.getData() == null) {
                onErrorMiddle(APIException.getApiExcept(aPIresult));
                return;
            }
    ...
    public static final class e extends MiddleSubscriber<APIresult<String>> {
        ...
        @Override // network.MiddleSubscriber
        protected void onNextMiddle(@j.c.a.d APIresult<String> aPIresult) {
            i.q2.t.i0.f(aPIresult, "resultInfo");
            super.onNextMiddle(aPIresult);
    ...
    public CriminalPhonePresenter(@j.c.a.d Activity activity, @j.c.a.d CriminalPhoneView criminalPhoneView) {
        super(activity, criminalPhoneView);
        i.q2.t.i0.f(activity, "activity");
        i.q2.t.i0.f(criminalPhoneView, "callview");
    }

    public final void criminalCallSave(@j.c.a.d CallBean callBean) {
        i.q2.t.i0.f(callBean, "bean");
        criminalCallSave(e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.y1), callBean, new a());
    }

    public final void getCriminakTel() {
        getsocialtels(e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.A1), new b());
    }

    public final void getCriminalCallList(@j.c.a.d String str) {
        i.q2.t.i0.f(str, "caseInfoID");
        HashMap<String, String> map = new HashMap<>();
        map.put("caseInfoID", str);
        getCriminalPhoneList(e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.x1), map, new c());
    }

    public final void getCriminalCallNum(@j.c.a.d String str) {
        i.q2.t.i0.f(str, "caseInfoID");
        HashMap<String, String> map = new HashMap<>();
        map.put("caseInfoID", str);
        getCriminalCallNum(e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.w1), map, new d());
    }

    public final void removecalltel(@j.c.a.d String str, @j.c.a.d String str2) {
        i.q2.t.i0.f(str, "caseInfoID");
        i.q2.t.i0.f(str2, "callTelInfoID");
        HashMap<String, String> map = new HashMap<>();
        map.put("caseInfoID", str);
        map.put("callTelInfoID", str2);
        removecalltel(e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.z1), map, new e());
    }
}
