...
/* JADX INFO: compiled from: CaseVerifyPresenter.kt */
...
public final class CaseVerifyPresenter extends ModelPresent<CaseVerifyCallview> {
    ...
    public CaseVerifyPresenter(@j.c.a.e Activity activity, @j.c.a.e CaseVerifyCallview caseVerifyCallview) {
    ...
    public final void checkID(@j.c.a.d String str) {
        ...
        postOperation(e.a.b(ModuelConfig.MODEL_CASEXC, 4, f.b.Y0), map, new a());
    }

    public final void createInvited(@j.c.a.d String str, @j.c.a.d String str2, @j.c.a.d String str3) {
        i.q2.t.i0.f(str, CommonNetImpl.NAME);
        i.q2.t.i0.f(str2, "idNumber");
        i.q2.t.i0.f(str3, "image");
        HashMap<String, String> map = new HashMap<>();
        map.put(CommonNetImpl.NAME, str);
        map.put("identityCardNum", str2);
        map.put("image", str3);
        map.put("areaCode", RegionConfigHttp.getNodeRegionId());
        createInvited(e.a.b(ModuelConfig.MODEL_CASEXC, 3, f.b.Z0), map, new b());
    }
}
