...
public class ReportPresenter extends ModelPresent<ReportCallView> {
    ...
    public void cancleUploadFile(boolean z) {
        ...
        String strB = e.a.b(ModuelConfig.MODEL_REPORT, 5, f.b.e0);
        HashMap<String, String> map = new HashMap<>();
        map.put("id", str);
        cancleUploadFile(strB, map, new b());
    }
    ...
    public void evidenceSubmit(EvidenceCommInfo evidenceCommInfo) {
        ...
        uploadReportParam(evidenceCommInfo, e.a.b(ModuelConfig.MODEL_REPORT, 5, f.b.c0), new a());
    }
