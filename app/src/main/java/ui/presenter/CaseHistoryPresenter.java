...
public class CaseHistoryPresenter extends ModelPresent<CaseHistoryCallView> {
    ...
    public void getDetail(String str) {
        String a2 = d.a.a(ModuelConfig.MODEL_CASEXC, 4, e.b.S0);
        HashMap<String, String> hashMap = new HashMap<>();
        hashMap.put("id", str);
        getDetail(a2, hashMap, new a());
    }
    ...
    public void returnCase(String str) {
        ...
        getOperation(d.a.a(ModuelConfig.MODEL_CASEXC, 4, e.b.U0), hashMap, new d());
    }
    ...
    public void submitCase(String str, ArrayList<AccountListBean> arrayList) {
        ...
        if (arrayList != null && arrayList.size() > 0) {
            ...
            hashMap.put("stopPayments", (ArrayList) eVar.a(eVar.a(arrayList), new b().getType()));
        }
        getOperation(d.a.a(ModuelConfig.MODEL_CASEXC, 4, e.b.T0), hashMap, new c());
    }
}
