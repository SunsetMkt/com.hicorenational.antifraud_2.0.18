...
/* JADX INFO: compiled from: AboutUsPresenter.kt */
...
public final class AboutUsPresenter extends ModelPresent<AboutUsView> {
    ...
    public AboutUsPresenter(@j.c.a.d Activity activity, @j.c.a.d AboutUsView aboutUsView) {
        super(activity, aboutUsView);
        i.q2.t.i0.f(activity, "activity");
        i.q2.t.i0.f(aboutUsView, "view");
    }
}
