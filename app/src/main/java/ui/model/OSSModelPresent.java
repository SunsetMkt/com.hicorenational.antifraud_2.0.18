...
public class OSSModelPresent<V extends BaseView> extends ModelPresent {
            ...
            protected void onNextMiddle(APIresult aPIresult) {
                ...
                activity.runOnUiThread(new Runnable() { // from class: ui.model.a
                    ...
                    public final void run() {
                        OSSModelPresent.b.a.a(OssFileInfo.this, iOssPicCallback);
                    }
                });
            }
        }
        ...
        class C0291b implements IRCallback {
            ...
            public void onSuccess() {
                ...
                activity.runOnUiThread(new Runnable() { // from class: ui.model.b
                    @Override // java.lang.Runnable
                    public final void run() {
                        OSSModelPresent.b.C0291b.a(OssFileInfo.this, iOssPicCallback);
                    }
                });
            }
        }
    ...
    public OssFileInfo doUpFileInfo(String str, List<String> list) {
        ...
        String a2 = o1.a(file);
        String str3 = str + "/" + a2 + y1.f(file.getName());
        OssFileInfo ossFileInfo = new OssFileInfo();
        ossFileInfo.setFilePath(str3);
        ossFileInfo.setFileMd5(a2);
    ...
    private final void getOssToken(OssFileRequest ossFileRequest, OssTokenCallView ossTokenCallView) {
        ...
        String a2 = o1.a(file);
        ossFileRequest.setFileMd5(a2);
        String b2 = o1.b(a2 + AccountManager.getAccountId() + System.currentTimeMillis());
        ...
        getOssToken(d.a.a(str, 8, e.b.S), hashMap, new a(ossTokenCallView));
    }
