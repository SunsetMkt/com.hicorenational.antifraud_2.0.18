...
public final class PersonalInfoAddActivity_ViewBinding implements Unbinder {
    ...
    public PersonalInfoAddActivity_ViewBinding(PersonalInfoAddActivity personalInfoAddActivity, View view) {
        ...
        personalInfoAddActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18488b = findRequiredView;
        findRequiredView.setOnClickListener(new a(personalInfoAddActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.et_area, "field 'mEtArea' and method 'onClick'");
        personalInfoAddActivity.mEtArea = (TextView) Utils.castView(findRequiredView2, R.id.et_area, "field 'mEtArea'", TextView.class);
        this.f18489c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(personalInfoAddActivity));
        ...
        personalInfoAddActivity.mBtnConfirm = (Button) Utils.castView(findRequiredView3, R.id.btn_confirm, "field 'mBtnConfirm'", Button.class);
        this.f18490d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(personalInfoAddActivity));
    }
}
