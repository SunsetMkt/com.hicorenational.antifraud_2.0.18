...
public final class ReportRecordsActivity_ViewBinding implements Unbinder {
    ...
    public ReportRecordsActivity_ViewBinding(ReportRecordsActivity reportRecordsActivity, View view) {
        ...
        reportRecordsActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18754b = findRequiredView;
        findRequiredView.setOnClickListener(new a(reportRecordsActivity));
