...
public class VirusKillingActivity_ViewBinding implements Unbinder {
    ...
    public VirusKillingActivity_ViewBinding(VirusKillingActivity virusKillingActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.stop_scan, "field 'mStopScan' and method 'onViewClicked'");
        virusKillingActivity.mStopScan = (TextView) Utils.castView(findRequiredView, R.id.stop_scan, "field 'mStopScan'", TextView.class);
        this.f19245b = findRequiredView;
        findRequiredView.setOnClickListener(new a(virusKillingActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_appeal, "field 'mTvAppeal' and method 'onViewClicked'");
        virusKillingActivity.mTvAppeal = (TextView) Utils.castView(findRequiredView2, R.id.tv_appeal, "field 'mTvAppeal'", TextView.class);
        this.f19246c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(virusKillingActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_delete, "field 'mTvDelete' and method 'onViewClicked'");
        virusKillingActivity.mTvDelete = (TextView) Utils.castView(findRequiredView3, R.id.tv_delete, "field 'mTvDelete'", TextView.class);
        this.f19247d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(virusKillingActivity));
        ...
        this.f19248e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(virusKillingActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.layout_app, "method 'onViewClicked'");
        this.f19249f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(virusKillingActivity));
        View findRequiredView6 = Utils.findRequiredView(view, R.id.layout_apk, "method 'onViewClicked'");
        this.f19250g = findRequiredView6;
        findRequiredView6.setOnClickListener(new f(virusKillingActivity));
        View findRequiredView7 = Utils.findRequiredView(view, R.id.tv_appeal_wb, "method 'onViewClicked'");
        this.f19251h = findRequiredView7;
        findRequiredView7.setOnClickListener(new g(virusKillingActivity));
    }
}
