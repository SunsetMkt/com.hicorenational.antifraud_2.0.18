...
public final class CriminalListActivity_ViewBinding implements Unbinder {
    ...
    public CriminalListActivity_ViewBinding(CriminalListActivity criminalListActivity, View view) {
        ...
        criminalListActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18006b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalListActivity));
        ...
        findRequiredView2.setOnClickListener(new b(criminalListActivity));
    }
}
