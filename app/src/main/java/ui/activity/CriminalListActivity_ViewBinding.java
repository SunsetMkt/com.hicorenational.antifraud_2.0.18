...
public final class CriminalListActivity_ViewBinding implements Unbinder {
    private CriminalListActivity a;
    ...
    class a extends DebouncingOnClickListener {
        final /* synthetic */ CriminalListActivity a;

        a(CriminalListActivity criminalListActivity) {
            this.a = criminalListActivity;
        }
    ...
    public void unbind() {
        CriminalListActivity criminalListActivity = this.a;
    ...
    public CriminalListActivity_ViewBinding(CriminalListActivity criminalListActivity, View view) {
        ...
        this.f13294b = viewFindRequiredView;
        ...
        this.f13295c = viewFindRequiredView2;
