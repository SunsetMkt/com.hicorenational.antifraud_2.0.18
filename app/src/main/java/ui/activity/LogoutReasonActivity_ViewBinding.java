...
public final class LogoutReasonActivity_ViewBinding implements Unbinder {
    ...
    public LogoutReasonActivity_ViewBinding(LogoutReasonActivity logoutReasonActivity, View view) {
        ...
        logoutReasonActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18321b = findRequiredView;
        findRequiredView.setOnClickListener(new a(logoutReasonActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.confirm, "field 'mConfim' and method 'onClick'");
        logoutReasonActivity.mConfim = (Button) Utils.castView(findRequiredView2, R.id.confirm, "field 'mConfim'", Button.class);
        this.f18322c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(logoutReasonActivity));
    }
}
