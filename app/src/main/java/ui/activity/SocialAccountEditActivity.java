...
public class SocialAccountEditActivity extends BaseActivity implements SocialTagsCallView {
    ...
    private SocialAccBean f13883bean;
    ...
    private void getIntentData() {
        ...
        this.f13883bean = (SocialAccBean) getIntent().getSerializableExtra(util.p1.w);
    }
    ...
    public void onSuccessRequest(List<SocialTypeBean> list) {
        ...
        this.mTagAdapter.c();
        SocialAccBean socialAccBean = this.f13883bean;
        ...
        if (iContains >= 0) {
            ...
            this.mTvAccName.setText(this.f13883bean.getAccountName());
            this.mEtAccount.setText(this.f13883bean.getAccountNum());
        ...
        this.mLlAccOther.setVisibility(0);
        this.mLlAccNorm.setVisibility(8);
        this.mEtTagOther.setText(this.f13883bean.getAccountName());
        this.mEtAccountOther.setText(this.f13883bean.getAccountNum());
        this.mTagAdapter.a(this.selectIndex);
    }
    ...
    public void onViewClicked(View view) {
        ...
        if (this.socialTypeBeans.size() > 0) {
            ...
            if (this.f13883bean != null) {
                org.greenrobot.eventbus.c.f().d(new util.n2.a(15, socialAccBean, Integer.valueOf(this.pos)));
            } else {
                org.greenrobot.eventbus.c.f().d(new util.n2.a(14, socialAccBean));
            }
            finish();
        }
    }
