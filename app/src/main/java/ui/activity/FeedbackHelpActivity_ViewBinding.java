...
public class FeedbackHelpActivity_ViewBinding implements Unbinder {
    ...
    public FeedbackHelpActivity_ViewBinding(FeedbackHelpActivity feedbackHelpActivity, View view) {
        ...
        this.f18162b = findRequiredView;
        findRequiredView.setOnClickListener(new a(feedbackHelpActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_feedback, "method 'onViewClicked'");
        this.f18163c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(feedbackHelpActivity));
    }
}
