...
public class CriminalSocialEditActivity_ViewBinding implements Unbinder {
    ...
    public CriminalSocialEditActivity_ViewBinding(CriminalSocialEditActivity criminalSocialEditActivity, View view) {
        ...
        criminalSocialEditActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18066b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalSocialEditActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18067c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(criminalSocialEditActivity));
    }
}
