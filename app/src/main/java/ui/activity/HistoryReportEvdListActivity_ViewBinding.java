...
public class HistoryReportEvdListActivity_ViewBinding implements Unbinder {
    ...
    public HistoryReportEvdListActivity_ViewBinding(HistoryReportEvdListActivity historyReportEvdListActivity, View view) {
        ...
        historyReportEvdListActivity.mIvRight = (ImageView) Utils.castView(findRequiredView, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f18228b = findRequiredView;
        findRequiredView.setOnClickListener(new a(historyReportEvdListActivity));
        ...
        this.f18229c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(historyReportEvdListActivity));
    }
}
