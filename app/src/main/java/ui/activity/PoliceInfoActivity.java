...
/* JADX INFO: compiled from: PoliceInfoActivity.kt */
...
public final class PoliceInfoActivity extends BaseActivity implements PolicInfoView {
    ...
    public void initPage() {
        StatisticsHttp.getInstance().pageOpenHttp(f.d.f10209i);
    ...
    public final void initView() {
        ...
        textView.setText(g2.l(String.valueOf(policBean != null ? policBean.getTelNumber() : null)));
    }
    ...
    public final void onClick(@j.c.a.d View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.iv_right /* 2131296874 */:
                util.f1.b(this.mActivity, "\u9000\u51fa\u5f53\u524d\u8d26\u53f7", "", "\u786e\u5b9a", "\u53d6\u6d88", new a());
                break;
            case R.id.tv_case_manger /* 2131297613 */:
                startActivity(new Intent(this, (Class<?>) CaseActivity.class));
                break;
            case R.id.tv_invite_qrcode /* 2131297739 */:
                startActivity(new Intent(this, (Class<?>) InviteQrcodeActivity.class));
                break;
            case R.id.tv_manual /* 2131297750 */:
    ...
    public void onSuccessRequest(@j.c.a.e PolicStistBean policStistBean) {
        TextView textView = this.mTvInviteNum;
        if (textView == null) {
            i.q2.t.i0.k("mTvInviteNum");
        }
    ...
    public final void setMBean(@j.c.a.e PolicBean policBean) {
    ...
    public final void setMIvRight(@j.c.a.d ImageView imageView) {
        i.q2.t.i0.f(imageView, "<set-?>");
    ...
    public final void setMTvDownApp(@j.c.a.d TextView textView) {
        i.q2.t.i0.f(textView, "<set-?>");
        this.mTvDownApp = textView;
    }

    public final void setMTvInviteNum(@j.c.a.d TextView textView) {
        i.q2.t.i0.f(textView, "<set-?>");
        this.mTvInviteNum = textView;
    }

    public final void setMTvPhoneNum(@j.c.a.d TextView textView) {
        i.q2.t.i0.f(textView, "<set-?>");
        this.mTvPhoneNum = textView;
    }

    public final void setMTvRegistNum(@j.c.a.d TextView textView) {
        i.q2.t.i0.f(textView, "<set-?>");
