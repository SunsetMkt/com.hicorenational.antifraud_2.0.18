...
public class CheckFraudActivity_ViewBinding implements Unbinder {
    ...
    public CheckFraudActivity_ViewBinding(CheckFraudActivity checkFraudActivity, View view) {
        ...
        checkFraudActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17928b = findRequiredView;
        findRequiredView.setOnClickListener(new a(checkFraudActivity));
        ...
        checkFraudActivity.mIvRight = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f17929c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(checkFraudActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.rb_pay, "field 'mRbPay' and method 'onViewClicked'");
        checkFraudActivity.mRbPay = (RadioButton) Utils.castView(findRequiredView3, R.id.rb_pay, "field 'mRbPay'", RadioButton.class);
        this.f17930d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(checkFraudActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.rb_url, "field 'mRbUrl' and method 'onViewClicked'");
        checkFraudActivity.mRbUrl = (RadioButton) Utils.castView(findRequiredView4, R.id.rb_url, "field 'mRbUrl'", RadioButton.class);
        this.f17931e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(checkFraudActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.rb_chat, "field 'mRbChat' and method 'onViewClicked'");
        checkFraudActivity.mRbChat = (RadioButton) Utils.castView(findRequiredView5, R.id.rb_chat, "field 'mRbChat'", RadioButton.class);
        this.f17932f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(checkFraudActivity));
        View findRequiredView6 = Utils.findRequiredView(view, R.id.iv_clear, "field 'mIvClear' and method 'onViewClicked'");
        checkFraudActivity.mIvClear = (ImageView) Utils.castView(findRequiredView6, R.id.iv_clear, "field 'mIvClear'", ImageView.class);
        this.f17933g = findRequiredView6;
        findRequiredView6.setOnClickListener(new f(checkFraudActivity));
        View findRequiredView7 = Utils.findRequiredView(view, R.id.ll_scan, "field 'mTvScan' and method 'onViewClicked'");
        checkFraudActivity.mTvScan = (LinearLayout) Utils.castView(findRequiredView7, R.id.ll_scan, "field 'mTvScan'", LinearLayout.class);
        this.f17934h = findRequiredView7;
        findRequiredView7.setOnClickListener(new g(checkFraudActivity));
        View findRequiredView8 = Utils.findRequiredView(view, R.id.confirm, "method 'onViewClicked'");
        this.f17935i = findRequiredView8;
        findRequiredView8.setOnClickListener(new h(checkFraudActivity));
    }
}
