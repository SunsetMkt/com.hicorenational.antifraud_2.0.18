...
public class VirusKillingActivity extends BaseActivity implements VirusKillingCallView, BaseQuickAdapter.i {
    ...
    class e implements IClickListener {
        ...
        public void clickOKBtn() {
            if (VirusKillingActivity.this.hasSelect()) {
                ...
                for (AppInfoBean appInfoBean : VirusKillingActivity.this.mAllSelectList) {
    ...
    private void appealSelect() {
        util.f1.a(this.mActivity, "\u786e\u5b9a\u4e0a\u62a5\u5e94\u7528\u9519\u8bef\u4fe1\u606f\u5417", "", "\u53d6\u6d88", "\u786e\u5b9a", R.color._A8B4F7, R.color.blue_dark, (IClickListener) new e());
    }
    ...
    private void changeScanState(int i2) {
        ...
        if (i2 == 1) {
            ...
            g2.a(this.mActivity, R.anim.scan_app_anim, this.mIvCircle);
        ...
        this.mScanResultTip.setText("\u6682\u672a\u53d1\u73b0\u53ef\u7591\u98ce\u9669");
        this.mScanResultTip.setVisibility(0);
        this.mScanState.setText("\u8be5\u7ed3\u679c\u4e3a\u8f85\u52a9\u7ed3\u679c\uff0c\u4e0d\u4ee3\u8868\u65e0\u98ce\u9669\uff0c\u8bf7\u63d0\u9ad8\u8b66\u60d5\uff0c\u8c28\u9632\u88ab\u9a97");
    ...
    private void deleteSelect() {
        if (hasSelect()) {
            String str = "";
            for (AppInfoBean appInfoBean : (ArrayList) this.mAllSelectList.clone()) {
            ...
            util.f1.b(this.mActivity, "\u5df2\u5220\u9664" + strSubstring + "\u5b89\u88c5\u5305", "\u786e\u5b9a", new f());
        }
    }

    private ArrayList<AppInfoBean> getRiskData(String str, boolean z) {
        ArrayList<AppInfoBean> arrayList = new ArrayList<>();
        for (AppBean appBean : c2.b(str, AppBean.class)) {
            arrayList.add(AppBean.AppBean2AppInfoBean(appBean, z ? new BitmapDrawable(k.c.a(appBean.getName(), appBean.getVersionName(), k.c.f12650c)) : null, appBean.getVirusName(), appBean.getVirusDescription(), appBean.isScaned(), appBean.getLastTime()));
        }
        return arrayList;
    }
    ...
    private void getRiskDate() {
        this.mAppChild.clear();
        this.mPackageChild.clear();
        this.mAppChild.add(getRiskData(c2.C0, true));
        this.mAppChild.add(getRiskData(c2.D0, true));
        this.mAppChild.add(getRiskData(c2.E0, false));
        this.mPackageChild.add(getRiskData(c2.F0, true));
        this.mPackageChild.add(getRiskData(c2.G0, true));
        this.mPackageChild.add(getRiskData(c2.H0, false));
        cleanCacheData();
    }
    ...
    public void nextUninstall() {
        ...
        for (AppInfoBean appInfoBean2 : this.mAllSelectList) {
            if (appInfoBean2.isTypeIsApp()) {
                appInfoBean2.setCancleUninstall(false);
            }
        }
        changeReportState(true);
    }
    ...
    private void scanApp() {
        if (!this.isAppScanning) {
            ...
            k.d.a(this.mIvAppStates, Integer.valueOf(R.mipmap.ic_scan_wait));
    ...
    public void scanPackage() {
        ...
        if (!this.isPackageScanning) {
            ...
            k.d.a(this.mIvApkStates, Integer.valueOf(R.mipmap.ic_scan_wait));
    ...
    public void initPage() {
        ...
        StatisticsHttp.getInstance().pageOpenHttp(f.d.p);
        ...
        this.options.a(com.bumptech.glide.load.p.j.f2961b);
        changeScanState(0);
        try {
    ...
    protected void onActivityResult(int i2, int i3, Intent intent) {
        ...
        if (size > i4) {
            ...
            if (x1.d(appInfoBean.getPkgName())) {
    ...
    public void onAppealSuccess() {
        util.f1.a((Activity) this, false, 1, "\u9519\u8bef\u4fe1\u606f\u4e0a\u62a5\u6210\u529f", R.drawable.iv_comit_succ);
    ...
    protected void onResume() {
        super.onResume();
        g2.f14889b.postDelayed(new Runnable() { // from class: ui.activity.o1
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.iv_back /* 2131296808 */:
                a();
                break;
            case R.id.layout_apk /* 2131296929 */:
                ...
                break;
            case R.id.layout_app /* 2131296930 */:
                ...
                break;
            case R.id.stop_scan /* 2131297451 */:
                btnDeal();
                break;
            case R.id.tv_appeal /* 2131297584 */:
                appealSelect();
                break;
            case R.id.tv_appeal_wb /* 2131297585 */:
                util.f1.a(this.mActivity);
                break;
    ...
    class g implements ui.e.c {
        ...
        public void a(int i2) {
            ...
            util.s1.c("Scanner", "APP\u603b\u6570=" + i2);
        }

        @Override // ui.e.c
        public void b() {
            util.s1.c("Scanner", "\u68c0\u6d4b\u5e94\u7528-----------------scanStop");
            try {
                VirusKillingActivity.this.btnDeal();
                if (VirusKillingActivity.this.mIvAppStates != null) {
                    k.d.a(VirusKillingActivity.this.mIvAppStates, Integer.valueOf(R.mipmap.ic_scan_wait));
                }
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        ...
        public void c() {
            ...
            util.s1.c("Scanner", "\u5f00\u59cb\u68c0\u6d4b");
            try {
                VirusKillingActivity.this.mScanApp.setText("\u6b63\u5728\u68c0\u6d4b\u5e94\u7528");
                VirusKillingActivity.this.mScanPackage.setText("\u7b49\u5f85\u68c0\u6d4b\u5b89\u88c5\u5305");
                k.d.a(VirusKillingActivity.this.mIvAppStates, Integer.valueOf(R.mipmap.ic_scan_loading));
                k.d.a(VirusKillingActivity.this.mIvApkStates, Integer.valueOf(R.mipmap.ic_scan_wait));
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        }
        ...
        public void a(List<AppInfoBean> list, AppInfoBean appInfoBean) {
            ...
            util.s1.b("scanSingleIng-->", "data " + VirusKillingActivity.this.mAdapter.c().size());
        }
        ...
        public void a(List<AppInfoBean> list) {
            try {
                for (AppInfoBean appInfoBean : list) {
                    ...
                    util.s1.c("Scanner", "\u68c0\u6d4b\u5b8c\u6210\u5e94\u7528=======" + appInfoBean.getName() + "==" + appInfoBean.getPkgName());
                }
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        ...
        public void a() {
            ...
            if (textView != null && virusKillingActivity2.mIvAppStates != null) {
                ...
                k.d.b(VirusKillingActivity.this.mIvAppStates, Integer.valueOf(R.mipmap.ic_scan_ok));
            }
    ...
    class h implements ui.e.c {
        ...
        public void a(int i2) {
            ...
            util.s1.c("Scanner", "\u5f00\u59cb\u68c0\u6d4b\u5b89\u88c5\u5305\u4e2a\u6570=====" + i2);
        }

        @Override // ui.e.c
        public void b() {
            util.s1.c("Scanner", "\u68c0\u6d4b\u5b89\u88c5\u5305       scanStop=====");
            try {
                VirusKillingActivity.this.btnDeal();
        ...
        public void c() {
            ...
            try {
                ...
                k.d.a(VirusKillingActivity.this.mIvApkStates, Integer.valueOf(R.mipmap.ic_scan_loading));
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        }
        ...
        public void a(List<AppInfoBean> list) {
            try {
                for (AppInfoBean appInfoBean : list) {
                    ...
                    util.s1.c("Scanner", "\u68c0\u6d4b\u5b8c\u6210\u5b89\u88c5\u5305=======" + appInfoBean.getName() + "==" + appInfoBean.getPkgName());
                }
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        ...
        public void a() {
            ...
            try {
                ...
                k.d.b(VirusKillingActivity.this.mIvApkStates, Integer.valueOf(R.mipmap.ic_scan_ok));
