...
public class VirusKillingActivity extends BaseActivity implements VirusKillingCallView, BaseQuickAdapter.i {
    ...
    public void dealCheck() {
        boolean a2 = util.u1.a(util.u1.A0, false);
        boolean a3 = util.u1.a(util.u1.B0, false);
        if (a2 && a3) {
    ...
    private void deleteSelect() {
        if (hasSelect()) {
            ...
            util.b1.b(this.mActivity, "已删除" + substring + "安装包", "确定", new f());
        }
    }
    ...
    private void initWarn() {
        ...
        boolean a2 = util.u1.a(util.u1.H, false);
        if (ContextCompat.checkSelfPermission(this, util.permissionutil.a.z) == 0 && this.mBasePresenter.isOpenFlowPrim() && a2) {
