...
public final class SignDeliveryDetailActivity_ViewBinding implements Unbinder {
    private SignDeliveryDetailActivity a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private View f13820b;

    class a extends DebouncingOnClickListener {
        final /* synthetic */ SignDeliveryDetailActivity a;

        a(SignDeliveryDetailActivity signDeliveryDetailActivity) {
            this.a = signDeliveryDetailActivity;
        }
    ...
    public void unbind() {
        SignDeliveryDetailActivity signDeliveryDetailActivity = this.a;
    ...
    public SignDeliveryDetailActivity_ViewBinding(SignDeliveryDetailActivity signDeliveryDetailActivity, View view) {
        ...
        this.f13820b = viewFindRequiredView;
