...
public final class SignDeliveryDetailActivity_ViewBinding implements Unbinder {
    ...
    public SignDeliveryDetailActivity_ViewBinding(SignDeliveryDetailActivity signDeliveryDetailActivity, View view) {
        ...
        signDeliveryDetailActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18962b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signDeliveryDetailActivity));
