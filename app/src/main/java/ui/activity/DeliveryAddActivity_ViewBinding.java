...
public final class DeliveryAddActivity_ViewBinding implements Unbinder {
    ...
    public DeliveryAddActivity_ViewBinding(DeliveryAddActivity deliveryAddActivity, View view) {
        ...
        deliveryAddActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18106b = findRequiredView;
        findRequiredView.setOnClickListener(new a(deliveryAddActivity));
        ...
        deliveryAddActivity.mBtnConfirm = (Button) Utils.castView(findRequiredView2, R.id.btn_confirm, "field 'mBtnConfirm'", Button.class);
        this.f18107c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(deliveryAddActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_delivery_plat, "field 'mTvDeliveryPlat' and method 'onViewClicked'");
        deliveryAddActivity.mTvDeliveryPlat = (TextView) Utils.castView(findRequiredView3, R.id.tv_delivery_plat, "field 'mTvDeliveryPlat'", TextView.class);
        this.f18108d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(deliveryAddActivity));
        ...
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_delivery_time, "field 'mTvDeliveryTime' and method 'onViewClicked'");
        deliveryAddActivity.mTvDeliveryTime = (TextView) Utils.castView(findRequiredView4, R.id.tv_delivery_time, "field 'mTvDeliveryTime'", TextView.class);
        this.f18109e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(deliveryAddActivity));
