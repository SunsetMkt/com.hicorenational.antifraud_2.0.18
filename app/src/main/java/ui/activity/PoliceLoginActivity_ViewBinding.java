...
public class PoliceLoginActivity_ViewBinding implements Unbinder {
    ...
    public PoliceLoginActivity_ViewBinding(PoliceLoginActivity policeLoginActivity, View view) {
        ...
        policeLoginActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18523b = findRequiredView;
        findRequiredView.setOnClickListener(new a(policeLoginActivity));
        ...
        policeLoginActivity.mConfirm = (TextView) Utils.castView(findRequiredView2, R.id.confirm, "field 'mConfirm'", TextView.class);
        this.f18524c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(policeLoginActivity));
        policeLoginActivity.mPhone = (EditText) Utils.findRequiredViewAsType(view, R.id.phone, "field 'mPhone'", EditText.class);
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_clear, "field 'mIvclean' and method 'onViewClicked'");
        policeLoginActivity.mIvclean = (ImageView) Utils.castView(findRequiredView3, R.id.iv_clear, "field 'mIvclean'", ImageView.class);
        this.f18525d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(policeLoginActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_resend, "field 'mTvReset' and method 'onViewClicked'");
        policeLoginActivity.mTvReset = (CodeCutTimeTextView) Utils.castView(findRequiredView4, R.id.tv_resend, "field 'mTvReset'", CodeCutTimeTextView.class);
        this.f18526e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(policeLoginActivity));
        ...
        policeLoginActivity.mIvClearCode = (ImageView) Utils.castView(findRequiredView5, R.id.iv_clear_code, "field 'mIvClearCode'", ImageView.class);
        this.f18527f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(policeLoginActivity));
    }
}
