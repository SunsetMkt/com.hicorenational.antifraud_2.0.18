...
public class WarnGuideActivity_ViewBinding implements Unbinder {
    ...
    public WarnGuideActivity_ViewBinding(WarnGuideActivity warnGuideActivity, View view) {
        ...
        warnGuideActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f19278b = findRequiredView;
        findRequiredView.setOnClickListener(new a(warnGuideActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_go_setting, "method 'onViewClicked'");
        this.f19279c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(warnGuideActivity));
    }
}
