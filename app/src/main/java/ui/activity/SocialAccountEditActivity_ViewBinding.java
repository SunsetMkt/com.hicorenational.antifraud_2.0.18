...
public class SocialAccountEditActivity_ViewBinding implements Unbinder {
    private SocialAccountEditActivity a;
    ...
    class a extends DebouncingOnClickListener {
        final /* synthetic */ SocialAccountEditActivity a;

        a(SocialAccountEditActivity socialAccountEditActivity) {
            this.a = socialAccountEditActivity;
        }
    ...
    @CallSuper
    public void unbind() {
        SocialAccountEditActivity socialAccountEditActivity = this.a;
    ...
    public SocialAccountEditActivity_ViewBinding(SocialAccountEditActivity socialAccountEditActivity, View view) {
        ...
        this.f13885b = viewFindRequiredView;
        ...
        this.f13886c = viewFindRequiredView2;
