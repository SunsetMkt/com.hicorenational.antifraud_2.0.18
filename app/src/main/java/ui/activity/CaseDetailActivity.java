...
public final class CaseDetailActivity extends BaseActivity implements CaseHistoryCallView {
    ...
    public final void initView(@i.c.a.d CaseDetailBean caseDetailBean) {
        ...
        if (status != 0) {
            if (status != 3) {
                if (status != 127) {
                    if (status != 5) {
                        ...
                        com.bumptech.glide.j<Drawable> a2 = com.bumptech.glide.b.a(this.mActivity).a(Integer.valueOf(R.mipmap.ic_detail_back));
                        ImageView imageView = this.mIvStatusTag;
                        if (imageView == null) {
                            h.q2.t.i0.k("mIvStatusTag");
                        }
            ...
            com.bumptech.glide.j<Drawable> a3 = com.bumptech.glide.b.a(this.mActivity).a(Integer.valueOf(R.mipmap.ic_detail_wait));
            ...
            if (j2 == null || !TextUtils.equals(j2.getStopPayment(), "1")) {
        ...
        com.bumptech.glide.j<Drawable> a4 = com.bumptech.glide.b.a(this.mActivity).a(Integer.valueOf(R.mipmap.ic_detail_over));
        ...
        RegionMudelBean j3 = d.a.j();
        if (j3 == null || !TextUtils.equals(j3.getStopPayment(), "1") || this.stopPaymentCount <= 0) {
    ...
    public final void onEvent(@i.c.a.e util.c2.a aVar) {
        if (aVar != null) {
            ...
            List<? extends AccountListBean> list = (List) b3;
