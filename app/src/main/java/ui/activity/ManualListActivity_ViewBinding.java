...
public final class ManualListActivity_ViewBinding implements Unbinder {
    ...
    public ManualListActivity_ViewBinding(ManualListActivity manualListActivity, View view) {
        ...
        manualListActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18383b = findRequiredView;
        findRequiredView.setOnClickListener(new a(manualListActivity));
