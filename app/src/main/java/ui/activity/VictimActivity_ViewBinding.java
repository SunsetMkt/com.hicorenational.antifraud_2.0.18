...
public final class VictimActivity_ViewBinding implements Unbinder {
    ...
    public VictimActivity_ViewBinding(VictimActivity victimActivity, View view) {
        ...
        victimActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f19197b = findRequiredView;
        findRequiredView.setOnClickListener(new a(victimActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_peop_credent_type, "field 'mTvPeopCredentType' and method 'onClick'");
        victimActivity.mTvPeopCredentType = (TextView) Utils.castView(findRequiredView2, R.id.tv_peop_credent_type, "field 'mTvPeopCredentType'", TextView.class);
        this.f19198c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(victimActivity));
        ...
        victimActivity.mBtnCommit = (Button) Utils.castView(findRequiredView3, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f19199d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(victimActivity));
    }
}
