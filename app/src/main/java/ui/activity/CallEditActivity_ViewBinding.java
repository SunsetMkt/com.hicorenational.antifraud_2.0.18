...
public class CallEditActivity_ViewBinding implements Unbinder {
    ...
    public CallEditActivity_ViewBinding(CallEditActivity callEditActivity, View view) {
        ...
        callEditActivity.mBtnConfirm = (Button) Utils.castView(findRequiredView, R.id.btn_confirm, "field 'mBtnConfirm'", Button.class);
        this.f17748b = findRequiredView;
        findRequiredView.setOnClickListener(new a(callEditActivity));
        ...
        callEditActivity.mTvOccurTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_occur_time, "field 'mTvOccurTime'", TextView.class);
        this.f17749c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(callEditActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_duration, "field 'mTvDuration' and method 'onViewClicked'");
        callEditActivity.mTvDuration = (TextView) Utils.castView(findRequiredView3, R.id.tv_duration, "field 'mTvDuration'", TextView.class);
        this.f17750d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(callEditActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f17751e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(callEditActivity));
    }
}
