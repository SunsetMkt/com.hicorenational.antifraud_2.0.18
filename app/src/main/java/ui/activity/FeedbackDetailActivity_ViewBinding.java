...
public class FeedbackDetailActivity_ViewBinding implements Unbinder {
    ...
    public FeedbackDetailActivity_ViewBinding(FeedbackDetailActivity feedbackDetailActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_go_feedback, "field 'mTvGoFeedback' and method 'onViewClicked'");
        feedbackDetailActivity.mTvGoFeedback = (TextView) Utils.castView(findRequiredView, R.id.tv_go_feedback, "field 'mTvGoFeedback'", TextView.class);
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.ll_solve, "method 'onViewClicked'");
        this.f18141d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(feedbackDetailActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.ll_not_solve, "method 'onViewClicked'");
