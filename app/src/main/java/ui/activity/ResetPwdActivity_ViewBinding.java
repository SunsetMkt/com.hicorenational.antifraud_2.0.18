...
public class ResetPwdActivity_ViewBinding implements Unbinder {
    ...
    public ResetPwdActivity_ViewBinding(ResetPwdActivity resetPwdActivity, View view) {
        ...
        resetPwdActivity.mConfim = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mConfim'", TextView.class);
        this.f18858b = findRequiredView;
        ...
        resetPwdActivity.mIvClean = (ImageView) Utils.castView(findRequiredView2, R.id.iv_clear, "field 'mIvClean'", ImageView.class);
        this.f18859c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(resetPwdActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18860d = findRequiredView3;
