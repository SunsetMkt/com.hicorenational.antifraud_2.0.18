...
public class ForgetPdwResetActivity_ViewBinding implements Unbinder {
    ...
    public ForgetPdwResetActivity_ViewBinding(ForgetPdwResetActivity forgetPdwResetActivity, View view) {
        ...
        forgetPdwResetActivity.mConfim = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mConfim'", TextView.class);
        this.f18180b = findRequiredView;
        findRequiredView.setOnClickListener(new a(forgetPdwResetActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18181c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(forgetPdwResetActivity));
    }
}
