...
public class SurveyAudioActivity_ViewBinding implements Unbinder {
    ...
    public SurveyAudioActivity_ViewBinding(SurveyAudioActivity surveyAudioActivity, View view) {
        ...
        surveyAudioActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.ll_add_suspect, "field 'mLlAddBtn' and method 'onViewClicked'");
        ...
        this.f19082e = findRequiredView4;
