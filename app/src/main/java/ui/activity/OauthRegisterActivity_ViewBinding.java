...
public class OauthRegisterActivity_ViewBinding implements Unbinder {
    ...
    public OauthRegisterActivity_ViewBinding(OauthRegisterActivity oauthRegisterActivity, View view) {
        ...
        oauthRegisterActivity.mConfirm = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mConfirm'", TextView.class);
        this.f18426b = findRequiredView;
        findRequiredView.setOnClickListener(new a(oauthRegisterActivity));
        ...
        oauthRegisterActivity.mIvClean = (ImageView) Utils.castView(findRequiredView2, R.id.iv_clear, "field 'mIvClean'", ImageView.class);
        this.f18427c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(oauthRegisterActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_resend, "field 'mTvReset' and method 'onViewClicked'");
        oauthRegisterActivity.mTvReset = (CodeCutTimeTextView) Utils.castView(findRequiredView3, R.id.tv_resend, "field 'mTvReset'", CodeCutTimeTextView.class);
        this.f18428d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(oauthRegisterActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18429e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(oauthRegisterActivity));
    }
}
