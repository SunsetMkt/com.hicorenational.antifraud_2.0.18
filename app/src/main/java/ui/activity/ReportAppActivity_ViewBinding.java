...
public final class ReportAppActivity_ViewBinding implements Unbinder {
    ...
    public ReportAppActivity_ViewBinding(ReportAppActivity reportAppActivity, View view) {
        ...
        reportAppActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18670b = findRequiredView;
        findRequiredView.setOnClickListener(new a(reportAppActivity));
        ...
        this.f18671c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(reportAppActivity));
    }
}
