...
public final class SignCallDetailActivity_ViewBinding implements Unbinder {
    ...
    public SignCallDetailActivity_ViewBinding(SignCallDetailActivity signCallDetailActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_audio_num, "field 'mAudioNum' and method 'onViewClicked'");
        signCallDetailActivity.mAudioNum = (TextView) Utils.castView(findRequiredView, R.id.tv_audio_num, "field 'mAudioNum'", TextView.class);
        this.f18924b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signCallDetailActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18925c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(signCallDetailActivity));
    }
}
