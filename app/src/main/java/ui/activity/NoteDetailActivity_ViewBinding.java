...
public final class NoteDetailActivity_ViewBinding implements Unbinder {
    ...
    public NoteDetailActivity_ViewBinding(NoteDetailActivity noteDetailActivity, View view) {
        ...
        noteDetailActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18415b = findRequiredView;
        findRequiredView.setOnClickListener(new a(noteDetailActivity));
