...
public class MainActivity extends BaseActivity implements MainCallview {
    ...
    public static void getPushIntent(Intent intent) {
        pushType = intent.getStringExtra(util.p1.f15012d);
        pushUrl = intent.getStringExtra(util.p1.Q);
    }
    ...
    private void initAdapter() {
        ...
        this.mBottomBar.setOnTabSelectedListener(new BottomBar.a() { // from class: ui.activity.k0
            @Override // ui.view.BottomBar.a
            public final void a(BottomLocalBean bottomLocalBean, int i2, int i3) {
                this.a.a(bottomLocalBean, i2, i3);
            }
        });
    }
    ...
    private void maskScreenDark(boolean z) {
    ...
    public /* synthetic */ void a() {
        if (this.mWebFragLocal != null && !TextUtils.isEmpty(pushType) && pushType.equals(receiver.e.f13026d)) {
        ...
        this.mPresenter.gxButtonRedDotHind();
    }
    ...
    @Override // ui.callview.MainCallview
    public void isHindGxButtonRedDot(boolean z) {
        if (this.mTabs.size() == 4) {
            BottomBarTab bottomBarTabA = this.mBottomBar.a(2);
            if (this.prePos == 2) {
                bottomBarTabA.a(false);
            } else {
                bottomBarTabA.a(z);
            }
        }
    ...
    protected void onActivityResult(int i2, int i3, Intent intent) {
        ...
        this.mTabs.get(this.mViewpager.getCurrentItem()).onActivityResult(i2, i3, intent);
    }
    ...
    public void onEventMainThread(util.n2.a aVar) {
        if (aVar != null) {
            ...
            if (iA == 354) {
                maskScreenDark(((Boolean) aVar.b()).booleanValue());
                return;
            }
            if (iA == 153) {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (extras == null || extras.getInt(util.p1.f15012d, 0) != 480) {
            return;
        }
    ...
    protected void onResume() {
        ...
        if (g2.f()) {
            util.f1.b(this, "\u672c\u5e94\u7528\u4e0d\u652f\u6301ROOT\u8bbe\u5907", "\u786e\u5b9a", new IOneClickListener() { // from class: ui.activity.l0
        ...
        this.mBottomBar.postDelayed(new Runnable() { // from class: ui.activity.m0
