...
public class CriminalSmsActivity extends BaseActivity implements CriminalSmsCallView, BaseQuickAdapter.i {
    ...
    class a implements BaseQuickAdapter.k {
        ...
        public void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
            ...
            intent.putExtra(util.p1.f15011c, (Serializable) CriminalSmsActivity.this.mSmsList);
            intent.putExtra(util.p1.f15013e, i2);
            intent.putExtra(util.p1.C0, CriminalSmsActivity.this.mCaseInfoId);
    ...
    class b implements PermissionsListener {
        ...
        public void onGranted() {
            ...
            intent.putExtra(SmsRecordSelectActivity.f13862k, SmsRecordSelectActivity.f13863l);
            CriminalSmsActivity.this.startActivity(intent);
        }
    }
    ...
    public void onEvent(util.n2.a aVar) {
        ...
        intent.putExtra(util.p1.f15011c, (Serializable) this.mSmsList);
        intent.putExtra(util.p1.f15010b, (Serializable) list.get(0));
        intent.putExtra(util.p1.C0, this.mCaseInfoId);
    ...
    public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
        ...
        if (id == R.id.iv_clear) {
            ...
            intent.putExtra(util.p1.f15013e, i2);
            intent.putExtra(util.p1.C0, this.mCaseInfoId);
            intent.putExtra(util.p1.f15012d, this.mOnlyShow);
            startActivity(intent);
        }
    }
    ...
    public boolean rejuctOperation() {
        ...
        e2.a(this.mSelectWarnStartStr + this.mMaxSelectNum + this.mEndStr);
        return true;
    }
