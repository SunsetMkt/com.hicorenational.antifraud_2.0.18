...
public class TagFlowLaoutActivity extends BaseActivity implements TagFlowLayoutCallView {
    ...
    class a extends com.zhy.view.flowlayout.b<ReportZPEleBean> {
        ...
        final /* synthetic */ TagFlowLayout f13902d;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(List list, TagFlowLayout tagFlowLayout) {
            super(list);
            this.f13902d = tagFlowLayout;
        }

        @Override // com.zhy.view.flowlayout.b
        public View a(FlowLayout flowLayout, int i2, ReportZPEleBean reportZPEleBean) {
            TextView textView = (TextView) LayoutInflater.from(TagFlowLaoutActivity.this.mActivity).inflate(R.layout.tag_flow_item, (ViewGroup) this.f13902d, false);
    ...
    class b implements View.OnClickListener {
        ...
        final /* synthetic */ ImageView f13904b;
        ...
        public void onClick(View view) {
            if (this.a.getTag() == null || !((Boolean) this.a.getTag()).booleanValue()) {
                ...
                this.a.setTag(true);
                this.f13904b.setImageResource(R.drawable.iv_tag_ar_up);
            } else {
                this.a.setVisibility(8);
                this.a.setTag(false);
                this.f13904b.setImageResource(R.drawable.iv_tag_ar_down);
            }
        }
    }
    ...
    private void getIntentData() {
        try {
            this.tagBean = (ReportZPEleBean) getIntent().getSerializableExtra(util.p1.O);
            this.pageType = getIntent().getIntExtra(util.p1.f15012d, 0);
    ...
    public /* synthetic */ boolean a(com.zhy.view.flowlayout.b bVar, ReportZPBean reportZPBean, View view, int i2, FlowLayout flowLayout) {
        ...
        org.greenrobot.eventbus.c.f().d(new util.n2.a(3, reportZPEleBean));
        finish();
        return true;
    }
    ...
    protected void initTagAdapter(final ReportZPBean reportZPBean, int i2) {
        ...
        tagFlowLayout.setOnTagClickListener(new TagFlowLayout.c() { // from class: ui.activity.h1
            @Override // com.zhy.view.flowlayout.TagFlowLayout.c
            public final boolean a(View view, int i3, FlowLayout flowLayout) {
                return this.a.a(aVar, reportZPBean, view, i3, flowLayout);
            }
        });
