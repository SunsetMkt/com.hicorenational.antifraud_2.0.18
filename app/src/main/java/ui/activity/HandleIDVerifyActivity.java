...
public class HandleIDVerifyActivity extends BaseActivity implements HandleIDVarfyFaceView {
    ...
    private void initCluse() {
        ...
        spannableString.setSpan(new ui.view.o(str, new ITextCallBackListener() { // from class: ui.activity.u
            ...
            public final void onResult(String str2) {
                HandleIDVerifyActivity.this.a(str2);
            }
        }), 28, str.length(), 33);
        ...
        this.mTCbSelect.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() { // from class: ui.activity.v
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                HandleIDVerifyActivity.this.a(compoundButton, z);
            }
        });
    }
    ...
    private void pctureTaken(byte[] bArr) {
        Bitmap a2 = bArr != null ? util.f1.a(BitmapFactory.decodeByteArray(bArr, 0, bArr.length)) : null;
        if (a2 != null) {
            ByteArrayOutputStream a3 = util.f1.a(a2, d.d.C);
            String a4 = util.x0.a(a3);
            try {
                a3.close();
            } catch (IOException e2) {
                e2.printStackTrace();
            }
            runOnUiThread(new c(a4));
        }
    }
