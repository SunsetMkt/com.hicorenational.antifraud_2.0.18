...
public class SmsAddActivity_ViewBinding implements Unbinder {
    ...
    public SmsAddActivity_ViewBinding(SmsAddActivity smsAddActivity, View view) {
        ...
        smsAddActivity.mBtnCommit = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mBtnCommit'", TextView.class);
        this.f19019b = findRequiredView;
        findRequiredView.setOnClickListener(new a(smsAddActivity));
        ...
        smsAddActivity.mTvTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_time, "field 'mTvTime'", TextView.class);
        this.f19020c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(smsAddActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f19021d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(smsAddActivity));
    }
}
