...
public final class SignReChargeActivity_ViewBinding implements Unbinder {
    ...
    public SignReChargeActivity_ViewBinding(SignReChargeActivity signReChargeActivity, View view) {
        ...
        signReChargeActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18966b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signReChargeActivity));
