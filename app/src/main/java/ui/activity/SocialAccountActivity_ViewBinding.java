...
public class SocialAccountActivity_ViewBinding implements Unbinder {
    ...
    public SocialAccountActivity_ViewBinding(SocialAccountActivity socialAccountActivity, View view) {
        ...
        socialAccountActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f19056b = findRequiredView;
        findRequiredView.setOnClickListener(new a(socialAccountActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f19057c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(socialAccountActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.ll_select, "method 'onViewClicked'");
        this.f19058d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(socialAccountActivity));
    }
}
