...
public final class CallActivity_ViewBinding implements Unbinder {
    ...
    public CallActivity_ViewBinding(CallActivity callActivity, View view) {
        ...
        callActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        ...
        this.f17732d = findRequiredView3;
        ...
        this.f17733e = findRequiredView4;
