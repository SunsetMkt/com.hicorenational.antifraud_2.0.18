...
public class PayStopListActivity_ViewBinding implements Unbinder {
    ...
    public PayStopListActivity_ViewBinding(PayStopListActivity payStopListActivity, View view) {
        ...
        findRequiredView.setOnClickListener(new a(payStopListActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.ll_input, "field 'mLlInput' and method 'onViewClicked'");
        payStopListActivity.mLlInput = findRequiredView2;
        this.f18461c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(payStopListActivity));
        ...
        payStopListActivity.mBtnCommit = (Button) Utils.castView(findRequiredView3, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18462d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(payStopListActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18463e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(payStopListActivity));
    }
}
