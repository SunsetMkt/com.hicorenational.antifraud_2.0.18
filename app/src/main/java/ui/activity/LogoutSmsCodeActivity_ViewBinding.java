...
public final class LogoutSmsCodeActivity_ViewBinding implements Unbinder {
    ...
    public LogoutSmsCodeActivity_ViewBinding(LogoutSmsCodeActivity logoutSmsCodeActivity, View view) {
        ...
        logoutSmsCodeActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18330b = findRequiredView;
        findRequiredView.setOnClickListener(new a(logoutSmsCodeActivity));
        ...
        logoutSmsCodeActivity.mTvReSend = (CodeCutTimeTextView) Utils.castView(findRequiredView2, R.id.tv_resend, "field 'mTvReSend'", CodeCutTimeTextView.class);
        this.f18331c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(logoutSmsCodeActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.confirm, "field 'mConfim' and method 'onClick'");
        logoutSmsCodeActivity.mConfim = (Button) Utils.castView(findRequiredView3, R.id.confirm, "field 'mConfim'", Button.class);
        this.f18332d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(logoutSmsCodeActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.iv_clear, "method 'onClick'");
        this.f18333e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(logoutSmsCodeActivity));
    }
}
