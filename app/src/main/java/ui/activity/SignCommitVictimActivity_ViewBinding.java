...
public final class SignCommitVictimActivity_ViewBinding implements Unbinder {
    ...
    public SignCommitVictimActivity_ViewBinding(SignCommitVictimActivity signCommitVictimActivity, View view) {
        ...
        signCommitVictimActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18939b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signCommitVictimActivity));
