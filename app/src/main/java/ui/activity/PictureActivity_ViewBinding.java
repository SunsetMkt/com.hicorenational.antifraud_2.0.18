...
public class PictureActivity_ViewBinding implements Unbinder {
    ...
    public PictureActivity_ViewBinding(PictureActivity pictureActivity, View view) {
        ...
        pictureActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18499b = findRequiredView;
        findRequiredView.setOnClickListener(new a(pictureActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18500c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(pictureActivity));
    }
}
