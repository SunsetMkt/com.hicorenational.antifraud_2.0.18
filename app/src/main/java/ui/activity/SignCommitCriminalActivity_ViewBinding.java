...
public final class SignCommitCriminalActivity_ViewBinding implements Unbinder {
    ...
    public SignCommitCriminalActivity_ViewBinding(SignCommitCriminalActivity signCommitCriminalActivity, View view) {
        ...
        signCommitCriminalActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18935b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signCommitCriminalActivity));
