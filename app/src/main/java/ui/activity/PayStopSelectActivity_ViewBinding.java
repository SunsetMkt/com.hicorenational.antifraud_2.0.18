...
public class PayStopSelectActivity_ViewBinding implements Unbinder {
    ...
    public PayStopSelectActivity_ViewBinding(PayStopSelectActivity payStopSelectActivity, View view) {
        ...
        payStopSelectActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18475b = findRequiredView;
        findRequiredView.setOnClickListener(new a(payStopSelectActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18476c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(payStopSelectActivity));
    }
}
