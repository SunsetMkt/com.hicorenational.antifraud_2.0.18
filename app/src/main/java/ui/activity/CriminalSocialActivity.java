...
public class CriminalSocialActivity extends BaseActivity implements CriminalSocialCallView, BaseQuickAdapter.i {
    ...
    class a implements BaseQuickAdapter.k {
        ...
        public void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
            ...
            intent.putExtra(util.p1.C0, CriminalSocialActivity.this.mCaseInfoId);
            if (i2 != -1) {
                intent.putExtra(util.p1.v, i2);
                intent.putExtra(util.p1.w, (Serializable) CriminalSocialActivity.this.mSocialList.get(i2));
            }
            intent.putExtra(util.p1.f15012d, CriminalSocialActivity.this.mOnlyShow);
    ...
    private void forceActivity(int i2) {
        ...
        if (i2 != -1) {
            intent.putExtra(util.p1.v, i2);
            intent.putExtra(util.p1.w, this.mSocialList.get(i2));
        }
