...
public final class AddCrimePhoneActivity_ViewBinding implements Unbinder {
    ...
    public AddCrimePhoneActivity_ViewBinding(AddCrimePhoneActivity addCrimePhoneActivity, View view) {
        ...
        addCrimePhoneActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17612b = findRequiredView;
        findRequiredView.setOnClickListener(new a(addCrimePhoneActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.rl_type_phone, "method 'onClick'");
        this.f17613c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(addCrimePhoneActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.rl_type_recharge, "method 'onClick'");
        this.f17614d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(addCrimePhoneActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.rl_type_relation, "method 'onClick'");
        this.f17615e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(addCrimePhoneActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.rl_type_delivery, "method 'onClick'");
        this.f17616f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(addCrimePhoneActivity));
        View findRequiredView6 = Utils.findRequiredView(view, R.id.btn_commit, "method 'onClick'");
        this.f17617g = findRequiredView6;
        findRequiredView6.setOnClickListener(new f(addCrimePhoneActivity));
    }
}
