...
public class AccountListActivity_ViewBinding implements Unbinder {
    ...
    public AccountListActivity_ViewBinding(AccountListActivity accountListActivity, View view) {
        ...
        accountListActivity.mLlAdd = (LinearLayout) Utils.castView(findRequiredView, R.id.ll_add, "field 'mLlAdd'", LinearLayout.class);
        ...
        findRequiredView2.setOnClickListener(new b(accountListActivity));
    }
}
