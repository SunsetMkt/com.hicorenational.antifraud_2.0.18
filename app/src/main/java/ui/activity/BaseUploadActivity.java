...
public abstract class BaseUploadActivity extends BaseActivity implements AudioCallView {
    ...
    class a implements IClickListener {
        ...
        public void cancelBtn() {
            try {
                if (BaseUploadActivity.this.mUploadStateList.get(this.a).getUploadState() == 1) {
                    AliOssClient.getInstance().taskCancle();
                }
                BaseUploadActivity.this.cancelUpdateHttp(this.a);
                BaseUploadActivity.this.clearItem(this.a);
    ...
    public void cancelUpdateHttp(int i2) {
        ...
        this.mPresenter.cancelUpdateHttp(map, new HandleFilePresenter.c() { // from class: ui.activity.j
    ...
    public void backDialog() {
        util.f1.a(this.mActivity, "\u662f\u5426\u505c\u6b62\u6587\u4ef6\u4e0a\u4f20\uff1f", "", "\u662f", "\u5426", R.color._353536, -1, (IClickListener) new b());
    }
    ...
    public String getUpId() {
        return Hicore.fromPageReport ? ReportNewActivity.REPORT_UP_ID : c2.b(c2.w);
    }
    ...
    public void setUpId() {
        ...
        String strB = Hicore.fromPageReport ? ReportNewActivity.REPORT_UP_ID : c2.b(c2.w);
