...
public abstract class BaseUploadActivity extends BaseActivity implements AudioCallView {
    ...
    public void cancelUpdateHttp(int i2) {
        ...
        this.mPresenter.cancelUpdateHttp(hashMap, new HandleFilePresenter.c() { // from class: ui.activity.h
    ...
    public void onEventMainThread(util.c2.a aVar) {
        if (aVar != null) {
            int a2 = aVar.a();
            if (a2 == 40 || a2 == 50 || a2 == 60 || a2 == 70 || a2 == 80) {
    ...
    public void setUpId() {
        ...
        String b2 = Hicore.fromPageReport ? ReportNewActivity.REPORT_UP_ID : util.u1.b(util.u1.w);
