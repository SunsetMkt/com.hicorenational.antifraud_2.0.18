...
public class BeforIdVerifyActivity_ViewBinding implements Unbinder {
    ...
    public BeforIdVerifyActivity_ViewBinding(BeforIdVerifyActivity beforIdVerifyActivity, View view) {
        ...
        beforIdVerifyActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17720b = findRequiredView;
        findRequiredView.setOnClickListener(new a(beforIdVerifyActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.btn_start, "field 'mStart' and method 'onViewClicked'");
        beforIdVerifyActivity.mStart = (Button) Utils.castView(findRequiredView2, R.id.btn_start, "field 'mStart'", Button.class);
        this.f17721c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(beforIdVerifyActivity));
    }
}
