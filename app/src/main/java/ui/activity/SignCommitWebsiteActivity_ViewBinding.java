...
public final class SignCommitWebsiteActivity_ViewBinding implements Unbinder {
    ...
    public SignCommitWebsiteActivity_ViewBinding(SignCommitWebsiteActivity signCommitWebsiteActivity, View view) {
        ...
        signCommitWebsiteActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18943b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signCommitWebsiteActivity));
