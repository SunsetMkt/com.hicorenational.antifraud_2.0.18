...
public class RecordHelpActivity_ViewBinding implements Unbinder {
    private RecordHelpActivity a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private View f13627b;

    class a extends DebouncingOnClickListener {
        final /* synthetic */ RecordHelpActivity a;

        a(RecordHelpActivity recordHelpActivity) {
            this.a = recordHelpActivity;
        }
    ...
    @CallSuper
    public void unbind() {
        RecordHelpActivity recordHelpActivity = this.a;
    ...
    public RecordHelpActivity_ViewBinding(RecordHelpActivity recordHelpActivity, View view) {
        ...
        this.f13627b = viewFindRequiredView;
