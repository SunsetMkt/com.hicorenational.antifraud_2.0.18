...
public class RecordHelpActivity_ViewBinding implements Unbinder {
    ...
    public RecordHelpActivity_ViewBinding(RecordHelpActivity recordHelpActivity, View view) {
        ...
        recordHelpActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18617b = findRequiredView;
        findRequiredView.setOnClickListener(new a(recordHelpActivity));
