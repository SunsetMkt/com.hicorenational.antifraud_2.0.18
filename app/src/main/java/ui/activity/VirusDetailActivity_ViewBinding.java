...
public class VirusDetailActivity_ViewBinding implements Unbinder {
    ...
    public VirusDetailActivity_ViewBinding(VirusDetailActivity virusDetailActivity, View view) {
        ...
        virusDetailActivity.mTvDelete = (TextView) Utils.castView(findRequiredView, R.id.tv_delete, "field 'mTvDelete'", TextView.class);
        this.f19226b = findRequiredView;
        findRequiredView.setOnClickListener(new a(virusDetailActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f19227c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(virusDetailActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_appeal, "method 'onViewClicked'");
        this.f19228d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(virusDetailActivity));
    }
}
