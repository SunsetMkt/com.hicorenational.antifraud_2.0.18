...
public final class SignAppDetailActivity_ViewBinding implements Unbinder {
    private SignAppDetailActivity a;
    ...
    class a extends DebouncingOnClickListener {
        final /* synthetic */ SignAppDetailActivity a;

        a(SignAppDetailActivity signAppDetailActivity) {
            this.a = signAppDetailActivity;
        }
    ...
    public void unbind() {
        SignAppDetailActivity signAppDetailActivity = this.a;
    ...
    public SignAppDetailActivity_ViewBinding(SignAppDetailActivity signAppDetailActivity, View view) {
        ...
        this.f13791b = viewFindRequiredView;
        ...
        this.f13792c = viewFindRequiredView2;
        ...
        this.f13793d = viewFindRequiredView3;
