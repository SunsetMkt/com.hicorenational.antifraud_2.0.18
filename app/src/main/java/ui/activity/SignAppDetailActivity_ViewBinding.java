...
public final class SignAppDetailActivity_ViewBinding implements Unbinder {
    ...
    public SignAppDetailActivity_ViewBinding(SignAppDetailActivity signAppDetailActivity, View view) {
        ...
        signAppDetailActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18909b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signAppDetailActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_zxing, "field 'mIvAppZxing' and method 'onClick'");
        signAppDetailActivity.mIvAppZxing = (ImageView) Utils.castView(findRequiredView2, R.id.iv_zxing, "field 'mIvAppZxing'", ImageView.class);
        this.f18910c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(signAppDetailActivity));
        signAppDetailActivity.mFlAppLogo = Utils.findRequiredView(view, R.id.fl_app_logo, "field 'mFlAppLogo'");
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_app_logo, "field 'mIvAppLogo' and method 'onClick'");
        signAppDetailActivity.mIvAppLogo = (ImageView) Utils.castView(findRequiredView3, R.id.iv_app_logo, "field 'mIvAppLogo'", ImageView.class);
        this.f18911d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(signAppDetailActivity));
