...
public final class ReporterAidActivity_ViewBinding implements Unbinder {
    ...
    public ReporterAidActivity_ViewBinding(ReporterAidActivity reporterAidActivity, View view) {
        ...
        reporterAidActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18835b = findRequiredView;
        findRequiredView.setOnClickListener(new a(reporterAidActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_report_record, "method 'onClick'");
        this.f18836c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(reporterAidActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_rule, "method 'onClick'");
        this.f18837d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(reporterAidActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.fl_confirm, "method 'onClick'");
        this.f18838e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(reporterAidActivity));
    }
}
