...
public class SmsRecordSelectActivity_ViewBinding implements Unbinder {
    ...
    public SmsRecordSelectActivity_ViewBinding(SmsRecordSelectActivity smsRecordSelectActivity, View view) {
        ...
        smsRecordSelectActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f19047b = findRequiredView;
        findRequiredView.setOnClickListener(new a(smsRecordSelectActivity));
        ...
        smsRecordSelectActivity.mBtnReport = (Button) Utils.castView(findRequiredView2, R.id.btn_report, "field 'mBtnReport'", Button.class);
        this.f19048c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(smsRecordSelectActivity));
    }
}
