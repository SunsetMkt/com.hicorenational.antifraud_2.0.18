...
public final class LogoutConfirmActivity_ViewBinding implements Unbinder {
    ...
    public LogoutConfirmActivity_ViewBinding(LogoutConfirmActivity logoutConfirmActivity, View view) {
        ...
        logoutConfirmActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18307b = findRequiredView;
        findRequiredView.setOnClickListener(new a(logoutConfirmActivity));
        logoutConfirmActivity.mTvTitle = (TextView) Utils.findRequiredViewAsType(view, R.id.tv_title, "field 'mTvTitle'", TextView.class);
        View findRequiredView2 = Utils.findRequiredView(view, R.id.btn_logout, "field 'mLogout' and method 'onClick'");
        logoutConfirmActivity.mLogout = (Button) Utils.castView(findRequiredView2, R.id.btn_logout, "field 'mLogout'", Button.class);
        this.f18308c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(logoutConfirmActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.btn_cancel, "field 'mCancel' and method 'onClick'");
        logoutConfirmActivity.mCancel = (Button) Utils.castView(findRequiredView3, R.id.btn_cancel, "field 'mCancel'", Button.class);
        this.f18309d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(logoutConfirmActivity));
    }
}
