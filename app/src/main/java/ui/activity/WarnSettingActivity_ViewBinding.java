...
public class WarnSettingActivity_ViewBinding implements Unbinder {
    ...
    public WarnSettingActivity_ViewBinding(WarnSettingActivity warnSettingActivity, View view) {
        ...
        warnSettingActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f19329b = findRequiredView;
        findRequiredView.setOnClickListener(new a(warnSettingActivity));
        ...
        warnSettingActivity.mIvRight = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f19330c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(warnSettingActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_go_permission, "field 'mTvGoPermission' and method 'onViewClicked'");
        warnSettingActivity.mTvGoPermission = (TextView) Utils.castView(findRequiredView3, R.id.tv_go_permission, "field 'mTvGoPermission'", TextView.class);
        this.f19331d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(warnSettingActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_error_free, "method 'onViewClicked'");
        this.f19332e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(warnSettingActivity));
    }
}
