...
public class WelcomeActivity_ViewBinding implements Unbinder {
    ...
    public WelcomeActivity_ViewBinding(WelcomeActivity welcomeActivity, View view) {
        ...
        welcomeActivity.mTvNext = (TextView) Utils.castView(findRequiredView, R.id.tv_next, "field 'mTvNext'", TextView.class);
        this.f19395b = findRequiredView;
        findRequiredView.setOnClickListener(new a(welcomeActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.lottie_likeanim, "field 'mLottieLike' and method 'onViewClicked'");
        welcomeActivity.mLottieLike = (LottieAnimationView) Utils.castView(findRequiredView2, R.id.lottie_likeanim, "field 'mLottieLike'", LottieAnimationView.class);
