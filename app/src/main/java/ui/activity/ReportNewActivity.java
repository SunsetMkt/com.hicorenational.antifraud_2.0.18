...
public class ReportNewActivity extends BaseActivity implements ReportCallView {
    ...
    class d implements IClickListener {
        final /* synthetic */ HistoryListInfo.RowsBean a;
        ...
        public void clickOKBtn() {
            ...
            intent.putExtra(util.p1.B, this.a);
    ...
    private void checkPermission() {
        util.permissionutil.c.a(this.mActivity, new String[]{util.permissionutil.a.f15033j}, new b());
    }

    public void cleanCacheData() {
        c2.a((Object) null, c2.c0);
        c2.a((List) null, c2.d0);
        c2.a((List) null, c2.e0);
        c2.a((List) null, c2.f0);
        c2.a((List) null, c2.h0);
        c2.a((List) null, c2.k0);
        c2.a((List) null, c2.l0);
        c2.a((List) null, c2.m0);
        c2.a((List) null, c2.o0);
        c2.a((List) null, c2.p0);
        c2.a((List) null, c2.q0);
        c2.b(c2.v, "");
        k.c.a(k.c.a);
        cleanList();
    }
    ...
    public void cleanList() {
        ...
        TradAccountActivity.f13910c = false;
    }
    ...
    /* JADX INFO: renamed from: getCacheBean */
    public void a() {
        List<SocialAccBean> list;
        REPORT_UP_ID = c2.b(c2.v);
        ReportPersonBean reportPersonBean = (ReportPersonBean) c2.a(c2.c0, ReportPersonBean.class);
        ...
        List<CallBean> listB = c2.b(c2.d0, CallBean.class);
        List<SmsBean> listB2 = c2.b(c2.e0, SmsBean.class);
        List<AppBean> listB3 = c2.b(c2.f0, AppBean.class);
        List<CasePicBean> listB4 = c2.b(c2.h0, CasePicBean.class);
        List<LocalMedia> listB5 = c2.b(c2.k0, LocalMedia.class);
        List<LocalMedia> listB6 = c2.b(c2.m0, LocalMedia.class);
        List<String> listB7 = c2.b(c2.o0, String.class);
        List<SocialAccBean> listB8 = c2.b(c2.p0, SocialAccBean.class);
        List<SocialAccBean> listB9 = c2.b(c2.q0, SocialAccBean.class);
        List<UploadStateInfo> listB10 = c2.b(c2.l0, UploadStateInfo.class);
        List<UploadStateInfo> listB11 = c2.b(c2.g0, UploadStateInfo.class);
        List<UploadStateInfo> listB12 = c2.b(c2.j0, UploadStateInfo.class);
        List<UploadStateInfo> listB13 = c2.b(c2.n0, UploadStateInfo.class);
        ...
        if (listB3 == null || listB3.size() <= 0) {
            ...
            if (arrayList == null || arrayList.size() <= 0) {
                org.greenrobot.eventbus.c.f().d(new util.n2.a(1, null));
            } else {
                fixApps();
                this.mLlApp.setAppSData(this.mApps);
    ...
    private void initScanData(Intent intent) {
        ...
        this.intentSMSBean = (SmsBean) intent.getSerializableExtra(util.p1.u);
        this.intentApps = getIntent().getParcelableArrayListExtra(util.p1.t);
        ArrayList<AppInfoBean> parcelableArrayListExtra = getIntent().getParcelableArrayListExtra(util.p1.x);
    ...
    private void initView() {
        util.f1.a(this, 3, "110", getString(R.string.report_time_tips), "", "\u6211\u77e5\u9053\u4e86", (IOneClickListener) null);
        ...
        if (isNeedSaveOrClear()) {
            ...
            g2.f14889b.post(new Runnable() { // from class: ui.activity.z0
                @Override // java.lang.Runnable
    ...
    private boolean isNeedSaveOrClear() {
        return TradAccountActivity.f13910c;
    }
    ...
    public void saveCacheData() {
        c2.b(c2.v, REPORT_UP_ID);
        c2.a(buildDiscCache(), c2.c0);
        c2.a((List) this.mCallList, c2.d0);
        c2.a((List) this.mSmsList, c2.e0);
        c2.a((List) this.mLocalAudioList, c2.k0);
        c2.a((List) this.mLocalVideoList, c2.m0);
        c2.a((List) this.mWebUrlList, c2.o0);
        c2.a((List) this.mSocialAccs, c2.p0);
        c2.a((List) this.mTradlAccs, c2.q0);
        c2.a((List) this.mAudioStateList, c2.l0);
        c2.a((List) this.mAppStateList, c2.g0);
        c2.a((List) this.mPictureStateList, c2.j0);
        c2.a((List) this.mVideoStateList, c2.n0);
        this.mCasePic.clear();
        this.mApps.clear();
        ...
        for (int i3 = 0; i3 < this.mAppList.size(); i3++) {
            k.c.a(k.c.a(this.mAppList.get(i3).getAppIcon()), this.mAppList.get(i3).getName(), this.mAppList.get(i3).getVersionName(), k.c.a);
            this.mApps.add(AppBean.AppInfoBean2AppBean(this.mAppList.get(i3)));
        }
        c2.a((List) this.mApps, c2.f0);
        c2.a((List) this.mCasePic, c2.h0);
    }
    ...
    private void saveDataCache() {
        if (!hasData()) {
            ...
            util.f1.a((Activity) this, "\u5c06\u6b64\u6b21\u7f16\u8f91\u4fdd\u7559", "", "\u4e0d\u4fdd\u7559", "\u4fdd\u7559", R.color._353536, -1, true, (IClickListener) new c());
        } else {
            cleanList();
            finish();
        }
    ...
    public void initPage() {
        StatisticsHttp.getInstance().pageOpenHttp(f.d.f10212l);
    ...
    public void onSuccessRequest(HistoryListInfo.RowsBean rowsBean) {
        ...
        if (this.isFromVirusCheck) {
            ...
            org.greenrobot.eventbus.c.f().d(new util.n2.a(26, arrayList));
        }
        if (isNeedSaveOrClear()) {
            cleanList();
        } else {
        ...
        this.dialogRP = util.f1.a(REPORTNUM, this.mActivity, "\u4e3e\u62a5\u6210\u529f", "\u611f\u8c22\u60a8\u7684\u4e3e\u62a5\uff0c\u6211\u4eec\u5c06\u5c3d\u5feb\u5904\u7406", "\u7ee7\u7eed\u4e3e\u62a5", "\u67e5\u770b\u4e3e\u62a5", new d(rowsBean));
    }
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_commit /* 2131296407 */:
                if (!LoginManager.getInstance().isLogOut()) {
                    if (hasUpFileId() == 0 && !hasReportData()) {
                        util.f1.b(this.mActivity, "\u8bf7\u81f3\u5c11\u586b\u5199\u4e00\u9879\u4e3e\u62a5\u4fe1\u606f", "\u77e5\u9053\u4e86", null);
                    } else if (hasUpFileId() == 1 || hasUpFileId() == 3 || hasUpFileId() == 4 || hasUpFileId() == 5 || hasUpFileId() == 6) {
                        e2.a("\u8bf7\u5148\u4e0a\u4f20\u6587\u4ef6");
                    } else if (this.mDefraudCode == -1 || TextUtils.isEmpty(this.mTvDuperyType.getText())) {
                        e2.a("\u8bf7\u9009\u62e9\u8bc8\u9a97\u7c7b\u578b");
                    } else {
                        checkPermission();
                    }
                ...
                break;
            case R.id.et_case_describe /* 2131296586 */:
            ...
            case R.id.iv_back /* 2131296808 */:
                saveDataCache();
                break;
            case R.id.ll_dupery_type /* 2131296994 */:
                Intent intent2 = new Intent(this.mActivity, (Class<?>) TagFlowLaoutActivity.class);
                ReportZPEleBean reportZPEleBean = this.info;
                if (reportZPEleBean != null) {
                    intent2.putExtra(util.p1.O, reportZPEleBean);
                }
            ...
            case R.id.region /* 2131297299 */:
                ...
                break;
            case R.id.tv_record_help /* 2131297838 */:
                startActivity(new Intent(this.mActivity, (Class<?>) RecordHelpActivity.class));
                break;
            case R.id.tv_social /* 2131297877 */:
                Intent intent3 = new Intent(this, (Class<?>) SocialAccountActivity.class);
                intent3.putExtra(util.p1.o, (Serializable) this.mSocialAccs);
                startActivity(intent3);
                break;
            case R.id.tv_trad /* 2131297928 */:
                Intent intent4 = new Intent(this, (Class<?>) TradAccountActivity.class);
                intent4.putExtra(util.p1.r, (Serializable) this.mTradlAccs);
                startActivity(intent4);
                break;
            case R.id.tv_upload_app /* 2131297948 */:
                startActivity(new Intent(this, (Class<?>) AppActivity.class));
                List<AppInfoBean> list = this.mAppList;
                if (list != null && list.size() > 0) {
                    org.greenrobot.eventbus.c.f().d(new util.n2.a(50, this.mAppList, this.mAppStateList));
                    break;
                }
                break;
            case R.id.tv_upload_audio /* 2131297949 */:
                startActivity(new Intent(this, (Class<?>) AudioActivity.class));
                List<LocalMedia> list2 = this.mLocalAudioList;
                if (list2 != null && list2.size() > 0) {
                    org.greenrobot.eventbus.c.f().d(new util.n2.a(40, this.mLocalAudioList, this.mAudioStateList));
                    break;
                }
                break;
            case R.id.tv_upload_call /* 2131297950 */:
                Intent intent5 = new Intent(this, (Class<?>) CallNewActivity.class);
                List<CallBean> list3 = this.mCallList;
                if (list3 != null && list3.size() > 0) {
                    intent5.putExtra(util.p1.s, (Serializable) this.mCallList);
                }
                startActivity(intent5);
                break;
            case R.id.tv_upload_picture /* 2131297951 */:
                startActivity(new Intent(this, (Class<?>) PictureActivity.class));
                List<LocalMedia> list4 = this.mPictureList;
                if (list4 != null && list4.size() > 0) {
                    org.greenrobot.eventbus.c.f().d(new util.n2.a(60, this.mPictureList, this.mPictureStateList));
                    break;
                }
                break;
            case R.id.tv_upload_sms /* 2131297952 */:
                Intent intent6 = new Intent(this, (Class<?>) SmsActivity.class);
                List<SmsBean> list5 = this.mSmsList;
                if (list5 != null && list5.size() > 0) {
                    intent6.putExtra(util.p1.u, (Serializable) this.mSmsList);
                }
                startActivity(intent6);
                break;
            case R.id.tv_upload_url /* 2131297954 */:
                Intent intent7 = new Intent(this, (Class<?>) WebsiteActivity.class);
                intent7.putStringArrayListExtra(util.p1.f15022n, (ArrayList) this.mWebUrlList);
                startActivity(intent7);
                break;
            case R.id.tv_upload_video /* 2131297955 */:
                startActivity(new Intent(this, (Class<?>) VideoActivity.class));
                List<LocalMedia> list6 = this.mLocalVideoList;
                if (list6 != null && list6.size() > 0) {
                    org.greenrobot.eventbus.c.f().d(new util.n2.a(70, this.mLocalVideoList, this.mVideoStateList));
                    break;
                }
                break;
        }
