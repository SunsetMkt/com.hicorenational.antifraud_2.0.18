...
public class ReportNewActivity extends BaseActivity implements ReportCallView {
    ...
    public void a() {
        ...
        List<CallBean> b2 = util.u1.b(util.u1.d0, CallBean.class);
        List<SmsBean> b3 = util.u1.b(util.u1.e0, SmsBean.class);
        List<AppBean> b4 = util.u1.b(util.u1.f0, AppBean.class);
        List<CasePicBean> b5 = util.u1.b(util.u1.h0, CasePicBean.class);
        List<LocalMedia> b6 = util.u1.b(util.u1.k0, LocalMedia.class);
        List<LocalMedia> b7 = util.u1.b(util.u1.m0, LocalMedia.class);
        List<String> b8 = util.u1.b(util.u1.o0, String.class);
        List<SocialAccBean> b9 = util.u1.b(util.u1.p0, SocialAccBean.class);
        List<SocialAccBean> b10 = util.u1.b(util.u1.q0, SocialAccBean.class);
        List<UploadStateInfo> b11 = util.u1.b(util.u1.l0, UploadStateInfo.class);
        List<UploadStateInfo> b12 = util.u1.b(util.u1.g0, UploadStateInfo.class);
        List<UploadStateInfo> b13 = util.u1.b(util.u1.j0, UploadStateInfo.class);
        List<UploadStateInfo> b14 = util.u1.b(util.u1.n0, UploadStateInfo.class);
        ...
        if (b6 == null || b6.size() <= 0) {
            ...
            this.mLocalAudioList = b6;
            this.mAudioStateList = b11;
            fixRecordMediasAudio();
            this.mAudioNum.setText(this.mLocalAudioList.size() + "个");
        }
        if (b7 == null || b7.size() <= 0) {
            ...
            this.mLocalVideoList = b7;
            this.mVideoStateList = b14;
            fixRecordMediasVideo();
            this.mVideoNum.setText(this.mLocalVideoList.size() + "个");
        }
