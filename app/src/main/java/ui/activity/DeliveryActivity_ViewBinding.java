...
public final class DeliveryActivity_ViewBinding implements Unbinder {
    ...
    public DeliveryActivity_ViewBinding(DeliveryActivity deliveryActivity, View view) {
        ...
        deliveryActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18088b = findRequiredView;
        findRequiredView.setOnClickListener(new a(deliveryActivity));
        ...
        findRequiredView2.setOnClickListener(new b(deliveryActivity));
        ...
        findRequiredView3.setOnClickListener(new c(deliveryActivity));
    }
}
