...
public final class IndustryListActivity extends BaseActivity implements View.OnClickListener, IndustryAddView {
    ...
    public final class IndustrysAdapte extends RecyclerView.Adapter<ListHolder> {
        ...
        public final class ListHolder extends RecyclerView.ViewHolder {
            ...
            public ListHolder(@i.c.a.d IndustrysAdapte industrysAdapte, View view) {
                ...
                h.q2.t.i0.a((Object) findViewById, "itemView.findViewById(R.id.content)");
                this.f18259a = (TextView) findViewById;
                View findViewById2 = view.findViewById(R.id.iv_select);
                h.q2.t.i0.a((Object) findViewById2, "itemView.findViewById(R.id.iv_select)");
                this.f18260b = (ImageView) findViewById2;
            }
        ...
        public void onBindViewHolder(@i.c.a.d ListHolder listHolder, int i2) {
            ...
            TextView b2 = listHolder.b();
            if (b2 != null) {
                Object obj = this.f18258b.industrys.get(i2);
                h.q2.t.i0.a(obj, "industrys.get(position)");
                b2.setText(((InDustryBean) obj).getPositionName());
            }
            ...
            if (num != null && positionId == num.intValue()) {
                TextView b3 = listHolder.b();
                if (b3 != null) {
                    b3.setTextColor(Color.parseColor("#2B4CFF"));
                }
                ImageView a2 = listHolder.a();
                if (a2 == null) {
                    h.q2.t.i0.f();
                }
                a2.setVisibility(0);
            } else {
                TextView b4 = listHolder.b();
                if (b4 != null) {
                    b4.setTextColor(Color.parseColor("#000000"));
                }
                ImageView a3 = listHolder.a();
                if (a3 == null) {
                    h.q2.t.i0.f();
                }
                a3.setVisibility(8);
        ...
        public ListHolder onCreateViewHolder(@i.c.a.d ViewGroup viewGroup, int i2) {
            ...
            View inflate = LayoutInflater.from(this.f18257a).inflate(R.layout.item_industry, viewGroup, false);
            h.q2.t.i0.a((Object) inflate, "LayoutInflater.from(cont…_industry, parent, false)");
    ...
    public final void initView() {
        ...
        h.q2.t.i0.a((Object) findViewById3, "findViewById(R.id.tv_right)");
        this.mTvRight = (TextView) findViewById3;
        View findViewById4 = findViewById(R.id.rv_List);
        h.q2.t.i0.a((Object) findViewById4, "findViewById(R.id.rv_List)");
