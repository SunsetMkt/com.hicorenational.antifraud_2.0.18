...
public class EvidenceDiscActivity_ViewBinding implements Unbinder {
    ...
    public EvidenceDiscActivity_ViewBinding(EvidenceDiscActivity evidenceDiscActivity, View view) {
        ...
        evidenceDiscActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18119b = findRequiredView;
        findRequiredView.setOnClickListener(new a(evidenceDiscActivity));
        ...
        evidenceDiscActivity.mBtnCommit = (Button) Utils.castView(findRequiredView2, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18120c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(evidenceDiscActivity));
    }
}
