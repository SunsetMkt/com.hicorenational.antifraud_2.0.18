...
public class AudioActivity extends BaseUploadActivity implements BaseQuickAdapter.i, MediaPlayer.OnCompletionListener {
    ...
    class b implements PermissionsListener {
        ...
        public void onGranted() {
            k.e.a(AudioActivity.this.mActivity, 200L, PictureMimeType.ofAudio(), AudioActivity.this.mMaxSelectNum - AudioActivity.this.mLocalMedia.size()).forResult(PictureConfig.CHOOSE_REQUEST);
        }
    }
    ...
    public void sendData() {
        org.greenrobot.eventbus.c.f().d(new util.n2.a(4, this.mLocalMedia, this.mUploadStateList));
    }
