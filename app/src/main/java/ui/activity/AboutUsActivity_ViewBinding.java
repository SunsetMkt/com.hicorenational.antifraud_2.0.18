...
public class AboutUsActivity_ViewBinding implements Unbinder {
    ...
    public AboutUsActivity_ViewBinding(AboutUsActivity aboutUsActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.check_upadte, "field 'mChenkBtn' and method 'onViewClicked'");
        aboutUsActivity.mChenkBtn = (Button) Utils.castView(findRequiredView, R.id.check_upadte, "field 'mChenkBtn'", Button.class);
        ...
        View findRequiredView4 = Utils.findRequiredView(view, R.id.ll_policy, "method 'onViewClicked'");
