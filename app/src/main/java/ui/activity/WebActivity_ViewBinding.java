...
public class WebActivity_ViewBinding implements Unbinder {
    ...
    public WebActivity_ViewBinding(WebActivity webActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.iv_back, "field 'mTIvBack' and method 'onViewClicked'");
        webActivity.mTIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mTIvBack'", ImageView.class);
        this.f19346b = findRequiredView;
        findRequiredView.setOnClickListener(new a(webActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_right, "field 'mTIvShare' and method 'onViewClicked'");
        webActivity.mTIvShare = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mTIvShare'", ImageView.class);
        this.f19347c = findRequiredView2;
        ...
        this.f19348d = findRequiredView3;
