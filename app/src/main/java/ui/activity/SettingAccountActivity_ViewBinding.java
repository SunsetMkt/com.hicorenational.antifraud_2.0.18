...
public class SettingAccountActivity_ViewBinding implements Unbinder {
    ...
    public SettingAccountActivity_ViewBinding(SettingAccountActivity settingAccountActivity, View view) {
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_ed_phone, "method 'onViewClicked'");
        this.f18877c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(settingAccountActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_ed_pwd, "method 'onViewClicked'");
        this.f18878d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(settingAccountActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.rl_logout_view, "method 'onViewClicked'");
