...
public final class ReportSuccessActivity_ViewBinding implements Unbinder {
    ...
    public ReportSuccessActivity_ViewBinding(ReportSuccessActivity reportSuccessActivity, View view) {
        ...
        reportSuccessActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18802b = findRequiredView;
        findRequiredView.setOnClickListener(new a(reportSuccessActivity));
        reportSuccessActivity.mTvTitle = (TextView) Utils.findRequiredViewAsType(view, R.id.tv_title, "field 'mTvTitle'", TextView.class);
        View findRequiredView2 = Utils.findRequiredView(view, R.id.fl_confirm, "method 'onClick'");
        this.f18803c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(reportSuccessActivity));
    }
}
