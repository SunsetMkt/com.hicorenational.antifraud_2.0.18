...
public class H5AppSelectedActivity extends BaseActivity {
    ...
    private void c() {
        ...
        new Thread(new Runnable() { // from class: ui.activity.s
            ...
            public final void run() {
                H5AppSelectedActivity.this.a(r1Var);
            }
        }).start();
    }
    ...
    public /* synthetic */ void a(util.r1 r1Var) {
        final List<AppInfoBean> a2 = util.r1.a(new String[]{util.r1.f20958d}, true);
        final List<AppInfoBean> a3 = r1Var.a();
        runOnUiThread(new Runnable() { // from class: ui.activity.t
            @Override // java.lang.Runnable
            public final void run() {
                H5AppSelectedActivity.this.a(a2, a3);
            }
        });
    }
