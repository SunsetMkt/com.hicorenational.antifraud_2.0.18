...
public class CaseActivity_ViewBinding implements Unbinder {
    ...
    public CaseActivity_ViewBinding(CaseActivity caseActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_tab_create, "field 'mTvTabCreate' and method 'onViewClicked'");
        caseActivity.mTvTabCreate = (TextView) Utils.castView(findRequiredView, R.id.tv_tab_create, "field 'mTvTabCreate'", TextView.class);
        this.f17830b = findRequiredView;
        findRequiredView.setOnClickListener(new a(caseActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_tab_history, "field 'mTvTabHistory' and method 'onViewClicked'");
        caseActivity.mTvTabHistory = (TextView) Utils.castView(findRequiredView2, R.id.tv_tab_history, "field 'mTvTabHistory'", TextView.class);
        this.f17831c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(caseActivity));
        ...
        caseActivity.mTvType = (TextView) Utils.castView(findRequiredView3, R.id.tv_type, "field 'mTvType'", TextView.class);
        this.f17832d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(caseActivity));
        ...
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_child_tab_wait, "field 'mTvChildTabWait' and method 'onViewClicked'");
        caseActivity.mTvChildTabWait = (TextView) Utils.castView(findRequiredView4, R.id.tv_child_tab_wait, "field 'mTvChildTabWait'", TextView.class);
        this.f17833e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(caseActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.tv_child_tab_over, "field 'mTvChildTabOver' and method 'onViewClicked'");
        caseActivity.mTvChildTabOver = (TextView) Utils.castView(findRequiredView5, R.id.tv_child_tab_over, "field 'mTvChildTabOver'", TextView.class);
        this.f17834f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(caseActivity));
