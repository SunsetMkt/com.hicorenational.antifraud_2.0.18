...
/* JADX INFO: compiled from: LogoutSuccActivity.kt */
...
public final class LogoutSuccActivity extends BaseActivity {
    ...
    public final void b() {
        if (AccountManager.getAccountInfo() != null) {
            ...
            i.q2.t.i0.a((Object) accountInfo, "AccountManager.getAccountInfo()");
    ...
    public void initPage() {
        ...
        i.q2.t.i0.a((Object) string, "resources.getString(R.string.succ_logout_tips)");
        Object[] objArr = {g2.l(AccountManager.getAccountPhone())};
        String str = String.format(string, Arrays.copyOf(objArr, objArr.length));
        i.q2.t.i0.a((Object) str, "java.lang.String.format(format, *args)");
