...
/* JADX INFO: compiled from: ManualAlreadyDetailActivity.kt */
...
public final class ManualAlreadyDetailActivity extends BaseActivity implements View.OnClickListener, ManualAlreadyDetailView {
    ...
    public void initPage() {
        ...
        long longExtra = getIntent().getLongExtra(util.p1.f15011c, -1L);
    ...
    public void onSuccess(@j.c.a.e CheckUserBean checkUserBean) {
    ...
    public final void setMPresenter(@j.c.a.e ManualAlreadyDetailPresenter manualAlreadyDetailPresenter) {
