...
public final class SignCommitAppActivity_ViewBinding implements Unbinder {
    ...
    public SignCommitAppActivity_ViewBinding(SignCommitAppActivity signCommitAppActivity, View view) {
        ...
        signCommitAppActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18931b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signCommitAppActivity));
