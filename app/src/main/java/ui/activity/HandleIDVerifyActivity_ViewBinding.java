...
public class HandleIDVerifyActivity_ViewBinding implements Unbinder {
    ...
    public HandleIDVerifyActivity_ViewBinding(HandleIDVerifyActivity handleIDVerifyActivity, View view) {
        ...
        handleIDVerifyActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18213b = findRequiredView;
        findRequiredView.setOnClickListener(new a(handleIDVerifyActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.btn_idvrfy_start, "field 'mConfirm' and method 'onViewClicked'");
        handleIDVerifyActivity.mConfirm = (Button) Utils.castView(findRequiredView2, R.id.btn_idvrfy_start, "field 'mConfirm'", Button.class);
        this.f18214c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(handleIDVerifyActivity));
