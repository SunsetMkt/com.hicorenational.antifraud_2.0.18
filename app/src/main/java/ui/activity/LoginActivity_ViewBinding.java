...
public class LoginActivity_ViewBinding implements Unbinder {
    ...
    public LoginActivity_ViewBinding(LoginActivity loginActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.iv_clear, "field 'mIvClean' and method 'onViewClicked'");
        loginActivity.mIvClean = (ImageView) Utils.castView(findRequiredView, R.id.iv_clear, "field 'mIvClean'", ImageView.class);
        ...
        loginActivity.mConfirm = (TextView) Utils.castView(findRequiredView2, R.id.confirm, "field 'mConfirm'", TextView.class);
        this.f18276c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(loginActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.login_change, "field 'mLoginChange' and method 'onViewClicked'");
        loginActivity.mLoginChange = (TextView) Utils.castView(findRequiredView3, R.id.login_change, "field 'mLoginChange'", TextView.class);
        this.f18277d = findRequiredView3;
        ...
        View findRequiredView4 = Utils.findRequiredView(view, R.id.forget_pwd, "field 'mForgetPwd' and method 'onViewClicked'");
        loginActivity.mForgetPwd = (TextView) Utils.castView(findRequiredView4, R.id.forget_pwd, "field 'mForgetPwd'", TextView.class);
        this.f18278e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(loginActivity));
        loginActivity.mLineV = Utils.findRequiredView(view, R.id.line_v, "field 'mLineV'");
        View findRequiredView5 = Utils.findRequiredView(view, R.id.iv_wx_login, "method 'onViewClicked'");
        this.f18279f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(loginActivity));
        View findRequiredView6 = Utils.findRequiredView(view, R.id.iv_qq_login, "method 'onViewClicked'");
        this.f18280g = findRequiredView6;
        findRequiredView6.setOnClickListener(new f(loginActivity));
        View findRequiredView7 = Utils.findRequiredView(view, R.id.iv_sina_login, "method 'onViewClicked'");
        this.f18281h = findRequiredView7;
