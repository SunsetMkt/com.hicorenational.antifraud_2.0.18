...
/* JADX INFO: compiled from: ReChargeActivity.kt */
...
public final class ReChargeActivity extends BaseActivity implements RechargeView {
    ...
    public static final class a implements IClickListener {
        ...
        public void cancelBtn() {
            ...
            if (rechargePresenter != null) {
                ...
                RechargeBean rechargeBean = arrayList != null ? (RechargeBean) arrayList.get(this.f13611b) : null;
                i.q2.t.i0.a((Object) rechargeBean, "arrayListBean?.get(itemPos)");
                rechargePresenter.deleteRecharge(str, rechargeBean.getChargeTelInfoID(), this.f13611b);
            }
        }
    ...
    public void onItemDelet(int i2) {
        util.f1.b(this.mActivity, "\u5220\u9664\u5f53\u524d\u5145\u503c\u7c7b\u4fe1\u606f\uff1f", "", "\u786e\u5b9a", "\u53d6\u6d88", new a(i2));
    }
