...
public class CriminalSmsAddActivity extends BaseActivity implements CriminalSmsAddCallView {
    ...
    class b implements PermissionsListener {
        ...
        public void onGranted() {
            k.e.a(CriminalSmsAddActivity.this.mActivity, 200L, PictureMimeType.ofImage(), 6 - CriminalSmsAddActivity.this.mLocalMedia.size()).forResult(PictureConfig.CHOOSE_REQUEST);
        }
    }
    ...
    private void brandDialog(i.b<BrandBean> bVar) {
        y1.a(this.mActivity, this.mBrandStrList, new c(bVar));
    }
    ...
    public void pickData(TextView textView) {
        y1.a(this.mActivity, this.strs, new a(textView));
    }
