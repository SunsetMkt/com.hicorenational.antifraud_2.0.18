...
public class MinePersonalActivity_ViewBinding implements Unbinder {
    ...
    public MinePersonalActivity_ViewBinding(MinePersonalActivity minePersonalActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_idfine_var, "field 'mTvIdFineVar' and method 'onViewClicked'");
        minePersonalActivity.mTvIdFineVar = (TextView) Utils.castView(findRequiredView, R.id.tv_idfine_var, "field 'mTvIdFineVar'", TextView.class);
        this.f18400b = findRequiredView;
        findRequiredView.setOnClickListener(new a(minePersonalActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.area, "field 'mArea' and method 'onViewClicked'");
        minePersonalActivity.mArea = (TextView) Utils.castView(findRequiredView2, R.id.area, "field 'mArea'", TextView.class);
        this.f18401c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(minePersonalActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.area_detail, "field 'mAreaDetail' and method 'onViewClicked'");
        minePersonalActivity.mAreaDetail = (TextView) Utils.castView(findRequiredView3, R.id.area_detail, "field 'mAreaDetail'", TextView.class);
        this.f18402d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(minePersonalActivity));
        ...
        this.f18403e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(minePersonalActivity));
    }
}
