...
public final class SignRelationDetialActivity_ViewBinding implements Unbinder {
    private SignRelationDetialActivity a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private View f13830b;

    class a extends DebouncingOnClickListener {
        final /* synthetic */ SignRelationDetialActivity a;

        a(SignRelationDetialActivity signRelationDetialActivity) {
            this.a = signRelationDetialActivity;
        }
    ...
    public void unbind() {
        SignRelationDetialActivity signRelationDetialActivity = this.a;
    ...
    public SignRelationDetialActivity_ViewBinding(SignRelationDetialActivity signRelationDetialActivity, View view) {
        ...
        this.f13830b = viewFindRequiredView;
