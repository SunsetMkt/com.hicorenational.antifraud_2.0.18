...
public class IDVarfySuccessActivity_ViewBinding implements Unbinder {
    private IDVarfySuccessActivity a;
    ...
    class a extends DebouncingOnClickListener {
        final /* synthetic */ IDVarfySuccessActivity a;

        a(IDVarfySuccessActivity iDVarfySuccessActivity) {
            this.a = iDVarfySuccessActivity;
        }
    ...
    @CallSuper
    public void unbind() {
        IDVarfySuccessActivity iDVarfySuccessActivity = this.a;
    ...
    public IDVarfySuccessActivity_ViewBinding(IDVarfySuccessActivity iDVarfySuccessActivity, View view) {
        ...
        this.f13428b = viewFindRequiredView;
        ...
        this.f13429c = viewFindRequiredView2;
