...
public class IDVarfySuccessActivity_ViewBinding implements Unbinder {
    ...
    public IDVarfySuccessActivity_ViewBinding(IDVarfySuccessActivity iDVarfySuccessActivity, View view) {
        ...
        iDVarfySuccessActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18251b = findRequiredView;
        findRequiredView.setOnClickListener(new a(iDVarfySuccessActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.btn_idvrfy_start, "method 'onViewClicked'");
        this.f18252c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(iDVarfySuccessActivity));
    }
}
