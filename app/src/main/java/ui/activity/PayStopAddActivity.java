    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.btn_commit /* 2131296395 */:
                ...
                if (!TextUtils.isEmpty(this.f18438a) && !TextUtils.isEmpty(trim) && !TextUtils.isEmpty(trim2) && !TextUtils.isEmpty(trim3) && !TextUtils.isEmpty(trim4) && !TextUtils.isEmpty(trim5)) {
                    ...
                    this.f18439b.setSuspectAccountTypeText(trim);
                    this.f18439b.setSuspectName(trim2);
                    this.f18439b.setSuspectAccount(trim3);
                    this.f18439b.setPaymentTime(trim4);
                    this.f18439b.setTransferAmount(a(trim5));
