...
public class ResetPhoneNumActivity_ViewBinding implements Unbinder {
    ...
    public ResetPhoneNumActivity_ViewBinding(ResetPhoneNumActivity resetPhoneNumActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.confirm, "field 'mConfim' and method 'onViewClicked'");
        resetPhoneNumActivity.mConfim = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mConfim'", TextView.class);
        this.f18848b = findRequiredView;
        findRequiredView.setOnClickListener(new a(resetPhoneNumActivity));
        ...
        resetPhoneNumActivity.mIvClean = (ImageView) Utils.castView(findRequiredView2, R.id.iv_clear, "field 'mIvClean'", ImageView.class);
        this.f18849c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(resetPhoneNumActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18850d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(resetPhoneNumActivity));
    }
}
