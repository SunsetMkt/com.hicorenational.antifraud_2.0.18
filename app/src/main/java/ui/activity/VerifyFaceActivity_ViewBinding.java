...
public class VerifyFaceActivity_ViewBinding implements Unbinder {
    ...
    public VerifyFaceActivity_ViewBinding(VerifyFaceActivity verifyFaceActivity, View view) {
        ...
        verifyFaceActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        ...
        verifyFaceActivity.mTvRight = (TextView) Utils.castView(findRequiredView2, R.id.tv_right, "field 'mTvRight'", TextView.class);
        this.f19176c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(verifyFaceActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_card_type, "field 'mTvCardType' and method 'onViewClicked'");
        verifyFaceActivity.mTvCardType = (TextView) Utils.castView(findRequiredView3, R.id.tv_card_type, "field 'mTvCardType'", TextView.class);
        ...
        verifyFaceActivity.mConfirm = (TextView) Utils.castView(findRequiredView4, R.id.confirm, "field 'mConfirm'", TextView.class);
