...
/* JADX INFO: compiled from: RechargeAddActivity.kt */
...
public final class RechargeAddActivity extends BaseActivity implements RechargeView {
    ...
    public static final class c extends h.a {
        ...
        final /* synthetic */ TextView f13618b;
        ...
        public void b(int i2, @j.c.a.d String str) {
            ...
            if (i.q2.t.i0.a((Object) rechargePlatBean.getEx(), (Object) "1")) {
    ...
    private final void showPlatPiker(TextView textView) {
        ...
        c.a.a.e.h hVar = new c.a.a.e.h(this.mActivity, this.pickTypes);
        hVar.x(3);
        hVar.E(0);
        hVar.C(15);
    ...
    public void onSuccessPlatList(@j.c.a.d List<? extends RechargePlatBean> list) {
        ...
        if (list.size() > 0) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (i.q2.t.i0.a((Object) platform, (Object) (rechargeBean != null ? rechargeBean.getPlatform() : null))) {
                    if (i.q2.t.i0.a((Object) list.get(i2).getEx(), (Object) "1")) {
    ...
    */
        ...
        switch (view.getId()) {
            case R.id.btn_confirm /* 2131296408 */:
                ...
                if (string.length() == 0) {
                    ...
                    if (!i.q2.t.i0.a((Object) string3, (Object) AccountManager.getVisiblePhone())) {
                        saveHttpApi();
                    } else {
                        util.f1.a(this.mActivity, "\u6dfb\u52a0\u7684\u5145\u503c\u624b\u673a\u53f7\u7801\u662f\u60a8\u7684\u767b\u5f55\u53f7\u7801\uff0c\u786e\u5b9a\u6dfb\u52a0\u4e2a\u4eba\u53f7\u7801\u4e3a\u8bc8\u9a97\u53f7\u7801?", "", "\u53d6\u6d88", "\u786e\u5b9a", -1, -1, (IClickListener) new a());
                    }
                } else {
                    e2.a("\u8bf7\u9009\u62e9\u5145\u503c\u65f6\u95f4");
                }
                break;
            case R.id.et_recharge_plat /* 2131296615 */:
            ...
            case R.id.iv_back /* 2131296808 */:
                onkeyback();
                break;
            case R.id.tv_recharge_time /* 2131297834 */:
    ...
    public final void setMLlOtherPlatName(@j.c.a.d View view) {
