...
public class CheckFraudResultActivity_ViewBinding implements Unbinder {
    ...
    public CheckFraudResultActivity_ViewBinding(CheckFraudResultActivity checkFraudResultActivity, View view) {
        ...
        checkFraudResultActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17954b = findRequiredView;
        findRequiredView.setOnClickListener(new a(checkFraudResultActivity));
        ...
        checkFraudResultActivity.mIvRight = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f17955c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(checkFraudResultActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_appeal, "field 'mTvAppeal' and method 'onViewClicked'");
        checkFraudResultActivity.mTvAppeal = (TextView) Utils.castView(findRequiredView3, R.id.tv_appeal, "field 'mTvAppeal'", TextView.class);
        this.f17956d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(checkFraudResultActivity));
        ...
        this.f17957e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(checkFraudResultActivity));
    }
}
