...
/* JADX INFO: compiled from: ManualActivity.kt */
...
public final class ManualActivity extends BaseActivity implements View.OnClickListener, ManualView {
    ...
    public final void initListener() {
        ...
        if (editText == null) {
            i.q2.t.i0.k("mEtCheckInfo");
        }
        util.h1.a(editText, new a());
    }
    ...
    public void onSuccess(@j.c.a.d CheckUserBean checkUserBean) {
        i.q2.t.i0.f(checkUserBean, "bean");
        if (checkUserBean.getAuditStatus() == Integer.parseInt("1")) {
            util.f1.a(this.mActivity, "\u63d0\u793a", "\u8be5\u7528\u6237\u5df2\u901a\u8fc7\u8ba4\u8bc1\u5ba1\u6838", "\u786e\u5b9a", (IOneClickListener) null);
        } else {
            ...
            intent.putExtra(util.p1.f15011c, checkUserBean);
            startActivity(intent);
        }
    }

    @Override // ui.callview.ManualView
    public void onfail(@j.c.a.d String str) {
        i.q2.t.i0.f(str, "msg");
        util.f1.a(this.mActivity, "\u672a\u627e\u5230\u8be5\u7528\u6237", "\u8bf7\u786e\u8ba4\u7528\u6237\u662f\u5426\u6210\u529f\u63d0\u4ea4\u4eba\u5de5\u5ba1\u6838", "\u786e\u5b9a", (IOneClickListener) null);
    }
    ...
    public final void setMPresenter(@j.c.a.e ManualPresenter manualPresenter) {
