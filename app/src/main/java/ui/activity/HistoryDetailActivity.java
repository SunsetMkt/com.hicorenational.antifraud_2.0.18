...
public class HistoryDetailActivity extends BaseActivity implements HistoryDetailCallView {
    ...
    private void getIntentData() {
        try {
            this.pageType = getIntent().getIntExtra(util.p1.C, 0);
            this.rowsBean = (HistoryListInfo.RowsBean) getIntent().getSerializableExtra(util.p1.B);
    ...
    public void initPage() {
        ...
        util.f1.a(this, 0, "110", getString(R.string.report_time_tips), "", "\u6211\u77e5\u9053\u4e86", (IOneClickListener) null);
    ...
    public int setLayoutView() {
        return e.a.k() ? R.layout.activity_history_detail_local : R.layout.activity_history_detail;
    }
}
