...
public class VideoActivity extends BaseUploadActivity implements PictureSelectAdapter.b, BaseQuickAdapter.i {
    ...
    class a implements PermissionsListener {
        ...
        public void onGranted() {
            k.e.a(VideoActivity.this.mActivity, 200L, PictureMimeType.ofVideo(), VideoActivity.this.mMaxSelectNum - VideoActivity.this.mLocalMedia.size()).forResult(PictureConfig.CHOOSE_REQUEST);
        }
    }
    ...
    private void stopPlayVedio(int i2) {
        try {
            ((JzvdStd) this.mAdapter.a(i2, R.id.image_view)).onStateNormal();
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
    ...
    public void onActivityResult(int i2, int i3, Intent intent) {
        ...
        deleteDoubleElement(this.mLocalMedia, g2.a(listObtainMultipleResult), null);
    ...
    public void sendData() {
        org.greenrobot.eventbus.c.f().d(new util.n2.a(7, this.mLocalMedia, this.mUploadStateList));
    }
