...
public class CriminalSmsSelectActivity_ViewBinding implements Unbinder {
    ...
    public CriminalSmsSelectActivity_ViewBinding(CriminalSmsSelectActivity criminalSmsSelectActivity, View view) {
        ...
        criminalSmsSelectActivity.mBtnCommit = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mBtnCommit'", TextView.class);
        this.f18043b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalSmsSelectActivity));
        ...
        criminalSmsSelectActivity.mTvTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_time, "field 'mTvTime'", TextView.class);
        this.f18044c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(criminalSmsSelectActivity));
        ...
        this.f18045d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(criminalSmsSelectActivity));
    }
}
