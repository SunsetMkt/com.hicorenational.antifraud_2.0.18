...
public class AppSelectedActivity_ViewBinding implements Unbinder {
    ...
    public AppSelectedActivity_ViewBinding(AppSelectedActivity appSelectedActivity, View view) {
        ...
        appSelectedActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17666b = findRequiredView;
        findRequiredView.setOnClickListener(new a(appSelectedActivity));
        ...
        appSelectedActivity.mIvRight = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f17667c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(appSelectedActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.btn_report, "field 'mBtnReport' and method 'onViewClicked'");
        appSelectedActivity.mBtnReport = (Button) Utils.castView(findRequiredView3, R.id.btn_report, "field 'mBtnReport'", Button.class);
        this.f17668d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(appSelectedActivity));
    }
}
