...
public class RegisterActivity_ViewBinding implements Unbinder {
    ...
    public RegisterActivity_ViewBinding(RegisterActivity registerActivity, View view) {
        ...
        registerActivity.mConfirm = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mConfirm'", TextView.class);
        this.f18628b = findRequiredView;
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_clear, "field 'mIvClean' and method 'onViewClicked'");
        registerActivity.mIvClean = (ImageView) Utils.castView(findRequiredView2, R.id.iv_clear, "field 'mIvClean'", ImageView.class);
        this.f18629c = findRequiredView2;
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_clear_account, "field 'mIvClearAccount' and method 'onViewClicked'");
        registerActivity.mIvClearAccount = (ImageView) Utils.castView(findRequiredView3, R.id.iv_clear_account, "field 'mIvClearAccount'", ImageView.class);
        this.f18630d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(registerActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_resend, "field 'mTvResend' and method 'onViewClicked'");
        registerActivity.mTvResend = (CodeCutTimeTextView) Utils.castView(findRequiredView4, R.id.tv_resend, "field 'mTvResend'", CodeCutTimeTextView.class);
        this.f18631e = findRequiredView4;
        ...
        View findRequiredView5 = Utils.findRequiredView(view, R.id.ll_to_login, "field 'mLlToLogin' and method 'onViewClicked'");
        registerActivity.mLlToLogin = (LinearLayout) Utils.castView(findRequiredView5, R.id.ll_to_login, "field 'mLlToLogin'", LinearLayout.class);
        this.f18632f = findRequiredView5;
