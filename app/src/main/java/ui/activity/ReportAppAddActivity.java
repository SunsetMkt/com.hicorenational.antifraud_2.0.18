...
public final class ReportAppAddActivity extends BaseActivity implements View.OnClickListener, ReportAppView {
    ...
    public final void initViewData() {
        ...
        if (TextUtils.isEmpty(surveyAppBean != null ? surveyAppBean.getPackageFileUrl() : null)) {
            ...
            Bitmap a2 = j.c.a(appName, surveyAppBean8 != null ? surveyAppBean8.getAppVersion() : null, j.c.f17008f);
            ImageView imageView = this.mIvAppIcon;
            if (imageView == null) {
                h.q2.t.i0.k("mIvAppIcon");
            }
    ...
    public void onActivityResult(int i2, int i3, @i.c.a.e Intent intent) {
        ...
        if (Build.VERSION.SDK_INT > 28) {
            y1.a(this.mActivity, (List<LocalMedia>) obtainMultipleResult);
        }
        List<LocalMedia> a2 = y1.a((List<LocalMedia>) obtainMultipleResult);
        if (this.imgType == 1) {
            this.mediaPic = a2.get(0);
            ImageView imageView = this.mIvAppZxingPic;
            if (imageView == null) {
                h.q2.t.i0.k("mIvAppZxingPic");
            }
    ...
    public final void onEventMainThread(@i.c.a.d util.c2.a aVar) {
        ...
        if (this.appInfo != null) {
            ...
            Bitmap a2 = j.c.a(appInfoBean5 != null ? appInfoBean5.getAppIcon() : null);
            ...
            j.c.a(a2, name, appInfoBean7 != null ? appInfoBean7.getVersionCode() : null, j.c.f17008f);
