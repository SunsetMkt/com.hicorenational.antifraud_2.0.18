    ...
    public void sendWebMsg(util.d2.a aVar) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(b3)) {
                ...
                intent.putExtra(util.k1.P, charSequence);
                intent.putExtra(util.k1.Q, b3);
                intent.putExtra(util.k1.T, b2);
            ...
            } else if (TextUtils.equals("yes", b4)) {
                this.mHandler.sendEmptyMessage(6);
