...
public final class RelationAddActivity_ViewBinding implements Unbinder {
    ...
    public RelationAddActivity_ViewBinding(RelationAddActivity relationAddActivity, View view) {
        ...
        this.f18661b = findRequiredView;
        findRequiredView.setOnClickListener(new a(relationAddActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.btn_commit, "method 'onViewClicked'");
        this.f18662c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(relationAddActivity));
    }
}
