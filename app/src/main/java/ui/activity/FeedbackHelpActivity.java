...
public class FeedbackHelpActivity extends BaseActivity implements FeedbackHelpCallView {
    ...
    class a implements View.OnClickListener {
        ...
        public void onClick(View view) {
            FeedbackHelpActivity.this.intentDetail(this.a);
        }
    }
    ...
    class d implements View.OnClickListener {
        ...
        final /* synthetic */ ImageView f13376b;

        d(LinearLayout linearLayout, ImageView imageView) {
            this.a = linearLayout;
            this.f13376b = imageView;
        }
        ...
        public void onClick(View view) {
            if (this.a.getVisibility() == 8) {
                ...
                AnimUtils.rotateArrowUpOrDown(this.f13376b, false);
            } else {
                this.a.setVisibility(8);
                AnimUtils.rotateArrowUpOrDown(this.f13376b, true);
            }
        }
    }
