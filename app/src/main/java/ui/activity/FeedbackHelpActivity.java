...
public class FeedbackHelpActivity extends BaseActivity implements FeedbackHelpCallView {
    ...
    private void addView(QATypeBean qATypeBean, boolean z) throws Exception {
        ...
        ImageView imageView = (ImageView) inflate.findViewById(R.id.iv_type_arrow);
        TextView textView2 = (TextView) inflate.findViewById(R.id.tv_content_1);
        View findViewById = inflate.findViewById(R.id.inc_content_2);
        int i2 = R.id.tv_content;
        TextView textView3 = (TextView) findViewById.findViewById(R.id.tv_content);
        LinearLayout linearLayout2 = (LinearLayout) inflate.findViewById(R.id.tv_content_more);
        View findViewById2 = inflate.findViewById(R.id.botton_line);
        if (qATypeBean.getQaList() != null && qATypeBean.getQaList().size() > 0) {
            ...
            while (i3 < qATypeBean.getQaList().size()) {
                ...
                if (i3 == 0) {
                    ...
                    View inflate2 = View.inflate(this, R.layout.layout_qa, viewGroup);
