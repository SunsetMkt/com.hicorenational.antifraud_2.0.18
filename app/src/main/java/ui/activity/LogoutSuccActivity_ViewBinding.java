...
public final class LogoutSuccActivity_ViewBinding implements Unbinder {
    ...
    public LogoutSuccActivity_ViewBinding(LogoutSuccActivity logoutSuccActivity, View view) {
        ...
        logoutSuccActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18343b = findRequiredView;
        findRequiredView.setOnClickListener(new a(logoutSuccActivity));
        ...
        findRequiredView2.setOnClickListener(new b(logoutSuccActivity));
    }
}
