...
public final class CriminalCallAddActivity_ViewBinding implements Unbinder {
    ...
    public CriminalCallAddActivity_ViewBinding(CriminalCallAddActivity criminalCallAddActivity, View view) {
        ...
        criminalCallAddActivity.mBtnConfirm = (Button) Utils.castView(findRequiredView, R.id.btn_confirm, "field 'mBtnConfirm'", Button.class);
        this.f17988b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalCallAddActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_occur_time, "field 'mTvOccurTime' and method 'onViewClicked'");
        criminalCallAddActivity.mTvOccurTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_occur_time, "field 'mTvOccurTime'", TextView.class);
        this.f17989c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(criminalCallAddActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_duration, "field 'mTvDuration' and method 'onViewClicked'");
        criminalCallAddActivity.mTvDuration = (TextView) Utils.castView(findRequiredView3, R.id.tv_duration, "field 'mTvDuration'", TextView.class);
        this.f17990d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(criminalCallAddActivity));
        ...
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_audio_num, "field 'mAudioNum' and method 'onViewClicked'");
        criminalCallAddActivity.mAudioNum = (TextView) Utils.castView(findRequiredView4, R.id.tv_audio_num, "field 'mAudioNum'", TextView.class);
        this.f17991e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(criminalCallAddActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f17992f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(criminalCallAddActivity));
    }
}
