...
public final class RechargeAddActivity_ViewBinding implements Unbinder {
    ...
    public RechargeAddActivity_ViewBinding(RechargeAddActivity rechargeAddActivity, View view) {
        ...
        rechargeAddActivity.mBtnConfirm = (Button) Utils.castView(findRequiredView, R.id.btn_confirm, "field 'mBtnConfirm'", Button.class);
        this.f18604b = findRequiredView;
        findRequiredView.setOnClickListener(new a(rechargeAddActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.et_recharge_plat, "field 'mEtRechargePlat' and method 'onViewClicked'");
        rechargeAddActivity.mEtRechargePlat = (TextView) Utils.castView(findRequiredView2, R.id.et_recharge_plat, "field 'mEtRechargePlat'", TextView.class);
        this.f18605c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(rechargeAddActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_recharge_time, "field 'mEtRechargeTime' and method 'onViewClicked'");
        rechargeAddActivity.mEtRechargeTime = (TextView) Utils.castView(findRequiredView3, R.id.tv_recharge_time, "field 'mEtRechargeTime'", TextView.class);
        this.f18606d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(rechargeAddActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18607e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(rechargeAddActivity));
    }
}
