...
public class ResetPwdActivity extends BaseActivity implements ResetPwdView {
    ...
    private void initListener() {
        util.h1.a(this.mPhoneCode, new IEditAfterListener() { // from class: ui.activity.d1
    ...
    public void onSuccRequest(int i2) {
        ...
        intent.putExtra(util.p1.H, util.p1.J);
    ...
    public void onViewClicked(View view) {
        ...
        } else if (g2.a(util.u1.v, true)) {
            toYanzheng(new IOneClickListener() { // from class: ui.activity.c1
