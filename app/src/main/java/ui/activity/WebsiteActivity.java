...
public class WebsiteActivity extends BaseActivity {
    ...
    private void c() {
        ...
        List<SmsBean> a2 = SmsRecordSelectActivity.a((Activity) this, true);
    ...
    private List<String> d() {
        ...
        for (int i2 = 0; i2 < this.f19368a.size(); i2++) {
            String trim = this.f19368a.get(i2).getText().toString().trim();
    ...
    private void a(String str) {
        View inflate = View.inflate(this.mActivity, R.layout.recyclerview_url_select, null);
