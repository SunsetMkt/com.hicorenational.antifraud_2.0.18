...
public class CheckIDActivity_ViewBinding implements Unbinder {
    ...
    public CheckIDActivity_ViewBinding(CheckIDActivity checkIDActivity, View view) {
        ...
        checkIDActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17969b = findRequiredView;
        findRequiredView.setOnClickListener(new a(checkIDActivity));
        checkIDActivity.mTvTitle = (TextView) Utils.findRequiredViewAsType(view, R.id.tv_title, "field 'mTvTitle'", TextView.class);
        View findRequiredView2 = Utils.findRequiredView(view, R.id.rl_acept_view, "field 'mRlAceptRead' and method 'onViewClicked'");
        checkIDActivity.mRlAceptRead = findRequiredView2;
        this.f17970c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(checkIDActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.btn_idvrfy_send, "field 'mIdVrfySend' and method 'onViewClicked'");
        checkIDActivity.mIdVrfySend = (Button) Utils.castView(findRequiredView3, R.id.btn_idvrfy_send, "field 'mIdVrfySend'", Button.class);
        this.f17971d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(checkIDActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.idvrfy_list, "field 'mIdVrfyList' and method 'onViewClicked'");
        checkIDActivity.mIdVrfyList = findRequiredView4;
        this.f17972e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(checkIDActivity));
