...
public final class ReportWebsiteAddActivity_ViewBinding implements Unbinder {
    ...
    public ReportWebsiteAddActivity_ViewBinding(ReportWebsiteAddActivity reportWebsiteAddActivity, View view) {
        ...
        reportWebsiteAddActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18823b = findRequiredView;
        findRequiredView.setOnClickListener(new a(reportWebsiteAddActivity));
        ...
        reportWebsiteAddActivity.mBtnCommit = (Button) Utils.castView(findRequiredView2, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18824c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(reportWebsiteAddActivity));
