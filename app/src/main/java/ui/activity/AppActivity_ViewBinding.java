...
public class AppActivity_ViewBinding implements Unbinder {
    ...
    public AppActivity_ViewBinding(AppActivity appActivity, View view) {
        ...
        appActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f17642b = findRequiredView;
        findRequiredView.setOnClickListener(new a(appActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f17643c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(appActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.ll_select, "method 'onViewClicked'");
        this.f17644d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(appActivity));
    }
}
