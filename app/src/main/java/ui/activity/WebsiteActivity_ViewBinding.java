...
public class WebsiteActivity_ViewBinding implements Unbinder {
    ...
    public WebsiteActivity_ViewBinding(WebsiteActivity websiteActivity, View view) {
        ...
        websiteActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f19374b = findRequiredView;
        findRequiredView.setOnClickListener(new a(websiteActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.fl_select_history, "field 'mTvSelectHistory' and method 'onViewClicked'");
        websiteActivity.mTvSelectHistory = findRequiredView2;
        this.f19375c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(websiteActivity));
        ...
        websiteActivity.mBtnCommit = (Button) Utils.castView(findRequiredView3, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f19376d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(websiteActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.fl_select, "method 'onViewClicked'");
        this.f19377e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(websiteActivity));
    }
}
