...
public final class ReportWebsiteActivity_ViewBinding implements Unbinder {
    ...
    public ReportWebsiteActivity_ViewBinding(ReportWebsiteActivity reportWebsiteActivity, View view) {
        ...
        reportWebsiteActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18811b = findRequiredView;
        findRequiredView.setOnClickListener(new a(reportWebsiteActivity));
        reportWebsiteActivity.mTvTitle = (TextView) Utils.findRequiredViewAsType(view, R.id.tv_title, "field 'mTvTitle'", TextView.class);
        View findRequiredView2 = Utils.findRequiredView(view, R.id.ll_add, "field 'mLlAddLayout' and method 'onClick'");
        reportWebsiteActivity.mLlAddLayout = findRequiredView2;
        this.f18812c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(reportWebsiteActivity));
