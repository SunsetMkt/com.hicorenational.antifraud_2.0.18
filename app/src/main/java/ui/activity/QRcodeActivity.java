...
public class QRcodeActivity extends BaseActivity {
    ...
    class a implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            Bitmap decodeResource = BitmapFactory.decodeResource(QRcodeActivity.this.getResources(), R.mipmap.ic_police_logo);
            int a2 = util.c1.a(QRcodeActivity.this, 240.0f);
            Bitmap a3 = util.e1.a(this.f18578a, a2, a2, decodeResource);
            ImageView imageView = QRcodeActivity.this.mIvQrcode;
            if (imageView != null) {
                imageView.post(new RunnableC0285a(a3));
            }
        }
    }
