...
public class IDVarfyFaceActivity_ViewBinding implements Unbinder {
    ...
    public IDVarfyFaceActivity_ViewBinding(IDVarfyFaceActivity iDVarfyFaceActivity, View view) {
        ...
        iDVarfyFaceActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18239b = findRequiredView;
        findRequiredView.setOnClickListener(new a(iDVarfyFaceActivity));
        iDVarfyFaceActivity.mTvTitle = (TextView) Utils.findRequiredViewAsType(view, R.id.tv_title, "field 'mTvTitle'", TextView.class);
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_firm, "method 'onViewClicked'");
        this.f18240c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(iDVarfyFaceActivity));
    }
}
