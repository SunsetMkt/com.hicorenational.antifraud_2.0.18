...
public class WarnActivity_ViewBinding implements Unbinder {
    ...
    public WarnActivity_ViewBinding(WarnActivity warnActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_dialog_phone, "field 'mTvAppVersion' and method 'onViewClicked'");
        warnActivity.mTvAppVersion = (TextView) Utils.castView(findRequiredView, R.id.tv_dialog_phone, "field 'mTvAppVersion'", TextView.class);
        this.f19267b = findRequiredView;
        findRequiredView.setOnClickListener(new a(warnActivity));
    }
}
