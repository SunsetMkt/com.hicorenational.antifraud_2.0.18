...
public final class SignDeliveryActivity_ViewBinding implements Unbinder {
    ...
    public SignDeliveryActivity_ViewBinding(SignDeliveryActivity signDeliveryActivity, View view) {
        ...
        signDeliveryActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18954b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signDeliveryActivity));
