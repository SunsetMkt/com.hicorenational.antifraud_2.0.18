...
public final class SignWebsitDetialActivity_ViewBinding implements Unbinder {
    ...
    public SignWebsitDetialActivity_ViewBinding(SignWebsitDetialActivity signWebsitDetialActivity, View view) {
        ...
        signWebsitDetialActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18987b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signWebsitDetialActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_websit_copy, "method 'onClick'");
        this.f18988c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(signWebsitDetialActivity));
    }
}
