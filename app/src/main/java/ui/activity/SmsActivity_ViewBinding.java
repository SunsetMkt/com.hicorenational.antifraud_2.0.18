...
public class SmsActivity_ViewBinding implements Unbinder {
    ...
    public SmsActivity_ViewBinding(SmsActivity smsActivity, View view) {
        ...
        smsActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f19001b = findRequiredView;
        ...
        this.f19002c = findRequiredView2;
        ...
        this.f19003d = findRequiredView3;
        ...
        this.f19004e = findRequiredView4;
