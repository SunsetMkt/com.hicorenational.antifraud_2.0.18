...
public class MinePersonalActivity extends BaseActivity implements MinePersonalView {
    ...
    public void onBackPressed() {
        ...
        if (this.pageType == 1) {
            ...
            org.greenrobot.eventbus.c.f().d(new util.n2.a(util.n2.a.u0, null));
        }
    }
    ...
    public void onSuccess(CheckUserBean checkUserBean) {
        ...
        util.f1.b(this.mActivity, "\u5b9e\u540d\u8ba4\u8bc1\u672a\u901a\u8fc7", "\u672a\u901a\u8fc7\u539f\u56e0\uff1a" + checkUserBean.getAuditMessage(), "\u6211\u77e5\u9053\u4e86", "\u91cd\u65b0\u9a8c\u8bc1", new a());
    }
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.area /* 2131296362 */:
                ...
                intent.putExtra(util.p1.f15011c, this.userInfo);
                intent.putExtra(util.p1.f15012d, 1);
                startActivity(intent);
                break;
            case R.id.area_detail /* 2131296363 */:
                Intent intent2 = new Intent(this.mActivity, (Class<?>) PersonalInfoAddActivity.class);
                intent2.putExtra(util.p1.f15011c, this.userInfo);
                intent2.putExtra(util.p1.f15012d, 11);
                startActivity(intent2);
                break;
            case R.id.iv_back /* 2131296808 */:
                onBackPressed();
                break;
            case R.id.tv_idfine_var /* 2131297734 */:
