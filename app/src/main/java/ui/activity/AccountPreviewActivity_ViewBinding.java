...
public class AccountPreviewActivity_ViewBinding implements Unbinder {
    private AccountPreviewActivity a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private View f13067b;

    class a extends DebouncingOnClickListener {
        final /* synthetic */ AccountPreviewActivity a;

        a(AccountPreviewActivity accountPreviewActivity) {
            this.a = accountPreviewActivity;
        }
    ...
    @CallSuper
    public void unbind() {
        AccountPreviewActivity accountPreviewActivity = this.a;
    ...
    public AccountPreviewActivity_ViewBinding(AccountPreviewActivity accountPreviewActivity, View view) {
        ...
        this.f13067b = viewFindRequiredView;
