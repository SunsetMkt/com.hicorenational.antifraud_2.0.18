...
public class CallRecordNewActivity_ViewBinding implements Unbinder {
    ...
    public CallRecordNewActivity_ViewBinding(CallRecordNewActivity callRecordNewActivity, View view) {
        ...
        callRecordNewActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17811b = findRequiredView;
        findRequiredView.setOnClickListener(new a(callRecordNewActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.btn_report, "field 'mBtnReport' and method 'onViewClicked'");
        callRecordNewActivity.mBtnReport = (Button) Utils.castView(findRequiredView2, R.id.btn_report, "field 'mBtnReport'", Button.class);
        this.f17812c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(callRecordNewActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_child_tab_me, "field 'mTvChildTabMe' and method 'onViewClicked'");
        callRecordNewActivity.mTvChildTabMe = (TextView) Utils.castView(findRequiredView3, R.id.tv_child_tab_me, "field 'mTvChildTabMe'", TextView.class);
        this.f17813d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(callRecordNewActivity));
        callRecordNewActivity.mVMe = Utils.findRequiredView(view, R.id.v_me, "field 'mVMe'");
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_child_tab_other, "field 'mTvChildTabOther' and method 'onViewClicked'");
        callRecordNewActivity.mTvChildTabOther = (TextView) Utils.castView(findRequiredView4, R.id.tv_child_tab_other, "field 'mTvChildTabOther'", TextView.class);
        this.f17814e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(callRecordNewActivity));
