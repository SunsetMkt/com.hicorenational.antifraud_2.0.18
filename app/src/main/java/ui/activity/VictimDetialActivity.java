...
/* JADX INFO: compiled from: VictimDetialActivity.kt */
...
public final class VictimDetialActivity extends BaseActivity {
    ...
    public final void initViewData() {
        this.a = (SurveyPeopleBean) getIntent().getSerializableExtra(util.p1.f15011c);
        if (this.a != null) {
            TextView textView = this.mTvPeopName;
            if (textView == null) {
                i.q2.t.i0.k("mTvPeopName");
            }
            SurveyPeopleBean surveyPeopleBean = this.a;
            textView.setText(surveyPeopleBean != null ? surveyPeopleBean.getPeopleName() : null);
            TextView textView2 = this.mTvPeopPhone;
            if (textView2 == null) {
                i.q2.t.i0.k("mTvPeopPhone");
            }
            SurveyPeopleBean surveyPeopleBean2 = this.a;
            textView2.setText(surveyPeopleBean2 != null ? surveyPeopleBean2.getPeoplePhone() : null);
            TextView textView3 = this.mTvPeopCredentType;
            if (textView3 == null) {
                i.q2.t.i0.k("mTvPeopCredentType");
            }
            SurveyPeopleBean surveyPeopleBean3 = this.a;
            textView3.setText(surveyPeopleBean3 != null ? surveyPeopleBean3.getDocumentName() : null);
            SurveyPeopleBean surveyPeopleBean4 = this.a;
            this.f13967b = String.valueOf(surveyPeopleBean4 != null ? surveyPeopleBean4.getDocumentNumber() : null);
            TextView textView4 = this.mEtPeopCredentNumber;
            if (textView4 == null) {
                i.q2.t.i0.k("mEtPeopCredentNumber");
            }
            textView4.setText(this.f13967b);
        }
    }
