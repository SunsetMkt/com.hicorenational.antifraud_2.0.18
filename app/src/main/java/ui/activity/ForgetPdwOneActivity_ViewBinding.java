...
public class ForgetPdwOneActivity_ViewBinding implements Unbinder {
    ...
    public ForgetPdwOneActivity_ViewBinding(ForgetPdwOneActivity forgetPdwOneActivity, View view) {
        ...
        forgetPdwOneActivity.mConfim = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mConfim'", TextView.class);
        this.f18170b = findRequiredView;
        findRequiredView.setOnClickListener(new a(forgetPdwOneActivity));
        ...
        forgetPdwOneActivity.mIvClean = (ImageView) Utils.castView(findRequiredView2, R.id.iv_clear, "field 'mIvClean'", ImageView.class);
        this.f18171c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(forgetPdwOneActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18172d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(forgetPdwOneActivity));
    }
}
