...
public class ChatFraudActivity_ViewBinding implements Unbinder {
    ...
    public ChatFraudActivity_ViewBinding(ChatFraudActivity chatFraudActivity, View view) {
        ...
        chatFraudActivity.mRegion = (TextView) Utils.castView(findRequiredView, R.id.region, "field 'mRegion'", TextView.class);
        this.f17913b = findRequiredView;
        findRequiredView.setOnClickListener(new a(chatFraudActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_dupery_type, "field 'mTvDuperyType' and method 'onViewClicked'");
        chatFraudActivity.mTvDuperyType = (TextView) Utils.castView(findRequiredView2, R.id.tv_dupery_type, "field 'mTvDuperyType'", TextView.class);
        this.f17914c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(chatFraudActivity));
        ...
        findRequiredView3.setOnClickListener(new c(chatFraudActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.btn_commit, "method 'onViewClicked'");
        this.f17916e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(chatFraudActivity));
    }
}
