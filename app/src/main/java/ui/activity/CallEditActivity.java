            ...
            case R.id.btn_confirm /* 2131296396 */:
                if (this.mEtVictimPhone.length() == 0) {
                    ...
                    if (list == null || list.size() <= 0) {
                        ...
                        int indexOf = this.f17743b.indexOf(this.f17742a);
                        for (int i2 = 0; i2 < this.f17743b.size(); i2++) {
                            if (i2 != this.f17744c && i2 != indexOf && TextUtils.equals(this.f17742a.getNumber(), this.f17743b.get(i2).getNumber()) && TextUtils.equals(this.f17742a.getCrime_time(), this.f17743b.get(i2).getCrime_time())) {
                                util.w1.a("输入信息重复，请重新输入");
                                break;
                            }
                        }
                        if (indexOf == -1 && this.f17744c == -1) {
                            this.f17743b.add(this.f17742a);
                        }
                    }
