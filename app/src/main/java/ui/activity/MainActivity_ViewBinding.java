...
public class MainActivity_ViewBinding implements Unbinder {
    ...
    public MainActivity_ViewBinding(MainActivity mainActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.iv_guide_main_1, "field 'mIvGuideMain1' and method 'onViewClicked'");
        mainActivity.mIvGuideMain1 = (ImageView) Utils.castView(findRequiredView, R.id.iv_guide_main_1, "field 'mIvGuideMain1'", ImageView.class);
        this.f18351b = findRequiredView;
