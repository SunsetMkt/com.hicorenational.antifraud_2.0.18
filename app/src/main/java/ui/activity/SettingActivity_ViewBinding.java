...
public class SettingActivity_ViewBinding implements Unbinder {
    ...
    public SettingActivity_ViewBinding(SettingActivity settingActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.time_txt, "field 'mTimeTxt' and method 'onViewClicked'");
        settingActivity.mTimeTxt = (TextView) Utils.castView(findRequiredView, R.id.time_txt, "field 'mTimeTxt'", TextView.class);
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.rl_cache_calean, "field 'mRlCache' and method 'onViewClicked'");
        ...
        View findRequiredView4 = Utils.findRequiredView(view, R.id.rl_account, "method 'onViewClicked'");
        this.f18894e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(settingActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.logout_btn, "method 'onViewClicked'");
        this.f18895f = findRequiredView5;
