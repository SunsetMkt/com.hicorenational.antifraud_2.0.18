...
public class CallNewActivity_ViewBinding implements Unbinder {
    ...
    public CallNewActivity_ViewBinding(CallNewActivity callNewActivity, View view) {
        ...
        callNewActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f17768b = findRequiredView;
        findRequiredView.setOnClickListener(new a(callNewActivity));
        ...
        findRequiredView2.setOnClickListener(new b(callNewActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.ll_select, "method 'onViewClicked'");
        this.f17770d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(callNewActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.ll_input, "method 'onViewClicked'");
        this.f17771e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(callNewActivity));
    }
}
