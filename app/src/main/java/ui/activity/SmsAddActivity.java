...
public class SmsAddActivity extends BaseActivity {
    ...
    public void initPage() {
        ...
        if (this.mEtVictimPhone.length() <= 0) {
            ...
            this.mEtVictimPhone.setText(j2);
        }
    }
    ...
    public void sendData() {
        ...
        this.f19014a.setSmsNum(obj);
        this.f19014a.setStringDate(this.mTvTime.getText().toString());
        this.f19014a.setSmsContent(obj2);
        this.f19014a.setVictimTel(this.mEtVictimPhone.getText().toString());
        this.f19014a.setStringDate(this.mTvTime.getText().toString());
        ...
        if (list == null || list.size() <= 0) {
            ...
            int indexOf = this.f19015b.indexOf(this.f19014a);
            for (int i2 = 0; i2 < this.f19015b.size(); i2++) {
                if (i2 != this.f19016c && i2 != indexOf && TextUtils.equals(this.f19014a.getVictimTel(), this.f19015b.get(i2).getVictimTel()) && TextUtils.equals(this.f19014a.getSmsNum(), this.f19015b.get(i2).getSmsNum()) && TextUtils.equals(this.f19014a.getStringDate(), this.f19015b.get(i2).getStringDate()) && TextUtils.equals(this.f19014a.getSmsContent(), this.f19015b.get(i2).getSmsContent())) {
                    util.w1.a("输入信息重复，请重新输入");
                    return;
                }
            }
            if (indexOf == -1 && this.f19016c == -1) {
                this.f19015b.add(this.f19014a);
            }
        }
