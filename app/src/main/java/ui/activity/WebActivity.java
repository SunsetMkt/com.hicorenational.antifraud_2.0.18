...
public class WebActivity extends BaseActivity implements WebShareView, IHandler.HandleWebActListener {
    ...
    public void sendWebMsg(util.o2.a aVar) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(strA)) {
                ...
                intent.putExtra(util.p1.P, strDecode);
                intent.putExtra(util.p1.Q, strA);
                intent.putExtra(util.p1.T, this.articId);
    ...
    public void initPage() {
        ...
        this.mTitle = getIntent().getStringExtra(util.p1.P);
        this.mOrginUrl = getIntent().getStringExtra(util.p1.Q);
        this.caragyCode = getIntent().getIntExtra(util.p1.V, -9);
        this.mPersonalize = getIntent().getStringExtra(util.p1.Z);
        this.mTvTitle.setText(this.mTitle);
        ...
        if (TextUtils.equals(this.mPersonalize, util.p1.a0)) {
            this.swipBackLayout.setInterEvent(true);
        }
    }
    ...
    public void a() {
        ...
        int i2 = this.toPage;
        if (i2 == 3) {
            util.f1.b(this.mActivity, "\u786e\u5b9a\u8981\u9000\u51fa\u7b54\u9898?", "\u9000\u51fa\u540e\u5df2\u4f5c\u7b54\u9898\u76ee\u5c06\u4e0d\u4f1a\u4fdd\u5b58", "\u9000\u51fa", "\u7ee7\u7eed", new a());
        } else if (i2 == 2) {
            this.mWebview.loadUrl(this.mOrginUrl);
        } else {
            super.a();
    ...
    public void onSuccessShareConfig(APIH5Bean aPIH5Bean) {
        if (aPIH5Bean != null) {
            try {
                if (!TextUtils.isEmpty(aPIH5Bean.getValue())) {
                    ...
                    String strReplace2 = this.shareBean.downloadUrl.replace("{1}", e.a.m() + "").replace("{2}", this.caragyCode + "");
        ...
        if (shareConfigBean != null) {
            new ui.f.c(this.mActivity, shareConfigBean, 2, new c.b() { // from class: ui.activity.q1
                @Override // ui.f.c.b
                public final void a() {
                    this.a.a();
                }
