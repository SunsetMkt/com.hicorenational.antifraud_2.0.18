    ...
    public void sendWebMsg(util.d2.a aVar) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(a2)) {
                ...
                intent.putExtra(util.k1.P, decode);
                intent.putExtra(util.k1.Q, a2);
                intent.putExtra(util.k1.T, this.articId);
                startActivity(intent);
            }
            String b3 = aVar.b("isfullScreen");
            String b4 = aVar.b("stylecolor");
            String b5 = aVar.b("toPage");
            if (TextUtils.equals("yes", b3)) {
        ...
        if (aPIH5Bean != null) {
            try {
                if (!TextUtils.isEmpty(aPIH5Bean.getValue())) {
                    ...
                    String replace2 = this.shareBean.downloadUrl.replace("{1}", d.a.m() + "").replace("{2}", this.caragyCode + "");
