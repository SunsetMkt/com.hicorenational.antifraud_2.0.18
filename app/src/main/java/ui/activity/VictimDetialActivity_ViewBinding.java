...
public final class VictimDetialActivity_ViewBinding implements Unbinder {
    ...
    public VictimDetialActivity_ViewBinding(VictimDetialActivity victimDetialActivity, View view) {
        ...
        victimDetialActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f19209b = findRequiredView;
        findRequiredView.setOnClickListener(new a(victimDetialActivity));
