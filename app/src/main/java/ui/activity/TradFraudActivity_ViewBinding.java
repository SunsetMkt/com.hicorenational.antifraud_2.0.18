...
public class TradFraudActivity_ViewBinding implements Unbinder {
    ...
    public TradFraudActivity_ViewBinding(TradFraudActivity tradFraudActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_account_name, "field 'mTvAccName' and method 'onViewClicked'");
        tradFraudActivity.mTvAccName = (TextView) Utils.castView(findRequiredView, R.id.tv_account_name, "field 'mTvAccName'", TextView.class);
        this.f19132b = findRequiredView;
        findRequiredView.setOnClickListener(new a(tradFraudActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.region, "field 'mRegion' and method 'onViewClicked'");
        tradFraudActivity.mRegion = (TextView) Utils.castView(findRequiredView2, R.id.region, "field 'mRegion'", TextView.class);
        this.f19133c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(tradFraudActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_dupery_type, "field 'mTvDuperyType' and method 'onViewClicked'");
        tradFraudActivity.mTvDuperyType = (TextView) Utils.castView(findRequiredView3, R.id.tv_dupery_type, "field 'mTvDuperyType'", TextView.class);
        this.f19134d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(tradFraudActivity));
        ...
        this.f19135e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(tradFraudActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.btn_commit, "method 'onViewClicked'");
        this.f19136f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(tradFraudActivity));
    }
}
