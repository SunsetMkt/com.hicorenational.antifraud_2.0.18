...
public class WarnSettingActivity extends BaseActivity {
    ...
    private void checkPermission() {
        ...
        boolean a2 = util.u1.a(util.u1.F, false);
        boolean a3 = util.u1.a(util.u1.G, false);
        boolean a4 = util.u1.a(util.u1.H, false);
        if (!a2 && !a3) {
            b(false);
            return;
        }
        ...
        if (a4) {
            StatisticsHttp.getInstance().trackWarnApp(a4 ? "1" : "0", null);
        }
        b(true);
    }
