...
public class CriminalSocialActivity_ViewBinding implements Unbinder {
    ...
    public CriminalSocialActivity_ViewBinding(CriminalSocialActivity criminalSocialActivity, View view) {
        ...
        criminalSocialActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18054b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalSocialActivity));
        criminalSocialActivity.mTvTip = (TextView) Utils.findRequiredViewAsType(view, R.id.tv_tip, "field 'mTvTip'", TextView.class);
        View findRequiredView2 = Utils.findRequiredView(view, R.id.ll_select, "field 'mLlSelect' and method 'onViewClicked'");
        criminalSocialActivity.mLlSelect = (LinearLayout) Utils.castView(findRequiredView2, R.id.ll_select, "field 'mLlSelect'", LinearLayout.class);
        this.f18055c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(criminalSocialActivity));
        ...
        this.f18056d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(criminalSocialActivity));
    }
}
