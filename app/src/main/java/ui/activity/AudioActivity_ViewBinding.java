...
public class AudioActivity_ViewBinding implements Unbinder {
    ...
    public AudioActivity_ViewBinding(AudioActivity audioActivity, View view) {
        ...
        audioActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f17685b = findRequiredView;
        findRequiredView.setOnClickListener(new a(audioActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f17686c = findRequiredView2;
        ...
        this.f17687d = findRequiredView3;
