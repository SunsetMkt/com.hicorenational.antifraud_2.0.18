...
public class WarnPrimessActivity extends BaseActivity implements WarnPrimessCallView {
    ...
    public void checkResult(boolean z, boolean z2) {
        boolean a2 = util.permissionutil.c.a(this.mActivity, this.permListPhone);
        boolean a3 = util.permissionutil.c.a(this.mActivity, this.permListRecord);
        boolean a4 = util.permissionutil.c.a(this.mActivity, this.permListSms);
        openState(this.mOpenPhone, a2);
        openState(this.mOpenPhoneRecord, a3);
        openState(this.mOpenSms, a4);
        if (!a2) {
    ...
    private void showBottomDlg(GuideBean guideBean) {
        View inflate = View.inflate(this.mActivity, R.layout.layout_warn_guide_flow, null);
        ImageView imageView = (ImageView) inflate.findViewById(R.id.iv_warn_guide_close);
        ImageView imageView2 = (ImageView) inflate.findViewById(R.id.iv_warn_guide);
        ...
        imageView.setOnClickListener(new d(from));
        textView.setOnClickListener(new e(from));
        if (guideBean != null) {
