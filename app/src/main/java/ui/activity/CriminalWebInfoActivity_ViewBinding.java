...
public final class CriminalWebInfoActivity_ViewBinding implements Unbinder {
    ...
    public CriminalWebInfoActivity_ViewBinding(CriminalWebInfoActivity criminalWebInfoActivity, View view) {
        ...
        criminalWebInfoActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18073b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalWebInfoActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.cl_social, "method 'onClick'");
        this.f18074c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(criminalWebInfoActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.cl_app, "method 'onClick'");
        this.f18075d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(criminalWebInfoActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.cl_website, "method 'onClick'");
        this.f18076e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(criminalWebInfoActivity));
    }
}
