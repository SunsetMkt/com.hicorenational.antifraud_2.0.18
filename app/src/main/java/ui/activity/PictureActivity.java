...
public class PictureActivity extends BaseUploadActivity implements PictureSelectAdapter.b, BaseQuickAdapter.i {
    ...
    class a implements PermissionsListener {
        ...
        public void onGranted() {
            k.e.a(PictureActivity.this.mActivity, 200L, PictureMimeType.ofImage(), PictureActivity.this.mMaxSelectNum - PictureActivity.this.mLocalMedia.size()).forResult(PictureConfig.CHOOSE_REQUEST);
        }
    }
    ...
    public void sendData() {
        org.greenrobot.eventbus.c.f().d(new util.n2.a(6, this.mLocalMedia, this.mUploadStateList));
    }
