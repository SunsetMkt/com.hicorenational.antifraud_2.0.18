...
public class PayStopAddActivity_ViewBinding implements Unbinder {
    ...
    public PayStopAddActivity_ViewBinding(PayStopAddActivity payStopAddActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_suspect_type, "field 'mTvSuspectType' and method 'onViewClicked'");
        payStopAddActivity.mTvSuspectType = (TextView) Utils.castView(findRequiredView, R.id.tv_suspect_type, "field 'mTvSuspectType'", TextView.class);
        this.f18443b = findRequiredView;
        findRequiredView.setOnClickListener(new a(payStopAddActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.tv_time, "field 'mTvTransTime' and method 'onViewClicked'");
        payStopAddActivity.mTvTransTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_time, "field 'mTvTransTime'", TextView.class);
        this.f18444c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(payStopAddActivity));
        ...
        payStopAddActivity.mBtnCommit = (Button) Utils.castView(findRequiredView3, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18445d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(payStopAddActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18446e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(payStopAddActivity));
    }
}
