...
public final class PoliceInfoActivity_ViewBinding implements Unbinder {
    ...
    public PoliceInfoActivity_ViewBinding(PoliceInfoActivity policeInfoActivity, View view) {
        ...
        policeInfoActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18507b = findRequiredView;
        findRequiredView.setOnClickListener(new a(policeInfoActivity));
        ...
        policeInfoActivity.mIvRight = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f18508c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(policeInfoActivity));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_case_manger, "method 'onClick'");
        this.f18509d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(policeInfoActivity));
        View findRequiredView4 = Utils.findRequiredView(view, R.id.tv_manual, "method 'onClick'");
        this.f18510e = findRequiredView4;
        findRequiredView4.setOnClickListener(new d(policeInfoActivity));
        View findRequiredView5 = Utils.findRequiredView(view, R.id.tv_invite_qrcode, "method 'onClick'");
        this.f18511f = findRequiredView5;
        findRequiredView5.setOnClickListener(new e(policeInfoActivity));
    }
}
