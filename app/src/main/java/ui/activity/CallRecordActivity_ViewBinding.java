...
public class CallRecordActivity_ViewBinding implements Unbinder {
    ...
    public CallRecordActivity_ViewBinding(CallRecordActivity callRecordActivity, View view) {
        ...
        callRecordActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f17789b = findRequiredView;
        findRequiredView.setOnClickListener(new a(callRecordActivity));
        ...
        callRecordActivity.mBtnReport = (Button) Utils.castView(findRequiredView2, R.id.btn_report, "field 'mBtnReport'", Button.class);
        this.f17790c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(callRecordActivity));
    }
}
