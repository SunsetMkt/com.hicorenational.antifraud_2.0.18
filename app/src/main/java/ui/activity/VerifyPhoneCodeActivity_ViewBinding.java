...
public class VerifyPhoneCodeActivity_ViewBinding implements Unbinder {
    ...
    public VerifyPhoneCodeActivity_ViewBinding(VerifyPhoneCodeActivity verifyPhoneCodeActivity, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.tv_reSend, "field 'mTvReset' and method 'onViewClicked'");
        verifyPhoneCodeActivity.mTvReset = (CodeCutTimeTextView) Utils.castView(findRequiredView, R.id.tv_reSend, "field 'mTvReset'", CodeCutTimeTextView.class);
        this.f19189b = findRequiredView;
        findRequiredView.setOnClickListener(new a(verifyPhoneCodeActivity));
        ...
        findRequiredView2.setOnClickListener(new b(verifyPhoneCodeActivity));
    }
}
