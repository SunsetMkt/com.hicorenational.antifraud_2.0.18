...
public final class ReportWebsiteAddActivity extends BasePicUploadActivity implements ReporCriminalView, ReportPictureSelAdapter.a, BaseQuickAdapter.i {
    ...
    public final ReportPictureSelAdapter initRecycle(@i.c.a.d NestedScrollView nestedScrollView, @i.c.a.d RecyclerView recyclerView, @i.c.a.d ArrayList<LocalMedia> arrayList, @i.c.a.d List<? extends UploadStateInfo> list) {
        ...
        ReportPictureSelAdapter a2 = ReportPictureSelAdapter.a(this.mActivity, recyclerView, this.mMaxSelectNum, this, this, arrayList, list);
        h.q2.t.i0.a((Object) a2, "ReportPictureSelAdapter.…List,uploadStateInfoList)");
        return a2;
    }
    ...
    public void onActivityResult(int i2, int i3, @i.c.a.e Intent intent) {
        ...
        List<LocalMedia> a2 = y1.a(obtainMultipleResult);
        h.q2.t.i0.a((Object) a2, "newList");
        int size = a2.size();
        for (int i4 = 0; i4 < size; i4++) {
            UploadFileBean uploadFileBean = new UploadFileBean();
            uploadFileBean.setLocalPath(a2.get(i4).getPath());
            uploadFileBean.setFileName(a2.get(i4).getFileName());
            this.mLocalMedia.add(a2.get(i4));
    ...
    public final void onClick(@i.c.a.d View view) {
        ...
        if (TextUtils.isEmpty(h.z2.c0.l((CharSequence) obj).toString())) {
    ...
    public void onItemChildClick(@i.c.a.e BaseQuickAdapter<?, ?> baseQuickAdapter, @i.c.a.e View view, int i2) {
        ...
        if (valueOf == null || valueOf.intValue() != R.id.iv_clear || rejuctOperation(false)) {
            return;
        }
        deleteDialog(i2);
    }
