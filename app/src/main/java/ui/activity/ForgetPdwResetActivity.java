...
public class ForgetPdwResetActivity extends BaseActivity implements IEditAfterListener, ForgetPwdCallView {
    ...
    private void initListener() {
        this.mPwdEye.setOnClickListener(new View.OnClickListener() { // from class: ui.activity.s
    ...
    public void initPage() {
        ...
        util.h1.a(this.mEtNewPwd, this);
        util.h1.b(this.mEtNewPwd);
        showSoftInput(this.mEtNewPwd);
        this.phoneNum = getIntent().getStringExtra(util.p1.F);
        this.phoneCode = getIntent().getStringExtra(util.p1.G);
    }
