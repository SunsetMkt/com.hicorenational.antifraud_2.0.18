...
public final class InviteQrcodeActivity extends BaseActivity {
    ...
    static final class a implements Runnable {
        ...
        @Override // java.lang.Runnable
        public final void run() {
            Bitmap decodeResource = BitmapFactory.decodeResource(InviteQrcodeActivity.this.getResources(), R.drawable.iv_qrcode_polic);
            int a2 = util.c1.a(InviteQrcodeActivity.this, 240.0f);
            Bitmap a3 = util.e1.a(this.f18266b, a2, a2, decodeResource);
            if (InviteQrcodeActivity.this.a() != null) {
                InviteQrcodeActivity.this.a().post(new RunnableC0284a(a3));
            }
        }
    }
    ...
    public final void initView() {
        ...
        PolicBean a2 = d.b.a();
        if (a2 != null) {
            createQRcode(d.a.f13520f + "/QRCode/?pcode=" + a2.getPoliceUserPCode() + "&policeuserid=" + a2.getId() + "&os=0");
        }
    }
