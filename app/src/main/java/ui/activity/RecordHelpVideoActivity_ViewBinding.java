...
public class RecordHelpVideoActivity_ViewBinding implements Unbinder {
    ...
    public RecordHelpVideoActivity_ViewBinding(RecordHelpVideoActivity recordHelpVideoActivity, View view) {
        ...
        recordHelpVideoActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18621b = findRequiredView;
        findRequiredView.setOnClickListener(new a(recordHelpVideoActivity));
