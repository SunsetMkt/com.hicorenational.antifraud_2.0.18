...
public final class LogoutActivity_ViewBinding implements Unbinder {
    ...
    public LogoutActivity_ViewBinding(LogoutActivity logoutActivity, View view) {
        ...
        logoutActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        ...
        this.f18298c = findRequiredView2;
        ...
        this.f18299d = findRequiredView3;
