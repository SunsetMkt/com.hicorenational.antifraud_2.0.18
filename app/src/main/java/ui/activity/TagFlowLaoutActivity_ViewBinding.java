...
public class TagFlowLaoutActivity_ViewBinding implements Unbinder {
    ...
    public TagFlowLaoutActivity_ViewBinding(TagFlowLaoutActivity tagFlowLaoutActivity, View view) {
        ...
        tagFlowLaoutActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f19101b = findRequiredView;
        findRequiredView.setOnClickListener(new a(tagFlowLaoutActivity));
        ...
        View findRequiredView2 = Utils.findRequiredView(view, R.id.ll_network_no, "field 'mLlNetworkNo' and method 'onViewClicked'");
        tagFlowLaoutActivity.mLlNetworkNo = findRequiredView2;
        this.f19102c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(tagFlowLaoutActivity));
    }
}
