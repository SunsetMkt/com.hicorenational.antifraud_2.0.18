...
public class TradAccountActivity_ViewBinding implements Unbinder {
    ...
    public TradAccountActivity_ViewBinding(TradAccountActivity tradAccountActivity, View view) {
        ...
        tradAccountActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f19112b = findRequiredView;
        findRequiredView.setOnClickListener(new a(tradAccountActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f19113c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(tradAccountActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.ll_select, "method 'onViewClicked'");
        this.f19114d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(tradAccountActivity));
    }
}
