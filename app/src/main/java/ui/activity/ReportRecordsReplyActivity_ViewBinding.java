...
public final class ReportRecordsReplyActivity_ViewBinding implements Unbinder {
    ...
    public ReportRecordsReplyActivity_ViewBinding(ReportRecordsReplyActivity reportRecordsReplyActivity, View view) {
        ...
        reportRecordsReplyActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18760b = findRequiredView;
        findRequiredView.setOnClickListener(new a(reportRecordsReplyActivity));
