...
public class CriminalSmsActivity_ViewBinding implements Unbinder {
    ...
    public CriminalSmsActivity_ViewBinding(CriminalSmsActivity criminalSmsActivity, View view) {
        ...
        criminalSmsActivity.mBtnCommit = (Button) Utils.castView(findRequiredView, R.id.btn_commit, "field 'mBtnCommit'", Button.class);
        this.f18015b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalSmsActivity));
