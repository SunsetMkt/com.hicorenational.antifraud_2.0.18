...
public class AppActivity extends BaseUploadActivity implements BaseQuickAdapter.i {
    ...
    class a implements PermissionsListener {
        ...
        public void onGranted() {
            ...
            intent.putExtra(AppSelectedActivity.f13094j, size);
    ...
    private void scanVirus() {
        ...
        util.s1.a("mCurrentUploadIndex-->-1 \u6587\u4ef6\u4e0a\u4f20\u8bf7\u6c42   1" + this.mCurrentUploadIndex);
        int i3 = this.mCurrentUploadIndex;
        if (i3 <= -1 || appInfoBean != this.mAppBeans.get(i3)) {
            return;
        }
        util.s1.a("mCurrentUploadIndex-->-1 \u6587\u4ef6\u4e0a\u4f20\u8bf7\u6c42   2" + this.mCurrentUploadIndex);
    ...
    public void sendData() {
        org.greenrobot.eventbus.c.f().d(new util.n2.a(5, this.mAppBeans, this.mUploadStateList));
    }
