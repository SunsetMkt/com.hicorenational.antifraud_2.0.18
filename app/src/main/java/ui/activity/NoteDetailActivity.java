...
/* JADX INFO: compiled from: NoteDetailActivity.kt */
...
public final class NoteDetailActivity extends BaseActivity {
    ...
    public final void initView() {
        this.a = (NoteListBean) getIntent().getSerializableExtra(util.p1.f15011c);
        if (this.a != null) {
            TextView textView = this.mTvTime;
            if (textView == null) {
                i.q2.t.i0.k("mTvTime");
    ...
    public final void a(@j.c.a.e NoteListBean noteListBean) {
        this.a = noteListBean;
    }
}
