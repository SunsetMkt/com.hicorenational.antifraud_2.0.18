...
public class H5AppSelectedActivity_ViewBinding implements Unbinder {
    ...
    public H5AppSelectedActivity_ViewBinding(H5AppSelectedActivity h5AppSelectedActivity, View view) {
        ...
        h5AppSelectedActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18197b = findRequiredView;
        findRequiredView.setOnClickListener(new a(h5AppSelectedActivity));
        ...
        h5AppSelectedActivity.mIvRight = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f18198c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(h5AppSelectedActivity));
        ...
        h5AppSelectedActivity.mBtnReport = (Button) Utils.castView(findRequiredView3, R.id.btn_report, "field 'mBtnReport'", Button.class);
        this.f18199d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(h5AppSelectedActivity));
    }
}
