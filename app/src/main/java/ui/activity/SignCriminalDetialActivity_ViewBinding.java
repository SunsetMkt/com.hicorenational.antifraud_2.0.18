...
public final class SignCriminalDetialActivity_ViewBinding implements Unbinder {
    ...
    public SignCriminalDetialActivity_ViewBinding(SignCriminalDetialActivity signCriminalDetialActivity, View view) {
        ...
        signCriminalDetialActivity.mIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mIvBack'", ImageView.class);
        this.f18950b = findRequiredView;
        findRequiredView.setOnClickListener(new a(signCriminalDetialActivity));
