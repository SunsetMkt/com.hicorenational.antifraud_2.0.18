...
public class ManualPhoneActivity_ViewBinding implements Unbinder {
    ...
    public ManualPhoneActivity_ViewBinding(ManualPhoneActivity manualPhoneActivity, View view) {
        ...
        manualPhoneActivity.mConfim = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mConfim'", TextView.class);
        this.f18389b = findRequiredView;
        findRequiredView.setOnClickListener(new a(manualPhoneActivity));
        ...
        manualPhoneActivity.mIvClean = (ImageView) Utils.castView(findRequiredView2, R.id.iv_clear, "field 'mIvClean'", ImageView.class);
        this.f18390c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(manualPhoneActivity));
        View findRequiredView3 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18391d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(manualPhoneActivity));
    }
}
