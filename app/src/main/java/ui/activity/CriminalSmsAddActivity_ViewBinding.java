...
public class CriminalSmsAddActivity_ViewBinding implements Unbinder {
    ...
    public CriminalSmsAddActivity_ViewBinding(CriminalSmsAddActivity criminalSmsAddActivity, View view) {
        ...
        criminalSmsAddActivity.mTvType = (TextView) Utils.castView(findRequiredView, R.id.tv_type, "field 'mTvType'", TextView.class);
        this.f18033b = findRequiredView;
        findRequiredView.setOnClickListener(new a(criminalSmsAddActivity));
        View findRequiredView2 = Utils.findRequiredView(view, R.id.iv_back, "method 'onViewClicked'");
        this.f18034c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(criminalSmsAddActivity));
    }
}
