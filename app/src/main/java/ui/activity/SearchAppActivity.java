...
public final class SearchAppActivity extends BaseActivity implements View.OnClickListener, AppSearchPresenter.a {
    ...
    public final void initView() {
        ...
        this.f18869a = (ImageView) findViewById;
        View findViewById2 = findViewById(R.id.et_search);
        h.q2.t.i0.a((Object) findViewById2, "findViewById(R.id.et_search)");
        this.f18870b = (EditText) findViewById2;
        View findViewById3 = findViewById(R.id.rv_appList);
        h.q2.t.i0.a((Object) findViewById3, "findViewById(R.id.rv_appList)");
        this.f18871c = (RecyclerView) findViewById3;
