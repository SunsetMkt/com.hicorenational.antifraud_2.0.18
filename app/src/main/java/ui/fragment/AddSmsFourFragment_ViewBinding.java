...
public class AddSmsFourFragment_ViewBinding implements Unbinder {
    ...
    public AddSmsFourFragment_ViewBinding(AddSmsFourFragment addSmsFourFragment, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.confirm, "field 'mBtnCommit' and method 'onViewClicked'");
        addSmsFourFragment.mBtnCommit = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mBtnCommit'", TextView.class);
        this.f19562b = findRequiredView;
        findRequiredView.setOnClickListener(new a(addSmsFourFragment));
        ...
        addSmsFourFragment.mTvTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_time, "field 'mTvTime'", TextView.class);
        this.f19563c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(addSmsFourFragment));
        ...
        View findRequiredView3 = Utils.findRequiredView(view, R.id.tv_brand, "field 'mTvBrand' and method 'onViewClicked'");
        addSmsFourFragment.mTvBrand = (TextView) Utils.castView(findRequiredView3, R.id.tv_brand, "field 'mTvBrand'", TextView.class);
        this.f19564d = findRequiredView3;
        findRequiredView3.setOnClickListener(new c(addSmsFourFragment));
