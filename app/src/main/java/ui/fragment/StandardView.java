...
import ui.fragment.StandardView;
...
public class StandardView extends LinearLayout {
    ...
    class b implements View.OnClickListener {
        ...
        public /* synthetic */ void a() {
            ...
            k1.a(StandardView.this.f19662a, j2.getH5Url() + j2.getRiskCheck());
        }
    ...
    private void c() {
        ...
        View inflate = LayoutInflater.from(this.f19662a).inflate(R.layout.view_standard, (ViewGroup) this, true);
        this.f19663b = (TextView) inflate.findViewById(R.id.tv_title);
        this.f19664c = (ConstraintLayout) inflate.findViewById(R.id.cl_virus_check);
        this.f19665d = (ConstraintLayout) inflate.findViewById(R.id.cl_fraud_check);
        this.f19667f = (ImageView) inflate.findViewById(R.id.iv_img);
        this.f19666e = (ViewStub) inflate.findViewById(R.id.stub_animation);
    ...
    public void setDataChange(RegionMudelBean regionMudelBean) {
        if (regionMudelBean == null) {
            ...
            setVisibility(0);
            this.f19664c.setVisibility(contains ? 0 : 8);
            this.f19665d.setVisibility(contains2 ? 0 : 8);
        }
    }
    ...
    public void a() {
        boolean d2 = j1.d();
        boolean a2 = u1.a(u1.z0, false);
        boolean a3 = u1.a(u1.A0, false);
        if ((d2 && !a2) || !a3) {
            if (TextUtils.equals(WelocmPresenter.VIRAPPCHECK, "1")) {
                e();
