...
public class AddSmsOneFragment extends BaseFragment {
    ...
    private CriminalSmsAddActivity f14155b;

    /* JADX INFO: renamed from: c */
    private SmsPictureAdapter f14156c;
    ...
    private List<LocalMedia> f14157d = new ArrayList();
    ...
    class b implements SmsPictureAdapter.b {
        ...
        public void onItemClickListener(int i2, List<LocalMedia> list) {
            AddSmsOneFragment.this.f14155b.onItemClickListener(i2, list);
        }
    }
    ...
    class c implements BaseQuickAdapter.i {
        ...
        public void onItemChildClick(BaseQuickAdapter baseQuickAdapter, View view, int i2) {
            AddSmsOneFragment.this.f14155b.onItemChildClick(baseQuickAdapter, view, i2);
        }
    }
    ...
    class d implements IClickListener {
        ...
        public void clickOKBtn() {
            AddSmsOneFragment.this.f14155b.confirm(AddSmsOneFragment.this.a);
        }
    }

    private void h() {
        this.mRecyclerview.setLayoutManager(new GridLayoutManager(this.mActivity, 3));
        List<LocalMedia> list = this.f14157d;
        this.f14155b.getClass();
        this.f14156c = new SmsPictureAdapter(R.layout.recyclerview_feedback, list, 6, this.f14155b.isOnlyShow());
        this.f14156c.a(this.mRecyclerview);
        this.f14156c.setOnItemClickListener(new b());
        this.f14156c.setOnItemChildClickListener(new c());
        this.mRecyclerview.setAdapter(this.f14156c);
    }
    ...
    public void initPage() {
        this.f14155b = (CriminalSmsAddActivity) this.mActivity;
        ...
        if (this.a == null) {
            this.a = new CriminalSmsBean();
            this.a.setSmsType(1);
            this.a.setSmsTypeText(this.f14155b.strs[0]);
        }
        this.f14155b.setChildBean(this.a);
        h();
        if (this.f14155b.isOnlyShow()) {
            i();
        }
    }
