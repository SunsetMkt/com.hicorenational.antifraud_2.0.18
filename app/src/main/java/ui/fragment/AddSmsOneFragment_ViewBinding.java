...
public class AddSmsOneFragment_ViewBinding implements Unbinder {
    ...
    public AddSmsOneFragment_ViewBinding(AddSmsOneFragment addSmsOneFragment, View view) {
        ...
        addSmsOneFragment.mBtnCommit = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mBtnCommit'", TextView.class);
        this.f19580b = findRequiredView;
        findRequiredView.setOnClickListener(new a(addSmsOneFragment));
        ...
        addSmsOneFragment.mTvTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_time, "field 'mTvTime'", TextView.class);
        this.f19581c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(addSmsOneFragment));
