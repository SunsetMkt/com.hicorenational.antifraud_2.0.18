...
public class AddSmsOneFragment_ViewBinding implements Unbinder {
    ...
    class a extends DebouncingOnClickListener {
        final /* synthetic */ AddSmsOneFragment a;

        a(AddSmsOneFragment addSmsOneFragment) {
            this.a = addSmsOneFragment;
        }
    ...
    public AddSmsOneFragment_ViewBinding(AddSmsOneFragment addSmsOneFragment, View view) {
        ...
        this.f14158b = viewFindRequiredView;
        ...
        this.f14159c = viewFindRequiredView2;
    ...
    @CallSuper
    public void unbind() {
        AddSmsOneFragment addSmsOneFragment = this.a;
