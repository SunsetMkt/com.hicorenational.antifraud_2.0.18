...
public class AddSmsThreeFragment_ViewBinding implements Unbinder {
    ...
    public AddSmsThreeFragment_ViewBinding(AddSmsThreeFragment addSmsThreeFragment, View view) {
        ...
        addSmsThreeFragment.mBtnCommit = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mBtnCommit'", TextView.class);
        this.f19595b = findRequiredView;
        findRequiredView.setOnClickListener(new a(addSmsThreeFragment));
        ...
        addSmsThreeFragment.mTvTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_time, "field 'mTvTime'", TextView.class);
        this.f19596c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(addSmsThreeFragment));
