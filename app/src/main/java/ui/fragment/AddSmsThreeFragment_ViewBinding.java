...
public class AddSmsThreeFragment_ViewBinding implements Unbinder {
    ...
    class a extends DebouncingOnClickListener {
        final /* synthetic */ AddSmsThreeFragment a;

        a(AddSmsThreeFragment addSmsThreeFragment) {
            this.a = addSmsThreeFragment;
        }
    ...
    public AddSmsThreeFragment_ViewBinding(AddSmsThreeFragment addSmsThreeFragment, View view) {
        ...
        this.f14165b = viewFindRequiredView;
        ...
        this.f14166c = viewFindRequiredView2;
    ...
    @CallSuper
    public void unbind() {
        AddSmsThreeFragment addSmsThreeFragment = this.a;
