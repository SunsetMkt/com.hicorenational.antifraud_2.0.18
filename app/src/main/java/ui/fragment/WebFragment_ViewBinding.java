...
public class WebFragment_ViewBinding implements Unbinder {
    ...
    public WebFragment_ViewBinding(WebFragment webFragment, View view) {
        ...
        webFragment.mTIvBack = (ImageView) Utils.castView(findRequiredView, R.id.iv_back, "field 'mTIvBack'", ImageView.class);
        ...
        webFragment.mIvRight = (ImageView) Utils.castView(findRequiredView2, R.id.iv_right, "field 'mIvRight'", ImageView.class);
        this.f19701c = findRequiredView2;
        ...
        this.f19702d = findRequiredView3;
