...
public class LocalWebFragment_ViewBinding implements Unbinder {
    ...
    public LocalWebFragment_ViewBinding(LocalWebFragment localWebFragment, View view) {
        ...
        View findRequiredView = Utils.findRequiredView(view, R.id.ll_network_no, "field 'mLlNetworkNo' and method 'onViewClicked'");
        localWebFragment.mLlNetworkNo = findRequiredView;
        this.f19634b = findRequiredView;
        findRequiredView.setOnClickListener(new a(localWebFragment));
    }
