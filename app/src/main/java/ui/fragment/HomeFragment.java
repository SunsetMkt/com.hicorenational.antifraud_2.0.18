...
public class HomeFragment extends BaseFragment implements HomeCallView, View.OnClickListener, ToolView.b {
        ...
        public void onIRSuccess(RegionMudelBean regionMudelBean) {
            if (regionMudelBean != null) {
                ...
                if (HomeFragment.this.isForceFresh) {
                    org.greenrobot.eventbus.c.f().d(new util.n2.a(util.n2.a.B0));
                }
            }
            HomeFragment homeFragment = HomeFragment.this;
    ...
    class d implements StatisticsHttp.CallbackComplete {
        ...
        class a implements StatisticsHttp.CallbackComplete {
            ...
            /* JADX INFO: renamed from: ui.fragment.HomeFragment$d$a$a, reason: collision with other inner class name */
            class C0291a implements StatisticsHttp.CallbackComplete {
                C0291a() {
                }
            ...
            @Override // network.http.StatisticsHttp.CallbackComplete
            public void onComplete() {
                StatisticsHttp.getInstance().trackWarnApp((d.this.a && c2.a(c2.H, false)) ? "1" : "0", new C0291a());
            }
        }
        ...
        public void onComplete() {
            HomeFragment homeFragment = HomeFragment.this;
            StatisticsHttp.getInstance().trackWarnSms((this.a && util.permissionutil.c.a(homeFragment.mActivity, homeFragment.presenter.checkPermissionSms()) && c2.a(c2.G, false)) ? "1" : "0", new a());
        }
    }
    ...
    /* JADX INFO: renamed from: goTools, reason: merged with bridge method [inline-methods] */
    public void a(String str) {
        ...
        if (TextUtils.equals(str, ModuelConfig.MODEL_WARN)) {
            ...
            intent.putExtra(p1.f15011c, this.mPresenter.getVerifyPointBean());
    ...
    private void initBanner() {
        ...
        this.mBanner.setImageLoader(s.getImageLoader(this.mActivity));
    ...
    private void initRegionView() {
        BaseFragment.mRegionBean = e.a.j();
    ...
    private void itemTurnPage(final String str, String str2, String str3, String str4, int i2) {
        if (this.mToolitemsView.a(str)) {
            if (i2 == 1) {
                h2.a(this.mActivity).a(Integer.parseInt(str), new IVerifyListener() { // from class: ui.fragment.g
    ...
    private void loadNewCaseCache() {
        List<HomeNewCaseBean.RowsBean> listB = u1.b(u1.o, HomeNewCaseBean.RowsBean.class);
        if (listB != null) {
    ...
    private boolean toH5NoteView() {
        ...
        intent.putExtra(p1.Q, BaseFragment.mRegionBean.getH5Url() + BaseFragment.mRegionBean.getBroadcast());
        startActivity(intent);
        return true;
    }
    ...
    private void urlOpen(String str, String str2, String str3) {
        if (TextUtils.equals(str2, ModuelConfig.OTYPE1)) {
            ...
            intent.putExtra(p1.P, g2.t(str3));
            intent.putExtra(p1.Q, str + AccountManager.getShareParam());
            startActivity(intent);
            return;
        }
        if (TextUtils.equals(str2, ModuelConfig.OTYPE2)) {
            Intent intent2 = new Intent(getActivity(), (Class<?>) WebActivity.class);
            intent2.putExtra(p1.P, g2.t(str3));
            intent2.putExtra(p1.Q, str);
            startActivity(intent2);
            return;
        }
        if (TextUtils.equals(str2, ModuelConfig.OTYPE3)) {
            p1.a((Context) this.mActivity, str);
        } else {
            p1.a(this.mActivity, str);
        }
    }
    ...
    private void urlOpenVerified(final String str, final String str2, String str3, final String str4) {
        if (TextUtils.equals(str3, ModuelConfig.OTYPE1) || TextUtils.equals(str3, ModuelConfig.OTYPE2)) {
            ...
            map.put(p1.P, g2.t(str4));
            map.put(p1.Q, str + AccountManager.getShareParam());
            h2.a(this.mActivity).a(18, map, new IVerifyListener() { // from class: ui.fragment.k
                @Override // interfaces.IVerifyListener
                public final void onSuccessVerify() {
                    this.a.b(str4, str);
                }
        ...
        if (TextUtils.equals(str3, ModuelConfig.OTYPE3)) {
            ...
            map2.put(p1.Q, str);
            h2.a(this.mActivity).a(19, map2, new IVerifyListener() { // from class: ui.fragment.b
                @Override // interfaces.IVerifyListener
                public final void onSuccessVerify() {
                    this.a.c(str);
                }
            ...
            map3.put(p1.Q, str);
            h2.a(this.mActivity).a(20, map3, new IVerifyListener() { // from class: ui.fragment.i
                @Override // interfaces.IVerifyListener
                public final void onSuccessVerify() {
                    this.a.a(str2, str);
                }
    ...
    public /* synthetic */ void e() {
        ...
        p1.a(this.mActivity, BaseFragment.mRegionBean.getH5Url() + BaseFragment.mRegionBean.getAssistantPolice());
    }
    ...
    public void onCheckPolice(boolean z, boolean z2) {
        ...
        StatisticsHttp.getInstance().trackWarnCall((zIsOpenFlowPrim && util.permissionutil.c.a(this.mActivity, this.presenter.checkPermissionCall()) && c2.a(c2.F, false)) ? "1" : "0", new d(zIsOpenFlowPrim));
    }
    ...
    public void onClick(View view) {
        ...
        if (id != R.id.fl_note_view) {
            ...
            h2.a(this.mActivity).a(13, new IVerifyListener() { // from class: ui.fragment.e
                @Override // interfaces.IVerifyListener
                public final void onSuccessVerify() {
                    this.a.e();
                }
    ...
    public void onNewCaseRequest(List<HomeNewCaseBean.RowsBean> list) {
        try {
            ...
            if (list == null || list.size() <= 0) {
                ...
                u1.a(u1.o, (List) this.mAdapter.a());
                showMoreBtn(z);
            } else {
                if (this.isLoadmore) {
    ...
    public void onNoteDlgRequest(NoteDlgBean noteDlgBean) {
        if (noteDlgBean != null) {
            if (!TextUtils.isEmpty(noteDlgBean.getTitle())) {
                f1.a(this.mActivity, noteDlgBean, (IOneClickListener) null);
            }
    ...
    public void setUserVisibleHint(boolean z) {
        ...
        mIsVisibleToUser = z;
        if (z) {
            StatisticsHttp.getInstance().pageOpenHttp(f.d.f10207g);
        }
    }

    public void virusFinish() {
        this.mStandardView.c();
    }
    ...
    public /* synthetic */ void b(String str, String str2) {
        Intent intent = new Intent(getActivity(), (Class<?>) WebActivity.class);
        intent.putExtra(p1.P, g2.t(str));
        intent.putExtra(p1.Q, str2 + AccountManager.getShareParam());
        startActivity(intent);
    }
