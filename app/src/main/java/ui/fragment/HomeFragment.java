...
public class HomeFragment extends BaseFragment implements HomeCallView, View.OnClickListener, ToolView.b {
    ...
    private void loadNewCaseCache() {
        List<HomeNewCaseBean.RowsBean> b2 = p1.b(p1.o, HomeNewCaseBean.RowsBean.class);
        if (b2 != null) {
            this.mAdapter.a(b2);
    ...
    private void urlOpenVerified(final String str, final String str2, String str3, final String str4) {
        if (TextUtils.equals(str3, ModuelConfig.OTYPE1) || TextUtils.equals(str3, ModuelConfig.OTYPE2)) {
            ...
            hashMap.put(k1.P, y1.t(str4));
            hashMap.put(k1.Q, str + AccountManager.getShareParam());
            z1.a(this.mActivity).a(18, hashMap, new IVerifyListener() { // from class: ui.fragment.k
                @Override // interfaces.IVerifyListener
                public final void onSuccessVerify() {
                    HomeFragment.this.b(str4, str);
                }
            });
            return;
        }
        if (TextUtils.equals(str3, ModuelConfig.OTYPE3)) {
            ...
            hashMap2.put(k1.Q, str);
            z1.a(this.mActivity).a(19, hashMap2, new IVerifyListener() { // from class: ui.fragment.b
                @Override // interfaces.IVerifyListener
                public final void onSuccessVerify() {
            ...
            hashMap3.put(k1.Q, str);
            z1.a(this.mActivity).a(20, hashMap3, new IVerifyListener() { // from class: ui.fragment.i
                @Override // interfaces.IVerifyListener
                public final void onSuccessVerify() {
    ...
    public void onCheckPolice(boolean z, boolean z2) {
        ...
        StatisticsHttp.getInstance().trackWarnCall((isOpenFlowPrim && util.permissionutil.c.a(this.mActivity, this.presenter.checkPermissionCall()) && u1.a(u1.F, false)) ? "1" : "0", new d(isOpenFlowPrim));
    }
