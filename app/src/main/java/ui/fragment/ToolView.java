...
public class ToolView extends LinearLayout {
    ...
    public void setDataChange(RegionMudelBean regionMudelBean) {
        if (regionMudelBean == null) {
            ...
            for (int i2 = 0; i2 < this.f19678e.size(); i2++) {
                ...
                int indexOf = this.f19681h.indexOf(homeToolBean.getModule());
                if (indexOf > -1) {
                    homeToolBean.setLocalIcon(this.f19682i[indexOf]);
                } else {
                    int indexOf2 = this.f19681h.indexOf(homeToolBean.getId());
                    if (indexOf2 > -1) {
                        homeToolBean.setLocalIcon(this.f19682i[indexOf2]);
                    } else {
    ...
    class a implements PageRecyclerView.a {
        ...
        public RecyclerView.ViewHolder a(ViewGroup viewGroup, int i2) {
            View inflate = LayoutInflater.from(ToolView.this.f19674a).inflate(R.layout.item_tool, viewGroup, false);
            ToolView toolView = ToolView.this;
            return new Holder(toolView, toolView.f19674a, inflate, null);
        }
    ...
    private void a() {
        ...
        View inflate = LayoutInflater.from(this.f19674a).inflate(R.layout.view_tools, (ViewGroup) this, true);
        this.f19675b = (PageRecyclerView) inflate.findViewById(R.id.page_recyclerview);
        this.f19676c = (PageIndicatorView) inflate.findViewById(R.id.page_indicator);
    }
        ...
        if (this.f19675b != null) {
            try {
                ...
                while (i2 < this.f19678e.size()) {
                    ...
                    View a2 = this.f19675b.a(i2);
                    if (a2 != null) {
                        View findViewById = a2.findViewById(R.id.red_dot);
                        if (!z) {
                            i3 = 8;
                        }
