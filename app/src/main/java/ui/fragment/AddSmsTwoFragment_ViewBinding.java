...
public class AddSmsTwoFragment_ViewBinding implements Unbinder {
    ...
    public AddSmsTwoFragment_ViewBinding(AddSmsTwoFragment addSmsTwoFragment, View view) {
        ...
        addSmsTwoFragment.mBtnCommit = (TextView) Utils.castView(findRequiredView, R.id.confirm, "field 'mBtnCommit'", TextView.class);
        this.f19610b = findRequiredView;
        findRequiredView.setOnClickListener(new a(addSmsTwoFragment));
        ...
        addSmsTwoFragment.mTvTime = (TextView) Utils.castView(findRequiredView2, R.id.tv_time, "field 'mTvTime'", TextView.class);
        this.f19611c = findRequiredView2;
        findRequiredView2.setOnClickListener(new b(addSmsTwoFragment));
