...
public class AddSmsTwoFragment_ViewBinding implements Unbinder {
    ...
    class a extends DebouncingOnClickListener {
        final /* synthetic */ AddSmsTwoFragment a;

        a(AddSmsTwoFragment addSmsTwoFragment) {
            this.a = addSmsTwoFragment;
        }
    ...
    public AddSmsTwoFragment_ViewBinding(AddSmsTwoFragment addSmsTwoFragment, View view) {
        ...
        this.f14172b = viewFindRequiredView;
        ...
        this.f14173c = viewFindRequiredView2;
    ...
    @CallSuper
    public void unbind() {
        AddSmsTwoFragment addSmsTwoFragment = this.a;
