...
public class b {
    static int a(int i2, int i3) {
        ...
        return ((int) (((double) ((i2 & 255) * f2)) + 0.5d)) | (((int) (((double) (((i2 >> 16) & 255) * f2)) + 0.5d)) << 16) | ViewCompat.MEASURED_STATE_MASK | (((int) (((double) (((i2 >> 8) & 255) * f2)) + 0.5d)) << 8);
    }
    ...
    public static void a(@f Window window, @ColorInt int i2) {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.clearFlags(d.c.a.b.a.a.C1);
