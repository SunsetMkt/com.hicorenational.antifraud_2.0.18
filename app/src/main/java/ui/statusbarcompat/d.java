...
/* JADX INFO: compiled from: StatusBarCompatLollipop.java */
...
class d {
    ...
    static class b implements AppBarLayout.OnOffsetChangedListener {
        ...
        final /* synthetic */ Window f14479b;
        ...
        class a implements ValueAnimator.AnimatorUpdateListener {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                b.this.f14479b.setStatusBarColor(((Integer) valueAnimator.getAnimatedValue()).intValue());
            }
        }

        /* JADX INFO: renamed from: ui.statusbarcompat.d$b$b, reason: collision with other inner class name */
        /* JADX INFO: compiled from: StatusBarCompatLollipop.java */
        class C0323b implements ValueAnimator.AnimatorUpdateListener {
            C0323b() {
            }
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i2) {
            if (Math.abs(i2) > appBarLayout.getHeight() - this.a.getScrimVisibleHeightTrigger()) {
                if (this.f14479b.getStatusBarColor() == 0) {
                    ValueAnimator duration = ValueAnimator.ofArgb(0, this.f14480c).setDuration(this.a.getScrimAnimationDuration());
            ...
            int statusBarColor = this.f14479b.getStatusBarColor();
            int i3 = this.f14480c;
            if (statusBarColor == i3) {
                ValueAnimator duration2 = ValueAnimator.ofArgb(i3, 0).setDuration(this.a.getScrimAnimationDuration());
                duration2.addUpdateListener(new C0323b());
                duration2.start();
            }
        }
    }
    ...
    static void b(Activity activity, int i2, boolean z) {
        ...
        if (z) {
            window.clearFlags(d.c.a.b.a.a.B1);
