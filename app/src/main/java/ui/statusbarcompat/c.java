...
/* JADX INFO: compiled from: StatusBarCompatKitKat.java */
...
class c {
    ...
    private static final String f14477b = "marginAdded";
    ...
    static class a implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout appBarLayout, int i2) {
            if (Math.abs(i2) > appBarLayout.getHeight() - this.a.getScrimVisibleHeightTrigger()) {
                if (this.f14478b.getAlpha() == 0.0f) {
                    this.f14478b.animate().cancel();
                    this.f14478b.animate().alpha(1.0f).setDuration(this.a.getScrimAnimationDuration()).start();
                    return;
                }
                return;
            }
            if (this.f14478b.getAlpha() == 1.0f) {
                this.f14478b.animate().cancel();
                this.f14478b.animate().alpha(0.0f).setDuration(this.a.getScrimAnimationDuration()).start();
            }
        }
    }
    ...
    private static void b(View view, int i2) {
        if (view != null && f14477b.equals(view.getTag())) {
    ...
    static void c(Activity activity) {
        activity.getWindow().addFlags(d.c.a.b.a.a.B1);
    ...
    private static void a(Activity activity) {
        ViewGroup viewGroup = (ViewGroup) activity.getWindow().getDecorView();
        View viewFindViewWithTag = viewGroup.findViewWithTag(a);
    ...
    static void a(Fragment fragment) {
        fragment.getActivity().getWindow().addFlags(d.c.a.b.a.a.B1);
