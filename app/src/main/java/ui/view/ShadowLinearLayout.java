...
public class ShadowLinearLayout extends LinearLayout {
    ...
    public ShadowLinearLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f20435d = obtainStyledAttributes.getColor(1, -16776961);
        this.f20436e = obtainStyledAttributes.getColor(0, ViewCompat.MEASURED_STATE_MASK);
        this.f20434c = obtainStyledAttributes.getDimensionPixelSize(2, 3);
        a();
    }
}
