...
public class BottomBarTab extends FrameLayout {
    ...
    private void a(Context context, int i2) {
        ...
        this.f20275a = (ImageView) inflate.findViewById(R.id.iv_tab_bar);
        this.f20276b = (TextView) inflate.findViewById(R.id.tv_tab_bar);
        this.f20277c = (TextView) inflate.findViewById(R.id.red_tip);
