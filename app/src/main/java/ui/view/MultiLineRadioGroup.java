...
public class MultiLineRadioGroup extends LinearLayout {
    ...
    private CompoundButton.OnCheckedChangeListener f14574b;
    ...
    private class b implements CompoundButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
            if (MultiLineRadioGroup.this.f14575c) {
                return;
            }
            MultiLineRadioGroup.this.f14575c = true;
            if (MultiLineRadioGroup.this.a != -1) {
                MultiLineRadioGroup multiLineRadioGroup = MultiLineRadioGroup.this;
                multiLineRadioGroup.a(multiLineRadioGroup.a, false);
            }
            MultiLineRadioGroup.this.f14575c = false;
        ...
        public void onChildViewAdded(View view, View view2) {
            ...
            if (view == multiLineRadioGroup && (listA = multiLineRadioGroup.a(view2)) != null && listA.size() > 0) {
                for (RadioButton radioButton : listA) {
                    ...
                    radioButton.setOnCheckedChangeListener(MultiLineRadioGroup.this.f14574b);
                }
            }
    ...
    public void setOnHierarchyChangeListener(ViewGroup.OnHierarchyChangeListener onHierarchyChangeListener) {
        this.f14577e.a = onHierarchyChangeListener;
    }

    private void b() {
        this.f14574b = new b();
        this.f14577e = new e();
        super.setOnHierarchyChangeListener(this.f14577e);
    }
