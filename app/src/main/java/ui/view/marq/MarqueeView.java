...
public class MarqueeView<T> extends ViewFlipper {
    ...
    class c implements Animation.AnimationListener {
        ...
        public void onAnimationEnd(Animation animation) {
            ...
            View a2 = marqueeView.a((MarqueeView) marqueeView.f20584l.get(MarqueeView.this.f20583k));
    ...
    public void b(String str, @AnimRes int i2, @AnimRes int i3) {
        ...
        int b2 = (int) c1.b(getContext(), getWidth());
        if (b2 == 0) {
            throw new RuntimeException("Please set the width of MarqueeView !");
        }
        int i4 = b2 / this.f20576d;
    ...
    private void a(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f20573a = obtainStyledAttributes.getInteger(4, this.f20573a);
        this.f20574b = obtainStyledAttributes.hasValue(0);
        this.f20575c = obtainStyledAttributes.getInteger(0, this.f20575c);
        this.f20578f = obtainStyledAttributes.getBoolean(5, false);
        if (obtainStyledAttributes.hasValue(7)) {
            this.f20576d = (int) obtainStyledAttributes.getDimension(7, this.f20576d);
            this.f20576d = c1.c(context, this.f20576d);
        }
        this.f20577e = obtainStyledAttributes.getColor(6, this.f20577e);
        ...
        if (obtainStyledAttributes.hasValue(1)) {
            this.f20580h = obtainStyledAttributes.getInt(1, this.f20580h);
            int i4 = this.f20580h;
            if (i4 == 0) {
                this.f20581i = R.anim.anim_bottom_in;
                this.f20582j = R.anim.anim_top_out;
    ...
    private void b(@AnimRes int i2, @AnimRes int i3) {
        ...
        if (this.f20574b) {
            loadAnimation.setDuration(this.f20575c);
        }
        setInAnimation(loadAnimation);
        Animation loadAnimation2 = AnimationUtils.loadAnimation(getContext(), i3);
        if (this.f20574b) {
            loadAnimation2.setDuration(this.f20575c);
        }
