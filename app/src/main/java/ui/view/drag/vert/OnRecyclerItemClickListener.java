...
public abstract class OnRecyclerItemClickListener implements RecyclerView.OnItemTouchListener {
    ...
    private class b extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDown(MotionEvent motionEvent) {
            ...
            View findChildViewUnder = OnRecyclerItemClickListener.this.f20540b.findChildViewUnder(motionEvent.getX(), motionEvent.getY());
            if (findChildViewUnder != null) {
                OnRecyclerItemClickListener.this.b(OnRecyclerItemClickListener.this.f20540b.getChildViewHolder(findChildViewUnder));
        ...
        public boolean onSingleTapUp(MotionEvent motionEvent) {
            ...
            OnRecyclerItemClickListener.this.a(OnRecyclerItemClickListener.this.f20540b.getChildViewHolder(findChildViewUnder));
            return true;
        }
    }
