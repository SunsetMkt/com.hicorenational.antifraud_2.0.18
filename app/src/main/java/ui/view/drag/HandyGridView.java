...
public class HandyGridView extends GridView implements AdapterView.OnItemLongClickListener, AdapterView.OnItemClickListener, ui.view.drag.e.a {
    ...
    private void c(int i2, int i3) {
        ui.view.drag.a a2 = this.f20501g.a(i2 - getFirstVisiblePosition());
        View view = a2.f20520b;
    ...
    private boolean a(View view) {
        int b2 = this.f20501g.b();
        for (int i2 = 0; i2 < b2; i2++) {
            ui.view.drag.a a2 = this.f20501g.a(i2);
            if (a2.f20520b == view) {
                return this.f20501g.a(a2);
            }
        }
        return false;
    }
