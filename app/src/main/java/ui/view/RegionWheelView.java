...
public class RegionWheelView extends LinearLayout {
    ...
    class b implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            List<?> a2 = regionWheelView3.f20394g.a(regionWheelView3.f20391d);
            if (a2.size() > 0) {
                RegionWheelView regionWheelView4 = RegionWheelView.this;
                regionWheelView4.f20389b = (b.a.a.d.d) a2.get(regionWheelView4.f20392e);
                RegionWheelView.this.f20398k.a(a2, RegionWheelView.this.f20392e);
            } else {
            ...
            List<?> a3 = regionWheelView6.f20394g.a(regionWheelView6.f20391d, regionWheelView6.f20392e);
            if (a3.size() > 0) {
                RegionWheelView regionWheelView7 = RegionWheelView.this;
                regionWheelView7.f20390c = (b.a.a.d.e) a3.get(regionWheelView7.f20393f);
                RegionWheelView.this.f20399l.a(a3, RegionWheelView.this.f20393f);
            } else {
    ...
    class c implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            RegionWheelView regionWheelView3 = RegionWheelView.this;
            regionWheelView3.f20393f = 0;
            List<?> a2 = regionWheelView3.f20394g.a(regionWheelView3.f20391d, regionWheelView3.f20392e);
            if (a2.size() > 0) {
                RegionWheelView regionWheelView4 = RegionWheelView.this;
                regionWheelView4.f20390c = (b.a.a.d.e) a2.get(regionWheelView4.f20393f);
                RegionWheelView.this.f20399l.a(a2, RegionWheelView.this.f20393f);
            } else {
                RegionWheelView regionWheelView5 = RegionWheelView.this;
                ...
                for (int i4 = 0; i4 < a2.size(); i4++) {
                    if (TextUtils.equals(((b.a.a.d.d) a2.get(i4)).getAreaId(), cityId)) {
                        ...
                        while (true) {
                            ...
                            if (TextUtils.equals(((b.a.a.d.e) a3.get(i2)).getAreaId(), districtId)) {
                                this.f20393f = i2;
                                this.f20390c = (b.a.a.d.e) a3.get(i2);
                                break;
                            }
                            i2++;
                        }
    ...
    public void a(ArrayList<b.a.a.d.k> arrayList) {
        ...
        if (arrayList != null || arrayList.size() > 0) {
            ...
            try {
                str = this.f20395h.get(this.f20391d).getCities().get(this.f20392e).getCounties().get(this.f20393f).getAreaName();
                try {
                    str2 = this.f20395h.get(this.f20391d).getCities().get(this.f20392e).getCounties().get(this.f20393f).getAreaId();
                } catch (Exception e2) {
                    e = e2;
                    e.printStackTrace();
                    if (county != null) {
