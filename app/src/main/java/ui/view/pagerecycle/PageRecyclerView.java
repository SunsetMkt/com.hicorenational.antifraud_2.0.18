...
public class PageRecyclerView extends RecyclerView {
    ...
    public class PageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i2) {
            ...
            RecyclerView.ViewHolder a2 = this.f20637b.a(viewGroup, i2);
            a2.itemView.measure(0, 0);
            a2.itemView.getLayoutParams().width = this.f20638c;
    ...
    public void a() {
        int ceil = (int) Math.ceil(this.f20625b.f20636a.size() / (this.f20630g * this.f20631h));
        if (ceil != this.f20632i) {
            PageIndicatorView pageIndicatorView = this.f20635l;
            if (pageIndicatorView != null) {
                pageIndicatorView.a(ceil);
            }
            int i2 = this.f20632i;
            if (ceil < i2 && this.f20633j == i2) {
                this.f20633j = ceil;
