...
public class FlayHeader extends InternalAbstract implements com.scwang.smartrefresh.layout.b.g {
    ...
    public void a(@NonNull com.scwang.smartrefresh.layout.b.j jVar, int i2, int i3) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(this.f14528d, "rotation", 0.0f, 360.0f);
    ...
    public void setPrimaryColors(int... iArr) {
        for (int i2 : iArr) {
            this.f14529e.setBackgroundColor(i2);
        }
    }
    ...
    public FlayHeader(Context context, AttributeSet attributeSet, int i2, @LayoutRes int i3) {
        ...
        this.f14528d = (ImageView) viewInflate.findViewById(R.id.header);
        this.f14529e = viewInflate.findViewById(R.id.primary);
    }
    ...
    public void a(@NonNull com.scwang.smartrefresh.layout.b.j jVar, @NonNull com.scwang.smartrefresh.layout.c.b bVar, @NonNull com.scwang.smartrefresh.layout.c.b bVar2) {
        ...
        if (i2 == 3) {
            this.f14528d.setImageResource(R.drawable.bg_record_time_cut);
        } else {
            if (i2 != 4) {
                return;
            }
            this.f14528d.setVisibility(0);
            this.f14528d.setImageResource(R.drawable.set_loading);
        }
    }
}
