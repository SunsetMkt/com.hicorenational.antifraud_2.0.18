...
/* JADX INFO: compiled from: ThreePicker.java */
/* JADX INFO: loaded from: classes2.dex */
public class x extends c.a.a.e.k {
    ...
    class a implements WheelView.g {
        ...
        public void a(int i2) {
            x.this.j0 = i2;
            if (x.this.m0 != null) {
                x.this.m0.g(x.this.j0, (String) x.this.g0.get(x.this.j0));
            }
        }
    }
    ...
    class b implements WheelView.g {
        ...
        public void a(int i2) {
            x.this.k0 = i2;
            if (x.this.m0 != null) {
                x.this.m0.f(x.this.k0, (String) x.this.h0.get(x.this.k0));
            }
        }
    }
    ...
    class c implements WheelView.g {
        ...
        public void a(int i2) {
            x.this.l0 = i2;
            if (x.this.m0 != null) {
                x.this.m0.f(x.this.l0, (String) x.this.i0.get(x.this.l0));
            }
        }
    }
    ...
    public x(Activity activity, List<String> list, List<String> list2, List<String> list3) {
        super(activity);
