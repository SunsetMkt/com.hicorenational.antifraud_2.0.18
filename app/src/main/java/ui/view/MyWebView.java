...
public class MyWebView extends WebView {
    ...
    public class a {
        ...
        public void sendWebMsg(String str) {
            ...
            s1.b("sendWebMsg-->" + str);
            MyWebView.this.mOnWebListener.shouldIntercept(util.o2.c.b(str));
        }
    }
    ...
    public static String getH5Data() {
        ...
        map.put("deviceid", d2.l());
        String str = "0";
        map.put("os-version", "0");
        map.put("market", Hicore.getApp().getChannel());
        map.put("app-version", d2.o());
        map.put("app-version-code", d2.n() + "");
    ...
    protected void initWebView(WebView webView) {
        ...
        settings.setAppCacheMaxSize(m0.f12222b);
