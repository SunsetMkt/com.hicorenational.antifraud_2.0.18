...
public class MaskView extends AppCompatImageView {
    ...
    private void a(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.f20363f = obtainStyledAttributes.getColor(3, -1);
        this.f20364g = obtainStyledAttributes.getDimensionPixelOffset(4, 1);
        this.f20365h = obtainStyledAttributes.getInt(2, 30);
        this.f20366i = obtainStyledAttributes.getColor(1, 16777215);
        this.f20367j = obtainStyledAttributes.getInt(0, 255);
        a();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float height = this.f20360c.height();
        ...
        canvas.drawCircle(f2, f3, min, this.f20358a);
        super.onDraw(canvas);
    }
