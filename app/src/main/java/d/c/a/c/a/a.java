...
import d.c.a.c.a.b.b;
import d.c.a.d.j;
import java.util.List;
import l.a.a.a.j.e;

/* JADX INFO: compiled from: HonorIdSignInManager.java */
...
public final class a {
    ...
    public static void a(Activity activity, int i2, SignInOptions signInOptions) {
        ...
        if (!l.a.a.a.b.b(signInOptions.f())) {
    ...
    public static d.c.a.c.a.c.a b(Activity activity, SignInOptions signInOptions) {
        l.a.a.a.a.a(activity, "Null activity is not permitted.");
        return new d.c.a.c.a.c.b(activity, signInOptions);
    }

    public static boolean a(Context context, SignInAccountInfo signInAccountInfo, List<Scope> list) {
        l.a.a.a.a.a(context, "Null context is not permitted.");
        if (signInAccountInfo == null || l.a.a.a.b.a(list)) {
            return false;
        }
        return b.a(context, signInAccountInfo, list);
    }

    public static d.c.a.c.a.c.a a(Context context, SignInOptions signInOptions) {
        l.a.a.a.a.a(context, "Null context is not permitted.");
        return new d.c.a.c.a.c.b(context, signInOptions);
    }
