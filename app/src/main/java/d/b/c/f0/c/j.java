...
public final class j {
    ...
    private static final int[] f9790e = {31892, 34236, 39577, 42195, 48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361, 96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589, 136944, 141498, 145311, 150283, 152622, 158308, 161089, 167017};

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final j[] f9791f = f();
    private final int a;
    ...
    public b a(f fVar) {
        return this.f9793c[fVar.ordinal()];
    }
    ...
    public static j b(int i2) throws d.b.c.h {
        if (i2 % 4 != 1) {
    ...
    d.b.c.z.b a() {
        int iC = c();
        d.b.c.z.b bVar = new d.b.c.z.b(iC);
        bVar.a(0, 0, 9, 9);
        int i2 = iC - 8;
        bVar.a(i2, 0, 8, 9);
        bVar.a(0, i2, 9, 8);
        int length = this.f9792b.length;
        for (int i3 = 0; i3 < length; i3++) {
            int i4 = this.f9792b[i3] - 2;
            for (int i5 = 0; i5 < length; i5++) {
                if ((i3 != 0 || (i5 != 0 && i5 != length - 1)) && (i3 != length - 1 || i5 != 0)) {
                    bVar.a(this.f9792b[i5] - 2, i4, 5, 5);
                }
            }
        }
        int i6 = iC - 17;
