...
final class a {
    ...
    a(d.b.c.z.b bVar) throws d.b.c.h {
        int iD = bVar.d();
        if (iD < 21 || (iD & 3) != 1) {
    ...
    private int a(int i2, int i3, int i4) {
        return this.f9782d ? this.a.b(i3, i2) : this.a.b(i2, i3) ? (i4 << 1) | 1 : i4 << 1;
    }

    byte[] b() throws d.b.c.h {
        g gVarC = c();
        j jVarD = d();
        c cVarA = c.a(gVarC.a());
        int iD = this.a.d();
        cVarA.a(this.a, iD);
        d.b.c.z.b bVarA = jVarD.a();
