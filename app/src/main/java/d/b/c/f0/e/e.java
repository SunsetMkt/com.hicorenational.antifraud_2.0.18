...
final class e {
    ...
    private static final int[][] f9825b = {new int[]{1, 1, 1, 1, 1}, new int[]{1, 0, 0, 0, 1}, new int[]{1, 0, 1, 0, 1}, new int[]{1, 0, 0, 0, 1}, new int[]{1, 1, 1, 1, 1}};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final int[][] f9826c = {new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, 106, -1, -1}, new int[]{6, 32, 58, 84, 110, -1, -1}, new int[]{6, 30, 58, 86, 114, -1, -1}, new int[]{6, 34, 62, 90, 118, -1, -1}, new int[]{6, 26, 50, 74, 98, 122, -1}, new int[]{6, 30, 54, 78, 102, 126, -1}, new int[]{6, 26, 52, 78, 104, 130, -1}, new int[]{6, 30, 56, 82, 108, 134, -1}, new int[]{6, 34, 60, 86, 112, 138, -1}, new int[]{6, 30, 58, 86, 114, 142, -1}, new int[]{6, 34, 62, 90, 118, 146, -1}, new int[]{6, 30, 54, 78, 102, 126, 150}, new int[]{6, 24, 50, 76, 102, 128, 154}, new int[]{6, 28, 54, 80, 106, 132, TinkerReport.KEY_APPLIED_PACKAGE_CHECK_TINKERFLAG_NOT_SUPPORT}, new int[]{6, 32, 58, 84, 110, 136, 162}, new int[]{6, 26, 54, 82, 110, 138, PictureConfig.PREVIEW_VIDEO_CODE}, new int[]{6, 30, 58, 86, 114, 142, 170}};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int[][] f9827d = {new int[]{8, 0}, new int[]{8, 1}, new int[]{8, 2}, new int[]{8, 3}, new int[]{8, 4}, new int[]{8, 5}, new int[]{8, 7}, new int[]{8, 8}, new int[]{7, 8}, new int[]{5, 8}, new int[]{4, 8}, new int[]{3, 8}, new int[]{2, 8}, new int[]{1, 8}, new int[]{0, 8}};

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final int f9828e = 7973;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final int f9829f = 1335;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final int f9830g = 21522;
    ...
    static void a(d.b.c.z.a aVar, d.b.c.f0.c.f fVar, j jVar, int i2, b bVar) throws w {
        a(bVar);
        a(jVar, bVar);
        a(fVar, i2, bVar);
        c(jVar, bVar);
    ...
    private static void b(int i2, int i3, b bVar) {
        for (int i4 = 0; i4 < 5; i4++) {
            for (int i5 = 0; i5 < 5; i5++) {
                bVar.a(i2 + i5, i3 + i4, f9825b[i4][i5]);
            }
        }
    }
    ...
    static void a(d.b.c.f0.c.f fVar, int i2, b bVar) throws w {
        d.b.c.z.a aVar = new d.b.c.z.a();
        a(fVar, i2, aVar);
    ...
    static void a(d.b.c.z.a aVar, int i2, b bVar) throws w {
        boolean zB;
        int iC = bVar.c() - 1;
        int iB = bVar.b() - 1;
        int i3 = 0;
    ...
    static void a(d.b.c.f0.c.f fVar, int i2, d.b.c.z.a aVar) throws w {
        if (f.b(i2)) {
            int bits = (fVar.getBits() << 3) | i2;
            aVar.a(bits, 5);
            aVar.a(a(bits, f9829f), 10);
            d.b.c.z.a aVar2 = new d.b.c.z.a();
            aVar2.a(f9830g, 15);
            aVar.b(aVar2);
            if (aVar.c() == 15) {
                return;
    ...
    static void a(j jVar, d.b.c.z.a aVar) throws w {
        aVar.a(jVar.e(), 6);
        aVar.a(a(jVar.e(), f9828e), 12);
        if (aVar.c() == 18) {
            return;
        }
        throw new w("should not happen but we got: " + aVar.c());
