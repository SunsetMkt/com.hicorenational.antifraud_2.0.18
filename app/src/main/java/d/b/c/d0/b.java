...
public final class b extends r {
    ...
    private static final char[] f9605b = {'T', 'N', '*', 'E'};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final char[] f9606c = {'/', ':', '+', '.'};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final char f9607d = a[0];

    @Override // d.b.c.d0.r
    public boolean[] a(String str) {
        int i2;
        if (str.length() < 2) {
            str = f9607d + str + f9607d;
        } else {
            char upperCase = Character.toUpperCase(str.charAt(0));
            char upperCase2 = Character.toUpperCase(str.charAt(str.length() - 1));
            boolean zA = a.a(a, upperCase);
            boolean zA2 = a.a(a, upperCase2);
            boolean zA3 = a.a(f9605b, upperCase);
            boolean zA4 = a.a(f9605b, upperCase2);
            if (zA) {
                if (!zA2) {
