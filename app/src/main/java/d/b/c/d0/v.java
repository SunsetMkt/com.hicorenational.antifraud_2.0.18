...
final class v {
    ...
    private static final int[] f9660c = {24, 20, 18, 17, 12, 6, 3, 10, 9, 5};
    private final int[] a = new int[4];

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final StringBuilder f9661b = new StringBuilder();

    v() {
    }

    private static Map<d.b.c.s, Object> b(String str) {
        String strA;
        if (str.length() != 5 || (strA = a(str)) == null) {
            return null;
        }
        EnumMap enumMap = new EnumMap(d.b.c.s.class);
        enumMap.put(d.b.c.s.SUGGESTED_PRICE, strA);
        return enumMap;
    }

    d.b.c.r a(int i2, d.b.c.z.a aVar, int[] iArr) throws d.b.c.m {
        StringBuilder sb = this.f9661b;
        sb.setLength(0);
        int iA = a(aVar, iArr, sb);
        String string = sb.toString();
        Map<d.b.c.s, Object> mapB = b(string);
        float f2 = i2;
    ...
    private static int a(int i2) throws d.b.c.m {
