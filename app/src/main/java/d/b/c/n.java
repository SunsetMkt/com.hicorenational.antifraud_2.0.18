...
public final class n extends j {
    ...
    private static final int f9839h = 2;
    ...
    public byte[] a(int i2, byte[] bArr) {
        ...
        System.arraycopy(this.f9840c, ((i2 + this.f9844g) * this.f9841d) + this.f9843f, bArr, 0, iC);
        return bArr;
    }
    ...
    public byte[] b() {
        int iC = c();
        int iA = a();
        if (iC == this.f9841d && iA == this.f9842e) {
            return this.f9840c;
        }
        int i2 = iC * iA;
        ...
        int i3 = this.f9844g;
        int i4 = this.f9841d;
        int i5 = (i3 * i4) + this.f9843f;
        if (iC == i4) {
            System.arraycopy(this.f9840c, i5, bArr, 0, i2);
            return bArr;
        }
    ...
    public int[] k() {
        ...
        int i2 = (this.f9844g * this.f9841d) + this.f9843f;
        for (int i3 = 0; i3 < iA; i3++) {
            int i4 = i3 * iC;
            for (int i5 = 0; i5 < iC; i5++) {
                iArr[i4 + i5] = ((bArr[(i5 * 2) + i2] & f1.f12066c) * 65793) | ViewCompat.MEASURED_STATE_MASK;
            }
            i2 += this.f9841d * 2;
        }
        return iArr;
    ...
    public j a(int i2, int i3, int i4, int i5) {
        return new n(this.f9840c, this.f9841d, this.f9842e, this.f9843f + i2, this.f9844g + i3, i4, i5, false);
    }

    private void a(int i2, int i3) {
        byte[] bArr = this.f9840c;
        int i4 = (this.f9844g * this.f9841d) + this.f9843f;
        int i5 = 0;
        while (i5 < i3) {
            int i6 = (i2 / 2) + i4;
            int i7 = (i4 + i2) - 1;
