...
public final class d {
    ...
    private final List<b> f10059b = new ArrayList();

    public d(a aVar) {
        this.a = aVar;
        this.f10059b.add(new b(aVar, new int[]{1}));
    }

    private b a(int i2) {
        if (i2 >= this.f10059b.size()) {
            List<b> list = this.f10059b;
            b bVarC = list.get(list.size() - 1);
            for (int size = this.f10059b.size(); size <= i2; size++) {
                a aVar = this.a;
                bVarC = bVarC.c(new b(aVar, new int[]{1, aVar.a((size - 1) + aVar.a())}));
                this.f10059b.add(bVarC);
            }
        }
        return this.f10059b.get(i2);
    }
