...
public final class k {
    ...
    public void a(float[] fArr) {
        ...
        float f2 = this.a;
        float f3 = this.f10022b;
        float f4 = this.f10023c;
        float f5 = this.f10024d;
        float f6 = this.f10025e;
        float f7 = this.f10026f;
        float f8 = this.f10027g;
        float f9 = this.f10028h;
        float f10 = this.f10029i;
    ...
    public void a(float[] fArr, float[] fArr2) {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            float f2 = fArr[i2];
            float f3 = fArr2[i2];
            float f4 = (this.f10023c * f2) + (this.f10026f * f3) + this.f10029i;
            fArr[i2] = (((this.a * f2) + (this.f10024d * f3)) + this.f10027g) / f4;
            fArr2[i2] = (((this.f10022b * f2) + (this.f10025e * f3)) + this.f10028h) / f4;
        }
    }
    ...
    k a() {
        ...
        float f3 = this.f10029i;
        float f4 = this.f10026f;
        float f5 = this.f10028h;
        float f6 = (f2 * f3) - (f4 * f5);
        float f7 = this.f10027g;
        float f8 = this.f10024d;
        float f9 = (f4 * f7) - (f8 * f3);
        float f10 = (f8 * f5) - (f2 * f7);
        float f11 = this.f10023c;
        float f12 = this.f10022b;
    ...
    k a(k kVar) {
        float f2 = this.a;
        float f3 = kVar.a;
        float f4 = this.f10024d;
        float f5 = kVar.f10022b;
        float f6 = this.f10027g;
        float f7 = kVar.f10023c;
        float f8 = (f2 * f3) + (f4 * f5) + (f6 * f7);
        float f9 = kVar.f10024d;
        float f10 = kVar.f10025e;
        float f11 = kVar.f10026f;
        float f12 = (f2 * f9) + (f4 * f10) + (f6 * f11);
        float f13 = kVar.f10027g;
        float f14 = kVar.f10028h;
        float f15 = kVar.f10029i;
        float f16 = (f2 * f13) + (f4 * f14) + (f6 * f15);
        float f17 = this.f10022b;
        float f18 = this.f10025e;
        float f19 = this.f10028h;
        float f20 = (f17 * f3) + (f18 * f5) + (f19 * f7);
        float f21 = (f17 * f9) + (f18 * f10) + (f19 * f11);
        float f22 = (f19 * f15) + (f17 * f13) + (f18 * f14);
        float f23 = this.f10023c;
        float f24 = this.f10026f;
        float f25 = (f3 * f23) + (f5 * f24);
        float f26 = this.f10029i;
