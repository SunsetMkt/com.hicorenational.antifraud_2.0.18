...
final class b {
    ...
    b(a aVar, int[] iArr) {
        ...
        if (i2 == length) {
            this.f10058b = new int[]{0};
            return;
        }
        this.f10058b = new int[length - i2];
        int[] iArr2 = this.f10058b;
    ...
    int b() {
        return this.f10058b.length - 1;
    }

    boolean c() {
        return this.f10058b[0] == 0;
    }
    ...
    int a(int i2) {
        ...
        int[] iArr = this.f10058b;
        int length = iArr.length;
        if (i2 != 1) {
            int iC = iArr[0];
            for (int i3 = 1; i3 < length; i3++) {
                iC = a.c(this.a.b(i2, iC), this.f10058b[i3]);
            }
            return iC;
        }
        int iC2 = 0;
    ...
    int b(int i2) {
        return this.f10058b[(r0.length - 1) - i2];
    }
    ...
    b c(int i2) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            iArr[i3] = this.a.b(this.f10058b[i3], i2);
        }
    ...
    b a(int i2, int i3) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            iArr[i4] = this.a.b(this.f10058b[i4], i3);
        }
        return new b(this.a, iArr);
    }
}
