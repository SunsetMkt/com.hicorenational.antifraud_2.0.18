...
public final class d implements v {
    ...
    public d.b.c.z.b a(String str, d.b.c.a aVar, int i2, int i3, Map<g, ?> map) throws w {
        ...
        if (map != null) {
            ...
            if (map.containsKey(g.PDF417_COMPACTION)) {
                eVar.a((d.b.c.e0.g.c) map.get(g.PDF417_COMPACTION));
            }
            if (map.containsKey(g.PDF417_DIMENSIONS)) {
                d.b.c.e0.g.d dVar = (d.b.c.e0.g.d) map.get(g.PDF417_DIMENSIONS);
    ...
    private static d.b.c.z.b a(e eVar, String str, int i2, int i3, int i4, int i5) throws w {
        boolean z;
        eVar.a(str, i2);
    ...
    private static d.b.c.z.b a(byte[][] bArr, int i2) {
        int i3 = i2 * 2;
        d.b.c.z.b bVar = new d.b.c.z.b(bArr[0].length + i3, bArr.length + i3);
        bVar.a();
        int iD = (bVar.d() - i2) - 1;
        int i4 = 0;
