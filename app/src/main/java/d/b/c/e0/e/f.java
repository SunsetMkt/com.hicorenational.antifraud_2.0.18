...
final class f {
    ...
    private static final int f9718e = 2;
    private final a a;
    ...
    f(a aVar, c cVar) {
        ...
        this.f9721d = aVar.a();
        this.f9720c = cVar;
        this.f9719b = new g[this.f9721d + 2];
    }
    ...
    private int f() {
        ...
        for (int i2 = 1; i2 < this.f9721d + 1; i2++) {
            d[] dVarArrB = this.f9719b[i2].b();
    ...
    private void h() {
        g[] gVarArr = this.f9719b;
        if (gVarArr[0] == null || gVarArr[this.f9721d + 1] == null) {
            return;
        }
        d[] dVarArrB = gVarArr[0].b();
        d[] dVarArrB2 = this.f9719b[this.f9721d + 1].b();
        for (int i2 = 0; i2 < dVarArrB.length; i2++) {
            if (dVarArrB[i2] != null && dVarArrB2[i2] != null && dVarArrB[i2].c() == dVarArrB2[i2].c()) {
                for (int i3 = 1; i3 <= this.f9721d; i3++) {
                    d dVar = this.f9719b[i3].b()[i2];
                    if (dVar != null) {
                        dVar.b(dVarArrB[i2].c());
                        if (!dVar.g()) {
                            this.f9719b[i3].b()[i2] = null;
                        }
                    }
                }
            }
    ...
    private int i() {
        ...
        for (int i3 = 0; i3 < dVarArrB.length; i3++) {
            if (dVarArrB[i3] != null) {
                ...
                int i4 = i2;
                int iA = 0;
                for (int i5 = 1; i5 < this.f9721d + 1 && iA < 2; i5++) {
                    d dVar = this.f9719b[i5].b()[i3];
                    if (dVar != null) {
                        iA = a(iC, iA, dVar);
                        if (!dVar.g()) {
                            i4++;
    ...
    private int j() {
        ...
        for (int i4 = 0; i4 < dVarArrB.length; i4++) {
            if (dVarArrB[i4] != null) {
                ...
                int i5 = i3;
                int iA = 0;
                for (int i6 = this.f9721d + 1; i6 > 0 && iA < 2; i6--) {
                    d dVar = this.f9719b[i6].b()[i4];
                    if (dVar != null) {
                        iA = a(iC, iA, dVar);
                        if (!dVar.g()) {
                            i5++;
    ...
    g[] e() {
        a(this.f9719b[0]);
        a(this.f9719b[this.f9721d + 1]);
        int i2 = d.b.c.e0.a.f9675b;
        while (true) {
            int iF = f();
            if (iF <= 0 || iF >= i2) {
                break;
    ...
    public String toString() {
        ...
        g gVar = gVarArr[0];
        if (gVar == null) {
            gVar = gVarArr[this.f9721d + 1];
        }
        Formatter formatter = new Formatter();
        for (int i2 = 0; i2 < gVar.b().length; i2++) {
            formatter.format("CW %3d:", Integer.valueOf(i2));
            for (int i3 = 0; i3 < this.f9721d + 2; i3++) {
                g[] gVarArr2 = this.f9719b;
                if (gVarArr2[i3] == null) {
