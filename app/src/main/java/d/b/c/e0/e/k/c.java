...
final class c {
    ...
    c(b bVar, int[] iArr) {
        ...
        if (i2 == length) {
            this.f9733b = new int[]{0};
            return;
        }
        this.f9733b = new int[length - i2];
    ...
    int b() {
        return this.f9733b.length - 1;
    }

    boolean c() {
        return this.f9733b[0] == 0;
    }
    ...
    int a(int i2) {
        ...
        if (i2 != 1) {
            ...
            for (int i3 = 1; i3 < length; i3++) {
                b bVar = this.a;
                iA = bVar.a(bVar.c(i2, iA), this.f9733b[i3]);
            }
            return iA;
        }
        int iA2 = 0;
    ...
    int b(int i2) {
        return this.f9733b[(r0.length - 1) - i2];
    }
    ...
    c[] b(c cVar) {
        if (this.a.equals(cVar.a)) {
            if (!cVar.c()) {
                c cVarC = this.a.c();
                int iB = this.a.b(cVar.b(cVar.b()));
                c cVarA = cVarC;
                c cVarD = this;
                while (cVarD.b() >= cVar.b() && !cVarD.c()) {
                    int iB2 = cVarD.b() - cVar.b();
                    int iC = this.a.c(cVarD.b(cVarD.b()), iB);
                    c cVarA2 = cVar.a(iB2, iC);
                    cVarA = cVarA.a(this.a.b(iB2, iC));
    ...
    c d() {
        ...
        for (int i2 = 0; i2 < length; i2++) {
            iArr[i2] = this.a.d(0, this.f9733b[i2]);
        }
    ...
    c c(int i2) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            iArr[i3] = this.a.c(this.f9733b[i3], i2);
        }
        return new c(this.a, iArr);
    }
    ...
    c a(int i2, int i3) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            iArr[i4] = this.a.c(this.f9733b[i4], i3);
        }
        return new c(this.a, iArr);
    }
}
