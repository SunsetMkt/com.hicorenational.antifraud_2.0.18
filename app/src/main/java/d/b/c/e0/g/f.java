...
final class f {
    ...
    static String a(CharSequence charSequence, int i2) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            int iCharAt = (charSequence.charAt(i3) + cArr[cArr.length - 1]) % d.b.c.e0.a.a;
            for (int i4 = iA - 1; i4 >= 1; i4--) {
                cArr[i4] = (char) ((cArr[i4 - 1] + (929 - ((a[i2][i4] * iCharAt) % d.b.c.e0.a.a))) % d.b.c.e0.a.a);
            }
            cArr[0] = (char) ((929 - ((iCharAt * a[i2][0]) % d.b.c.e0.a.a)) % d.b.c.e0.a.a);
        }
        StringBuilder sb = new StringBuilder(iA);
        for (int i5 = iA - 1; i5 >= 0; i5--) {
            if (cArr[i5] != 0) {
                cArr[i5] = (char) ('\u03a1' - cArr[i5]);
            }
            sb.append(cArr[i5]);
        }
        return sb.toString();
