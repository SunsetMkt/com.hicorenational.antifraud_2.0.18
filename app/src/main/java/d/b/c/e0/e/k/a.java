...
public final class a {
            ...
            if (cVar.b() >= i2 / 2) {
                if (!cVar.c()) {
                    ...
                    while (cVar2.b() >= cVar.b() && !cVar2.c()) {
                        ...
                        int iC = this.a.c(cVar2.b(cVar2.b()), iB);
                        cVarC2 = cVarC2.a(this.a.b(iB2, iC));
    ...
    private int[] a(c cVar) throws d {
        ...
        int[] iArr = new int[iB];
        int i2 = 0;
        for (int i3 = 1; i3 < this.a.b() && i2 < iB; i3++) {
            if (cVar.a(i3) == 0) {
                iArr[i2] = this.a.b(i3);
                i2++;
            }
    ...
    private int[] a(c cVar, c cVar2, int[] iArr) {
        ...
        for (int i2 = 1; i2 <= iB; i2++) {
            iArr2[iB - i2] = this.a.c(i2, cVar2.b(i2));
        }
        c cVar3 = new c(this.a, iArr2);
        int length = iArr.length;
        int[] iArr3 = new int[length];
        for (int i3 = 0; i3 < length; i3++) {
            int iB2 = this.a.b(iArr[i3]);
            iArr3[i3] = this.a.c(this.a.d(0, cVar.a(iB2)), this.a.b(cVar3.a(iB2)));
        }
        return iArr3;
    }
}
