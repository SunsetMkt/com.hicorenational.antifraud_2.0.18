...
public final class c {
    ...
    private final d.b.c.z.n.c a = new d.b.c.z.n.c(d.b.c.z.n.a.o);

    public e a(d.b.c.z.b bVar) throws d, h {
        return a(bVar, null);
    }

    public e a(d.b.c.z.b bVar, Map<d.b.c.e, ?> map) throws d, h {
        byte[] bArr;
        byte[] bArrA = new a(bVar).a();
        a(bArrA, 0, 10, 10, 0);
        int i2 = bArrA[0] & cw.f7205m;
        if (i2 == 2 || i2 == 3 || i2 == 4) {
            a(bArrA, 20, 84, 40, 1);
            a(bArrA, 20, 84, 40, 2);
            bArr = new byte[94];
    ...
    private void a(byte[] bArr, int i2, int i3, int i4, int i5) throws d {
        ...
        for (int i8 = 0; i8 < i6; i8++) {
            if (i5 == 0 || i8 % 2 == i5 - 1) {
                iArr[i8 / i7] = bArr[i8 + i2] & f1.f12066c;
            }
        }
        try {
            this.a.a(iArr, i4 / i7);
