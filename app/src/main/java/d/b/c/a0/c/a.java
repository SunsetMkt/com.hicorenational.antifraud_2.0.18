...
final class a {
    ...
    private final d.b.c.z.b f9450b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final e f9451c;

    a(d.b.c.z.b bVar) throws h {
        int iD = bVar.d();
        ...
        this.f9451c = b(bVar);
        this.a = a(bVar);
        this.f9450b = new d.b.c.z.b(this.a.g(), this.a.d());
    }

    private static e b(d.b.c.z.b bVar) throws h {
    ...
    byte[] b() throws h {
        byte[] bArr = new byte[this.f9451c.f()];
        int iD = this.a.d();
        int iG = this.a.g();
        int i2 = 4;
        int i3 = 0;
        ...
        while (true) {
            if (i2 == iD && i3 == 0 && !z) {
                ...
                if (i2 == i5 && i3 == 0 && (iG & 3) != 0 && !z2) {
                    ...
                    do {
                        if (i2 < iD && i3 >= 0 && !this.f9450b.b(i3, i2)) {
                    ...
                    int i7 = i3 + 3;
                    do {
                        if (i6 >= 0 && i7 < iG && !this.f9450b.b(i7, i6)) {
    ...
    d.b.c.z.b a(d.b.c.z.b bVar) {
        int iE = this.f9451c.e();
        int iD = this.f9451c.d();
        if (bVar.d() == iE) {
            int iB = this.f9451c.b();
            int iA = this.f9451c.a();
            int i2 = iE / iB;
            int i3 = iD / iA;
            d.b.c.z.b bVar2 = new d.b.c.z.b(i3 * iA, i2 * iB);
