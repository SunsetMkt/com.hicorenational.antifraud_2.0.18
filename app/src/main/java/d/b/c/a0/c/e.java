...
public final class e {
    ...
    private static final e[] f9457h = h();
    private final int a;
    ...
    static final class c {
        ...
        private c(int i2, b bVar) {
            this.a = i2;
            this.f9465b = new b[]{bVar};
        }

        private c(int i2, b bVar, b bVar2) {
            this.a = i2;
            this.f9465b = new b[]{bVar, bVar2};
        }
    }
    ...
    public static e a(int i2, int i3) throws h {
        ...
        for (e eVar : f9457h) {
            if (eVar.f9458b == i2 && eVar.f9459c == i3) {
                return eVar;
            }
        }
        throw h.getFormatInstance();
