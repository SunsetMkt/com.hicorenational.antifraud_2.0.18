...
/* JADX INFO: compiled from: VINResultParser.java */
/* JADX INFO: loaded from: classes.dex */
public final class i0 extends u {

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f9954f = Pattern.compile("[IOQ]");

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final Pattern f9955g = Pattern.compile("[A-Z0-9]{17}");
    ...
    public h0 a(d.b.c.r rVar) {
        if (rVar.a() != d.b.c.a.CODE_39) {
            return null;
        }
        String strTrim = f9954f.matcher(rVar.e()).replaceAll("").trim();
        if (!f9955g.matcher(strTrim).matches()) {
            return null;
        }
        try {
