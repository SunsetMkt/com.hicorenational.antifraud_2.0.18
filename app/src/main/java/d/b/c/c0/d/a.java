...
/* JADX INFO: compiled from: QRCodeMultiReader.java */
/* JADX INFO: loaded from: classes.dex */
public final class a extends d.b.c.f0.a implements c {

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final r[] f9529c = new r[0];

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final t[] f9530d = new t[0];
    ...
    private static List<r> a(List<r> list) {
        ...
        r rVar4 = new r(sb.toString(), bArr, f9530d, d.b.c.a.QR_CODE);
        if (length2 > 0) {
    ...
    public r[] b(d.b.c.c cVar, Map<e, ?> map) throws m {
        ArrayList arrayList = new ArrayList();
        for (g gVar : new d.b.c.c0.d.b.a(cVar.a()).b(map)) {
            try {
                d.b.c.z.e eVarA = a().a(gVar.a(), map);
                t[] tVarArrB = gVar.b();
