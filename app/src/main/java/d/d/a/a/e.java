...
/* JADX INFO: compiled from: V2SchemeUtil.java */
/* JADX INFO: loaded from: classes.dex */
public class e {
    public static Map<Integer, ByteBuffer> a(ByteBuffer byteBuffer) throws a.c {
        d.d.a.a.f.a.a(byteBuffer);
        ByteBuffer byteBufferA = d.d.a.a.f.a.a(byteBuffer, 8, byteBuffer.capacity() - 24);
        ...
        while (byteBufferA.hasRemaining()) {
            ...
            linkedHashMap.put(Integer.valueOf(i4), d.d.a.a.f.a.a(byteBufferA, i3 - 4));
            if (i4 == 1896449818) {
    ...
    public static ByteBuffer b(File file) throws Throwable {
        ...
        try {
            ...
            ByteBuffer byteBufferA2 = d.d.a.a.f.a.a(randomAccessFile, d.d.a.a.f.a.a(byteBufferA, jLongValue)).a();
    ...
    public static a a(File file, boolean z) throws Throwable {
        ...
        try {
            ...
            long jLongValue = cVarB.b().longValue();
            if (!d.d.a.a.f.b.a(randomAccessFile, jLongValue)) {
                long jA = d.d.a.a.f.a.a(byteBufferA, jLongValue);
                c<ByteBuffer, Long> cVarA = d.d.a.a.f.a.a(randomAccessFile, jA);
                c<ByteBuffer, Long> cVarA2 = a(randomAccessFile, jA, (int) (jLongValue - jA));
                a aVar = new a();
                aVar.a = z;
                aVar.f10103b = file.length();
                if (!z) {
                    aVar.f10104c = a(randomAccessFile, (int) cVarA.b().longValue());
                }
                aVar.f10105d = cVarA;
                aVar.f10106e = cVarA2;
                aVar.f10107f = cVarB;
    ...
    public static ByteBuffer a(Map<Integer, ByteBuffer> map) {
        if (map != null && !map.isEmpty()) {
            ...
            byteBufferAllocate.putLong(jRemaining);
            byteBufferAllocate.putLong(d.d.a.a.f.a.f10124n);
            byteBufferAllocate.putLong(d.d.a.a.f.a.f10123m);
    ...
    public static boolean a(String str) throws Exception {
        return d.d.a.a.f.a.a(str);
    }

    public static boolean a(File file) {
        try {
            return a(b(file)).containsKey(Integer.valueOf(d.d.a.a.f.a.p));
        } catch (a.c unused) {
