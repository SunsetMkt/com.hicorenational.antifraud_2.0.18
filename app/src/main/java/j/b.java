...
public class b implements ImageEngine {
    ...
    class a extends j<Bitmap> {
        ...
        public void a(@Nullable Bitmap bitmap) {
            ...
            if (bitmap != null) {
                ...
                this.f16995l.setVisibility(isLongImg ? 0 : 8);
                this.f16996m.setVisibility(isLongImg ? 8 : 0);
                if (isLongImg) {
    ...
    class C0263b extends j<Bitmap> {
        ...
        public void a(@Nullable Bitmap bitmap) {
            if (bitmap != null) {
                boolean isLongImg = MediaUtils.isLongImg(bitmap.getWidth(), bitmap.getHeight());
                this.f16997k.setVisibility(isLongImg ? 0 : 8);
                this.f16998l.setVisibility(isLongImg ? 8 : 0);
                if (!isLongImg) {
    ...
    class c extends com.bumptech.glide.r.l.c {
        ...
        public void a(Bitmap bitmap) {
            RoundedBitmapDrawable create = RoundedBitmapDrawableFactory.create(this.f17000k.getResources(), bitmap);
            create.setCornerRadius(8.0f);
            this.f17001l.setImageDrawable(create);
        }
    }
