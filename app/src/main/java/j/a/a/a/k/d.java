...
public class d extends g {
    ...
    void a(byte[] bArr, int i2, int i3) {
        ...
        if (!this.f12455i || this.f12457k == 0) {
            return;
        }
        a(this.u);
    ...
    void b(byte[] bArr, int i2, int i3) {
        ...
        if (i3 >= 0) {
            ...
            while (i5 < i3) {
                ...
                if (this.f12457k == 0) {
                    ...
                    this.f12456j += 4;
                    int i13 = this.f12450d;
                    if (i13 > 0 && i13 <= this.f12456j) {
                        byte[] bArr4 = this.t;
                        System.arraycopy(bArr4, 0, bArr2, this.f12453g, bArr4.length);
                        this.f12453g += this.t.length;
                        this.f12456j = 0;
                    }
                }
                i5++;
        ...
        int i24 = this.f12456j;
        int i25 = this.f12453g;
        this.f12456j = i24 + (i25 - i14);
        if (this.f12450d <= 0 || this.f12456j <= 0) {
            return;
        }
        byte[] bArr9 = this.t;
        System.arraycopy(bArr9, 0, this.f12452f, i25, bArr9.length);
        this.f12453g += this.t.length;
    }
