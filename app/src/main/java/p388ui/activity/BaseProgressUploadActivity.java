...
public abstract class BaseProgressUploadActivity extends BaseActivity {
    ...
    /* renamed from: ui.activity.BaseProgressUploadActivity$a */
    class C6144a implements IClickListener {
        ...
        public void cancelBtn() {
            try {
                if (BaseProgressUploadActivity.this.mStateList.get(this.f21873a).getUploadState() == 1) {
                    try {
                ...
                BaseProgressUploadActivity.this.deteleUpload(this.f21873a);
                BaseProgressUploadActivity.this.clearItem(this.f21873a);
    ...
    /* renamed from: ui.activity.BaseProgressUploadActivity$b */
    class C6145b implements IClickListener {
        C6145b() {
        }
    ...
    public void backDialog() {
        C7257b1.m26183a(this.mActivity, "有未上传成功的文件，确定返回？", "", "是", "否", C2113R.color._353536, -1, (IClickListener) new C6145b());
    }
    ...
    public void deleteDialog(int i2) {
        ...
        if (uploadState != 0) {
            if (uploadState == 1) {
                C7257b1.m26183a(this.mActivity, "是否停止上传并删除所选记录？", "", "是", "否", C2113R.color._353536, -1, (IClickListener) new C6144a(i2));
                return;
            }
            if (uploadState == 2) {
                if (!C7313q1.m26534f()) {
