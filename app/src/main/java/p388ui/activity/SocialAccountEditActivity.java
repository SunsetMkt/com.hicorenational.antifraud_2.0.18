...
import p388ui.presenter.SocialAccEditPresenter;
import util.C7292k1;
import util.C7331w1;
...
public class SocialAccountEditActivity extends BaseActivity implements SocialTagsCallView {
    ...
    private SocialAccBean f25904bean;
    ...
    /* renamed from: ui.activity.SocialAccountEditActivity$a */
    class C6612a extends AbstractC4439b<SocialTypeBean> {
        C6612a(List list) {
            super(list);
        }
        ...
        public View mo16383a(FlowLayout flowLayout, int i2, SocialTypeBean socialTypeBean) {
            TextView textView = (TextView) LayoutInflater.from(SocialAccountEditActivity.this.mActivity).inflate(C2113R.layout.tag_flow, (ViewGroup) SocialAccountEditActivity.this.mFlowLayout, false);
            textView.setText(((SocialTypeBean) SocialAccountEditActivity.this.socialTypeBeans.get(i2)).getText());
            textView.setTextColor(SocialAccountEditActivity.this.getResources().getColorStateList(C2113R.color.text_choose_one));
            return textView;
        }
    }
    ...
    private void getIntentData() {
        ...
        this.f25904bean = (SocialAccBean) getIntent().getSerializableExtra(C7292k1.f25440w);
    }

    /* renamed from: a */
    public /* synthetic */ boolean m25381a(View view, int i2, FlowLayout flowLayout) {
    ...
    protected void initTagAdapter() {
        this.mTagAdapter = new C6612a(this.socialTypeBeans);
        this.mFlowLayout.setAdapter(this.mTagAdapter);
        this.mFlowLayout.setOnTagClickListener(new TagFlowLayout.InterfaceC4437c() { // from class: ui.activity.e1
            ...
            public final boolean mo16381a(View view, int i2, FlowLayout flowLayout) {
                return SocialAccountEditActivity.this.m25381a(view, i2, flowLayout);
            }
        });
    }
    ...
    public void onSuccessRequest(List<SocialTypeBean> list) {
        ...
        SocialAccBean socialAccBean = this.f25904bean;
        ...
        if (contains >= 0) {
            ...
            this.mTvAccName.setText(this.f25904bean.getAccountName());
            this.mEtAccount.setText(this.f25904bean.getAccountNum());
        ...
        this.mLlAccOther.setVisibility(0);
        this.mLlAccNorm.setVisibility(8);
        this.mEtTagOther.setText(this.f25904bean.getAccountName());
        this.mEtAccountOther.setText(this.f25904bean.getAccountNum());
        this.mTagAdapter.m16387a(this.selectIndex);
    }
    ...
    public void onViewClicked(View view) {
        ...
        if (this.socialTypeBeans.size() > 0) {
            ...
            if (this.f25904bean != null) {
                C6049c.m24987f().m25000d(new C7265a(15, socialAccBean, Integer.valueOf(this.pos)));
            } else {
                C6049c.m24987f().m25000d(new C7265a(14, socialAccBean));
            }
            finish();
        }
    }
    ...
    public int setLayoutView() {
        return C2113R.layout.activity_social_acc_edit;
    }
}
