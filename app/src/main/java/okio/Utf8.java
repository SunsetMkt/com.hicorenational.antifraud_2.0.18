...
public final class Utf8 {
    ...
    public static final int process4Utf8Bytes(@d byte[] bArr, int i2, int i3, @d l<? super Integer, y1> lVar) {
        ...
        int i7 = (((b5 ^ n.a) ^ (b4 << 6)) ^ (b3 << 12)) ^ (b2 << 18);
        if (i7 > 1114111) {
            lVar.invoke(numValueOf);
            return 4;
        }
    ...
    */
    public static final void processUtf16Chars(@d byte[] bArr, int i2, int i3, @d l<? super Character, y1> lVar) {
        int i4;
        i0.f(bArr, "$this$processUtf16Chars");
        i0.f(lVar, "yield");
        int i5 = i2;
        while (i5 < i3) {
            byte b2 = bArr[i5];
            if (b2 >= 0) {
                ...
                if ((b2 >> 5) == -2) {
                    ...
                    if (i3 <= i7) {
                        ...
                        if ((b4 & 192) == 128) {
                            int i8 = (b4 ^ n.a) ^ (b3 << 6);
                            lVar.invoke(Character.valueOf(i8 < 128 ? (char) REPLACEMENT_CODE_POINT : (char) i8));
                            i6 = 2;
                        }
                        i5 += i6;
                    }
                    ...
                    if ((b2 >> 4) == -2) {
                        ...
                        if (i3 <= i10) {
                            ...
                            if ((b6 & 192) == 128) {
                                byte b7 = bArr[i10];
                                if ((b7 & 192) == 128) {
                                    int i12 = ((b7 ^ n.a) ^ (b6 << 6)) ^ (b5 << 12);
                                    lVar.invoke(Character.valueOf((i12 >= 2048 && (55296 > i12 || 57343 < i12)) ? (char) i12 : (char) REPLACEMENT_CODE_POINT));
                                    i4 = 3;
                                } else {
                                    lVar.invoke(Character.valueOf((char) REPLACEMENT_CODE_POINT));
                                    i4 = 2;
                        ...
                        if (i3 <= i13) {
                            ...
                            if ((b9 & 192) == 128) {
                                ...
                                if ((b10 & 192) == 128) {
                                    byte b11 = bArr[i13];
                                    if ((b11 & 192) == 128) {
                                        int i16 = (((b11 ^ n.a) ^ (b10 << 6)) ^ (b9 << 12)) ^ (b8 << 18);
                                        if (i16 <= 1114111 && ((55296 > i16 || 57343 < i16) && i16 >= 65536 && i16 != 65533)) {
                                            lVar.invoke(Character.valueOf((char) ((i16 >>> 10) + HIGH_SURROGATE_HEADER)));
                                            lVar.invoke(Character.valueOf((char) ((i16 & 1023) + LOG_SURROGATE_HEADER)));
                                        } else {
                                            lVar.invoke(Character.valueOf(REPLACEMENT_CHARACTER));
                                        }
                                        i9 = 4;
        ...
        while (i2 < i3) {
            ...
            if (cCharAt2 < '\u0080') {
                ...
                if (cCharAt2 < '\u0800') {
                    ...
                    lVar.invoke(Byte.valueOf((byte) ((cCharAt2 & '?') | 128)));
                } else if (cCharAt2 > '\udbff' || i3 <= (i4 = i2 + 1) || '\udc00' > (cCharAt = str.charAt(i4)) || '\udfff' < cCharAt) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static final void processUtf8CodePoints(@d byte[] bArr, int i2, int i3, @d l<? super Integer, y1> lVar) {
        int i4;
        i0.f(bArr, "$this$processUtf8CodePoints");
        i0.f(lVar, "yield");
        int i5 = i2;
        while (i5 < i3) {
            byte b2 = bArr[i5];
            if (b2 >= 0) {
                ...
                if ((b2 >> 5) == -2) {
                    ...
                    if (i3 <= i7) {
                        ...
                        if ((b4 & 192) == 128) {
                            int i8 = (b4 ^ n.a) ^ (b3 << 6);
                            lVar.invoke(i8 < 128 ? Integer.valueOf(REPLACEMENT_CODE_POINT) : Integer.valueOf(i8));
                            i6 = 2;
                        }
                        i5 += i6;
                    }
                    ...
                    if ((b2 >> 4) == -2) {
                        ...
                        if (i3 <= i10) {
                            ...
                            if ((b6 & 192) == 128) {
                                ...
                                if ((b7 & 192) == 128) {
                                    int i12 = ((b7 ^ n.a) ^ (b6 << 6)) ^ (b5 << 12);
                                    lVar.invoke((i12 >= 2048 && (55296 > i12 || 57343 < i12)) ? Integer.valueOf(i12) : Integer.valueOf(REPLACEMENT_CODE_POINT));
                                    i4 = 3;
                                } else {
                                    lVar.invoke(Integer.valueOf(REPLACEMENT_CODE_POINT));
                                    i4 = 2;
                        ...
                        if (i3 <= i13) {
                            ...
                            if ((b9 & 192) == 128) {
                                ...
                                if ((b10 & 192) == 128) {
                                    ...
                                    if ((b11 & 192) == 128) {
                                        int i16 = (((b11 ^ n.a) ^ (b10 << 6)) ^ (b9 << 12)) ^ (b8 << 18);
                                        lVar.invoke((i16 <= 1114111 && (55296 > i16 || 57343 < i16) && i16 >= 65536) ? Integer.valueOf(i16) : Integer.valueOf(REPLACEMENT_CODE_POINT));
                                        i9 = 4;
                                    } else {
                                        lVar.invoke(Integer.valueOf(REPLACEMENT_CODE_POINT));
                                    }
