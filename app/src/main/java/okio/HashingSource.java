...
public final class HashingSource extends ForwardingSource {
    ...
    @c(level = i.d.ERROR, message = "moved to val", replaceWith = @o0(expression = "hash", imports = {}))
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public HashingSource(@d Source source, @d ByteString byteString, @d String str) throws NoSuchAlgorithmException {
        super(source);
        i0.f(source, "source");
        i0.f(byteString, "key");
        i0.f(str, "algorithm");
