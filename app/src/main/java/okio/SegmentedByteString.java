...
public final class SegmentedByteString extends ByteString {
    ...
    public ByteBuffer asByteBuffer() {
        ...
        i0.a((Object) asReadOnlyBuffer, "ByteBuffer.wrap(toByteArray()).asReadOnlyBuffer()");
    ...
    public ByteString digest$okio(@d String str) {
        ...
        i0.a((Object) digest, "digest.digest()");
    ...
    public ByteString substring(int i2, int i3) {
        ...
        byte[][] bArr = (byte[][]) n.a(getSegments$okio(), segment, segment2 + 1);
