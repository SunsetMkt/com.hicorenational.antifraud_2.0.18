...
public final class RealBufferedSource implements BufferedSource {
    ...
    public InputStream inputStream() {
        return new InputStream() { // from class: okio.RealBufferedSource.inputStream.1
            ...
            public int read() throws IOException {
                ...
                return RealBufferedSource.this.bufferField.readByte() & f1.f12066c;
            }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:43:0x002f, code lost:
        ...
        r1 = java.lang.Integer.toString(r8, i.z2.d.a(i.z2.d.a(16)));
        i.q2.t.i0.a((java.lang.Object) r1, "java.lang.Integer.toStri\u2026(this, checkRadix(radix))");
        r0.append(r1);
     */
    ...
    */
    ...
    public long readHexadecimalUnsignedLong() throws EOFException {
        ...
        if (i2 == 0) {
            ...
            String string = Integer.toString(b2, i.z2.d.a(i.z2.d.a(16)));
    ...
    public String readUtf8LineStrict(long j2) throws EOFException {
        ...
        long j3 = j2 == m0.f12222b ? Long.MAX_VALUE : j2 + 1;
        byte b2 = (byte) 10;
        long jIndexOf = indexOf(b2, 0L, j3);
        if (jIndexOf != -1) {
            return BufferKt.readUtf8Line(this.bufferField, jIndexOf);
        }
        if (j3 < m0.f12222b && request(j3) && this.bufferField.getByte(j3 - 1) == ((byte) 13) && request(1 + j3) && this.bufferField.getByte(j3) == b2) {
