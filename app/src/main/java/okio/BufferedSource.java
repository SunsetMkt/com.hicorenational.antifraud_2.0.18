...
public interface BufferedSource extends Source, ReadableByteChannel {
    ...
    long indexOf(@j.c.a.d ByteString byteString) throws IOException;

    long indexOf(@j.c.a.d ByteString byteString, long j2) throws IOException;

    long indexOfElement(@j.c.a.d ByteString byteString) throws IOException;

    long indexOfElement(@j.c.a.d ByteString byteString, long j2) throws IOException;
    ...
    boolean rangeEquals(long j2, @j.c.a.d ByteString byteString) throws IOException;

    boolean rangeEquals(long j2, @j.c.a.d ByteString byteString, int i2, int i3) throws IOException;

    int read(@j.c.a.d byte[] bArr) throws IOException;

    int read(@j.c.a.d byte[] bArr, int i2, int i3) throws IOException;

    long readAll(@j.c.a.d Sink sink) throws IOException;
    ...
    void readFully(@j.c.a.d Buffer buffer, long j2) throws IOException;
    ...
    @j.c.a.d
    String readString(long j2, @j.c.a.d Charset charset) throws IOException;

    @j.c.a.d
    String readString(@j.c.a.d Charset charset) throws IOException;
    ...
    int select(@j.c.a.d Options options) throws IOException;
