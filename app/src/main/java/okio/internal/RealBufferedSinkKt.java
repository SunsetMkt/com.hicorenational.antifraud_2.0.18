...
public final class RealBufferedSinkKt {
    public static final void commonClose(@d RealBufferedSink realBufferedSink) {
    ...
    @d
    public static final BufferedSink commonEmit(@d RealBufferedSink realBufferedSink) {
    ...
    @d
    public static final BufferedSink commonEmitCompleteSegments(@d RealBufferedSink realBufferedSink) {
    ...
    public static final void commonFlush(@d RealBufferedSink realBufferedSink) {
    ...
    public static final void commonWrite(@d RealBufferedSink realBufferedSink, @d Buffer buffer, long j2) {
    ...
    public static final long commonWriteAll(@d RealBufferedSink realBufferedSink, @d Source source) {
    ...
    @d
    public static final BufferedSink commonWrite(@d RealBufferedSink realBufferedSink, @d Source source, long j2) {
        i0.f(realBufferedSink, "$this$commonWrite");
        i0.f(source, "source");
        while (j2 > 0) {
