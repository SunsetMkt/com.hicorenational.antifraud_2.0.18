...
public final class SegmentedByteStringKt {
    ...
    public static final void forEachSegment(@d SegmentedByteString segmentedByteString, @d i.q2.s.q<? super byte[], ? super Integer, ? super Integer, y1> qVar) {
    ...
    public static final void forEachSegment(@d SegmentedByteString segmentedByteString, int i2, int i3, i.q2.s.q<? super byte[], ? super Integer, ? super Integer, y1> qVar) {
        int iSegment = segment(segmentedByteString, i2);
        while (i2 < i3) {
