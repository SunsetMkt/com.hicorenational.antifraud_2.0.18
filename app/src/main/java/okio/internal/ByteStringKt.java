...
public final class ByteStringKt {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:304:0x0069, code lost:
        ...
        return -1;
     */
    /* JADX WARN: Removed duplicated region for block: B:303:0x0067  */
    /* JADX WARN: Removed duplicated region for block: B:343:0x00ba  */
    /* JADX WARN: Removed duplicated region for block: B:399:0x0131  */
    /* JADX WARN: Removed duplicated region for block: B:469:0x01c8  */
    /*
    ...
    */
        ...
        loop0: while (i5 < length) {
            ...
            if (b2 >= 0) {
                ...
                if ((b2 >> 5) == -2) {
                    ...
                    int i17 = (((b12 ^ n.a) ^ (b11 << 6)) ^ (b10 << 12)) ^ (b9 << 18);
                    if (i17 > 1114111) {
                        if (i7 == i2) {
                            return i6;
                        }
    ...
    public static final int commonCompareTo(@d ByteString byteString, @d ByteString byteString2) {
        ...
        for (int i2 = 0; i2 < iMin; i2++) {
            int i3 = byteString.getByte(i2) & f1.f12066c;
            int i4 = byteString2.getByte(i2) & f1.f12066c;
            if (i3 != i4) {
                return i3 < i4 ? -1 : 1;
            }
        }
    ...
    public static final String commonHex(@d ByteString byteString) {
        ...
        for (byte b2 : byteString.getData$okio()) {
            ...
            i2 = i3 + 1;
            cArr[i3] = getHEX_DIGIT_CHARS()[b2 & cw.f7205m];
        }
