...
public final class RealBufferedSourceKt {
    ...
    public static final String commonReadUtf8LineStrict(@d RealBufferedSource realBufferedSource, long j2) throws EOFException {
        ...
        if (j3 < m0.f12222b && realBufferedSource.request(j3) && realBufferedSource.bufferField.getByte(j3 - 1) == ((byte) 13) && realBufferedSource.request(1 + j3) && realBufferedSource.bufferField.getByte(j3) == b2) {
