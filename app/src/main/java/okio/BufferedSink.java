...
public interface BufferedSink extends Sink, WritableByteChannel {
    ...
    @j.c.a.d
    BufferedSink write(@j.c.a.d ByteString byteString) throws IOException;

    @j.c.a.d
    BufferedSink write(@j.c.a.d ByteString byteString, int i2, int i3) throws IOException;

    @j.c.a.d
    BufferedSink write(@j.c.a.d Source source, long j2) throws IOException;

    @j.c.a.d
    BufferedSink write(@j.c.a.d byte[] bArr) throws IOException;

    @j.c.a.d
    BufferedSink write(@j.c.a.d byte[] bArr, int i2, int i3) throws IOException;

    long writeAll(@j.c.a.d Source source) throws IOException;
    ...
    @j.c.a.d
    BufferedSink writeString(@j.c.a.d String str, int i2, int i3, @j.c.a.d Charset charset) throws IOException;

    @j.c.a.d
    BufferedSink writeString(@j.c.a.d String str, @j.c.a.d Charset charset) throws IOException;

    @j.c.a.d
    BufferedSink writeUtf8(@j.c.a.d String str) throws IOException;

    @j.c.a.d
    BufferedSink writeUtf8(@j.c.a.d String str, int i2, int i3) throws IOException;
