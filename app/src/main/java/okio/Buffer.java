...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    @i.c(level = i.d.ERROR, message = "moved to operator function", replaceWith = @o0(expression = "this[index]", imports = {}))
    ...
    @f
    @d
    public final Buffer copyTo(@d OutputStream outputStream) throws IOException {
        return copyTo$default(this, outputStream, 0L, 0L, 6, (Object) null);
    }

    @f
    @d
    public final Buffer copyTo(@d OutputStream outputStream, long j2) throws IOException {
        return copyTo$default(this, outputStream, j2, 0L, 4, (Object) null);
    }

    @f
    @d
    public final Buffer copyTo(@d OutputStream outputStream, long j2, long j3) throws IOException {
        ...
        while (j3 > 0) {
            ...
            int i4 = (int) (((long) segment.pos) + j2);
            int iMin = (int) Math.min(segment.limit - i4, j3);
    ...
    @d
    public final ByteString hmacSha1(@d ByteString byteString) {
        i0.f(byteString, "key");
        return hmac("HmacSHA1", byteString);
    }

    @d
    public final ByteString hmacSha256(@d ByteString byteString) {
        i0.f(byteString, "key");
        return hmac("HmacSHA256", byteString);
    }

    @d
    public final ByteString hmacSha512(@d ByteString byteString) {
        i0.f(byteString, "key");
    ...
    public long indexOf(byte b2) {
        return indexOf(b2, 0L, m0.f12222b);
    }
        ...
        return new InputStream() { // from class: okio.Buffer.inputStream.1
            ...
            public int read() {
                if (Buffer.this.size() > 0) {
                    return Buffer.this.readByte() & f1.f12066c;
                }
                return -1;
            }
    ...
    public int read(@d ByteBuffer byteBuffer) throws IOException {
    ...
    @f
    @d
    public final UnsafeCursor readAndWriteUnsafe(@d UnsafeCursor unsafeCursor) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:117:0x00c5 A[EDGE_INSN: B:117:0x00c5->B:107:0x00c5 BREAK  A[LOOP:0: B:68:0x0012->B:119:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
    ...
    */
            ...
            while (i3 < i4) {
                ...
                if (b2 >= b3 && b2 <= ((byte) 57)) {
                    ...
                    if (j2 >= BufferKt.OVERFLOW_ZONE) {
                        segment = segment2;
                        bArr = bArr2;
                        if (j2 != BufferKt.OVERFLOW_ZONE || i5 >= j3) {
                            j2 = (j2 * 10) + ((long) i5);
                        }
                    }
    ...
    @d
    public final Buffer readFrom(@d InputStream inputStream) throws IOException {
        i0.f(inputStream, "input");
        readFrom(inputStream, m0.f12222b, true);
        return this;
    }

    @Override // okio.BufferedSource
    public void readFully(@d Buffer buffer, long j2) throws EOFException {
        i0.f(buffer, "sink");
        if (size() >= j2) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:98:0x00b2 A[EDGE_INSN: B:98:0x00b2->B:92:0x00b2 BREAK  A[LOOP:0: B:57:0x000d->B:100:?], SYNTHETIC] */
    @Override // okio.BufferedSource
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    public int readInt() throws EOFException {
        ...
        int i3 = segment.limit;
        if (i3 - i2 < 4) {
            return ((readByte() & f1.f12066c) << 24) | ((readByte() & f1.f12066c) << 16) | ((readByte() & f1.f12066c) << 8) | (readByte() & f1.f12066c);
        }
        byte[] bArr = segment.data;
        int i4 = i2 + 1;
        int i5 = i4 + 1;
    ...
    public short readShort() throws EOFException {
        ...
        int i3 = segment.limit;
        if (i3 - i2 < 2) {
            return (short) (((readByte() & f1.f12066c) << 8) | (readByte() & f1.f12066c));
        }
        byte[] bArr = segment.data;
        int i4 = i2 + 1;
        int i5 = i4 + 1;
    ...
    @f
    @d
    public final UnsafeCursor readUnsafe(@d UnsafeCursor unsafeCursor) {
        i0.f(unsafeCursor, "unsafeCursor");
        if (!(unsafeCursor.buffer == null)) {
            throw new IllegalStateException("already attached to a buffer".toString());
        }
    ...
    public String readUtf8() {
        return readString(this.size, i.z2.f.a);
    }
    ...
    public String readUtf8LineStrict() throws EOFException {
        return readUtf8LineStrict(m0.f12222b);
    }
    ...
    @f
    @d
    public final Buffer writeTo(@d OutputStream outputStream) throws IOException {
        return writeTo$default(this, outputStream, 0L, 2, null);
    }

    @f
    @d
    public final Buffer writeTo(@d OutputStream outputStream, long j2) throws IOException {
        i0.f(outputStream, "out");
    ...
    public long indexOf(byte b2, long j2) {
        return indexOf(b2, j2, m0.f12222b);
    }
    ...
    @d
    public final Buffer readFrom(@d InputStream inputStream, long j2) throws IOException {
        i0.f(inputStream, "input");
        if (j2 >= 0) {
    ...
    @Override // okio.BufferedSource
    public long indexOf(@d ByteString byteString) throws IOException {
        i0.f(byteString, "bytes");
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer writeString(@d String str, @d Charset charset) {
        i0.f(str, "string");
        i0.f(charset, "charset");
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer writeUtf8(@d String str) {
        i0.f(str, "string");
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer writeString(@d String str, int i2, int i3, @d Charset charset) {
        i0.f(str, "string");
        i0.f(charset, "charset");
        if (!(i2 >= 0)) {
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer writeUtf8(@d String str, int i2, int i3) {
        i0.f(str, "string");
        if (!(i2 >= 0)) {
            throw new IllegalArgumentException(("beginIndex < 0: " + i2).toString());
        }
                ...
                if (cCharAt < '\u0080') {
                    ...
                    if (cCharAt < '\u0800') {
                        ...
                        if (cCharAt <= '\udbff' && '\udc00' <= cCharAt3 && '\udfff' >= cCharAt3) {
                            int i10 = (((cCharAt & '\u03ff') << 10) | (cCharAt3 & '\u03ff')) + 65536;
                            Segment segmentWritableSegment$okio3 = writableSegment$okio(4);
                            byte[] bArr3 = segmentWritableSegment$okio3.data;
    ...
    @d
    public final Buffer copyTo(@d Buffer buffer, long j2) {
        i0.f(buffer, "out");
    ...
    @d
    public final Buffer copyTo(@d Buffer buffer, long j2, long j3) {
        i0.f(buffer, "out");
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer write(@d ByteString byteString) {
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer write(@d ByteString byteString, int i2, int i3) {
        i0.f(byteString, "byteString");
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer write(@d byte[] bArr) {
        i0.f(bArr, "source");
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer write(@d byte[] bArr, int i2, int i3) {
        i0.f(bArr, "source");
        long j2 = i3;
    ...
    @Override // okio.BufferedSink
    @d
    public Buffer write(@d Source source, long j2) throws IOException {
        i0.f(source, "source");
        while (j2 > 0) {
                ...
                if (size() - j4 < j4) {
                    ...
                    if (segment != null) {
                        ...
                        while (size < size3) {
                            ...
                            for (int i2 = (int) ((((long) segment.pos) + j4) - j6); i2 < iMin; i2++) {
                                if (bArr[i2] == b2 && BufferKt.rangeEquals(segment, i2 + 1, bArrInternalArray$okio, 1, size2)) {
                                    j3 = ((long) (i2 - segment.pos)) + j6;
                                    return j3;
                                }
                            }
                            j4 = j6 + ((long) (segment.limit - segment.pos));
                            segment = segment.next;
                            if (segment == null) {
                                i0.f();
                            }
                    ...
                    if (segment != null) {
                        ...
                        while (j5 < size5) {
                            ...
                            for (int i3 = (int) ((((long) segment.pos) + j4) - j5); i3 < iMin2; i3++) {
                                if (bArr2[i3] == b3 && BufferKt.rangeEquals(segment, i3 + 1, bArrInternalArray$okio2, 1, size4)) {
                                    j3 = ((long) (i3 - segment.pos)) + j5;
                                    return j3;
                                }
                            }
                            j4 = ((long) (segment.limit - segment.pos)) + j5;
                            segment = segment.next;
                            if (segment == null) {
                                i0.f();
                            }
