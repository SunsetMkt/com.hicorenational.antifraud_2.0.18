...
public final class b<T> extends c<T> {
    ...
    public Object[] Z() {
        Object[] c2 = c(f13674i);
        return c2 == f13674i ? new Object[0] : c2;
    }
    ...
    a<T>[] o(Object obj) {
        a<T>[] aVarArr = this.f13677b.get();
        a<T>[] aVarArr2 = f13676k;
        if (aVarArr != aVarArr2 && (aVarArr = this.f13677b.getAndSet(aVarArr2)) != f13676k) {
            n(obj);
        }
        return aVarArr;
    }
    ...
    public void onComplete() {
        if (this.f13682g.compareAndSet(null, k.f16046a)) {
            ...
            for (a<T> aVar : o(complete)) {
                aVar.emitNext(complete, this.f13683h);
            }
        }
    }
    ...
    public void onError(Throwable th) {
        ...
        for (a<T> aVar : o(error)) {
            aVar.emitNext(error, this.f13683h);
        }
    }
