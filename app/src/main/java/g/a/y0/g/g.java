...
public final class g extends j0 {
    ...
    static {
        f15941j.dispose();
        int max = Math.max(1, Math.min(10, Integer.getInteger(f15942k, 5).intValue()));
        f15936e = new k(f15935d, max);
        f15938g = new k(f15937f, max);
    ...
    static final class a implements Runnable {
        ...
        a(long j2, TimeUnit timeUnit, ThreadFactory threadFactory) {
            ...
            if (timeUnit != null) {
                scheduledExecutorService = Executors.newScheduledThreadPool(1, g.f15938g);
