...
public class p extends j0 implements g.a.u0.c {
    ...
    static abstract class f extends AtomicReference<g.a.u0.c> implements g.a.u0.c {
        ...
        void call(j0.c cVar, g.a.f fVar) {
            ...
            if (cVar2 != p.f15970f && cVar2 == p.f15969e) {
                g.a.u0.c callActual = callActual(cVar, fVar);
                if (compareAndSet(p.f15969e, callActual)) {
                    return;
                }
                callActual.dispose();
            }
    ...
    @g.a.t0.f
    public j0.c a() {
        j0.c a2 = this.f15971b.a();
        g.a.d1.c<T> X = g.a.d1.g.a0().X();
        g.a.l<g.a.c> o = X.o(new a(a2));
        e eVar = new e(X, a2);
        this.f15972c.onNext(o);
        return eVar;
    }
