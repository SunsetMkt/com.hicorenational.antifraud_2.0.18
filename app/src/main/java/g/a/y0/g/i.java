...
public class i extends j0.c implements g.a.u0.c {
    ...
    public n a(Runnable runnable, long j2, @g.a.t0.f TimeUnit timeUnit, @g.a.t0.g g.a.y0.a.c cVar) {
        ...
        try {
            if (j2 <= 0) {
                schedule = this.f15961a.submit((Callable) nVar);
            } else {
                schedule = this.f15961a.schedule((Callable) nVar, j2, timeUnit);
            }
    ...
    public g.a.u0.c b(Runnable runnable, long j2, long j3, TimeUnit timeUnit) {
        ...
        if (j3 <= 0) {
            f fVar = new f(a2, this.f15961a);
            try {
                if (j2 <= 0) {
                    schedule = this.f15961a.submit(fVar);
                } else {
                    schedule = this.f15961a.schedule(fVar, j2, timeUnit);
                }
                fVar.a(schedule);
                return fVar;
            } catch (RejectedExecutionException e2) {
