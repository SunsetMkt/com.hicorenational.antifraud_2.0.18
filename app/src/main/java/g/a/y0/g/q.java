...
public final class q extends j0 {
    ...
    public void c() {
        ...
        do {
            ...
            if (scheduledExecutorService != f15985g) {
                ...
                scheduledExecutorService2 = a(this.f15986b);
            }
        } while (!this.f15987c.compareAndSet(scheduledExecutorService, scheduledExecutorService2));
    }
    ...
    public g.a.u0.c a(@g.a.t0.f Runnable runnable, long j2, TimeUnit timeUnit) {
        ...
        try {
            if (j2 <= 0) {
                schedule = this.f15987c.get().submit(mVar);
            } else {
                schedule = this.f15987c.get().schedule(mVar, j2, timeUnit);
            }
