...
public final class l2<T> extends g.a.y0.e.d.a<T, T> {
    ...
    protected void d(g.a.i0<? super T> i0Var) {
        g.a.f1.i<T> S = g.a.f1.e.T().S();
        try {
            g.a.g0 g0Var = (g.a.g0) g.a.y0.b.b.a(this.f15249b.apply(S), "The handler returned a null ObservableSource");
            a aVar = new a(i0Var, S, this.f14934a);
