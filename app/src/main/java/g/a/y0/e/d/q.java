...
public final class q<T, U extends Collection<? super T>> extends g.a.y0.e.d.a<T, U> {
        ...
        public void onSubscribe(g.a.u0.c cVar) {
            if (g.a.y0.a.d.validate(this.O, cVar)) {
                ...
                try {
                    ...
                    g.a.j0 j0Var = this.N;
                    long j2 = this.L;
                    g.a.u0.c a2 = j0Var.a(this, j2, j2, this.M);
    ...
    protected void d(g.a.i0<? super U> i0Var) {
        ...
        j0.c a2 = this.f15399e.a();
        if (this.f15396b == this.f15397c) {
            this.f14934a.subscribe(new a(new g.a.a1.m(i0Var), this.f15400f, this.f15396b, this.f15398d, this.f15401g, this.f15402h, a2));
        } else {
            this.f14934a.subscribe(new c(new g.a.a1.m(i0Var), this.f15400f, this.f15396b, this.f15397c, this.f15398d, a2));
        }
    }
}
