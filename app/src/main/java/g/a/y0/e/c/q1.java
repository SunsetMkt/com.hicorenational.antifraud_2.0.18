...
public final class q1<T, D> extends g.a.s<T> {
    ...
    protected void b(g.a.v<? super T> vVar) {
        try {
            D call = this.f14878a.call();
            try {
                ((g.a.y) g.a.y0.b.b.a(this.f14879b.apply(call), "The sourceSupplier returned a null MaybeSource")).a(new a(vVar, call, this.f14880c, this.f14881d));
            } catch (Throwable th) {
                g.a.v0.b.b(th);
                if (this.f14881d) {
                    try {
                        this.f14880c.accept(call);
                    } catch (Throwable th2) {
                        g.a.v0.b.b(th2);
