...
public final class x3<T, D> extends g.a.b0<T> {
    ...
    public void d(g.a.i0<? super T> i0Var) {
        try {
            D call = this.f15576a.call();
            try {
                ((g.a.g0) g.a.y0.b.b.a(this.f15577b.apply(call), "The sourceSupplier returned a null ObservableSource")).subscribe(new a(i0Var, call, this.f15578c, this.f15579d));
            } catch (Throwable th) {
                g.a.v0.b.b(th);
                try {
                    this.f15578c.accept(call);
