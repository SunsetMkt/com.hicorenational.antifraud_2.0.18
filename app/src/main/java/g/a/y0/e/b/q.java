...
public final class q<T, U extends Collection<? super T>> extends g.a.y0.e.b.a<T, U> {
        ...
        public void onSubscribe(i.d.d dVar) {
            if (g.a.y0.i.j.validate(this.q0, dVar)) {
                ...
                try {
                    ...
                    long j2 = this.n0;
                    g.a.u0.c a2 = j0Var.a(this, j2, j2, this.o0);
    ...
    protected void d(i.d.c<? super U> cVar) {
        ...
        j0.c a2 = this.f14518f.a();
        if (this.f14515c == this.f14516d) {
            this.f14110b.a((g.a.q) new a(new g.a.g1.e(cVar), this.f14519g, this.f14515c, this.f14517e, this.f14520h, this.f14521i, a2));
        } else {
            this.f14110b.a((g.a.q) new c(new g.a.g1.e(cVar), this.f14519g, this.f14515c, this.f14516d, this.f14517e, a2));
        }
    }
}
