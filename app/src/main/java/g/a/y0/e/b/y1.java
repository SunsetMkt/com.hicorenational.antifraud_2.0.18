...
public final class y1<T, U> extends g.a.y0.e.b.a<T, U> {
    ...
    static final class a<T, U> extends g.a.y0.h.a<T, U> {
        ...
        public U poll() throws Exception {
            ...
            if (poll != null) {
                return (U) g.a.y0.b.b.a(this.f14724f.apply(poll), "The mapper function returned a null value.");
            }
            return null;
        }
    ...
    static final class b<T, U> extends g.a.y0.h.b<T, U> {
        ...
        public U poll() throws Exception {
            ...
            if (poll != null) {
                return (U) g.a.y0.b.b.a(this.f14725f.apply(poll), "The mapper function returned a null value.");
            }
            return null;
        }
