        ...
        public void onNext(T t) {
            ...
            if (e()) {
                ...
                if (j2 >= this.r0) {
                    ...
                    g.a.d1.g<T> m2 = g.a.d1.g.m(this.p0);
                    this.w0 = m2;
                    this.h0.onNext(m2);
                    if (requested != h.q2.t.m0.f16408b) {
                        a(1L);
                    }
                    if (this.q0) {
                        ...
                        long j3 = this.m0;
                        g.a.u0.c a2 = cVar2.a(runnableC0194a, j3, j3, this.n0);
        ...
        public void onSubscribe(i.d.d dVar) {
            ...
            if (g.a.y0.i.j.validate(this.v0, dVar)) {
                ...
                if (this.q0) {
                    j0.c cVar2 = this.s0;
                    long j2 = this.m0;
                    a2 = cVar2.a(runnableC0194a, j2, j2, this.n0);
                } else {
                    g.a.j0 j0Var = this.o0;
                    long j3 = this.m0;
                    a2 = j0Var.a(runnableC0194a, j3, j3, this.n0);
                }
                if (this.y0.replace(a2)) {
            ...
            while (!this.t0) {
                ...
                if (z2) {
                    ...
                    if (!bVar.f14514b) {
                        ...
                        long requested = requested();
                        if (requested != 0) {
                            g.a.d1.g<T> m2 = g.a.d1.g.m(this.q0);
                            list.add(m2);
                            cVar.onNext(m2);
                            if (requested != h.q2.t.m0.f16408b) {
                                a(1L);
                            }
                            this.p0.a(new a(m2), this.m0, this.o0);
                        } else {
