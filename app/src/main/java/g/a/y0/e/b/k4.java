...
public final class k4<T, D> extends g.a.l<T> {
    ...
    public void d(i.d.c<? super T> cVar) {
        try {
            D call = this.f14332b.call();
            try {
                ((i.d.b) g.a.y0.b.b.a(this.f14333c.apply(call), "The sourceSupplier returned a null Publisher")).subscribe(new a(cVar, call, this.f14334d, this.f14335e));
            } catch (Throwable th) {
                g.a.v0.b.b(th);
                try {
                    this.f14334d.accept(call);
