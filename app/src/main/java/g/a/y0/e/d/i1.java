                    ...
                    if (num == LEFT_VALUE) {
                        ...
                        try {
                            ...
                            if (this.error.get() != null) {
                                ...
                                try {
                                    i0Var.onNext((Object) g.a.y0.b.b.a(this.resultSelector.apply(poll, V), "The resultSelector returned a null value"));
                        ...
                        c cVar4 = (c) poll;
                        g.a.f1.j<TRight> remove = this.lefts.remove(Integer.valueOf(cVar4.index));
