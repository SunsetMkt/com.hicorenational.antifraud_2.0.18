...
public final class t0<T, U> extends g.a.k0<T> {
    ...
    protected void b(g.a.n0<? super T> n0Var) {
        try {
            U call = this.f15855a.call();
            try {
                ((g.a.q0) g.a.y0.b.b.a(this.f15856b.apply(call), "The singleFunction returned a null SingleSource")).a(new a(n0Var, call, this.f15858d, this.f15857c));
            } catch (Throwable th) {
                th = th;
                g.a.v0.b.b(th);
                if (this.f15858d) {
                    try {
                        this.f15857c.accept(call);
                    } catch (Throwable th2) {
                        g.a.v0.b.b(th2);
                        th = new g.a.v0.a(th, th2);
                    }
