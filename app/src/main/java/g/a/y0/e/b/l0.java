...
public final class l0<T, K> extends g.a.y0.e.b.a<T, T> {
    ...
    static final class a<T, K> extends g.a.y0.h.a<T, T> {
        ...
        public T poll() throws Exception {
            while (true) {
                ...
                K apply = this.f14338f.apply(poll);
                if (!this.f14341i) {
                    this.f14341i = true;
                    this.f14340h = apply;
                    return poll;
                }
                if (!this.f14339g.a(this.f14340h, apply)) {
                    this.f14340h = apply;
                    return poll;
                }
                this.f14340h = apply;
        ...
        public boolean tryOnNext(T t) {
            ...
            try {
                K apply = this.f14338f.apply(t);
                if (this.f14341i) {
                    boolean a2 = this.f14339g.a(this.f14340h, apply);
                    this.f14340h = apply;
                    if (a2) {
                        return false;
                    }
    ...
    static final class b<T, K> extends g.a.y0.h.b<T, T> implements g.a.y0.c.a<T> {
        ...
        public T poll() throws Exception {
            while (true) {
                T poll = this.f16012c.poll();
                if (poll == null) {
                    return null;
                }
                K apply = this.f14342f.apply(poll);
                if (!this.f14345i) {
                    this.f14345i = true;
                    this.f14344h = apply;
                    return poll;
                }
                if (!this.f14343g.a(this.f14344h, apply)) {
                    this.f14344h = apply;
                    return poll;
                }
                this.f14344h = apply;
        ...
        public boolean tryOnNext(T t) {
            ...
            try {
                K apply = this.f14342f.apply(t);
                if (this.f14345i) {
                    boolean a2 = this.f14343g.a(this.f14344h, apply);
                    this.f14344h = apply;
                    if (a2) {
                        return false;
                    }
