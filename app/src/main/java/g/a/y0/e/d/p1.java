            ...
            while (!this.cancelled) {
                ...
                if (z2) {
                    ...
                    if (num == LEFT_VALUE) {
                        ...
                        try {
                            g.a.g0 g0Var = (g.a.g0) g.a.y0.b.b.a(this.leftEnd.apply(poll), "The leftEnd returned a null ObservableSource");
                            ...
                            if (this.error.get() != null) {
                                ...
                                while (it.hasNext()) {
                                    try {
                                        i0Var.onNext((Object) g.a.y0.b.b.a(this.resultSelector.apply(poll, it.next()), "The resultSelector returned a null value"));
                                    } catch (Throwable th) {
                                        fail(th, i0Var, cVar);
                                        return;
                                    }
                        ...
                        try {
                            g.a.g0 g0Var2 = (g.a.g0) g.a.y0.b.b.a(this.rightEnd.apply(poll), "The rightEnd returned a null ObservableSource");
                            ...
                            if (this.error.get() != null) {
                                ...
                                while (it2.hasNext()) {
                                    try {
                                        i0Var.onNext((Object) g.a.y0.b.b.a(this.resultSelector.apply(it2.next(), poll), "The resultSelector returned a null value"));
                                    } catch (Throwable th3) {
                                        fail(th3, i0Var, cVar);
                                        return;
                                    }
