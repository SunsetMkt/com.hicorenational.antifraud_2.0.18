...
public final class o0<R> extends g.a.c {
    ...
    protected void b(g.a.f fVar) {
        try {
            R call = this.f14085a.call();
            try {
                ((g.a.i) g.a.y0.b.b.a(this.f14086b.apply(call), "The completableFunction returned a null CompletableSource")).a(new a(fVar, call, this.f14087c, this.f14088d));
            } catch (Throwable th) {
                g.a.v0.b.b(th);
                if (this.f14088d) {
                    try {
                        this.f14087c.accept(call);
                    } catch (Throwable th2) {
                        g.a.v0.b.b(th2);
