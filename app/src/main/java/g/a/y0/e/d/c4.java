        ...
        void g() {
            ...
            while (!this.h0) {
                ...
                if (z2) {
                    ...
                    jVar.onNext(g.a.y0.j.q.getValue(poll));
                    long j2 = this.d0 + 1;
                    if (j2 >= this.b0) {
                        this.e0++;
                        this.d0 = 0L;
                        ...
                        if (this.O) {
                            ...
                            long j3 = this.K;
                            g.a.u0.c a2 = cVar2.a(runnableC0209a2, j3, j3, this.L);
                            if (!this.i0.compareAndSet(cVar, a2)) {
                                a2.dispose();
                            }
                        }
                    } else {
        ...
        public void onNext(T t) {
            ...
            if (e()) {
                ...
                if (j2 >= this.b0) {
                    ...
                    this.d0 = 0L;
                    jVar.onComplete();
                    g.a.f1.j<T> i2 = g.a.f1.j.i(this.N);
                    this.g0 = i2;
                    this.F.onNext(i2);
                    if (this.O) {
                        this.i0.get().dispose();
        ...
        public void onSubscribe(g.a.u0.c cVar) {
            ...
            if (g.a.y0.a.d.validate(this.f0, cVar)) {
                ...
                if (this.O) {
                    j0.c cVar2 = this.c0;
                    long j2 = this.K;
                    a2 = cVar2.a(runnableC0209a, j2, j2, this.L);
                } else {
                    g.a.j0 j0Var = this.M;
                    long j3 = this.K;
                    a2 = j0Var.a(runnableC0209a, j3, j3, this.L);
                }
                g.a.y0.a.d.replace(this.i0, a2);
            }
        }
    }
    ...
    static final class c<T> extends g.a.y0.d.w<T, Object, g.a.b0<T>> implements g.a.u0.c, Runnable {
            ...
            while (!this.d0) {
                ...
                if (z2) {
                    ...
                    if (!bVar.f15028b) {
                        ...
                        g.a.f1.j<T> i3 = g.a.f1.j.i(this.O);
                        list.add(i3);
                        i0Var.onNext(i3);
        ...
        public void onSubscribe(g.a.u0.c cVar) {
            if (g.a.y0.a.d.validate(this.c0, cVar)) {
                ...
                g.a.f1.j<T> i2 = g.a.f1.j.i(this.O);
                this.b0.add(i2);
                this.F.onNext(i2);
