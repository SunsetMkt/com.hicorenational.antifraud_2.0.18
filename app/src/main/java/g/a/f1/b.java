...
public final class b<T> extends i<T> {
    ...
    public Object[] U() {
        Object[] c2 = c(f13756h);
        return c2 == f13756h ? new Object[0] : c2;
    }
    ...
    a<T>[] n(Object obj) {
        a<T>[] aVarArr = this.f13760b.get();
        a<T>[] aVarArr2 = f13758j;
        if (aVarArr != aVarArr2 && (aVarArr = this.f13760b.getAndSet(aVarArr2)) != f13758j) {
            m(obj);
        }
        return aVarArr;
    }
