...
public final class f<T> extends i<T> {
    ...
    static final class d<T> extends AtomicReference<Object> implements b<T> {
        ...
        C0176f<Object> getHead() {
            ...
            while (true) {
                ...
                c0176f = c0176f2;
                c0176f2 = c0176f4;
                if (c0176f2 == null || c0176f2.time > a2) {
                    break;
                }
                c0176f3 = c0176f2.get();
            }
        ...
        public void replay(c<T> cVar) {
            ...
            C0176f<Object> c0176f = (C0176f) cVar.index;
            if (c0176f == null) {
                c0176f = getHead();
            }
            int i2 = 1;
    ...
    public Object[] U() {
        Object[] c2 = c(f13791f);
        return c2 == f13791f ? new Object[0] : c2;
    }
