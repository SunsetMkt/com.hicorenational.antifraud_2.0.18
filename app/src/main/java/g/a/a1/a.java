...
public abstract class a<T, U extends a<T, U>> implements g.a.u0.c {
    ...
    public final U a(Throwable th) {
        return a(g.a.y0.b.a.a(th));
    }

    public final U a(Class<? extends Throwable> cls) {
        return a(g.a.y0.b.a.b((Class) cls));
    }
    ...
    public final U a(Iterable<? extends T> iterable) {
        boolean hasNext;
        boolean hasNext2;
        Iterator<T> it = this.f13616b.iterator();
    ...
    public final U b(int i2) {
        return a(i2, b.SLEEP_10MS, com.heytap.mcssdk.constant.a.r);
    }
    ...
    public final U a(int i2, Runnable runnable) {
        return a(i2, runnable, com.heytap.mcssdk.constant.a.r);
    }
