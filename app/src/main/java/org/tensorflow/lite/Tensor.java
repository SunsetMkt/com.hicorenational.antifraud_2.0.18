...
public final class Tensor {
    ...
    private void i(Object obj) {
        if (g(obj)) {
            ...
            int[] e2 = e(obj);
            if (!Arrays.equals(e2, this.f17513c)) {
                throw new IllegalArgumentException(String.format("Cannot copy between a TensorFlowLite tensor with shape %s and a Java object with shape %s.", Arrays.toString(this.f17513c), Arrays.toString(e2)));
            }
        }
    }
    ...
    private void j(Object obj) {
        a f2;
        a aVar;
        if (!g(obj) && (f2 = f(obj)) != (aVar = this.f17512b)) {
            throw new IllegalArgumentException(String.format("Cannot convert between a TensorFlowLite tensor with type %s and a Java object of type %s (which is compatible with the TensorFlowLite type %s).", aVar, obj.getClass().getName(), f2));
        }
    }
    ...
    int[] b(Object obj) {
        ...
        j(obj);
        int[] e2 = e(obj);
        if (Arrays.equals(this.f17513c, e2)) {
            return null;
        }
        return e2;
    }
