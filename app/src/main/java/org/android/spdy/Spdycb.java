...
public interface Spdycb {
    ...
    void spdyDataRecvCallback(SpdySession spdySession, boolean z, long j2, int i2, Object obj);

    void spdyDataSendCallback(SpdySession spdySession, boolean z, long j2, int i2, Object obj);
