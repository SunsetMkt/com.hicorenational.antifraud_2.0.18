...
public interface Intenalcb {
    ...
    void spdyDataChunkRecvCB(SpdySession spdySession, boolean z, long j2, SpdyByteArray spdyByteArray, int i2);

    void spdyDataRecvCallback(SpdySession spdySession, boolean z, long j2, int i2, int i3);

    void spdyDataSendCallback(SpdySession spdySession, boolean z, long j2, int i2, int i3);
