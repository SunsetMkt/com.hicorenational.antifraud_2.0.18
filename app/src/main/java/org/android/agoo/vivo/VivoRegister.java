...
public class VivoRegister {
    ...
    public class a implements IPushActionListener {
        ...
        /* JADX INFO: renamed from: org.android.agoo.vivo.VivoRegister$a$a, reason: collision with other inner class name */
        public class C0277a implements IPushQueryActionListener {
            public C0277a() {
            }
        ...
        public void onStateChanged(int i2) {
            ...
            if (i2 == 0) {
                VivoRegister.getToken(this.a, new C0277a());
            }
        }
    }

    public class b implements IPushQueryActionListener {
        public final /* synthetic */ IPushQueryActionListener a;
