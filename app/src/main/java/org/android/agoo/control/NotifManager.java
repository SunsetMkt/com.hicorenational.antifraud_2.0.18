...
public class NotifManager {
    ...
    private void reportMethod(MsgDO msgDO, TaoBaseService.ExtraInfo extraInfo) {
        try {
            ...
            String a2 = ACCSManager.getAccsInstance(this.mContext, Config.a(this.mContext), Config.c(this.mContext)).a(this.mContext, accsRequest, extraInfo);
            if (ALog.isPrintLog(ALog.Level.E)) {
                ALog.e(TAG, AgooConstants.MESSAGE_REPORT, Constants.KEY_DATA_ID, a2, NotificationCompat.CATEGORY_STATUS, msgDO.msgStatus, "errorcode", msgDO.errorCode);
            }
        } catch (Throwable th) {
    ...
    public void doUninstall(String str, boolean z) {
        try {
            ...
            hashMap.put("appkey", Config.a(this.mContext));
            hashMap.put("utdid", com.taobao.accs.utl.j.b(this.mContext));
            ACCSManager.getAccsInstance(this.mContext, Config.a(this.mContext), Config.c(this.mContext)).a(this.mContext, new ACCSManager.AccsRequest(null, "agooKick", new JSONObject(hashMap).toString().getBytes("UTF-8"), null, null, null, null), new TaoBaseService.ExtraInfo());
        } catch (Throwable th) {
