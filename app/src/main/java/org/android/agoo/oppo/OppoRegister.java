        ...
        try {
            ...
            HeytapPushManager.register(applicationContext, str, str2, new ICallBackResultService() { // from class: org.android.agoo.oppo.OppoRegister.1
                ...
                public void onError(int i2, String str3, String str4, String str5) {
                    ALog.i(OppoRegister.TAG, "onError", "code", Integer.valueOf(i2), "msg", str3, "pkg", str4, "miniPkg", str5);
                }

                @Override // com.heytap.msp.push.callback.ICallBackResultService
                public void onGetNotificationStatus(int i2, int i3) {
                    ALog.i(OppoRegister.TAG, "onGetNotificationStatus", "code", Integer.valueOf(i2), NotificationCompat.CATEGORY_STATUS, Integer.valueOf(i3));
                }

                @Override // com.heytap.msp.push.callback.ICallBackResultService
                public void onGetPushStatus(int i2, int i3) {
                    ALog.i(OppoRegister.TAG, "onGetPushStatus", "code", Integer.valueOf(i2), NotificationCompat.CATEGORY_STATUS, Integer.valueOf(i3));
                }

                @Override // com.heytap.msp.push.callback.ICallBackResultService
                public void onRegister(int i2, String str3, String str4, String str5) {
                    ALog.i(OppoRegister.TAG, "onRegister", "regid", str3, "code", Integer.valueOf(i2), "pkg", str4, "miniPkg", str5);
                ...
                public void onSetPushTime(int i2, String str3) {
                    ALog.i(OppoRegister.TAG, "onSetPushTime", "code", Integer.valueOf(i2), "pushTime", str3);
                }

                @Override // com.heytap.msp.push.callback.ICallBackResultService
                public void onUnRegister(int i2, String str3, String str4) {
                    ALog.e(OppoRegister.TAG, "onUnRegister", "code", Integer.valueOf(i2), "pkg", str3, "miniPkg", str4);
                }
            });
        } catch (Throwable th) {
