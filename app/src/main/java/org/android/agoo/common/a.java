...
public final class a {
    ...
    private static byte[] f17314a = {82, 22, 50, 44, -16, 124, -40, -114, -87, -40, 37, 23, -56, 23, -33, 75};

    /* renamed from: b, reason: collision with root package name */
    private static ThreadLocal<Cipher> f17315b = new ThreadLocal<>();

    /* renamed from: c, reason: collision with root package name */
    private static final AlgorithmParameterSpec f17316c = new IvParameterSpec(f17314a);
    ...
    private static final Cipher a(SecretKeySpec secretKeySpec, byte[] bArr, int i2) {
        Cipher a2 = a();
        try {
            a2.init(i2, secretKeySpec, new IvParameterSpec(bArr));
            return a2;
