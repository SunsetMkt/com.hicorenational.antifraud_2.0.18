...
public class AgooService extends TaoBaseService {
    ...
    public static CallBack f12861b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AgooFactory f12862c;
    ...
    public void onBind(String str, int i2, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (a != null && GlobalClientInfo.AGOO_SERVICE_ID.equals(str)) {
            if (i2 == 200) {
                ...
                a.onFailure(String.valueOf(i2), "bind Agoo service fail");
            }
        }
        a = null;
    }
    ...
    public void onCreate() {
        ...
        this.f12862c = new AgooFactory();
        this.f12862c.init(getApplicationContext(), null, null);
    }
    ...
    public void onData(String str, String str2, String str3, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
        ...
        try {
            this.f12862c.saveMsg(bArr);
            this.f12862c.msgRecevie(bArr, "accs", extraInfo);
        } catch (Throwable th) {
    ...
    public void onResponse(String str, String str2, int i2, byte[] bArr, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (i2 == 200 && TextUtils.equals(str, AgooConstants.AGOO_SERVICE_AGOOACK)) {
            ...
            this.f12862c.updateMsg(bArr, true);
        } else {
            if (i2 != 200 && TextUtils.equals(str, AgooConstants.AGOO_SERVICE_AGOOACK)) {
                if (ALog.isPrintLog(ALog.Level.E)) {
    ...
    public void onUnbind(String str, int i2, TaoBaseService.ExtraInfo extraInfo) {
        ...
        if (f12861b != null && GlobalClientInfo.AGOO_SERVICE_ID.equals(str)) {
            if (i2 == 200) {
                f12861b.onSuccess();
            } else {
                f12861b.onFailure(String.valueOf(i2), "unbind Agoo service fail");
            }
        }
        f12861b = null;
    }
