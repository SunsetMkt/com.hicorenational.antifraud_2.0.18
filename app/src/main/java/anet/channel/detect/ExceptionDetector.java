...
class ExceptionDetector {
    ...
    void b() throws JSONException {
        ...
        a a2 = a("guide-acs.m.taobao.com", this.f1700b);
        a a3 = a("gw.alicdn.com", this.f1702d);
        a a4 = a("msgacs.m.taobao.com", this.f1701c);
    ...
    boolean c() {
        ...
        if (currentTimeMillis < this.f1699a) {
            return false;
        }
        Iterator<Pair<String, Integer>> it = this.f1703e.iterator();
        int i2 = 0;
        ...
        boolean z = i2 * 2 > 10;
        if (z) {
            this.f1699a = currentTimeMillis + 1800000;
        }
        return z;
    }
    ...
    private JSONObject a(a aVar) throws JSONException {
        ...
        if (aVar != null && aVar.f1709d != null) {
            ...
            if ("guide-acs.m.taobao.com".equals(aVar.f1706a)) {
                ArrayList<String> a2 = a(!TextUtils.isEmpty(aVar.f1708c) ? aVar.f1708c : aVar.f1707b, 5);
                JSONObject jSONObject3 = new JSONObject();
                int i2 = 0;
                while (i2 < a2.size()) {
                    int i3 = i2 + 1;
