...
class d {
    ...
    private AtomicInteger f1414b = new AtomicInteger(1);

    d() {
    }

    private void c(String str, l.e eVar) {
        String str2 = "HR" + this.f1414b.getAndIncrement();
        ALog.i("anet.HorseRaceDetector", "startTcpTask", str2, "ip", eVar.a, "port", Integer.valueOf(eVar.f1632b.a));
        HorseRaceStat horseRaceStat = new HorseRaceStat(str, eVar);
        long jCurrentTimeMillis = System.currentTimeMillis();
        try {
            Socket socket = new Socket(eVar.a, eVar.f1632b.a);
            socket.setSoTimeout(eVar.f1632b.f1607c == 0 ? 10000 : eVar.f1632b.f1607c);
    ...
    private void b(String str, l.e eVar) {
        ConnProtocol connProtocolValueOf = ConnProtocol.valueOf(eVar.f1632b);
        ConnType connTypeValueOf = ConnType.valueOf(connProtocolValueOf);
        if (connTypeValueOf == null) {
            return;
        }
        ALog.i("anet.HorseRaceDetector", "startLongLinkTask", null, Constants.KEY_HOST, str, "ip", eVar.a, "port", Integer.valueOf(eVar.f1632b.a), "protocol", connProtocolValueOf);
        String str2 = "HR" + this.f1414b.getAndIncrement();
        Context context = GlobalAppRuntimeInfo.getContext();
        StringBuilder sb = new StringBuilder();
        sb.append(connTypeValueOf.isSSL() ? DefaultWebClient.HTTPS_SCHEME : DefaultWebClient.HTTP_SCHEME);
        sb.append(str);
        ...
        synchronized (horseRaceStat) {
            try {
                horseRaceStat.wait(eVar.f1632b.f1607c == 0 ? 10000 : eVar.f1632b.f1607c);
    ...
    private void a(l.c cVar) {
        ...
        int i2 = 0;
        while (true) {
            l.e[] eVarArr2 = cVar.f1624b;
            if (i2 >= eVarArr2.length) {
                return;
            }
            l.e eVar = eVarArr2[i2];
            String str2 = eVar.f1632b.f1606b;
    ...
    private void a(String str, l.e eVar) {
        HttpUrl httpUrl = HttpUrl.parse(eVar.f1632b.f1606b + HttpConstant.SCHEME_SPLIT + str + eVar.f1633c);
        if (httpUrl == null) {
            return;
        }
        ALog.i("anet.HorseRaceDetector", "startShortLinkTask", null, "url", httpUrl);
        Request requestBuild = new Request.Builder().setUrl(httpUrl).addHeader("Connection", "close").setConnectTimeout(eVar.f1632b.f1607c).setReadTimeout(eVar.f1632b.f1608d).setRedirectEnable(false).setSslSocketFactory(new anet.channel.util.j(str)).setSeq("HR" + this.f1414b.getAndIncrement()).build();
        requestBuild.setDnsOptimize(eVar.a, eVar.f1632b.a);
        long jCurrentTimeMillis = System.currentTimeMillis();
