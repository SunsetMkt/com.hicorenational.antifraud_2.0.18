...
public class SessionCenter {
    ...
    protected void b(HttpUrl httpUrl, int i2, long j2, SessionGetCallback sessionGetCallback) throws Exception {
        ...
        Session a3 = this.f1640e.a(a2, i2);
        if (a3 != null) {
            ALog.d(TAG, "get internal hit cache session", this.f1638c, com.umeng.analytics.pro.d.aw, a3);
        ...
        if (GlobalAppRuntimeInfo.isAppBackground() && i2 == anet.channel.entity.c.f1769a && AwcnConfig.isAccsSessionCreateForbiddenInBg() && (b2 = this.f1642g.b(httpUrl.host())) != null && b2.isAccs) {
            ALog.w(TAG, "app background, forbid to create accs session", this.f1638c, new Object[0]);
            throw new ConnectException("accs session connecting forbidden in background");
        }
        a2.b(this.f1637b, i2, anet.channel.util.i.a(this.f1638c), sessionGetCallback, j2);
    }
    ...
    public void unregisterSessionInfo(String str) {
        SessionInfo a2 = this.f1642g.a(str);
    ...
    private class a implements NetworkStatusHelper.INetworkStatusChangeListener, IStrategyListener, AppLifecycle.AppLifecycleListener {
        ...
        public void onNetworkStatusChanged(NetworkStatusHelper.NetworkStatus networkStatus) {
            ...
            List<SessionRequest> a2 = SessionCenter.this.f1640e.a();
            if (!a2.isEmpty()) {
    ...
    protected Session a(HttpUrl httpUrl, int i2, long j2, SessionGetCallback sessionGetCallback) throws Exception {
        ...
        if (httpUrl != null) {
            ...
            if (a3 != null) {
                ...
                a2.a(this.f1637b, i2, anet.channel.util.i.a(this.f1638c), sessionGetCallback, j2);
                if (sessionGetCallback == null && j2 > 0 && (i2 == anet.channel.entity.c.f1771c || a2.b() == i2)) {
                    a2.a(j2);
                    a3 = this.f1640e.a(a2, i2);
                    if (a3 == null) {
