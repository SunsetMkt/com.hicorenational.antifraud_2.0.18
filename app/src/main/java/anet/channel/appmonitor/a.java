    ...
    public void commitStat(StatObject statObject) {
        ...
        if (statObject.beforeCommit()) {
            if (monitor.monitorPoint().equals("network")) {
                ...
                if (b2 != 10000 && f1678e.nextInt(10000) >= b2) {
                    return;
                }
            }
            try {
                ...
                if (list != null) {
                    for (Field field : list) {
                        ...
                        create.setValue(f1677d.get(field), obj == null ? "" : obj.toString());
                    }
                    for (Field field2 : f1676c.get(cls)) {
                        Double valueOf = Double.valueOf(field2.getDouble(statObject));
                        create2.setValue(f1677d.get(field2), valueOf.doubleValue());
                        if (hashMap != null) {
                            hashMap.put(f1677d.get(field2), valueOf);
                        }
                    }
                }
