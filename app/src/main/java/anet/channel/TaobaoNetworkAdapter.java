...
public class TaobaoNetworkAdapter implements Serializable {
    ...
    private static void a(String str, String str2, ConnProtocol connProtocol, boolean z, boolean z2) {
        ...
        if (z) {
            if (!z2) {
                ...
                SessionCenter.getInstance(new Config.Builder().setAppkey(str2).setEnv(ENV.ONLINE).build()).get(HttpUrl.parse(StringUtils.concatString(HttpConstant.HTTPS, HttpConstant.SCHEME_SPLIT, str)), anet.channel.entity.c.a, 0L);
            }
        }
    }
    ...
    public static void init(Context context, HashMap<String, Object> map) {
        ...
        if (isInited.compareAndSet(false, true)) {
            ...
            if (map != null && Constants.CHANNEL_PROCESS_NAME.equals(map.get(UMModuleRegister.PROCESS)) && b.a.k.b.i()) {
                ALog.e("awcn.TaobaoNetworkAdapter", "channelLocalInstanceEnable", null, new Object[0]);
                b.a.k.b.l(false);
            }
            ALog.setLog(new anet.channel.d.a());
            b.a.k.b.a(new anet.channel.c.a());
            ...
            if (map != null) {
                try {
                    if (!map.containsKey("isNextLaunch") || PreferenceManager.getDefaultSharedPreferences(context).getBoolean(AwcnConfig.NEXT_LAUNCH_FORBID, false)) {
                        ...
                        GlobalAppRuntimeInfo.addBucketInfo("isNextLaunch", b.a.u.a.f1908j);
                        z = true;
                    }
            ...
            if (map != null) {
                try {
                    ...
                    if (AgooConstants.TAOBAO_PACKAGE.equals(str)) {
                        if (defaultSharedPreferences.getBoolean(b.a.k.b.a, true)) {
                            b.a.k.b.e(true);
