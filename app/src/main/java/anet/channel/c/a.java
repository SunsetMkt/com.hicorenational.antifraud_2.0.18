...
public class a implements b.a.k.a {
    ...
    public void onConfigUpdate(String str) {
        if ("networkSdk".equals(str)) {
            ...
            try {
                c.a.a.a(Boolean.valueOf(getConfig(str, "network_empty_scheme_https_switch", b.a.u.a.f1908j)).booleanValue());
            } catch (Exception unused) {
            }
            try {
                b.a.k.b.p(Boolean.valueOf(getConfig(str, "network_spdy_enable_switch", b.a.u.a.f1908j)).booleanValue());
            } catch (Exception unused2) {
            }
            try {
                b.a.k.b.i(Boolean.valueOf(getConfig(str, "network_http_cache_switch", b.a.u.a.f1908j)).booleanValue());
            } catch (Exception unused3) {
            }
            try {
                String config = getConfig(str, "network_http_cache_flag", null);
                if (config != null) {
                    b.a.k.b.a(Long.valueOf(config).longValue());
                }
            } catch (Exception unused4) {
            }
            try {
                AwcnConfig.setHttpsSniEnable(Boolean.valueOf(getConfig(str, "network_https_sni_enable_switch", b.a.u.a.f1908j)).booleanValue());
            } catch (Exception unused5) {
            }
            try {
                AwcnConfig.setAccsSessionCreateForbiddenInBg(Boolean.valueOf(getConfig(str, "network_accs_session_bg_switch", b.a.u.a.f1908j)).booleanValue());
            } catch (Exception unused6) {
            }
            try {
                b.a.k.b.b(Integer.valueOf(getConfig(str, "network_request_statistic_sample_rate", "10000")).intValue());
            } catch (Exception unused7) {
            }
            try {
                String config2 = getConfig(str, "network_request_forbidden_bg", null);
                if (!TextUtils.isEmpty(config2)) {
                    b.a.k.b.d(Boolean.valueOf(config2).booleanValue());
                }
            } catch (Exception unused8) {
            }
            try {
                b.a.k.b.f(getConfig(str, "network_url_white_list_bg", null));
            ...
            try {
                AwcnConfig.setHorseRaceEnable(Boolean.valueOf(getConfig(str, "network_horse_race_switch", b.a.u.a.f1908j)).booleanValue());
            } catch (Exception unused12) {
            }
            try {
                AwcnConfig.setTnetHeaderCacheEnable(Boolean.valueOf(getConfig(str, "tnet_enable_header_cache", b.a.u.a.f1908j)).booleanValue());
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config5)) {
                    ...
                    SharedPreferences.Editor editorEdit = PreferenceManager.getDefaultSharedPreferences(b.a.o.c.getContext()).edit();
            ...
            try {
                b.a.k.b.n(Boolean.valueOf(getConfig(str, "network_response_buffer_switch", b.a.u.a.f1908j)).booleanValue());
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config6)) {
                    ...
                    SharedPreferences.Editor editorEdit2 = PreferenceManager.getDefaultSharedPreferences(b.a.o.c.getContext()).edit();
                    editorEdit2.putBoolean(b.a.k.b.f1803b, zBooleanValue2);
                    editorEdit2.apply();
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config15)) {
                    b.a.k.b.m(Boolean.valueOf(config15).booleanValue());
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config16)) {
                    ...
                    SharedPreferences.Editor editorEdit3 = PreferenceManager.getDefaultSharedPreferences(b.a.o.c.getContext()).edit();
                    editorEdit3.putBoolean(b.a.k.b.a, zBooleanValue3);
                    editorEdit3.apply();
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config17)) {
                    ...
                    SharedPreferences.Editor editorEdit4 = PreferenceManager.getDefaultSharedPreferences(b.a.o.c.getContext()).edit();
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config26)) {
                    b.a.k.b.f(Boolean.valueOf(config26).booleanValue());
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config27)) {
                    b.a.k.b.c(Boolean.valueOf(config27).booleanValue());
                }
    ...
    public void register() {
        ...
        try {
            ...
            getConfig("networkSdk", "network_empty_scheme_https_switch", b.a.u.a.f1908j);
        } catch (Exception e2) {
