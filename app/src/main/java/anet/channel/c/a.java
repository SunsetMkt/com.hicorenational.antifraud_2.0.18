...
public class a implements a.a.k.a {
    ...
    public void onConfigUpdate(String str) {
        if ("networkSdk".equals(str)) {
            ...
            try {
                c.a.f1956a.a(Boolean.valueOf(getConfig(str, "network_empty_scheme_https_switch", a.a.u.a.f1253j)).booleanValue());
            } catch (Exception unused) {
            }
            try {
                a.a.k.b.p(Boolean.valueOf(getConfig(str, "network_spdy_enable_switch", a.a.u.a.f1253j)).booleanValue());
            } catch (Exception unused2) {
            }
            try {
                a.a.k.b.i(Boolean.valueOf(getConfig(str, "network_http_cache_switch", a.a.u.a.f1253j)).booleanValue());
            } catch (Exception unused3) {
            }
            try {
                String config = getConfig(str, "network_http_cache_flag", null);
                if (config != null) {
                    a.a.k.b.a(Long.valueOf(config).longValue());
                }
            } catch (Exception unused4) {
            }
            try {
                AwcnConfig.setHttpsSniEnable(Boolean.valueOf(getConfig(str, "network_https_sni_enable_switch", a.a.u.a.f1253j)).booleanValue());
            } catch (Exception unused5) {
            }
            try {
                AwcnConfig.setAccsSessionCreateForbiddenInBg(Boolean.valueOf(getConfig(str, "network_accs_session_bg_switch", a.a.u.a.f1253j)).booleanValue());
            } catch (Exception unused6) {
            }
            try {
                a.a.k.b.b(Integer.valueOf(getConfig(str, "network_request_statistic_sample_rate", "10000")).intValue());
            } catch (Exception unused7) {
            }
            try {
                String config2 = getConfig(str, "network_request_forbidden_bg", null);
                if (!TextUtils.isEmpty(config2)) {
                    a.a.k.b.d(Boolean.valueOf(config2).booleanValue());
                }
            } catch (Exception unused8) {
            }
            try {
                a.a.k.b.f(getConfig(str, "network_url_white_list_bg", null));
            ...
            try {
                AwcnConfig.setHorseRaceEnable(Boolean.valueOf(getConfig(str, "network_horse_race_switch", a.a.u.a.f1253j)).booleanValue());
            } catch (Exception unused12) {
            }
            try {
                AwcnConfig.setTnetHeaderCacheEnable(Boolean.valueOf(getConfig(str, "tnet_enable_header_cache", a.a.u.a.f1253j)).booleanValue());
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config5)) {
                    ...
                    SharedPreferences.Editor edit = PreferenceManager.getDefaultSharedPreferences(a.a.o.c.getContext()).edit();
            ...
            try {
                a.a.k.b.n(Boolean.valueOf(getConfig(str, "network_response_buffer_switch", a.a.u.a.f1253j)).booleanValue());
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config6)) {
                    ...
                    SharedPreferences.Editor edit2 = PreferenceManager.getDefaultSharedPreferences(a.a.o.c.getContext()).edit();
                    edit2.putBoolean(a.a.k.b.f1120b, booleanValue2);
                    edit2.apply();
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config15)) {
                    a.a.k.b.m(Boolean.valueOf(config15).booleanValue());
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config16)) {
                    ...
                    SharedPreferences.Editor edit3 = PreferenceManager.getDefaultSharedPreferences(a.a.o.c.getContext()).edit();
                    edit3.putBoolean(a.a.k.b.f1119a, booleanValue3);
                    edit3.apply();
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config17)) {
                    ...
                    SharedPreferences.Editor edit4 = PreferenceManager.getDefaultSharedPreferences(a.a.o.c.getContext()).edit();
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config26)) {
                    a.a.k.b.f(Boolean.valueOf(config26).booleanValue());
                }
            ...
            try {
                ...
                if (!TextUtils.isEmpty(config27)) {
                    a.a.k.b.c(Boolean.valueOf(config27).booleanValue());
                }
    ...
    public void register() {
        ...
        try {
            ...
            getConfig("networkSdk", "network_empty_scheme_https_switch", a.a.u.a.f1253j);
        } catch (Exception e2) {
