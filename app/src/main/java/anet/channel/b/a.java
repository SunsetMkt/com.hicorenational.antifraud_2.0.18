...
public class a implements a.a.j.a {
    ...
    public void a() {
        ...
        if (f1683a && (cacheForModule = AVFSCacheManager.getInstance().cacheForModule("networksdk.httpcache")) != null) {
    ...
    public void clear() {
        if (f1683a) {
            try {
                IAVFSCache b2 = b();
                if (b2 != null) {
                    b2.removeAllObject((IAVFSCache.OnAllObjectRemoveCallback) f1686d);
                }
            } catch (Exception e2) {
    ...
    public a.C0001a get(String str) {
        ...
        try {
            IAVFSCache b2 = b();
            if (b2 != null) {
                return (a.C0001a) b2.objectForKey(StringUtils.md5ToHex(str));
            }
        } catch (Exception e2) {
    ...
    public void put(String str, a.C0001a c0001a) {
        if (f1683a) {
            try {
                IAVFSCache b2 = b();
                if (b2 != null) {
                    b2.setObjectForKey(StringUtils.md5ToHex(str), c0001a, (IAVFSCache.OnObjectSetCallback) f1684b);
                }
            } catch (Exception e2) {
    ...
    public void remove(String str) {
        if (f1683a) {
            try {
                IAVFSCache b2 = b();
                if (b2 != null) {
                    b2.removeObjectForKey(StringUtils.md5ToHex(str), (IAVFSCache.OnObjectRemoveCallback) f1685c);
                }
            } catch (Exception e2) {
