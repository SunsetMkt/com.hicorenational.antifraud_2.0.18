...
public class a implements IFullTraceAnalysis {
    ...
    public void commitRequest(String str, RequestStatistic requestStatistic) {
        if (!this.f1671a || requestStatistic == null || TextUtils.isEmpty(str)) {
            return;
        }
    ...
    public anet.channel.fulltrace.b getSceneInfo() {
        ...
        bVar.f1779b = SceneIdentifier.isUrlLaunch();
        bVar.f1780c = SceneIdentifier.getAppLaunchTime();
        bVar.f1781d = SceneIdentifier.getLastLaunchTime();
        bVar.f1782e = SceneIdentifier.getDeviceLevel();
        bVar.f1778a = SceneIdentifier.getStartType();
        bVar.f1783f = SceneIdentifier.getBucketInfo();
        bVar.f1784g = ABTestCenter.getUTABTestBucketId("networksdk");
        return bVar;
    }
}
