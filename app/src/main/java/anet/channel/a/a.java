...
public class a implements IFullTraceAnalysis {
    ...
    public anet.channel.fulltrace.b getSceneInfo() {
        ...
        bVar.f1451b = SceneIdentifier.isUrlLaunch();
        bVar.f1452c = SceneIdentifier.getAppLaunchTime();
        bVar.f1453d = SceneIdentifier.getLastLaunchTime();
        bVar.f1454e = SceneIdentifier.getDeviceLevel();
        bVar.a = SceneIdentifier.getStartType();
        bVar.f1455f = SceneIdentifier.getBucketInfo();
        bVar.f1456g = ABTestCenter.getUTABTestBucketId("networksdk");
        return bVar;
    }
}
