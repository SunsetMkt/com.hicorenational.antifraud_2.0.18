...
public class l {
        ...
        public b(JSONObject jSONObject) {
            ...
            if (optJSONArray != null) {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    this.f2002f[i2] = optJSONArray.optString(i2);
                }
            } else {
                this.f2002f = null;
            }
            ...
            if (optJSONArray2 == null || optJSONArray2.length() <= 0) {
                ...
                for (int i3 = 0; i3 < length2; i3++) {
                    this.f2003g[i3] = optJSONArray2.optString(i3);
                }
            }
            ...
            if (optJSONArray3 != null) {
                ...
                for (int i4 = 0; i4 < length3; i4++) {
                    this.f2004h[i4] = new a(optJSONArray3.optJSONObject(i4));
                }
            } else {
                this.f2004h = null;
            }
            ...
            for (int i5 = 0; i5 < length4; i5++) {
                this.f2005i[i5] = new e(optJSONArray4.optJSONObject(i5));
            }
        }
    }
    ...
    public static class c {
        ...
        public c(JSONObject jSONObject) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                this.f2010b[i2] = new e(optJSONArray.optJSONObject(i2));
            }
        }
    }
    ...
    public static class d {
        ...
        public d(JSONObject jSONObject) {
            ...
            if (optJSONArray != null) {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    this.f2012b[i2] = new b(optJSONArray.optJSONObject(i2));
                }
            } else {
                this.f2012b = null;
            }
            ...
            for (int i3 = 0; i3 < length2; i3++) {
                this.f2013c[i3] = new c(optJSONArray2.optJSONObject(i3));
            }
        }
    }
