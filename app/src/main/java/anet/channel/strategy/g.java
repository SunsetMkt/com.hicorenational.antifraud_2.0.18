...
class g implements IStrategyInstance, HttpDispatcher.IDispatchEventListener {
    ...
    public synchronized void saveData() {
        ...
        if (currentTimeMillis - this.f1979c > 30000) {
            this.f1979c = currentTimeMillis;
    ...
    public List<IConnStrategy> getConnStrategyListByHost(String str, IStrategyFilter iStrategyFilter) {
        ...
        List queryByHost = this.f1978b.d().queryByHost(str);
        if (queryByHost.isEmpty()) {
            queryByHost = this.f1978b.f1933c.a(str);
        }
        if (queryByHost.isEmpty() || iStrategyFilter == null) {
            ALog.d("getConnStrategyListByHost", null, Constants.KEY_HOST, str, "result", queryByHost);
            return queryByHost;
        }
    ...
    public String getSchemeByHost(String str, String str2) {
        ...
        String a2 = this.f1978b.f1932b.a(str);
