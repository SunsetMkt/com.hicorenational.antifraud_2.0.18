...
class a {
    ...
    final ConcurrentHashMap<String, List<IPConnStrategy>> f1949a = new ConcurrentHashMap<>();

    /* renamed from: b, reason: collision with root package name */
    final HashMap<String, Object> f1950b = new HashMap<>();
    ...
    List a(String str) {
        ...
        if (!this.f1949a.containsKey(str)) {
            synchronized (this.f1950b) {
                if (this.f1950b.containsKey(str)) {
                    obj = this.f1950b.get(str);
                } else {
                    obj = new Object();
                    this.f1950b.put(str, obj);
                    a(str, obj);
                }
            }
            if (obj != null) {
        ...
        List<IPConnStrategy> list2 = this.f1949a.get(str);
    ...
    void a(String str, ConnProtocol connProtocol) {
        List<IPConnStrategy> list = this.f1949a.get(str);
    ...
    void a(String str, IConnStrategy iConnStrategy, ConnEvent connEvent) {
        ...
        if (connEvent.isSuccess || TextUtils.isEmpty(str) || connEvent.isAccs || (list = this.f1949a.get(str)) == null || list == Collections.EMPTY_LIST) {
            return;
        }
        Iterator<IPConnStrategy> it = list.iterator();
        while (it.hasNext()) {
        ...
        if (list.isEmpty()) {
            this.f1949a.put(str, Collections.EMPTY_LIST);
        }
    }
