...
class b {
    ...
    static AtomicInteger f1970a = new AtomicInteger(0);

    /* renamed from: b, reason: collision with root package name */
    static HostnameVerifier f1971b = new c();

    /* renamed from: c, reason: collision with root package name */
    static Random f1972c = new Random();
    ...
    public static void a(Map map) {
        ...
        for (int i2 = 0; i2 < 3; i2++) {
            ...
            if (i2 != 2) {
                iConnStrategy = !a3.isEmpty() ? a3.remove(0) : null;
                if (iConnStrategy != null) {
                    str = a(schemeByHost, iConnStrategy.getIp(), iConnStrategy.getPort(), hashMap, i2);
                } else {
                    str = a(schemeByHost, (String) null, 0, hashMap, i2);
                }
            } else {
                String[] amdcServerFixIp = DispatchConstants.getAmdcServerFixIp();
                if (amdcServerFixIp != null && amdcServerFixIp.length > 0) {
                    a2 = a(schemeByHost, amdcServerFixIp[f1972c.nextInt(amdcServerFixIp.length)], 0, hashMap, i2);
                } else {
                    a2 = a(schemeByHost, (String) null, 0, hashMap, i2);
                }
                String str2 = a2;
                iConnStrategy = null;
                str = str2;
            }
            int a4 = a(str, hashMap, i2);
            if (iConnStrategy != null) {
    ...
    private static String a(String str, String str2, int i2, Map<String, String> map, int i3) {
        ...
        if (!AmdcRuntimeInfo.isForceHttps() && i3 == 2 && HttpConstant.HTTPS.equalsIgnoreCase(str) && f1972c.nextBoolean()) {
