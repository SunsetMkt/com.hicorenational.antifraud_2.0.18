...
final class c implements IStrategyListener {
    ...
    public void onStrategyUpdated(l.d dVar) {
        ...
        loop0: while (true) {
            ...
            str = bVarArr[i2].a;
            l.a[] aVarArr = bVarArr[i2].f1619h;
            if (aVarArr != null && aVarArr.length > 0) {
                for (l.a aVar : aVarArr) {
                    String str2 = aVar.f1606b;
        ...
        if (!str.equals(a.f1428b)) {
            String unused = a.f1428b = str;
            SharedPreferences.Editor editorEdit = a.f1432f.edit();
            editorEdit.putString("http3_detector_host", a.f1428b);
            editorEdit.apply();
        }
