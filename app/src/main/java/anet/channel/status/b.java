            ...
            if (!z) {
                if (networkInfo != null && networkInfo.isConnected()) {
                    ...
                    if (networkInfo.getType() == 0) {
                        ...
                        String replace = TextUtils.isEmpty(subtypeName) ? "" : subtypeName.replace(c.c.a.b.a.a.f3100g, "");
                        a(a(networkInfo.getSubtype(), replace), replace);
                        f1904e = a(networkInfo.getExtraInfo());
                        h();
                    } else if (networkInfo.getType() == 1) {
                        a(NetworkStatusHelper.NetworkStatus.WIFI, UtilityImpl.NET_TYPE_WIFI);
                        if (AwcnConfig.isWifiInfoEnable() && (i2 = i()) != null && b(util.permissionutil.a.f20913g)) {
                            f1906g = i2.getBSSID();
                            f1905f = i2.getSSID();
                        }
