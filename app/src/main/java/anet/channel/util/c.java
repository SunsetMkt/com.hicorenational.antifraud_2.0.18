...
public class c {
    ...
    static ConcurrentHashMap<String, f> f1652d = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: e */
    static ConcurrentHashMap<String, Integer> f1653e = new ConcurrentHashMap<>();

    static {
        f1650b = null;
        f1651c = null;
        try {
            f1651c = new f((Inet6Address) InetAddress.getAllByName("64:ff9b::")[0], 96);
            f1650b = b(NetworkStatusHelper.getStatus());
    ...
    public static f d() {
        f fVar = f1652d.get(f1650b);
        return fVar == null ? f1651c : fVar;
    }
    ...
    public static void e() {
        ...
        f1650b = b(NetworkStatusHelper.getStatus());
        if (f1653e.putIfAbsent(f1650b, 0) != null) {
            return;
        }
        int iJ = j();
        f1653e.put(f1650b, Integer.valueOf(iJ));
    ...
    public static String a(Inet4Address inet4Address) throws Exception {
        ...
        byte[] address2 = fVarD.f1655b.getAddress();
        int i2 = fVarD.a / 8;
        int i3 = 0;
        int i4 = 0;
        while (true) {
