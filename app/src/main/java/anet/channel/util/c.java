...
public class c {
    ...
    static volatile String f2048b;

    /* renamed from: c, reason: collision with root package name */
    static f f2049c;

    /* renamed from: a, reason: collision with root package name */
    static final byte[][] f2047a = {new byte[]{-64, 0, 0, -86}, new byte[]{-64, 0, 0, -85}};

    /* renamed from: d, reason: collision with root package name */
    static ConcurrentHashMap<String, f> f2050d = new ConcurrentHashMap<>();

    /* renamed from: e, reason: collision with root package name */
    static ConcurrentHashMap<String, Integer> f2051e = new ConcurrentHashMap<>();

    static {
        f2048b = null;
        f2049c = null;
        try {
            f2049c = new f((Inet6Address) InetAddress.getAllByName("64:ff9b::")[0], 96);
            f2048b = b(NetworkStatusHelper.getStatus());
    ...
    public static f d() {
        f fVar = f2050d.get(f2048b);
        return fVar == null ? f2049c : fVar;
    }
    ...
    public static void e() {
        ...
        f2048b = b(NetworkStatusHelper.getStatus());
        if (f2051e.putIfAbsent(f2048b, 0) != null) {
            return;
        }
        int j2 = j();
        f2051e.put(f2048b, Integer.valueOf(j2));
        NetTypeStat netTypeStat = new NetTypeStat();
        netTypeStat.ipStackType = j2;
        String str = f2048b;
        if (j2 == 2 || j2 == 3) {
    ...
    public static int j() {
        ...
        try {
            ...
            i2 = 0;
            ALog.e("awcn.Inet64Util", "startIpStackDetect", null, new Object[]{"ip stack", Integer.valueOf(i2), "detectType", r3});
            return i2;
        }
        ALog.e("awcn.Inet64Util", "startIpStackDetect", null, new Object[]{"ip stack", Integer.valueOf(i2), "detectType", r3});
        return i2;
    ...
    public static String a(Inet4Address inet4Address) throws Exception {
        ...
        byte[] address2 = d2.f2056b.getAddress();
        int i2 = d2.f2055a / 8;
        int i3 = 0;
        int i4 = 0;
        while (true) {
