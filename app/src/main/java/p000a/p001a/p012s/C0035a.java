...
/* renamed from: a.a.s.a */
/* loaded from: classes.dex */
public class C0035a implements Serializable, Cloneable {
    ...
    public void filledBy(RequestStatistic requestStatistic) {
        if (requestStatistic != null) {
            ...
            if (requestStatistic.f1002ip != null && requestStatistic.port != 0) {
                this.ip_port = String.format("%s:%d", requestStatistic.f1002ip, Integer.valueOf(requestStatistic.port));
            }
