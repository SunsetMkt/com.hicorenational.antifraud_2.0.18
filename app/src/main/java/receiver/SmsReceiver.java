...
public class SmsReceiver extends BroadcastReceiver implements SMSWarnCallView {
    ...
    private void createView() {
        if (this.window == null) {
            ...
            View inflate = LayoutInflater.from(this.mContext).inflate(R.layout.dialog_sms_intercepte, (ViewGroup) null);
            ((TextView) inflate.findViewById(R.id.txt_dialog_title)).setTypeface(Typeface.createFromAsset(Hicore.getApp().getAssets(), "DIN-Medium.otf"));
            this.mTvSmsAddress = (TextView) inflate.findViewById(R.id.txt_dialog_sms_address);
            this.mTvSmsContent = (TextView) inflate.findViewById(R.id.txt_dialog_sms_content);
            this.mTvWarn = (TextView) inflate.findViewById(R.id.txt_dialog_sms_warn);
            Button button = (Button) inflate.findViewById(R.id.btn_dialog_sms_close);
            Button button2 = (Button) inflate.findViewById(R.id.btn_dialog_sms_report);
            button.setOnClickListener(new View.OnClickListener() { // from class: receiver.b
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SmsReceiver.this.a(view);
                }
            });
            button2.setOnClickListener(new View.OnClickListener() { // from class: receiver.a
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    SmsReceiver.this.b(view);
                }
            });
