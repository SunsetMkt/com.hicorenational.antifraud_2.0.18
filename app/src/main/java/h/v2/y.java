...
class y {
    ...
    public static final int a(int i2, @i.c.a.d g<j1> gVar) {
        ...
        if (!gVar.isEmpty()) {
            return b2.a(i2, gVar.getStart().a()) < 0 ? gVar.getStart().a() : b2.a(i2, gVar.getEndInclusive().a()) > 0 ? gVar.getEndInclusive().a() : i2;
        }
    ...
    public static final long a(long j2, @i.c.a.d g<n1> gVar) {
        ...
        if (!gVar.isEmpty()) {
            return b2.a(j2, gVar.getStart().a()) < 0 ? gVar.getStart().a() : b2.a(j2, gVar.getEndInclusive().a()) > 0 ? gVar.getEndInclusive().a() : j2;
        }
        throw new IllegalArgumentException("Cannot coerce value to an empty range: " + gVar + '.');
    }
}
