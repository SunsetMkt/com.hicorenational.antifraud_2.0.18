...
public final class t implements h.w2.c<Object>, s {
    ...
    static {
        List c2;
        Map<Class<? extends h.m<?>>, Integer> a2;
        int b2;
        String b3;
        String b4;
        int i2 = 0;
        c2 = h.g2.y.c(h.q2.s.a.class, h.q2.s.l.class, h.q2.s.p.class, h.q2.s.q.class, h.q2.s.r.class, h.q2.s.s.class, h.q2.s.t.class, h.q2.s.u.class, h.q2.s.v.class, h.q2.s.w.class, h.q2.s.b.class, h.q2.s.c.class, h.q2.s.d.class, h.q2.s.e.class, h.q2.s.f.class, h.q2.s.g.class, h.q2.s.h.class, h.q2.s.i.class, h.q2.s.j.class, h.q2.s.k.class, h.q2.s.m.class, h.q2.s.n.class, h.q2.s.o.class);
        ArrayList arrayList = new ArrayList(h.g2.z.a(c2, 10));
        for (Object obj : c2) {
            int i3 = i2 + 1;
            if (i2 < 0) {
                h.g2.y.f();
        ...
        hashMap3.putAll(f16440c);
        hashMap3.putAll(f16441d);
        Collection<String> values = f16440c.values();
        i0.a((Object) values, "primitiveFqNames.values");
        for (String str : values) {
            StringBuilder sb = new StringBuilder();
            sb.append("kotlin.jvm.internal.");
            i0.a((Object) str, "kotlinName");
            b4 = h.z2.c0.b(str, '.', (String) null, 2, (Object) null);
            sb.append(b4);
            sb.append("CompanionObject");
            h.i0 a3 = h.c1.a(sb.toString(), str + ".Companion");
        ...
        f16442e = hashMap3;
        HashMap<String, String> hashMap4 = f16442e;
        b2 = h.g2.b1.b(hashMap4.size());
        LinkedHashMap linkedHashMap = new LinkedHashMap(b2);
        Iterator<T> it = hashMap4.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry entry2 = (Map.Entry) it.next();
            Object key = entry2.getKey();
            b3 = h.z2.c0.b((String) entry2.getValue(), '.', (String) null, 2, (Object) null);
