...
public final class p1 implements h.w2.q {
    ...
    private final String a() {
        h.w2.e p = p();
        if (!(p instanceof h.w2.c)) {
            p = null;
        }
        h.w2.c cVar = (h.w2.c) p;
        Class<?> a2 = cVar != null ? h.q2.a.a(cVar) : null;
        return (a2 == null ? p().toString() : a2.isArray() ? a(a2) : a2.getName()) + (o().isEmpty() ? "" : h.g2.g0.a(o(), ", ", "<", ">", 0, null, new a(), 24, null)) + (n() ? "?" : "");
    }
