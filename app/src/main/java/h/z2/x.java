...
class x extends w {
    ...
    private static final StringBuilder a(@i.c.a.d StringBuilder sb, int i2, int i3, String str) {
        ...
        h.q2.t.i0.a((Object) replace, "this.replace(startIndex, endIndex, value)");
        return replace;
    }
    ...
    private static final StringBuilder b(@i.c.a.d StringBuilder sb, int i2) {
        ...
        h.q2.t.i0.a((Object) deleteCharAt, "this.deleteCharAt(index)");
        return deleteCharAt;
    }
    ...
    private static final StringBuilder a(@i.c.a.d StringBuilder sb, int i2, int i3) {
        ...
        h.q2.t.i0.a((Object) delete, "this.delete(startIndex, endIndex)");
        return delete;
    }
    ...
    private static final StringBuilder a(@i.c.a.d StringBuilder sb, int i2, char[] cArr, int i3, int i4) {
        ...
        h.q2.t.i0.a((Object) insert, "this.insert(index, value…x, endIndex - startIndex)");
        return insert;
    }
    ...
    private static final StringBuilder a(@i.c.a.d StringBuilder sb, int i2, CharSequence charSequence, int i3, int i4) {
        ...
        h.q2.t.i0.a((Object) insert, "this.insert(index, value, startIndex, endIndex)");
        return insert;
    }

    @i.c.a.d
    public static final Appendable a(@i.c.a.d Appendable appendable) {
        h.q2.t.i0.f(appendable, "$this$appendln");
        Appendable append = appendable.append(f0.f16692a);
        h.q2.t.i0.a((Object) append, "append(SystemProperties.LINE_SEPARATOR)");
        return append;
    }

    @h.m2.f
    private static final Appendable a(@i.c.a.d Appendable appendable, CharSequence charSequence) {
        Appendable append = appendable.append(charSequence);
        h.q2.t.i0.a((Object) append, "append(value)");
        return a(append);
    }

    @h.m2.f
    private static final Appendable a(@i.c.a.d Appendable appendable, char c2) {
