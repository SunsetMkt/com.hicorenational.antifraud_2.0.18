...
public class b {
    ...
    public static final class C0239b<T> implements Comparator<T> {
        ...
        public final int compare(T t, T t2) {
            int a2;
            a2 = b.a((Comparable) this.f16203a.invoke(t), (Comparable) this.f16203a.invoke(t2));
            return a2;
        }
    }
    ...
    public static final class d<T> implements Comparator<T> {
        ...
        public final int compare(T t, T t2) {
            int a2;
            a2 = b.a((Comparable) this.f16206a.invoke(t2), (Comparable) this.f16206a.invoke(t));
            return a2;
        }
    }
    ...
    static final class h<T> implements Comparator<T> {
        ...
        @Override // java.util.Comparator
        public final int compare(T t, T t2) {
            int compare = this.f16211a.compare(t, t2);
            return compare != 0 ? compare : this.f16212b.compare(t, t2);
        }
    }
    ...
    public static final class i<T> implements Comparator<T> {
        ...
        public final int compare(T t, T t2) {
            int a2;
            int compare = this.f16213a.compare(t, t2);
            if (compare != 0) {
                return compare;
            }
            a2 = b.a((Comparable) this.f16214b.invoke(t), (Comparable) this.f16214b.invoke(t2));
            return a2;
        }
    }
    ...
    public static final class j<T> implements Comparator<T> {
        ...
        @Override // java.util.Comparator
        public final int compare(T t, T t2) {
            int compare = this.f16215a.compare(t, t2);
            return compare != 0 ? compare : this.f16216b.compare(this.f16217c.invoke(t), this.f16217c.invoke(t2));
        }
    }
    ...
    public static final class k<T> implements Comparator<T> {
        ...
        public final int compare(T t, T t2) {
            int a2;
            int compare = this.f16218a.compare(t, t2);
            if (compare != 0) {
                return compare;
            }
            a2 = b.a((Comparable) this.f16219b.invoke(t2), (Comparable) this.f16219b.invoke(t));
            return a2;
        }
    }
    ...
    public static final class l<T> implements Comparator<T> {
        ...
        @Override // java.util.Comparator
        public final int compare(T t, T t2) {
            int compare = this.f16220a.compare(t, t2);
            return compare != 0 ? compare : this.f16221b.compare(this.f16222c.invoke(t2), this.f16222c.invoke(t));
        }
    }
    ...
    public static final class m<T> implements Comparator<T> {
        ...
        @Override // java.util.Comparator
        public final int compare(T t, T t2) {
            int compare = this.f16223a.compare(t, t2);
            return compare != 0 ? compare : ((Number) this.f16224b.invoke(t, t2)).intValue();
        }
    }
    ...
    static final class n<T> implements Comparator<T> {
        ...
        @Override // java.util.Comparator
        public final int compare(T t, T t2) {
            int compare = this.f16225a.compare(t, t2);
            return compare != 0 ? compare : this.f16226b.compare(t2, t);
        }
    }
