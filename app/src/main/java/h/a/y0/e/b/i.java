...
/* JADX INFO: compiled from: FlowableAny.java */
/* JADX INFO: loaded from: classes2.dex */
public final class i<T> extends h.a.y0.e.b.a<T, Boolean> {

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    final h.a.x0.r<? super T> f10703c;
    ...
    public i(h.a.l<T> lVar, h.a.x0.r<? super T> rVar) {
        super(lVar);
        this.f10703c = rVar;
    }
    ...
    protected void d(j.d.c<? super Boolean> cVar) {
        this.f10561b.a((h.a.q) new a(cVar, this.f10703c));
    }
}
