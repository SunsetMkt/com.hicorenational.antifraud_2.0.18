...
public final class l {
    ...
    public static <T> void a(j.d.c<? super T> cVar, T t, AtomicInteger atomicInteger, c cVar2) {
    ...
    public static void a(j.d.c<?> cVar, Throwable th, AtomicInteger atomicInteger, c cVar2) {
    ...
    public static void a(j.d.c<?> cVar, AtomicInteger atomicInteger, c cVar2) {
        if (atomicInteger.getAndIncrement() == 0) {
            Throwable thTerminate = cVar2.terminate();
            if (thTerminate != null) {
                cVar.onError(thTerminate);
