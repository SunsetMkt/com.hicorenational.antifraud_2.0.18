...
public class b1 extends a1 {
    ...
    public static final <K, V> Map<K, V> a(@i.c.a.d h.i0<? extends K, ? extends V> i0Var) {
        ...
        Map<K, V> singletonMap = Collections.singletonMap(i0Var.getFirst(), i0Var.getSecond());
        h.q2.t.i0.a((Object) singletonMap, "java.util.Collections.si…(pair.first, pair.second)");
        return singletonMap;
    }
    ...
    public static final <K, V> Map<K, V> b(@i.c.a.d Map<? extends K, ? extends V> map) {
        ...
        h.q2.t.i0.a((Object) singletonMap, "java.util.Collections.singletonMap(key, value)");
        h.q2.t.i0.a((Object) singletonMap, "with(entries.iterator().…ingletonMap(key, value) }");
        return singletonMap;
    }
