...
public class q extends p {
    ...
    public static <T> List<T> d(@i.c.a.d T[] tArr) {
        ...
        List<T> a2 = s.a(tArr);
        h.q2.t.i0.a((Object) a2, "ArraysUtilJVM.asList(this)");
        return a2;
    }
    ...
    private static final <T> String f(@i.c.a.d T[] tArr) {
        ...
        h.q2.t.i0.a((Object) deepToString, "java.util.Arrays.deepToString(this)");
        return deepToString;
    }
    ...
    private static final byte[] d(@i.c.a.d byte[] bArr) {
        ...
        h.q2.t.i0.a((Object) copyOf, "java.util.Arrays.copyOf(this, size)");
        return copyOf;
    }
    ...
    public static int[] c(@i.c.a.d int[] iArr, int i2) {
        ...
        copyOf[length] = i2;
        h.q2.t.i0.a((Object) copyOf, "result");
        return copyOf;
    }
    ...
    private static final byte[] b(@i.c.a.d byte[] bArr, int i2, int i3) {
        ...
        if (i3 <= bArr.length) {
            ...
            h.q2.t.i0.a((Object) copyOfRange, "java.util.Arrays.copyOfR…this, fromIndex, toIndex)");
            return copyOfRange;
        }
    ...
    private static final byte[] a(@i.c.a.d byte[] bArr, int i2) {
        ...
        h.q2.t.i0.a((Object) copyOf, "java.util.Arrays.copyOf(this, newSize)");
        return copyOf;
    }
