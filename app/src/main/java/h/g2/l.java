...
public final class l<E> extends g<E> {
    ...
    public int lastIndexOf(Object obj) {
        ...
        if (i4 < i3) {
            ...
            while (!h.q2.t.i0.a(obj, this.f16153b[u])) {
                if (u == i4) {
                    return -1;
                }
                u--;
    ...
    public void add(int i2, E e2) {
        ...
        if (i2 < ((size() + 1) >> 1)) {
            int c2 = c(i3);
            int c3 = c(this.f16152a);
            int i4 = this.f16152a;
            if (c2 >= i4) {
                Object[] objArr = this.f16153b;
                objArr[c3] = objArr[i4];
                q.a(objArr, objArr, i4, i4 + 1, c2 + 1);
            } else {
                Object[] objArr2 = this.f16153b;
                q.a(objArr2, objArr2, i4 - 1, i4, objArr2.length);
                Object[] objArr3 = this.f16153b;
                objArr3[objArr3.length - 1] = objArr3[0];
                q.a(objArr3, objArr3, 0, 1, c2 + 1);
            }
            this.f16153b[c2] = e2;
            this.f16152a = c3;
        } else {
        ...
        if (i2 < ((size() + 1) >> 1)) {
            ...
            if (i4 < i5) {
                ...
                if (length >= i7) {
                    ...
                    q.a(objArr7, objArr7, 0, this.f16152a + length, i4);
                }
            }
            this.f16152a = i6;
