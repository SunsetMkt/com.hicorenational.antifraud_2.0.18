        ...
        private final File d() {
            ...
            while (true) {
                ...
                if (b2 == null) {
                    ...
                    if (i0.a(b2, peek.a()) || !b2.isDirectory() || this.f16337c.size() >= k.this.f16336f) {
                        break;
                    }
                    this.f16337c.push(a(b2));
                }
            }
            return b2;
        }
