...
public final class x {
    ...
    public static final <T> T b(@i.c.a.d Reader reader, @i.c.a.d h.q2.s.l<? super h.x2.m<String>, ? extends T> lVar) {
    ...
    public static final String b(@i.c.a.d Reader reader) {
        ...
        i0.a((Object) stringWriter2, "buffer.toString()");
        return stringWriter2;
    }

    @i.c.a.d
    public static final List<String> a(@i.c.a.d Reader reader) {
    ...
    public static final h.x2.m<String> a(@i.c.a.d BufferedReader bufferedReader) {
        ...
        a2 = h.x2.s.a(new s(bufferedReader));
        return a2;
    }
    ...
    public static final long a(@i.c.a.d Reader reader, @i.c.a.d Writer writer, int i2) {
    ...
    @i.c.a.d
    public static final byte[] a(@i.c.a.d URL url) {
        i0.f(url, "$this$readBytes");
        InputStream openStream = url.openStream();
        try {
            i0.a((Object) openStream, "it");
            byte[] a2 = b.a(openStream);
    ...
    public static final void a(@i.c.a.d Reader reader, @i.c.a.d h.q2.s.l<? super String, y1> lVar) {
