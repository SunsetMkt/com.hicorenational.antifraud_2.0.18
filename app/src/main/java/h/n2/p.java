...
class p extends o {
    ...
    @i.c.a.d
    public static final String c(@i.c.a.d File file, @i.c.a.d Charset charset) {
        i0.f(file, "$this$readText");
        i0.f(charset, "charset");
        InputStreamReader inputStreamReader = new InputStreamReader(new FileInputStream(file), charset);
        try {
            String b2 = x.b(inputStreamReader);
    ...
    @i.c.a.d
    public static final byte[] g(@i.c.a.d File file) {
        ...
        try {
            ...
            if (i2 > 0) {
                ...
                i0.a((Object) bArr, "java.util.Arrays.copyOf(this, newSize)");
            } else {
                ...
                if (read2 != -1) {
                    ...
                    bArr = h.g2.q.a(buffer, copyOf, bArr.length, 0, gVar.size());
                }
            }
    ...
    public static final void b(@i.c.a.d File file, @i.c.a.d byte[] bArr) {
    ...
    public static final void b(@i.c.a.d File file, @i.c.a.d String str, @i.c.a.d Charset charset) {
    ...
    public static final void a(@i.c.a.d File file, @i.c.a.d byte[] bArr) {
    ...
    public static final void a(@i.c.a.d File file, @i.c.a.d String str, @i.c.a.d Charset charset) {
    ...
    @i.c.a.d
    public static final List<String> b(@i.c.a.d File file, @i.c.a.d Charset charset) {
    ...
    public static final void a(@i.c.a.d File file, @i.c.a.d h.q2.s.p<? super byte[], ? super Integer, y1> pVar) {
        i0.f(file, "$this$forEachBlock");
        i0.f(pVar, "action");
        a(file, 4096, pVar);
    }

    public static /* synthetic */ Object b(File file, Charset charset, h.q2.s.l lVar, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            charset = h.z2.f.f16682a;
        }
        ...
        try {
            Object invoke = lVar.invoke(x.a(bufferedReader));
            f0.b(1);
            if (h.m2.l.a(1, 1, 0)) {
    ...
    public static final void a(@i.c.a.d File file, int i2, @i.c.a.d h.q2.s.p<? super byte[], ? super Integer, y1> pVar) {
        int a2;
        i0.f(file, "$this$forEachBlock");
        i0.f(pVar, "action");
        a2 = h.v2.q.a(i2, 512);
    ...
    public static final <T> T b(@i.c.a.d File file, @i.c.a.d Charset charset, @i.c.a.d h.q2.s.l<? super h.x2.m<String>, ? extends T> lVar) {
        i0.f(file, "$this$useLines");
        i0.f(charset, "charset");
        i0.f(lVar, "block");
        Reader inputStreamReader = new InputStreamReader(new FileInputStream(file), charset);
        BufferedReader bufferedReader = inputStreamReader instanceof BufferedReader ? (BufferedReader) inputStreamReader : new BufferedReader(inputStreamReader, 8192);
        try {
            T invoke = lVar.invoke(x.a(bufferedReader));
            f0.b(1);
            if (h.m2.l.a(1, 1, 0)) {
                c.a(bufferedReader, (Throwable) null);
            } else {
    ...
    public static /* synthetic */ void a(File file, Charset charset, h.q2.s.l lVar, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            charset = h.z2.f.f16682a;
        }
    ...
    public static final void a(@i.c.a.d File file, @i.c.a.d Charset charset, @i.c.a.d h.q2.s.l<? super String, y1> lVar) {
