...
public final class i<T> implements c<T> {
    ...
    private static final AtomicReferenceFieldUpdater<i<?>, Object> f16260e = AtomicReferenceFieldUpdater.newUpdater(i.class, Object.class, "a");
    ...
    public final Object a() {
        ...
        Object obj2 = f16258c;
        if (obj == obj2) {
            AtomicReferenceFieldUpdater<i<?>, Object> atomicReferenceFieldUpdater = f16260e;
            b3 = h.k2.l.n.b.b();
    ...
    public void resume(T t) {
        ...
        while (true) {
            ...
            if (obj != obj2) {
                ...
                AtomicReferenceFieldUpdater<i<?>, Object> atomicReferenceFieldUpdater = f16260e;
                b3 = h.k2.l.n.b.b();
                if (atomicReferenceFieldUpdater.compareAndSet(this, b3, f16259d)) {
                    this.f16263b.resume(t);
                    return;
                }
            } else if (f16260e.compareAndSet(this, obj2, t)) {
                return;
            }
        }
    }
    ...
    public void resumeWithException(@i.c.a.d Throwable th) {
        ...
        while (true) {
            ...
            } else if (f16260e.compareAndSet(this, obj2, new b(th))) {
                return;
            }
        }
    }
