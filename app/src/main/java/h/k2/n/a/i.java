...
final class i {
    ...
    public final String a(@i.c.a.d h.k2.n.a.a aVar) {
        ...
        if (aVar2 == f16302a || (method = aVar2.f16305a) == null || (invoke = method.invoke(aVar.getClass(), new Object[0])) == null || (method2 = aVar2.f16306b) == null || (invoke2 = method2.invoke(invoke, new Object[0])) == null) {
            return null;
        }
        Method method3 = aVar2.f16307c;
