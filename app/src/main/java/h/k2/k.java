...
public final class k<T> implements d<T>, h.k2.n.a.e {
    ...
    private static final AtomicReferenceFieldUpdater<k<?>, Object> f16248c = AtomicReferenceFieldUpdater.newUpdater(k.class, Object.class, "a");
    ...
    public final Object a() {
        ...
        if (obj == aVar) {
            AtomicReferenceFieldUpdater<k<?>, Object> atomicReferenceFieldUpdater = f16248c;
            b3 = h.k2.m.d.b();
    ...
    public void resumeWith(@i.c.a.d Object obj) {
        ...
        while (true) {
            ...
            if (obj2 != aVar) {
                ...
                AtomicReferenceFieldUpdater<k<?>, Object> atomicReferenceFieldUpdater = f16248c;
                b3 = h.k2.m.d.b();
                if (atomicReferenceFieldUpdater.compareAndSet(this, b3, h.k2.m.a.RESUMED)) {
                    this.f16251b.resumeWith(obj);
                    return;
                }
            } else if (f16248c.compareAndSet(this, aVar, obj)) {
                return;
            }
        }
    }
