...
/* renamed from: util.i1 */
/* loaded from: classes2.dex */
public class C7286i1 {
    /* renamed from: a */
    public static boolean m26380a(String str) {
    ...
    */
    public static boolean m26382b(java.lang.String r12) {
        /*
            Method dump skipped, instructions count: 270
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: util.C7286i1.m26382b(java.lang.String):boolean");
    }

    /* renamed from: c */
    public static boolean m26383c(String str) {
        return Pattern.compile("^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])))))|(\\d{2}(([02468][1235679])|([13579][01345789]))[\\-\\/\\s]?((((0?[13578])|(1[02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(30)))|(0?2[\\-\\/\\s]?((0?[1-9])|(1[0-9])|(2[0-8]))))))(\\s(((0?[0-9])|([1-2][0-3]))\\:([0-5]?[0-9])((\\s)|(\\:([0-5]?[0-9])))))?$").matcher(str).matches();
    }

    /* renamed from: d */
    private static boolean m26384d(String str) {
        return Pattern.compile("[0-9]*").matcher(str).matches();
    }

    /* renamed from: a */
    private static Hashtable m26379a() {
    ...
    /* renamed from: a */
    private static boolean m26381a(String str, String str2) {
