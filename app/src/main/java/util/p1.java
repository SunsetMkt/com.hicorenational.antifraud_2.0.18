...
public class p1 {
    ...
    public static final String a = "com.coolapk.market";
    public static final String a0 = "extra_web_personalize_ad";
    public static final int a1 = 3;

    /* JADX INFO: renamed from: b */
    public static final String f15010b = "from_page_bean_extra";
    public static final String b0 = "extra_name";
    public static final int b1 = 4;

    /* JADX INFO: renamed from: c */
    public static final String f15011c = "from_page_bean";
    public static final String c0 = "extra_id_info";
    public static final int c1 = 5;

    /* JADX INFO: renamed from: d */
    public static final String f15012d = "from_page_type";
    public static final String d0 = "extra_id_number";
    public static final int d1 = 6;

    /* JADX INFO: renamed from: e */
    public static final String f15013e = "from_page_tag";
    ...
    public static void a(Activity activity, Uri uri, int i2) {
        ...
        File file = new File(e.d.f10175k + e.d.a);
        if (Build.VERSION.SDK_INT < 24) {
            intent.setDataAndType(uri, "image/*");
        } else {
            File fileA = uri != null ? j1.a(activity, uri) : file;
            intent.addFlags(128);
            intent.setDataAndType(j1.a(activity, fileA), "image/*");
        }
        intent.putExtra("crop", b.a.u.a.f1908j);
        ...
        c2.b(e.d.f10167c, Uri.fromFile(file).toString());
    ...
    public static void b(Activity activity, String str) {
        ...
        File file = new File(e.d.f10175k);
        if (!file.exists()) {
            file.mkdirs();
        }
        if (Build.VERSION.SDK_INT < 24) {
