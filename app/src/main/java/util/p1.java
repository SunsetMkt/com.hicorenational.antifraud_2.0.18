...
public class p1 {
    ...
    public static <T> List<T> b(String str, Class<T> cls) {
        ...
        String decodeString = a2.decodeString(str, null);
        ArrayList arrayList = new ArrayList();
        try {
            if (!TextUtils.isEmpty(decodeString)) {
                Iterator<com.google.gson.k> it = new com.google.gson.o().a(decodeString).getAsJsonArray().iterator();
                while (it.hasNext()) {
    ...
    public static <T> T a(String str, Class<T> cls) {
        ...
        try {
            ...
            return (T) eVar.a((com.google.gson.k) new com.google.gson.o().a(decodeString).getAsJsonObject(), (Class) cls);
        } catch (Exception unused) {
            return null;
        }
    }
