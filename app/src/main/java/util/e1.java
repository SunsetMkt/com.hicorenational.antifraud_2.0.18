        ...
        if (str != null) {
            try {
                if (!"".equals(str)) {
                    ...
                    hashMap.put(c.b.c.g.CHARACTER_SET, "utf-8");
                    hashMap.put(c.b.c.g.ERROR_CORRECTION, c.b.c.f0.c.f.H);
                    c.b.c.z.b a2 = new c.b.c.f0.b().a(str, c.b.c.a.QR_CODE, i2, i3, hashMap);
