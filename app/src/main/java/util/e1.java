...
public class e1 {
    private static final String a = "DataCleanManager";
    ...
    static class a implements Runnable {
        ...
        public void run() {
            ...
            File file = this.a;
            if (file == null || !file.exists() || !this.a.isDirectory() || (fileArrListFiles = this.a.listFiles()) == null || fileArrListFiles.length <= 0) {
                return;
            }
    ...
    public static long g(Context context) {
        try {
            return c(new File(context.getCacheDir() + "/" + a.InterfaceC0046a.f2821b));
        } catch (Exception e2) {
            e2.printStackTrace();
            return 0L;
        }
