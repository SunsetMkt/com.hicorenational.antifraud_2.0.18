...
public class d1 {
    ...
    static class b implements TextWatcher {
        ...
        public void onTextChanged(CharSequence charSequence, int i2, int i3, int i4) {
            int indexOf;
            if (this.f20795a <= 0 || (indexOf = charSequence.toString().indexOf(".")) <= -1) {
                return;
            }
            ...
            if (charSequence.length() - i5 > this.f20795a) {
                String charSequence2 = charSequence.toString().subSequence(0, i5 + this.f20795a).toString();
                this.f20796b.setText(charSequence2);
                this.f20796b.setSelection(Math.min(i2 + 1, charSequence2.length()));
            }
        }
    }
