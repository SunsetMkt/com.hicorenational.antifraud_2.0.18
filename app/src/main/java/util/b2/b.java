...
public abstract class b implements Runnable {
    ...
    protected void a(ByteBuffer byteBuffer, int i2, long j2) {
        if (this.f20749b) {
            ...
            while (this.f20749b) {
                int dequeueInputBuffer = this.f20755h.dequeueInputBuffer(com.heytap.mcssdk.constant.a.q);
                if (dequeueInputBuffer >= 0) {
                    ...
                    if (i2 > 0) {
                        this.f20755h.queueInputBuffer(dequeueInputBuffer, 0, i2, j2, 0);
                        return;
                    } else {
                        this.f20752e = true;
                        this.f20755h.queueInputBuffer(dequeueInputBuffer, 0, 0, j2, 4);
                        return;
                    }
                }
            }
    ...
    protected void a() {
        ...
        try {
            ...
            int i2 = 0;
            while (this.f20749b) {
                int dequeueOutputBuffer = this.f20755h.dequeueOutputBuffer(this.f20757j, com.heytap.mcssdk.constant.a.q);
                if (dequeueOutputBuffer == -1) {
                    if (!this.f20752e && (i2 = i2 + 1) > 5) {
                        return;
                    }
                } else if (dequeueOutputBuffer == -3) {
                    byteBufferArr = this.f20755h.getOutputBuffers();
                    ...
                    if (byteBuffer != null) {
                        ...
                        this.f20755h.releaseOutputBuffer(dequeueOutputBuffer, false);
