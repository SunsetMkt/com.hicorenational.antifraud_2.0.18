...
/* JADX INFO: compiled from: MediaVideoEncoder.java */
...
public class d extends b {
    ...
    private int j() {
        ...
        s1.c(y, String.format("bitrate=%5.2f[Mbps]", Float.valueOf((i2 / 1024.0f) / 1024.0f)));
        return i2;
    }

    private VirtualDisplay k() {
        MediaProjection mediaProjection = this.u;
        if (mediaProjection == null || this.f14968h == null) {
            return null;
        }
    ...
    protected void e() throws IOException {
        ...
        this.f14966f = false;
        if (a(z) == null) {
            s1.b(y, "Unable to find an appropriate codec for video/avc");
            return;
        }
        ...
        this.f14968h = MediaCodec.createEncoderByType(z);
        this.f14968h.configure(mediaFormatCreateVideoFormat, (Surface) null, (MediaCrypto) null, 1);
        this.t = this.f14968h.createInputSurface();
        this.f14968h.start();
        this.v = k();
    ...
    @Override // util.m2.b
    protected void g() {
        this.f14968h.signalEndOfInputStream();
        this.f14965e = true;
    }
    ...
    protected static final int a(MediaCodecInfo mediaCodecInfo, String str) {
        try {
            ...
            if (i2 == 0) {
                s1.b(y, "couldn't find a good color format for " + mediaCodecInfo.getName() + " / " + str);
            }
            return i2;
        } catch (Throwable th) {
            Thread.currentThread().setPriority(5);
