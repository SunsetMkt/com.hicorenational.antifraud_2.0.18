...
public class c {
    ...
    public static boolean c() {
        try {
            Cursor query = Hicore.getApp().getContentResolver().query(Uri.parse("content://sms/failed"), new String[]{bl.f10170d, UserInfo.ADDRESS, "person", "body", "date", "type"}, null, null, "date desc");
            if (query == null) {
                return true;
            }
            query.close();
