...
public final class ViewGroupKt {
    ...
    public static final void forEach(@d ViewGroup viewGroup, @d l<? super View, y1> lVar) {
        i0.f(viewGroup, "$receiver");
        i0.f(lVar, "action");
    ...
    public static final void forEachIndexed(@d ViewGroup viewGroup, @d p<? super Integer, ? super View, y1> pVar) {
        i0.f(viewGroup, "$receiver");
        i0.f(pVar, "action");
        int childCount = viewGroup.getChildCount();
        for (int i2 = 0; i2 < childCount; i2++) {
