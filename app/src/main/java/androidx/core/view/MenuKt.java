...
public final class MenuKt {
    ...
    public static final boolean contains(@j.c.a.d Menu menu, @j.c.a.d MenuItem menuItem) {
        i0.f(menu, "$receiver");
        i0.f(menuItem, "item");
        int size = menu.size();
    ...
    public static final void forEach(@j.c.a.d Menu menu, @j.c.a.d l<? super MenuItem, y1> lVar) {
        i0.f(menu, "$receiver");
        i0.f(lVar, "action");
        int size = menu.size();
        for (int i2 = 0; i2 < size; i2++) {
    ...
    public static final void forEachIndexed(@j.c.a.d Menu menu, @j.c.a.d p<? super Integer, ? super MenuItem, y1> pVar) {
        i0.f(menu, "$receiver");
        i0.f(pVar, "action");
        int size = menu.size();
        for (int i2 = 0; i2 < size; i2++) {
    ...
    @j.c.a.d
    public static final MenuItem get(@j.c.a.d Menu menu, int i2) {
        i0.f(menu, "$receiver");
        MenuItem item = menu.getItem(i2);
        i0.a((Object) item, "getItem(index)");
        return item;
    ...
    @j.c.a.d
    public static final m<MenuItem> getChildren(@j.c.a.d final Menu menu) {
        i0.f(menu, "$receiver");
    ...
    public static final int getSize(@j.c.a.d Menu menu) {
        i0.f(menu, "$receiver");
        return menu.size();
    }

    public static final boolean isEmpty(@j.c.a.d Menu menu) {
        i0.f(menu, "$receiver");
        return menu.size() == 0;
    }

    public static final boolean isNotEmpty(@j.c.a.d Menu menu) {
        i0.f(menu, "$receiver");
        return menu.size() != 0;
    }

    @j.c.a.d
    public static final Iterator<MenuItem> iterator(@j.c.a.d Menu menu) {
        i0.f(menu, "$receiver");
        return new AnonymousClass1(menu);
    }

    public static final void minusAssign(@j.c.a.d Menu menu, @j.c.a.d MenuItem menuItem) {
        i0.f(menu, "$receiver");
        i0.f(menuItem, "item");
