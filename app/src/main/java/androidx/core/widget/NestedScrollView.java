...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
            ...
            if (i12 <= i17) {
                ...
                if (i12 >= i16) {
                    ...
                    if (z3 && !hasNestedScrollingParent(1)) {
                        this.mScroller.springBack(i14, i12, 0, 0, 0, getScrollRange());
                    }
                    onOverScrolled(i14, i12, z2, z3);
                    return !z2 || z3;
                }
                i12 = i16;
            }
    ...
    public boolean pageScroll(int i2) {
        ...
        return scrollAndFocus(i2, i3, rect3.bottom);
    }
    ...
    void smoothScrollTo(int i2, int i3, boolean z) {
    ...
    void smoothScrollTo(int i2, int i3, int i4, boolean z) {
