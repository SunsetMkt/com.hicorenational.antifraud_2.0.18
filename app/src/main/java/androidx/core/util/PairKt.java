...
public final class PairKt {
    ...
    @d
    public static final <F, S> android.util.Pair<F, S> toAndroidPair(@d i.i0<? extends F, ? extends S> i0Var) {
        i0.f(i0Var, "$receiver");
        return new android.util.Pair<>(i0Var.getFirst(), i0Var.getSecond());
    }

    @d
    public static final <F, S> i.i0<F, S> toKotlinPair(@d android.util.Pair<F, S> pair) {
        i0.f(pair, "$receiver");
        return new i.i0<>(pair.first, pair.second);
    }
}
