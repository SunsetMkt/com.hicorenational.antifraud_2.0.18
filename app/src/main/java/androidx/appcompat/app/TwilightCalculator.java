...
class TwilightCalculator {
    ...
    /* renamed from: C1 */
    private static final float f365C1 = 0.0334196f;

    /* renamed from: C2 */
    private static final float f366C2 = 3.49066E-4f;

    /* renamed from: C3 */
    private static final float f367C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0 */
    private static final float f368J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j2, double d2, double d3) {
        ...
        double round = Math.round((r3 - f368J0) - r9) + f368J0 + ((-d3) / 360.0d) + (Math.sin(d4) * 0.0053d) + (Math.sin(2.0d * sin) * (-0.0069d));
