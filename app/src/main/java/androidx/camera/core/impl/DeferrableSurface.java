...
public abstract class DeferrableSurface {
    ...
    private final d.b.b.a.a.a<Void> mTerminationFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.c
    ...
    */
    ...
    @NonNull
    public final d.b.b.a.a.a<Surface> getSurface() {
        synchronized (this.mLock) {
            if (this.mClosed) {
    ...
    @NonNull
    public d.b.b.a.a.a<Void> getTerminationFuture() {
    ...
    @NonNull
    protected abstract d.b.b.a.a.a<Surface> provideSurface();
}
