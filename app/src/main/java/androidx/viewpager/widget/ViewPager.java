...
public class ViewPager extends ViewGroup {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() != 8 && (layoutParams2 = (LayoutParams) childAt.getLayoutParams()) != null && layoutParams2.isDecor) {
                ...
                if (z2) {
                    ...
                    int i12 = z ? 1073741824 : Integer.MIN_VALUE;
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:211:0x0066, code lost:
        ...
        r8 = null;
     */
    /* JADX WARN: Removed duplicated region for block: B:248:0x00fa A[PHI: r7 r10 r15
  0x00fa: PHI (r7v14 float) = (r7v12 float), (r7v13 float), (r7v5 float) binds: [B:246:0x00ef, B:243:0x00d9, B:237:0x00c3] A[DONT_GENERATE, DONT_INLINE]
  0x00fa: PHI (r10v4 int) = (r10v3 int), (r10v2 int), (r10v7 int) binds: [B:246:0x00ef, B:243:0x00d9, B:237:0x00c3] A[DONT_GENERATE, DONT_INLINE]
  0x00fa: PHI (r15v6 int) = (r15v4 int), (r15v5 int), (r15v9 int) binds: [B:246:0x00ef, B:243:0x00d9, B:237:0x00c3] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
            ...
            if (f3 < 2.0f) {
                ...
                while (true) {
                    ...
                    if (f3 >= paddingRight && i13 > iMin) {
                        ...
                        if (i13 == itemInfo3.position && !itemInfo3.scrolling) {
                            this.mItems.remove(i12);
                            this.mAdapter.destroyItem((ViewGroup) this, i13, itemInfo3.object);
                            if (i12 < this.mItems.size()) {
                                itemInfo3 = this.mItems.get(i12);
                            }
                        }
                    } else if (itemInfo3 == null || i13 != itemInfo3.position) {
                        ItemInfo itemInfoAddNewItem2 = addNewItem(i13, i12);
                        i12++;
                        f3 += itemInfoAddNewItem2.widthFactor;
                        itemInfo3 = i12 < this.mItems.size() ? this.mItems.get(i12) : null;
                    } else {
