...
public abstract class e<K, V> implements Map<K, V>, i.q2.t.q1.a {
    ...
    private volatile Collection<? extends V> f12077b;
    ...
    public static final class a {
        ...
        public final int a(@j.c.a.d Map.Entry<?, ?> entry) {
            i.q2.t.i0.f(entry, "e");
        ...
        @j.c.a.d
        public final String b(@j.c.a.d Map.Entry<?, ?> entry) {
            i.q2.t.i0.f(entry, "e");
        ...
        public final boolean a(@j.c.a.d Map.Entry<?, ?> entry, @j.c.a.e Object obj) {
            i.q2.t.i0.f(entry, "e");
            if (!(obj instanceof Map.Entry)) {
                return false;
            }
            Map.Entry entry2 = (Map.Entry) obj;
            return i.q2.t.i0.a(entry.getKey(), entry2.getKey()) && i.q2.t.i0.a(entry.getValue(), entry2.getValue());
        }
    }
    ...
    public static final class b extends j<K> {
        ...
        /* JADX INFO: compiled from: AbstractMap.kt */
        public static final class a implements Iterator<K>, i.q2.t.q1.a {
        ...
        @Override // i.g2.j, i.g2.a, java.util.Collection, java.lang.Iterable
        @j.c.a.d
    ...
    /* JADX INFO: compiled from: AbstractMap.kt */
    static final class c extends i.q2.t.j0 implements i.q2.s.l<Map.Entry<? extends K, ? extends V>, String> {
        c() {
            super(1);
        }
        ...
        @Override // i.q2.s.l
        @j.c.a.d
        public final String invoke(@j.c.a.d Map.Entry<? extends K, ? extends V> entry) {
            i.q2.t.i0.f(entry, "it");
    ...
    public static final class d extends i.g2.a<V> {
    ...
    public boolean containsValue(Object obj) {
        ...
        while (it.hasNext()) {
            if (i.q2.t.i0.a(((Map.Entry) it.next()).getValue(), obj)) {
                return true;
            }
        }
        return false;
    ...
    public Collection<V> e() {
        ...
        Collection<? extends V> collection = this.f12077b;
        if (collection == null) {
            i.q2.t.i0.f();
        }
        return collection;
    ...
    private final Map.Entry<K, V> b(K k2) {
        ...
        while (true) {
            ...
            next = it.next();
            if (i.q2.t.i0.a(((Map.Entry) next).getKey(), k2)) {
                break;
            }
        }
    ...
    public final boolean a(@j.c.a.e Map.Entry<?, ?> entry) {
