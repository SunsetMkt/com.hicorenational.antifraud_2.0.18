...
public class y extends x {
    ...
    /* JADX INFO: compiled from: Collections.kt */
    public static final class a<T> extends i.q2.t.j0 implements i.q2.s.l<T, Integer> {
        final /* synthetic */ Comparable $key;
        final /* synthetic */ i.q2.s.l $selector;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public a(i.q2.s.l lVar, Comparable comparable) {
            super(1);
            this.$selector = lVar;
            this.$key = comparable;
        }
        ...
        public final int invoke2(T t) {
            return i.h2.b.a((Comparable) this.$selector.invoke(t), this.$key);
        }
    ...
    @j.c.a.d
    public static final <T> Collection<T> b(@j.c.a.d T[] tArr) {
        i.q2.t.i0.f(tArr, "$this$asCollection");
        return new k(tArr, false);
    }

    @j.c.a.d
    public static <T> List<T> c(@j.c.a.d T... tArr) {
    ...
    @j.c.a.d
    public static <T> List<T> e(@j.c.a.d T... tArr) {
        i.q2.t.i0.f(tArr, "elements");
    ...
    @j.c.a.d
    public static final <T> ArrayList<T> a(@j.c.a.d T... tArr) {
        i.q2.t.i0.f(tArr, "elements");
        return tArr.length == 0 ? new ArrayList<>() : new ArrayList<>(new k(tArr, true));
    }
    ...
    @j.c.a.d
    public static final <T> List<T> d(@j.c.a.d T... tArr) {
        i.q2.t.i0.f(tArr, "elements");
        return r.q(tArr);
    }
    ...
    @i.t0(version = "1.1")
    @i.m2.f
    private static final <T> List<T> a(int i2, i.q2.s.l<? super Integer, ? extends T> lVar) {
    ...
    @j.c.a.d
    public static final <T> List<T> b(@j.c.a.e T t) {
    ...
    @i.t0(version = "1.3")
    @i.m2.f
    private static final <E> List<E> c(int i2, @i.b i.q2.s.l<? super List<E>, i.y1> lVar) {
        ArrayList arrayList = new ArrayList(i2);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @i.m2.f
    private static final <T> Collection<T> d(@j.c.a.e Collection<? extends T> collection) {
    ...
    @i.t0(version = "1.3")
    @i.m2.f
    private static final <E> List<E> a(@i.b i.q2.s.l<? super List<E>, i.y1> lVar) {
    ...
    @i.t0(version = "1.1")
    @i.m2.f
    private static final <T> List<T> b(int i2, i.q2.s.l<? super Integer, ? extends T> lVar) {
        ArrayList arrayList = new ArrayList(i2);
        for (int i3 = 0; i3 < i2; i3++) {
            arrayList.add(lVar.invoke(Integer.valueOf(i3)));
        }
    ...
    @i.t0(version = "1.3")
    @i.m2.f
    private static final <T> boolean c(@j.c.a.e Collection<? extends T> collection) {
        return collection == null || collection.isEmpty();
    }

    @j.c.a.d
    public static i.v2.k a(@j.c.a.d Collection<?> collection) {
        i.q2.t.i0.f(collection, "$this$indices");
        return new i.v2.k(0, collection.size() - 1);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @i.m2.f
    private static final <T> List<T> c(@j.c.a.e List<? extends T> list) {
        return list != 0 ? list : b();
    }

    public static <T> int a(@j.c.a.d List<? extends T> list) {
        i.q2.t.i0.f(list, "$this$lastIndex");
        return list.size() - 1;
    }
    ...
    @i.t0(version = "1.3")
    @i.m2.f
    private static final Object a(Collection collection, i.q2.s.a aVar) {
        return collection.isEmpty() ? aVar.invoke() : collection;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @j.c.a.d
    public static <T> List<T> b(@j.c.a.d List<? extends T> list) {
        i.q2.t.i0.f(list, "$this$optimizeReadOnlyList");
        int size = list.size();
        if (size != 0) {
    ...
    public static final <T extends Comparable<? super T>> int a(@j.c.a.d List<? extends T> list, @j.c.a.e T t, int i2, int i3) {
        i.q2.t.i0.f(list, "$this$binarySearch");
        a(list.size(), i2, i3);
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
            int iA = i.h2.b.a(list.get(i5), t);
            if (iA < 0) {
                i2 = i5 + 1;
            } else {
                if (iA <= 0) {
    ...
    public static final <T> int a(@j.c.a.d List<? extends T> list, T t, @j.c.a.d Comparator<? super T> comparator, int i2, int i3) {
        i.q2.t.i0.f(list, "$this$binarySearch");
    ...
    public static /* synthetic */ int a(List list, Comparable comparable, int i2, int i3, i.q2.s.l lVar, int i4, Object obj) {
        if ((i4 & 2) != 0) {
            i2 = 0;
        }
        if ((i4 & 4) != 0) {
        ...
        i.q2.t.i0.f(list, "$this$binarySearchBy");
        i.q2.t.i0.f(lVar, "selector");
        return a(list, i2, i3, new a(lVar, comparable));
    }

    public static final <T, K extends Comparable<? super K>> int a(@j.c.a.d List<? extends T> list, @j.c.a.e K k2, int i2, int i3, @j.c.a.d i.q2.s.l<? super T, ? extends K> lVar) {
        i.q2.t.i0.f(list, "$this$binarySearchBy");
        i.q2.t.i0.f(lVar, "selector");
        return a(list, i2, i3, new a(lVar, k2));
    }

    public static /* synthetic */ int a(List list, int i2, int i3, i.q2.s.l lVar, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i2 = 0;
        }
        if ((i4 & 2) != 0) {
    ...
    public static final <T> int a(@j.c.a.d List<? extends T> list, int i2, int i3, @j.c.a.d i.q2.s.l<? super T, Integer> lVar) {
        i.q2.t.i0.f(list, "$this$binarySearch");
        i.q2.t.i0.f(lVar, "comparison");
        a(list.size(), i2, i3);
        int i4 = i3 - 1;
        while (i2 <= i4) {
            int i5 = (i2 + i4) >>> 1;
