...
public final class j0 implements List, Serializable, RandomAccess, i.q2.t.q1.a {
    ...
    public boolean contains(@j.c.a.d Void r2) {
        i.q2.t.i0.f(r2, "element");
        return false;
    }

    @Override // java.util.List, java.util.Collection
    public boolean containsAll(@j.c.a.d Collection collection) {
    ...
    public int indexOf(@j.c.a.d Void r2) {
        i.q2.t.i0.f(r2, "element");
        return -1;
    }
    ...
    public int lastIndexOf(@j.c.a.d Void r2) {
        i.q2.t.i0.f(r2, "element");
        return -1;
    }
