...
public abstract class d<E> extends i.g2.a<E> implements List<E>, i.q2.t.q1.a {
    ...
    public static final class a {
        ...
        public final boolean a(@j.c.a.d Collection<?> collection, @j.c.a.d Collection<?> collection2) {
            i.q2.t.i0.f(collection, bh.aI);
            i.q2.t.i0.f(collection2, DispatchConstants.OTHER);
            ...
            while (it2.hasNext()) {
                if (!i.q2.t.i0.a(it2.next(), it.next())) {
                    return false;
                }
            }
            return true;
    ...
    /* JADX INFO: compiled from: AbstractList.kt */
    private class b implements Iterator<E>, i.q2.t.q1.a {
        private int a;
    ...
    /* JADX INFO: compiled from: AbstractList.kt */
    private class c extends d<E>.b implements ListIterator<E>, i.q2.t.q1.a {
        public c(int i2) {
            super();
    ...
    /* JADX INFO: renamed from: i.g2.d$d, reason: collision with other inner class name */
    /* JADX INFO: compiled from: AbstractList.kt */
    private static final class C0238d<E> extends d<E> implements RandomAccess {
        private int a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final d<E> f12074b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private final int f12075c;

        /* JADX WARN: Multi-variable type inference failed */
        public C0238d(@j.c.a.d d<? extends E> dVar, int i2, int i3) {
            i.q2.t.i0.f(dVar, "list");
            this.f12074b = dVar;
            this.f12075c = i2;
            d.Companion.b(this.f12075c, i3, this.f12074b.size());
            this.a = i3 - this.f12075c;
        }

        @Override // i.g2.d, java.util.List
        public E get(int i2) {
            d.Companion.a(i2, this.a);
            return this.f12074b.get(this.f12075c + i2);
        }
    ...
    public int lastIndexOf(Object obj) {
        ...
        while (listIterator.hasPrevious()) {
            if (i.q2.t.i0.a(listIterator.previous(), obj)) {
