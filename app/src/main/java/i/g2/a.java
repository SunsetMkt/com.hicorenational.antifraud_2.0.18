...
public abstract class a<E> implements Collection<E>, i.q2.t.q1.a {

    /* JADX INFO: renamed from: i.g2.a$a */
    /* JADX INFO: compiled from: AbstractCollection.kt */
    static final class C0235a extends i.q2.t.j0 implements i.q2.s.l<E, CharSequence> {
        C0235a() {
            super(1);
        }
    ...
    public String toString() {
        return g0.a(this, ", ", "[", "]", 0, null, new C0235a(), 24, null);
    }
    ...
    public <T> T[] toArray(@j.c.a.d T[] tArr) {
        ...
        T[] tArr2 = (T[]) i.q2.t.u.a(this, tArr);
        if (tArr2 != null) {
            return tArr2;
        }
