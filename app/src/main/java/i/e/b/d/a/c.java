    ...
    class b extends Handler {
        ...
        public void handleMessage(Message message) {
            if (message.what == 11) {
                ...
                try {
                    String a2 = c.Q.a(i2, message.getData().getString("appid"));
                    if (i2 == 0) {
                        String unused = c.I = a2;
                        c.c(8, c.I);
                    } else if (i2 == 1) {
                        if (a2 != null) {
                            String unused2 = c.J = a2;
                        }
                        c.c(9, c.J);
                    } else if (i2 == 2) {
                        if (a2 != null) {
                            String unused3 = c.K = a2;
                        }
                        c.c(10, c.K);
                    } else if (i2 != 3) {
                        if (i2 == 4) {
                            String unused4 = c.M = a2;
                        } else if (i2 == 5 && a2 != null) {
                            String unused5 = c.N = a2;
                        }
                    } else if (a2 != null) {
                        String unused6 = c.L = a2;
                    }
                } catch (Exception e2) {
        ...
        if (this.f16963a >= B && list != null && list.size() != 0) {
            try {
                ...
                for (int i2 = 0; i2 < list.size(); i2++) {
                    ...
                    if (split.length == 2) {
                        arrayList.add(Boolean.valueOf(Q.a(6, "vivo", split[0], split[1])));
                    }
                }
                return arrayList;
