...
public class b {
    ...
    boolean a(int i2, String str, ContentValues[] contentValuesArr) {
        ...
        try {
            bulkInsert = this.f16950a.getContentResolver().bulkInsert(parse, contentValuesArr);
    ...
    */
    java.lang.String a(int r8, java.lang.String r9) {
        /*
            r7 = this;
            r0 = 0
            if (r8 == 0) goto L64
    ...
    boolean a(int i2, String str, String str2, String str3) {
        ...
        try {
            delete = this.f16950a.getContentResolver().delete(parse, "packageName=? and uid=?", new String[]{str2, str3});
