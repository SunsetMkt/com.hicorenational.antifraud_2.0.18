...
public class b {
    ...
    public c.AbstractC0254c b(String str) {
        ...
        c.AbstractC0254c a2 = c.AbstractC0254c.a(hashSet);
        return a2.equals(c.f16813d) ? c.f16814e : a2;
    }
                ...
                if (z) {
                    ...
                    if (trim.length() != 0) {
                        ...
                        if (split.length != 3) {
                            ...
                            arrayList.add(new C0253b(Pattern.compile(split[0]), new HashSet(Arrays.asList(split[1].split("\\+"))), split[2].equals(a.a.u.a.f1253j)));
                        }
                    }
                }
            }
    ...
    public String a(String str) {
        c.AbstractC0254c b2 = b(str);
        return b2.c() ? b2.a() : c.f16811b;
    }
}
