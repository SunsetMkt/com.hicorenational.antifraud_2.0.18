...
public class g {
        ...
        static class a implements Comparator<k> {
            ...
            public int compare(k kVar, k kVar2) {
                for (int i2 = 0; i2 < kVar.f16861a.length(); i2++) {
                    ...
                    int charAt = kVar.f16861a.charAt(i2) - kVar2.f16861a.charAt(i2);
                    if (charAt != 0) {
                        return charAt;
                    }
                }
    ...
    static {
        for (i.a.a.a.m.k.d dVar : i.a.a.a.m.k.d.values()) {
            ...
            for (i.a.a.a.m.k.h hVar : i.a.a.a.m.k.h.values()) {
                ...
                enumMap.put((EnumMap) hVar, (i.a.a.a.m.k.h) Collections.unmodifiableMap(hashMap));
            }
    ...
    private static Scanner a(String str) {
        ...
        InputStream resourceAsStream = i.a.a.a.m.k.c.class.getClassLoader().getResourceAsStream(format);
    ...
    private static Scanner b(i.a.a.a.m.k.d dVar, i.a.a.a.m.k.h hVar, String str) {
        ...
        InputStream resourceAsStream = i.a.a.a.m.k.c.class.getClassLoader().getResourceAsStream(a2);
        if (resourceAsStream != null) {
            return new Scanner(resourceAsStream, "UTF-8");
        }
    ...
    private static k b(String str) {
        ...
        if (indexOf >= 0) {
            if (str.endsWith("]")) {
                return new k(str.substring(0, indexOf), c.AbstractC0254c.a(new HashSet(Arrays.asList(str.substring(indexOf + 1, str.length() - 1).split("[+]")))));
            }
        ...
        while (true) {
            ...
            while (scanner.hasNextLine()) {
                ...
                if (z) {
                    ...
                    if (trim.length() == 0) {
                        continue;
                    } else if (trim.startsWith(f16839h)) {
                        String trim2 = trim.substring(8).trim();
                        if (trim2.contains(c.c.a.b.a.a.f3100g)) {
                        ...
                        if (split.length != 4) {
                            ...
                            try {
                                arrayList.add(new c(e(split[0]), e(split[1]), e(split[2]), c(e(split[3])), i2, str));
