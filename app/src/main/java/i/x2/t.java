...
class t extends s {
    ...
    /* JADX INFO: compiled from: _SequencesJvm.kt */
    static final class a extends j0 implements i.q2.s.l<Object, Boolean> {
        ...
        public final boolean invoke2(@j.c.a.e Object obj) {
            return this.$klass.isInstance(obj);
        }
    }

    @j.c.a.d
    public static final <R> m<R> a(@j.c.a.d m<?> mVar, @j.c.a.d Class<R> cls) {
    ...
    @j.c.a.d
    public static final <T extends Comparable<? super T>> SortedSet<T> d(@j.c.a.d m<? extends T> mVar) {
        i0.f(mVar, "$this$toSortedSet");
        return (SortedSet) u.c((m) mVar, new TreeSet());
    }

    @j.c.a.d
    public static final <C extends Collection<? super R>, R> C a(@j.c.a.d m<?> mVar, @j.c.a.d C c2, @j.c.a.d Class<R> cls) {
    ...
    @j.c.a.d
    public static final <T> SortedSet<T> a(@j.c.a.d m<? extends T> mVar, @j.c.a.d Comparator<? super T> comparator) {
        i0.f(mVar, "$this$toSortedSet");
