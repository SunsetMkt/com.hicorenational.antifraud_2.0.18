...
public final class z<T, R> implements m<R> {
    ...
    private final i.q2.s.l<T, R> f12398b;
    ...
    public static final class a implements Iterator<R>, i.q2.t.q1.a {
        ...
        @Override // java.util.Iterator
        public R next() {
            return (R) z.this.f12398b.invoke(this.a.next());
        }
    ...
    public z(@j.c.a.d m<? extends T> mVar, @j.c.a.d i.q2.s.l<? super T, ? extends R> lVar) {
        i0.f(mVar, "sequence");
    ...
    @j.c.a.d
    public final <E> m<E> a(@j.c.a.d i.q2.s.l<? super R, ? extends Iterator<? extends E>> lVar) {
        i0.f(lVar, "iterator");
        return new i(this.a, this.f12398b, lVar);
    }
}
