...
class q {
    ...
    private static final int f12373b = 1;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final int f12374c = 2;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final int f12375d = 3;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final int f12376e = 4;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final int f12377f = 5;
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final <T> Iterator<T> a(@i.b i.q2.s.p<? super o<? super T>, ? super i.k2.d<? super y1>, ? extends Object> pVar) {
        return c(pVar);
    }
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final <T> m<T> b(@i.b i.q2.s.p<? super o<? super T>, ? super i.k2.d<? super y1>, ? extends Object> pVar) {
        return new a(pVar);
    }

    @t0(version = "1.3")
    @j.c.a.d
    public static <T> Iterator<T> c(@i.b @j.c.a.d i.q2.s.p<? super o<? super T>, ? super i.k2.d<? super y1>, ? extends Object> pVar) {
        i0.f(pVar, "block");
        n nVar = new n();
        nVar.a(i.k2.m.c.a(pVar, nVar, nVar));
        return nVar;
    }

    @t0(version = "1.3")
    @j.c.a.d
    public static final <T> m<T> d(@i.b @j.c.a.d i.q2.s.p<? super o<? super T>, ? super i.k2.d<? super y1>, ? extends Object> pVar) {
        i0.f(pVar, "block");
        return new b(pVar);
    }
}
