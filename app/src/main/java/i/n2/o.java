...
class o {
    private static final int a(@j.c.a.d String str) {
        int iA;
    ...
    @j.c.a.d
    public static final String b(@j.c.a.d File file) {
    ...
    public static final boolean c(@j.c.a.d File file) {
    ...
    @j.c.a.d
    public static final i d(@j.c.a.d File file) {
        List listB;
    ...
    @j.c.a.d
    public static final File a(@j.c.a.d File file) {
        i0.f(file, "$this$root");
        return new File(b(file));
    }

    @j.c.a.d
    public static final File a(@j.c.a.d File file, int i2, int i3) {
