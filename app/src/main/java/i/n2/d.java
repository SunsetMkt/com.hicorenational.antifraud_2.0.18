...
public final class d {
    ...
    private static final i.s f12168c = i.v.a(a.INSTANCE);

    /* JADX INFO: compiled from: Console.kt */
    static final class a extends j0 implements i.q2.s.a<CharsetDecoder> {
    ...
    private static final CharsetDecoder a() {
        return (CharsetDecoder) f12168c.getValue();
    }
    ...
    @j.c.a.e
    public static final String a(@j.c.a.d InputStream inputStream, @j.c.a.d CharsetDecoder charsetDecoder) throws IOException {
    ...
    private static final boolean a(@j.c.a.d CharsetDecoder charsetDecoder, ByteBuffer byteBuffer, CharBuffer charBuffer, boolean z) throws CharacterCodingException {
    ...
    private static final boolean a(@j.c.a.d CharBuffer charBuffer) {
        int iPosition = charBuffer.position();
        return iPosition > 0 && charBuffer.get(iPosition - 1) == '\n';
    }

    private static final void a(@j.c.a.d Buffer buffer) {
        buffer.position(buffer.limit());
        buffer.limit(buffer.capacity());
    }

    private static final void a(@j.c.a.d CharBuffer charBuffer, StringBuilder sb) {
        charBuffer.flip();
