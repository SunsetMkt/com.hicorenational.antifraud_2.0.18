...
public final class t1 implements Comparable<t1> {
    ...
    public static final short f12274b = 0;

    /* JADX INFO: renamed from: c */
    public static final short f12275c = -1;

    /* JADX INFO: renamed from: d */
    public static final int f12276d = 2;

    /* JADX INFO: renamed from: e */
    public static final int f12277e = 16;
    ...
    private static final int a(short s, byte b2) {
        return i.q2.t.i0.a(s & f12275c, b2 & f1.f12066c);
    }
    ...
    public static boolean a(short s, @j.c.a.e Object obj) {
    ...
    private static final int c(short s, byte b2) {
        return j1.c(j1.c(s & f12275c) - j1.c(b2 & f1.f12066c));
    }
    ...
    private static final int e(short s, short s2) {
        return j1.c(j1.c(s & f12275c) - j1.c(s2 & f12275c));
    }
    ...
    @i.m2.f
    private static final i.v2.t h(short s, short s2) {
        return new i.v2.t(j1.c(s & f12275c), j1.c(s2 & f12275c), null);
    }
    ...
    private static final int i(short s, short s2) {
        return b2.c(j1.c(s & f12275c), j1.c(s2 & f12275c));
    }
    ...
    public static String n(short s) {
        return String.valueOf(s & f12275c);
    }
    ...
    private static final int p(short s) {
        return j1.c(s & f12275c);
    }

    @i.m2.f
    private static final long q(short s) {
        return n1.c(((long) s) & 65535);
    }
    ...
    private static final int a(short s, int i2) {
        return b2.a(j1.c(s & f12275c), i2);
    }

    @i.m2.f
    private static int b(short s, short s2) {
        return i.q2.t.i0.a(s & f12275c, s2 & f12275c);
    }

    @i.m2.f
    private static final int c(short s, int i2) {
        return j1.c(j1.c(s & f12275c) - i2);
    }
    ...
    private static final int e(short s, byte b2) {
        return b2.c(j1.c(s & f12275c), j1.c(b2 & f1.f12066c));
    }
    ...
    private static final int a(short s, long j2) {
        return b2.a(n1.c(((long) s) & 65535), j2);
    }

    @i.m2.f
    private static final int b(short s, byte b2) {
        return b2.b(j1.c(s & f12275c), j1.c(b2 & f1.f12066c));
    }

    @i.m2.f
    private static final long c(short s, long j2) {
        return n1.c(n1.c(((long) s) & 65535) - j2);
    }
    ...
    private static final int b(short s, int i2) {
        return b2.b(j1.c(s & f12275c), i2);
    }

    @i.m2.f
    private static final int c(short s, short s2) {
        return b2.b(j1.c(s & f12275c), j1.c(s2 & f12275c));
    }
    ...
    private static final long e(short s, long j2) {
        return b2.c(n1.c(((long) s) & 65535), j2);
    }
    ...
    private static final long b(short s, long j2) {
        return b2.b(n1.c(((long) s) & 65535), j2);
    }
