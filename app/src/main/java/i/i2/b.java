...
public final class b {
    ...
    @d
    public static final Thread a(boolean z, boolean z2, @j.c.a.e ClassLoader classLoader, @j.c.a.e String str, int i2, @d i.q2.s.a<y1> aVar) {
        i0.f(aVar, "block");
        a aVar2 = new a(aVar);
        if (z2) {
    ...
    @f
    private static final <T> T a(@d ThreadLocal<T> threadLocal, i.q2.s.a<? extends T> aVar) {
        T t = threadLocal.get();
        if (t != null) {
            return t;
        }
