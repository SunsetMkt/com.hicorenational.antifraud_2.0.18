...
public final class p1 implements i.w2.q {
    ...
    @j.c.a.d
    private final i.w2.e a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @j.c.a.d
    private final List<i.w2.s> f12233b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final boolean f12234c;

    /* JADX INFO: compiled from: TypeReference.kt */
    static final class a extends j0 implements i.q2.s.l<i.w2.s, String> {
        a() {
            super(1);
        }
        ...
        @Override // i.q2.s.l
        @j.c.a.d
        public final String invoke(@j.c.a.d i.w2.s sVar) {
            i0.f(sVar, "it");
            return p1.this.a(sVar);
        }
    }

    public p1(@j.c.a.d i.w2.e eVar, @j.c.a.d List<i.w2.s> list, boolean z) {
    ...
    private final String a() {
        i.w2.e eVarP = p();
        if (!(eVarP instanceof i.w2.c)) {
            eVarP = null;
        }
        i.w2.c cVar = (i.w2.c) eVarP;
        Class<?> clsA = cVar != null ? i.q2.a.a(cVar) : null;
        return (clsA == null ? p().toString() : clsA.isArray() ? a(clsA) : clsA.getName()) + (o().isEmpty() ? "" : i.g2.g0.a(o(), ", ", "<", ">", 0, null, new a(), 24, null)) + (n() ? "?" : "");
    }
    ...
    public final String a(@j.c.a.d i.w2.s sVar) {
        String strValueOf;
        if (sVar.d() == null) {
            return "*";
        }
