...
public final class s1 {
    ...
    private static final byte d(byte b2) {
        return f1.c((byte) Integer.highestOneBit(b2 & f1.f12066c));
    }
    ...
    private static final byte e(byte b2) {
        return f1.c((byte) Integer.lowestOneBit(b2 & f1.f12066c));
    }
    ...
    private static final short d(short s) {
        return t1.c((short) Integer.highestOneBit(s & t1.f12275c));
    }
    ...
    private static final short e(short s) {
        return t1.c((short) Integer.lowestOneBit(s & t1.f12275c));
    }
    ...
    private static final int b(byte b2) {
        return Integer.bitCount(j1.c(b2 & f1.f12066c));
    }
    ...
    private static final int b(short s) {
        return Integer.bitCount(j1.c(s & t1.f12275c));
    }
