...
@k
public final class g1 implements Collection<f1>, i.q2.t.q1.a {

    @j.c.a.d
    private final byte[] a;

    /* JADX INFO: compiled from: UByteArray.kt */
    private static final class a extends i.g2.u1 {
        private int a;
        ...
        public boolean hasNext() {
            return this.a < this.f12070b.length;
        }
    }

    @n0
    private /* synthetic */ g1(@j.c.a.d byte[] bArr) {
        i.q2.t.i0.f(bArr, "storage");
        this.a = bArr;
    }

    @j.c.a.d
    public static final /* synthetic */ g1 a(@j.c.a.d byte[] bArr) {
        i.q2.t.i0.f(bArr, "v");
        return new g1(bArr);
    }

    public static boolean a(byte[] bArr, @j.c.a.e Object obj) {
        return (obj instanceof g1) && i.q2.t.i0.a(bArr, ((g1) obj).c());
    }

    public static final boolean a(@j.c.a.d byte[] bArr, @j.c.a.d byte[] bArr2) {
        return i.q2.t.i0.a(bArr, bArr2);
    }
    ...
    @n0
    @j.c.a.d
    public static byte[] b(@j.c.a.d byte[] bArr) {
        i.q2.t.i0.f(bArr, "storage");
        return bArr;
    }
    ...
    @j.c.a.d
    public static i.g2.u1 f(byte[] bArr) {
        return new a(bArr);
    }
    ...
    public boolean containsAll(@j.c.a.d Collection<? extends Object> collection) {
        return a(this.a, (Collection<f1>) collection);
    }
    ...
    public static boolean a(byte[] bArr, byte b2) {
        return i.g2.r.b(bArr, b2);
    }

    public static boolean a(byte[] bArr, @j.c.a.d Collection<f1> collection) {
        i.q2.t.i0.f(collection, "elements");
        if (collection.isEmpty()) {
            return true;
        }
        for (Object obj : collection) {
            if (!((obj instanceof f1) && i.g2.r.b(bArr, ((f1) obj).a()))) {
                return false;
            }
        }
        return true;
