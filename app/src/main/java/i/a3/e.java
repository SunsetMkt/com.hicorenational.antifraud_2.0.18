...
public final class e {
    ...
    @j
    @t0(version = "1.3")
    public static final double a(int i2, @j.c.a.d TimeUnit timeUnit) {
        i0.f(timeUnit, "unit");
    ...
    @j
    @t0(version = "1.3")
    public static final double a(long j2, @j.c.a.d TimeUnit timeUnit) {
        i0.f(timeUnit, "unit");
    ...
    public static final double a(double d2, @j.c.a.d TimeUnit timeUnit) {
        i0.f(timeUnit, "unit");
        return d.c(h.a(d2, timeUnit, TimeUnit.NANOSECONDS));
    }
}
