...
public class l implements Iterable<Long>, i.q2.t.q1.a {

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final a f12314d = new a(null);
    ...
    public l(long j2, long j3, long j4) {
        ...
        this.a = j2;
        this.f12315b = i.m2.m.b(j2, j3, j4);
        this.f12316c = j4;
    }
    ...
    public boolean equals(@j.c.a.e Object obj) {
        if (obj instanceof l) {
            if (!isEmpty() || !((l) obj).isEmpty()) {
                l lVar = (l) obj;
                if (this.a != lVar.a || this.f12315b != lVar.f12315b || this.f12316c != lVar.f12316c) {
                }
            }
            return true;
        }
    ...
    public int hashCode() {
        ...
        long j2 = 31;
        long j3 = this.a;
        long j4 = this.f12315b;
        long j5 = j2 * (((j3 ^ (j3 >>> 32)) * j2) + (j4 ^ (j4 >>> 32)));
        long j6 = this.f12316c;
    ...
    public Iterator<Long> iterator2() {
        return new m(this.a, this.f12315b, this.f12316c);
    }
}
