...
public class q extends p {
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final int a(@j.c.a.d k kVar) {
        return a(kVar, (i.u2.f) i.u2.f.f12287c);
    }
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final Integer b(@j.c.a.d k kVar) {
        return b(kVar, i.u2.f.f12287c);
    }
    ...
    @i.q2.e(name = "intRangeContains")
    public static final boolean c(@j.c.a.d g<Integer> gVar, byte b2) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Integer.valueOf(b2));
    }

    @i.q2.e(name = "longRangeContains")
    public static final boolean d(@j.c.a.d g<Long> gVar, byte b2) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Long.valueOf(b2));
    }

    @i.q2.e(name = "shortRangeContains")
    public static final boolean e(@j.c.a.d g<Short> gVar, byte b2) {
        i0.f(gVar, "$this$contains");
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final long a(@j.c.a.d n nVar) {
        return a(nVar, (i.u2.f) i.u2.f.f12287c);
    }

    @i.j
    @t0(version = "1.3")
    @i.m2.f
    private static final Long b(@j.c.a.d n nVar) {
        return b(nVar, i.u2.f.f12287c);
    }

    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "intRangeContains")
    public static final boolean c(@j.c.a.d g<Integer> gVar, double d2) {
        i0.f(gVar, "$this$contains");
        Integer numB = b(d2);
        if (numB != null) {
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "longRangeContains")
    public static final boolean d(@j.c.a.d g<Long> gVar, double d2) {
        i0.f(gVar, "$this$contains");
        Long lC = c(d2);
        if (lC != null) {
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "shortRangeContains")
    public static final boolean e(@j.c.a.d g<Short> gVar, double d2) {
        i0.f(gVar, "$this$contains");
        Short shD = d(d2);
        if (shD != null) {
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final char a(@j.c.a.d c cVar) {
        return a(cVar, (i.u2.f) i.u2.f.f12287c);
    }

    @i.j
    @t0(version = "1.3")
    @i.m2.f
    private static final Character b(@j.c.a.d c cVar) {
        return b(cVar, i.u2.f.f12287c);
    }

    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "intRangeContains")
    public static final boolean c(@j.c.a.d g<Integer> gVar, float f2) {
        i0.f(gVar, "$this$contains");
        Integer numB = b(f2);
        if (numB != null) {
            return gVar.contains(numB);
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "longRangeContains")
    public static final boolean d(@j.c.a.d g<Long> gVar, float f2) {
        i0.f(gVar, "$this$contains");
        Long lC = c(f2);
        if (lC != null) {
            return gVar.contains(lC);
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "shortRangeContains")
    public static final boolean e(@j.c.a.d g<Short> gVar, float f2) {
        i0.f(gVar, "$this$contains");
        Short shD = d(f2);
        if (shD != null) {
            return gVar.contains(shD);
    ...
    @t0(version = "1.3")
    public static final int a(@j.c.a.d k kVar, @j.c.a.d i.u2.f fVar) {
        i0.f(kVar, "$this$random");
        i0.f(fVar, "random");
        try {
            return i.u2.g.a(fVar, kVar);
    ...
    @j.c.a.e
    @t0(version = "1.3")
    public static final Integer b(@j.c.a.d k kVar, @j.c.a.d i.u2.f fVar) {
        i0.f(kVar, "$this$randomOrNull");
        i0.f(fVar, "random");
        if (kVar.isEmpty()) {
            return null;
        }
        return Integer.valueOf(i.u2.g.a(fVar, kVar));
    }

    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "floatRangeContains")
    public static final boolean c(@j.c.a.d g<Float> gVar, int i2) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Float.valueOf(i2));
    }

    @i.q2.e(name = "longRangeContains")
    public static final boolean d(@j.c.a.d g<Long> gVar, int i2) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Long.valueOf(i2));
    }

    @i.q2.e(name = "shortRangeContains")
    public static final boolean e(@j.c.a.d g<Short> gVar, int i2) {
        i0.f(gVar, "$this$contains");
        Short shB = b(i2);
        if (shB != null) {
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "floatRangeContains")
    public static final boolean c(@j.c.a.d g<Float> gVar, long j2) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Float.valueOf(j2));
    }

    @i.q2.e(name = "intRangeContains")
    public static final boolean d(@j.c.a.d g<Integer> gVar, long j2) {
        i0.f(gVar, "$this$contains");
        Integer numB = b(j2);
        if (numB != null) {
            return gVar.contains(numB);
    ...
    @i.q2.e(name = "shortRangeContains")
    public static final boolean e(@j.c.a.d g<Short> gVar, long j2) {
        i0.f(gVar, "$this$contains");
        Short shC = c(j2);
        if (shC != null) {
    ...
    @t0(version = "1.3")
    public static final long a(@j.c.a.d n nVar, @j.c.a.d i.u2.f fVar) {
        i0.f(nVar, "$this$random");
        i0.f(fVar, "random");
        try {
            return i.u2.g.a(fVar, nVar);
        } catch (IllegalArgumentException e2) {
            throw new NoSuchElementException(e2.getMessage());
        }
    }
    ...
    @j.c.a.e
    @t0(version = "1.3")
    public static final Long b(@j.c.a.d n nVar, @j.c.a.d i.u2.f fVar) {
        i0.f(nVar, "$this$randomOrNull");
        i0.f(fVar, "random");
        if (nVar.isEmpty()) {
            return null;
        }
        return Long.valueOf(i.u2.g.a(fVar, nVar));
    }

    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "floatRangeContains")
    public static final boolean c(@j.c.a.d g<Float> gVar, short s) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Float.valueOf(s));
    }

    @i.q2.e(name = "intRangeContains")
    public static final boolean d(@j.c.a.d g<Integer> gVar, short s) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Integer.valueOf(s));
    }

    @i.q2.e(name = "longRangeContains")
    public static final boolean e(@j.c.a.d g<Long> gVar, short s) {
        i0.f(gVar, "$this$contains");
    ...
    @t0(version = "1.3")
    public static final char a(@j.c.a.d c cVar, @j.c.a.d i.u2.f fVar) {
    ...
    @j.c.a.e
    @t0(version = "1.3")
    public static final Character b(@j.c.a.d c cVar, @j.c.a.d i.u2.f fVar) {
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final boolean a(@j.c.a.d k kVar, Integer num) {
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "floatRangeContains")
    public static final boolean b(@j.c.a.d g<Float> gVar, byte b2) {
        i0.f(gVar, "$this$contains");
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final boolean a(@j.c.a.d n nVar, Long l2) {
        i0.f(nVar, "$this$contains");
        return l2 != null && nVar.a(l2.longValue());
    }

    @i.q2.e(name = "floatRangeContains")
    public static final boolean b(@j.c.a.d g<Float> gVar, double d2) {
        i0.f(gVar, "$this$contains");
    ...
    @t0(version = "1.3")
    @i.m2.f
    private static final boolean a(@j.c.a.d c cVar, Character ch) {
        i0.f(cVar, "$this$contains");
        return ch != null && cVar.a(ch.charValue());
    }

    @i.q2.e(name = "doubleRangeContains")
    public static final boolean b(@j.c.a.d g<Double> gVar, float f2) {
        i0.f(gVar, "$this$contains");
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "doubleRangeContains")
    public static final boolean a(@j.c.a.d g<Double> gVar, byte b2) {
        i0.f(gVar, "$this$contains");
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "doubleRangeContains")
    public static final boolean b(@j.c.a.d g<Double> gVar, int i2) {
        i0.f(gVar, "$this$contains");
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "byteRangeContains")
    public static final boolean a(@j.c.a.d g<Byte> gVar, double d2) {
        i0.f(gVar, "$this$contains");
        Byte bA = a(d2);
        if (bA != null) {
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "doubleRangeContains")
    public static final boolean b(@j.c.a.d g<Double> gVar, long j2) {
        i0.f(gVar, "$this$contains");
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "byteRangeContains")
    public static final boolean a(@j.c.a.d g<Byte> gVar, float f2) {
        i0.f(gVar, "$this$contains");
        Byte bA = a(f2);
        if (bA != null) {
            return gVar.contains(bA);
    ...
    @i.c(message = "This `contains` operation mixing integer and floating point arguments has ambiguous semantics and is going to be removed.")
    @i.q2.e(name = "doubleRangeContains")
    public static final boolean b(@j.c.a.d g<Double> gVar, short s) {
        i0.f(gVar, "$this$contains");
        return gVar.contains(Double.valueOf(s));
    }

    @i.q2.e(name = "byteRangeContains")
    public static final boolean a(@j.c.a.d g<Byte> gVar, int i2) {
        i0.f(gVar, "$this$contains");
        Byte bA = a(i2);
        if (bA != null) {
            return gVar.contains(bA);
    ...
    @i.q2.e(name = "byteRangeContains")
    public static final boolean a(@j.c.a.d g<Byte> gVar, long j2) {
        i0.f(gVar, "$this$contains");
        Byte bA = a(j2);
        if (bA != null) {
            return gVar.contains(bA);
    ...
    @i.q2.e(name = "byteRangeContains")
    public static final boolean a(@j.c.a.d g<Byte> gVar, short s) {
        i0.f(gVar, "$this$contains");
        Byte bA = a(s);
        if (bA != null) {
            return gVar.contains(bA);
    ...
    public static final l a(byte b2, long j2) {
        return l.f12314d.a(b2, j2, -1L);
    }

    @j.c.a.d
    public static final l a(short s, long j2) {
        return l.f12314d.a(s, j2, -1L);
    }
    ...
    public static final i a(int i2, short s) {
        return i.f12306d.a(i2, s, -1);
    }

    @j.c.a.d
    public static final l a(long j2, short s) {
        return l.f12314d.a(j2, s, -1L);
    }
    ...
    public static final i a(byte b2, short s) {
        return i.f12306d.a(b2, s, -1);
    }

    @j.c.a.d
    public static final i a(@j.c.a.d i iVar) {
        i0.f(iVar, "$this$reversed");
        return i.f12306d.a(iVar.getLast(), iVar.getFirst(), -iVar.b());
    }
    ...
    @j.c.a.d
    public static final l a(@j.c.a.d l lVar) {
        i0.f(lVar, "$this$reversed");
        return l.f12314d.a(lVar.getLast(), lVar.getFirst(), -lVar.b());
    }

    @j.c.a.d
    public static final a a(@j.c.a.d a aVar) {
        i0.f(aVar, "$this$reversed");
        return a.f12295d.a(aVar.getLast(), aVar.getFirst(), -aVar.b());
    }
    ...
    @j.c.a.d
    public static i a(@j.c.a.d i iVar, int i2) {
        i0.f(iVar, "$this$step");
    ...
    @j.c.a.d
    public static final l a(@j.c.a.d l lVar, long j2) {
        i0.f(lVar, "$this$step");
    ...
    @j.c.a.d
    public static final a a(@j.c.a.d a aVar, int i2) {
        i0.f(aVar, "$this$step");
        p.a(i2 > 0, Integer.valueOf(i2));
        a.C0250a c0250a = a.f12295d;
        char first = aVar.getFirst();
        char last = aVar.getLast();
        if (aVar.b() <= 0) {
            i2 = -i2;
        }
        return c0250a.a(first, last, i2);
    }
    ...
    @j.c.a.d
    public static final <T extends Comparable<? super T>> T a(@j.c.a.d T t, @j.c.a.e T t2, @j.c.a.e T t3) {
    ...
    @t0(version = "1.1")
    @j.c.a.d
    public static final <T extends Comparable<? super T>> T a(@j.c.a.d T t, @j.c.a.d f<T> fVar) {
        i0.f(t, "$this$coerceIn");
        i0.f(fVar, "range");
        if (!fVar.isEmpty()) {
    ...
    @j.c.a.d
    public static final <T extends Comparable<? super T>> T a(@j.c.a.d T t, @j.c.a.d g<T> gVar) {
        i0.f(t, "$this$coerceIn");
        i0.f(gVar, "range");
    ...
    public static final int a(int i2, @j.c.a.d g<Integer> gVar) {
        i0.f(gVar, "range");
        if (gVar instanceof f) {
    ...
    public static final long a(long j2, @j.c.a.d g<Long> gVar) {
        i0.f(gVar, "range");
        if (gVar instanceof f) {
