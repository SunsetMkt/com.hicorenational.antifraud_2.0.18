...
@k
public final class o1 implements Collection<n1>, i.q2.t.q1.a {

    @j.c.a.d
    private final long[] a;

    /* JADX INFO: compiled from: ULongArray.kt */
    private static final class a extends i.g2.y1 {
        private int a;

        /* JADX INFO: renamed from: b */
        private final long[] f12192b;

        public a(@j.c.a.d long[] jArr) {
        ...
        public boolean hasNext() {
            return this.a < this.f12192b.length;
        }
    }

    @n0
    private /* synthetic */ o1(@j.c.a.d long[] jArr) {
        i.q2.t.i0.f(jArr, "storage");
        this.a = jArr;
    }

    @j.c.a.d
    public static final /* synthetic */ o1 a(@j.c.a.d long[] jArr) {
        i.q2.t.i0.f(jArr, "v");
        return new o1(jArr);
    }

    public static boolean a(long[] jArr, @j.c.a.e Object obj) {
        return (obj instanceof o1) && i.q2.t.i0.a(jArr, ((o1) obj).c());
    }

    public static final boolean a(@j.c.a.d long[] jArr, @j.c.a.d long[] jArr2) {
        return i.q2.t.i0.a(jArr, jArr2);
    }
    ...
    @n0
    @j.c.a.d
    public static long[] b(@j.c.a.d long[] jArr) {
        i.q2.t.i0.f(jArr, "storage");
        return jArr;
    }
    ...
    @j.c.a.d
    public static i.g2.y1 f(long[] jArr) {
        return new a(jArr);
    }
    ...
    public boolean containsAll(@j.c.a.d Collection<? extends Object> collection) {
        return a(this.a, (Collection<n1>) collection);
    }
    ...
    public static boolean a(long[] jArr, long j2) {
        return i.g2.r.b(jArr, j2);
    }

    public static boolean a(long[] jArr, @j.c.a.d Collection<n1> collection) {
        i.q2.t.i0.f(collection, "elements");
        if (collection.isEmpty()) {
            return true;
        }
        for (Object obj : collection) {
            if (!((obj instanceof n1) && i.g2.r.b(jArr, ((n1) obj).a()))) {
                return false;
            }
        }
        return true;
