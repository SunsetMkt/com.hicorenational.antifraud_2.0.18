...
public final class h {
    @k
    @t0(version = "1.3")
    public static final int a(@j.c.a.d f fVar) {
    ...
    @k
    @t0(version = "1.3")
    public static final int b(@j.c.a.d f fVar, int i2) {
        i0.f(fVar, "$this$nextUInt");
        return a(fVar, 0, i2);
    }
    ...
    @k
    @t0(version = "1.3")
    public static final int a(@j.c.a.d f fVar, int i2, int i3) {
        i0.f(fVar, "$this$nextUInt");
        a(i2, i3);
    ...
    @k
    @t0(version = "1.3")
    public static final long b(@j.c.a.d f fVar) {
    ...
    @k
    @t0(version = "1.3")
    public static final int a(@j.c.a.d f fVar, @j.c.a.d t tVar) {
        i0.f(fVar, "$this$nextUInt");
        i0.f(tVar, "range");
        if (!tVar.isEmpty()) {
    ...
    @k
    @t0(version = "1.3")
    public static final long a(@j.c.a.d f fVar, long j2) {
        i0.f(fVar, "$this$nextULong");
        return a(fVar, 0L, j2);
    }
    ...
    @k
    @t0(version = "1.3")
    public static final long a(@j.c.a.d f fVar, long j2, long j3) {
        i0.f(fVar, "$this$nextULong");
        a(j2, j3);
    ...
    @k
    @t0(version = "1.3")
    public static final long a(@j.c.a.d f fVar, @j.c.a.d w wVar) {
        i0.f(fVar, "$this$nextULong");
        i0.f(wVar, "range");
        if (!wVar.isEmpty()) {
            if (b2.a(wVar.getLast(), -1L) < 0) {
                return a(fVar, wVar.getFirst(), n1.c(wVar.getLast() + n1.c(((long) 1) & 4294967295L)));
            }
    ...
    @t0(version = "1.3")
    @j.c.a.d
    public static final byte[] a(@j.c.a.d f fVar, @j.c.a.d byte[] bArr) {
    ...
    @t0(version = "1.3")
    @j.c.a.d
    public static final byte[] a(@j.c.a.d f fVar, int i2) {
        i0.f(fVar, "$this$nextUBytes");
    ...
    @t0(version = "1.3")
    @j.c.a.d
    public static final byte[] a(@j.c.a.d f fVar, @j.c.a.d byte[] bArr, int i2, int i3) {
        i0.f(fVar, "$this$nextUBytes");
        i0.f(bArr, "array");
        fVar.a(bArr, i2, i3);
        return bArr;
