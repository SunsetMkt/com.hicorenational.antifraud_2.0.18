...
public final class g {
    ...
    @t0(version = "1.3")
    public static final int a(@j.c.a.d f fVar, @j.c.a.d k kVar) {
    ...
    @t0(version = "1.3")
    public static final long a(@j.c.a.d f fVar, @j.c.a.d n nVar) {
        i0.f(fVar, "$this$nextLong");
        i0.f(nVar, "range");
        if (!nVar.isEmpty()) {
            return nVar.getLast() < m0.f12222b ? fVar.a(nVar.getFirst(), nVar.getLast() + 1) : nVar.getFirst() > Long.MIN_VALUE ? fVar.a(nVar.getFirst() - 1, nVar.getLast()) + 1 : fVar.e();
        }
    ...
    @j.c.a.d
    public static final String a(@j.c.a.d Object obj, @j.c.a.d Object obj2) {
        i0.f(obj, "from");
        i0.f(obj2, "until");
