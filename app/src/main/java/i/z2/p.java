...
public final class p {
    ...
    /* JADX INFO: compiled from: Regex.kt */
    public static final class a<T> extends j0 implements i.q2.s.l<T, Boolean> {
    ...
    /* JADX INFO: compiled from: Regex.kt */
    public static final class b<T> extends j0 implements i.q2.s.l<T, Boolean> {
        final /* synthetic */ int $value$inlined;
    ...
    public static final /* synthetic */ <T extends Enum<T> & i> Set<T> b(int i2) {
        i.q2.t.i0.a(4, ExifInterface.GPS_DIRECTION_TRUE);
        EnumSet enumSetAllOf = EnumSet.allOf(Enum.class);
        i.g2.d0.b((Iterable) enumSetAllOf, (i.q2.s.l) new b(i2));
    ...
    public static final m b(@j.c.a.d Matcher matcher, int i2, CharSequence charSequence) {
        if (matcher.find(i2)) {
    ...
    public static final m b(@j.c.a.d Matcher matcher, CharSequence charSequence) {
        if (matcher.matches()) {
            return new n(matcher, charSequence);
        }
        return null;
    ...
    public static final i.v2.k b(@j.c.a.d MatchResult matchResult) {
        return i.v2.q.d(matchResult.start(), matchResult.end());
    }

    public static final i.v2.k b(@j.c.a.d MatchResult matchResult, int i2) {
        return i.v2.q.d(matchResult.start(i2), matchResult.end(i2));
    }

    public static final int b(@j.c.a.d Iterable<? extends i> iterable) {
