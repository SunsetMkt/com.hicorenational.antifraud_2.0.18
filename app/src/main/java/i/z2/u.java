...
class u extends t {
    ...
    /* JADX INFO: compiled from: Indent.kt */
    static final class a extends j0 implements i.q2.s.l<String, String> {
        ...
        @Override // i.q2.s.l
        @j.c.a.d
        public final String invoke(@j.c.a.d String str) {
            i.q2.t.i0.f(str, "line");
            return str;
        }
    }

    /* JADX INFO: compiled from: Indent.kt */
    static final class b extends j0 implements i.q2.s.l<String, String> {
    ...
    /* JADX INFO: compiled from: Indent.kt */
    static final class c extends j0 implements i.q2.s.l<String, String> {
        final /* synthetic */ String $indent;
    ...
    @j.c.a.d
    public static final String a(@j.c.a.d String str, @j.c.a.d String str2, @j.c.a.d String str3) {
        int i2;
        String strInvoke;
        i.q2.t.i0.f(str, "$this$replaceIndentByMargin");
        i.q2.t.i0.f(str2, "newIndent");
        i.q2.t.i0.f(str3, "marginPrefix");
        ...
        i.q2.s.l<String, String> lVarA = a(str2);
        int iA = i.g2.y.a((List) listK);
        ...
        String string = ((StringBuilder) i.g2.g0.a(arrayList, new StringBuilder(length), (124 & 2) != 0 ? ", " : "\n", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : null)).toString();
        i.q2.t.i0.a((Object) string, "mapIndexedNotNull { inde\u2026\"\\n\")\n        .toString()");
        return string;
    }

    @j.c.a.d
    public static final String b(@j.c.a.d String str, @j.c.a.d String str2) {
        String strInvoke;
        i.q2.t.i0.f(str, "$this$replaceIndent");
        i.q2.t.i0.f(str2, "newIndent");
        List<String> listK = c0.k((CharSequence) str);
        ArrayList arrayList = new ArrayList();
        for (Object obj : listK) {
        ...
        Integer num = (Integer) i.g2.w.y((Iterable) arrayList2);
        int i2 = 0;
        ...
        String string = ((StringBuilder) i.g2.g0.a(arrayList3, new StringBuilder(length), (124 & 2) != 0 ? ", " : "\n", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : null)).toString();
        i.q2.t.i0.a((Object) string, "mapIndexedNotNull { inde\u2026\"\\n\")\n        .toString()");
        return string;
    }

    @j.c.a.d
    public static final String c(@j.c.a.d String str, @j.c.a.d String str2) {
        i.q2.t.i0.f(str, "$this$trimMargin");
        i.q2.t.i0.f(str2, "marginPrefix");
        return a(str, "", str2);
    }

    @j.c.a.d
    public static final String c(@j.c.a.d String str) {
        i.q2.t.i0.f(str, "$this$trimIndent");
        return b(str, "");
    }
    ...
    @j.c.a.d
    public static final String a(@j.c.a.d String str, @j.c.a.d String str2) {
        i.q2.t.i0.f(str, "$this$prependIndent");
        i.q2.t.i0.f(str2, "indent");
        return i.x2.u.a(i.x2.u.w(c0.j((CharSequence) str), new c(str2)), "\n", null, null, 0, null, null, 62, null);
    }

    private static final int b(@j.c.a.d String str) {
    ...
    private static final i.q2.s.l<String, String> a(String str) {
        return str.length() == 0 ? a.INSTANCE : new b(str);
    }

    private static final String a(@j.c.a.d List<String> list, int i2, i.q2.s.l<? super String, String> lVar, i.q2.s.l<? super String, String> lVar2) {
        String strInvoke;
        int iA = i.g2.y.a((List) list);
        ArrayList arrayList = new ArrayList();
        int i3 = 0;
        for (Object obj : list) {
            int i4 = i3 + 1;
        ...
        String string = ((StringBuilder) i.g2.g0.a(arrayList, new StringBuilder(i2), (124 & 2) != 0 ? ", " : "\n", (124 & 4) != 0 ? "" : null, (124 & 8) == 0 ? null : "", (124 & 16) != 0 ? -1 : 0, (124 & 32) != 0 ? "..." : null, (124 & 64) != 0 ? null : null)).toString();
        i.q2.t.i0.a((Object) string, "mapIndexedNotNull { inde\u2026\"\\n\")\n        .toString()");
        return string;
    }
}
