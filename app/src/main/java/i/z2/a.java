...
public enum a {
    ...
    private static final i.s f12400b = i.v.a(C0252a.INSTANCE);

    /* JADX INFO: renamed from: i.z2.a$a */
    /* JADX INFO: compiled from: CharCategory.kt */
    static final class C0252a extends j0 implements i.q2.s.a<Map<Integer, ? extends a>> {
        ...
        public final Map<Integer, ? extends a> invoke() {
            ...
            LinkedHashMap linkedHashMap = new LinkedHashMap(i.v2.q.a(b1.b(aVarArrValues.length), 16));
