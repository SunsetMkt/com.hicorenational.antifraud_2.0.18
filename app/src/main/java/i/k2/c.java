...
public final class c implements g, Serializable {
    ...
    private static final class a implements Serializable {
        ...
        /* JADX INFO: renamed from: i.k2.c$a$a, reason: collision with other inner class name */
        /* JADX INFO: compiled from: CoroutineContextImpl.kt */
    ...
    static final class b extends j0 implements p<String, g.b, String> {
        ...
        @Override // i.q2.s.p
        @j.c.a.d
        public final String invoke(@j.c.a.d String str, @j.c.a.d g.b bVar) {
            i0.f(str, "acc");
            i0.f(bVar, "element");
            if (str.length() == 0) {
    ...
    /* JADX INFO: renamed from: i.k2.c$c, reason: collision with other inner class name */
    /* JADX INFO: compiled from: CoroutineContextImpl.kt */
    static final class C0242c extends j0 implements p<y1, g.b, y1> {
        final /* synthetic */ g[] $elements;
        final /* synthetic */ g1.f $index;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C0242c(g[] gVarArr, g1.f fVar) {
            super(2);
            this.$elements = gVarArr;
            this.$index = fVar;
        }
        ...
        public final void invoke2(@j.c.a.d y1 y1Var, @j.c.a.d g.b bVar) {
    ...
    public c(@j.c.a.d g gVar, @j.c.a.d g.b bVar) {
        i0.f(gVar, "left");
        i0.f(bVar, "element");
        this.left = gVar;
        this.element = bVar;
    ...
    private final Object writeReplace() {
        ...
        g1.f fVar = new g1.f();
        fVar.element = 0;
        fold(y1.a, new C0242c(gVarArr, fVar));
        if (fVar.element == iA) {
