...
public interface g {
    ...
    public static final class a {
        ...
        /* JADX INFO: renamed from: i.k2.g$a$a */
        /* JADX INFO: compiled from: CoroutineContext.kt */
        static final class C0243a extends j0 implements p<g, b, g> {
            ...
            public final g invoke(@j.c.a.d g gVar, @j.c.a.d b bVar) {
                ...
                if (eVar == null) {
                    return new i.k2.c(gVarMinusKey, bVar);
                }
                g gVarMinusKey2 = gVarMinusKey.minusKey(e.V);
                return gVarMinusKey2 == i.INSTANCE ? new i.k2.c(bVar, eVar) : new i.k2.c(new i.k2.c(gVarMinusKey2, bVar), eVar);
            }
        }

        @j.c.a.d
        public static g a(g gVar, @j.c.a.d g gVar2) {
            i0.f(gVar2, com.umeng.analytics.pro.d.R);
            return gVar2 == i.INSTANCE ? gVar : (g) gVar2.fold(gVar, C0243a.INSTANCE);
        }
    }
    ...
    public interface b extends g {
        ...
        public static final class a {
            ...
            @j.c.a.d
            public static g a(b bVar, @j.c.a.d g gVar) {
                i0.f(gVar, com.umeng.analytics.pro.d.R);
                return a.a(bVar, gVar);
            }

            @j.c.a.d
            public static g b(b bVar, @j.c.a.d c<?> cVar) {
                i0.f(cVar, "key");
