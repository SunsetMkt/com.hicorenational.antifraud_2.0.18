...
public class ScanAppAdapter extends BaseQuickAdapter<AppInfoBean, BaseViewHolder> {
    ...
    public void a(BaseViewHolder baseViewHolder, AppInfoBean appInfoBean) {
        try {
            ...
            if (virusLevel == 0) {
                k.d.b(imageView2, Integer.valueOf(R.mipmap.ic_scan_ok));
                return;
            }
            if (virusLevel != 2 && virusLevel != 1) {
                k.d.a(imageView2, Integer.valueOf(R.mipmap.ic_scan_loading));
                return;
            }
            k.d.b(imageView2, Integer.valueOf(R.mipmap.ic_scan_risk));
