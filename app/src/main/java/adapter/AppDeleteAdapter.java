...
public class AppDeleteAdapter extends BaseQuickAdapter<AppInfoBean, BaseViewHolder> {
    ...
    public void a(BaseViewHolder baseViewHolder, AppInfoBean appInfoBean) {
        ...
        baseViewHolder.a(R.id.tv_app_name, (CharSequence) appInfoBean.getName()).a(R.id.tv_app_version, (CharSequence) ("版本:" + appInfoBean.getVersionCode() + "  |  " + formatFileSize)).a(R.id.iv_clear);
    }
