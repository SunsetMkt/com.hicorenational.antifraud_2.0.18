...
public class PayStopAdapter extends BaseQuickAdapter<AccountListBean, BaseViewHolder> {
    public PayStopAdapter(int i2, List<AccountListBean> list) {
        super(i2, list);
    }
