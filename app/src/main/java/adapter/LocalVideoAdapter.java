...
public class LocalVideoAdapter extends BaseQuickAdapter<LocalMedia, BaseViewHolder> {
    ...
    public void a(BaseViewHolder baseViewHolder, LocalMedia localMedia) {
        ...
        com.bumptech.glide.b.e(this.x).a(Uri.fromFile(new File(localMedia.getPath()))).a((com.bumptech.glide.r.a<?>) hVar).a(jzvdStd.thumbImageView);
        jzvdStd.setUp(localMedia.getPath(), localMedia.getPath(), 0);
    }
}
