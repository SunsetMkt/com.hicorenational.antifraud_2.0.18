...
public class CriminalSmsAdapter extends BaseQuickAdapter<CriminalSmsBean, BaseViewHolder> {
    public CriminalSmsAdapter(List<CriminalSmsBean> list) {
        super(C2113R.layout.recyclerview_criminal_sms, list);
    }
    ...
    public void mo204a(BaseViewHolder baseViewHolder, CriminalSmsBean criminalSmsBean) {
        ...
        baseViewHolder.m5211a(C2113R.id.tv_type_sms, (CharSequence) criminalSmsBean.getSmsTypeText()).m5211a(C2113R.id.tv_victim_phone, (CharSequence) ("接收短信号码：" + criminalSmsBean.getVictimMobile())).m5211a(C2113R.id.tv_time, (CharSequence) criminalSmsBean.getDeliveryTime()).m5194a(C2113R.id.iv_edit).m5194a(C2113R.id.iv_clear);
    }
}
