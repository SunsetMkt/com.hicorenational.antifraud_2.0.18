...
public class CriminalSmsAdapter extends BaseQuickAdapter<CriminalSmsBean, BaseViewHolder> {
    public CriminalSmsAdapter(List<CriminalSmsBean> list) {
        super(R.layout.recyclerview_criminal_sms, list);
    }
    ...
    public void a(BaseViewHolder baseViewHolder, CriminalSmsBean criminalSmsBean) {
        ...
        baseViewHolder.a(R.id.tv_type_sms, (CharSequence) criminalSmsBean.getSmsTypeText()).a(R.id.tv_victim_phone, (CharSequence) ("\u63a5\u6536\u77ed\u4fe1\u53f7\u7801\uff1a" + criminalSmsBean.getVictimMobile())).a(R.id.tv_time, (CharSequence) criminalSmsBean.getDeliveryTime()).a(R.id.iv_edit).a(R.id.iv_clear);
    }
}
