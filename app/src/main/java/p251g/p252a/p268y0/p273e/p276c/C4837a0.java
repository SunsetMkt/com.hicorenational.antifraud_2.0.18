...
/* renamed from: g.a.y0.e.c.a0 */
/* loaded from: classes2.dex */
public final class C4837a0<T> extends AbstractC4474c {

    /* renamed from: a */
    final InterfaceC4588y<T> f18549a;

    /* renamed from: b */
    final InterfaceC4584o<? super T, ? extends InterfaceC4513i> f18550b;

    /* compiled from: MaybeFlatMapCompletable.java */
    /* renamed from: g.a.y0.e.c.a0$a */
    static final class a<T> extends AtomicReference<InterfaceC4552c> implements InterfaceC4559v<T>, InterfaceC4491f, InterfaceC4552c {
    ...
    public C4837a0(InterfaceC4588y<T> interfaceC4588y, InterfaceC4584o<? super T, ? extends InterfaceC4513i> interfaceC4584o) {
        this.f18549a = interfaceC4588y;
        this.f18550b = interfaceC4584o;
    }

    @Override // p251g.p252a.AbstractC4474c
    /* renamed from: b */
    protected void mo17086b(InterfaceC4491f interfaceC4491f) {
        a aVar = new a(interfaceC4491f, this.f18550b);
        interfaceC4491f.onSubscribe(aVar);
        this.f18549a.mo18100a(aVar);
    }
}
