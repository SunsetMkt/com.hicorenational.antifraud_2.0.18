...
public class d implements a {
    ...
    */
    private static java.util.ArrayList<com.hihonor.honorid.core.data.HonorAccount> a(java.lang.String r6, android.content.Context r7, boolean r8) {
        /*
    ...
    private void b(Context context) {
        ...
        k.a.a.b.a.a a2 = k.a.a.b.a.a.a(context);
        ...
        if (!TextUtils.isEmpty(a3)) {
            String c2 = com.hihonor.honorid.d.a.b.c(context, a3);
    ...
    private static void a(XmlPullParser xmlPullParser, Context context, boolean z, HonorAccount honorAccount, String str) {
        if ("userId".equals(str)) {
            ...
            if (z) {
                nextText = com.hihonor.honorid.d.a.b.c(context, nextText);
            }
        ...
        if ("deviceId".equals(str)) {
            ...
            if (z) {
                nextText2 = com.hihonor.honorid.d.a.b.c(context, nextText2);
            }
        ...
        if (c.c.a.b.a.a.t.equals(str)) {
            ...
            if (z) {
                nextText3 = com.hihonor.honorid.d.a.b.c(context, nextText3);
            }
    ...
    private void a(Context context) {
        ...
        com.hihonor.honorid.g.c.b.a(context, "accounts.xml", (List<HonorAccount>) a2, true);
    }
}
