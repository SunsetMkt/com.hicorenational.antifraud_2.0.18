...
public class d {
    ...
    private static final ThreadLocal<SimpleDateFormat> f1802b = new ThreadLocal<>();
    ...
    public static a.C0022a a(Map<String, List<String>> map) {
        long j2;
        long j3;
        ...
        if (z) {
            ...
            if (jA <= 0 || jA2 < jA) {
                ...
                c0022a.etag = singleHeaderFieldByKey5;
                c0022a.ttl = jCurrentTimeMillis;
                c0022a.serverDate = jA;
                c0022a.lastModified = j3;
                c0022a.responseHeaders = map;
                return c0022a;
            }
        ...
        c0022a2.etag = singleHeaderFieldByKey5;
        c0022a2.ttl = jCurrentTimeMillis;
        c0022a2.serverDate = jA;
        c0022a2.lastModified = j3;
        c0022a2.responseHeaders = map;
        return c0022a2;
    }

    private static SimpleDateFormat a() {
        SimpleDateFormat simpleDateFormat = f1802b.get();
