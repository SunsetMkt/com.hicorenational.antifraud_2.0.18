...
public abstract class b extends h.a {
    ...
    public static final int f1852f = 0;

    /* JADX INFO: renamed from: g */
    public static final int f1853g = 1;

    /* JADX INFO: renamed from: h */
    private static final String f1854h = "anet.UnifiedNetworkDelegate";

    /* JADX INFO: renamed from: e */
    public int f1855e = 1;

    public b(Context context) {
        b.a.o.c.init(context);
    }
    ...
    public anetwork.channel.aidl.a b(ParcelableRequest parcelableRequest) throws RemoteException {
        try {
            anetwork.channel.entity.k kVar = new anetwork.channel.entity.k(parcelableRequest, this.f1855e, true);
            ...
            ALog.e(f1854h, "asyncSend failed", parcelableRequest.f1691m, e2, new Object[0]);
    ...
    public anetwork.channel.aidl.e a(ParcelableRequest parcelableRequest, anetwork.channel.aidl.g gVar) throws RemoteException {
        try {
            return a(new anetwork.channel.entity.k(parcelableRequest, this.f1855e, false), gVar);
        } catch (Exception e2) {
            ALog.e(f1854h, "asyncSend failed", parcelableRequest.f1691m, e2, new Object[0]);
            throw new RemoteException(e2.getMessage());
        }
