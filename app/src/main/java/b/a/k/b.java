...
public class b {
    ...
    public static final String f1803b = "SESSION_ASYNC_OPTIMIZE";

    /* JADX INFO: renamed from: c */
    private static volatile boolean f1804c = true;

    /* JADX INFO: renamed from: d */
    private static volatile boolean f1805d = true;

    /* JADX INFO: renamed from: e */
    private static volatile boolean f1806e = true;

    /* JADX INFO: renamed from: f */
    private static volatile int f1807f = 5;

    /* JADX INFO: renamed from: g */
    private static volatile boolean f1808g = true;

    /* JADX INFO: renamed from: h */
    private static volatile boolean f1809h = true;

    /* JADX INFO: renamed from: i */
    private static volatile boolean f1810i = false;

    /* JADX INFO: renamed from: j */
    private static volatile long f1811j = 0;

    /* JADX INFO: renamed from: k */
    private static volatile boolean f1812k = false;

    /* JADX INFO: renamed from: l */
    private static volatile ConcurrentHashMap<String, List<String>> f1813l;

    /* JADX INFO: renamed from: m */
    private static volatile CopyOnWriteArrayList<String> f1814m;

    /* JADX INFO: renamed from: n */
    private static final List<String> f1815n = new ArrayList();
    ...
    public static void d() {
        ...
        f1811j = defaultSharedPreferences.getLong("Cache.Flag", 0L);
    ...
    public static void f(String str) {
        ...
        try {
            ...
            while (itKeys.hasNext()) {
                ...
                try {
                    if ("*".equals(obj)) {
                        concurrentHashMap.put(next, f1815n);
    ...
    public static boolean b(HttpUrl httpUrl) {
        ...
        List<String> list;
        if (httpUrl == null || (concurrentHashMap = f1813l) == null || (list = concurrentHashMap.get(httpUrl.host())) == null) {
            return false;
        }
        if (list == f1815n) {
            return true;
    ...
    public static void a(long j2) {
        if (j2 != f1811j) {
            ALog.i("anet.NetworkConfigCenter", "set cache flag", null, "old", Long.valueOf(f1811j), "new", Long.valueOf(j2));
            f1811j = j2;
            SharedPreferences.Editor editorEdit = PreferenceManager.getDefaultSharedPreferences(c.getContext()).edit();
            editorEdit.putLong("Cache.Flag", f1811j);
            editorEdit.apply();
            b.a.j.b.a();
        }
    }
    ...
    public static boolean a(String str) {
        ...
        CopyOnWriteArrayList<String> copyOnWriteArrayList = f1814m;
        if (f1814m == null) {
            return false;
        }
