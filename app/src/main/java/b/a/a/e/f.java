...
public class f<Fst extends b.a.a.d.g<Snd>, Snd extends b.a.a.d.i<Trd>, Trd> extends b.a.a.e.k {
    ...
    class a implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            fVar2.n0 = 0;
            fVar2.o0 = 0;
            List<Snd> a2 = fVar2.p0.a(fVar2.m0);
            f fVar3 = f.this;
            fVar3.h0 = a2.get(fVar3.n0);
            this.f2270a.a((List<?>) a2, f.this.n0);
            if (!f.this.p0.b()) {
                f fVar4 = f.this;
                List<Trd> a3 = fVar4.p0.a(fVar4.m0, fVar4.n0);
                f fVar5 = f.this;
                fVar5.i0 = a3.get(fVar5.o0);
                this.f2271b.a((List<?>) a3, f.this.o0);
            }
            if (f.this.w0 != null) {
    ...
    class b implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            if (!fVar2.p0.b()) {
                ...
                f fVar3 = f.this;
                fVar3.o0 = 0;
                List<Trd> a2 = fVar3.p0.a(fVar3.m0, fVar3.n0);
                f fVar4 = f.this;
                fVar4.i0 = a2.get(fVar4.o0);
                this.f2273a.a((List<?>) a2, f.this.o0);
            }
            if (f.this.w0 != null) {
                i iVar = f.this.w0;
                f fVar5 = f.this;
    ...
    public Trd D() {
        if (this.i0 == null) {
            List<Trd> a2 = this.p0.a(this.m0, this.n0);
            if (a2.size() > 0) {
                this.i0 = a2.get(this.o0);
            }
        }
        return this.i0;
    }
    ...
    protected View r() {
        ...
        WheelView x = x();
        x.setLayoutParams(new LinearLayout.LayoutParams(0, -2, this.q0));
        ...
        WheelView x2 = x();
        x2.setLayoutParams(new LinearLayout.LayoutParams(0, -2, this.r0));
        ...
        WheelView x3 = x();
        if (!this.p0.b()) {
            x3.setLayoutParams(new LinearLayout.LayoutParams(0, -2, this.s0));
        ...
        x.a(this.p0.a(), this.m0);
        x.setOnItemSelectListener(new a(x2, x3));
        x2.a(this.p0.a(this.m0), this.n0);
        x2.setOnItemSelectListener(new b(x3));
        if (this.p0.b()) {
            return linearLayout;
        }
        x3.a(this.p0.a(this.m0, this.n0), this.o0);
    ...
    public void v() {
        ...
        if (!this.p0.b()) {
            ...
            if (this.u0 != null) {
                this.u0.a(z.getName(), B.getName(), D instanceof b.a.a.d.j ? ((b.a.a.d.j) D).getName() : D.toString());
                return;
            }
            return;
        }
        ...
        if (abstractC0028f != null) {
            abstractC0028f.a(z.getName(), B.getName(), (String) null);
        }
    }
    ...
    */
    public void a(Fst r7, Snd r8, Trd r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: b.a.a.e.f.a(b.a.a.d.g, b.a.a.d.i, java.lang.Object):void");
    }
