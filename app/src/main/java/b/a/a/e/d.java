...
public class d extends b.a.a.e.k {
    ...
    class a implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            d dVar = d.this;
            dVar.j(c2, b.a.a.g.c.c((String) dVar.h0.get(d.this.r0)));
    ...
    protected View r() {
        ...
        if (i5 == 0 || i5 == 2) {
            ...
            x3.a(this.i0, this.s0);
            x3.setOnItemSelectListener(new c());
            linearLayout.addView(x3);
            if (!TextUtils.isEmpty(this.n0)) {
                TextView w3 = w();
                w3.setTextSize(this.J0);
                w3.setText(this.n0);
    ...
    public void E(int i2) {
        ...
        if (this.K0) {
            ...
            if (size > i5) {
                ...
                str = b.a.a.g.c.b(Calendar.getInstance().get(2) + 1);
            }
