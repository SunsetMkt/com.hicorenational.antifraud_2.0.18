...
public class a extends b.a.a.e.f<b.a.a.d.k, b.a.a.d.d, b.a.a.d.e> {
    ...
    class C0025a implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            aVar3.n0 = 0;
            aVar3.o0 = 0;
            List<?> a2 = aVar3.p0.a(aVar3.m0);
            if (a2.size() > 0) {
                a aVar4 = a.this;
                aVar4.h0 = (Snd) a2.get(aVar4.n0);
                this.f2240a.a(a2, a.this.n0);
            } else {
                a.this.h0 = null;
                this.f2240a.setItems(new ArrayList());
            }
            a aVar5 = a.this;
            List<?> a3 = aVar5.p0.a(aVar5.m0, aVar5.n0);
            if (a3.size() <= 0) {
                a.this.i0 = null;
                this.f2241b.setItems(new ArrayList());
            } else {
                a aVar6 = a.this;
                aVar6.i0 = a3.get(aVar6.o0);
                this.f2241b.a(a3, a.this.o0);
            }
        }
    }
    ...
    class b implements WheelView.g {
        ...
        public void a(int i2) {
            ...
            a aVar3 = a.this;
            aVar3.o0 = 0;
            List<?> a2 = aVar3.p0.a(aVar3.m0, aVar3.n0);
            if (a2.size() <= 0) {
                a.this.i0 = null;
                this.f2243a.setItems(new ArrayList());
            } else {
                a aVar4 = a.this;
                aVar4.i0 = a2.get(aVar4.o0);
                this.f2243a.a(a2, a.this.o0);
            }
        }
    }
    ...
    public b.a.a.d.e F() {
        ...
        List<b.a.a.d.e> counties = E.getCounties();
        if (counties.size() == 0) {
            return null;
        }
    ...
    protected View r() {
        ...
        x.setOnItemSelectListener(new C0025a(x2, x3));
