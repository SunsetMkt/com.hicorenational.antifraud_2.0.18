    ...
    public void onDataReceive(ByteArray byteArray, boolean z) {
        ...
        try {
            ...
            if (this.f1229c.f1200d != null) {
                ...
                if (z) {
                    String g2 = this.f1229c.f1197a.f1230a.g();
                    this.f1229c.f1199c.data = this.f1229c.f1200d.toByteArray();
                    long currentTimeMillis = System.currentTimeMillis();
                    this.f1229c.f1198b.put(g2, this.f1229c.f1199c);
                    ALog.i(g.n, "write cache", this.f1229c.f1197a.f1232c, "cost", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), "size", Integer.valueOf(this.f1229c.f1199c.data.length), "key", g2);
                }
            }
        } catch (Exception e2) {
    ...
    public void onResponseCode(int i2, Map<String, List<String>> map) {
        ...
        if (HttpHelper.checkRedirect(this.f1227a, i2) && (singleHeaderFieldByKey = HttpHelper.getSingleHeaderFieldByKey(map, "Location")) != null) {
            ...
            if (parse != null) {
                if (this.f1229c.f1204h.compareAndSet(false, true)) {
                    parse.lockScheme();
                    this.f1229c.f1197a.f1230a.a(parse);
                    this.f1229c.f1197a.f1233d = new AtomicBoolean();
                    l lVar = this.f1229c.f1197a;
                    lVar.f1234e = new g(lVar, null, null);
                    this.f1228b.recordRedirect(i2, parse.simpleUrlString());
        ...
        try {
            ...
            if (this.f1229c.f1199c != null && i2 == 304) {
                ...
                a.C0001a a2 = a.a.j.d.a(map);
                if (a2 != null && a2.ttl > this.f1229c.f1199c.ttl) {
                    this.f1229c.f1199c.ttl = a2.ttl;
                }
                ...
                long currentTimeMillis = System.currentTimeMillis();
                this.f1229c.f1198b.put(g2, this.f1229c.f1199c);
                ALog.i(g.n, "update cache", this.f1229c.f1197a.f1232c, "cost", Long.valueOf(System.currentTimeMillis() - currentTimeMillis), "key", g2);
                return;
            }
            if (this.f1229c.f1198b != null) {
                if ("no-store".equals(HttpHelper.getSingleHeaderFieldByKey(map, "Cache-Control"))) {
                    this.f1229c.f1198b.remove(g2);
                } else {
                    g gVar = this.f1229c;
                    a.C0001a a3 = a.a.j.d.a(map);
                    gVar.f1199c = a3;
                    if (a3 != null) {
