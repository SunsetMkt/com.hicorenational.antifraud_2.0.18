...
class g implements a.a.t.a {
    ...
    private Session b() {
        Session session;
        SessionCenter a2 = a();
        HttpUrl f2 = this.f1197a.f1230a.f();
        ...
        if (kVar.f2230j != 1 || !a.a.k.b.r() || this.f1197a.f1230a.f2225e != 0 || containsNonDefaultPort) {
            return a(null, a2, f2, containsNonDefaultPort);
        }
        HttpUrl a3 = a(f2);
        try {
            session = a2.getThrowsException(a3, anet.channel.entity.c.f1769a, 0L);
        ...
        ALog.i(n, "tryGetSession", this.f1197a.f1232c, "Session", session);
    ...
    private void c() {
        ...
        RequestStatistic requestStatistic = kVar.f2226f;
        Request a3 = kVar.a();
        if (this.f1197a.f1230a.f2230j != 1 || !a.a.k.b.r() || this.f1197a.f1230a.f2225e != 0 || containsNonDefaultPort) {
            a(a(null, a2, f2, containsNonDefaultPort), a3);
            return;
        }
        a2.asyncGet(a(f2), anet.channel.entity.c.f1769a, 3000L, new j(this, requestStatistic, System.currentTimeMillis(), a3, a2, f2, containsNonDefaultPort));
    }
    ...
    private SessionCenter a() {
        String a2 = this.f1197a.f1230a.a(a.a.u.a.f1244a);
        if (TextUtils.isEmpty(a2)) {
            return SessionCenter.getInstance();
        }
        ENV env = ENV.ONLINE;
        String a3 = this.f1197a.f1230a.a(a.a.u.a.f1245b);
        if (a.a.u.a.f1256m.equalsIgnoreCase(a3)) {
            env = ENV.PREPARE;
        } else if (a.a.u.a.n.equalsIgnoreCase(a3)) {
            env = ENV.TEST;
        }
        ...
        if (config == null) {
            config = new Config.Builder().setAppkey(a2).setEnv(env).setAuthCode(this.f1197a.f1230a.a(a.a.u.a.f1246c)).build();
        }
    ...
    */
    ...
    public void a(Session session, Request request) {
        ...
        this.f1202f = session.request(a2, new k(this, a2, requestStatistic));
    }
}
