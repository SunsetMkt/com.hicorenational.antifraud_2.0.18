...
public abstract class b extends h.a {
    ...
    private NetworkResponse c(ParcelableRequest parcelableRequest) {
        ...
        try {
            ...
            anetwork.channel.aidl.f k2 = aVar.k();
            if (k2 != null) {
                ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream(k2.length() > 0 ? k2.length() : 1024);
                ByteArray a2 = a.C0012a.f1691a.a(2048);
                while (true) {
                    int read = k2.read(a2.getBuffer());
                    if (read == -1) {
                        break;
                    }
