...
public class c implements a {
    ...
    public void run() {
        ...
        if (this.f1186b != null) {
            String g2 = kVar.g();
            Request a2 = this.f1185a.f1230a.a();
            String str = a2.getHeaders().get("Cache-Control");
            boolean equals2 = "no-store".equals(str);
            long currentTimeMillis = System.currentTimeMillis();
            if (equals2) {
                this.f1186b.remove(g2);
                equals = false;
                c0001a = null;
            } else {
                equals = "no-cache".equals(str);
                a.C0001a c0001a2 = this.f1186b.get(g2);
            ...
            if (c0001a == null || equals || !c0001a.isFresh()) {
                if (this.f1187c) {
                    return;
                }
                g gVar = new g(this.f1185a, equals2 ? null : this.f1186b, c0001a);
            ...
            if (this.f1185a.f1233d.compareAndSet(false, true)) {
                ...
                this.f1185a.f1231b.a(new DefaultFinishEvent(200, HttpConstant.SUCCESS, a2));
            }
        }
    }
}
