...
class i implements Runnable {
    ...
    public void run() {
        ...
        this.f1216c.connWaitTime = System.currentTimeMillis() - currentTimeMillis;
        this.f1216c.spdyRequestSend = session != null;
        a2 = this.f1219f.a(session, this.f1214a, this.f1217d, this.f1218e);
        g gVar = this.f1219f;
        gVar.a(a2, gVar.f1197a.f1230a.a());
    }
}
