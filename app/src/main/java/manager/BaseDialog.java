...
public class BaseDialog extends Dialog {
    ...
    private void initWindowState() {
        ...
        this.f12810d = windowManager.getDefaultDisplay();
    ...
    public void initOnCreate() {
        ...
        if (this.widthDialog > 0.0d) {
            layoutParams.width = (int) (((double) this.f12810d.getWidth()) * this.widthDialog);
        } else {
            ...
            if (f2 > 0.0f) {
                ...
                layoutParams.width = this.f12810d.getWidth();
            }
        }
        if (this.heightDialog > 0.0d) {
            this.lp.height = (int) (((double) this.f12810d.getHeight()) * this.heightDialog);
        } else {
            ...
            if (f3 > 0.0f) {
                ...
                this.lp.height = this.f12810d.getHeight() - getStatusBarHeight();
            }
        }
